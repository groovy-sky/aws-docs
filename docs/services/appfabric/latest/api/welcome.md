...
including the required permissions to use the service, see the [AWS AppFabric Administration Guide](../adminguide.md). For more
information about using the AWS Command Line Interface (AWS CLI) to manage your
