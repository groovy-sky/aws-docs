...
This section provides the API operations, data types, and common errors for the AWS AppFabric
productivity features.

###### Note

For all other AppFabric APIs, see the [AWS AppFabric API Reference](../api.md).
