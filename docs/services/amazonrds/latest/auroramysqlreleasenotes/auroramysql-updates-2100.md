---
title: "Aurora MySQL database engine updates 2021-05-25 (version 2.10.0) (Deprecated)"
---
...
[Optimizing binary log replication](../aurorauserguide/auroramysql-replication.md#binlog-optimization) in the _Amazon Aurora User Guide_.

- In [Aurora MySQL version 2.08](auroramysql-updates-2080.md),
...
[Rebooting an Aurora MySQL cluster (version 2.10 and higher)](../aurorauserguide/user-rebootcluster.md#aurora-mysql-survivable-replicas) in the _Amazon Aurora User Guide_.
...
[Zero-downtime restart (ZDR) for Amazon Aurora MySQL](../aurorauserguide/auroramysql-replication.md#AuroraMySQL.Replication.Availability) and
...
- [">XA ROLLBACK](https://dev.mysql.com/doc/refman/5.7/en/xa.html) statements that failed
...
- With GTIDs enabled, [XA COMMIT](https://dev.mysql.com/doc/refman/5.7/en/xa.html) on a
...
[XA ROLLBACK](https://dev.mysql.com/doc/refman/5.7/en/xa.html) statement was issued for
