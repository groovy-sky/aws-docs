...
To determine the version number of your Aurora PostgreSQL database, see [Identifying versions of Amazon Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Updates.Versions.html) in the _Amazon Aurora User_
_Guide_.

For information about extensions and modules, see [Extension versions for Amazon Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Extensions.html).
...
the [describe-db-engine-versions](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-engine-versions.html) AWS CLI command as shown following.
...
see [Shared Plan Cache](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/apg-shared-plan-cache.html).
...
execution efficiency. For more information, see [Improving Aurora PostgreSQL query performance using subquery transformation](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/apg-correlated-subquery.html#apg-corsubquery-transformation).

- Added support for caching the result of correlated subquery to improve execution
efficiency. For more information, see [Using subquery cache to improve Aurora PostgreSQL query performance](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/apg-correlated-subquery.html#apg-subquery-cache).
...
see [Extension versions for Amazon Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Extensions.html).
...
across regions, and others. For more information, see [Cross-Region resiliency for Global Database secondary clusters](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-global-database-secondary-availability.html).
...
more information, see [aurora\_stat\_statements](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora_stat_statements.html).
...
more information, see [Monitoring query execution plans for Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Monitoring.Query.Plans.html).
...
For information about extensions and modules, see [Extensions supported for Aurora PostgreSQL 16](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Extensions.html#AuroraPostgreSQL.Extensions.16).
...
For more information, see [Monitoring query execution plans for Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Monitoring.Query.Plans.html).
...
For information about extensions and modules, see [Extensions supported for Aurora PostgreSQL 15](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Extensions.html#AuroraPostgreSQL.Extensions.15).
...
[Babelfish for Aurora PostgreSQL version 3.2](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraBabelfish.Updates.html), and improved support for
[AWS Database Migration Service](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.PostgreSQL.html#CHAP_Target.PostgreSQL.Babelfish).
...
preventing issues caused by insufficient memory. For more information, see [Improved memory management in Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.BestPractices.memory.management).
...
For information about extensions and modules, see [Extensions supported for Aurora PostgreSQL 14](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Extensions.html#AuroraPostgreSQL.Extensions.14).
...
the PostgreSQL community, along with Aurora-specific improvements. The releases also contain new features and improvements for
[Babelfish for Aurora PostgreSQL version 3.2](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraBabelfish.Updates.html), and improved support for
[AWS Database Migration Service](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.PostgreSQL.html#CHAP_Target.PostgreSQL.Babelfish). Refer to the [Amazon Aurora versions](../aurorauserguide/aurora-versionpolicy.md)
to help you to decide how often to upgrade and how to plan your upgrade process. As a reminder, if you are running any version of Amazon Aurora PostgreSQL 11,
you must upgrade to a newer major version by February 29, 2024.
...
see [Using SCRAM for PostgreSQL password encryption](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Appendix.PostgreSQL.CommonDBATasks.Roles#PostgreSQL_Password_Encryption_configuration).
...
[Aurora PostgreSQL 13.7](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Updates.html#AuroraPostgreSQL.Updates.20180305.137X).
...
see [Aurora PostgreSQL collations for EBCDIC and other mainframe migrations](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Reference.html#AuroraPostgreSQL.Reference.Collations.mainframe.migration) in the _Amazon Aurora User Guide_.
...
For information about extensions and modules, see [Extensions supported for Aurora PostgreSQL 13](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Extensions.html#AuroraPostgreSQL.Extensions.13).
...
see [Managing\
large objects with the lo module](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/PostgreSQL_large_objects_lo_extension.html).

- Added support for zero-downtime patching (ZDP) for minor version upgrades and patches. For more information, see
[Minor\
release upgrades and zero-downtime patching](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_UpgradeDBInstance.PostgreSQL.html#USER_UpgradeDBInstance.PostgreSQL.Minor)
...
For more information, see [Working with Babelfish for Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/babelfish.html).
...
For information about extensions and modules, see [Extensions supported for Aurora PostgreSQL 12](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Extensions.html#AuroraPostgreSQL.Extensions.12).
...
- Added support for the `large object` module (extension). For more information,
see [Managing large objects with the lo module](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/PostgreSQL_large_objects_lo_extension.html).
...
[Managing PostgreSQL partitions with the pg\_partman extension](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/PostgreSQL_Partitions.html)
in the _Amazon Aurora User Guide_.

- The `pg_cron` extension version 1.3.0. For more information, see
[Scheduling maintenance with the PostgreSQL pg\_cron extension](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/PostgreSQL_pg_cron.html)
in the _Amazon Aurora User Guide_.
...
For information about extensions and modules, see [Extensions supported for Aurora PostgreSQL 11](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Extensions.html#AuroraPostgreSQL.Extensions.11).
...
3.2](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraBabelfish.Updates.html), and improved support for [AWS Database Migration Service](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.PostgreSQL.html#CHAP_Target.PostgreSQL.Babelfish). Refer to the [Amazon\
...
caused by insufficient memory. For more information, see [Improved memory management in Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.BestPractices.memory.management).
...
For more information, see [Managing large objects with the lo module](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/PostgreSQL_large_objects_lo_extension.html).

- Added support for zero-downtime patching (ZDP) for minor version
upgrades and patches. For more information, see [Minor release upgrades and zero-downtime patching](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_UpgradeDBInstance.PostgreSQL.html#USER_UpgradeDBInstance.PostgreSQL.Minor) in the
...
cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/PostgreSQL-Lambda.html) in the _Amazon Aurora User Guide_.
...
**error code: 248`**. For more information, see [aws\_s3.table\_import\_from\_s3](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_PostgreSQL.S3Import.html#aws_s3.table_import_from_s3) in the _Amazon Aurora_
_User Guide_.
...
global database for Aurora PostgreSQL. For more information, see [Managing RPOs for Aurora PostgreSQL–based global databases](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-global-database-disaster-recovery.html#aurora-global-database-manage-recovery) in
...
1. Support for exporting data to Amazon S3. For more information, see [Exporting data from an Aurora PostgreSQL DB cluster to Amazon S3](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/postgresql-s3-export.html) in
    the _Amazon Aurora User Guide_.

2. Support for Amazon Aurora Machine Learning. For more information, see
    [Using\
    machine learning (ML) with Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/postgresql-ml.html) in the
    _Amazon Aurora User Guide_.
...
see [Using machine learning (ML) with Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/postgresql-ml.html) in
the _Amazon Aurora User Guide_.

- The new `aws_s3` extension. For more information,
see [Exporting data from an Aurora PostgreSQL DB cluster to\
Amazon S3](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/postgresql-s3-export.html) in the _Amazon Aurora User_
_Guide_.
...
supported. To upgrade, see [Upgrading the PostgreSQL DB engine for Aurora PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_UpgradeDBInstance.PostgreSQL.html#USER_UpgradeDBInstance.Upgrading.ExtensionUpgrades) in the
_Amazon Aurora User Guide_.
...
7. An upgrade of the `apg_plan_mgmt` extension to version 1.0.1.
    For details, see [Version 1.0.1 of the Aurora PostgreSQL apg\_plan\_mgmt extension](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/auroraqpm.updates.html#auroraqpm-version.101).
