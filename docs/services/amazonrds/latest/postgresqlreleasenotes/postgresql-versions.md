...
the [`describe-db-engine-versions`](../../../cli/latest/reference/rds/describe-db-engine-versions.md) AWS CLI command. For example, to display
...
improvements for PostgreSQL announced in the [PostgreSQL 18.4 release](https://www.postgresql.org/docs/release/18.4).
...
improvements for PostgreSQL announced in the [PostgreSQL 17.10 release](https://www.postgresql.org/docs/release/17.10).
...
information, see [Identify and resolve aggressive vacuum blockers in RDS for PostgreSQL](../userguide/appendix-postgresql-commondbatasks-autovacuum-monitoring.md)
...
information, see [Managing logical slot synchronization for RDS for PostgreSQL](../userguide/appendix-postgresql-commondbatasks-pglogical-slot-synchronization.md).
...
improvements for PostgreSQL announced in the [PostgreSQL 16.14 release](https://www.postgresql.org/docs/release/16.14).
...
- [Delegated extension role](../userguide/rds-delegated-ext.md) was added.
...
improvements for PostgreSQL announced in the [PostgreSQL 15.18 release](https://www.postgresql.org/docs/release/15.18).
...
improvements for PostgreSQL announced in the [PostgreSQL 14.23 release](https://www.postgresql.org/docs/release/14.23).
...
- The [PostGIS](../userguide/appendix-postgresql-commondbatasks-postgis.md) extension is updated to 3.1.7
...
- The [PostGIS](../userguide/appendix-postgresql-commondbatasks-postgis.md) extension is updated to version 3.1.4, along with the following
related extensions:
...
- The [pg\_cron](../userguide/postgresql-pg-cron.md)
extension is updated to version 1.3.1.

- The [pg\_partman](../userguide/postgresql-partitions.md)
extension is updated to version 4.5.1.

- The [PostGIS](../userguide/appendix-postgresql-commondbatasks-postgis.md) extension is updated to version 3.0.3, along with the following
related extensions:
...
- The [PostGIS](../userguide/appendix-postgresql-commondbatasks-postgis.md) extension is updated to version 3.0.2.
...
partitions with the pg\_partman extension](../userguide/postgresql-partitions.md) in the _Amazon RDS User_
_Guide_.

- Added the `pg_cron` extension version 1.3.0. For more information, see
[Scheduling maintenance\
with the PostgreSQL pg\_cron extension](../userguide/postgresql-pg-cron.md) in the
_Amazon RDS User Guide_.
...
- The [aws\_commons](../userguide/user-postgresql-s3import-reference.md#USER_PostgreSQL.S3Import.create_s3_uri) extension is updated to 1.2.
...
- The [PostGIS](../userguide/appendix-postgresql-commondbatasks-postgis.md) extension is updated to version 3.1.4, along with the
...
- Support for Amazon S3 import. For more information, see [Importing Amazon S3 data into an RDS for PostgreSQL DB instance](../userguide/user-postgresql-s3import.md) in the
_Amazon RDS User Guide_.
...
extension. See [Managing spatial data with the PostGIS extension](../userguide/appendix-postgresql-commondbatasks-postgis.md) in the
_Amazon RDS User Guide_.
...
- The [PostGIS](../userguide/appendix-postgresql-commondbatasks-postgis.md) extension is updated to version 2.5.5, along with the
following related extensions:
...
- Update of the `GDAL` library, which is used by the PostGIS
extension. See [Working with the PostGIS extension](../userguide/appendix-postgresql-commondbatasks-postgis.md) in the
_Amazon RDS User Guide_.
