...
support](../userguide/extended-support.md) and [Amazon RDS\
...
about support dates for major engine versions by using the AWS CLI or the RDS API. For more information, see [Viewing support dates for engine versions in Amazon RDS Extended Support](../userguide/extended-support-viewing-support-dates.md).

PostgreSQL major versionCommunity release dateRDS release dateCommunity end of life dateRDS end of standard support dateRDS start of Extended Support year 1 pricingRDS start of Extended Support year 3 pricingRDS end of Extended Support date
...
[Using Amazon RDS Extended Support](../userguide/extended-support.md).
...
information about these minor versions, see [Amazon RDS Extended Support updates](postgresql-extendedsupport.md). For more information about Amazon RDS Extended Support,
see [Using Amazon RDS Extended Support](../userguide/extended-support.md).
