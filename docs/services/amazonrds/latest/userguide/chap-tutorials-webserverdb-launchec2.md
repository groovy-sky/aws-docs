---
title: "Launch an EC2 instance to connect with your DB instance"
---
...
window or tab, you can use the service at [https://checkip.amazonaws.com](https://checkip.amazonaws.com/).
...
![Configure Instance Details](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Tutorial_WebServer_14.png)
...
9. Complete [Create an Amazon RDS DB instance](chap-tutorials-webserverdb-createdbinstance.md).
