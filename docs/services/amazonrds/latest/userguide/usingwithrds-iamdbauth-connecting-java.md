...
Amazon RDS
that is specific to an AWS Region. (For more information, see [Using SSL/TLS to encrypt a connection to a DB instance or cluster](usingwithrds-ssl.md).) At runtime, the class loader
...
AWS Region, see [Using SSL/TLS to encrypt a connection to a DB instance or cluster](usingwithrds-ssl.md).
