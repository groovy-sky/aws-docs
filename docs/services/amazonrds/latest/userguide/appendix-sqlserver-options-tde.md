...
- [Encrypting data on RDS for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/TDE.Encrypting.html)

- [Backing up and restoring TDE certificates on RDS for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/TDE.BackupRestoreRDS.html)

- [Backing up and restoring TDE certificates for on-premises databases](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/TDE.BackupRestoreOnPrem.html)

- [Turning off TDE for RDS for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/TDE.Disabling.html)
...
1. Determine whether your DB instance is already associated with an option group
    ...
    associated with, use the RDS console, the [describe-db-instance](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-instances.html) AWS CLI command, or the API operation [DescribeDBInstances](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeDBInstances.html).
...
For information about creating or modifying an option group, see [Working with option groups](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithOptionGroups.html). For information about adding an option to an option group, see [Adding an option to an option group](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithOptionGroups.html#USER_WorkingWithOptionGroups.AddOption).
...
persistent options in an option group, see [Option groups overview](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithOptionGroups.html#Overview.OptionGroups).
...
option. For more information about this scenario, see [Considerations for option groups](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_CopySnapshot.html#USER_CopySnapshot.Options).
