...
![Consolidated Performance Insights and CloudWatch metrics dashboard.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Monitoring_UnifiedDashboard.png)
