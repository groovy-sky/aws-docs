...
07. (Optional) In **Additional configuration**, make the
    ...
    1. For **Option group**, choose a new option
        group. For more information, see [Working with option groups in RDS Custom for Oracle](custom-oracle-option-groups.md).
08. Choose **Continue**.
...
To modify the storage for an RDS Custom for Oracle DB instance, use the [modify-db-instance](../../../cli/latest/reference/rds/modify-db-instance.md)
