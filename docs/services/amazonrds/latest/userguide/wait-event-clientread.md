...
For information about DB instance classes, see [DB instance classes](concepts-dbinstanceclass.md). To determine the DB instance class that is equivalent to an Amazon EC2
