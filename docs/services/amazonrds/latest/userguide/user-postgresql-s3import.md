...
- [Installing the aws\_s3 extension](user-postgresql-s3import-installextension.md)

- [Overview of importing data from Amazon S3 data](user-postgresql-s3import-overview.md)

- [Setting up access to an Amazon S3 bucket](user-postgresql-s3import-accesspermission.md)

- [Importing data from Amazon S3 to your RDS for PostgreSQL DB instance](user-postgresql-s3import-fileformats.md)

- [Function reference](user-postgresql-s3import-reference.md)
