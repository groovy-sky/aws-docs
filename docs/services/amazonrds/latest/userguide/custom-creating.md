...
- [Connecting to your RDS Custom DB instance using Session Manager](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-creating.ssm.html)

- [Connecting to your RDS Custom DB instance using SSH](#custom-creating.ssh)

- [Logging in to your RDS Custom for Oracle database as SYS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-creating.sysdba.html)
...
`rdsdb`. For more information, see [Step 5: Prepare the CEV manifest](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-cev.preparing.html#custom-cev.preparing.manifest).
...
08. Choose a **DB instance class**.
    ...
    For supported classes, see [DB instance class support for RDS Custom for Oracle](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-oracle-feature-support.html#custom-reqs-limits.instances).
...
12. For **Database options**, do the following:
    ...
    3. For **Option group**, choose an option group or
       ...
       `Timezone`. For more information, see [Oracle time zone](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-managing.timezone.html).
...
You create an RDS Custom DB instance by using the [create-db-instance](https://docs.aws.amazon.com/cli/latest/reference/rds/create-db-instance.html) AWS CLI
command.
...
classes, see [DB instance class support for RDS Custom for Oracle](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-oracle-feature-support.html#custom-reqs-limits.instances))
...
custom engine version that you specified in [Creating a CEV](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-cev.create.html))
...
can't contain pluggable databases (PDBs). For more information, see [Database architecture for Amazon RDS Custom for Oracle](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-oracle.db-architecture.html).
...
created (if they don't already exist) and used. For more information, see [Using service-linked roles for Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.IAM.ServiceLinkedRoles.html).
...
to it using an ssh client. For more information, see [Connecting to your Linux instance using SSH](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AccessingInstancesLinux.html).
