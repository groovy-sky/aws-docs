...
information, see [Enabling automated backups](user-workingwithautomatedbackups-enabling.md).
...
Enable backup replication by using the [`start-db-instance-automated-backups-replication`](../../../cli/latest/reference/rds/start-db-instance-automated-backups-replication.md) AWS CLI
command.
...
aws rds start-db-instance-automated-backups-replication \
  ...
  --kms-key-id "arn:aws:kms:us-east-1:123456789012:key/AWS_ACCESS_KEY_ID_REDACTED" \
...
`pre-signed-url` option, see [start-db-instance-automated-backups-replication](../../../cli/latest/reference/rds/start-db-instance-automated-backups-replication.md) in the _AWS CLI Command Reference_.

Enable backup replication by using the [`StartDBInstanceAutomatedBackupsReplication`](../../../../reference/amazonrds/latest/apireference/api-startdbinstanceautomatedbackupsreplication.md) RDS API
...
Signature Version 4)](../../../s3/latest/api/sigv4-query-string-auth.md) in the _Amazon Simple Storage Service API Reference_ and [Signature Version 4 signing process](../../../../general/latest/gr/signature-version-4.md) in the _AWS_
_General Reference_.
