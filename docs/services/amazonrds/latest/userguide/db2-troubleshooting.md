...
for an RDS for Db2 database, see [rdsadmin.update\_db\_param](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-update-db-param).
...
1. Create a VPC. For more information see [Create a VPC](https://docs.aws.amazon.com/vpc/latest/userguide/create-vpc.html) in the
...
2. Create an Amazon S3 gateway endpoint for private subnets to use. For more
    ...
    endpoints](https://docs.aws.amazon.com/vpc/latest/privatelink/gateway-endpoints.html) in the
...
To confirm an Amazon S3 gateway endpoint, run the [describe-vpc-endpoints](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html) command. In the
...
The following errors can occur when you call the [rdsadmin.activate\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-activate-database) stored procedure.
...
The following errors can occur when you call the [rdsadmin.alter\_tablespace](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-tablespaces.html#db2-sp-alter-tablespace) stored procedure.
...
information, see [rdsadmin.alter\_tablespace](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-tablespaces.html#db2-sp-alter-tablespace) and [rdsadmin.get\_task\_status](db2-user-defined-functions.md#db2-udf-get-task-status).
...
see [rdsadmin.alter\_tablespace](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-tablespaces.html#db2-sp-alter-tablespace).
...
The following errors can occur when you call the [rdsadmin.backup\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-backup-database) stored procedure.
...
if configured. For more information, see [Increasing DB instance storage capacity](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PIOPS.ModifyingExisting.html).

Increase your disk space and then call the [rdsadmin.backup\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-backup-database) stored procedure again. To confirm that
...
The following error can occur when you call the [rdsadmin.create\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-create-database) stored procedure.
...
The following error can occur when you call the [rdsadmin.deactivate\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-deactivate-database) stored procedure.
...
The following errors can occur when you call the [rdsadmin.drop\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-drop-database) stored procedure.
...
by calling the [rdsadmin.create\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-create-database) stored procedure.
...
The following error can occur when you call the [rdsadmin.reactivate\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-reactivate-database) stored procedure.
...
The following errors can occur when you call the [rdsadmin.restore\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-restore-database) stored procedure:
...
The following error can occur when you call the [rdsadmin.update\_db\_param](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-update-db-param) stored procedure.
...
more information, see [Viewing parameter values for a DB parameter group in Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithParamGroups.Viewing.html).
