...
To create a DB cluster parameter group, use the AWS CLI [`create-db-cluster-parameter-group`](../../../cli/latest/reference/rds/create-db-cluster-parameter-group.md) command.
