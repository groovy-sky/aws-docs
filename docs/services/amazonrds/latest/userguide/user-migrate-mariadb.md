...
To learn about option groups, see [Working with option groups](user-workingwithoptiongroups.md).
...
[`restore-db-instance-from-db-snapshot`](../../../cli/latest/reference/rds/restore-db-instance-from-db-snapshot.md) command with
...
password using the AWS Management Console, the [`modify-db-instance`](../../../cli/latest/reference/rds/modify-db-instance.md) AWS CLI command, or the [ModifyDBInstance](../../../../reference/amazonrds/latest/apireference/api-modifydbinstance.md) RDS
