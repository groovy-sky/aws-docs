...
required for RDS Custom automation. For more information, see [Tagging RDS Custom for SQL Server resources](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-managing-sqlserver.tagging.html).
...
- [RDS Custom service-linked role](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-creating-sqlserver.slr.html)

- [Connecting to your RDS Custom DB instance using AWS Systems Manager](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-creating-sqlserver.ssm.html)

- [Connecting to your RDS Custom DB instance using RDP](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-creating-sqlserver.rdp.html)
...
17. Choose **Create database**.
    ...
    **details**.
    ...
    instance, see [Managing an Amazon RDS Custom for SQL Server DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-managing-sqlserver.html).
