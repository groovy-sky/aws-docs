...
![Image of a file object in an Amazon S3 bucket.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/aws_s3_import-export_s3_bucket-info.png)
...
6. Invoke the `aws_s3.table_import_from_s3`
    ...
    For examples, see [Importing data from Amazon S3 to your RDS for PostgreSQL DB instance](user-postgresql-s3import-fileformats.md).
