...
You can create a Multi-AZ DB cluster snapshot by using the AWS CLI [create-db-cluster-snapshot](../../../cli/latest/reference/rds/create-db-cluster-snapshot.md) command with the following options:
...
[CreateDBClusterSnapshot](../../../../reference/amazonrds/latest/apireference/api-createdbclustersnapshot.md) operation with the following
parameters:
...
instructions, see [Deleting a DB snapshot for Amazon RDS](user-deletesnapshot.md).
