...
additional storage volumes present in the OS. To view OS metrics in CloudWatch Logs, see [Viewing OS metrics using CloudWatch Logs](user-monitoring-os-cloudwatchlogs.md).
