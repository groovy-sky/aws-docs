...
[Troubleshooting DB issues for Amazon RDS Custom for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-troubleshooting-sqlserver.html).
...
AWS based on the source IP](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_examples_aws_deny-ip.html) in the _AWS Identity and Access Management User Guide_. Also make sure that the
...
information about RDS Custom for SQL Server, see [Fixing unsupported configurations in RDS Custom for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-troubleshooting-sqlserver.html#custom-troubleshooting-sqlserver.fix-unsupported).
...
2. Pause RDS Custom automation. For more information, see [Pausing and resuming your RDS Custom DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-managing.customizing-env.html#custom-managing.pausing).
...
promote it automatically. For more information, see [Promoting an RDS Custom for Oracle replica to a standalone DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-rr.promoting.html).
