...
For more information about these options, see [Oracle time zone](appendix-oracle-options-timezone.md) and [Oracle Label Security](oracle-options-ols.md).
...
- [Sharing public snapshots for Amazon RDS](user-sharesnapshot-public.md)
...
For more information, see [Sharing public snapshots for Amazon RDS](user-sharesnapshot-public.md).
...
information on how to work around this issue, see [Sharing encrypted snapshots for Amazon RDS](share-encrypted-snapshot.md).
...
[`describe-db-snapshot-attributes`](../../../cli/latest/reference/rds/describe-db-snapshot-attributes.md)
AWS CLI command.

You can also share a manual DB snapshot with other AWS accounts by
using the Amazon RDS API. To do so, call the
[`ModifyDBSnapshotAttribute`](../../../../reference/amazonrds/latest/apireference/api-modifydbsnapshotattribute.md)
...
[`DescribeDBSnapshotAttributes`](../../../../reference/amazonrds/latest/apireference/api-describedbsnapshotattributes.md)
API operation.
