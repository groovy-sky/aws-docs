...
- [Limitations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.html#Appendix.SQLServer.Options.MSDTC.Limitations)

- [Enabling MSDTC](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Enabling.html)

  - [Creating the option group for MSDTC](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Enabling.html#Appendix.SQLServer.Options.MSDTC.OptionGroup)

  - [Adding the MSDTC option to the option group](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Enabling.html#Appendix.SQLServer.Options.MSDTC.Add)

  - [Creating the parameter group for MSDTC](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Enabling.html#MSDTC.CreateParamGroup)

  - [Modifying the parameter for MSDTC](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Enabling.html#ModifyParam.MSDTC)

  - [Associating the option group and parameter group with the DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Enabling.html#MSDTC.Apply)

  - [Modifying the MSDTC option](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Enabling.html#Appendix.SQLServer.Options.MSDTC.Modify)
- [Using transactions](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.html#Appendix.SQLServer.Options.MSDTC.Using)

  - [Using distributed transactions](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.html#Appendix.SQLServer.Options.MSDTC.UsingXA)

  - [Using XA transactions](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.html#MSDTC.XA)

  - [Using transaction tracing](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.html#MSDTC.Tracing)
- [Disabling MSDTC](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Disable.html)

- [Troubleshooting MSDTC for RDS for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Troubleshooting.html)
...
- The `in-doubt xact resolution` parameter must be set to 1 or 2. For more information, see [Modifying the parameter for MSDTC](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.MSDTC.Enabling.html#ModifyParam.MSDTC).
