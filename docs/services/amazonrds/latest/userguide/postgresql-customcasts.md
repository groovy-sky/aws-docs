---
title: "Managing custom casts in RDS for PostgreSQL"
---
...
Starting with RDS for PostgreSQL versions 13.23, 14.20, 15.15, 16.11, 17.7, and 18.1, you can use the rds\_casts extension to install additional casts for built-in types, while still being able to create your own casts for custom types.
