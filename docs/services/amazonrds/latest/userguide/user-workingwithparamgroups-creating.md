...
To create a DB parameter group, use the AWS CLI [`create-db-parameter-group`](https://docs.aws.amazon.com/cli/latest/reference/rds/create-db-parameter-group.html) command. The following
