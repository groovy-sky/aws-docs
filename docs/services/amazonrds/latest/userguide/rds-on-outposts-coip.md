...
[Customer-owned IP\
addresses](../../../outposts/latest/userguide/routing.md#ip-addressing) in the _AWS Outposts User Guide_.
...
DB instance status, see [Viewing Amazon RDSDB instance status](accessing-monitoring.md#Overview.DBInstance.Status).
...
information about setting up security groups, see [Provide access to your DB instance in your VPC by creating a security group](chap-settingup.md#CHAP_SettingUp.SecurityGroup).
...
with shared AWS Outposts resources](../../../outposts/latest/userguide/sharing-outposts.md) in the _AWS Outposts User Guide_.
