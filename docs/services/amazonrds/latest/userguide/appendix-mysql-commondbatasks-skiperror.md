...
shown following. For more information, see [Connecting to your MySQL DB instance](user-connecttoinstance.md).
...
`mysql.rds_skip_repl_error`, see [mysql.rds\_skip\_repl\_error](mysql-stored-proc-replicating.md#mysql_rds_skip_repl_error).
...
in [mysql.rds\_skip\_repl\_error](mysql-stored-proc-replicating.md#mysql_rds_skip_repl_error).
