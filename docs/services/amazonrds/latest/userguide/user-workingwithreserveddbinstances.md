...
- [Purchasing reserved DB instances for Amazon RDS](user-workingwithreserveddbinstances-workingwith.md)
...
Aurora, see
[Reserved DB instances for Aurora](../aurorauserguide/user-workingwithreserveddbinstances.md).
