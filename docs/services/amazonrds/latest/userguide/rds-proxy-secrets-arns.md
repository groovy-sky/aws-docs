...
secret for each database user account that the proxy connects to on the RDS DB instance.
...
For information about adding a new IAM DB user, see [Creating a database account using IAM authentication](usingwithrds-iamdbauth-dbaccounts.md).
...
- To create a Secrets Manager secret for use with RDS Proxy, use the [create-secret](../../../cli/latest/reference/secretsmanager/create-secret.md)
command:
...
To see the secrets owned by your AWS account, use the [list-secrets](../../../cli/latest/reference/secretsmanager/list-secrets.md)
command:
...
use the [get-secret-value](../../../cli/latest/reference/secretsmanager/get-secret-value.md) command. Replace
