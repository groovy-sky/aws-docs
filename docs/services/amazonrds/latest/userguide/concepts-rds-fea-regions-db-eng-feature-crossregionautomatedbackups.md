---
title: "Supported Regions and DB engines for cross-Region automated backups in Amazon RDS"
---
...
logs when they're ready. For more information, see [Replicating automated backups to another AWS Region](user-replicatebackups.md).

For information about AWS Regions where backup replication is available,
see [Replicating automated backups to another AWS Region](user-replicatebackups.md).
