...
- [Accessing more SQL text in the Performance Insights dashboard](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.UsingDashboard.SQLTextSize.html)

- [Viewing SQL statistics in the Performance Insights dashboard](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.UsingDashboard.AnalyzeDBLoad.AdditionalMetrics.AnalyzingSQLLevel.html)
...
![SQL text](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/sql-text-oracle.png)

To learn how to see more than the default 500 bytes of SQL text, see [Accessing more SQL text in the Performance Insights dashboard](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.UsingDashboard.SQLTextSize.html).
...
![Selected SQL digest](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/perf_insights_4b.png)
...
![Top SQL](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/perf_insights_4.png)
...
engines, see [SQL statistics for Performance Insights](sql-statistics.md).
...
[Average active sessions](user-perfinsights-overview-activesessions.md#USER_PerfInsights.Overview.ActiveSessions.AAS).
...
![DB load by waits](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/perf_insights_6.png)
...
![Top SQL table with literal query selected](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/perf-insights-sql-ids-open.png)
...
![Statistics preferences](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/perf-insights-sql-ids-preferences-icon.png)
...
![Preferences window](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/perf-insights-sql-ids-preferences.png)
...
see the engine specific SQL statistics section in [SQL statistics for Performance Insights](sql-statistics.md)
