...
3. Choose **Test connection**.
      ...
      information, see [Considerations for security groups with Amazon RDS for Db2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-security-groups-considerations.html).
