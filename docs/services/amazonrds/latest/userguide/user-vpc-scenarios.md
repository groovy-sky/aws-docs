...
VPC](#USER_VPC.Scenario1)

- [An EC2 instance in a different\
VPC](#USER_VPC.Scenario3)

- [A client application through the\
internet](#USER_VPC.Scenario4)
...
![VPC scenario with a public web server and a private database.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/con-VPC-sec-grp.png)
...
subnets for this scenario, see [Tutorial: Create a VPC for use with a DB instance (IPv4 only)](chap-tutorials-webserverdb-createvpc.md).
...
![Adding a security group to another security group's rules.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/con-vpc-add-sg-rule.png)

For more information about connecting to the DB instance from your EC2
instance, see [Connecting to an Amazon RDS DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_CommonTasks.Connect.html)
.
...
![A DB instance in a VPC accessed by an Amazon EC2 instance in a different VPC.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/RDSVPC2EC2VPC.png)
...
see [VPC peering](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-peering.html) in the
...
![A DB instance in a VPC accessed by a client application through the internet.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/GS-VPC-network.png)
...
[Creating a DB instance in a VPC](user-vpc-workingwithrdsinstanceinavpc.md#USER_VPC.InstanceInVPC).
...
is Direct Connect?](https://docs.aws.amazon.com/directconnect/latest/UserGuide/Welcome.html)
...
![DB instances in a VPC accessed by a private network.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/site-to-site-vpn-connection.png)

For more information, see [Internetwork traffic privacy](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/inter-network-traffic-privacy.html).
