...
instance, see [Connecting to an Amazon RDS DB instance](chap-commontasks-connect.md)
.
...
see [VPC peering](../../../vpc/latest/userguide/vpc-peering.md) in the
...
is Direct Connect?](../../../directconnect/latest/userguide/welcome.md)

- An AWS Client VPN connection. For more information, see [What is\
AWS Client VPN?](../../../vpn/latest/clientvpn-admin/what-is.md)
