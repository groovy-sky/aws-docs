...
editions and edition-based redefinition](https://docs.oracle.com/en/database/oracle/oracle-database/19/admin/getting-started-with-database-administration.html) in the Oracle
documentation.
