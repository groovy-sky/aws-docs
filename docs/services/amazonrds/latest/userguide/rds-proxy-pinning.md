...
same values for those settings. For details about what RDS Proxy tracks for a database engine, see the following:
...
RDS Proxy tracks the following MariaDB and MySQL
statements:
...
filters property. For more information, see [Creating a proxy for Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-proxy-creating.html) and [Modifying an RDS Proxy](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-proxy-modifying-proxy.html).
