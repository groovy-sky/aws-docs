...
To create a DB instance read replica from a Multi-AZ DB cluster, use the AWS CLI command [`create-db-instance-read-replica`](../../../cli/latest/reference/rds/create-db-instance-read-replica.md). For
