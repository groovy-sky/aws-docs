...
using the AWS CLI [copy-db-cluster-parameter-group](../../../cli/latest/reference/rds/copy-db-cluster-parameter-group.md) command or the RDS API
[CopyDBClusterParameterGroup](../../../../reference/amazonrds/latest/apireference/api-copydbparametergroup.md) operation.
...
To copy a DB cluster parameter group, use the AWS CLI [`copy-db-cluster-parameter-group`](../../../cli/latest/reference/rds/copy-db-cluster-parameter-group.md) command with the following required parameters:
...
To copy a DB cluster parameter group, use the RDS API [`CopyDBClusterParameterGroup`](../../../../reference/amazonrds/latest/apireference/api-copydbclusterparametergroup.md)
