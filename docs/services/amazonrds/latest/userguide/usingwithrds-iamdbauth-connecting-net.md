---
title: "Connecting to your DB instance using IAM authentication and the AWS SDK for .NET"
---
...
To run this code example, you need the [AWS SDK for .NET](http://aws.amazon.com/sdk-for-net),
...
the DB instance endpoint against the endpoint in the
SSL certificate.
