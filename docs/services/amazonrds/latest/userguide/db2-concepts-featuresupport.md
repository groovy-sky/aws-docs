...
Amazon RDS stored procedures for [Stored procedures for granting and revoking privileges for RDS for Db2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-granting-revoking-privileges.html).

- Creation of roles with the Amazon RDS [rdsadmin.create\_role](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-granting-revoking-privileges.html#db2-sp-create-role) stored procedure.
