...
creating a replica in the same AWS Region. You can use the AWS Management Console, run the [`create-db-instance-read-replica`](https://docs.aws.amazon.com/cli/latest/reference/rds/create-db-instance-read-replica.html) command, or call the [`CreateDBInstanceReadReplica`](../../../../reference/amazonrds/latest/apireference/api-createdbinstancereadreplica.md) API operation.
...
- [Region and version availability](#USER_ReadRepl.XRgn.RegionVersionAvailability)

- [Creating a cross-Region read replica](#ReadRepl.XRgn)

- [How Amazon RDS does cross-Region replication](#USER_ReadRepl.XRgn.Process)

- [Cross-Region replication considerations](#USER_ReadRepl.XRgn.Cnsdr)

- [Cross-Region replication costs](#USER_ReadRepl.XRgn.Costs)
...
availability with cross-Region replication, see [Supported Regions and DB engines for cross-Region read replicas in Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RDS_Fea_Regions_DB-eng.Feature.CrossRegionReadReplicas.html).
...
03. Choose the Db2, MariaDB, Microsoft SQL Server, MySQL, Oracle, or
...
06. Choose the **Destination Region**.

07. Choose the instance specifications that you want to use. We recommend
     that you use the same or larger DB instance class and storage type for the
     read replica.

08. To create an encrypted read replica in another AWS Region:
...
09. Choose other options, such as storage autoscaling.
...
[`create-db-instance-read-replica`](https://docs.aws.amazon.com/cli/latest/reference/rds/create-db-instance-read-replica.html) command. In this
case, you use [`create-db-instance-read-replica`](https://docs.aws.amazon.com/cli/latest/reference/rds/create-db-instance-read-replica.html) from the
...
For information about ARNs, see [Amazon Resource Names (ARNs) in Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Tagging.ARN.html).

To create a read replica in a different AWS Region from the source DB instance,
you can use the AWS CLI [`create-db-instance-read-replica`](https://docs.aws.amazon.com/cli/latest/reference/rds/create-db-instance-read-replica.html) command from the
...
option, see [create-db-instance-read-replica](https://docs.aws.amazon.com/cli/latest/reference/rds/create-db-instance-read-replica.html) in the _AWS CLI Command Reference_.
...
the Amazon RDS API operation [CreateDBInstanceReadReplica](../../../../reference/amazonrds/latest/apireference/api-createdbinstancereadreplica.md). In this case, you call [CreateDBInstanceReadReplica](../../../../reference/amazonrds/latest/apireference/api-createdbinstancereadreplica.md) from the AWS Region where you want
...
source DB instance, you can use the Amazon RDS API [`CreateDBInstanceReadReplica`](../../../../reference/amazonrds/latest/apireference/api-createdbinstancereadreplica.md) operation from the
...
`PreSignedURL` should contain a request for the [`CreateDBInstanceReadReplica`](../../../../reference/amazonrds/latest/apireference/api-createdbinstancereadreplica.md) operation to call in
the source AWS Region where the read replica is created in. To learn more
about `PreSignedUrl`, see [`CreateDBInstanceReadReplica`](../../../../reference/amazonrds/latest/apireference/api-createdbinstancereadreplica.md).
...
For information about replication lag time, see [Monitoring read replication](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.Monitoring.html).
...
- You can have up to 20 concurrent create cross-Region read replica requests in progress to a single destination AWS Region per account.
You must wait for these requests to complete before submitting additional create cross-Region read replica requests to the same destination AWS Region.
...
information, see [IBM IDs for bring your own license (BYOL) for Db2](db2-licensing.md#db2-prereqs-ibm-info).
...
AWS CLI command [create-db-instance-read-replica](https://docs.aws.amazon.com/cli/latest/reference/rds/create-db-instance-read-replica.html). You can't specify a custom
...
and permissions in IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html) in the
_IAM User Guide_.
...
roles](https://docs.aws.amazon.com/IAM/latest/UserGuide/using-service-linked-roles.html) in the _IAM User Guide_.
...
AWS Region](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html) in the _IAM User Guide_.
