...
idle in transaction connections, see [Database has long running idle in transaction connection](#proactive-insights.idle-txn)
...
[Analyzing performance anomalies with Amazon DevOps Guru for Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/devops-guru-for-rds.html).
...
[the PostgreSQL documentation](https://www.postgresql.org/docs/current/runtime-config-client.html).
...
![In pgadmin, choose AUTOCOMMIT to turn it on.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/apg-insight-pgadmin-autocommit.png)
