...
automate by using [CloudFormation](../../../cloudformation/latest/userguide/aws-resource-rds-dbinstance.md#aws-resource-rds-dbinstance-return-values:~:text=EngineLifecycleSupport) or other services, this default behavior maintains the availability of
...
[restore-db-cluster-from-s3](../../../cli/latest/reference/rds/restore-db-cluster-from-s3.md) AWS CLI command or the
...
For more information, see [MySQL versions](mysql-concepts-versionmgmt.md) and [Release calendars for Amazon RDS for PostgreSQL](../postgresqlreleasenotes/postgresql-release-calendar.md).
...
When you run the [restore-db-instance-from-db-snapshot](../../../cli/latest/reference/rds/restore-db-instance-from-db-snapshot.md) or [restore-db-cluster-from-snapshot](../../../cli/latest/reference/rds/restore-db-cluster-from-snapshot.md) AWS CLI command, select
...
When you use the
[RestoreDBInstanceFromDBSnapshot](../../../../reference/amazonrds/latest/apireference/api-restoredbinstancefromdbsnapshot.md) or [RestoreDBClusterFromSnapshot](../../../../reference/amazonrds/latest/apireference/api-restoredbclusterfromsnapshot.md) Amazon RDS API operation,
...
follow the instructions for your DB engine in [Restoring to a DB instance](user-restorefromsnapshot.md).
