...
- [Requiring SSL/TLS for specific user accounts to a MariaDB DB instance on Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MariaDB-ssl-connections.require-ssl-users.html)
