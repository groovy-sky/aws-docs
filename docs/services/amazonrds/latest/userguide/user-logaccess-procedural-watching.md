...
![Choose the Logs & events tab](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Monitoring_logsEvents.png)

5. In the **Logs** section, choose a log file, and then choose
    **Watch**.

![Choose a log](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Monitoring_LogsEvents_watch.png)

RDS shows the tail of the log, as in the following MySQL example.

![Tail of a log file](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Monitoring_LogsEvents_watch_content.png)
