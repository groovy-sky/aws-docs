...
information about the requirements, see [Overview of automatic connectivity with a Lambda function](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/lambda-rds-connect.html#lambda-rds-connect-overview).
   ...
   - If you don't have a proxy, and you want Amazon RDS to automatically create one for you, choose
     ...
     2. Choose **Secrets Manager secret**. Then, for **Select**
        **secret**, choose an AWS Secrets Manager secret. If you don't have a Secrets Manager secret, choose
         **Create new Secrets Manager secret** to [create a new secret](https://docs.aws.amazon.com/secretsmanager/latest/userguide/create_secret.html). After you
