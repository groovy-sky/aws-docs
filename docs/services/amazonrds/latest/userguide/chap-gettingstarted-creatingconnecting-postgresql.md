...
![EC2 instance and PostgreSQL DB instance.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/getting-started-postgresql.png)

This tutorial allows you to create your resources by using one of the following methods:

1. Use the AWS Management Console ‐
    [Create an EC2 instance](#CHAP_GettingStarted.Creating.RDSPostgreSQL.EC2) and
    [Create a PostgreSQL DB instance](#CHAP_GettingStarted.Creating.PostgreSQL)

2. Use CloudFormation to create the database instance and EC2 instance ‐
    [(Optional) Create VPC, EC2 instance, and PostgreSQL instance using CloudFormation](#CHAP_GettingStarted.CFN.PostgreSQL)
...
- [Create an EC2 instance](#CHAP_GettingStarted.Creating.RDSPostgreSQL.EC2)

- [Create a PostgreSQL DB instance](#CHAP_GettingStarted.Creating.PostgreSQL)

- [(Optional) Create VPC, EC2 instance, and PostgreSQL instance using CloudFormation](#CHAP_GettingStarted.CFN.PostgreSQL)

- [Connect to a PostgreSQL DB instance](#CHAP_GettingStarted.Connecting.PostgreSQL)

- [Delete the EC2 instance and DB instance](#CHAP_GettingStarted.Deleting.PostgreSQL)

- [(Optional) Delete the EC2 instance and DB instance created with CloudFormation](#CHAP_GettingStarted.DeletingCFN.PostgreSQL)

- [(Optional) Connect your DB instance to a Lambda function](#CHAP_GettingStarted.ComputeConnect.PostreSQL)
...
08. For **Master username**, enter a name for the master user, or keep
    ...
    ![Create database page.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/easy-create-postgresql.png)
...
11. Open **View default settings for Easy create**.
    ...
    ![Easy create default settings for RDS for PostgreSQL.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/easy-create-view-default-postgres.png)
...
13. In the **Databases** list, choose the name of the new PostgreSQL DB
     instance to show its details.

    The DB instance has a status of **Creating** until it is ready to use.

    ![DB instance details.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Postgres-Launch06.png)
...
stack on the CloudFormation console](../../../cloudformation/latest/userguide/cfn-console-create-stack.md) and [Working with\
nested stacks](../../../cloudformation/latest/userguide/using-cfn-nested-stacks.md).
...
key pairs and Linux instances](../../../ec2/latest/userguide/ec2-key-pairs.md).
...
01. Set **Stack name** to
     **PostgreSQLTestStack**.

02. Under **Parameters**, set **Availability**
    **Zones** by selecting three availability zones.

03. Under **Linux Bastion Host configuration**, for
...
04. In **Linux Bastion Host configuration** settings,
     ...
     determine your public IP address using the service at [https://checkip.amazonaws.com](https://checkip.amazonaws.com/). An example of an IP
...
05. Under **Database General configuration**, set
     **Database instance class** to
     **db.t3.micro**.

06. Set **Database name** to
     `database-test1`.

07. For **Database master username**, enter a name
     for the master user.

08. Set **Manage DB master user password with Secrets Manager**
     to `false` for this tutorial.

09. For **Database password**, set a password of your
     choice. Remember this password for further steps in the
     tutorial.

10. Under **Database Storage configuration**, set
     **Database storage type** to
     **gp2**.

11. Under **Database Monitoring configuration**, set
     **Enable RDS Performance Insights** to false.

12. Leave all other settings as the default values. Click
     **Next** to continue.
...
stack data and resources on the AWS Management Console](../../../cloudformation/latest/userguide/cfn-console-view-stack-data-resources.md).
...
5. On the **Connectivity & security** tab, copy
      ...
      ![Connect to a PostgreSQL DB instance.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/PostgreSQL-endpoint.png)
2. Connect to the EC2 instance that you created earlier by following the
    steps in [Connect to your\
    Linux instance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AccessingInstances.html) in the
...
For more information on connecting to a PostgreSQL DB instance, see [Connecting to a DB instance running the PostgreSQL database engine](user-connecttopostgresqlinstance.md). If you can't
    connect to your DB instance, see [Troubleshooting connections to your RDS for PostgreSQL instance](user-connecttopostgresqlinstance-troubleshooting.md).
...
For security, it is a best practice to use encrypted connections. Only use
    ...
    connections, see [Connecting to a PostgreSQL DB instance over SSL](postgresql-concepts-general-ssl.md#PostgreSQL.Concepts.General.SSL.Connecting).
...
For more information about deleting an EC2 instance, see [Terminate your instance](../../../ec2/latest/userguide/terminating-instances.md) in the
_Amazon EC2 User Guide_.
...
a stack on the CloudFormation console](../../../cloudformation/latest/userguide/cfn-console-delete-stack.md) in the
...
second. For more information, see [Automatically connecting a Lambda function and a DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/lambda-rds-connect.html).
