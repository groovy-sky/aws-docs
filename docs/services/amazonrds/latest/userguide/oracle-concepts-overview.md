...
- [RDS for Oracle users and privileges](oracle-concepts-privileges.md)
...
- [RDS for Oracle initialization parameters](oracle-concepts-featuresupport-parameters.md)
