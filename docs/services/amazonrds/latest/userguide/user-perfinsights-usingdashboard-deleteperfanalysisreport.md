...
![Performance Insights dashboard to delete with a report selected for deletion](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/PI_DeleteAnalysisRep.png)
