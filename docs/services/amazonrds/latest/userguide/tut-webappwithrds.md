...
1. [Launch an EC2 instance to connect with your DB instance](chap-tutorials-webserverdb-launchec2.md)

2. [Create an Amazon RDS DB instance](chap-tutorials-webserverdb-createdbinstance.md)
