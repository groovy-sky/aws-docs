...
For more information on `tempdb` replication, see [TempDB configuration for Multi-AZ deployments](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/SQLServer.TempDB.MAZ.html).
