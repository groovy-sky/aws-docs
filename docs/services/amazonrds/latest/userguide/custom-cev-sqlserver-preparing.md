...
13. Create a new CEV by providing the AMI ID of the image that you created. For detailed steps,
     see [Creating a CEV for RDS Custom for SQL Server](custom-cev-sqlserver-create.md).

14. Create a new RDS Custom for SQL Server DB instance using the CEV. For detailed steps, see [Create an RDS Custom for SQL Server DB instance from a CEV](custom-cev-sqlserver-create.md#custom-cev-sqlserver.create.newdbinstance).
...
1. Search for **CU20** within the [Windows AMI version history](../../../ec2/latest/windowsguide/ec2-windows-ami-version-history.md).
...
4. Run Sysprep on the EC2 instance. For more information prepping an AMI using Sysprep, see
    [Create a standardized Amazon Machine Image (AMI) using Sysprep](../../../ec2/latest/windowsguide/creating-ebsbacked-winami.md#sysprep-using-ec2launchv2).
...
7. Create a new RDS Custom for SQL Server DB instance using the CEV. For detailed steps, see [Create an RDS Custom for SQL Server DB instance from a CEV](custom-cev-sqlserver-create.md#custom-cev-sqlserver.create.newdbinstance).
...
For more information, see [AWS Windows AMI version history](../../../ec2/latest/windows-ami-reference/ec2-windows-ami-version-history.md).
...
modify an RDS Custom for SQL Server DB instance to use a different CEV. For more information, see [Modifying an RDS Custom for SQL Server DB instance](custom-managing-modify-sqlserver.md).
...
more information, see [Modifying an RDS Custom for SQL Server DB instance](custom-managing-modify-sqlserver.md).
