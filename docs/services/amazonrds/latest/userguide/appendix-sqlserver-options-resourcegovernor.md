...
- [Supported versions and Regions](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.ResourceGovernor.html#ResourceGovernor.SupportedVersions)

- [Limitations and recommendations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.ResourceGovernor.html#ResourceGovernor.Limitations)

- [Enabling Microsoft SQL Server resource governor for your RDS for SQL Server instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/ResourceGovernor.Enabling.html)

  - [Creating the option group for RESOURCE\_GOVERNOR](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/ResourceGovernor.Enabling.html#ResourceGovernor.OptionGroup)

  - [Adding the RESOURCE\_GOVERNOR option to the option group](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/ResourceGovernor.Enabling.html#ResourceGovernor.Add)

  - [Associating the option group with your DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/ResourceGovernor.Enabling.html#ResourceGovernor.Apply)
...
- [Considerations for Multi-AZ deployment](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.ResourceGovernor.html#ResourceGovernor.Considerations)

- [Considerations for read replicas](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.ResourceGovernor.html#ResourceGovernor.ReadReplica)

- [Monitor Microsoft SQL Server resource governor using system views for your RDS for SQL Server instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/ResourceGovernor.Monitoring.html)

  - [Resource pool runtime statistics](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/ResourceGovernor.Monitoring.html#ResourceGovernor.ResourcePoolStats)
- [Disabling Microsoft SQL Server resource governor for your RDS for SQL Server instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/ResourceGovernor.Disabling.html)

- [Best practices for configuring resource governor on RDS for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/ResourceGovernor.BestPractices.html)
