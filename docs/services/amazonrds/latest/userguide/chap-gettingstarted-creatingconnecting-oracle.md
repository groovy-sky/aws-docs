---
title: "Creating and connecting to an Oracle DB instance"
---
...
For more information about connecting to an RDS for Oracle DB instance, see [Connecting to your Oracle DB instance](user-connecttooracleinstance.md). If you can't connect to
...
For security, it is a best practice to use encrypted connections. Only use an unencrypted
    ...
    trusted. For information about using encrypted connections, see [Securing Oracle DB instance connections](oracle-concepts-restricteddbaprivileges.md).
