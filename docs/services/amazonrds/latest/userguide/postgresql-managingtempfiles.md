...
For an example of viewing temporary file usage with Performance Insights, see [Viewing temporary file usage with Performance Insights](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL.ManagingTempFiles.Example.html)
