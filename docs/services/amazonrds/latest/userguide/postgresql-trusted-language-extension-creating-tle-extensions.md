...
- [pgtle.install\_extension](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.install_extension)

- [pgtle.install\_update\_path](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.install_update_path)

- [pgtle.register\_feature](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.register_feature)

- [pgtle.register\_feature\_if\_not\_exists](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.register_feature_if_not_exists)

- [pgtle.set\_default\_version](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.set_default_version)

- [pgtle.uninstall\_extension(name)](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.uninstall_extension-name)

- [pgtle.uninstall\_extension(name, version)](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.uninstall_extension-name-version)

- [pgtle.uninstall\_extension\_if\_exists](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.uninstall_extension_if_exists)

- [pgtle.uninstall\_update\_path](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.uninstall_update_path)

- [pgtle.uninstall\_update\_path\_if\_exists](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.uninstall_update_path_if_exists)

- [pgtle.unregister\_feature](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.unregister_feature)

- [pgtle.unregister\_feature\_if\_exists](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.unregister_feature_if_exists)
...
[Setting up Trusted Language Extensions in your RDS for PostgreSQL DB instance](postgresql-trusted-language-extension-setting-up.md).
...
function, see [pgtle.install\_update\_path](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.install_update_path). You need to have the `pgtle_admin` role to
perform this task.
...
For more information about this function, see [pgtle.set\_default\_version](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL_trusted_language_extension-functions-reference.html#pgtle.set_default_version).
