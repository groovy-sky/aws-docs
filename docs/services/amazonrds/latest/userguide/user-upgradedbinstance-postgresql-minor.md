...
upgrade extensions, see [Upgrading PostgreSQL extensions in RDS for PostgreSQL databases](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.PostgreSQL.ExtensionUpgrades.html).
