...
06. For **Source**, select the RDS
    ...
    **me**, or configure them manually. For instructions to
    fix them manually, see [Step 1: Create a custom DB parameter group](zero-etl-setting-up.md#zero-etl.parameters).
...
07. Once your source database is
     successfully configured, choose **Next**.

08. For **Target**, do the following:
...
09. Once your target AWS Glue managed catalog is configured correctly, choose
     **Next**.

10. (Optional) For **Tags**, add one or more tags to the
     integration. For more information, see [Tagging Amazon RDS resources](user-tagging.md).

11. For **Encryption**, specify how you want your
     ...
     **Customize encryption settings** and choose a
     KMS key to use for encryption. For more information, see [Encrypting Amazon RDS resources](overview-encryption.md).
...
13. Review your integration settings and choose **Create zero-ETL integration**.
    ...
    If creation fails, see [Troubleshooting Amazon RDS zero-ETL integrations](zero-etl-troubleshooting.md) for
