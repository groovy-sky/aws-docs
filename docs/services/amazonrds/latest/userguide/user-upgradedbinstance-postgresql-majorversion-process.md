...
invalid databases](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/appendix.postgresql.commondbatasks.autovacuumbehavior.html).
...
05. **Handle logical replication**
    **slots** – An upgrade can't
    ...
    Logical replication setups that use the `pglogical`
     ...
     extension, see [Managing logical replication slots for RDS for PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.PostgreSQL.CommonDBATasks.pglogical.handle-slots.html).
...
08. **Handle zero-ETL integrations**
     – If you have an existing [zero-ETL integration](zero-etl.md), [delete it](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/zero-etl.deleting.html) before
...
For more information, see [Upgrading PostgreSQL extensions in RDS for PostgreSQL databases](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.PostgreSQL.ExtensionUpgrades.html). To learn more about upgrading PostGIS, see [Step 6: Upgrade the PostGIS extension](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.PostgreSQL.CommonDBATasks.PostGIS.html#Appendix.PostgreSQL.CommonDBATasks.PostGIS.Update).
...
extensions. To upgrade extensions, see [Upgrading PostgreSQL extensions in RDS for PostgreSQL databases](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.PostgreSQL.ExtensionUpgrades.html).
