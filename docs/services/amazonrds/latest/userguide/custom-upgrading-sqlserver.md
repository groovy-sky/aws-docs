...
from the available versions when modifying your DB instance. Alternatively, use the [`describe-db-engine-versions`](../../../cli/latest/reference/rds/describe-db-engine-versions.md) CLI command or [DescribeDBEngineVersions](../../../../reference/amazonrds/latest/apireference/api-describedbengineversions.md) RDS API command.
...
[Modifying an RDS Custom for SQL Server DB instance](custom-managing-modify-sqlserver.md). Alternatively, use
[`modify-db-instance`](../../../cli/latest/reference/rds/modify-db-instance.md) CLI command or
