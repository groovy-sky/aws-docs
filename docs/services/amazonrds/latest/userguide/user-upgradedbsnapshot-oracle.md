...
vulnerabilities or service limitations. For more information, see [Oracle engine version management](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Oracle.Overview.html#Oracle.Concepts.Patching).
...
5. (Optional) For **Option group**, choose the option
    ...
    more information, see [Option group considerations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Oracle.OGPG.html#USER_UpgradeDBInstance.Oracle.OGPG.OG).
...
To upgrade an Oracle DB snapshot by using the AWS CLI, call the [modify-db-snapshot](https://docs.aws.amazon.com/cli/latest/reference/rds/modify-db-snapshot.html)
...
instance. For more information, see [Option group considerations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Oracle.OGPG.html#USER_UpgradeDBInstance.Oracle.OGPG.OG).
...
upgrading a DB instance. For more information, see [Option group considerations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Oracle.OGPG.html#USER_UpgradeDBInstance.Oracle.OGPG.OG).
