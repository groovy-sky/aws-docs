...
page. For descriptions of the Enhanced Monitoring metrics, see [OS metrics in Enhanced Monitoring](user-monitoring-available-os-metrics.md).

![Dashboard view](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/metrics1.png)
...
![Graph with multiple disks](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/enhanced-monitoring-multiple-disks.png)
...
![Graph showing file system usage](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/enhanced-monitoring-filesystem.png)
...
![Primary and secondary choice for Enhanced Monitoring](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/enhanced-monitoring-primary-secondary.png)

For more information about
Multi-AZ deployments, see [Configuring and managing a Multi-AZ deployment for Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.MultiAZ.html).
...
![Process list view](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/metrics2.png)
...
more information, see [Viewing OS metrics using CloudWatch Logs](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Monitoring.OS.CloudWatchLogs.html).
