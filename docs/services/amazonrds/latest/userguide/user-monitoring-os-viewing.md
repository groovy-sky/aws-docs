...
Multi-AZ deployments, see [Configuring and managing a Multi-AZ deployment for Amazon RDS](concepts-multiaz.md).
...
more information, see [Viewing OS metrics using CloudWatch Logs](user-monitoring-os-cloudwatchlogs.md).
