...
For more information, see [Creating and using an IAM policy for IAM database access](../aurorauserguide/usingwithrds-iamdbauth-iampolicy.md) in the _Amazon Aurora User Guide_.
...
[Connecting to a database using IAM authentication](rds-proxy-connecting.md#rds-proxy-connecting-iam).
...
attach the policy to a permission set or role. For a tutorial on this topic, see [Create and attach your first customer managed policy](../../../iam/latest/userguide/tutorial-managed-policies.md) in the
_IAM User Guide_.
