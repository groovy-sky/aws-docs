...
- Predicted storage growth exceeding the current allocated storage size in the next 7 hours based on the `FreeStorageSpace` metrics from the past hour. For more information on metrics, see [Monitoring with Amazon CloudWatch](monitoringoverview.md#monitoring-cloudwatch).
...
it to at least 26% more to avoid receiving an [event notification](user-events-messages.md#RDS-EVENT-0225) that the storage
...
additional storage volumes, see [Adding storage volumes](user-piops-modifyingexisting-additionalvolumes.md).
...
To enable storage autoscaling for a new DB instance, use the AWS CLI command [`create-db-instance`](../../../cli/latest/reference/rds/create-db-instance.md). Set the following parameter:
...
[`describe-orderable-db-instance-options`](../../../cli/latest/reference/rds/describe-orderable-db-instance-options.md)
...
[`DescribeValidDbInstanceModifications`](../../../../reference/amazonrds/latest/apireference/api-describevaliddbinstancemodifications.md)
operation for an existing instance, or the
[`DescribeOrderableDBInstanceOptions`](../../../../reference/amazonrds/latest/apireference/api-describeorderabledbinstanceoptions.md)
...
[`modify-db-instance`](../../../cli/latest/reference/rds/modify-db-instance.md). Set the following
parameter:
...
Amazon RDS API [`DescribeValidDbInstanceModifications`](../../../../reference/amazonrds/latest/apireference/api-describevaliddbinstancemodifications.md) operation
for an existing instance, or the [`DescribeOrderableDBInstanceOptions`](../../../../reference/amazonrds/latest/apireference/api-describeorderabledbinstanceoptions.md) operation
...
[Modify storage and performance settings](blue-green-deployments-creating.md#blue-green-deployments-resize).
...
To turn off storage autoscaling for a DB instance, use the AWS CLI command [`modify-db-instance`](../../../cli/latest/reference/rds/modify-db-instance.md)
