...
100\. For more information about how RDS Proxy uses this setting, see [MaxConnectionsPercent](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-proxy-connections.html#rds-proxy-connection-pooling-tuning.maxconnectionspercent).**Session pinning filters**
...
`--vpc-subnet-ids` parameter, see [Setting up network prerequisites for RDS Proxy](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-proxy-network-prereqs.html) for
