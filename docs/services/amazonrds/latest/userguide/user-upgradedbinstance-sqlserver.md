...
we recommend that you test the upgrade by following the steps described in [Testing an RDS for SQL Server upgrade](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.SQLServer.UpgradeTesting.html).
...
- [Major version upgrades for RDS for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.SQLServer.Major.html)

- [Considerations for SQL Server upgrades](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.SQLServer.Considerations.html)

- [Testing an RDS for SQL Server upgrade](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.SQLServer.UpgradeTesting.html)
