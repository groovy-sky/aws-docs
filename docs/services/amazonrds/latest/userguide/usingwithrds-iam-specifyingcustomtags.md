...
For information about creating tags, see [Tagging Amazon RDS resources](user-tagging.md).
...
For more information about adding tags to an Amazon RDS resource, see [Amazon Resource Names (ARNs) in Amazon RDS](user-tagging-arn.md).
...
information about using ARNs with Amazon RDS resources, see [Amazon Resource Names (ARNs) in Amazon RDS](user-tagging-arn.md).
