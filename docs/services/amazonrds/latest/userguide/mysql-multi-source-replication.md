...
To learn how to enable automatic backups, see [Enabling automated backups](user-workingwithautomatedbackups-enabling.md).
...
in replication or exclude them from replication. For more information on replication filters, see [Configuring replication filters with MySQL](user-mysql-replication-readreplicas-replicationfilters.md).
