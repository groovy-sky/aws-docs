...
instance. For more information, see [Working with option groups](user-workingwithoptiongroups.md).
...
[Linked Servers with Oracle OLEDB](appendix-sqlserver-options-linkedservers-oracle-oledb.md)
...
[Native backup and restore](appendix-sqlserver-options-backuprestore.md)
...
[Transparent Data Encryption](appendix-sqlserver-options-tde.md)
...
[SQL Server Analysis Services](appendix-sqlserver-options-ssas.md)
...
[SQL Server Integration Services](appendix-sqlserver-options-ssis.md)
...
[SQL Server Reporting Services](appendix-sqlserver-options-ssrs.md)
...
[Microsoft Distributed Transaction Coordinator](appendix-sqlserver-options-msdtc.md)
...
[SQL Server resource governor](appendix-sqlserver-options-resourcegovernor.md)
