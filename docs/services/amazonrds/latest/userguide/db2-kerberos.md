---
title: "Using Kerberos authentication for Amazon RDS for Db2"
---
...
For more information, see [What is Directory Service?](../../../directoryservice/latest/admin-guide/what-is.md) in the
...
availability of RDS for Db2 with Kerberos authentication, see [Supported Regions and DB engines for Kerberos authentication in Amazon RDS](concepts-rds-fea-regions-db-eng-feature-kerberosauthentication.md).

###### Note

Kerberos authentication isn't supported for DB instance classes
that are deprecated for RDS for Db2 DB instances. For more information, see [Amazon RDS for Db2 instance classes](db2-concepts-general-instanceclasses.md).
...
1. Use AWS Managed Microsoft AD to create an AWS Managed Microsoft AD directory. You can use the
    ...
    information, see [Create your AWS Managed Microsoft AD directory](../../../directoryservice/latest/admin-guide/ms-ad-getting-started-create-directory.md) in the _AWS Directory Service Administration Guide_.
...
the [restore-db-instance-from-db-snapshot](../../../cli/latest/reference/rds/restore-db-instance-from-db-snapshot.md)
...
operation. For instructions, see [Restoring to a DB instance](user-restorefromsnapshot.md).

- Restore an RDS for Db2 DB instance to a point-in-time using the console,
the [restore-db-instance-to-point-in-time](../../../cli/latest/reference/rds/restore-db-instance-to-point-in-time.md) command,
or the [RestoreDBInstanceToPointInTime](../../../../reference/amazonrds/latest/apireference/api-restoredbinstancetopointintime.md) API
...
For example, running the [modify-db-instance](../../../cli/latest/reference/rds/modify-db-instance.md) CLI command, you can perform the following
actions:
...
can view the status of the domain membership in the console or by running the [describe-db-instances](../../../cli/latest/reference/rds/describe-db-instances.md) command. The status of the DB
