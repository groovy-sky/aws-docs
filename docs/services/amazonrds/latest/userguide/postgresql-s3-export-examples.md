...
Export your PostgreSQL data to Amazon S3 by calling the [aws\_s3.query\_export\_to\_s3](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/postgresql-s3-export-functions.html#aws_s3.export_query_to_s3) function.
...
- Make sure that the
DB instance has export access to Amazon S3
...
The following shows the basic ways of calling the [aws\_s3.query\_export\_to\_s3](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/postgresql-s3-export-functions.html#aws_s3.export_query_to_s3) function.

These examples use the variable `s3_uri_1` to identify a structure that
contains the information identifying the Amazon S3 file. Use the [aws\_commons.create\_s3\_uri](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/postgresql-s3-export-functions.html#aws_commons.create_s3_uri)
...
For the full reference for this function and additional ways to call it, see [aws\_s3.query\_export\_to\_s3](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/postgresql-s3-export-functions.html#aws_s3.export_query_to_s3). For more about accessing
files in Amazon S3, see [View an\
object](https://docs.aws.amazon.com/AmazonS3/latest/userguide/OpeningAnObject.html) in the _Amazon Simple Storage Service User Guide_.

## Exporting to a CSV file that uses a custom delimiter

The following example shows how to call the [aws\_s3.query\_export\_to\_s3](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/postgresql-s3-export-functions.html#aws_s3.export_query_to_s3) function to export data to a
