---
title: "Modifying an RDS for Oracle tenant database"
---
...
To modify a tenant database using the AWS CLI, call the [modify-tenant-database](../../../cli/latest/reference/rds/modify-tenant-database.md) command with the following
parameters:
