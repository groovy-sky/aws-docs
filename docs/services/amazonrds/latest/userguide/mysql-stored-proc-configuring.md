...
the [mysql.rds\_start\_replication\_until\_gtid](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-stored-proc-gtid.html#mysql_rds_start_replication_until_gtid)
...
To skip a specific GTID-based transaction that is known to cause disaster, you can use the [mysql.rds\_skip\_transaction\_with\_gtid](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-stored-proc-gtid.html#mysql_rds_skip_transaction_with_gtid) stored
procedure. For more information about working with GTID-based replication, see [Using GTID-based replication](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-replication-gtid.html).
