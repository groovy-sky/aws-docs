---
title: "Parameter groups for Amazon RDS"
---
...
about option groups, see [Working with option groups](user-workingwithoptiongroups.md).
...
- [Comparing DB parameter groups](user-workingwithparamgroups-comparing.md)

- [Specifying DB parameters](user-paramvaluesref.md)
