---
title: "Working with read replicas for Microsoft SQL Server in Amazon RDS"
---
...
stored procedure.
For more information,
see [Dropping a database in an Amazon RDS for Microsoft SQL Server DB instance](appendix-sqlserver-commondbatasks-dropmirrordb.md).
...
including the management of its options. For more information about option groups, see [Working with option groups](user-workingwithoptiongroups.md).
