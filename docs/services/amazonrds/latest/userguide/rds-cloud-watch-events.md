---
title: "Creating a rule that triggers on an Amazon RDS event"
---
...
instance is created or deleted. For more information, see the [Amazon CloudWatch Events User Guide](../../../amazoncloudwatch/latest/events.md) and the [Amazon EventBridge User Guide](../../../eventbridge/latest/userguide.md).
...
EventBridge Rule That Triggers on an Event](../../../amazoncloudwatch/latest/events/create-cloudwatch-events-rule.md) in the _Amazon CloudWatch User Guide_.
