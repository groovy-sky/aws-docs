...
was successfully created. For more information, see the [rdsadmin.create\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-create-database) stored procedure.
...
information, see the [rdsadmin.drop\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-drop-database) stored procedure.
...
more information, see the [rdsadmin.restore\_database](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-restore-database) stored
procedure.
...
To view detailed error look at RDS Event Messages for you Db Instance. The Event Messages can be viewed at [Viewing Amazon RDS events.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ListEvents.html)
...
This user-defined function displays a selected lists of modifiable database parameters. These parameters can be updated using the stored procedure [rdsadmin.update\_db\_param](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-sp-managing-databases.html#db2-sp-update-db-param).
