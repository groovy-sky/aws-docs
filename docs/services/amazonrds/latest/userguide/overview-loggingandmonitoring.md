---
title: "Logging and monitoring in Amazon RDS"
---
...
made, and additional details. For more information, see [Monitoring Amazon RDS API calls in AWS CloudTrail](logging-using-cloudtrail.md)
.
...
hosts, or users. For more information, see [Monitoring DB load with Performance Insights on Amazon RDS](user-perfinsights.md)
.

**Database Logs**

You can view, download, and watch database logs using the AWS Management Console,
AWS CLI, or RDS API. For more information, see [Monitoring Amazon RDS log files](user-logaccess.md)
.
...
,
see [Monitoring metrics in an Amazon RDS instance](chap-monitoring.md)
.
