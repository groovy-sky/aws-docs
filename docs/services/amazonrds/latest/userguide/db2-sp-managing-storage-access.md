...
databases that use Amazon S3 for migrating data. For more information, see [Migrating Db2 data through Amazon S3 to Amazon RDS for Db2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-migration-load-from-s3.html).
...
deletes the alias. For more information, see [Migrating Db2 data through Amazon S3 to Amazon RDS for Db2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-migration-load-from-s3.html).
