...
on DevOps Guru for RDS. For information about turning on DevOps Guru for RDS, see [Turning on DevOps Guru and specifying resource coverage](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/devops-guru-for-rds.html#devops-guru-for-rds.configuring.coverage).
...
- [Viewing Amazon RDS recommendations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UserRecommendationsView.html)

- [Applying Amazon RDS recommendations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USERRecommendationsManage.ApplyRecommendation.html)

- [Dismissing Amazon RDS recommendations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USERRecommendationsManage.DismissRecommendation.html)

- [Modifying dismissed Amazon RDS recommendations to active recommendations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USERRecommendationsManage.DismissToActiveRecommendation.html)

- [Recommendations from Amazon RDS reference](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USERRecommendationsManage.RecommendationReference.html)
