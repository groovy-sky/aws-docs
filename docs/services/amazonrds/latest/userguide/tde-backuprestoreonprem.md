...
1. Generate the data key using the AWS CLI [generate-data-key](../../../cli/latest/reference/kms/generate-data-key.md) command.
...
For more information on KMS decryption, see [decrypt](../../../cli/latest/reference/kms/decrypt.md) in the KMS section of the _AWS CLI Command Reference_.
