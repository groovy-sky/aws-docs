...
`csvlog`, see [Using the log\_fdw extension to access the DB log using SQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_PostgreSQL.Extensions.log_fdw.html).
