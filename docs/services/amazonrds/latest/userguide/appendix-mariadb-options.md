...
information about working with option groups, see [Working with option groups](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithOptionGroups.html).
...
then the log file never rotates. For more information, see [Log rotation and retention for MariaDB](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_LogAccess.MariaDB.LogFileSize.html) and
...
**version**. For more information, see [Creating an option group](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithOptionGroups.html#USER_WorkingWithOptionGroups.Create).
...
2. Add the **MARIADB\_AUDIT\_PLUGIN** option to the option group, and configure the option settings.
    ...
    see [Adding an option to an option group](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithOptionGroups.html#USER_WorkingWithOptionGroups.AddOption).
...
information about how to modify option settings, see [Modifying an option setting](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithOptionGroups.html#USER_WorkingWithOptionGroups.ModifyOption). For more
