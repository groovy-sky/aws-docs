...
needed. For more information, see [Deactivating a database](db2-managing-databases.md#db2-deactivating-database) and [Activating a database](db2-managing-databases.md#db2-activating-database).
...
memory for an RDS for Db2 database, see [rdsadmin.update\_db\_param](db2-sp-managing-databases.md#db2-sp-update-db-param).
