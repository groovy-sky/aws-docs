...
. For RDS DB clusters,
you can also create additional read/write and read-only endpoints. For more information, see [Overview of proxy endpoints](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-proxy-endpoints.html#rds-proxy-endpoints-overview).
...
(IAM). For general information about those security features, see [Security in Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.html). Also, make sure to familiarize
...
minimize pinning, see [Avoiding pinning an RDS Proxy](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-proxy-pinning.html).
