...
table with the `--character-set-name` parameter of the AWS CLI [create-db-instance](../../../cli/latest/reference/rds/create-db-instance.md) command or with the
...
For information about connecting to an Oracle DB instance with a SQL client, see [Connecting to your Oracle DB instance](user-connecttooracleinstance.md).
