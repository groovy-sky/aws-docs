...
- Integration with the existing RDS read replica APIs: [CreateDBInstanceReadReplica](../../../../reference/amazonrds/latest/apireference/api-createdbinstancereadreplica.md), [PromoteReadReplica](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_PromoteReadReplica.html), and [SwitchoverReadReplica](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_SwitchoverReadReplica.html)
...
CDB architecture, see [Overview of RDS for Oracle CDBs](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Oracle.Concepts.CDBs.html).
