...
You must have an S3 bucket to use for your backup files and then upload backups you want
    ...
    [create a bucket](../../../s3/latest/userguide/creatingabucket.md). Alternatively, you can
...
service](../../../iam/latest/userguide/id-roles-create-for-service.md).
...
We recommend using the [`aws:SourceArn`](../../../iam/latest/userguide/reference-policies-condition-keys.md#condition-keys-sourcearn) and
[`aws:SourceAccount`](../../../iam/latest/userguide/reference-policies-condition-keys.md#condition-keys-sourceaccount) global condition context keys in resource-based trust relationships to limit
...
names (ARNs)](../../../../general/latest/gr/aws-arns-and-namespaces.md).
...
If you want to encrypt your backup files, include an encryption key in your permissions policy. For more information about encryption keys, see [Getting started](../../../kms/latest/developerguide/getting-started.md) in the _AWS Key Management Service Developer Guide_.
