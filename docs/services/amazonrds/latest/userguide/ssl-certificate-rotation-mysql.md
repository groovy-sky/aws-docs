---
title: "Updating applications to connect to MySQL DB instances using new SSL/TLS certificates"
---
...
using SSL/TLS with MySQL DB instances, see [SSL/TLS support for MySQL DB instances on Amazon RDS](mysql-concepts-sslsupport.md).
