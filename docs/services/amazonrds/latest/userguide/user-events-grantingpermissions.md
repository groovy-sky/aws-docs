...
control](../../../sns/latest/dg/sns-access-policy-use-cases.md) in the _Amazon Simple Notification Service Developer Guide_.
...
To see a list of resource types and their ARNs, see [Resources Defined by Amazon RDS](../../../service-authorization/latest/reference/list-amazonrds.md#amazonrds-resources-for-iam-policies) in the _Service Authorization Reference_.
