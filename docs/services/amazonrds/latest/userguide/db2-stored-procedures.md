...
[rdsadmin.activate\_database](db2-sp-managing-databases.md#db2-sp-activate-database)
...
[rdsadmin.add\_groups](db2-sp-granting-revoking-privileges.md#db2-sp-add-groups)
...
[rdsadmin.add\_user](db2-sp-granting-revoking-privileges.md#db2-sp-add-user)
...
[rdsadmin.alter\_bufferpool](db2-sp-managing-buffer-pools.md#db2-sp-alter-buffer-pool)
...
[rdsadmin.alter\_tablespace](db2-sp-managing-tablespaces.md#db2-sp-alter-tablespace)
...
[rdsadmin.backup\_database](db2-sp-managing-databases.md#db2-sp-backup-database)
...
[rdsadmin.catalog\_storage\_access](db2-sp-managing-storage-access.md#db2-sp-catalog-storage-access)
...
[rdsadmin.change\_password](db2-sp-granting-revoking-privileges.md#db2-sp-change-password)
...
`ROLL-FORWARD PENDING` state. A `ROLL-FORWARD
                                PENDING` state occurs when you called [rdsadmin.rollforward\_database](db2-sp-managing-databases.md#db2-sp-rollforward-database) but set the
`complete_rollforward` parameter to
`FALSE`.

[rdsadmin.configure\_db\_audit](db2-sp-managing-audit-policies.md#db2-sp-configure-db-audit)
...
[rdsadmin.create\_bufferpool](db2-sp-managing-buffer-pools.md#db2-sp-create-buffer-pool)
...
[rdsadmin.create\_role](db2-sp-granting-revoking-privileges.md#db2-sp-create-role)
...
[rdsadmin.create\_tablespace](db2-sp-managing-tablespaces.md#db2-sp-create-tablespace)
...
[rdsadmin.db2pd\_command](db2-sp-managing-databases.md#db2-sp-db2pd-command)
...
[rdsadmin.db2support\_command](db2-sp-managing-databases.md#db2-sp-db2support-command)
...
[rdsadmin.dbadm\_grant](db2-sp-granting-revoking-privileges.md#db2-sp-dbadm-grant)
...
[rdsadmin.dbadm\_revoke](db2-sp-granting-revoking-privileges.md#db2-sp-dbadm-revoke)
...
[rdsadmin.deactivate\_database](db2-sp-managing-databases.md#db2-sp-deactivate-database)
...
[rdsadmin.disable\_db\_audit](db2-sp-managing-audit-policies.md#db2-sp-disable-db-audit)
...
[rdsadmin.drop\_bufferpool](db2-sp-managing-buffer-pools.md#db2-sp-drop-buffer-pool)
...
[rdsadmin.drop\_role](db2-sp-granting-revoking-privileges.md#db2-sp-drop-role)
...
[rdsadmin.drop\_tablespace](db2-sp-managing-tablespaces.md#db2-sp-drop-tablespace)
...
[rdsadmin.fgac\_command](db2-sp-managing-databases.md#db2-sp-fgac-command)
...
[rdsadmin.force\_application](db2-sp-managing-databases.md#db2-sp-force-application)
...
[rdsadmin.grant\_role](db2-sp-granting-revoking-privileges.md#db2-sp-grant-role)
...
[rdsadmin.list\_archive\_log\_information](db2-sp-managing-databases.md#db2-sp-list-archive-log-information)
...
[rdsadmin.list\_sid\_group\_mapping](db2-sp-granting-revoking-privileges.md#db2-sp-list-sid-group-mapping)
...
[rdsadmin.list\_users](db2-sp-granting-revoking-privileges.md#db2-sp-list-users)
...
[rdsadmin.reactivate\_database](db2-sp-managing-databases.md#db2-sp-reactivate-database)
...
can use either this stored procedure or the [rdsadmin.activate\_database](db2-sp-managing-databases.md#db2-sp-activate-database) stored procedure. For a
database on a replica source DB instance, you must use the
`rdsadmin.reactivate_database` stored procedure.

[rdsadmin.remove\_groups](db2-sp-granting-revoking-privileges.md#db2-sp-remove-groups)
...
[rdsadmin.remove\_sid\_group\_mapping](db2-sp-granting-revoking-privileges.md#db2-sp-remove-sid-group-mapping)
...
[rdsadmin.remove\_user](db2-sp-granting-revoking-privileges.md#db2-sp-remove-user)
...
[rdsadmin.restore\_database](db2-sp-managing-databases.md#db2-sp-restore-database)
...
[rdsadmin.revoke\_role](db2-sp-granting-revoking-privileges.md#db2-sp-revoke-role)
...
instance by calling [rdsadmin.restore\_database](db2-sp-managing-databases.md#db2-sp-restore-database).

[rdsadmin.rollforward\_status](db2-sp-managing-databases.md#db2-sp-rollforward-status)

Databases

Use the `rdsadmin.rollforward_status` stored procedure to
query the rollforward status of calling the [rdsadmin.rollforward\_database](db2-sp-managing-databases.md#db2-sp-rollforward-database) or [rdsadmin.complete\_rollforward](db2-sp-managing-databases.md#db2-sp-complete-rollforward) stored procedure on an
RDS for Db2 DB instance.
...
[rdsadmin.set\_configuration](db2-sp-managing-databases.md#db2-sp-set-configuration)
...
[rdsadmin.set\_sid\_group\_mapping](db2-sp-granting-revoking-privileges.md#db2-sp-set-sid-group-mapping)
...
[rdsadmin.show\_configuration](db2-sp-managing-databases.md#db2-sp-show-configuration)
...
[rdsadmin.uncatalog\_storage\_access](db2-sp-managing-storage-access.md#db2-sp-uncatalog-storage-access)
...
[rdsadmin.update\_db\_param](db2-sp-managing-databases.md#db2-sp-update-db-param)
...
[rdsadmin.enable\_archive\_log\_copy](db2-sp-managing-databases.md#db2-sp-enable_archive_log_copy)

Databases

Use the `rdsadmin.enable_archive_log_copy` stored procedure to enables RDS Db2 database archive log copy to Amazon S3.

[rdsadmin.disable\_archive\_log\_copy](db2-sp-managing-databases.md#db2-sp-disable_archive_log_copy)
