---
title: "Automatically connecting an EC2 instance and a Multi-AZ DB cluster"
---
...
requirements described in [Overview of automatic connectivity with an EC2 instance](ec2-rds-connect.md#ec2-rds-connect-overview).
