---
title: "Configuring RDS for MySQL binary logging for instance deployments"
---
...
Aurora MySQL, this parameter is static. For more information, see [Configuring Aurora MySQL binary logging](../aurorauserguide/user-logaccess-mysql-binaryformat.md).)
