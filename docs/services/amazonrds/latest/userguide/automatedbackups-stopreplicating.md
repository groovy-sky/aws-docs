...
Stop backup replication by using the [`stop-db-instance-automated-backups-replication`](../../../cli/latest/reference/rds/stop-db-instance-automated-backups-replication.md)
AWS CLI command.
...
Stop backup replication by using the [`StopDBInstanceAutomatedBackupsReplication`](../../../../reference/amazonrds/latest/apireference/api-stopdbinstanceautomatedbackupsreplication.md) RDS API
