...
[Turning on the Advanced mode of Database Insights for Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_DatabaseInsights.TurningOnAdvanced.html).
...
For more information about Database Insights, see [Monitoring Amazon RDS databases with CloudWatch Database Insights](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_DatabaseInsights.html).
...
hosts, or users. For information about using Performance Insights with Amazon DocumentDB, see _[Amazon DocumentDB Developer Guide](https://docs.aws.amazon.com/documentdb/latest/developerguide/performance-insights.html)_.
...
- [Turning Performance Insights on and off for Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.Enabling.html)

- [Overview of the Performance Schema for Performance Insights on Amazon RDS for MariaDB or MySQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.EnableMySQL.html)

- [Configuring access policies for Performance Insights](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.access-control.html)
...
- [Viewing Performance Insights proactive recommendations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.InsightsRecommendationViewDetails.html)

- [Retrieving metrics with the Performance Insights API for Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.API.html)

- [Logging Performance Insights calls using AWS CloudTrail](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.CloudTrail.html)

- [Performance Insights API and interface VPC endpoints (AWS PrivateLink)](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/pi-vpc-interface-endpoints.html)
