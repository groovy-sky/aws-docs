...
![EC2 instance and MySQL DB instance.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/getting-started-mysql.png)

This tutorial allows you to create your resources by using one of the following methods:

1. Use the AWS Management Console ‐
    [Create a MySQL DB instance](#CHAP_GettingStarted.Creating.MySQL) and
...
02. In the upper-right corner of the Amazon RDS console, choose the AWS Region you used for the EC2
     instance previously.
...
05. In **Configuration**, choose **MySQL**.
...
08. For **Master username**, enter a name for the master user, or keep the
    ...
    ![Create database page.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/easy-create-mysql.png)
...
11. (Optional) Open **View default settings for Easy create**.
    ...
    ![Easy create default settings.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/easy-create-view-default-mysql.png)
...
13. In the **Databases** list, choose the name of the new MySQL
     DB instance to show its details.

    The DB instance has a status of **Creating** until it is ready to use.

    ![DB instance details.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/MySQL-Launch06.png)
...
01. Set **Stack name** to **MySQLTestStack**.
...
08. Set **Manage DB master user password with Secrets Manager** to
...
5. On the **Connectivity & security** tab, copy the endpoint.
      ...
      ![Connect to a MySQL DB instance.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/MySQLConnect1.png)
...
For more information about connecting to a MySQL DB instance, see [Connecting to your MySQL DB instance](user-connecttoinstance.md). If you can't connect to your DB instance, see
...
For security, it is a best practice to use encrypted connections. Only use an unencrypted MySQL
    ...
    using encrypted connections, see [Connecting to your MySQL DB instance on Amazon RDS with SSL/TLS from the MySQL command-line client (encrypted)](user-connecttoinstancessl-cli.md).
...
a day to hundreds of per second. For more information, see [Automatically connecting a Lambda function and a DB instance](lambda-rds-connect.md).
