...
authentication plugin for RDS for MySQL 8.4 For more information, see [Encrypting with SSL/TLS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-ssl-connections.html).

For information about configuring, using, and managing read replicas, see [Working with MySQL read replicas](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_MySQL.Replication.ReadReplicas.html).
...
reduce performance. For more information, see [Troubleshooting a MySQL read replica problem](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.Troubleshooting.html).
...
`1`, even though this might reduce performance. For more information, see [Troubleshooting a MySQL read replica problem](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.Troubleshooting.html).
...
modifying parameters, see [Modifying parameters in a DB parameter group in Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithParamGroups.Modifying.html).
...
from an instance of MySQL running external to Amazon RDS, see [Configuring binary log file position replication with an external source instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Procedural.Importing.External.Repl.html).
...
running external to Amazon RDS, see [Configuring binary log file position replication with an external source instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Procedural.Importing.External.Repl.html).
...
and client key into the DB instance or DB cluster using the [mysql.rds\_import\_binlog\_ssl\_material](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/url-rds-user;mysql_rds_import_binlog_ssl_material.html) procedure.
...
For more information, see [Configuring binary log file position replication with an external source instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Procedural.Importing.External.Repl.html).
...
instance by using the instructions in [Promoting a read replica to be a standalone DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.Promote.html).
...
that is known to cause disaster, you can use the [mysql.rds\_skip\_transaction\_with\_gtid](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-stored-proc-gtid.html#mysql_rds_skip_transaction_with_gtid) stored procedure. For
more information about working with GTID-based replication, see [Using GTID-based replication](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-replication-gtid.html).
...
using the instructions in [Promoting a read replica to be a standalone DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.Promote.html).
...
replication on a channel, call [mysql.rds\_stop\_replication\_for\_channel](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-stored-proc-multi-source-replication.html#mysql_rds_stop_replication_for_channel).
...
[mysql.rds\_start\_replication\_until\_gtid](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-stored-proc-gtid.html#mysql_rds_start_replication_until_gtid) stored procedure. To
roll forward changes to a delayed read replica to the time just before a disaster,
...
instructions in [Promoting a read replica to be a standalone DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.Promote.html).

To use the `mysql.rds_rds_start_replication_until_gtid` procedure,
GTID-based replication must be enabled. To skip a specific GTID-based transaction
that is known to cause disaster, you can use the [mysql.rds\_skip\_transaction\_with\_gtid](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-stored-proc-gtid.html#mysql_rds_skip_transaction_with_gtid) stored procedure. For
more information on GTID-based replication, see [Using GTID-based replication](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-replication-gtid.html).
...
with Amazon RDS, see [Troubleshooting a MySQL read replica problem](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.Troubleshooting.html).
...
To set the binlog retention time, use the [mysql.rds\_set\_configuration](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-stored-proc-configuring.html#mysql_rds_set_configuration) procedure and specify a
...
You can use the [mysql.rds\_start\_replication\_until](#mysql_rds_start_replication_until) or [mysql.rds\_start\_replication\_until\_gtid](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-stored-proc-gtid.html#mysql_rds_start_replication_until_gtid) stored procedure to
...
configuration. For more information, see [Restoring a backup into an Amazon RDS for MySQL DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Procedural.Importing.html).
...
replication actions, such as purging binary logs. For more information, see [Exporting data from a MySQL DB instance by using replication](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Procedural.Exporting.NonRDSRepl.html).
...
to be the new primary DB instance by using the instructions in [Promoting a read replica to be a standalone DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.Promote.html).

You can configure delayed replication using the following
stored procedures:

- [mysql.rds\_set\_configuration](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-stored-proc-configuring.html#mysql_rds_set_configuration)
