...
Include the following permissions to the key policy for your AWS KMS key. Replace `111122223333` with your account number and `AWS_ACCESS_KEY_ID_REDACTED` with your IAM role name.
...

{
  ...
  "Principal": {
    "AWS": [
      "arn:aws:sts::111122223333:assumed-role/AWS_ACCESS_KEY_ID_REDACTED/RDS-Db2Audit",
      "arn:aws:iam::111122223333:role/AWS_ACCESS_KEY_ID_REDACTED"
    ]
  },
  "Action": [
    "kms:GenerateDataKey",
...
1. Run the [create-policy](../../../cli/latest/reference/iam/create-policy.md) command. In the
...
1. Run the [create-role](../../../cli/latest/reference/iam/create-role.md) command. In the
...
3. Run the [attach-role-policy](../../../cli/latest/reference/iam/attach-role-policy.md) command. In the
...
more information about how to use this stored procedure, see [rdsadmin.configure\_db\_audit](db2-sp-managing-audit-policies.md#db2-sp-configure-db-audit).
...
configuration of the audit policy. For more information, see [rdsadmin.configure\_db\_audit](db2-sp-managing-audit-policies.md#db2-sp-configure-db-audit).
...
database. For more information, see [rdsadmin.disable\_db\_audit](db2-sp-managing-audit-policies.md#db2-sp-disable-db-audit).
...
information about how to view events, see [Viewing logs, events, and streams in the Amazon RDS console](logs-events-streams-console.md).
