...
- [Migrating from Linux to Linux for Amazon RDS for Db2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-one-time-migration-linux.html)

- [Migrating from Linux to Linux with near-zero downtime for Amazon RDS for Db2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-near-zero-downtime-migration.html)

- [Migrating synchronously from Linux to Linux for Amazon RDS for Db2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-synchronous-migration-linux.html)

- [Migrating from AIX or Windows to Linux for Amazon RDS for Db2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-one-time-migration-aix-windows-linux.html)
...
- [Migrating to Amazon RDS for Db2 with AWS Database Migration Service (AWS DMS)](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/db2-migration-amazon-dms.html)
