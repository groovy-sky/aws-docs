...
![A few dismissed recommendations selected and Move to active button highlighted in the console](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Recommendations_DismissToActive.png)
...
![a banner in the console showing the message with the number of resources moved successfully from dismissed to active recommendations](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Recommendation-DismissToActive-Banner.png)

The following example shows the banner with the failure message.

![a banner in the console showing the message with the resource that failed to move from dismissed to active recommendations](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Recommendation-DismissToActive-Banner-Failure.png)
...
To change a dismissed RDS recommendation to active recommendation using the Amazon RDS API, use the [ModifyDBRecommendation](../../../../reference/amazonrds/latest/apireference/api-modifydbrecommendation.md) operation.
