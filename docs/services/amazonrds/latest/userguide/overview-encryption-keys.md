...
Amazon RDS
automatically integrates with [AWS Key Management Service (AWS KMS)](../../../kms/latest/developerguide.md) for key management. Amazon RDS
uses envelope
...
in RDS
, use the [kms:ViaService condition key](../../../kms/latest/developerguide/policy-conditions.md#conditions-kms-via-service) with the
