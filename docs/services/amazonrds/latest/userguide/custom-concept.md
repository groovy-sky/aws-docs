...
in [Fixing unsupported configurations in RDS Custom for Oracle](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-troubleshooting.html#custom-troubleshooting.fix-unsupported) and [Fixing unsupported configurations in RDS Custom for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-troubleshooting-sqlserver.html#custom-troubleshooting-sqlserver.fix-unsupported). If any of
...
- [Fixing unsupported configurations in RDS Custom for Oracle](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-troubleshooting.html#custom-troubleshooting.fix-unsupported)

- [Fixing unsupported configurations in RDS Custom for SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-troubleshooting-sqlserver.html#custom-troubleshooting-sqlserver.fix-unsupported)
...
instance. For more information, see [Working with custom engine versions for Amazon RDS Custom for Oracle](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-cev.html).
...
CloudTrail manually, see [Deleting a trail](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-delete-trails-console.html) in the _AWS CloudTrail User_
_Guide_.
