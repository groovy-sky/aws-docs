...
- [Securing your Amazon S3 bucket against the confused deputy problem](custom-security-confused-deputy.md)

- [Rotating RDS Custom for Oracle credentials for compliance programs](custom-security-cred-rotation.md)
...
management tasks. For more information, see [AmazonRDSCustomServiceRolePolicy](../../../aws-managed-policy/latest/reference/amazonrdscustomservicerolepolicy.md).
