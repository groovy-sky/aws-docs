...
[Supported Regions and DB engines for cross-Region automated backups in Amazon RDS](concepts-rds-fea-regions-db-eng-feature-crossregionautomatedbackups.md).
...
other. For more information, see [Finding information about replicated backups for Amazon RDS](automatedbackups-replicating-describe.md).
