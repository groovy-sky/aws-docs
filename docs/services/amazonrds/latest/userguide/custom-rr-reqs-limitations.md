...
information, see [Configuring a VPN tunnel between RDS Custom for Oracle primary and replica instances](cfo-standby-vpn-tunnel.md).
...
[create-db-instance-read-replica](../../../cli/latest/reference/rds/create-db-instance-read-replica.md) AWS CLI command.
...
noted in the event log. You can also see the new state by using the [describe-db-instances](../../../cli/latest/reference/rds/describe-db-instances.md) AWS CLI command.
...
the replication status by using the [describe-db-instances](../../../cli/latest/reference/rds/describe-db-instances.md) AWS CLI command, but there might be a delay
