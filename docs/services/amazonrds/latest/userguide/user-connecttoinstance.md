...
You can also connect to a DB instance from a web server. For more information, see [Tutorial: Create a web server and an Amazon RDS DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/TUT_WebAppWithRDS.html).
...
- [Finding the connection information for an RDS for MySQL DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToInstance.EndpointAndPort.html)

- [Installing the MySQL command-line client](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-install-cli.html)

- [Connecting from the MySQL command-line client (unencrypted)](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToInstance.CLI.html)

- [Connecting from MySQL Workbench](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToInstance.MySQLWorkbench.html)

- [Connecting to RDS for MySQL with the AWS JDBC Driver, AWS Python Driver, and AWS ODBC Driver for MySQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Connecting.Drivers.html)
