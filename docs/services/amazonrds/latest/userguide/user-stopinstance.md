...
temporarily. For more information, see [Starting an Amazon RDS DB instance that was previously stopped](user-startinstance.md).
...
see [Microsoft SQL Server Multi-AZ deployment limitations, notes, and recommendations](user-sqlservermultiaz-recommendations.md).
...
Additional limitations apply to RDS Custom for SQL Server. For more information, see [Starting and stopping an RDS Custom for SQL Server DB instance](custom-managing-sqlserver-startstop.md).
...
[stop-db-instance](../../../cli/latest/reference/rds/stop-db-instance.md) command
...
call the
[StopDBInstance](../../../../reference/amazonrds/latest/apireference/api-stopdbinstance.md) operation
