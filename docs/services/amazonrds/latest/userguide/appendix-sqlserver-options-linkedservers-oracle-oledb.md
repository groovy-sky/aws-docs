...
- [Supported versions and Regions](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.VersionRegionSupport)

- [Limitations and recommendations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.Limitations)

- [Activating linked servers with Oracle](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.Enabling)

  - [Creating the option group for OLEDB\_ORACLE](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.OptionGroup)

  - [Adding the OLEDB\_ORACLE option to the option group](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.Add)

  - [Modifying the OLEDB\_ORACLE version option to another version](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.Modify)

  - [Associating the option group with your DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.Apply)
- [Modifying OLEDB provider properties](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.ModifyProviderProperties)

- [Modifying OLEDB driver properties](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.ModifyDriverProperties)

- [Deactivating linked servers with Oracle](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.html#LinkedServers_Oracle_OLEDB.Disable)
...
[`rds add-option-to-option-group`](https://docs.aws.amazon.com/cli/latest/reference/rds/add-option-to-option-group.html) AWS CLI command with the option group and option version
