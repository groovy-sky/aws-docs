...
- `CREATED` – After you call one of the SSAS stored procedures, a task is
created and the status is set to `CREATED`.
...
- `CANCEL_REQUESTED` – After you call `rds_cancel_task`, the
...
For more information, see [Troubleshooting SSAS issues](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/SSAS.Trouble.html).
