...
on the T instance classes, see [DB instance class types](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.DBInstanceClass.Types.html)
...
DB instances with [dedicated log volume](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PIOPS.dlv.html) enabled
...
the source DB instance. For more information, see [Monitoring multi-source replication channels](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql-multi-source-replication.html#mysql-multi-source-replication-monitoring).
