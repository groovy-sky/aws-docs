...
see [Setting the database time zone](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.Oracle.CommonDBATasks.TimeZoneSupport.html). For more information about upgrade
considerations, see [Time zone considerations](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Oracle.OGPG.html#USER_UpgradeDBInstance.Oracle.OGPG.DST).
...
The following example uses the AWS CLI [add-option-to-option-group](https://docs.aws.amazon.com/cli/latest/reference/rds/add-option-to-option-group.html) command to add the `Timezone`
