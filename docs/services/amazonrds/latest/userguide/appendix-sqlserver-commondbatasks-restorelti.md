...
7. For **DB Instance Identifier**, enter the name for the restored DB
    instance.

8. Choose **Restore DB Instance**.

For more information about restoring from a snapshot, see [Restoring to a DB instance](user-restorefromsnapshot.md).
