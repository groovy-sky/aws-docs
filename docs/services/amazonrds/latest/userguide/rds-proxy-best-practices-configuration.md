...
[Maximum number of database connections](chap-limits.md#RDS_Limits.MaxConnections) in the _Amazon RDS User Guide_,
[Maximum connections to an Aurora MySQL DB instance](../aurorauserguide/auroramysql-managing-performance.md#AuroraMySQL.Managing.MaxConnections), and
[Maximum connections to an Aurora PostgreSQL DB instance](../aurorauserguide/aurorapostgresql-managing.md#AuroraPostgreSQL.Managing.MaxConnections) in the _Amazon Aurora User Guide_.
...
[Maximum connections for Aurora Serverless v2](../aurorauserguide/aurora-serverless-v2-setting-capacity.md#aurora-serverless-v2.max-connections) in the _Amazon Aurora User Guide_.
...
[Aurora MySQL](../aurorauserguide/aurora-global-database-write-forwarding-ams.md#aurora-global-database-write-forwarding-params-ams) and
[Aurora PostgreSQL](../aurorauserguide/aurora-global-database-write-forwarding-apg.md#aurora-global-database-write-forwarding-params-apg) in the _Amazon Aurora User Guide_.
...
[Modifying a proxy](rds-proxy-modifying-proxy.md) for Amazon RDS.

- [Creating a proxy](../aurorauserguide/rds-proxy-creating.md) and
[Modifying a proxy](../aurorauserguide/rds-proxy-modifying-proxy.md) for Amazon Aurora.
