...
procedures. For more information, see [Using native backup and restore](sqlserver-procedural-importing-native-using.md).
...
3. Drop the database from your old drive to release the
    space. For more information, see [Dropping a database in an Amazon RDS for Microsoft SQL Server DB instance](appendix-sqlserver-commondbatasks-dropmirrordb.md).
