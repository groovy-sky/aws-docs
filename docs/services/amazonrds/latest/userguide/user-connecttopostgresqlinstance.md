...
- [Installing the psql client](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToPostgreSQLInstance.html#install-psql)

- [Finding the connection information for an RDS for PostgreSQL DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToPostgreSQLInstance.html#postgresql-endpoint)

- [Using pgAdmin to connect to a RDS for PostgreSQL DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToPostgreSQLInstance.pgAdmin.html)

- [Using psql to connect to your RDS for PostgreSQL DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToPostgreSQLInstance.psql.html)

- [Connecting to RDS for PostgreSQL with the Amazon Web Services (AWS) JDBC Driver](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL.Connecting.JDBCDriver.html)

- [Connecting to RDS for PostgreSQL with the Amazon Web Services (AWS) Python Driver](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/PostgreSQL.Connecting.PythonDriver.html)
...
- [Troubleshooting connections to your RDS for PostgreSQL instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToPostgreSQLInstance.Troubleshooting.html)
  ...
  - [Error – FATAL: database name does not exist](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToPostgreSQLInstance.Troubleshooting.html#USER_ConnectToPostgreSQLInstance.Troubleshooting-DBname)

  - [Error – Could not connect to server: Connection timed out](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToPostgreSQLInstance.Troubleshooting.html#USER_ConnectToPostgreSQLInstance.Troubleshooting-timeout)

  - [Errors with security group access rules](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ConnectToPostgreSQLInstance.Troubleshooting.html#USER_ConnectToPostgreSQLInstance.Troubleshooting-AccessRules)
...
You can obtain these details by using the AWS Management Console, the AWS CLI [describe-db-instances](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-instances.html)
command, or the Amazon RDS API [DescribeDBInstances](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeDBInstances.html) operation.
