---
title: "Resolving identifiable vacuum blockers in RDS for PostgreSQL"
---
...
autovacuum](appendix-postgresql-commondbatasks-autovacuum.md#Appendix.PostgreSQL.CommonDBATasks.Autovacuum.AdaptiveAutoVacuuming) threshold of 500 million transaction IDs. For
...
replicas](user-postgresql-replication-readreplicas.md), it prevents autovacuum on the primary database from removing
