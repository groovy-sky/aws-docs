...
To create a new DB instance with IAM authentication by using the AWS CLI, use the [`create-db-instance`](../../../cli/latest/reference/rds/create-db-instance.md) command. Specify the `--enable-iam-database-authentication` option, as shown in
...
command [`modify-db-instance`](../../../cli/latest/reference/rds/modify-db-instance.md). Specify either the `--enable-iam-database-authentication` or
