...
1. From the Dynamic Host Configuration Protocol (DHCP) options set attached
    ...
    address of your DNS name server. For more information, see [DHCP options sets](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_DHCP_Options.html).
...
For more information, see [Security groups for your\
    VPC](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html) and [Adding and\
    removing rules](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html#AddRemoveRules).
...
For more information, see [Security groups for your\
    VPC](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html) and [Adding and\
    removing rules](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html#AddRemoveRules) in the _Amazon VPC User Guide_.
...
Also, if the Amazon RDS DB instance and the DNS server are not in the same VPC,
    ...
    peering?](https://docs.aws.amazon.com/vpc/latest/peering/Welcome.html) in _Amazon VPC Peering Guide_.
