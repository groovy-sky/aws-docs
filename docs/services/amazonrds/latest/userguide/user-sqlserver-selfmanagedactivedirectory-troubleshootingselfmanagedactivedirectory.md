...
[Configure your AD domain service account](user-sqlserver-selfmanagedactivedirectory-requirements.md#USER_SQLServer_SelfManagedActiveDirectory.Requirements.DomainAccountConfig).
