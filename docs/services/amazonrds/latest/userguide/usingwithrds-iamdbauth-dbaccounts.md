...
and that you have enabled IAM database authentication on your DB instance. For more information, see [Region and version availability](usingwithrds-iamdbauth.md#UsingWithRDS.IAMDBAuth.Availability) and [Enabling and disabling IAM database authentication](usingwithrds-iamdbauth-enabling.md).
