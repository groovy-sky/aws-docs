...
![Enable Performance Insights during DB instance creation with console](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/aurora_perf_insights_enabling.png)
...
![Counter metrics](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/oracle_perf_insights_counters.png)
...
![Filter metrics](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_select_metrics.png)
...
![Database load](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_2.png)
...
DimensionAurora PostgreSQLAurora MySQL
...
![Filter metrics](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_2b.png)
...
![Database load item details](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_2c.png)

To see details for any item for the selected time period in the legend, hover over that item.

![Time period details for DB load](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_3.png)
...
![Top N dimensions](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_4c.png)
...
To learn how to analyze queries by using the **Top SQL** tab, see [Overview of the Top SQL tab](user-perfinsights-usingdashboard-analyzedbload-additionalmetrics.md#USER_PerfInsights.UsingDashboard.Components.AvgActiveSessions.TopLoadItemsTable.TopSQL).
