---
title: "Connecting to your DB cluster using IAM authentication and the AWS SDK for Java"
---
...
- [Set up the AWS SDK for Java](../../../../reference/sdk-for-java/v1/developer-guide/setup-install.md)

For examples on how to use the SDK for Java 2.x, see [Amazon RDS examples using SDK for Java 2.x](../../../../reference/sdk-for-java/latest/developer-guide/java-rds-code-examples.md).
...
key and secret key that it finds in the [default credential provider chain](../../../../reference/sdk-for-java/v1/developer-guide/credentials.md#credentials-default). For more information about AWS
access keys, see [Managing access keys for users](../../../iam/latest/userguide/id-credentials-access-keys.md).
...
version 4 signing process](../../../../general/latest/gr/signature-version-4.md) in the _AWS General Reference._
...
To run this code example, you need the [AWS SDK for Java](http://aws.amazon.com/sdk-for-java),
...
Amazon Aurora
that is specific to an AWS Region. (For more information, see [Using SSL/TLS to encrypt a connection to a DB cluster](usingwithrds-ssl.md).) At runtime, the class loader
...
AWS Region, see [Using SSL/TLS to encrypt a connection to a DB cluster](usingwithrds-ssl.md).
...
This code example obtains AWS credentials from the [default credential provider chain](../../../../reference/sdk-for-java/v1/developer-guide/credentials.md#credentials-default).
...
public class IAMDatabaseAuthenticationTester {
     ...
     * btusi123.cmz7kenwo2ye.rds.cn-north-1.amazonaws.com.cn:3306/?Action=connect&DBUser=iamtestuser&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20171003T010726Z&X-Amz-SignedHeaders=host&X-Amz-Expires=899&X-Amz-Credential=AWS_ACCESS_KEY_ID_REDACTED%2F20171003%2Fcn-north-1%2Frds-db%2Faws4_request&X-Amz-Signature=f9f45ef96c1f770cdad11a53e33ffa4c3730bc03fdee820cfdf1322eed15483b
     * @return
     */
