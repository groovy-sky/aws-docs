...
and then start a simple replication. For more information, see [Setting up logical replication for your Aurora PostgreSQL DB cluster](aurorapostgresql-replication-logical-configure.md). With replication under
