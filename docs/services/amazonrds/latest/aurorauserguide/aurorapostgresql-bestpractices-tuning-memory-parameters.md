...
For more information, see [Parameter groups for Amazon Aurora](user-workingwithparamgroups.md).
...
![Image of custom parameter group with log_temp_files set to 1024kB.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/postgres_tuning_custom_parameter.png)
...
For more information about pgbench, see [pgbench](https://www.postgresql.org/docs/current/pgbench.html) in the
...
![Image of the log file from AWS Management Console showing the temporary files.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/postgres_tuning_log_temp_files.png)
...
and then start a simple replication. For more information, see [Setting up logical replication for your Aurora PostgreSQL DB cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Replication.Logical.Configure.html). With replication under
