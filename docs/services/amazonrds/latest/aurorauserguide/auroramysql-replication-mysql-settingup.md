...
- [1\. Turn on binary logging on the replication source](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Replication.MySQL.SettingUp.html#AuroraMySQL.Replication.MySQL.EnableBinlog)

- [2\. Retain binary logs on the replication source until no longer needed](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Replication.MySQL.SettingUp.html#AuroraMySQL.Replication.MySQL.RetainBinlogs)

- [3\. Create a copy or dump of your replication source](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Replication.MySQL.SettingUp.html#AuroraMySQL.Replication.MySQL.CreateSnapshot)

- [4\. Load the dump into your replica target (if needed)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Replication.MySQL.SettingUp.html#AuroraMySQL.Replication.MySQL.LoadSnapshot)

- [5\. Create a replication user on your replication source](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Replication.MySQL.SettingUp.html#AuroraMySQL.Replication.MySQL.CreateReplUser)

- [6\. Turn on replication on your replica target](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Replication.MySQL.SettingUp.html#AuroraMySQL.Replication.MySQL.EnableReplication)

  - [Setting a location to stop replication to a read replica](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Replication.MySQL.SettingUp.html#AuroraMySQL.Replication.StartReplicationUntil)
- [7\. Monitor your replica](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Replication.MySQL.SettingUp.html#AuroraMySQL.Replication.MySQL.Monitor)

- [Synchronizing passwords between replication source and target](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Replication.MySQL.SettingUp.html#AuroraMySQL.Replication.passwords)
...
later, you can run the [mysql.rds\_remove\_binlog\_ssl\_material](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_remove_binlog_ssl_material) stored procedure.
...
To set the binary log retention time frame, use the [mysql.rds\_set\_configuration](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-configuring.html#mysql_rds_set_configuration) procedure and specify a configuration parameter of
...
the read replica has been created, call the [mysql.rds\_stop\_replication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_stop_replication) procedure on the read replica. While replication is
...
Be sure to retain the same DB parameter
    ...
    enabled. For more information, see [Restoring from a DB cluster snapshot](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-restore-snapshot.html).
...
- Call the [describe-events](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-events.html) AWS CLI command, as in the
following example.
...
1. Connect to your read replica and stop replication by running the [mysql.rds\_stop\_replication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_stop_replication)
    procedure.
...
cluster. For more information, see [Restoring from a DB cluster snapshot](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-restore-snapshot.html).
...
cluster. For more information, see [Migrating data to an Amazon Aurora MySQL DB cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Migrating.html).
...
- [mysql.rds\_set\_external\_source (Aurora MySQL version 3)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_set_external_source)

- [mysql.rds\_set\_external\_master (Aurora MySQL version 2)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_set_external_master)

- [mysql.rds\_start\_replication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_start_replication) (all versions)
...
2. Connect to the DB instance and call the [mysql.rds\_set\_external\_master (Aurora MySQL version 2)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_set_external_master) or
    [mysql.rds\_set\_external\_source (Aurora MySQL version 3)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_set_external_source)
    and [mysql.rds\_start\_replication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_start_replication)
...
[mysql.rds\_reset\_external\_master (Aurora MySQL version 2)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_reset_external_master) or
[mysql.rds\_reset\_external\_source (Aurora MySQL version 3)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_reset_external_source)
...
location using the [mysql.rds\_start\_replication\_until(Aurora MySQL version 3)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_start_replication_until) stored procedure.
...
2. Run the [mysql.rds\_start\_replication\_until(Aurora MySQL version 3)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_start_replication_until) stored procedure.
