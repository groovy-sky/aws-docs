---
title: "Creating a DB cluster that uses Aurora serverless"
---
...
in [Creating an Amazon Aurora DB cluster](aurora-createinstance.md). With Aurora serverless, your
...
Make sure that the cluster's initial settings meet the requirements listed in [Requirements and limitations for Aurora serverless](aurora-serverless-v2-requirements.md). Specify the following
...
available Regions, see [Supported Regions and Aurora DB engines for Aurora serverless](concepts-aurora-fea-regions-db-eng-feature-serverlessv2.md).

**DB engine version**

Choose an engine version that's compatible with Aurora serverless. For information about the
Aurora serverless version requirements, see [Requirements and limitations for Aurora serverless](aurora-serverless-v2-requirements.md).
...
chose a DB engine version that's supported for [Supported Regions and Aurora DB engines for Aurora serverless](concepts-aurora-fea-regions-db-eng-feature-serverlessv2.md).
...
information, see [Choosing the promotion tier for an Aurora serverless reader](aurora-serverless-v2-administration.md#aurora-serverless-v2-choosing-promotion-tier).
...
- For **Version**, choose one of the supported versions for [Supported Regions and Aurora DB engines for Aurora serverless](concepts-aurora-fea-regions-db-eng-feature-serverlessv2.md).
...
For more information about Aurora serverless capacity units, see
    [Aurora serverless capacity](aurora-serverless-v2-how-it-works.md#aurora-serverless-v2.how-it-works.capacity) and
...
![Instance configuration settings for Aurora serverless.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/serverless_v2_screencaps/serverless_v2_capacity_setting_incl_nonzero_minimum.png)
...
![Capacity setting Aurora serverless when the lower limit is 0 ACUs.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/serverless_v2_screencaps/serverless_v2_capacity_setting_incl_zero_minimum.png)
...
7. Choose **Create database** to create your Aurora DB cluster with an Aurora serverless DB
...
[Aurora serverless capacity](aurora-serverless-v2-how-it-works.md#aurora-serverless-v2.how-it-works.capacity)
and [Performance and scaling for Aurora serverless](aurora-serverless-v2-setting-capacity.md).
...
[Adding an Aurora serverless reader](aurora-serverless-v2-administration.md#aurora-serverless-v2-adding-reader) and
...
procedure in [Setting the Aurora serverless capacity range for a cluster](aurora-serverless-v2-administration.md#aurora-serverless-v2-setting-acus).
