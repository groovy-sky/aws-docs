---
title: "Identity-based policy examples for Amazon Aurora"
---
...
- [Permission policies to create, modify and, delete resources in Aurora](security-iam-id-based-policy-examples-create-and-modify-examples.md)
...
- [Grant permission to tag Aurora resources during creation](security-iam-id-based-policy-examples-grant-permissions-tags-on-create.md)
