...
Logs each successful connection. To
learn how to use this parameter with
`log_disconnections` to detect connection churn,
see [Managing Aurora PostgreSQL connection churn with pooling](aurorapostgresql-bestpractices-connection-pooling.md).

log\_disconnections

–

Logs the end of each session and its duration. To learn how to use this parameter with
`log_connections` to detect connection churn, see
