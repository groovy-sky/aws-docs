...
Use in MySQL](https://dev.mysql.com/doc/refman/5.6/en/internal-temporary-tables.html) in the _MySQL Reference Manual_.
...
Using the sys Schema](https://dev.mysql.com/doc/refman/8.0/en/sys-schema-prerequisites.html) in the MySQL documentation.
...
[Use \
the TempTable storage engine on Amazon RDS for MySQL and Amazon Aurora MySQL](https://aws.amazon.com/blogs/database/use-the-temptable-storage-engine-on-amazon-rds-for-mysql-and-amazon-aurora-mysql).
...
For more information, see [Created\_tmp\_disk\_tables](https://dev.mysql.com/doc/refman/8.0/en/server-status-variables.html) in the MySQL documentation.
