---
title: "Canceling a DB cluster export task"
---
...
To cancel an export task using the AWS CLI, use the [cancel-export-task](../../../cli/latest/reference/rds/cancel-export-task.md) command. The command requires the `--export-task-identifier` option.
...
To cancel an export task using the Amazon RDS API, use the [CancelExportTask](../../../../reference/amazonrds/latest/apireference/api-cancelexporttask.md) operation with the `ExportTaskIdentifier` parameter.
