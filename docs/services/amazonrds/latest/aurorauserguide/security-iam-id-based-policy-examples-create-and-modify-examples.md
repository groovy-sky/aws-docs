...
`Condition` element. For more information about specifying conditions, see [Policy condition keys for Aurora](security-iam-service-with-iam.md#UsingWithRDS.IAM.Conditions).
