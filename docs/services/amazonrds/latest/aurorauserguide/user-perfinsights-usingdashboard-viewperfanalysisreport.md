...
![DB load chart showing entire analysis report period](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/PI_EntireAnalysisRep.png)
...
![DB load chart showing insight in the report](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/PI_AnalysisRepInsight_chart.png)

![Report insight analysis and recommendation section](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/PI_AnalysisRepInsight_Recommendations.png)
