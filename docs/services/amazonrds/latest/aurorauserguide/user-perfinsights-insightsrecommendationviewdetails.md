...
For more information about turning on Performance Insights, see [Turning Performance Insights on and off for Aurora](user-perfinsights-enabling.md). For information about pricing and data
