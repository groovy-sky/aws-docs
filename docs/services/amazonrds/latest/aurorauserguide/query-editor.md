...
The SQL that you can run is subject to the Data API limitations. For more information, see [Limitations for the Amazon RDS Data API](data-api-limitations.md).
...
Data API is available. For more information, see [Supported Regions and Aurora DB engines for RDS Data API](concepts-aurora-fea-regions-db-eng-feature-data-api.md).
...
the administrative user name and password. For more information, see [Creating an IAM user in your AWS account](../../../iam/latest/userguide/id-users-create.md) in the
...
For information about creating an IAM policy, see [Creating IAM policies](../../../iam/latest/userguide/access-policies-create.md)
in the _AWS Identity and Access Management User Guide_.

For information about adding an IAM policy to a user, see [Adding and removing IAM identity permissions](../../../iam/latest/userguide/access-policies-manage-attach-detach.md)
in the _AWS Identity and Access Management User Guide_.
