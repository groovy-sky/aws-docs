...
`pg_hint_plan`, see [https://github.com/ossc-db/pg\_hint\_plan](https://github.com/ossc-db/pg_hint_plan). For details about the version of this extension supported by Aurora PostgreSQL, see [Extension versions for Amazon Aurora PostgreSQL](../aurorapostgresqlreleasenotes/aurorapostgresql-extensions.md)
