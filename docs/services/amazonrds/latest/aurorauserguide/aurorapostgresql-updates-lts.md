...
[PostgreSQL 17.7](../aurorapostgresqlreleasenotes/aurorapostgresql-updates.md#aurorapostgresql-versions-version177x) in the _Release Notes for Aurora PostgreSQL_.
