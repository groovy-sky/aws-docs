...
[AWS-owned key](../../../kms/latest/developerguide/concepts.md#aws-owned-key)
...
about key types, see
[customer managed keys and AWS managed keys](../../../kms/latest/developerguide/concepts.md#key-mgmt).
...
you use the [AWS Key Management Service (AWS KMS)](../../../kms/latest/developerguide.md).
...
AWS Management Console, AWS CLI, or RDS API. Restart the DB cluster using the AWS CLI command [start-db-cluster](../../../cli/latest/reference/rds/start-db-cluster.md) or
...
read replicas. For more information, see [Limitations for stopping and starting Aurora DB clusters](aurora-cluster-stop-start.md#aurora-cluster-stop-limitations).
...
If you use the [create-db-cluster](../../../cli/latest/reference/rds/create-db-cluster.md) AWS CLI command to create an encrypted DB
...
cluster by using the AWS CLI, call the [describe-db-clusters](../../../cli/latest/reference/rds/describe-db-clusters.md) command with the following option:
...
To determine whether encryption at rest is turned on for a DB
cluster by using the Amazon RDS API, call the [DescribeDBClusters](../../../../reference/amazonrds/latest/apireference/api-describedbclusters.md) operation with the following
parameter:
