...
For more information, see [apg\_plan\_mgmt.delete\_plan](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.Functions.html#AuroraPostgreSQL.Optimize.Functions.delete_plan).
...
effect. For more information, see the [apg\_plan\_mgmt.max\_plans](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.Parameters.html#AuroraPostgreSQL.Optimize.Parameters.max_plans) parameter.
