...
filters property. For more information, see [Creating a proxy for Amazon Aurora](rds-proxy-creating.md) and [Modifying an RDS Proxy](rds-proxy-modifying-proxy.md).
