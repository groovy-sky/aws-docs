---
title: "Resetting parameters in a DB cluster parameter groupin Amazon Aurora"
---
...
To reset parameters in a DB cluster parameter group to their default values,
use the AWS CLI [`reset-db-cluster-parameter-group`](../../../cli/latest/reference/rds/reset-db-cluster-parameter-group.md) command with the following
...
[`ResetDBClusterParameterGroup`](../../../../reference/amazonrds/latest/apireference/api-resetdbclusterparametergroup.md) command with the following
