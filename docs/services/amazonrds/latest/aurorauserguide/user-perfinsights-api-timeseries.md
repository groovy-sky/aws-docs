...
![Counter Metrics and Database Load charts](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf-insights-api-charts.png)
...
For information about using the `get-resource-metrics` AWS CLI command, see [`get-resource-metrics`](../../../cli/latest/reference/pi/get-resource-metrics.md).
