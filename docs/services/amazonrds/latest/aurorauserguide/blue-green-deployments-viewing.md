...
![Blue/green deployment in the database list](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/blue-green-deployment-view-db-list-aurora.png)
...
![Blue/green deployment details](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/blue-green-deployment-view-details-aurora.png)
...
![Blue/green deployment configuration details](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/blue-green-deployment-view-config-aurora.png)

The following image shows an example of the **Status** tab:

![Blue/green deployment status](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/blue-green-deployment-view-status-aurora.png)
