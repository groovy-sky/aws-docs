...
5. For Aurora serverless or provisioned DB clusters, choose either **Aurora I/O-Optimized** or
...
(Newer versions that support Aurora serverless) Use this parameter to configure the minimum and
maximum capacity for an Aurora serverless clone. If you don't specify this parameter, you
can't create any Aurora serverless instances in the clone cluster until you modify the cluster
