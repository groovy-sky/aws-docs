...
[Aurora Serverless v2 capacity](#aurora-serverless-v2.how-it-works.capacity).
...
[Aurora Serverless v2 scaling](#aurora-serverless-v2.how-it-works.scaling).
...
[Creating an Aurora Serverless v2 DB cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2.create.html#aurora-serverless-v2.create-cluster) and
...
Aurora Serverless v2 platform versionACU rangePerformance10–128Baseline performance20–256Baseline performance30–256Up to 30% improved performance compared to platform version 2
...
minimum capacity value, see [Choosing the minimum Aurora Serverless v2 capacity setting for a cluster](aurora-serverless-v2-setting-capacity.md#aurora-serverless-v2.min_capacity_considerations). For all the
considerations when choosing the maximum capacity value, see [Choosing the maximum Aurora Serverless v2 capacity setting for a cluster](aurora-serverless-v2-setting-capacity.md#aurora-serverless-v2.max_capacity_considerations).
...
information about how Aurora Serverless v2 charges are calculated, see the [Aurora pricing page](https://aws.amazon.com/rds/aurora/pricing).
...
[Monitoring metrics in an Amazon Aurora cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/MonitoringAurora.html). For tips about monitoring
Aurora Serverless v2, see
[Important Amazon CloudWatch metrics for Aurora Serverless v2](aurora-serverless-v2-setting-capacity.md#aurora-serverless-v2.viewing.monitoring).
...
[Choosing the promotion tier for an Aurora Serverless v2 reader](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2-administration.html#aurora-serverless-v2-choosing-promotion-tier).
...
see [Aurora Serverless v2 capacity](#aurora-serverless-v2.how-it-works.capacity).
