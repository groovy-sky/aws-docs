...
[Launch an EC2 instance to connect with your DB cluster](chap-tutorials-webserverdb-launchec2.md). The web server connects to the Amazon Aurora
DB cluster that you created in [Create an Amazon Aurora DB cluster](chap-tutorials-webserverdb-createdbcluster.md).
...
If you don't see the Apache test page, check your inbound rules for the
    VPC security group that you created in [Tutorial: Create a VPC for use with a DB cluster (IPv4 only)](chap-tutorials-webserverdb-createvpc.md). Make sure that
...
- To delete a DB cluster, follow the instructions in [Deleting Aurora DB clusters and DB instances](user-deletecluster.md). You
