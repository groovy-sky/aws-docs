---
title: "aurora_global_db_instance_status"
---
...
instance runs. For a list of Regions, see [Region availability](concepts-regionsandavailabilityzones.md#Aurora.Overview.Availability).
...
when it generates hot standby information. A _hot_
...
`aurora_global_db_status`, see [Monitoring Aurora PostgreSQL-based global databases](aurora-global-database-monitoring.md#aurora-global-database-monitoring.postgres).
