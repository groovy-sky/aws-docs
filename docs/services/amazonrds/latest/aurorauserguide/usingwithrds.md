...
Amazon Aurora
(Aurora), see [AWS services in scope by compliance program](https://aws.amazon.com/compliance/services-in-scope).
...
[Amazon VPC and Amazon Aurora](user-vpc.md)
.
...
To review IAM policy examples, see [Identity-based policy examples for Amazon Aurora](security-iam-id-based-policy-examples.md)
.
...
on using SSL/TLS with a DB cluster, see [Using SSL/TLS to encrypt a connection to a DB cluster](usingwithrds-ssl.md)
.
...
cluster. For more information, see [Encrypting Amazon Aurora resources](overview-encryption.md)
.
...
For information about security with Aurora MySQL, see [Security with Amazon Aurora MySQL](auroramysql-security.md)
. For
information about security with Aurora PostgreSQL, see [Security with Amazon Aurora PostgreSQL](aurorapostgresql-security.md)
.
...
the cloud. If you are not already familiar with Amazon RDS, see the [_Amazon RDS user_\
_guide_](../userguide/welcome.md).
...
API reference](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/Welcome.html). For more information about the AWS CLI, see [AWS Command Line Interface reference for Amazon RDS](https://docs.aws.amazon.com/cli/latest/reference/rds/index.html).
...
- [Data protection in Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/DataDurability.html)

- [Identity and access management for Amazon Aurora](usingwithrds-iam.md)

- [Logging and monitoring in Amazon Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Overview.LoggingAndMonitoring.html)

- [Compliance validation for Amazon Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/RDS-compliance.html)

- [Resilience in Amazon Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/disaster-recovery-resiliency.html)

- [Infrastructure security in Amazon Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/infrastructure-security.html)
...
- [Security best practices for Amazon Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/CHAP_BestPractices.Security.html)
