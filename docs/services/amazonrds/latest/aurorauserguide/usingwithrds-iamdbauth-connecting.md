...
process](https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html) in the _AWS General Reference._) The AWS CLI
...
- [Connecting to your DB cluster using IAM authentication with the AWS drivers](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/IAMDBAuth.Connecting.Drivers.html)

- [Connecting to your DB cluster using IAM authentication from the command line: AWS CLI and mysql client](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAMDBAuth.Connecting.AWSCLI.html)

- [Connecting to your DB cluster using IAM authentication from the command line: AWS CLI and psql client](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAMDBAuth.Connecting.AWSCLI.PostgreSQL.html)

- [Connecting to your DB cluster using IAM authentication and the AWS SDK for .NET](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAMDBAuth.Connecting.NET.html)

- [Connecting to your DB cluster using IAM authentication and the AWS SDK for Go](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAMDBAuth.Connecting.Go.html)

- [Connecting to your DB cluster using IAM authentication and the AWS SDK for Java](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAMDBAuth.Connecting.Java.html)

- [Connecting to your DB cluster using IAM authentication and the AWS SDK for Python (Boto3)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAMDBAuth.Connecting.Python.html)
