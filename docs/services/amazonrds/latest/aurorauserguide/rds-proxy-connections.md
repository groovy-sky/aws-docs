...
For information on database connection limits, see [Maximum connections to an Aurora MySQL DB instance](auroramysql-managing-performance.md#AuroraMySQL.Managing.MaxConnections)
