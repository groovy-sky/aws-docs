...
05. For **Actions**, choose **Expand all**, and then choose the bucket
    ...
    Object permissions are permissions for object operations in Amazon S3, and
     ...
     in Amazon S3, see [Permissions for object operations](../../../s3/latest/userguide/using-with-s3-actions.md#using-with-s3-actions-related-to-objects).
...
09. In the **Add ARN(s)** dialog box, provide the details
    ...
    to your Amazon S3 resources](../../../s3/latest/userguide/s3-access-control.md).
...
14. Complete the steps in [Creating an IAM role to allow Amazon Aurora to access AWS services](auroramysql-integrating-authorizing-iam-createrole.md).
