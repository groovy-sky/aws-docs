...
FeatureBucket permissionsObject permissions
...
05. For **Actions**, choose **Expand all**, and then choose the bucket
    ...
    Object permissions are permissions for object operations in Amazon S3, and
     ...
     in Amazon S3, see [Permissions for object operations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-with-s3-actions.html#using-with-s3-actions-related-to-objects).

06. Choose **Resources**, and choose **Add ARN** for **bucket**.
...
08. If the **object** resource is listed, choose **Add ARN** for **object**.

09. In the **Add ARN(s)** dialog box, provide the details
     about your resource.
...
10. (Optional) Choose **Add ARN** for **bucket** to add another Amazon S3 bucket
    ...
    to all buckets and objects in Amazon S3.

11. Choose **Review policy**.

12. For **Name**, enter a name for your IAM policy, for
...
14. Complete the steps in [Creating an IAM role to allow Amazon Aurora to access AWS services](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Integrating.Authorizing.IAM.CreateRole.html).
