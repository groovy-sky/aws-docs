---
title: "Managing high object counts in Amazon Aurora PostgreSQL"
---
...
You can access unlogged tables only from the writer node in the Aurora DB cluster. See [Working with unlogged tables in Aurora PostgreSQL](aurora-postgresql-unlogged-tables.md) for full details.
