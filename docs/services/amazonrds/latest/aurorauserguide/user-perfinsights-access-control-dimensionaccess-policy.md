...
evaluation logic](../../../iam/latest/userguide/reference-policies-evaluation-logic.md) in the _IAM User Guide_. If the IAM
policy statement doesn't specify any dimension, then the statement controls access to
all the dimensions for the specified action. For the list of available dimensions, see [DimensionGroup](../../../../reference/performance-insights/latest/apireference/api-dimensiongroup.md).
