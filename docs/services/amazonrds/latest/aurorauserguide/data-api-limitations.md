...
some data types. For the list of supported types, see [Comparing Amazon RDS Data API behaviors for Aurora Serverless v2 and provisioned clusters with Aurora Serverless v1 clusters](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/data-api.differences.html).
