---
title: "Specifying the RAM disk for the stats_temp_directory"
---
...
so that the change takes effect. For information about setting parameters, see [Parameter groups for Amazon Aurora](user-workingwithparamgroups.md).
For more information about restarting the DB cluster, see [Rebooting an Amazon Aurora DB cluster or Amazon Aurora DB instance](user-rebootcluster.md).
