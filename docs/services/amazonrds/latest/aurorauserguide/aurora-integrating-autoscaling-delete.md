...
To delete a scaling policy from your Aurora DB cluster, use the [`delete-scaling-policy`](../../../cli/latest/reference/application-autoscaling/delete-scaling-policy.md)
...
To delete a scaling policy from your Aurora DB cluster, use the [`DeleteScalingPolicy`](../../../../reference/applicationautoscaling/latest/apireference/api-deletescalingpolicy.md) the Application Auto Scaling API operation with the following parameters:
