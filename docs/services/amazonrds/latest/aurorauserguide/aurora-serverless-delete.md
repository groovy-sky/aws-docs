...
[Configuration\
basics](../../../cli/latest/userguide/cli-configure-quickstart.md#cli-configure-quickstart-config) in the AWS Command Line Interface User Guide.
...
[modify-db-cluster](../../../cli/latest/reference/rds/modify-db-cluster.md) AWS CLI command as shown in
the following:
...
[delete-db-cluster](../../../cli/latest/reference/rds/delete-db-cluster.md) shows you how. You provide
