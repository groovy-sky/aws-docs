...
circumstances and avoid plan regressions. For more information, see [Best practices for Aurora PostgreSQL query plan management](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.BestPractice.html).
...
capture a plan without actually running it. For more information, see [Analyzing the optimizer's chosen plan](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.UsePlans.html#AuroraPostgreSQL.Optimize.UsePlans.AnalyzePlans). To learn more
about query plan management's modes (manual, automatic), see [Capturing Aurora PostgreSQL execution plans](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.CapturePlans.html).
...
between modes, see [Capturing Aurora PostgreSQL execution plans](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.CapturePlans.html).
...
02. Create a custom DB cluster parameter group for your Aurora PostgreSQL DB
     ...
     management and to set its behavior. For more information, see [Creating a DB parameter group in Amazon Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_WorkingWithParamGroups.Creating.html).
...
10. Change the `apg_plan_mgmt.capture_plan_baselines` parameter to
    ...
    you can use for specific SQL statements. To learn more, see [Capturing Aurora PostgreSQL execution plans](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.CapturePlans.html).
...
11. Change the value of `apg_plan_mgmt.use_plan_baselines`
     ...
     the statement from its plan baseline. To learn more, see [Using Aurora PostgreSQL managed plans](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.UsePlans.html).
...
3. Use the [apg\_plan\_mgmt.validate\_plans](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.Functions.html#AuroraPostgreSQL.Optimize.Functions.validate_plans)
...
To learn more about using this function, see [Validating plans](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.Deleting.html#AuroraPostgreSQL.Optimize.Maintenance.ValidatingPlans).

4. Use the [apg\_plan\_mgmt.reload](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.Functions.html#AuroraPostgreSQL.Optimize.Functions.reload) function to
...
To learn more about all functions available for query plan management, see [Function reference for Aurora PostgreSQL query plan management](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Optimize.Functions.html).
