...
For details, see [Aurora MySQL hints](auroramysql-reference-hints.md).
...
see [Scaling reads for your MySQL database with Amazon Aurora](auroramysql-replication-readscaling.md).
...
`UTC`. For more information, see [Modifying parameters in a DB cluster parameter groupin Amazon Aurora](user-workingwithparamgroups-modifyingcluster.md).
...
accessing error logs in Amazon Aurora, see [Monitoring Amazon Aurora log files](user-logaccess.md).
