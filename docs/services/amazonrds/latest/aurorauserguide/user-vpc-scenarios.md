...
![VPC scenario with a public web server and a private database.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/con-VPC-sec-grp-aurora.png)
...
subnets for this scenario, see [Tutorial: Create a VPC for use with a DB cluster (IPv4 only)](chap-tutorials-webserverdb-createvpc.md).
...
![Adding a security group to another security group's rules.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/con-vpc-add-sg-rule.png)
...
![A DB instance in a VPC accessed by an Amazon EC2 instance in a different VPC.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/RDSVPC2EC2VPC-aurora.png)
...
![A DB cluster in a VPC accessed by a client application through the internet.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/GS-VPC-network-aurora.png)
...
[Creating a DB cluster in a VPC](user-vpc-workingwithrdsinstanceinavpc.md#USER_VPC.InstanceInVPC).
...
![DB clusters in a VPC accessed by a private network.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/site-to-site-vpn-connection-aurora.png)

For more information, see [Internetwork traffic privacy](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/inter-network-traffic-privacy.html).
