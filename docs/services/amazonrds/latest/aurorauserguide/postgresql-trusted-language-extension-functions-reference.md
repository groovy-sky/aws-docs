...
only available feature is the `passcheck` hook. For more information, see [Password-check hook (passcheck)](postgresql-trusted-language-extension-hooks-reference.md#passcheck_hook).
...
extensions that you develop. For more information, see [Password-check hook (passcheck)](postgresql-trusted-language-extension-hooks-reference.md#passcheck_hook).
