...
information about these values, see `status` in [Reference for the apg\_plan\_mgmt.dba\_plans view for Aurora PostgreSQL-Compatible Edition](aurorapostgresql-optimize-dba-plans-view-reference.md).
