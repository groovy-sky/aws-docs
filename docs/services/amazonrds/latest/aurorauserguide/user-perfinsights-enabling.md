...
see [Overview of the Performance Schema for Performance Insights on Aurora MySQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.EnableMySQL.html).
...
see [Monitoring an Amazon Aurora global database with Amazon RDS Performance Insights](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-global-database-monitoring.html#aurora-global-database-pi).
...
For more information, see [Changing an AWS KMS policy for Performance Insights](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.access-control.cmk-policy.html).
...
is `7` days. For more information about retention periods, see [Pricing and data retention for Performance Insights](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.Overview.cost.html).
