...
and helps you to access them across multiple DB instances and AWS Regions. For details, see [High availability for Amazon Aurora](concepts-aurorahighavailability.md).
