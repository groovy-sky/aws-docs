...
AWS CLI [describe-db-clusters](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-clusters.html) command and look at the value returned in
...
time for a DB cluster, use the AWS CLI [describe-db-clusters](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-clusters.html) command
...
information, see [Restoring an Aurora Serverless v1 DB cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless.restorefromsnapshot.html).
...
AWS Backup, that backup plan is used for point-in-time recovery. For information, see [Restoring a DB cluster to a specified time using AWS Backup](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-pitr-bkp.html).
...
- [Restoring a DB cluster to a specified time from a retained automated backup](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-pitr-retained.html)

- [Restoring a DB cluster to a specified time using AWS Backup](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-pitr-bkp.html)
...
To restore a DB cluster to a specified time, use the AWS CLI command [restore-db-cluster-to-point-in-time](https://docs.aws.amazon.com/cli/latest/reference/rds/restore-db-cluster-to-point-in-time.html) to create a
new DB cluster.
...
[`RestoreDBClusterToPointInTime`](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_RestoreDBClusterToPointInTime.html) operation with the following parameters:
