...
![Selected widget with menu to view in CloudWatch](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/PI-ExprtToCW-SelectedMetric.png)
