...
![Export to CloudWatch window with add to existing dashboard option selected](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/Pi-ExprtToCW-AddToExistingBoard.png)
