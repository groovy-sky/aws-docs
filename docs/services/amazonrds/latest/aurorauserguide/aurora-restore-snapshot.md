...
information, see [AWS::RDS::DBCluster](../../../cloudformation/latest/userguide/aws-resource-rds-dbcluster.md) in the _AWS CloudFormation User Guide_.
...
taking a copy of it and restoring from that. For more information, see [Sharing a DB cluster snapshot](aurora-share-snapshot.md).
...
data to an Aurora MySQL parallel query-enabled cluster. For more information, see [Parallel query for Amazon Aurora MySQL](aurora-mysql-parallel-query.md).
...
Call the [create-db-instance](../../../cli/latest/reference/rds/create-db-instance.md) AWS CLI command to create the primary instance
...
[RestoreDBClusterFromSnapshot](../../../../reference/amazonrds/latest/apireference/api-restoredbclusterfromsnapshot.md) with the following parameters:
