...
see [Getting information from the Babelfish system catalog](babelfish-query-database.md).
...
Database user (non-DBO) who owns the schema can do the
following:SQL ServerBabelfish

Create objects in the schema without additional grants by the
DBO?
