...
events and tuning your Aurora PostgreSQL DB cluster, see [Tuning with wait events for Aurora PostgreSQL](aurorapostgresql-tuning.md).
...
more information, see [Client:ClientRead](apg-waits-clientread.md).

**Client:ClientWrite**

A backend process is waiting to send more data to a PostgreSQL client. For
more information, see [Client:ClientWrite](apg-waits-clientwrite.md).
...
information, see [CPU](apg-waits-cpu.md).
...
information, see [IO:BufFileRead and IO:BufFileWrite](apg-waits-iobuffile.md).
...
it, and so read it from storage. For more information, see [IO:DataFileRead](apg-waits-iodatafileread.md).
...
of a prepared transaction. For more information, see [IO:XactSync](apg-waits-xactsync.md).
...
waiting for the event to become durable. For more information, see [IPC:DamRecordTxAck](apg-waits-ipcdamrecordtxac.md).
...
more information, see [Lock:advisory](apg-waits-lockadvisory.md).
...
extend a relation at a time. For more information, see [Lock:extend](apg-waits-lockextend.md).
...
locked by another transaction. For more information, see [Lock:Relation](apg-waits-lockrelation.md).
...
information, see [Lock:tuple](apg-waits-locktuple.md).
...
of a shared memory buffer. For more information, see [LWLock:buffer\_content (BufferContent)](apg-waits-lockbuffercontent.md).

**LWLock:buffer\_mapping**

A backend process is waiting to associate a data block with a buffer in
the shared buffer pool. For more information, see [LWLock:buffer\_mapping](apg-waits-lwl-buffer-mapping.md).
...
information, see [LWLock:BufferIO (IPC:BufferIO)](apg-waits-lwlockbufferio.md).
...
parallel query. For more information, see [LWLock:lock\_manager](apg-waits-lw-lock-manager.md).
...
A process is waiting for I/O on a simple least-recently used (SLRU) buffer
for a multixact member. For more information, see [LWLock:MultiXact](apg-waits-lwlockmultixact.md).
...
A process is waiting for I/O on a simple least-recently used (SLRU) buffer
for a multixact offset. For more information, see [LWLock:MultiXact](apg-waits-lwlockmultixact.md).
...
sleep timeout to expire. For more information, see [Timeout:PgSleep](apg-waits-timeoutpgsleep.md).
...
For a complete list of PostgreSQL wait events, see [The Statistics Collector > Wait Event tables](https://www.postgresql.org/docs/current/monitoring-stats.html) in the PostgreSQL
documentation.
