...
- **By using the AWS CLI** – Call the [modify-db-cluster](../../../cli/latest/reference/rds/modify-db-cluster.md) AWS CLI command, and specify the name of your DB cluster for the
