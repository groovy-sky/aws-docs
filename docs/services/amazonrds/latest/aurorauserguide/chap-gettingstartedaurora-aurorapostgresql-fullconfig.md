...
![EC2 instance and Aurora PostgreSQL DB cluster.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/getting-started-aurora-postgresql.png)

This tutorial allows you to create your resources by using one of the following methods:

1. Use the AWS Management Console ‐
    [Step 1: Create an EC2 instance](#CHAP_GettingStarted.Creating.AuroraPostgreSQL.EC2) and
...
For information, see [Creating an Amazon Aurora DB cluster](aurora-createinstance.md).
...
04. Choose **Create database**, and make sure that **Easy create** is chosen.
    ...
    ![Create database section: Easy create option selected.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/easy-create-option.png)

05. In **Configuration**, choose **Aurora (PostgreSQL**
    **Compatible)** for **Engine type**.
...
07. For **DB cluster identifier**, enter `database-test1`.
    ...
    ![Configuration section with selections.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/easy-create-aurora-postgresql.png)

08. For **Master username**, enter a name for the user, or
     keep the default name ( `postgres`).

09. To use an automatically generated master password for the DB cluster, select **Auto generate a**
    **password**.
...
11. Open **View default settings for Easy create**.
    ...
    ![Easy create default settings.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/easy-create-view-default-settings-aurora-postgresql.png)
...
12. Choose **Create database**.
    ...
    so. For more information about modifying a DB cluster, see [Modifying an Amazon Aurora DB cluster](aurora-modifying.md).

13. In the **Databases** list, choose the name of the new Aurora PostgreSQL
     DB cluster to show its details.

    The writer instance has a status of **Creating** until the
     DB cluster is ready to use.

    ![DB cluster details showing Region & AZ and Status.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/creating-status-aurora-postgresql.png)
...
01. Set **Stack name** to **AurPostgreSQLTestStack**.
...
05. Under **Database General configuration**, set **Database instance class** to **db.t4g.large**.
...
5. On the **Connectivity & security** tab, copy the endpoint
      ...
      ![Connectivity & security tab showing endpoint name.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/AuroraPostgreSQLLaunch01.png)
...
For more information about connecting to an Aurora PostgreSQL DB cluster, see [Connecting to an Amazon Aurora PostgreSQL DB cluster](aurora-connecting.md#Aurora.Connecting.AuroraPostgreSQL). If you can't connect to your DB cluster, see
...
For security, it is a best practice to use encrypted connections. Only use an unencrypted PostgreSQL
    ...
    using encrypted connections, see [Securing Aurora PostgreSQL data with SSL/TLS](aurorapostgresql-security.md#AuroraPostgreSQL.Security.SSL).
