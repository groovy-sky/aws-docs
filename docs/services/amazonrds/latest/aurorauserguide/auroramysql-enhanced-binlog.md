...
For more information, see [Configuring Aurora MySQL binary logging](user-logaccess-mysql-binaryformat.md).`aurora_enhanced_binlog``0`Set the value of this parameter to `1`
