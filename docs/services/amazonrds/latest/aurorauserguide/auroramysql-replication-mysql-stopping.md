...
target, and call the [mysql.rds\_stop\_replication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_stop_replication)
procedure.
...
Connect to the RDS DB instance that is the replica target and call the [mysql.rds\_stop\_replication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_stop_replication)
procedure.
...
2. Use the [mysql.rds\_set\_configuration](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-configuring.html#mysql_rds_set_configuration) procedure and specify the configuration
