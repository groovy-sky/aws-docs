...
see
[Supported Regions and Aurora DB engines for Performance Insights](concepts-aurora-fea-regions-db-eng-feature-perfinsights.md).
...
[Aurora IP addressing](user-vpc-workingwithrdsinstanceinavpc.md#USER_VPC.IP_addressing).
