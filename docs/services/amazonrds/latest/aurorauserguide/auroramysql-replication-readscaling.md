...
the [mysql.rds\_set\_external\_master (Aurora MySQL version 2)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_set_external_master) or [mysql.rds\_set\_external\_source (Aurora MySQL version 3)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_set_external_source) and [mysql.rds\_start\_replication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_start_replication) procedures to set up
...
05. In the Amazon RDS Management Console, add the IP address of the server that
     ...
     group, see [Security\
     groups for your VPC](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html) in the _Amazon Virtual Private Cloud User_
    _Guide_.
...
09. Make the Amazon Aurora DB cluster the replica. Connect to the Amazon Aurora DB
     ...
     replication source by using the [mysql.rds\_set\_external\_master (Aurora MySQL version 2)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_set_external_master) or [mysql.rds\_set\_external\_source (Aurora MySQL version 3)](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_set_external_source) and [mysql.rds\_start\_replication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_start_replication) procedures.
...
10. On the Amazon Aurora DB cluster, call the [mysql.rds\_start\_replication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/mysql-stored-proc-replicating.html#mysql_rds_start_replication) procedure to start
     replication.
