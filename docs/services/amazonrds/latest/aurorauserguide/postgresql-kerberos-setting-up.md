---
title: "Setting up Kerberos authentication for PostgreSQL DB clusters"
---
...
endpoint rather than rds.amazonaws.com. For more information, see [Connecting to PostgreSQL with Kerberos authentication](postgresql-kerberos-connecting.md).
...
[create-db-cluster](../../../cli/latest/reference/rds/create-db-cluster.md) CLI command, or the [CreateDBCluster](../../../../reference/amazonrds/latest/apireference/api-createdbcluster.md) RDS
...
the [modify-db-cluster](../../../cli/latest/reference/rds/modify-db-cluster.md) CLI command, or the [ModifyDBCluster](../../../../reference/amazonrds/latest/apireference/api-modifydbcluster.md) RDS
...
console, the [restore-db-cluster-from-db-snapshot](../../../cli/latest/reference/rds/restore-db-cluster-from-snapshot.md) CLI command, or the [RestoreDBClusterFromDBSnapshot](../../../../reference/amazonrds/latest/apireference/api-restoredbclusterfromsnapshot.md) RDS API operation. For
...
console, the [restore-db-instance-to-point-in-time](../../../cli/latest/reference/rds/restore-db-cluster-to-point-in-time.md) CLI command, or the [RestoreDBClusterToPointInTime](../../../../reference/amazonrds/latest/apireference/api-restoredbclustertopointintime.md) RDS API operation. For
