...
![Directory details page](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/WinAuth2.png)
...
![Image of details page](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/WinAuth3.png)
...
skip to [Step 3: Create an IAM role for Amazon Aurora to access the Directory Service](#postgresql-kerberos-setting-up.CreateIAMRole).
...
a trust relationship](https://docs.aws.amazon.com/directoryservice/latest/admin-guide/ms_ad_setup_trust.html) in the
...
endpoint rather than rds.amazonaws.com. For more information, see [Connecting to PostgreSQL with Kerberos authentication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/postgresql-kerberos-connecting.html).

- Windows clients can't connect using Aurora custom endpoints. To
learn more, see [Amazon Aurora endpoint connections](aurora-overview-endpoints.md).
...
than the IAM role used for [IAM database authentication](usingwithrds-iamdbauth.md).)
...
permissions to an AWS service](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-service.html) in the
_IAM User Guide_.
...
user](https://docs.aws.amazon.com/directoryservice/latest/admin-guide/ms_ad_manage_users_groups_create_user.html) in the _AWS Directory Service Administration Guide_.
...
move on to [Step 6: Create or modify a PostgreSQL DB cluster](#postgresql-kerberos-setting-up.create-modify).
...
Gateway](https://docs.aws.amazon.com/vpc/latest/tgw/what-is-transit-gateway.html).
...
1. Start sharing the directory with the AWS account that the DB instance
    ...
    Domain-join](https://docs.aws.amazon.com/directoryservice/latest/admin-guide/ms_ad_tutorial_directory_sharing.html) in the _Directory Service Administration_
_Guide_.
...
[create-db-cluster](https://docs.aws.amazon.com/cli/latest/reference/rds/create-db-cluster.html) CLI command, or the [CreateDBCluster](../../../../reference/amazonrds/latest/apireference/api-createdbcluster.md) RDS
API operation. For instructions, see [Creating and connecting to an Aurora PostgreSQL DB cluster](chap-gettingstartedaurora-creatingconnecting-aurorapostgresql.md).

- Modify an existing PostgreSQL DB cluster using the console,
the [modify-db-cluster](https://docs.aws.amazon.com/cli/latest/reference/rds/modify-db-cluster.html) CLI command, or the [ModifyDBCluster](../../../../reference/amazonrds/latest/apireference/api-modifydbcluster.md) RDS
API operation. For instructions, see [Modifying an Amazon Aurora DB cluster](aurora-modifying.md).

- Restore a PostgreSQL DB cluster from a DB snapshot using the
console, the [restore-db-cluster-from-db-snapshot](https://docs.aws.amazon.com/cli/latest/reference/rds/restore-db-cluster-from-snapshot.html) CLI command, or the [RestoreDBClusterFromDBSnapshot](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_RestoreDBClusterFromSnapshot.html) RDS API operation. For
instructions, see [Restoring from a DB cluster snapshot](aurora-restore-snapshot.md).

- Restore a PostgreSQL DB cluster to a point-in-time using the
console, the [restore-db-instance-to-point-in-time](https://docs.aws.amazon.com/cli/latest/reference/rds/restore-db-cluster-to-point-in-time.html) CLI command, or the [RestoreDBClusterToPointInTime](../../../../reference/amazonrds/latest/apireference/api-restoredbclustertopointintime.md) RDS API operation. For
instructions, see [Restoring a DB cluster to a specified time](aurora-pitr.md).
...
![Choosing Kerberos for authentication and identifying the directory to use.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/rpg-authentication-use-kerberos.png)
...
more information, see [IAM database authentication](usingwithrds-iamdbauth.md).
...
working with a custom DB cluster parameter group, see [Parameter groups for Amazon Aurora](user-workingwithparamgroups.md).

You can use the AWS CLI or the AWS Management Console to change the setting. For more
information, see [Modifying parameters in a DB cluster parameter groupin Amazon Aurora](user-workingwithparamgroups-modifyingcluster.md).
