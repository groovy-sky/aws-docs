---
title: "Precheck descriptions for upgrading Aurora MySQL version 2 to version 3"
---
...
8.0). For prechecks that run during upgrades from Aurora MySQL version 3 to version 8.4, see [Precheck descriptions for upgrading Aurora MySQL version 3 to version 8.4](auroramysql-upgrade-prechecks-v3-to-v84-descriptions.md).
