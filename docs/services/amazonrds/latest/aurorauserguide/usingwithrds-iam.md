---
title: "Identity and access management for Amazon Aurora"
---
...
- [How Amazon Aurora works with IAM](security-iam-service-with-iam.md)
...
Aurora, see [Troubleshooting Amazon Aurora identity and access](security-iam-troubleshoot.md).
...
basic concepts of IAM. To learn more about how your company can use IAM with Aurora, see [How Amazon Aurora works with IAM](security-iam-service-with-iam.md).

**Administrator** – If you're an administrator, you might want to learn details about how you can
write policies to manage access to Aurora. To view example Aurora identity-based policies that you can use in IAM, see [Identity-based policy examples for Amazon Aurora](security-iam-id-based-policy-examples.md).
...
using IAM, see [IAM database authentication](usingwithrds-iamdbauth.md).
