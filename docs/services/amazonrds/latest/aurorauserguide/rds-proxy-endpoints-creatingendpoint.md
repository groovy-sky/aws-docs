...
07. For **Virtual Private Cloud (VPC)**, choose the default to
     ...
     cross-VPC access, see [Accessing Aurora databases across VPCs](rds-proxy-endpoints.md#rds-proxy-cross-vpc).
...
[Using reader endpoints with Aurora clusters](rds-proxy-endpoints.md#rds-proxy-endpoints-reader)
.
