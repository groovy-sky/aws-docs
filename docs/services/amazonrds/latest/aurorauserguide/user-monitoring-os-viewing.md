...
page. For descriptions of the Enhanced Monitoring metrics, see [OS metrics in Enhanced Monitoring](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_Monitoring-Available-OS-Metrics.html).

![Dashboard view](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/metrics1.png)
...
![Process list view](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/metrics2.png)
...
more information, see [Viewing OS metrics using CloudWatch Logs](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_Monitoring.OS.CloudWatchLogs.html).
