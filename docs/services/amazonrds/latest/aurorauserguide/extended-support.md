...
You can only enroll a database in RDS Extended Support by enabling RDS Extended Support when you first [create](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-creating-db-instance.html) or [restore](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-restoring-db-instance.html) a DB instance. You can't
...
the RDS end of Extended Support dates, see [Release calendar for Aurora MySQL major versions](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraMySQLReleaseNotes/AuroraMySQL.release-calendars.html#AuroraMySQL.release-calendars.major) and [Release calendar for Aurora PostgreSQL major versions](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/aurorapostgresql-release-calendar.html#aurorapostgresql.major.versions.supported).

###### Topics

- [Overview of Amazon RDS Extended Support](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-overview.html)

- [Amazon RDS Extended Support charges](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-charges.html)

- [Versions with Amazon RDS Extended Support](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-versions.html)

- [Amazon Aurora and customer responsibilities with Amazon RDS Extended Support](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-responsibilities.html)

- [Creating an Aurora DB cluster or a global cluster with Amazon RDS Extended Support](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-creating-db-instance.html)

- [Viewing the enrollment of your Aurora DB clusters or global clusters in Amazon RDS Extended Support](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-viewing.html)

- [Viewing support dates for engine versions in Amazon RDS Extended Support](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-viewing-support-dates.html)

- [Restoring an Aurora DB cluster or a global cluster with Amazon RDS Extended Support](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/extended-support-restoring-db-instance.html)
