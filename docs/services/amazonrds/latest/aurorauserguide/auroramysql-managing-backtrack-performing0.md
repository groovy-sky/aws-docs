...
- Call the [backtrack-db-cluster](../../../cli/latest/reference/rds/backtrack-db-cluster.md) AWS CLI command and supply
...
[BacktrackDBCluster](../../../../reference/amazonrds/latest/apireference/api-backtrackdbcluster.md) operation. This operation backtracks the DB
