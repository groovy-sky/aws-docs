---
title: "Logical migration from MySQL to Amazon Aurora MySQL by using mysqldump"
---
...
reduced downtime](../userguide/mariadb-importing-data-reduced-downtime.md)
...
an Amazon RDS for MySQL DB instance](../userguide/mysql-importing-data-external-database.md)

- MariaDB – [Importing data from an external MariaDB database to \
an Amazon RDS for MariaDB DB instance](../userguide/mariadb-importing-data-external-database.md)
