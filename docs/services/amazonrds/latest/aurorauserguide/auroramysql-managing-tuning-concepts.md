...
Reference Manual](https://dev.mysql.com/doc/refman/8.0/en/innodb-architecture.html).
...
states, see [General\
Thread States](https://dev.mysql.com/doc/refman/5.7/en/general-thread-states.html) in the _MySQL Reference Manual_.
...
information, see [Overview of the Performance Schema for Performance Insights on Aurora MySQL](user-perfinsights-enablemysql.md).
