...
It's also possible that the specified transaction ID wasn't created by a [BeginTransaction](../../../../reference/rdsdataservice/latest/apireference/api-begintransaction.md) call. Make sure that your call has a
...
[`ExecuteStatement`](../../../../reference/rdsdataservice/latest/apireference/api-executestatement.md) calls
