...
information on how to work around this issue, see [Sharing encrypted snapshots](share-encrypted-snapshot.md).
...
[`describe-db-cluster-snapshot-attributes`](../../../cli/latest/reference/rds/describe-db-cluster-snapshot-attributes.md)
AWS CLI command.

You can also share a manual DB cluster snapshot with other AWS accounts by
using the Amazon RDS API. To do so, call the
[`ModifyDBClusterSnapshotAttribute`](../../../../reference/amazonrds/latest/apireference/api-modifydbclustersnapshotattribute.md)
...
[`DescribeDBClusterSnapshotAttributes`](../../../../reference/amazonrds/latest/apireference/api-describedbclustersnapshotattributes.md)
API operation.
