...
![In pgadmin, choose AUTOCOMMIT to turn it on.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/apg-insight-pgadmin-autocommit.png)
