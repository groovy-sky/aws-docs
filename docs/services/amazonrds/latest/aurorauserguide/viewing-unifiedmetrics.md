...
For more information about turning on Performance Insights, see [Turning Performance Insights on and off for Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.Enabling.html).

In the following sections, you can learn to display Performance Insights and CloudWatch metrics.

###### Topics

- [Choosing the new monitoring view from the Monitoring tab](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Viewing_Unifiedmetrics.MonitoringTab.html)

- [Choosing the new monitoring view from the Performance Insights page](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Viewing_Unifiedmetrics.PInavigationPane.html)

- [Creating a custom dashboard with Performance Insights](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Viewing_Unifiedmetrics.PIcustomizeMetricslist.html)

- [Choosing the preconfigured dashboard with Performance Insights](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Viewing_Unifiedmetrics.PI-preconfigured-dashboard.html)
