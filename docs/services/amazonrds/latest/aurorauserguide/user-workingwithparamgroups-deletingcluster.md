---
title: "Deleting a DB cluster parameter groupin Amazon Aurora"
---
...
To delete a DB cluster parameter group, use the AWS CLI [`delete-db-cluster-parameter-group`](../../../cli/latest/reference/rds/delete-db-cluster-parameter-group.md) command with the
...
To delete a DB cluster parameter group, use the RDS API [`DeleteDBClusterParameterGroup`](../../../../reference/amazonrds/latest/apireference/api-deletedbclusterparametergroup.md) command with the
following required parameter.
