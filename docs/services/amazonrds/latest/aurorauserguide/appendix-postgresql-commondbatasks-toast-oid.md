---
title: "Managing TOAST OID contention in Amazon Aurora PostgreSQL"
---
...
information, see [LWLock:BufferIO wait event troubleshooting guide](apg-waits-lwlockbufferio.md).
