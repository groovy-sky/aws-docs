...
To get a high-level view of how Amazon Aurora and other AWS services work with IAM, see [AWS services that work with IAM](../../../iam/latest/userguide/reference-aws-services-that-work-with-iam.md) in the
_IAM User Guide_.
...
see [Identity-based policy examples for Amazon Aurora](security-iam-id-based-policy-examples.md).
...
To see a list of Aurora actions, see [Actions Defined by Amazon RDS](../../../service-authorization/latest/reference/list-amazonrds.md#amazonrds-actions-as-permissions) in the
...
To see a list of Aurora condition keys, see [Condition Keys for Amazon RDS](../../../service-authorization/latest/reference/list-amazonrds.md#amazonrds-policy-keys)
...
see [Using service-linked roles for Amazon Aurora](usingwithrds-iam-servicelinkedroles.md).
