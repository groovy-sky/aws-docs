...
available with Directory Service. To learn more, see [What is Directory Service?](https://docs.aws.amazon.com/directoryservice/latest/admin-guide/what_is.html) in the
...
- [Overview of Kerberos authentication for Aurora MySQL DB clusters](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos.html#aurora-mysql-kerberos-setting-up-overview)

- [Limitations of Kerberos authentication for Aurora MySQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos.html#aurora-mysql-kerberos.limitations)

- [Setting up Kerberos authentication for Aurora MySQL DB clusters](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html)

  - [Step 1: Create a directory using AWS Managed Microsoft AD](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.create-directory)

  - [Step 2: (Optional) Create a trust for an on-premises Active Directory](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.create-trust)

  - [Step 3: Create an IAM role for use by Amazon Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.CreateIAMRole)

  - [Step 4: Create and configure users](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.create-users)

  - [Step 5: Create or modify an Aurora MySQL DB cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.create-modify)

  - [Step 6: Create Aurora MySQL users that use Kerberos authentication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.create-logins)

    - [Modifying an existing Aurora MySQL login](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos.modify-login)
  - [Step 7: Configure a MySQL client](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.configure-client)

  - [Step 8: (Optional) Configure case-insensitive username comparison](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.case-insensitive)
- [Connecting to Aurora MySQL with Kerberos authentication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-connecting.html)

  - [Using the Aurora MySQL Kerberos login to connect to the DB cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-connecting.html#aurora-mysql-kerberos-connecting.login)

  - [Kerberos authentication with Aurora global databases](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-connecting.html#aurora-mysql-kerberos-connecting.global)

  - [Migrating from RDS for MySQL to Aurora MySQL](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-connecting.html#aurora-mysql-kerberos-connecting.rds)

  - [Preventing ticket caching](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-connecting.html#aurora-mysql-kerberos.destroy-tickets)

  - [Logging for Kerberos authentication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-connecting.html#aurora-mysql-kerberos.logging)
- [Managing a DB cluster in a domain](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-managing.html)

  - [Understanding domain membership](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-managing.html#aurora-mysql-kerberos-managing.understanding)
...
1. Use AWS Managed Microsoft AD to create an AWS Managed Microsoft AD directory. You can use the AWS Management Console, the
    ...
    [Create your AWS Managed Microsoft AD directory](https://docs.aws.amazon.com/directoryservice/latest/admin-guide/ms_ad_getting_started_create_directory.html) in the _AWS Directory Service Administration Guide_.
...
For the role to allow access, the AWS Security Token Service (AWS STS) endpoint must be activated in the
    ...
    information, see [Activating and deactivating AWS STS in an AWS Region](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html#sts-regions-activate-deactivate) in the
    _IAM User Guide_.
...
3. Create and configure users in the AWS Managed Microsoft AD directory using the Microsoft Active Directory tools. For more information about
    ...
    groups in AWS managed Microsoft AD](https://docs.aws.amazon.com/directoryservice/latest/admin-guide/ms_ad_manage_users_groups.html) in the _AWS Directory Service Administration Guide_.
...
5. Use the Amazon RDS primary user credentials to connect to the Aurora MySQL DB cluster. Create
    the database user in Aurora MySQL by using the instructions in [Step 6: Create Aurora MySQL users that use Kerberos authentication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.create-logins).

Users that you create this way can log in to the Aurora MySQL DB cluster using Kerberos authentication. For more
    information, see [Connecting to Aurora MySQL with Kerberos authentication](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-connecting.html).
...
For more information about setting up forest trusts using Directory Service, see [When to create a trust relationship](https://docs.aws.amazon.com/directoryservice/latest/admin-guide/ms_ad_setup_trust.html) in the
_AWS Directory Service Administration Guide_.
...
For more information, see [Step 8: (Optional) Configure case-insensitive username comparison](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-mysql-kerberos-setting-up.html#aurora-mysql-kerberos-setting-up.case-insensitive).
