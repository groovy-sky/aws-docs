...
particular, the VPC for the EC2 instance must be the same as the VPC for the RDS DB instanceAurora cluster that the proxy connects to.
...
for your instance class, see [Planning for IP address capacity](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/rds-proxy-network-prereqs.html#rds-proxy-network-prereqs.plan-ip-address).
...
Add a Secrets Manager secret for this role. For more information, see [Configuring IAM authentication for RDS Proxy](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/rds-proxy-iam-setup.html).
...
- Avoid pinning proxy connections. See [Avoiding pinning an RDS Proxy](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/rds-proxy-pinning.html).

- Review `ConnectionBorrowTimeout` and
`MaxConnectionsPercent` settings. See [RDS Proxy connection considerations](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/rds-proxy-connections.html).
