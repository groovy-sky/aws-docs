...
actions on your behalf. For more information, see [Service-linked role permissions for Amazon Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAM.ServiceLinkedRoles.html#service-linked-role-permissions).
...
[Service-linked role for Amazon RDS Preview](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAM.ServiceLinkedRoles.html#slr-permissions-rdspreview).
...
entities. This policy is attached to a service-linked role that allows Amazon RDS to
call AWS services on behalf of your RDS DB resources. For more information, see
[Service-linked role permissions for Amazon RDS Beta](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAM.ServiceLinkedRoles.html#slr-permissions-rdsbeta).
