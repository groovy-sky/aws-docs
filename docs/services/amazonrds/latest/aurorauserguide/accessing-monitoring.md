...
To view DB cluster information by using the AWS CLI, use the [describe-db-clusters](../../../cli/latest/reference/rds/describe-db-clusters.md) command. For example, the
...
To view DB cluster information using the Amazon RDS API, use the [DescribeDBClusters](../../../../reference/amazonrds/latest/apireference/api-describedbclusters.md) operation.
...
status, see [Applying updates to a DB cluster](user-upgradedbinstance-maintenance.md#USER_UpgradeDBInstance.OSUpgrades).
...
For more information, see [Encrypting an Amazon Aurora DB cluster](overview-encryption.md#Overview.Encryption.Enabling).
...
about maintenance status, see [Applying updates to a DB cluster](user-upgradedbinstance-maintenance.md#USER_UpgradeDBInstance.OSUpgrades).
