...
- [Turn on the Performance Schema for Aurora MySQL](user-perfinsights-enablemysql-rds.md)
...
If you change the `performance_schema` parameter value manually, and then later want to change to automatic management, see [Turn on the Performance Schema for Aurora MySQL](user-perfinsights-enablemysql-rds.md).
