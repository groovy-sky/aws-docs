...
logs. For more information, see [Monitoring Amazon Aurora metrics with Amazon CloudWatch](monitoring-cloudwatch.md).
...
timeframes. To learn how, see [Aurora PostgreSQL database log files](user-logaccess-concepts-postgresql.md).
