...
For information on using Amazon CloudWatch metrics to monitor your Aurora DB instance throughput, see [Evaluating DB instance usage for Aurora MySQL with Amazon CloudWatch metrics](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.BestPractices.CW.html) and [Evaluating DB instance usage for Aurora PostgreSQL with CloudWatch metrics](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL_AnayzeResourceUsage.html#AuroraPostgreSQL_AnayzeResourceUsage.EvaluateInstanceUsage).
