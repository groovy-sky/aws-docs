...
Programmatically and In the Console](../../../iam/latest/userguide/reference-policies-examples-s3-home-directory-console.md) in the
_IAM User Guide_.

- You can enable file versioning for content stored in Amazon S3 buckets used
by WorkSpaces Applications. For more information, see [Using Versioning](../../../s3/latest/userguide/versioning.md).
