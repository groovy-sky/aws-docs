...
2. WorkSpaces Applications sends them a welcome email.

3. You assign one or more stacks to the users.

4. WorkSpaces Applications sends them an optional notification email. This email includes
...
6. They sign in to WorkSpaces Applications by entering their email address and permanent password.
