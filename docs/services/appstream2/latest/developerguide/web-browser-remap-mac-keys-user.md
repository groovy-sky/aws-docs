...
You can remap this Mac keyTo this key during a streaming session

Option key

![Keyboard key labeled "option" representing a modifier key on Apple keyboards.](https://docs.aws.amazon.com/images/appstream2/latest/developerguide/images/mac-option-key.png)
...
![Key labeled "command" on a keyboard, typically found on Apple devices.](https://docs.aws.amazon.com/images/appstream2/latest/developerguide/images/mac-command-key.png)
...
![Preferences window showing display, resolution, and keyboard settings options.](https://docs.aws.amazon.com/images/appstream2/latest/developerguide/images/Preferences-new.png)
