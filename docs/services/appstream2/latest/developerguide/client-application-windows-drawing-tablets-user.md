...
your streaming applications, you must connect to WorkSpaces Applications by using the
WorkSpaces Applications client and share the drawing tablet with your streaming session.
...
start an WorkSpaces Applications streaming session. You can use the WorkSpaces Applications client or a [supported web browser](web-browser-user.md) to start a streaming session.
