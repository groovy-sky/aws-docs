...
your laptop and a built-in webcam), you can also select one webcam from
**Active Webcam**.

If you have selected **Show Toolbar**, you can also enable or
disable the microphone and webcam by choosing the microphone or video icon. If
you have more than one webcam, you can select the down arrow next to the video
icon, and select one webcam to use.
...
configuration tasks, as described in [Real-Time Audio-Video](feature-support-real-time-av.md).
