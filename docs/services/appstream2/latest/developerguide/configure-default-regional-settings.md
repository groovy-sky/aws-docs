...
that are specific to their location or language. For more information, see [Enable Your WorkSpaces Applications Users to Configure Their Regional Settings](regional-settings.md). You can also configure
