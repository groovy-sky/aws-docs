...
You can no longer use Route 53 to register new .qa domains or transfer .qa
domains to Route 53. We'll continue to support .qa domains that are already
...
Not supported. You can no longer transfer .qa domains to
Route 53.
...
- Domain is deleted from the registry: 31 days after
expiration
