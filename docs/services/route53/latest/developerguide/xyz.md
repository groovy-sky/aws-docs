...
The registry for .xyz domains, Generation XYZ, considers some domain
names to be premium domain names. You can't register premium .xyz
domains with or transfer them to Route 53. For more information, see the
[Generation XYZ](https://gen.xyz/) website.
