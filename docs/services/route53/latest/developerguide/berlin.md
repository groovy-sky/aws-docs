...
- The owner, administrative, or technical contact must
provide an address in Berlin, and the administrative contact
must be an individual.

- You must activate and use your .berlin domain within 12
months following its registration (applies to a website,
redirection, or email address).

- If you publish a website under your .berlin domain, or if
your .berlin domain redirects to another website, the
content of the website must be related to Berlin.
...
- Domain is deleted from the registry: 80 days after
expiration
