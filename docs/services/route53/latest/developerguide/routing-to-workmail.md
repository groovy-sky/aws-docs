...
2. Add an Amazon WorkMail organization and email domain. For more information, see
    [Getting started for new users](https://docs.aws.amazon.com/workmail/latest/adminguide/getting_started_new_user.html) in the _Amazon WorkMail Administrator Guide_.
...
3. Open another browser tab, and open the [Route 53 console](https://console.aws.amazon.com/route53/home).
...
For example, if your Amazon WorkMail email domain is **example.com** and the value of **Hostname** is
    **\_amazonses.example.com**, copy **\_amazonses**.
...
For example, if your Amazon WorkMail email domain is **example.com** and the value of **Hostname** is
    **autodiscover.example.com**, copy **autodiscover**.
