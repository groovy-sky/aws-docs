...
- The owner or the administrative contact must provide a
valid address in the Netherlands. A local presence is
required.

- If you do not have a valid address in the Netherlands, the
Registry SIDN will provide you with a domicile address, as
per the Domicile Address Procedure.

- The domain name must be 3-63 characters, excluding
.nl.
...
before and 39 days after expiration

- Domain is deleted from the registry: 39 days after
expiration
