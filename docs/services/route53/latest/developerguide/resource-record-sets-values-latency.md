...
- You can't create non-latency records that have the same values for
**Record name** and **Record type** as
latency records.
...
Enter a value that uniquely identifies this record in the group of latency
records.
