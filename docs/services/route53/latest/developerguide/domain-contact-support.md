...
(See [Quotas](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DNSLimitations.html).)
...
1. Using the AWS account that the domain is currently registered to, sign in to the
    [AWS Support](https://console.aws.amazon.com/route53/home).
...
1. Go to the [I'm an AWS customer and I'm \
    looking for billing or account support](https://pages.awscloud.com/contact-us-account-support.html) page.
