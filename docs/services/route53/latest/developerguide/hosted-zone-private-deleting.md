...
If a private hosted zone was created by another service, you can't delete it using the Route 53 console. Instead, you need to use the
applicable process for the other service:

- **AWS Cloud Map** – To delete a hosted zone that AWS Cloud Map created when you created a private DNS namespace,
...
- **Amazon Elastic Container Service (Amazon ECS) Service Discovery** – To delete a private hosted zone that
