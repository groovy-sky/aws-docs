...
_www.example.com_. The trailing dot is optional; Route 53 assumes that the domain name
is fully qualified. This means that Route 53 treats _www.example.com_ (without a trailing dot)
and _www.example.com._ (with a trailing dot) as identical.
...
[Configure a CAA record](https://docs.aws.amazon.com/acm/latest/userguide/setup-caa.html) in the _AWS Certificate Manager User Guide_.
...
The following parameters are described in [RFC 9460, section 9.1](https://www.rfc-editor.org/rfc/rfc9460.html).
...
In [RFC 2181, Clarifications to the DNS Specification](https://tools.ietf.org/html/rfc2181), section 10.3
...
[https://tools.ietf.org/html/rfc3404#section-4.4](https://tools.ietf.org/html/rfc3404)

- **S-NAPTR DDDS application** –
[https://tools.ietf.org/html/rfc3958#section-6.5](https://tools.ietf.org/html/rfc3958)

- **U-NAPTR DDDS application** –
[https://tools.ietf.org/html/rfc4848#section-4.5](https://tools.ietf.org/html/rfc4848)
...
[RFC 3402, section 3.2, Substitution Expression Syntax](https://tools.ietf.org/html/rfc3402)
...
about the fields in an SOA record, see [NS and SOA records that Amazon Route 53 creates for a public hosted zone](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/SOA-NSrecords.html).
...
[The SPF DNS Record Type](http://tools.ietf.org/html/rfc7208).
...
The following parameters are described in [RFC 9460, section 2.3](https://www.rfc-editor.org/rfc/rfc9460.html).
...
The following parameters are specified in [RFC 6698, section 3](https://datatracker.ietf.org/doc/html/rfc6698).
...
[routing policy](routing-policy.md), include all values for a domain (example.com) or
...
"ASCII octal codes." One useful reference is [ASCII Code - The extended ASCII table](https://www.ascii-code.com/).
