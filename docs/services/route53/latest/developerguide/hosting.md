...
You can no longer use Route 53 to register new .hosting domains or transfer
.hosting domains to Route 53. We'll continue to support .hosting domains that are
...
Not supported. You can no longer transfer .hosting domains to
Route 53.
