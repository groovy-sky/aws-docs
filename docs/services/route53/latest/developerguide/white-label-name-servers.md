...
- **Route 53 API** – See
[CreateReusableDelegationSet](../../../../reference/route53/latest/apireference/api-createreusabledelegationset.md) in the
_Amazon Route 53 API Reference_

- **AWS CLI** – See
[create-reusable-delegation-set](https://docs.aws.amazon.com/cli/latest/reference/route53/create-reusable-delegation-set.html) in the
_AWS CLI Command Reference_

- **AWS SDKs** See the applicable SDK documentation on the
[AWS Documentation](../../../../general/index.md) page
...
see [CreateHostedZone](../../../../reference/route53/latest/apireference/api-createhostedzone.md) in the
_Amazon Route 53 API Reference_.
...
for the hosted zones, see [CreateHostedZone](../../../../reference/route53/latest/apireference/api-createhostedzone.md)
...
see [Working with records](rrsets-working-with.md).
...
2. In the NS record, make note of the names of the current name servers for the domain, so you can revert
    to these name servers if necessary.

3. Update the NS record. Replace the name of the Route 53 name servers with the names of your
...
[Adding or changing name servers and glue records for a domain](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/domain-name-servers-glue-records.html).
