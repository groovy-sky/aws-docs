...
We recommend that you periodically check the dashboard in the Route 53 console, especially after you register a new domain or
...
Sharing Resolver query logging configs with other
accounts
