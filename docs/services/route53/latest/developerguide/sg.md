...
You can no longer use Route 53 to register new .sg domains or transfer .sg
domains to Route 53. We'll continue to support .sg domains that are already
...
Not supported. You can no longer transfer .sg domains to
Route 53.
...
The registry for .sg domains doesn't allow you to delete domain
