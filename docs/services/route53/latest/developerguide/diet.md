...
You can no longer use Route 53 to register new .diet domains or transfer .diet
domains to Route 53. We'll continue to support .diet domains that are already
...
Not supported. You can no longer transfer .diet domains to
Route 53.
