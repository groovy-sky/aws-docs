...
# SNS don't bind subscribe and publish [Medium](https://docs.aws.amazon.com/amazonq/detector-library/jsx/severity/medium)

Do not bind the SNS Publish operation with the SNS Subscribe or Create Topic operation.

**Detector ID**

jsx/sns-no-bind-subscribe-publish@v1.0
...
[\# amazon-sns](https://docs.aws.amazon.com/amazonq/detector-library/jsx/tags/amazon-sns) [\# aws-javascript-sdk](https://docs.aws.amazon.com/amazonq/detector-library/jsx/tags/aws-javascript-sdk)
