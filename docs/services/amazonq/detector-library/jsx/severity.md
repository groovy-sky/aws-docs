...
[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/jsx/severity/critical)

##### High severity

Browse all detectors with high severity.

[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/jsx/severity/high)

##### Medium severity

Browse all detectors with medium severity.

[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/jsx/severity/medium)

##### Low severity

Browse all detectors with low severity.

[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/jsx/severity/low)

##### Info severity

Browse all detectors with info severity.

[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/jsx/severity/info)
