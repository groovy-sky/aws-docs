...
### [Improper Neutralization of Special Elements in Data Query](../improper-neutralization-of-elements-in-data-query.md)
...
### [Argument Injection](../argument-injection.md)

Improper Neutralization of Argument Delimiters in a Command .

### [Insecure host name verifier](../insecure-host-name-verifier.md)
...
### [Deserialization of Untrusted Data](../deserialization-of-untrusted-data.md)
...
### [Use of Insufficiently Random Values](../use-of-insufficiently-random-values.md)
...
### [Improper Validation Of Array Index](../improper-validation-of-array-index.md)
...
### [Insecure jax endpoint usage](../insecure-jax-endpoint-usage.md)
...
### [External Access to Files or Directories](../external-access-to-files-directories.md)

External parties gain unauthorized access to files or directories via the product.

### [Incorrect Certificate Hostname Verification](../incorrect-certificate-hostname-verification.md)
