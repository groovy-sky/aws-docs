...
# Inefficient Regular Expression [High](https://docs.aws.amazon.com/amazonq/detector-library/csharp/severity/high)

Consider setting a regex timeout to avoid Regular expression Denial of Service (ReDoS)

**Detector ID**

csharp/inefficient-regular-expression@v1.0
