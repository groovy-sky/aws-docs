...
# Inter Process Write of RegionInfo [Medium](https://docs.aws.amazon.com/amazonq/detector-library/csharp/severity/medium)

RegionInfo should be instantiated using a full culture name rather than a two-letter ISO region code.

**Detector ID**

csharp/region-info-inter-process-write@v1.0
