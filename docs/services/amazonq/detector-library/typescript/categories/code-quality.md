...
### [Invoke super appropriately](../invoke-super-appropriately.md)
...
### [Use {} instead of new Object()](../literal-instead-of-new-object.md)

New Object() has been used for object creation instead of {}.

### [improper input validation cdk](../improper-input-validation-cdk.md)
...
### [Improper Restriction of Operations within the Bounds of a Memory Buffer](../improper-restriction-of-operations.md)
...
### [Avoid Undefined As Variable Name](../avoid-undefined-as-variable-name.md)

Checks if the undefined is used as variable.

### [Index of method comparison](../index-of-method-comparison.md)
...
### [Typeof expression](../typeof-expression.md)
...
### [Lazy Load Module](../lazy-load-module.md)
