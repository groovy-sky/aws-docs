...
5  app.get('/users/:profileUrl',function(req: Request, res: Response) {
6    var url: string = req.params.url
...
5  const safeurl: string[] = ['www.example.com']
6  app.post('/users/:profileUrl',function(req: Request, res: Response) {
7    var url: string = req.params.url
