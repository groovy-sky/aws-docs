...
javascript/insecure-temp-file@v1.0
...
[\# availability](https://docs.aws.amazon.com/amazonq/detector-library/javascript/tags/availability) [\# race-condition](https://docs.aws.amazon.com/amazonq/detector-library/javascript/tags/race-condition) [\# owasp-top10](https://docs.aws.amazon.com/amazonq/detector-library/javascript/tags/owasp-top10)
...
4    var tmp_file = "/tmp/f"
5    fs.readFile(tmp_file, 'utf8', function (err, data) {
6       // ...
7    })
8}
