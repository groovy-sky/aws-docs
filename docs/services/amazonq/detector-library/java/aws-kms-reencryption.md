...
java/aws-kms-reencryption@v1.0
...
[CWE-310](https://cwe.mitre.org/data/definitions/310.html) [CWE-311](https://cwe.mitre.org/data/definitions/311.html)

**Tags**

[\# aws-java-sdk](https://docs.aws.amazon.com/amazonq/detector-library/java/tags/aws-java-sdk) [\# aws-kms](https://docs.aws.amazon.com/amazonq/detector-library/java/tags/aws-kms) [\# efficiency](https://docs.aws.amazon.com/amazonq/detector-library/java/tags/efficiency) [\# information-leak](https://docs.aws.amazon.com/amazonq/detector-library/java/tags/information-leak) [\# owasp-top10](https://docs.aws.amazon.com/amazonq/detector-library/java/tags/owasp-top10)
