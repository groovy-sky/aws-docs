...
# Not calling finalize causes skipped cleanup steps [Medium](https://docs.aws.amazon.com/amazonq/detector-library/java/severity/medium)

Always call `super.finalize` explicitly. This ensures that cleanup steps specified by the parent class are not skipped.

**Detector ID**

java/finalize-on-super-class@v1.0
...
[CWE-568](https://cwe.mitre.org/data/definitions/568.html)

**Tags**

[\# availability](https://docs.aws.amazon.com/amazonq/detector-library/java/tags/availability) [\# maintainability](https://docs.aws.amazon.com/amazonq/detector-library/java/tags/maintainability) [\# resource-leak](https://docs.aws.amazon.com/amazonq/detector-library/java/tags/resource-leak) [\# security-context](https://docs.aws.amazon.com/amazonq/detector-library/java/tags/security-context)
