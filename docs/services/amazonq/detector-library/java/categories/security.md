...
### [Unspecified default value](../unspecified-default-value.md)

Unspecified defaults can cause your application to crash.

### [Device Permission Usage.](../device-permission-usage.md)
...
### [Overflow when deserializing relational database objects](../javax-persistence-id.md)
...
### [Inefficient additional authenticated data (AAD) authenticity](../cipher-update-aad.md)
...
### [Use of externally-controlled input to build connection string](../connection-string-injection.md)
...
### [AWS Lambda client not reused](../aws-client-per-invocation.md)

Reuse AWS clients in Lambda.

### [Missing check on the result of createNewFile](../missing-check-on-createnewfile.md)
...
### [Improper Initialization](../improper-initialization.md)

The code failed to initialize or incorrectly initialized internal data, leading to undefined behavior.

### [Unexpected re-assignment of synchronized objects](../reassign-synchronized-object.md)
...
### [Input and output values become out of sync](../out-of-sync-input-and-output.md)
...
### [Concurrency deadlock](../concurrency-deadlock.md)
...
### [Not calling finalize causes skipped cleanup steps](../finalize-on-super-class.md)

Always call `super.finalize` explicitly.

### [Unchecked S3 object metadata content length](../s3-object-metadata-content-length-check.md)
...
### [Bad parameters used with AWS API methods](../aws-bad-params.md)
...
### [Avoid reset exception in Amazon S3](../avoid-reset-exception-rule.md)
...
### [Case sensitive keys in S3 object user metadata](../s3-object-user-metadata-key-case-sensitivity.md)
...
### [Stack trace not included in re-thrown exception](../throw-exception-with-trace.md)

When re-throwing an exception, make sure to include the stack trace.

### [Insufficient number of PBEKeySpec iterations](../insufficient-pbekeyspec-iterations.md)
...
### [Missing encryption of sensitive data in storage](../missing-encryption-at-rest.md)

Sensitive data is potentially persisted into storage or passed to another service without always being encrypted.

### [Ignored output of DynamoDBMapper operations](../aws-dynamodb-mapper-batch-output-ignored.md)
...
### [Atomicity violation](../concurrency-atomicity-violation.md)
...
### [Missing handling of specifically-thrown exceptions](../missing-specifically-thrown-exception-handling.md)
...
### [Catching and not re-throwing or logging exceptions](../unhandled-exceptions.md)

It's not good practice to catch an exception and then re-throw or log it.

### [Missing check when launching an Android activity with an implicit intent](../missing-check-on-android-startactivity.md)

Your application can crash if the check for an application that can receive the implicit intent is missing from code.

### [Arithmetic overflow or underflow](../arithmetic-overflow.md)
...
### [Resources used by an Amazon S3 TransferManager are not released](../amazon-s3-transfer-manager-shutdown.md)
...
### [Missing timezone of SimpleDateFormat](../simple-date-format-time-zone.md)
...
### [Missing handling of file deletion result](../missing-file-deletion-result-check.md)
