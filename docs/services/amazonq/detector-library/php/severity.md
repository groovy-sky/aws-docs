...
[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/php/severity/critical)

##### High severity

Browse all detectors with high severity.

[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/php/severity/high)

##### Medium severity

Browse all detectors with medium severity.

[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/php/severity/medium)

##### Low severity

Browse all detectors with low severity.

[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/php/severity/low)

##### Info severity

Browse all detectors with info severity.

[Click here→](https://docs.aws.amazon.com/amazonq/detector-library/php/severity/info)
