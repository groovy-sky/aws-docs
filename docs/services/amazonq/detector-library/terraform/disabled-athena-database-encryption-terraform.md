---
title: "Disabled athena database encryption Medium"
---
...
# Disabled athena database encryption [Medium](severity/medium.md)

Unencryption is detected for Athena Database. Make sure that encryption is enabled for Athena Database.

**Detector ID**

terraform/disabled-athena-database-encryption-terraform@v1.0
