---
title: "Avoid hardcoded AWS access keys and secrets credentials Critical"
---
...
# Avoid hardcoded AWS access keys and secrets credentials [Critical](severity/critical.md)
...
3  access_key = "AWS_ACCESS_KEY_ID_REDACTED"
