---
title: "disabled detailed monitoring for EC2 Medium"
---
...
# disabled detailed monitoring for EC2 [Medium](severity/medium.md)

Disabled detailed monitoring for EC2 instances is detected. Make sure that monitoring is set to true.

**Detector ID**

terraform/disabled-detailed-monitoring-for-ec2-terraform@v1.0
