...
### [Unsecured encryption of SageMaker data at rest](../unsecured-sagemaker-data-terraform.md)

Unsecured Encryption at rest is detected for the data stored in SageMaker.

### [Disabled AWS Glue security encryption](../disabled-glue-sec-encrypt-terraform.md)

Disabled encryption is configured in AWS Glue security.

### [Restrict IAM asterisk action](../restrict-iam-asterisk-action-critical-terraform.md)

IAM policy documents detect the use of asterisk as an action for statements.

### [Disabled AWS RDS Encryption](../disabled-rds-encryption-terraform.md)

Disabled Encryption is detected for AWS RDS DB cluster.

### [Exposed secrets in EC2 user data](../exposed-ec2-user-data-secret-terraform.md)

Secrets are being revealed by EC2 user data.

### [Disabled block public acls](../disabled-block-public-acls-terraform.md)

Disabled block public ACLS in S3 bucket is detected.

### [Disabled Glue Data Catalog encryption](../disabled-glue-cat-encrypt-terraform.md)

Disabled Encryption is detected for the Glue Data Catalog.

### [S3 bucket restrict public bucket not true](../s3-bucket-restrict-public-bucket-terraform.md)

S3 Bucket is not configured to RestrictPublicBucket.

### [nonhttps viewer protocol policy](../nonhttps-viewer-protocol-policy-terraform.md)

Cloudfront distribution ViewerProtocolPolicy is not set to HTTPS.

### [Restrict log4j2 message lookup](../restrict-log4j2-msg-lookup-terraform.md)

Allowance of message lookup in Log4j2 by WAF is detected.

### [Restrict overly permissive VPC peering routes](../restrict-vpc-peering-routes-terraform.md)

Overly permissive access is granted by the AWS route table with VPC peering to all traffic.

### [Restrict overly permissive access by AWS EKS to all traffic](../restrict-eks-traffic-access-terraform.md)

Overly permissive access is granted by the AWS EKS cluster security group to all traffic.

### [Secure AWS Database Migration Service endpoints](../secure-dms-endpoints-terraform.md)

Overly permissive access is granted by the AWS route table with VPC peering to all traffic.

### [Disabled logging for aws document db](../disabled-logging-for-aws-document-db-terraform.md)

Disabled logging is detected for AWS DocumentDB.

### [Unencrypted code build project](../unencrypted-code-build-project-terraform.md)

Unencryption is detected for CodeBuild project.

### [Sns Topic Uses CMK](../sns-topic-uses-cmk-terraform.md)

Custom Master Key is not used in SNS topic for encryption of messages.

### [Enabled RDS public access](../enabled-rds-public-access-terraform.md)

Enabled public accessibility for RDS database is detected.

### [Unsecure encryption of DAX at rest](../unsecure-encrypt-dax-terraform.md)

Unsecured encryption of DAX is detected at rest.

### [Public READ bucket ACL](../public-read-bucket-acl-terraform.md)

The Bucket ACL allows public READ permission.

### [disabled detailed monitoring for EC2](../disabled-detailed-monitoring-for-ec2-terraform.md)

Disabled detailed monitoring for EC2 instances is detected.

### [Disabled iam authentication](../disabled-iam-authentication-terraform.md)

Disabled IAM authentication is detected for RDS database.

### [Unecrypted AWS Redshift using CMK](../unencrypted-redshift-cmk-terraform.md)

Unencrypted AWS Redshift cluster using CMK is detected.

### [Implicit SSH for AWS EKS node group](../implicit-eks-ssh-access-terraform.md)

implicit SSH access from 0.0.0.0/0 for AWS EKS node group is detected.

### [Restrict IAM asterisk action](../restrict-iam-asterisk-action-terraform.md)

IAM policy documents detect the use of asterisk as an action for statements.

### [Disabled encryption on Aurora at rest](../disabled-aurora-encryption-terraform.md)

Disabled Encryption is detected for all data in Aurora at rest.

### [Restrict assumed IAM role access](../restrict-assumed-role-terraform.md)

The IAM role doesn't permit only specific services or principals for assumption.

### [Restrict AWS IAM policy with full administrative privileges](../restrict-iam-admin-policy-terraform.md)

AWS IAM policy permits full administrative privileges.

### [Restrict actions with any Principal for S3 buckets](../restrict-s3-principal-action-terraform.md)

Allowance of an action with any Principal by S3 bucket is detected.

### [Disabled ALB drops HTTP headers](../disabled-alb-drops-http-headers-terraform.md)

Disabled ALB drops HTTP headers is detected.

### [Restrict IAM policies with full 'asterisk-asterisk' administrative privileges](../restrict-asterisk-iam-admin-policies-terraform.md)

Creation of IAM policies that allow full 'asterisk-asterisk' administrative privileges is detected.

### [Disabled athena database encryption](../disabled-athena-database-encryption-terraform.md)

Unencryption is detected for Athena Database.

### [Use AWS certificate manager SSL certificate with Elastic Load Balancer](../use-aws-certificate-ssl-elb-terraform.md)

SSL certificate from AWS certificate manager is not being used by the Elastic Load Balancer.

### [Unencrypted backup vault](../unencrypted-backup-vault-terraform.md)

Unencrypted Backup Vault is detected at rest using KMS CMK.

### [Avoid hardcoded AWS access keys and secrets credentials](../avoid-hardcoded-credentials-terraform.md)

HardCoded AWS access keys and secrets are embedded in infrastructure.

### [Restrict IAM password reuse](../restrict-iam-password-reuse-terraform.md)

The AWS IAM password policy permits the reuse of password.

### [Disabled document db encryption](../disabled-document-db-encryption-terraform.md)

Unencryption is detected for DocumentDB.

### [Configure TLS 1.2 in AWS Load balancer](../configure-tls-elb-terraform.md)

TLS 1.2 is not being used by the AWS Load balancer.

### [Misconfigured data encryption at rest for AWS SageMaker instance](../misconfigured-sagemaker-kms-encryption-terraform.md)

Data encryption at rest using KMS key is not configured in AWS SageMaker notebook instance.

### [Disabled AWS S3 object versioning](../disabled-s3-versioning-terraform.md)

Disabled versioning is detected for AWS S3 object.

### [Configure HTTPS for CloudFront distribution ViewerProtocolPolicy](../conf-https-cloudfront-policy-terraform.md)

HTTPS is not configured in the ViewerProtocolPolicy of CloudFront distribution.

### [Unsecured Encryption in transit for EFS volumes](../unsecure-encrypt-efs-terraform.md)

Unsecured Encryption in transit is detected for EFS volumes in ECS task definitions.

### [Unencrypted EBS Volumes](../unencrypted-ebs-volumes-terraform.md)

Instances and Launch configurations with unencrypted EBS volumes is detected.

### [Exposed secrets in Lambda function environment variables](../exposed-lambda-env-secret-terraform.md)

The exposure of secrets through Lambda function's environment variables is detected.

### [RDS postgresql file read vulnerability](../rds-postgresql-file-read-vulnerability-terraform.md)

Local file read vulnerability is detected in AWS RDS PostgreSQL.

### [Undefined lambda function urls authtype](../undefined-lambda-function-urls-authtype-terraform.md)

URLs AuthType is not defined for AWS Lambda function.

### [Associate AWS Glue component with a security component](../associate-glue-security-terraform.md)

AWS Glue component is detected without associated security configuration.

### [Restrict public access on DMS replication instance](../restrict-public-access-dms-terraform.md)

DMS replication instance with public accessibility is detected.

### [S3 bucket ignore public acls not true](../s3-bucket-ignore-public-acls-not-true-terraform.md)

S3 Bucket is not configured to IgnorePublicAcls.

### [DynamoDB Table Autoscaling Enabled](../dynamodb-table-autoscaling-enabled-terraform.md)

Ensure that Auto Scaling is enabled on your DynamoDB tables.

### [Restrict Neptune cluster instance public access](../restrict-neptume-public-access-terraform.md)

Public availability is detected for Neptune cluster instance.

### [Restrict the use of asterisk actions for SQS policy documents](../restrict-sqs-asterisk-action-terraform.md)

SQS policy documents detect the use of asterisk as an action for statements.

### [Disabled Neptune logging](../disabled-neptune-logging-terraform.md)

Disabled Neptune logging is detected.

### [nonhttps load balancer terraform](../nonhttps-load-balancer-terraform.md)

Application Load Balancer is not set to HTTPS.

### [Unencryted Codebuild projects](../unencryted-codebuild-projects-terraform.md)

Unencrypted CodeBuild projects is detected.

### [Unencrypted Secrets Manager using CMK](../unencrypted-secrets-manager-using-cmk-terraform.md)

Unencypted Secrets Manager secret is dected using Customer Managed Key.

### [AWS S3 public WRITE permission](../public-write-s3-bucket-terraform.md)

AWS S3 bucket allows public WRITE permission.

### [Restrict public IP association on EC2 instance](../restrict-public-ip-ec2-terraform.md)

EC2 instance with public IP is detected.

### [Disabled DynamoDB Point-In-Time Recovery](../disabled-dynamodb-pitr-terraform.md)
