---
title: "Unencrypted backup vault Medium"
---
...
# Unencrypted backup vault [Medium](severity/medium.md)

Unencrypted Backup Vault is detected at rest using KMS CMK. Make sure that encryption is enabled for Backup Vault.

**Detector ID**

terraform/unencrypted-backup-vault-terraform@v1.0
