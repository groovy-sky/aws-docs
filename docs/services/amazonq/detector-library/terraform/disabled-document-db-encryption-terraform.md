---
title: "Disabled document db encryption Medium"
---
...
# Disabled document db encryption [Medium](severity/medium.md)

Unencryption is detected for DocumentDB. Make sure that storage encrypted is set to true.

**Detector ID**

terraform/disabled-document-db-encryption-terraform@v1.0
