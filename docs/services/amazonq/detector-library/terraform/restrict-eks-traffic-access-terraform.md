---
title: "Restrict overly permissive access by AWS EKS to all traffic High"
---
...
# Restrict overly permissive access by AWS EKS to all traffic [High](severity/high.md)
