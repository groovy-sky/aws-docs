---
title: "Restrict AWS IAM policy with full administrative privileges Critical"
---
...
# Restrict AWS IAM policy with full administrative privileges [Critical](severity/critical.md)
...
terraform/restrict-iam-admin-policy-terraform@v1.0
