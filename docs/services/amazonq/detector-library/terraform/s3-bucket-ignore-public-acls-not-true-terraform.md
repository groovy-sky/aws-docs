---
title: "S3 bucket ignore public acls not true Medium"
---
...
# S3 bucket ignore public acls not true [Medium](severity/medium.md)

S3 Bucket is not configured to IgnorePublicAcls. Make sure that IgnorePublicAcls is set to true.

**Detector ID**

terraform/s3-bucket-ignore-public-acls-not-true-terraform@v1.0
