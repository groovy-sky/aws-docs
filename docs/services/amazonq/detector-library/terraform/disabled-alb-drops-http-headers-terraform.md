---
title: "Disabled ALB drops HTTP headers Medium"
---
...
# Disabled ALB drops HTTP headers [Medium](severity/medium.md)

Disabled ALB drops HTTP headers is detected. Make sure that drop header is set to true in AWS ALB.

**Detector ID**

terraform/disabled-alb-drops-http-headers-terraform@v1.0
