---
title: "nonhttps viewer protocol policy Medium"
---
...
# nonhttps viewer protocol policy [Medium](severity/medium.md)

Cloudfront distribution ViewerProtocolPolicy is not set to HTTPS. Makre sure Cloudfront distribution ViewerProtocolPolicy is set to HTTPS to avoid data loss.

**Detector ID**

terraform/nonhttps-viewer-protocol-policy-terraform@v1.0
