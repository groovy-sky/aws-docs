---
title: "Unencrypted code build project Medium"
---
...
# Unencrypted code build project [Medium](severity/medium.md)

Unencryption is detected for CodeBuild project. Make sure that encryption is enabled for CodeBuild project.

**Detector ID**

terraform/unencrypted-code-build-project-terraform@v1.0
