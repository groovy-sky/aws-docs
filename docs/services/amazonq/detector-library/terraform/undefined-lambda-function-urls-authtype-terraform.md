---
title: "Undefined lambda function urls authtype Medium"
---
...
# Undefined lambda function urls authtype [Medium](severity/medium.md)

URLs AuthType is not defined for AWS Lambda function. Make sure that AWS AuthType for your Lambda function URLs is defined.

**Detector ID**

terraform/undefined-lambda-function-urls-authtype-terraform@v1.0
