---
title: "Disabled logging for aws document db Medium"
---
...
# Disabled logging for aws document db [Medium](severity/medium.md)

Disabled logging is detected for AWS DocumentDB. Make sure that AWS DocumentDB is configured to logging.

**Detector ID**

terraform/disabled-logging-for-aws-document-db-terraform@v1.0
