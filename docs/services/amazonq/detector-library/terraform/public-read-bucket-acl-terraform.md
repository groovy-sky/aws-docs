...
4  # Noncompliant: ACL defined which allows public READ access.
5  acl = "public-read"
6  versioning {
7    enabled = true
8  }
...
2  provider = aws.west
3  bucket = aws_s3_bucket.bucket_good_1.id
4  # Compliant: ACL defined which allows private access.
5  acl = "private"
6  versioning {
7    enabled = true
8  }
