---
title: "DynamoDB Table Autoscaling Enabled Low"
---
...
# DynamoDB Table Autoscaling Enabled [Low](severity/low.md)

Ensure that you dynamically adjust the provisioned throughput capacity of your DynamoDB tables automatically in response to changes in your application's traffic patterns.

**Detector ID**

terraform/dynamodb-table-autoscaling-enabled-terraform@v1.0
...
[CWE-](https://cwe.mitre.org/data/definitions/null.html)
