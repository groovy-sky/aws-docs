---
title: "Misconfigured data encryption at rest for AWS SageMaker instance High"
---
...
# Misconfigured data encryption at rest for AWS SageMaker instance [High](severity/high.md)
