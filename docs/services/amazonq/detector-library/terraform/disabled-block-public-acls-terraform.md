---
title: "Disabled block public acls Medium"
---
...
# Disabled block public acls [Medium](severity/medium.md)

Disabled block public ACLS in S3 bucket is detected. Make sure that block public ACLS is set to true.

**Detector ID**

terraform/disabled-block-public-acls-terraform@v1.0
