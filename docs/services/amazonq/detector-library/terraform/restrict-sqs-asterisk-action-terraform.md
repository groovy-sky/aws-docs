---
title: "Restrict the use of asterisk actions for SQS policy documents High"
---
...
# Restrict the use of asterisk actions for SQS policy documents [High](severity/high.md)
