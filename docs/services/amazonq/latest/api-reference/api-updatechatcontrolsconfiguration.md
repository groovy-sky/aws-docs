...
Type: [BlockedPhrasesConfigurationUpdate](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_BlockedPhrasesConfigurationUpdate.html) object
...
Type: [CreatorModeConfiguration](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_CreatorModeConfiguration.html) object
...
Type: [HallucinationReductionConfiguration](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_HallucinationReductionConfiguration.html) object
...
Type: [OrchestrationConfiguration](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_OrchestrationConfiguration.html) object
...
Type: Array of [TopicConfiguration](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_TopicConfiguration.html) objects
