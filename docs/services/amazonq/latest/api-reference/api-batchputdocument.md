...
Type: Array of [Document](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_Document.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qbusiness-2023-11-27/BatchPutDocument)
