...
Type: Array of [BatchCreateCategoryInputCategory](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_qapps_BatchCreateCategoryInputCategory.html) objects
