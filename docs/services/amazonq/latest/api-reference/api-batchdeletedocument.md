...
Type: Array of [DeleteDocument](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_DeleteDocument.html) objects
...
Type: Array of [FailedDocument](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_FailedDocument.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qbusiness-2023-11-27/BatchDeleteDocument)
