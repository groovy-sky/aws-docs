...
Type: [GroupStatusDetail](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_GroupStatusDetail.html) object

**[statusHistory](#API_GetGroup_ResponseSyntax)**

The status history of the group.

Type: Array of [GroupStatusDetail](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_GroupStatusDetail.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qbusiness-2023-11-27/GetGroup)
