...
Type: [EncryptionConfiguration](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_EncryptionConfiguration.html) object
...
Type: [QuickSightConfiguration](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_QuickSightConfiguration.html) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qbusiness-2023-11-27/CreateApplication)
