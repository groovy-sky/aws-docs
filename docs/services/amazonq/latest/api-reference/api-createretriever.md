...
Type: [RetrieverConfiguration](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_RetrieverConfiguration.html) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qbusiness-2023-11-27/CreateRetriever)
