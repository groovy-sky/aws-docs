...
Type: Array of [CardValue](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_qapps_CardValue.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qapps-2023-11-27/StartQAppSession)
