...
Type: Array of [WebExperience](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_WebExperience.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qbusiness-2023-11-27/ListWebExperiences)
