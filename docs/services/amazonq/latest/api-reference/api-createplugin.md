...
Type: [PluginAuthConfiguration](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_PluginAuthConfiguration.html) object
...
Type: [CustomPluginConfiguration](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_CustomPluginConfiguration.html) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qbusiness-2023-11-27/CreatePlugin)
