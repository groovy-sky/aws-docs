...
Type: Array of [Index](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_Index.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qbusiness-2023-11-27/ListIndices)
