...
Type: Array of [ActionSummary](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_ActionSummary.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/qbusiness-2023-11-27/ListPluginActions)
