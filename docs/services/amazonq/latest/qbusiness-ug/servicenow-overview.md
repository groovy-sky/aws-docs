...
**crawling**Yes. For more information, see [ACL crawling](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/servicenow-user-management).**[Identity\**
...
information, see [Field mappings](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/servicenow-field-mappings).**Filters**Yes. The following filters are supported:
