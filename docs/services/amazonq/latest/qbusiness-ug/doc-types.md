...
files and chat](upload-chat-files.md) feature, the size of each file you upload must be 10 MB or less,
...
document upload](upload-docs.md) or the [Upload\
files and chat](upload-chat-files.md) feature, it considers each file you add a document. When you
...
metadata controls in Amazon Q Business.](mapping-doc-attributes.md)
...
CSVs by providing a [metadata file](mapping-doc-attributes.md). Example:
