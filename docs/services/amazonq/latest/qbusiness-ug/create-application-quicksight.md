...
Amazon Quick and access answers from unstructured data in Amazon Q Business. [Amazon Quick](../../../quicksight/latest/user/welcome.md)
...
create it with the Amazon Q Business [CreateApplication](../api-reference/api-createapplication.md)
API operation.
...
[Supported AWS Regions for Amazon Q in QuickSight](../../../quicksight/latest/user/regions-aqs.md). For
...
- To create an Amazon Q Business application with the [CreateApplication](../api-reference/api-createapplication.md) API operation, the user or role must have
permissions to create an application. For more information about setting up
Amazon Q Business, see [Setting up for Amazon Q Business](setting-up.md).
...
Q](../../../quicksight/latest/user/generative-bi-q-business-configure.md) in the _Amazon Quick User Guide_.
...
[CreateApplication](../api-reference/api-createapplication.md) API operation. For `identityType`, specify
...
operations](../../../quicksight/latest/developerguide/namespace-operations.md).
