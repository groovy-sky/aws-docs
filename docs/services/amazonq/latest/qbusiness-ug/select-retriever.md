...
AWS Management Console, or the [CreateIndex](../api-reference/api-createindex.md) and [CreateRetriever](../api-reference/api-createretriever.md) API operations.
...
You [create a\
Amazon Kendra index](../../../kendra/latest/dg/create-index.md) using the Amazon Kendra console and API. To connect a Amazon Kendra index to
Amazon Q Business, you can use the Amazon Q Business console or the [CreateRetriever](../api-reference/api-createretriever.md) API operation.
...
- [What is\
Amazon Kendra?](../../../kendra/latest/dg/what-is.md)

- [Creating a data source connector](../../../kendra/latest/dg/data-source.md)

- [Amazon Kendra API Reference](../../../../reference/kendra/latest/apireference/welcome.md)
