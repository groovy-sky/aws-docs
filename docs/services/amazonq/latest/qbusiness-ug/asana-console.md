...
05. Then, on the **Asana** data source page, enter
...
07. In **Sync scope, Workspace ID** – Enter your workspace
     Id.
...
09. **Authentication** – Enter your service account token
...
12. **IAM role** – Choose
    ...
    For more information, see [IAM role](asana-connector.md#Asana-iam).
