---
title: "Prerequisites for connecting Amazon Q Business to SharePoint Server 2019"
---
...
SharePoint Server 2019 to Amazon Q, based on the authentication mode of your choice.
...
**IDP to control access to your documents, make sure you've**
...
**If using Email ID with Custom Domain**
**for access control, complete the following step:**
...
- Stored your SharePoint Server 2019 authentication credentials in an AWS Secrets Manager
