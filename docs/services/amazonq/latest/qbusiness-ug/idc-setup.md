---
title: "Configuring an IAM Identity Center instance for an Amazon Q Business application"
---
...
- [Enable an IAM Identity Center instance](../../../singlesignon/latest/userguide/get-set-up-for-idc.md) and [connect the identity source](../../../singlesignon/latest/userguide/tutorials.md) for your Amazon Q Business
...
- [Configure an IAM Identity Center instance](../../../singlesignon/latest/userguide/quick-start-default-idc.md) to connect to
...
[Manage instances](../../../singlesignon/latest/userguide/identity-center-instances.md) in the IAM Identity Center User Guide.
...
IAM Identity Center](../../../singlesignon/latest/userguide/get-set-up-for-idc.md)

- [Prerequisites and considerations for setting up\
IAM Identity Center](../../../singlesignon/latest/userguide/get-started-prereqs-considerations.md)

- [Confirm your identity sources in\
IAM Identity Center](../../../singlesignon/latest/userguide/prereq-identity-sources.md)

- [Get started with common tasks in\
IAM Identity Center](../../../singlesignon/latest/userguide/getting-started.md)
...
- [Account instances of IAM Identity Center](../../../singlesignon/latest/userguide/account-instances-identity-center.md)

- [Enable an account instance of\
IAM Identity Center](../../../singlesignon/latest/userguide/enable-account-instance-console.md)

- [Control account instance creation with Service\
Control Policies](../../../singlesignon/latest/userguide/control-account-instance.md)

- [Create an account instance of\
IAM Identity Center](../../../singlesignon/latest/userguide/create-account-instance.md)
...
where IAM Identity Center is available](../../../../general/latest/gr/sso.md) (excluding opt-in and special regions), even if
