---
title: "Prerequisites for connecting Amazon Q Business to SharePoint Server 2016"
---
...
- [Prerequisites for using NTLM authentication](#sharepoint-server-2016-prereqs-ntlm)

- [Prerequisites for using Kerberos authentication](#sharepoint-server-2016-prereqs-kerberos)

- [Prerequisites for using SharePoint App-Only authentication](#sharepoint-server-2016-prereqs-app-only)
