...
- [Configuring the Amazon Q Business Microsoft Word Add-in for use](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/configuring-integration-msword.html)

- [Removing the Amazon Q Business Add-in as a Microsoft Word integration](#removing-integration-msword)

- [Using the Amazon Q Business Add-in for Microsoft Word](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/using-integration-msword.html)
