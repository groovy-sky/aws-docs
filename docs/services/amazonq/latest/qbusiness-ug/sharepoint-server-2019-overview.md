---
title: "SharePoint Server 2019 connector overview"
---
...
**crawling**Yes. For more information, see [ACL crawling](sharepoint-server-2019-user-management.md).
...
information, see [Field mappings](sharepoint-server-2019-field-mappings.md).**Filters**Yes. The following filters are supported:
