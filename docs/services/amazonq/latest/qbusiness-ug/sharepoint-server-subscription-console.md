...
05. Then, on the **SharePoint Server (Subscription Edition)** data source page, enter
...
12. **IAM role** – Choose
    ...
    For more information, see [IAM role](sharepoint-server-subscription-connector.md#sharepoint-server-subscription-iam).
