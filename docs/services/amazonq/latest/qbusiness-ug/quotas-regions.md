...
information, see [AWS\
service endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html) in the _AWS General Reference_.
...
see [Amazon Q Business regions and endpoints](https://docs.aws.amazon.com/general/latest/gr/amazonq.html) in the _Amazon Web_
...
management](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/conversation-api.html).
