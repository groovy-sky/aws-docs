...
- [Data collection concepts](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/qapps-forms-data-collection-concepts.html)

- [Creating a new Q App with a data collection form](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/qapps-forms-creating-app.html)

- [Starting a new data collection](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/qapps-forms-starting-new-data-collection.html)
