...
IAM features you can use with Amazon Q BusinessIAM featureAmazon Q Business support
...
To view examples of Amazon Q identity-based policies, see [Identity-based policy examples for Amazon Q Business](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/security_iam_id-based-policy-examples.html).
...
To see a list of Amazon Q Business actions, see [Actions Defined by Amazon Q Business](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-actions-as-permissions) in the
...
`qbusiness:`. For example, to grant someone permission to list an Amazon Q application with the [`ListApplications`](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_ListApplications.html) API operation, you include the
...
To see a list of Amazon Q Business condition keys, see [Condition Keys for Amazon Q Business](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-policy-keys)
in the _Service Authorization Reference_. To learn with which actions and resources
you can use a condition key, see [Actions Defined by Amazon Q Business](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-actions-as-permissions).
...
ActionResource typeCondition keys[CreateApplication](../api-reference/api-createapplication.md)`aws:ResourceTag`, `aws:RequestTag`,
`aws:TagKeys`[CreateDataSource](../api-reference/api-createdatasource.md)`aws:ResourceTag`, `aws:RequestTag`,
`aws:TagKeys`[CreateIndex](../api-reference/api-createindex.md)`aws:ResourceTag`, `aws:RequestTag`,
`aws:TagKeys`[CreatePlugin](../api-reference/api-createplugin.md)`aws:ResourceTag`, `aws:RequestTag`,
`aws:TagKeys`[CreateRetriever](../api-reference/api-createretriever.md)`aws:ResourceTag`, `aws:RequestTag`,
`aws:TagKeys`[CreateWebExperience](../api-reference/api-createwebexperience.md)`aws:ResourceTag`, `aws:RequestTag`,
`aws:TagKeys`[ListTagsForResource](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_ListTagsForResource.html)application, index, retriever, data source, web experience,
plugin[TagResource](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_TagResource.html)application, index, retriever, data source, web experience,
plugin`aws:ResourceTag`, `aws:RequestTag`,
`aws:TagKeys`[UntagResource](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_UntagResource.html)application, index, retriever, data source, web experience,
plugin`aws:TagKeys`
...
see [Using service-linked roles for Amazon Q Business](using-service-linked-roles.md).
