...
CategoryFeatureSupport**Security****Authentication type**Personal token, OAuth token**Authentication credentials**

- GitHub (Cloud) token

**[Access Control List (ACL)](connector-concepts.md#connector-authorization)**
**crawling**Yes. For more information, see [ACL crawling](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/github-cloud-user-management.html).
**[Identity\**
...
information, see [Field mappings](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/github-cloud-field-mappings.html).**Filters**Yes. The following filters are supported:
