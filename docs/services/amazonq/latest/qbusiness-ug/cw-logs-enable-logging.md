...
stream](../../../amazoncloudwatch/latest/logs/createfirehosestream.md).
...
quotas](../../../../general/latest/gr/cwl-region.md#limits_cloudwatch_events).
...
If you want the users' email recorded in your logs, it must be added explicitly as a
field along with the [other fields](cw-log-examples.md) that you
