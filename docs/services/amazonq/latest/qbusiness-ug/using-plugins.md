...
1. Ask to perform an action directly. For example: Create a
       Jira ticket for a broken mouse. See [Quick create](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/using-plugins.html#quick-create) for more
       details.
...
2. Start chatting in your web experience to find answers to
       ...
       more information, see [Contextual create](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/using-plugins.html#contextual-create).
