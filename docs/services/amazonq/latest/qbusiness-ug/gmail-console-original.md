---
title: "Connecting Amazon Q Business to Gmail using the legacy connector (Console)"
---
...
08. In **Authentication**, for **AWS Secrets Manager**
    ...
    1. Enter the following information in the **Create an AWS Secrets Manager**
       **secret window**:
       ...
       2. **Client email** – The client email
           address that you copied from your Google service account.
...
09. **IAM role** – Choose
    ...
    For more information, see [IAM role](gmail-connector.md#gmail-iam).

10. In **Sync scope**, choose from the following entity types:
