...
1. [Get started with\
    Amazon Q Business](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/getting-started.html)
...
3. Set up the retriever and connect your data sources. For a complete list of
    ...
    that you want to retrieve data from. For more information, see [Creating a retriever for an Amazon Q Business application environment](select-retriever.md) and [Connecting Amazon Q Business data sources](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/data-sources.html).
