...
- The connector crawls links in SharePoint 2019 only if
...
- To use **Identity Crawler** with SharePoint Server 2019 to crawl
...
SharePoint Server 2019. You need to add users and groups directly to your document
permissions list.
