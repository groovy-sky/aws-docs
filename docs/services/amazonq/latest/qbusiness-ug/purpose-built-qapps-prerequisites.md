...
(Application admin role)](../../../singlesignon/latest/userguide/use-case-app-admin.md) in the _IAM Identity Center User_
...
see [Manage an external identity provider](../../../singlesignon/latest/userguide/manage-your-identity-source-idp.md) in the
_IAM Identity Center User Guide_.

To set up AWS Identity and Access Management, see [Get\
started with IAM](../../../iam/latest/userguide/getting-started.md) in the _AWS Identity and Access Management User Guide_.
...
connect them to your IAM instance, see [Identity providers and federation](../../../iam/latest/userguide/id-roles-providers.md) in the _AWS Identity and Access Management User_
...
– Complete [setting up Amazon Q Business](../business-use-dg/setting-up.md) and create an Amazon Q Business
