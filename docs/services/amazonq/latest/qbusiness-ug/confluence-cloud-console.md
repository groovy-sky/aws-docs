---
title: "Connecting Amazon Q Business to Confluence (Cloud) using the console"
---
...
05. Then, on the **Confluence (Cloud)** data source page, enter
...
10. **AWS Secrets Manager secret** – Choose an existing secret or
    ...
    2. If using **Basic Authentication** – Enter the
        **Secret name** **User name**, and **Password** (
...
12. **IAM role** – Choose
    ...
    For more information, see [IAM role](confluence-cloud-connector.md#confluence-cloud-iam).
...
13. In **Sync scope**, choose from the following options :
    1. In **Sync scope**, for **sync**
       **contents**, choose to sync from the following entity types:
        ...
        **Blog comments**, **Blog**
       **attachments**, **Personal spaces** **Archived spaces**, and **Archived**
       **pages**.
