...
**crawling**Yes. For more information, see [ACL crawling](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/confluence-server-user-management.html).**[Identity\**
...
**[Field mappings](connector-concepts.md#connector-field-mappings)**Yes. For more information, see [Field mappings](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/confluence-server-field-mappings.html).**Filters**Yes. The following filters are supported:
