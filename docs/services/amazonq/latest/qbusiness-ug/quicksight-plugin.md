...
access to insights and external databases through [Amazon Quick](../../../quicksight/latest/user/welcome.md).
...
can enable the plugin with the console or the [CreatePlugin](../api-reference/api-createplugin.md) API
operation.
...
For information about pausing the plugin, see [Pausing integration with Quick](quicksight-plugin-pausing-integration.md).

###### Note

If your [Admin controls and guardrails](guardrails.md) settings allow Amazon Q to
...
started with Generative BI](../../../quicksight/latest/user/generative-bi-get-started.md).
...
permissions. For a policy example, see [IAM role for an Amazon Q Business web experience using IAM Identity Center](web-experience-iam-role-idc.md).
...
[AWS managed policy: QBusinessQuicksightPluginPolicy](security-iam-awsmanpol.md#security-iam-awsmanpol-amazonq-quicksight-policy).
