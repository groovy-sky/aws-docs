...
**crawling**Yes. For more information, see [ACL crawling](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/sharepoint-server-subscription-user-management.html).
...
information, see [Field mappings](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/sharepoint-server-subscription-field-mappings.html).**Filters**Yes. The following filters are supported:
