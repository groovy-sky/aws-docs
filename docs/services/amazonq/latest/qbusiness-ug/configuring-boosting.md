---
title: "Configuring document attributes for boosting in Amazon Q Business"
---
...
can use the AWS Management Console or the [DocumentAttributeBoostingConfiguration](../api-reference/api-documentattributeboostingconfiguration.md) parameter of the
[UpdateRetriever](../api-reference/api-updateretriever.md) API
operation.
