---
title: "Connecting Amazon Q Business to Box using the console"
---
...
05. Then, on the **Box** data source page, enter
...
09. In **Authentication** – Choose to create an
     **AWS**
...
11. **IAM role** – Choose
    ...
    For more information, see [IAM role](box-connector.md#box-iam).
