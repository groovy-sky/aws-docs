---
title: "Connecting Amazon Q Business to SharePoint Server 2019 using the console"
---
...
05. Then, on the **SharePoint Server 2019** data source page, enter
...
13. **IAM role** – Choose
    ...
    For more information, see [IAM role](sharepoint-server-2019-connector.md#sharepoint-server-2019-iam).
