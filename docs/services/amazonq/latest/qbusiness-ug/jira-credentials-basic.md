...
1. Log in to your account from [Jira](https://jira.atlassian.com/). Note the username you logged in with. You
...
3. Then, go to [Security](https://id.atlassian.com/manage-profile/security/api-tokens.) page in Jira.
