...
attached to it. If you use the API, you must also use the [DeleteRetriever](../api-reference/api-deleteretriever.md) API operation to
...
can use the console or the [GetIndex](../api-reference/api-getindex.md) and [GetRetriever](../api-reference/api-getretriever.md) API
operation.
...
use the console or the [ListIndices](../api-reference/api-listindices.md) API operation and the [ListRetrievers](../api-reference/api-listretrievers.md) API
operation.
...
[UpdateIndices](../api-reference/api-updateindices.md) API
operation.
