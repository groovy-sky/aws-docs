...
For information on supported IDEs for this feature, see [Supported IDEs](q-in-ide.md#supported-ides-features). For information on supported languages, see
...
[Amazon Q Detector\
Library](../../../codeguru/detector-library.md).
