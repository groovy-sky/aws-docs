...
Users accessing [Amazon Q in the IDE](q-in-ide.md) or [Amazon Q on the command line](command-line.md) don't require IAM
permissions.
...
line tool for transformations](transform-cli.md). This policy does not affect access to [Amazon Q on the command line](command-line.md).
...
to perform, except for Amazon EC2 actions. This policy uses the [`aws:CalledVia` global condition key](../../../iam/latest/userguide/reference-policies-condition-keys.md#condition-keys-calledvia) to specify that Amazon EC2
...
action. This policy uses the [`aws:CalledVia` global condition key](../../../iam/latest/userguide/reference-policies-condition-keys.md#condition-keys-calledvia) to specify that Amazon Q is
...
information on how to specify what Regions you can make calls to, see [aws:RequestedRegion](../../../iam/latest/userguide/reference-policies-condition-keys.md#condition-keys-requestedregion) in the _AWS Identity and Access Management User Guide_.
