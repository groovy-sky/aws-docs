...
organization managed by [AWS Organizations](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html).
...
2. Add users and groups. For instructions, see [Add users to your IAM Identity Center\
    directory](https://docs.aws.amazon.com/singlesignon/latest/userguide/addusers.html) in the _AWS IAM Identity Center User Guide_.
...
IAM Identity Center, in a management account. For more information, see [Subscribe users to Amazon Q Developer Pro in a management account](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/subscribe-management.html).
