---
title: "Amazon Q Developer and interface endpoints (AWS PrivateLink)"
---
...
endpoint](../../../vpc/latest/userguide/vpce-interface.md#create-interface-endpoint) in the _Amazon VPC User Guide_.
...
service through an interface endpoint](../../../vpc/latest/userguide/vpce-interface.md#access-service-though-endpoint) in the
...
1. [Create a VPN\
    connection between your on-premises device and your VPC.](../../../vpn/latest/clientvpn-user/client-vpn-user-what-is.md)

2. [Create an interface VPC endpoint for\
    Amazon Q.](#vpc-endpoint-create)

3. [Set up an inbound Amazon Route 53 endpoint.](../../../route53/latest/developerguide/routing-to-vpc-interface-endpoint.md) This will enable you to use
...
- [SageMaker AI Studio](../../../sagemaker/latest/dg/host-vpc.md)

- [AWS Glue Studio](../../../glue/latest/dg/start-connecting.md)
