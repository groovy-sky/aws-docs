...
[Supported Regions\
page](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/regions.html#default-regions), except for opt-in Regions. If your users have identities in an IAM Identity Center
...
- [GitLab Duo with Amazon Q](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/gitlab-with-amazon-q.html)
...
and security, see [Encryption at rest](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/data-encryption.html#encryption-rest).
