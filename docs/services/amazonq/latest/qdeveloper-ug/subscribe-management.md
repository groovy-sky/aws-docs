...
managed by [AWS Organizations](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html). It is the ultimate owner of the organization, and is responsible for paying all
...
for AWS Organizations](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_getting-started_concepts.html) in the _AWS Organizations User Guide_.
...
more information about IAM Identity Center, see [Organization instances of IAM Identity Center](https://docs.aws.amazon.com/singlesignon/latest/userguide/organization-instances-identity-center.html) in the
...
- Disabling dashboard metrics, see [Disabling the Amazon Q Developer dashboard](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/dashboard-disabling.html).
