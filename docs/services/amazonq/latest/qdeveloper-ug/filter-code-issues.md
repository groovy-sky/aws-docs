...
![The severity filter menu in IntelliJ IDEA.](https://docs.aws.amazon.com/images/amazonq/latest/qdeveloper-ug/images/jb-filter-issues.png)

3. Select or deselect the the severity levels you want to filter for,
...
![The filter icon in the Code Issues tab in Visual Studio Code.](https://docs.aws.amazon.com/images/amazonq/latest/qdeveloper-ug/images/filter-issues-vsc.png)
...
3. Select **Severity** to group issues in the Code Issues panel based on their
...
![The grouping icon in the Code Issues tab in Visual Studio Code.](https://docs.aws.amazon.com/images/amazonq/latest/qdeveloper-ug/images/group-issues-vsc.png)
