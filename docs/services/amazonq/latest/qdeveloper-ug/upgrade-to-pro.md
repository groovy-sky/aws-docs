...
1. Choose **Confirm upgrade**.
   ...
   The **Subscriptions** page of the Amazon Q Developer console appears with an **Upgrade to Q Developer Pro successful** message. You should see your user name listed in the **Builder ID users** section.
...
1. Choose **Confirm upgrade**.
   ...
   The **Subscriptions** page of the Amazon Q Developer console appears with a **Upgrade to Q Developer Pro successful** message. You should see your user name listed in the **Builder ID users** section.
