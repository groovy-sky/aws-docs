...
Amazon Q Developer Pro as a workforce user](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/subscribe-users.html) by your administrator, and you must provide the Start URL to
...
Then, enter the AWS Region where you were subscribed in the following
    format: `us-east-1`. For a list of supported Regions, see [Supported Regions](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/regions.html). For a list of Region
    codes, see [Regional endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints) in the _AWS General Reference guide_.
...
1. To convert embedded SQL, you must first create a YAML file that contains
    ...
    Schema Conversion](https://docs.aws.amazon.com/dms/latest/sbs/schema-conversion-oracle-postgresql.html).
