...
[Addressing code issues](address-code-issues.md).
...
8. For more information about addressing code issues, see [Addressing code issues with Amazon Q Developer](address-code-issues.md).
...
[Amazon Q Developer Pro subscription](getting-started-q-dev.md).

Auto-reviews are rule-based reviews powered by [Amazon Q detectors](../../../codeguru/detector-library.md). Amazon Q automatically
