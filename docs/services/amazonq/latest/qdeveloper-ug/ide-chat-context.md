...
more information, see [Adding workspace context to Amazon Q Developer chat in the IDE](workspace-context.md).
...
see [Saving prompts to a library for use with Amazon Q Developer chat](context-prompt-library.md).
...
rules that you define as context. For more information, see [Creating project rules for use with Amazon Q Developer chat](context-project-rules.md).
