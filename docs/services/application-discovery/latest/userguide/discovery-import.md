...
can keep. For more information, see [AWS Application Discovery Service Quotas](https://docs.aws.amazon.com/application-discovery/latest/userguide/ads_service_limits.html).
...
more information on this matching, see [Matching logic for discovered servers and applications](https://docs.aws.amazon.com/application-discovery/latest/userguide/view-data.html#add-match-logic).
...
For more information on using this command, see [create-policy](https://docs.aws.amazon.com/cli/latest/reference/iam/create-policy.html)
...
3. Use the `aws iam attach-user-policy` AWS CLI command to
    ...
    see [attach-user-policy](https://docs.aws.amazon.com/cli/latest/reference/iam/attach-user-policy.html) in the
...
Line Interface](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-install.html) in the
...
import issues, see [Troubleshooting failed import records](https://docs.aws.amazon.com/application-discovery/latest/userguide/troubleshooting.html#troubleshooting-import-failed-records).
