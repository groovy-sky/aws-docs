...
Before you deploy the Discovery Agent, you must choose a [Migration Hub home Region](https://docs.aws.amazon.com/migrationhub/latest/ug/home-region.html). You must
...
all of the required prerequisites in [Prerequisites for Discovery Agent](https://docs.aws.amazon.com/application-discovery/latest/userguide/gen-prep-agents.html)
