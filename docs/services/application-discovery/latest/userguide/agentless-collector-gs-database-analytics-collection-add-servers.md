---
title: "Adding your LDAP and OS servers"
---
...
Linux,192.0.2.0,22,Key-based authentication,USER-EXAMPLE,AWS_ACCESS_KEY_ID_REDACTED
Windows,203.0.113.0,,NTLM,USER2-EXAMPLE,AWS_ACCESS_KEY_ID_REDACTED
```
