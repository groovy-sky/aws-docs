---
title: "Accessing the Agentless Collector console"
---
...
1. Open a web browser, and then type the following URL in the address bar:
    ...
    collector from [Deploy Agentless Collector](agentless-collector-deploying.md#agentless-collector-gs-deploy).
...
you'll [Configuring Agentless Collector](agentless-collector-gs-configure.md). Otherwise, next you'll see [The Agentless Collector dashboard](agentless-collector-dashboard.md).
