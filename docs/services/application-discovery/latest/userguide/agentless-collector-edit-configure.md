---
title: "Editing Agentless Collector settings"
---
...
(Agentless Collector) as described in [Configuring Agentless Collector](agentless-collector-gs-configure.md). The following procedure
...
2. Under **Destination AWS account for discovery**
     **data**, enter the AWS access key and secret key for the
      ...
      the IAM user, see [Deploying Application Discovery Service Agentless Collector](agentless-collector-deploying.md#agentless-collector-gs-iam-user).
