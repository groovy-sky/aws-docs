...
**settings** and follow the instructions described in [Editing Agentless Collector settings](https://docs.aws.amazon.com/application-discovery/latest/userguide/agentless-collector-edit-configure.html).
...
described in [Viewing your collected data](https://docs.aws.amazon.com/application-discovery/latest/userguide/agentless-collector-gs-view-collected-data.html).
