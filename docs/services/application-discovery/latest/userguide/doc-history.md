...
see [Discovery\
Connector](https://docs.aws.amazon.com/application-discovery/latest/userguide/appendix.html).
...
information, see [Using the Agentless Collector Network Data Collection module](https://docs.aws.amazon.com/application-discovery/latest/userguide/agentless-collector-gs-network-data-collection.html).
...
For more information, see [Eventual consistency in the AWS Application Discovery Service API](https://docs.aws.amazon.com/application-discovery/latest/userguide/discovery-api-queries.html#eventual-consistency).
...
Service](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsapplicationdiscoveryservice.html).
...
migration to the AWS Cloud. For more information, see [Agentless Collector](https://docs.aws.amazon.com/application-discovery/latest/userguide/agentless-collector.html).
