...
Agentless Collectors or Discovery Agents, see [Discovering data with the AWS Migration Hub console](https://docs.aws.amazon.com/application-discovery/latest/userguide/console-walkthrough.html).
...
see [Migration Hub Import](https://docs.aws.amazon.com/migrationhub/latest/ug/migration-hub-import.html).
