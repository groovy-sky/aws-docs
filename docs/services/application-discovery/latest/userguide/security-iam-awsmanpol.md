...
database. For an example of this policy, see [Granting full access to Application Discovery Service](https://docs.aws.amazon.com/application-discovery/latest/userguide/security_iam_id-based-policy-examples.html#security_iam_id-based-policy-examples-ads-fullaccess).
...
of this policy, see [Granting access to discovery agents](https://docs.aws.amazon.com/application-discovery/latest/userguide/security_iam_id-based-policy-examples.html#security_iam_id-based-policy-examples-ads-agentaccess).
...
mapping data that's collected by the agents. For an example of this policy, see [Granting permissions for agent data collection](https://docs.aws.amazon.com/application-discovery/latest/userguide/security_iam_id-based-policy-examples.html#security_iam_id-based-policy-examples-ads-export-service).
...
policy, see [Granting permissions for data exploration](https://docs.aws.amazon.com/application-discovery/latest/userguide/security_iam_id-based-policy-examples.html#security_iam_id-based-policy-examples-ads-export-firehose).
...
the RSS feed on the [Document History for AWS Application Discovery Service](https://docs.aws.amazon.com/application-discovery/latest/userguide/doc-history.html) page.
