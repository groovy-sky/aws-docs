---
title: "Data collected by the Agentless Collector VMware vCenter data collection module"
---
...
Collected Data](export-data.md) in the _Application Discovery Service User Guide_.
