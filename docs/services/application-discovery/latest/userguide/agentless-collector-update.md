...
3. Follow the instructions in [Update instance software on your\
    AL2 instance](../../../linux/al2/ug/install-updates.md) in the Amazon Linux 2 User Guide.
...
To enable and use Live Patching for Amazon Linux 2023, see [Kernel Live Patching on AL2023](../../../linux/al2023/ug/live-patching.md) in the
...
To enable and use Live Patching for Amazon Linux 2, see [Kernel Live Patching on AL2](../../../linux/al2/ug/al2-live-patching.md) in the
_Amazon EC2 User Guide_.
