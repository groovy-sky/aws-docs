...
practice [Create\
Individual IAM Users](https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html#create-iam-users) and create an AWS Identity and Access Management (IAM) administrator user.
...
[Creating Your First IAM User and Administrators Group](https://docs.aws.amazon.com/IAM/latest/UserGuide/getting-started_create-admin-group.html) in the
_IAM User Guide_.
...
[Grant\
Least Privilege](https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html#grant-least-privilege), granting users minimum permissions.
...
[AWS managed policies for AWS Application Discovery Service](https://docs.aws.amazon.com/application-discovery/latest/userguide/security-iam-awsmanpol.html).
...
2. Create a non-administrator IAM user by following the instructions for
    ...
    in your AWS account](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html) in the
    _IAM User Guide_.
...
managed policies, see [AWS managed policies for AWS Application Discovery Service](https://docs.aws.amazon.com/application-discovery/latest/userguide/security-iam-awsmanpol.html).
...
3. After you create the user provide them with programmatic access as described in
    [Support programmatic user access](https://docs.aws.amazon.com/IAM/latest/UserGuide/introduction_identity-management.html?icmpid=docs_iam_console#gs-get-keys).
