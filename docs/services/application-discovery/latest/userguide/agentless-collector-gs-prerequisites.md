---
title: "Prerequisites for Agentless Collector"
---
...
`FleetAdvisorS3Policy`. For more information, see [Deploying Application Discovery Service Agentless Collector](agentless-collector-deploying.md#agentless-collector-gs-iam-user). The IAM user must be
...
fix the connection to AWS, see [Fixing Agentless Collector cannot reach AWS during setup](agentless-collector-troubleshooting.md#agentless-collector-fix-connector-cannot-reach-aws).
