...
managed policy](https://docs.aws.amazon.com/IAM/latest/UserGuide/tutorial_managed-policies.html) in the _IAM User Guide_.
...
Privilege](https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html#grant-least-privilege), granting users minimum permissions.
...
2. Create a non-administrator IAM user by following the instructions for
    ...
    AWS account](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html) in the _IAM User Guide_.
...
You'll need these access keys in [Configuring Agentless Collector](https://docs.aws.amazon.com/application-discovery/latest/userguide/agentless-collector-gs-configure.html).
...
long-term credentials](https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html#rotate-credentials) in the
_IAM User Guide._
...
VMware](https://docs.aws.amazon.com/linux/al2023/ug/vmware-supported-configurations.html#vmware-host-requirements)
