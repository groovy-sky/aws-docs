...
**Agentless Collector**. If you do not select this checkbox,
    ...
    [Manually updating Application Discovery Service Agentless Collector](https://docs.aws.amazon.com/application-discovery/latest/userguide/agentless-collector-update.html).
