...
For more information about adding permissions to a policy, see [Adding and removing IAM identity permissions](../../../iam/latest/userguide/access-policies-manage-attach-detach.md) in the
_IAM User Guide_.
