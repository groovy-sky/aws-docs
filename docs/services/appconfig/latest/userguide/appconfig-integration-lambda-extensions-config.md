...
variables. For more information, see [Using AWS Lambda environment variables](../../../lambda/latest/dg/configuration-envvars.md) in the
...
by specifying an IAM role that grants [permissions](../../../iam/latest/userguide/id-roles-use-permissions-to-switch.md)
...
3. (Optional) If needed, an [external\
    ID](../../../iam/latest/userguide/id-roles-create-for-user-externalid.md) can be specified using the
