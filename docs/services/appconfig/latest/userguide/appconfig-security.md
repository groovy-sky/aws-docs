...
AWS Systems Manager](../../../systems-manager/latest/userguide/security.md). That section describes how to configure Systems Manager to meet the security
...
For more information about implementing least privilege access, see [SEC03-BP02 Grant least privilege access](../../../wellarchitected/latest/framework/sec-permissions-least-privileges.md) in the
...
your data. For more information, see [AWS owned keys](../../../kms/latest/developerguide/concepts.md#aws-owned-cmk)
...
key](../../../kms/latest/developerguide/concepts.md#customer-cmk) in the _AWS Key Management Service Developer Guide_.
...
When calling the AWS AppConfig [StartDeployment](../../../../reference/appconfig/2019-10-09/apireference/api-appconfigdata-startdeployment.md) API operation, the identity calling
...
An [encryption\
context](../../../kms/latest/developerguide/concepts.md#encrypt_context) is an optional set of key-value pairs that contain additional
...
AWS services through AWS PrivateLink](../../../vpc/latest/privatelink/privatelink-access-aws-services.md) in the
_AWS PrivateLink Guide_.

### Considerations for AWS AppConfig

Before you set up an interface endpoint for AWS AppConfig, review [Considerations](../../../vpc/latest/privatelink/create-interface-endpoint.md#considerations-interface-endpoints) in the
_AWS PrivateLink Guide_.

AWS AppConfig supports making calls to the [`appconfig`](../../../../reference/appconfig/2019-10-09/apireference/api-operations-amazon-appconfig.md) and [`appconfigdata`](../../../../reference/appconfig/2019-10-09/apireference/api-operations-aws-appconfig-data.md) services through the interface
endpoint.
...
or the AWS Command Line Interface (AWS CLI). For more information, see [Create an interface endpoint](../../../vpc/latest/privatelink/create-interface-endpoint.md#create-interface-endpoint-aws) in the
_AWS PrivateLink Guide_.
...
using endpoint policies](../../../vpc/latest/privatelink/vpc-endpoints-access.md) in the
_AWS PrivateLink Guide_.
...
Secrets Manager. For information about Secrets Manager, see [What is AWS Secrets Manager?](../../../secretsmanager/latest/userguide/intro.md) in the
...
secrets](../../../secretsmanager/latest/userguide/rotating-secrets.md) in the _AWS Secrets Manager User Guide_.
