...
more information, see [Retrieving configuration data without AWS AppConfig Agent](https://docs.aws.amazon.com/appconfig/latest/userguide/about-data-plane.html).
...
[retrieval features:](https://docs.aws.amazon.com/appconfig/latest/userguide/appconfig-agent-how-to-use-additional-features.html)
