...
by the Lambda function execution role. For more information, see [AWS Lambda execution role](../../../lambda/latest/dg/lambda-intro-execution-role.md)
in the _AWS Lambda Developer Guide_. For more information about AWS AppConfig
permissions, see [Actions,\
resources, and condition keys for AWS AppConfig](../../../service-authorization/latest/reference/list-awsappconfig.md) in the
...
[Configuring\
extensions](../../../lambda/latest/dg/using-extensions.md#using-extensions-config) in the _AWS Lambda Developer Guide_. The name of the
...
the console](../../../lambda/latest/dg/getting-started-create-function.md) in the _AWS Lambda Developer Guide_.
