...
To view code samples with `Entity-Id`, see [Using AWS AppConfig Agent to read a freeform configuration profile](https://docs.aws.amazon.com/appconfig/latest/userguide/appconfig-code-samples-agent-read-configuration.html).
