...
extension](working-with-appconfig-extensions.md) to retrieve your data from its source. For example, by using an AWS AppConfig
...
1. Create an [AWS Lambda\
    function](../../../lambda/latest/dg/welcome.md) that fetches data from your data source. As long as a Lambda function
...
2. Create a custom AWS AppConfig extension that invokes your Lambda function. For more
    information, see [Walkthrough: Creating custom AWS AppConfig extensions](working-with-appconfig-extensions-creating-custom.md).
...
4. Create an extension association that triggers using the
    ...
    information, see [Step 4: Create an extension association for a custom AWS AppConfig extension](working-with-appconfig-extensions-creating-custom-association.md).
