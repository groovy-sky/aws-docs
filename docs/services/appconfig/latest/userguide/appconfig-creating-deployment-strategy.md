...
Reference](https://docs.aws.amazon.com/appconfig/2019-10-09/APIReference/API_CreateDeploymentStrategy.html), `step percentage` is called `growth
                    factor`.
...
based on CloudWatch alarms. For more information, see [Configure permissions for automatic rollback](https://docs.aws.amazon.com/appconfig/latest/userguide/setting-up-appconfig.html#getting-started-with-appconfig-cloudwatch-alarms-permissions).
...
- [Using predefined deployment strategies](https://docs.aws.amazon.com/appconfig/latest/userguide/appconfig-creating-deployment-strategy-predefined.html)

- [Create a deployment strategy](https://docs.aws.amazon.com/appconfig/latest/userguide/appconfig-creating-deployment-strategy-create.html)
