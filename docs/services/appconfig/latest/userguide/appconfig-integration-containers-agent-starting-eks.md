---
title: "Starting the AWS AppConfig agent for Amazon EKS integration"
---
...
[Creating\
or updating a kubeconfig file for an Amazon EKS cluster](../../../eks/latest/userguide/create-kubeconfig.md) in the
...
variables. For more information, see [(Optional) Using environment variables to configure AWS AppConfig Agent for Amazon ECS and Amazon EKS](appconfig-integration-containers-agent-configuring.md).
