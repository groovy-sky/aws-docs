...
+ [How AWS User Experience Customization works with IAM](security_iam_service-with-iam.md)
+ [Identity-based policy examples for AWS User Experience Customization](security_iam_id-based-policy-examples.md)
