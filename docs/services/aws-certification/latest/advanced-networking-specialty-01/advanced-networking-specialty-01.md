...
<a name="advanced-networking-specialty-01"></a>
...
**Topics**
+ [Introduction](#advanced-networking-specialty-01-intro)
+ [Target Candidate Description](#advanced-networking-specialty-01-target)
+ [Exam Content](#advanced-networking-specialty-01-exam-content)
+ [Content Outline](#advanced-networking-specialty-01-domains)
+ [AWS Services for the Exam](#advanced-networking-specialty-01-services)
+ [Content Domain 1: Network Design](advanced-networking-specialty-01-domain1.md)
+ [Content Domain 2: Network Implementation](advanced-networking-specialty-01-domain2.md)
+ [Content Domain 3: Network Management and Operation](advanced-networking-specialty-01-domain3.md)
+ [Content Domain 4: Network Security, Compliance, and Governance](advanced-networking-specialty-01-domain4.md)
+ [In-Scope AWS Services](ans-01-in-scope-services.md)
+ [Out-of-Scope AWS Services](ans-01-out-of-scope-services.md)
+ [Survey](#advanced-networking-specialty-01-survey)

## Introduction
<a name="advanced-networking-specialty-01-intro"></a>

The [AWS Certified Advanced Networking - Specialty (ANS-C01)](https://aws.amazon.com/certification/certified-advanced-networking-specialty/) exam is intended for individuals who perform an AWS networking specialist's role. The exam validates a candidate's ability to design, implement, manage, and secure AWS and hybrid network architectures at scale.
...
<a name="advanced-networking-specialty-01-target"></a>
...
<a name="advanced-networking-specialty-01-aws-knowledge"></a>
...
## Exam Content
<a name="advanced-networking-specialty-01-exam-content"></a>

### Question Types
<a name="advanced-networking-specialty-01-question-types"></a>
...
### Unscored Content
<a name="advanced-networking-specialty-01-unscored-content"></a>
...
### Exam Results
<a name="advanced-networking-specialty-01-exam-results"></a>
...
## Content Outline
<a name="advanced-networking-specialty-01-domains"></a>
...
+ [Content Domain 1: Network Design (30% of scored content)](advanced-networking-specialty-01-domain1.md)
+ [Content Domain 2: Network Implementation (26% of scored content)](advanced-networking-specialty-01-domain2.md)
+ [Content Domain 3: Network Management and Operation (20% of scored content)](advanced-networking-specialty-01-domain3.md)
+ [Content Domain 4: Network Security, Compliance, and Governance (24% of scored content)](advanced-networking-specialty-01-domain4.md)

## AWS Services for the Exam
<a name="advanced-networking-specialty-01-services"></a>
...
## Survey
<a name="advanced-networking-specialty-01-survey"></a>

How useful was this exam guide? Let us know by [taking our survey](https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=ANS-Specialty&course_id=ANS-C01&Q_Language=EN).
