...
<a name="sysops-administrator-associate-03"></a>
...
**Topics**
+ [Introduction](#sysops-administrator-associate-03-intro)
+ [Target candidate description](#sysops-administrator-associate-03-target)
+ [Exam content](#sysops-administrator-associate-03-exam-content)
+ [Content outline](#sysops-administrator-associate-03-domains)
+ [Content Domain 1: Monitoring, Logging, Analysis, Remediation, and Performance Optimization](sysops-administrator-associate-03-domain1.md)
+ [Content Domain 2: Reliability and Business Continuity](sysops-administrator-associate-03-domain2.md)
+ [Content Domain 3: Deployment, Provisioning, and Automation](sysops-administrator-associate-03-domain3.md)
+ [Content Domain 4: Security and Compliance](sysops-administrator-associate-03-domain4.md)
+ [Content Domain 5: Networking and Content Delivery](sysops-administrator-associate-03-domain5.md)
+ [Mentions of AWS services on the exam](soa-03-service-mentions.md)
+ [In-Scope AWS Services](soa-03-in-scope-services.md)
+ [Out-of-Scope AWS Services](soa-03-out-of-scope-services.md)
+ [Comparison of SOA-C02 and SOA-C03](sysops-administrator-associate-03-comparison.md)
+ [Revisions](soa-03-revisions.md)
+ [Survey](#sysops-administrator-associate-03-survey)

## Introduction
<a name="sysops-administrator-associate-03-intro"></a>

The [AWS Certified CloudOps Engineer - Associate (SOA-C03)](https://aws.amazon.com/certification/certified-cloudops-engineer-associate/) exam is intended for CloudOps engineers. The exam validates a candidate's ability to deploy, manage, and operate workloads on AWS.
...
<a name="sysops-administrator-associate-03-target"></a>
...
<a name="sysops-administrator-associate-03-general-knowledge"></a>
...
<a name="sysops-administrator-associate-03-aws-knowledge"></a>
...
<a name="sysops-administrator-associate-03-out-of-scope"></a>
...
## Exam content
<a name="sysops-administrator-associate-03-exam-content"></a>

### Response types
<a name="sysops-administrator-associate-03-response-types"></a>
...
### Unscored content
<a name="sysops-administrator-associate-03-unscored-content"></a>
...
### Exam results
<a name="sysops-administrator-associate-03-exam-results"></a>
...
## Content outline
<a name="sysops-administrator-associate-03-domains"></a>
...
+ [Content Domain 1: Monitoring, Logging, Analysis, Remediation, and Performance Optimization (22% of scored content)](sysops-administrator-associate-03-domain1.md)
+ [Content Domain 2: Reliability and Business Continuity (22% of scored content)](sysops-administrator-associate-03-domain2.md)
+ [Content Domain 3: Deployment, Provisioning, and Automation (22% of scored content)](sysops-administrator-associate-03-domain3.md)
+ [Content Domain 4: Security and Compliance (16% of scored content)](sysops-administrator-associate-03-domain4.md)
+ [Content Domain 5: Networking and Content Delivery (18% of scored content)](sysops-administrator-associate-03-domain5.md)

## Survey
<a name="sysops-administrator-associate-03-survey"></a>

How useful was this exam guide? Let us know by [taking our survey](https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=SysOps-Associate&course_id=SOA-C02&Q_Language=EN).
