...
<a name="cloud-practitioner-02"></a>
...
**Topics**
+ [Introduction](#cloud-practitioner-02-intro)
+ [Target Candidate Description](#cloud-practitioner-02-target)
+ [Exam Content](#cloud-practitioner-02-exam-content)
+ [Content Outline](#cloud-practitioner-02-domains)
+ [Service References](#clf-service-references)
+ [Content Domain 1: Cloud Concepts](cloud-practitioner-02-domain1.md)
+ [Content Domain 2: Security and Compliance](cloud-practitioner-02-domain2.md)
+ [Content Domain 3: Cloud Technology and Services](cloud-practitioner-02-domain3.md)
+ [Content Domain 4: Billing, Pricing, and Support](cloud-practitioner-02-domain4.md)
+ [Technologies and Concepts](clf-technologies-concepts.md)
+ [In-Scope AWS Services](clf-02-in-scope-services.md)
+ [Out-of-Scope AWS Services](clf-02-out-of-scope-services.md)
+ [Survey](#cloud-practitioner-02-survey)

## Introduction
<a name="cloud-practitioner-02-intro"></a>

The [AWS Certified Cloud Practitioner (CLF-C02)](https://aws.amazon.com/certification/certified-cloud-practitioner/) exam is intended for individuals who can effectively demonstrate overall knowledge of the AWS Cloud, independent of a specific job role.
...
<a name="cloud-practitioner-02-target"></a>
...
<a name="cloud-practitioner-02-aws-knowledge"></a>
...
<a name="cloud-practitioner-02-out-of-scope"></a>
...
## Exam Content
<a name="cloud-practitioner-02-exam-content"></a>
...
### Unscored Content
<a name="cloud-practitioner-02-unscored-content"></a>
...
### Exam Results
<a name="cloud-practitioner-02-exam-results"></a>
...
## Content Outline
<a name="cloud-practitioner-02-domains"></a>
...
+ [Content Domain 1: Cloud Concepts (24% of scored content)](cloud-practitioner-02-domain1.md)
+ [Content Domain 2: Security and Compliance (30% of scored content)](cloud-practitioner-02-domain2.md)
+ [Content Domain 3: Cloud Technology and Services (34% of scored content)](cloud-practitioner-02-domain3.md)
+ [Content Domain 4: Billing, Pricing, and Support (12% of scored content)](cloud-practitioner-02-domain4.md)

## Service References
<a name="clf-service-references"></a>
...
## Survey
<a name="cloud-practitioner-02-survey"></a>
