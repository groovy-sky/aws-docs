---
title: "Troubleshooting Amazon ElastiCache identity and access"
---
...
- To learn whether ElastiCache supports these features, see [How Amazon ElastiCache works with IAM](security-iam-service-with-iam.md).
