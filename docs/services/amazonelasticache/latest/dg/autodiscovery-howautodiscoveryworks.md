---
title: "How Auto Discovery Works"
---
...
![Connecting to Cache Nodes](https://docs.aws.amazon.com/images/AmazonElastiCache/latest/dg/images/autodiscovery_cluster_membership_refresh-diagram.png)

Process of Connecting to Cache Nodes

![1](https://docs.aws.amazon.com/images/AmazonElastiCache/latest/dg/images/callouts/1.png)

The application resolves the configuration endpoint's DNS name. Because
the configuration endpoint maintains CNAME entries for all of the cache
nodes, the DNS name resolves to one of the nodes; the client can
then connect to that node.

![2](https://docs.aws.amazon.com/images/AmazonElastiCache/latest/dg/images/callouts/2.png)

The client requests the configuration information for all of the
other nodes. Since each node maintains configuration information for
all of the nodes in the cluster, any node can pass configuration
information to the client upon request.

![3](https://docs.aws.amazon.com/images/AmazonElastiCache/latest/dg/images/callouts/3.png)

The client receives the current list of cache node
hostnames and IP addresses. It can then connect to all of the
...
![Normal Cluster Operations](https://docs.aws.amazon.com/images/AmazonElastiCache/latest/dg/images/autodiscovery_normal_cache_usage-diagram.png)

Process of Normal Cluster Operations

![1](https://docs.aws.amazon.com/images/AmazonElastiCache/latest/dg/images/callouts/1.png)

The application issues a _get_ request for a
particular data item, identified by its key.

![2](https://docs.aws.amazon.com/images/AmazonElastiCache/latest/dg/images/callouts/2.png)

The client uses a hashing algorithm against the key to
determine which cache node contains the data item.

![3](https://docs.aws.amazon.com/images/AmazonElastiCache/latest/dg/images/callouts/3.png)

The data item is requested from the appropriate node.

![4](https://docs.aws.amazon.com/images/AmazonElastiCache/latest/dg/images/callouts/4.png)
