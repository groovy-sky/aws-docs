...
cluster to populate through use. For information about seeding a new cluster, see [Tutorial: Seeding a new node-based cluster with an externally created backup](backups-seeding-redis.md).
...
For more information about creating an Amazon S3 bucket, see [Creating a bucket](../../../s3/latest/userguide/creatingabucket.md) in the _Amazon Simple Storage Service User Guide_.
...
access](../../../s3/latest/userguide/s3-access-control.md) in the _Amazon S3 User Guide_.
...
If you want to copy your backup to another AWS Region, use Amazon S3 to copy it. For more information, see [Copying an object](../../../s3/latest/userguide/makingacopyofanobject.md) in the _Amazon Simple Storage Service User Guide_.
