...
- [Offline resharding for Valkey or Redis OSS (cluster mode enabled)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-offline)

- [Online resharding for Valkey or Redis OSS (cluster mode enabled)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online)

  - [Adding shards with online resharding](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online-add)

  - [Removing shards with online resharding](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online-remove)

    - [Removing shards (Console)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online-remove-console)

    - [Removing shards (AWS CLI)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online-remove-cli)

    - [Removing shards (ElastiCache API)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online-remove-api)
  - [Online shard rebalancing](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online-rebalance)

    - [Online Shard Rebalancing (Console)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online-rebalance-console)

    - [Online shard rebalancing (AWS CLI)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online-rebalance-cli)

    - [Online shard rebalancing (ElastiCache API)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/scaling-redis-cluster-mode-enabled.html#redis-cluster-resharding-online-rebalance-api)
- [Online vertical scaling by modifying node type](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/redis-cluster-vertical-scaling.html)

  - [Online scaling up](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/redis-cluster-vertical-scaling.html#redis-cluster-vertical-scaling-scaling-up)

    - [Scaling up Valkey or Redis OSS clusters (Console)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/redis-cluster-vertical-scaling.html#redis-cluster-vertical-scaling-console)

    - [Scaling up Valkey or Redis OSS clusters (AWS CLI)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/redis-cluster-vertical-scaling.html#Scaling.RedisStandalone.ScaleUp.CLI)

    - [Scaling up Valkey or Redis OSS clusters (ElastiCache API)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/redis-cluster-vertical-scaling.html#VeticalScaling.RedisReplGrps.ScaleUp.API)
  - [Online scaling down](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/redis-cluster-vertical-scaling.html#redis-cluster-vertical-scaling-scaling-down)

    - [Scaling down Valkey or Redis OSS clusters (Console)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/redis-cluster-vertical-scaling.html#redis-cluster-vertical-scaling-down-console)

    - [Scaling down Valkey or Redis OSS clusters (AWS CLI)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/redis-cluster-vertical-scaling.html#Scaling.RedisStandalone.ScaleDown.CLI)

    - [Scaling down Valkey or Redis OSS clusters (ElastiCache API)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/redis-cluster-vertical-scaling.html#Scaling.Vertical.ScaleDown.API)
...
1. Create a manual backup of your existing Valkey or Redis OSS cluster.
    For more information, see [Taking manual backups](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/backups-manual.html).
...
3. Update the endpoints in your application to the new
    cluster's endpoints.
    For more information, see [Finding connection endpoints in ElastiCache](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Endpoints.html).
...
upgrading your engine version, see [Version Management for ElastiCache](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/VersionManagement.html).
...
For more information, see [Online cluster resizing](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/best-practices-online-resharding.html).
...
delete the replication group. For more information, see [Deleting a replication group](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Replication.DeletingRepGroup.html). The following procedure
...
delete the replication group. For more information, see [Deleting a replication group](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Replication.DeletingRepGroup.html).
