...
For more information, see [How synchronization and backup are implemented](replication-redis-versions.md).
...
see [Creating an ElastiCache parameter group](parametergroups-creating.md) and
