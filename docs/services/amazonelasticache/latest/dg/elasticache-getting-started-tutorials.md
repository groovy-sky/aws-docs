...
AWS SDKs are available for a wide variety of languages. For a complete list,
see [Tools for Amazon Web Services](https://aws.amazon.com/tools).
...
Network type for serverless caches
