---
title: "Identity and Access Management for Amazon ElastiCache"
---
...
- [Identity-based policy examples for Amazon ElastiCache](security-iam-id-based-policy-examples.md)

- [Troubleshooting Amazon ElastiCache identity and access](security-iam-troubleshoot.md)
...
administrator if you cannot access features (see [Troubleshooting Amazon ElastiCache identity and access](security-iam-troubleshoot.md))

- **Service administrator** \- determine user access and
submit permission requests (see [How Amazon ElastiCache works with IAM](security-iam-service-with-iam.md))

- **IAM administrator** \- write policies to manage
access (see [Identity-based policy examples for Amazon ElastiCache](security-iam-id-based-policy-examples.md))
