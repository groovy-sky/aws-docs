...
topic [Finding a Cluster's Endpoints (Console) (Memcached)](endpoints.md#Endpoints.Find.Memcached)
...
To take advantage of Auto Discovery, client programs must use the _ElastiCache_
_Cluster Client_. The ElastiCache Cluster Client is available for Java, PHP, and .NET
...
The source code for the ElastiCache Cluster Client for Java is available at [https://github.com/amazonwebservices/aws-elasticache-cluster-client-memcached-for-java](https://github.com/amazonwebservices/aws-elasticache-cluster-client-memcached-for-java).
...
For more information, see [Installing the ElastiCache cluster client for PHP](appendix-phpautodiscoverysetup.md).
...
For more information, see [Installing the ElastiCache cluster client for .NET](appendix-dotnetautodiscoverysetup.md).
