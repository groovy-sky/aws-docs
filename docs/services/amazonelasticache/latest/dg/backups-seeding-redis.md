...
see [Restoring from a backup into a new cache](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/backups-restoring.html).
...
Valkey or Redis OSS overhead. For more information, see [Ensuring you have enough memory to make a Valkey or Redis OSS snapshot](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/BestPractices.BGSAVE.html).
...
see [Redis OSS node-type specific parameters](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/ParameterGroups.Engine.html#ParameterGroups.Redis.NodeSpecific)
...
2. Follow the instructions for creating an Amazon S3 bucket in [Creating a bucket](https://docs.aws.amazon.com/AmazonS3/latest/userguide/create-bucket.html) in the
...
in [Managing AWS\
\
regions](https://docs.aws.amazon.com/general/latest/gr/rande-manage.html) in _AWS General Reference_.
...
To create the cluster, follow the directions at [Creating a cluster for Valkey or Redis OSS](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.Create.html)
or [Creating a Valkey or Redis OSS replication group from scratch](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Replication.CreatingReplGroup.NoExistingCluster.html).
...
ElastiCache API to obtain event messages. For more information, see [Viewing ElastiCache events](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/ECEvents.Viewing.html).
