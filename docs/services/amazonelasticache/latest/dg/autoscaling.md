...
Scaling service to provide this functionality. For more information, see [Application Auto Scaling](https://docs.aws.amazon.com/autoscaling/application/userguide/what-is-application-auto-scaling.html). To use automatic scaling, you define and apply a
...
- [Target tracking scaling policies](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/AutoScaling-Scaling-Policies-Target.html) – Increase or
...
- [Scheduled scaling for your application.](https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-scheduled-scaling.html) –
