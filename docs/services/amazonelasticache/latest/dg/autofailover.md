...
creating a cluster with replication, see [Creating a Valkey or Redis OSS replication group](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Replication.CreatingRepGroup.html). For information about adding a read
replica to a cluster with replication, see [Adding a read replica for Valkey or Redis OSS (Cluster Mode Disabled)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Replication.AddReadReplica.html).
...
For more information on this process, see [Creating a Valkey (cluster mode disabled) cluster (Console)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/SubnetGroups.designing-cluster-pre.valkey.html#Clusters.Create.CON.valkey-gs). Be sure to have one or more
replicas and enable Multi-AZ.

#### Enabling Multi-AZ on an existing cluster (Console)

For more information on this process, see Modifying a Cluster [Using the ElastiCache AWS Management Console](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.Modify.html#Clusters.Modify.CON).
...
- [modify-replication-group](https://docs.aws.amazon.com/cli/latest/reference/elasticache/modify-replication-group.html) in the _AWS CLI Command_
_Reference._
...
- [Finding a Valkey or Redis OSS (Cluster Mode Disabled) Cluster's Endpoints (Console)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Endpoints.html#Endpoints.Find.Redis)

- [Finding the Endpoints for Valkey or Redis OSS Replication Groups (AWS CLI)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Endpoints.html#Endpoints.Find.CLI.ReplGroups)

- [Finding Endpoints for Valkey or Redis OSS Replication Groups (ElastiCache API)](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Endpoints.html#Endpoints.Find.API.ReplGroups)
...
- [DescribeEvents](https://docs.aws.amazon.com/AmazonElastiCache/latest/APIReference/API_DescribeEvents.html) in the _ElastiCache API_
_Reference_

- [describe-events](https://docs.aws.amazon.com/cli/latest/reference/elasticache/describe-events.html) in the _AWS CLI Command_
_Reference._
...
4. In the **Details** area, confirm that this cluster is
    ...
    information, see [Using the ElastiCache AWS Management Console](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.Modify.html#Clusters.Modify.CON).
...
- [test-failover](https://docs.aws.amazon.com/cli/latest/reference/elasticache/test-failover.html) in the _AWS CLI Command_
_Reference._
...
- [TestFailover](https://docs.aws.amazon.com/AmazonElastiCache/latest/APIReference/API_TestFailover.html) in
