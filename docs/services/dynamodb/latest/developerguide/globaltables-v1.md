...
- [Global tables: How it works](globaltables-howitworks.md)

- [Best practices and requirements for managing global tables](globaltables-reqs-bestpractices.md)

- [Creating a global table (Version 2017.11.29)](globaltables-tutorial.md)

- [Monitoring global tables](globaltables-monitoring.md)
