...
any requests that you make using the context. For more information, see [Specifying optional parameters for DynamoDBContext](dotnetdynamodbcontext.md#OptionalConfigParams).
