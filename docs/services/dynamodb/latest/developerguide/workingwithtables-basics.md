...
from each other. For more information, see [Supported data types and naming rules in Amazon DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.NamingRulesDataTypes.html).
...
`RANGE` (for a sort key). For more information, see [Primary key](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.CoreComponents.html#HowItWorks.CoreComponents.PrimaryKey).
...
for you. For more information, see [DynamoDB provisioned capacity mode](provisioned-capacity-mode.md) and [Managing throughput capacity automatically with DynamoDB auto scaling](autoscaling.md).
...
100 bytes. (For more information, go to [DynamoDB Pricing](https://aws.amazon.com/dynamodb/pricing).) This extra
...
- Manipulate global secondary indexes on the table (see [Using Global Secondary Indexes in DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GSI.html)).

- Enable or disable DynamoDB Streams on the table (see [Change data capture for DynamoDB Streams](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Streams.html)).
...
AWS Management Console, see [Step 6: (Optional) Delete your DynamoDB table to clean up resources](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/getting-started-step-6.html).
...
[Throughput default quotas](servicequotas.md#default-limits-throughput).
