...
reserved word. For more information, see [Expression attribute names (aliases) in DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.ExpressionAttributeNames.html).
