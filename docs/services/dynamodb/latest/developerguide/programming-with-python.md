...
- [Official\
AWS single-action code examples.](../../../code-library/latest/ug/python-3-dynamodb-code-examples.md)
...
SDK reference](../../../../reference/sdkref/latest/guide/feature-retry-behavior.md).
...
generate (for example [BatchWriteItem](../../../../reference/amazondynamodb/latest/apireference/api-batchwriteitem.md)).
