...
- General partition concepts and data distribution, see [Partitions in DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.Partitions.html).
...
persists, check if your table is limited by its [Understanding DynamoDB warm throughput](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/warm-throughput.html) capacity. Use warm throughput or increase
...
- **Pre-warm capacity:** If throttling
persists, check if your table is limited by its [Understanding DynamoDB warm throughput](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/warm-throughput.html) capacity.
...
- **Pre-warm capacity:** If throttling
persists, check if your GSI is limited by its [Understanding DynamoDB warm throughput](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/warm-throughput.html) capacity.
...
limited by its [Understanding DynamoDB warm throughput](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/warm-throughput.html) capacity. Use warm throughput or
...
1. Enable [CloudWatch Contributor\
    Insights](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/contributorinsights_HowItWorks.html) on your table or GSI to track the most throttled keys.
...
DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/bp-indexes-general.html).
