...
Number of MRSC global tables (See [Consistency modes](v2globaltables-howitworks.md#V2globaltables_HowItWorks.consistency-modes))
...
information on import and validation, see [import format quotas and validation](s3dataimport-validation.md#S3DataImport.Validation.limits).
