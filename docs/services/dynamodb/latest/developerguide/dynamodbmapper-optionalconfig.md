...
For more information, see [_DynamoDBMapperConfig_](../../../../reference/awsjavasdk/latest/javadoc/com/amazonaws/services/dynamodbv2/datamodeling/dynamodbmapperconfig.md) in the
[AWS SDK for Java API Reference](../../../../reference/sdk-for-java/latest/reference.md).
