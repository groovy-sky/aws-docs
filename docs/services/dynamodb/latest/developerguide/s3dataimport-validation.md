...
considered on a case-by-case basis. For more details on DynamoDB limits, see [Service Quotas](servicequotas.md).
...
[Using and data keys](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/encryption.usagenotes.html#dynamodb-kms).
