...
For the corresponding Javadoc documentation, see [DynamoDBMapper](../../../../reference/awsjavasdk/latest/javadoc/com/amazonaws/services/dynamodbv2/datamodeling/dynamodbmapper.md) in the _AWS SDK for Java API Reference_.
...
versioning, see [DynamoDB and optimistic locking with version number](dynamodbmapper-optimisticlocking.md).
...
For a list of transaction-specific exceptions, see [TransactWriteItems errors](../../../../reference/amazondynamodb/latest/apireference/api-transactwriteitems.md#API_TransactWriteItems_Errors).
...
- [DynamoDBMapperConfig.SaveBehavior](dynamodbmapper-optionalconfig.md).
...
For a list of transaction-specific exceptions, see [TransactGetItems errors](../../../../reference/amazondynamodb/latest/apireference/api-transactgetitems.md#API_TransactGetItems_Errors).
...
in Amazon S3. For more information, see the [Javadocs for `S3Link`](../../../../reference/awsjavasdk/latest/javadoc/com/amazonaws/services/dynamodbv2/datamodeling/s3link.md).
