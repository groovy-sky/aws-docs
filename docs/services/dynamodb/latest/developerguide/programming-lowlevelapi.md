...
| --- | --- | --- |
| S | {"S": "Hello"} | Value is a JSON string. |
| N | {"N": "123.45"} | Value is a string, not a JSON number. This preserves precision across languages. |
| B | {"B": "dGhpcyBpcyBhIHRlc3Q="} | Value is a base64-encoded string. |
| BOOL | {"BOOL": true} | Value is a JSON boolean (true or false), not a string. |
| NULL | {"NULL": true} | Value is the JSON boolean true to indicate null. |
| M | {"M": {"Name": {"S": "Joe"}}} | Value is a JSON object of attribute name–value pairs. |
| L | {"L": [{"S": "Red"}, {"N": "5"}]} | Value is a JSON array of attribute values. |
| SS | {"SS": ["Red", "Blue"]} | Value is a JSON array of strings. |
| NS | {"NS": ["1", "2.5"]} | Value is a JSON array of number strings. |
| BS | {"BS": ["U3Vubnk=", "UmFpbnk="]} | Value is a JSON array of base64-encoded strings. |
