...
[Data types](constraints.md#limits-data-types).
...
list, see [Reserved words in DynamoDB](reservedwords.md). Also,
...
For more information, see [Attributes](constraints.md#limits-attributes).
...
those elements are deeply nested. For more information, see [Using expressions in DynamoDB](expressions.md).
