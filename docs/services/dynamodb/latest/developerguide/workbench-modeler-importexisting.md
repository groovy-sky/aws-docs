...
JSON template format](../../../cloudformation/latest/userguide/aws-resource-dynamodb-table.md).

###### To import a data model

1. Open NoSQL Workbench, and on the main screen, select **Import model**.
    You can import either a NoSQL Workbench model format or CloudFormation JSON template.
