...
<a name="w2aac58b5c13"></a>
 ...
 If you can't access the DynamoDB API or DynamoDB Streams API then you need to update your certificate bundle. To do this, you need to import at least one of the required CAs. You can find these at [https://www.amazontrust.com/repository/](https://www.amazontrust.com/repository/).
