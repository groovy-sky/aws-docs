...
access key. For more information, see [Granting programmatic access](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/SettingUp.DynamoWebService.html#SettingUp.DynamoWebService.GetCredentials).
...
2. Follow the instructions for [Installing the AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/installing.html) and [Configuring the\
...
secret access key. For more information, see [Setting up DynamoDB (web service)](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/SettingUp.DynamoWebService.html).
...
You can also access DynamoDB by downloading and using the [NoSQL Workbench for DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/workbench.html).
...
DynamoDB local. To learn more about DynamoDB local and its requirements, see [Setting up DynamoDB local (downloadable version)](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DynamoDBLocal.html).
...
at the end of the process. For more information, see [Building data models with NoSQL Workbench](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/workbench.Modeler.html).
...
generate sample code in multiple languages. For more information, see [Exploring datasets and building operations with NoSQL Workbench](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/workbench.querybuilder.html).

## IP address ranges

Amazon Web Services (AWS) publishes its current IP address ranges in JSON format. To view the
current ranges, download [ip-ranges.json](https://ip-ranges.amazonaws.com/ip-ranges.json). For more information, see [AWS IP address ranges](https://docs.aws.amazon.com/general/latest/gr/aws-ip-ranges.html) in the
...
quotas](https://docs.aws.amazon.com/general/latest/gr/ddb.html) topic in the _AWS General Reference_
_guide_.
...
endpoints, see [Dual-stack and FIPS endpoints](https://docs.aws.amazon.com/sdkref/latest/guide/feature-endpoints.html) topic in the _AWS SDKs and Tools guide_.
...
issues. For more information, see [IP address condition operators](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html#Conditions_IPAddress) section in the _AWS_
