...
- `-cors` `value` — Enables support for cross-origin resource
...
- `-dbPath` `value` — The directory where DynamoDB writes its database
...
- `-port` `value` — The port number that DynamoDB uses to
...
- [Java: Setting the AWS Region and endpoint](codesamples-java.md#CodeSamples.Java.RegionAndEndpoint) (DynamoDB local
...
- The downloadable version of DynamoDB ignores the [Limit](../../../../reference/amazondynamodb/latest/apireference/api-executestatement.md#DDB-ExecuteStatement-request-Limit) parameter in [ExecuteStatement](../../../../reference/amazondynamodb/latest/apireference/api-executestatement.md).
