...
condition expression. See [Condition and filter expressions, operators, and functions in DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.OperatorsAndFunctions.html) for more information about
logical operators.
...
For code examples in various programming languages, see the [Amazon DynamoDB Getting Started Guide](https://docs.aws.amazon.com/amazondynamodb/latest/gettingstartedguide) and the
...
all the results (see [Paginating the results](#Scan.Pagination)).
...
If you `Scan` a...DynamoDB consumes read capacity units from...TableThe table's provisioned read capacity.Global secondary indexThe index's provisioned read capacity.Local secondary indexThe base table's provisioned read capacity.

###### Note

Cross-account access for secondary index scan operations is currently not
supported with [resource-based\
policies](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/access-control-resource-based.html).
...
information, see [DynamoDB read consistency](howitworks-readconsistency.md).
...
or replication scenarios, in conjunction with [DynamoDB Streams](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Streams.html).
...
![A multithreaded application that performs a parallel scan by dividing a table into three segments.](https://docs.aws.amazon.com/images/amazondynamodb/latest/developerguide/images/ParallelScan.png)
