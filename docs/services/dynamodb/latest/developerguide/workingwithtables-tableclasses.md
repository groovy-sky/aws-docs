...
Explorer, see the [AWS Billing and Cost Management Documentation](../../../account-billing/index.md). See [Amazon DynamoDB Pricing](https://aws.amazon.com/dynamodb/pricing/on-demand)
