...
+ [Increase your existing DynamoDB table's warm throughput](update-warm-throughput.md)
+ [Create a new DynamoDB table with higher warm throughput](create-table-warm-throughput.md)
+ [Understanding DynamoDB warm throughput in different scenarios](warm-throughput-scenarios.md)
