---
title: "Troubleshooting Amazon Simple Workflow Service identity and access"
---
...
- To learn whether Amazon SWF supports these features, see [How Amazon Simple Workflow Service works with IAM](security-iam-service-with-iam.md).
