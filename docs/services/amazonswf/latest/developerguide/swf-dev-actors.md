...
various next actions. For a list of the possible decisions, go to [Decision](../../../../reference/amazonswf/latest/apireference/api-decision.md) in the Amazon Simple Workflow Service API Reference.
...
To use an activity task in your workflow, you must register it using either the Amazon SWF console or the [RegisterActivityType](../../../../reference/amazonswf/latest/apireference/api-registeractivitytype.md) action.
