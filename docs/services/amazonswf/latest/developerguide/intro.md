...
1. Write a **decider** to handle the coordination logic of your workflow.

1. Register your activities and workflow with Amazon SWF.

   You can do this step programmatically or by using the AWS Management Console.

1. Start your activity workers and decider.
...
1. Start one or more executions of your workflow.
...
1. View workflow executions using the AWS Management Console.
...
You have the option of developing for Amazon SWF in any of the programming languages supported by AWS. For Java developers, the AWS Flow Framework is also available. For more information, see the [AWS Flow Framework](https://aws.amazon.com/swf/flow/) website, and see [AWS Flow Framework for Java Developer Guide](https://docs.aws.amazon.com/amazonswf/latest/awsflowguide/).
...
For a list of Amazon SWF endpoints, see [Regions and Endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html).
