---
title: "Identity-based policy examples for Amazon Simple Workflow Service"
---
...
For details about actions and resource types defined by Amazon SWF, including the format of the ARNs for each of the resource types, see [Actions, Resources, and Condition Keys for Amazon Simple Workflow Service](../../../iam/latest/userguide/list-amazonsimpleworkflowservice.md) in the _Service Authorization Reference_.
