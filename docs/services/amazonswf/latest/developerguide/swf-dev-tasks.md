...
+ **Lambda task** – A *Lambda* task is similar to an Activity task, but executes a Lambda function instead of a traditional Amazon SWF activity. For more information about how to define a Lambda task, see [AWS Lambda tasks in Amazon SWF](lambda-task.md).
