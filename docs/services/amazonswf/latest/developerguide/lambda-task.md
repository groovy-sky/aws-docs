...
1. Attach the IAM roles to your workflows.

1. Call your Lambda function during a workflow execution.
...
For more information, see [ Implementing AWS Lambda Tasks](https://docs.aws.amazon.com/amazonswf/latest/awsflowguide/lambda-task.html)
