...
+ Assign your account's Access ID and secret ID to the AWS\_ACCESS\_KEY\_ID and AWS\_SECRET\_KEY environment variables, respectively. It's a good practice to not expose the literal key values in your code. Storing them in environment variables is a convenient way to handle the issue.
