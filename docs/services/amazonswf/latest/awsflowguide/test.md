...
Because the `SpringWorkflowWorker` is fully configured in Spring and automatically starts polling when the Spring context is initialized, the host process for the decider is simple:
