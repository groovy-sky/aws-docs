...
3. Under **multifactor authentication**, choose **Multifactor Authentication Setup**.

You will be redirected to _AWS Access Portal_. For information on AWS Access Portal, see [Using the AWS access portal.](../../../singlesignon/latest/userguide/using-the-portal.md).
