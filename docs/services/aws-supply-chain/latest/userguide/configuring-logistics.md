...
![Viewing the logistics details](https://docs.aws.amazon.com/images/aws-supply-chain/latest/userguide/images/Logistics.png)
...
![Comments feature on the Logistics page](https://docs.aws.amazon.com/images/aws-supply-chain/latest/userguide/images/comments-logistics.PNG)

The **Logistics** page, displays the following from your ERP or source system:

Logistics columnDescriptionData entityColumn
...
You can select the standard transfer order (STO) or line number to view in your ERP or source system.
...
Displays the current milestone.
