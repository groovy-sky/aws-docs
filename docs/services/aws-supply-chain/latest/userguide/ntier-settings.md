...
2. Choose **Organization**, **Forecast Commits**, or
    **Purchase Orders**, depending on what you want to
    edit.

For information on how to update the settings, see [Using N-Tier Visibility for the first time](ntier-firsttime.md).
