...
For more information, see [Lambda function scaling](../../../lambda/latest/dg/concurrent-executions.md#per-function-concurrency).
...
For more information, see [Managing your costs with AWS Budgets](../../../awsaccountbilling/latest/aboutv2/budgets-managing-costs.md).
...
domains](../../../opensearch-service/latest/developerguide/createupdatedomains.md#createdomains).

For more information about OpenSearch Service, see the [Amazon OpenSearch Service Developer Guide](../../../opensearch-service/latest/developerguide.md).
