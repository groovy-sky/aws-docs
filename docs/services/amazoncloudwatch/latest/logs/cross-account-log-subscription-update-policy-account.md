...
in [Enable logging from AWS services](aws-logs-and-resource-policy.md), then before
doing this step, you must have first updated the subscription
filters in all the sender accounts as explained in [Step 1: Update the subscription filters](cross-account-log-subscription-update-filter-account.md).
