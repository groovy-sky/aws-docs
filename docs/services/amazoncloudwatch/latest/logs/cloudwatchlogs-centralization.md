...
2. **KMS Encrypted Log Group**
      ...
      add the tag LogsManaged = true to the kms key. For more information, see [Step 2: Set permissions on the KMS key](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatchLogs-Insights-Query-Encrypt.html#cmk-permissions).
...
the necessary permissions to CloudWatch Logs. For more information, see [Step 2: Set permissions on the KMS key](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatchLogs-Insights-Query-Encrypt.html#cmk-permissions).
