...
For more information, see [Cross-account cross-Region log centralization](cloudwatchlogs-centralization.md).
...
[Collecting Metrics and Logs from Amazon EC2 Instances and On-Premises Servers with the CloudWatch Agent](../monitoring/install-cloudwatch-agent.md) in the
_Amazon CloudWatch User Guide_.

- **AWS CLI**—The [put-log-events](../../../cli/latest/reference/logs/put-log-events.md)
uploads batches of log events to CloudWatch Logs.

- **Programmatically**— The [PutLogEvents](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putlogevents.md)
...
For more information, see [Creating metrics from log events using filters](monitoringlogdata.md).
...
For detailed information about deletion protection, see [Protecting log groups from deletion](protecting-log-groups-from-deletion.md).
...
[Controlling access to Amazon Web Services resources using tags](../../../iam/latest/userguide/access-tags.md).
...
Cost Allocation Tags for Custom Billing Reports](../../../awsaccountbilling/latest/aboutv2/cost-alloc-tags.md) in the
...
[create-log-group](../../../cli/latest/reference/logs/create-log-group.md)

Creates a log group. You can optionally add tags when you create the log group.

[tag-resource](../../../cli/latest/reference/logs/tag-resource.md)

Assigns one or more tags (key-value pairs) to the specified CloudWatch Logs resource.

[list-tags-for-resource](../../../cli/latest/reference/logs/list-tags-for-resource.md)

Displays the tags the are associated with a CloudWatch Logs resource.

[untag-resource](../../../cli/latest/reference/logs/untag-log-group.md)
...
[UntagResource](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-untagloggroup.md)
