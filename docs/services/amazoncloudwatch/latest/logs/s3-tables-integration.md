...
Learn more about Lake Formation permissions at [https://docs.aws.amazon.com/lake-formation/latest/dg/granting-catalog-permissions.html](../../../lake-formation/latest/dg/granting-catalog-permissions.md).
