---
title: "Supported log destinations"
---

# Supported log destinations

The following table shows which destinations each AWS service supports
for sending logs, and which permissions version is required.
...
[Amazon Bedrock AgentCore Payments](../../../bedrock-agentcore/latest/devguide/payments.md)
...
[Amazon Chime media quality metric logs and SIP message logs](../../../chime/latest/ag/monitoring-cloudwatch.md#cw-logs)
...
[CloudFront: access logs](../../../amazoncloudfront/latest/developerguide/accesslogs.md)
...
[Amazon Connect Customer logs](../../../connect/latest/adminguide/logging-and-monitoring.md)
...
[Amazon ElastiCache (Redis OSS) logs](../../../amazonelasticache/latest/red-ug/log-delivery.md)
...
[AWS Elastic Beanstalk logs](../../../elasticbeanstalk/latest/dg/awshowto-cloudwatchlogs.md)

Custom logs

Supported

[Amazon Elastic Container Service logs](../../../amazonecs/latest/developerguide/using-cloudwatch-logs.md)

Custom logs

Supported

[Amazon Elastic Kubernetes Service Auto Mode logs](../../../eks/latest/userguide/auto-managed-component-logs.md)
...
[Amazon Elastic Kubernetes Service control plane logs](../../../eks/latest/userguide/control-plane-logs.md)
...
[AWS Entity Resolution logs](../../../entityresolution/latest/userguide/what-is-service.md)
...
[AWS Fargate logs](../../../amazonecs/latest/developerguide/using-awslogs.md)

Custom logs

Supported

[AWS Fault Injection Service experiment logs](../../../fis/latest/userguide/monitoring-logging.md)
...
[AWS Glue job logs](../../../glue/latest/dg/monitor-continuous-logging.md)
...
[Amazon Interactive Video Service chat logs](../../../ivs/latest/lowlatencyuserguide/chat-logging.md)
...
[AWS IoT logs](../../../iot/latest/developerguide/cloud-watch-logs.md)
...
[AWS Lambda logs](../../../lambda/latest/dg/monitoring-cloudwatchlogs.md)
...
[Amazon SES logs](../../../ses/latest/dg/eb-logging.md)
...
[Amazon Managed Service for Prometheus logs](../../../prometheus/latest/userguide/cw-logs.md)
...
[Amazon MSK broker logs](../../../msk/latest/developerguide/msk-logging.md)
...
[Amazon MSK Connect logs](../../../msk/latest/developerguide/msk-connect-logging.md)
...
[AWS PCS logs](../../../pcs/latest/userguide/monitoring-overview.md)
...
[Amazon Relational Database Service PostgreSQL logs](../../../amazonrds/latest/userguide/user-logaccess-concepts-postgresql.md#USER_LogAccess.PostgreSQL.PublishtoCloudWatchLogs)

Custom logs

Supported

[AWS RTB Fabric logs](../../../rtb-fabric/latest/userguide/what-is-rtb-fabric.md)
...
[AWS Security Hub](../../../securityhub/latest/userguide/what-is-securityhub-v2.md)

Vended logs[Supported \[V2\
Permissions\]](aws-vended-logs-permissions-v2.md)

[Amazon Route 53 public DNS query logs](../../../route53/latest/developerguide/logging-monitoring.md)
...
[Amazon SageMaker AI events](../../../sagemaker/latest/dg/logging-cloudwatch.md)
...
[Amazon SageMaker AI worker events](../../../sagemaker/latest/dg/workteam-private-tracking.md)
...
[AWS Site-to-Site VPN logs](../../../vpn/latest/s2svpn/monitoring-logs.md)
...
[EC2 Spot Instance data feed files](../../../ec2/latest/userguide/spot-data-feeds.md)
...
[AWS Step Functions Express Workflow and Standard Workflow logs](../../../step-functions/latest/dg/cw-logs.md)
...
[Amazon Virtual Private Cloud flow logs](../../../vpc/latest/userguide/flow-logs-s3.md)
...
[Amazon VPC Lattice access logs](../../../vpc-lattice/latest/ug/monitoring-access-logs.md)
...
[Amazon VPC Route Server](../../../vpc/latest/userguide/dynamic-routing-route-server.md)
...
[AWS WAF logs](../../../waf/latest/developerguide/logging-destinations.md)
