---
title: "Understanding data protection policies"
---
...
data of interest, you use [data identifiers](cwl-managed-data-identifiers.md). CloudWatch Logs data protection then detects the sensitive
...
see [Audit findings reports](mask-sensitive-log-data-audit-findings.md).
