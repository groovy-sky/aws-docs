...
At a command prompt, run the following [filter-log-events](https://docs.aws.amazon.com/cli/latest/reference/logs/filter-log-events.html) command. Use `--filter-pattern` to limit the results
