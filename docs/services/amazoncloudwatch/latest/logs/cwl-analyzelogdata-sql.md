...
For information about all OpenSearch SQL commands including syntax, see [Supported SQL commands](../../../opensearch-service/latest/developerguide/supported-directquery-sql.md) in the OpenSearch Service Developer Guide.
