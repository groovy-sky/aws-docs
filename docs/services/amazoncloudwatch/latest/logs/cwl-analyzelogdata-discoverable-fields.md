...
[Explore related\
telemetry](../monitoring/explorerelated.md) feature.
...
that query. For more information, see [CloudWatch Logs Insights language query syntax](cwl-querysyntax.md).
...
indexes, see [Create field indexes to improve query performance and reduce scan volume](cloudwatchlogs-field-indexing.md).
...
field. For more information about the `parse` command, see [Query syntax](cwl-querysyntax.md) in the Amazon CloudWatch User Guide.
