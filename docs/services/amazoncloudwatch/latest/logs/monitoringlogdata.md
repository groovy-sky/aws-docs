...
to the transformed versions of the log events. For more information, see [Transform logs during ingestion](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatch-Logs-Transformation.html).
...
- [Listing metric filters](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/ListingMetricFilters.html)

- [Deleting a metric filter](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/DeletingMetricFilter.html)
