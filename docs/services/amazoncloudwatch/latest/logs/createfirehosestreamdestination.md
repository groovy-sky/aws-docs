...
1. Wait until the Firehose stream that you created in [Step 1: Create a Firehose delivery stream](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CreateFirehoseStream.html) becomes active. You can use the following command to check the
...
2. When the delivery stream is active, create the IAM role that will
    ...
    **~/TrustPolicyForCWL.json**. Use a text editor to
    ...
    [Amazon CloudWatch Logs endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/cwl_region.html).
