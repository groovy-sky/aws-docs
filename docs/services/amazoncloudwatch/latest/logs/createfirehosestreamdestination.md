...
1. Wait until the Firehose stream that you created in [Step 1: Create a Firehose delivery stream](createfirehosestream.md) becomes active. You can use the following command to check the
