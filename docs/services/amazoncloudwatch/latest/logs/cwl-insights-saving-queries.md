...
**To save a query**, call [PutQueryDefinition](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putquerydefinition.md):
...
For more information about this action, see [PutQueryDefinition](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putquerydefinition.md).
...
Call [StartQuery](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-startquery.md) with the `$QueryName()`
