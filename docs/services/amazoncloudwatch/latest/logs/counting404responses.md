...
03. Choose `Actions`, **Create metric**
    **filter**.

04. For **Filter Pattern**, type `[IP, UserInfo,
                                User, Timestamp, RequestInfo, StatusCode=404, Bytes]`.

05. (Optional) To test your filter pattern, under **Test**
...
06. Choose **Next**, and then for **Filter**
    **Name**, type **HTTP404Errors**.

07. Under **Metric Details**, for **Metric**
    **Namespace**, enter `MyNameSpace`.

08. For **Metric Name**, enter
     `ApacheNotFoundErrorCount`.

09. Confirm that **Metric Value** is 1. This specifies that
