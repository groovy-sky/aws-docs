...
[Start a Live Tail session using an AWS SDK](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/example_cloudwatch-logs_StartLiveTail_section.html).
...
Live Tail section](https://docs.aws.amazon.com/toolkit-for-vscode/latest/userguide/cloudwatch-livetail.html) of the AWS Toolkit for Visual Studio Code User Guide.

The Live Tail feature is available in all commercial AWS [Regions](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html?icmpid=docs_homepage_addtlrcs#region).
...
and [StartLiveTail](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_StartLiveTail.html).
