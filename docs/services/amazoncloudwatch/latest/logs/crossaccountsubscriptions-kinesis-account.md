---
title: "Cross-account cross-Region account-level subscriptions using Amazon Kinesis Data Streams"
---
...
- [Setting up a new cross-account subscription](cross-account-log-subscription-new-account.md)

- [Updating an existing cross-account subscription](cross-account-log-subscription-update-account.md)
