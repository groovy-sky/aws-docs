...
PPL commands](../../../opensearch-service/latest/developerguide/supported-ppl.md) in the OpenSearch Service Developer Guide.

For information on other query languages you can use see, [CloudWatch Logs Insights](cwl-querysyntax.md), [OpenSearch Service\
SQL](cwl-analyzelogdata-sql.md), and [CloudWatch Metrics Insights](../monitoring/query-with-cloudwatch-metrics-insights.md)
