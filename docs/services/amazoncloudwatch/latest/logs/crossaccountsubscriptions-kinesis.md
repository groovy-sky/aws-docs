...
- [Setting up a new cross-account subscription](cross-account-log-subscription-new.md)

- [Updating an existing cross-account subscription](cross-account-log-subscription-update.md)
