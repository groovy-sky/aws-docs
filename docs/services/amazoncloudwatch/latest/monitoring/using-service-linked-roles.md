---
title: "Using service-linked roles for CloudWatch"
---

# Using service-linked roles for CloudWatch

Amazon CloudWatch uses AWS Identity and Access Management (IAM) [service-linked roles](../../../iam/latest/userguide/id-roles-terms-and-concepts.md#iam-term-service-linked-role). A service-linked role is a unique type of IAM role
...
That Work with IAM](../../../iam/latest/userguide/reference-aws-services-that-work-with-iam.md) and look for the services that have **Yes** in the **Service-Linked Role** column.
...
here: [AWSObservabilityAdminTelemetryEnablementServiceRolePolicy](../../../aws-managed-policy/latest/reference/awsobservabilityadmintelemetryenablementservicerolepolicy.md).
...
For more information, see [Creating a Service-Linked Role](../../../iam/latest/userguide/using-service-linked-roles.md#create-service-linked-role) in the
_IAM User Guide_.
...
[GetRole](../../../../reference/iam/latest/apireference/api-getrole.md)

2. To update a role's description, use the following command:

[UpdateRoleDescription](../../../../reference/iam/latest/apireference/api-updateroledescription.md)
...
1. To submit a deletion request for a service-linked role, call [DeleteServiceLinkedRole](../../../../reference/iam/latest/apireference/api-deleteservicelinkedrole.md). In the request, specify the role
...
2. To check the status of the deletion, call [GetServiceLinkedRoleDeletionStatus](../../../../reference/iam/latest/apireference/api-getservicelinkedroledeletionstatus.md). In the request, specify
    the `DeletionTaskId`.
...
Updated the [CloudWatchApplicationSignalsServiceRolePolicy](using-service-linked-roles.md#service-linked-role-signals)
...
Updated the [CloudWatchApplicationSignalsServiceRolePolicy](using-service-linked-roles.md#service-linked-role-signals) to
