...
with [Transaction Search](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/AmazonCloudWatch/latest/monitoring/CloudWatch-Transaction-Search.html) enabled. To start using zero code instrumentation in PHP, follow these steps from the OpenTelemetry PHP Instrumentation docs, [PHP zero-code instrumentation](https://opentelemetry.io/docs/zero-code/php).
...
- **Amazon EKS** – [Setting up a Node.js application with the ESM module format](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals-Enable-EKS.html#EKS-NodeJs-ESM)

- **Amazon ECS with sidecar strategy** – [Setting up a Node.js application with the ESM module format](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals-ECS-Sidecar.html#ECS-NodeJs-ESM)

- **Amazon ECS with daemon strategy** – [Setting up a Node.js application with the ESM module format](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals-ECS-Daemon.html#ECSDaemon-NodeJs-ESM)

- **Amazon ECS with AWS CDK**

- **Amazon EC2** – [Setting up a Node.js application with the ESM module format](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals-Enable-EC2Main.html#EC2-NodeJs-ESM)

- **Kubernetes** – [Setting up a Node.js application with the ESM module format](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals-Enable-KubernetesMain.html#Kubernetes-NodeJs-ESM)
...
with [Transaction Search](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/AmazonCloudWatch/latest/monitoring/CloudWatch-Transaction-Search.html) enabled. To start using zero code instrumentation in GoLang, follow these steps from the OpenTelemetry GoLang Instrumentation docs,
