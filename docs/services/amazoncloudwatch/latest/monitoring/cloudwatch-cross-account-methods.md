---
title: "Monitor across accounts and Regions"
---
...
- **[Cross-account cross-Region log centralization](../logs/cloudwatchlogs-centralization.md)**–
...
**centralization](../logs/cloudwatchlogs-centralization.md)**
