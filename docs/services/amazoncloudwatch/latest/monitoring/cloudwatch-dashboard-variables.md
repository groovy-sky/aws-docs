...
see [Tutorial: Creating a CloudWatch Lambda dashboard with function name as the variable](cloudwatch-dashboard-variables-property.md).
...
see [Tutorial: Creating a dashboard that uses a regular expression pattern to switch between AWS Regions](cloudwatch-dashboard-variables-pattern.md).

Property variables apply to most use cases and are less complex to set up.

###### Topics

- [Copying a variable to another CloudWatch dashboard](cloudwatch-dashboard-variables-copy.md)

- [Tutorial: Creating a dashboard that uses a regular expression pattern to switch between AWS Regions](cloudwatch-dashboard-variables-pattern.md)
