...
[Collect JVM metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Agent-JMX-metrics.html#CloudWatch-Agent-JVM-metrics). For general information about CloudWatch agent configuration, see
...
see [Collect Java Management Extensions (JMX) metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Agent-JMX-metrics.html) for information about setting up TLS or authorization in agent configuration as required.
