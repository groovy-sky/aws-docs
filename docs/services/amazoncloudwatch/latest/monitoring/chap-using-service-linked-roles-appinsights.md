...
CloudWatch Application Insights uses AWS Identity and Access Management (IAM) [service-linked roles](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_terms-and-concepts.html#iam-term-service-linked-role). A service-linked role is a unique type of IAM role that is
...
with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) and look for the services that have **Yes** in
...
policy, see [Application Insights updates to AWS managed policies](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/security-iam-awsmanpol-appinsights.html#security-iam-awsmanpol-appinsights-updates).
...
service is available. For more information, see [CloudWatch Application Insights Regions and Endpoints](https://docs.aws.amazon.com/general/latest/gr/applicationinsights.html).
