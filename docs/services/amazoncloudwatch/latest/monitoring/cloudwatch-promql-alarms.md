...
For information about alarm concepts, see [Concepts](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/alarm-concepts.html).

For information about alarm data queries, see [Alarm data queries](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/alarm-data-queries.html).

For information about alarm actions, see [Alarm actions](alarm-actions.md).

For information about alarm limits, see [Limits](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/alarm-limits.html).
