...
choose the application name to display the application details in the [myApplications](../../../awsconsolehelpdocs/latest/gsg/aws-myapplications.md) console page. For services
