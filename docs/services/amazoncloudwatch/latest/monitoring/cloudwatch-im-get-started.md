...
[Examples of using the CLI with Internet Monitor](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-IM-get-started-CLI.html).
...
For more information about configuring a monitor, see [Edit a monitor in Internet Monitor](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-IM-get-started.edit-monitor.html).
...
For more information, see [Get suggestions to optimize application performance in Internet Monitor (Optimize page)](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-IM-insights.html).
