...
automatic dashboards. For more information, see [Getting started with CloudWatch automatic dashboards](gettingstarted.md).
...
[Using the\
X-Ray Trace Map](../../../xray/latest/devguide/xray-console-servicemap.md).
...
see [Using service-linked roles for CloudWatch](using-service-linked-roles.md).
...
For more information, see [Creating a customized CloudWatch dashboard](create-dashboard.md).
