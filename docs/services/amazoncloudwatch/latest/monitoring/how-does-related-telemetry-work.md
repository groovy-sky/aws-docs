...
automatically. For a complete list of supported resources, see [AWS services that support related telemetry](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/services-with-related-telemetry.html).
...
[Collect metrics, logs, and traces using the CloudWatch agent](install-cloudwatch-agent.md), and [Configure CloudWatch agent service and environment names for related entities](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Agent-configure-related-telemetry.html).
...
information, see [Configure CloudWatch agent service and environment names for related entities](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Agent-configure-related-telemetry.html).
