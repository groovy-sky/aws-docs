...
To begin working with Internet Monitor, see [Getting started with Internet Monitor using the console](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-IM-get-started.html).
