...
enclosed by single quotes. For more information, see [Statistics](cloudwatch-concepts.md#Statistic).
...
Original stringTokens generated

CustomCount1

`customcount1`, `custom`, `count`,
`1`
