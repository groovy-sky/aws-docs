...
for ECS EC2 instance level metrics](https://aws-otel.github.io/docs/setup/ecs).
...
policy](https://aws-otel.github.io/docs/setup/ecs/create-iam-policy) and [Create IAM\
role](https://aws-otel.github.io/docs/setup/ecs/create-iam-role).
...
Collector](https://aws-otel.github.io/docs/setup/ecs/task-definition-for-ecs-ec2-instance).
...
Amazon ECS EC2 instance metrics](https://aws-otel.github.io/docs/setup/ecs/create-task-definition-instance-console).
...
the Amazon Elastic Container Service (Amazon ECS) using daemon service](https://aws-otel.github.io/docs/setup/ecs/run-daemon-service).
...
For more information, about creating a configuration file, see [Custom OpenTelemetry Configuration](https://aws-otel.github.io/docs/setup/ecs). For more information about the options
that you can use in the configuration file, see [AWS Container Insights Receiver](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/awscontainerinsightreceiver/README.md).
