...
4. Choose filters for the fleet of databases you want to monitor.

5. Choose **Save filter as fleet**.

6. In the **Save filter set (fleet)** window, enter a name for your fleet.
