...
4. In the **Add to this dashboard** dialog box,
   ...
   - To add a graph to the dashboard, choose **Line** or
     ...
     **graph** dialog box, select the metric(s) to graph, and then
      ...
      you can add it manually. For more information, see [Graph metrics manually on a CloudWatch dashboard](add-old-metrics-to-graph.md).
   ...
   - To add a text block to the dashboard, choose
     ...
     **widget** dialog box, for **Markdown**,
      format your text using [Markdown](../../../../general/latest/gr/aws-markdown.md), and then choose **Create**
     **widget**.
