...
logs to CloudWatch Logs (with the [PutMetricData](../../../../reference/amazoncloudwatch/latest/apireference/api-putmetricdata.md) or [PutLogEvents](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putlogevents.md) operations), you can add entity information to those logs or
...
For information on how to add entity information, see [Entity information in EMF format](cloudwatch-embedded-metric-format-specification.md#entity-information-emf-format).
...
The `KeyAttributes` property of the Entity objects ( [in CloudWatch](../../../../reference/amazoncloudwatch/latest/apireference/api-entity.md) or
[in CloudWatch \
...
the CloudFormation [resource type](../../../cloudformation/latest/userguide/aws-template-resource-type-ref.md) string. For example,
`AWS::DynamoDB::Table`.

- `"Identifier": "<resource-id>"`
– The primary identifier for the resource. For more
information, see [primaryIdentifier](../../../cloudformation-cli/latest/userguide/resource-type-schema.md#schema-properties-primaryidentifier) in the _Extension Development_
...
[service name](../../../cloudformation/latest/userguide/aws-template-resource-type-ref.md) string. For example,
`AWS::DynamoDB`.
