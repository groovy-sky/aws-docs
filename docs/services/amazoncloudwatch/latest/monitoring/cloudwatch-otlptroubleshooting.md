...
- Make sure your credentials are set up correctly by following the [standard AWS SDK credential provider chain](../../../../reference/sdkref/latest/guide/standardized-credentials.md)
