...
To create a PromQL alarm, see [Create an alarm using a PromQL query](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Create_PromQL_Alarm.html).
