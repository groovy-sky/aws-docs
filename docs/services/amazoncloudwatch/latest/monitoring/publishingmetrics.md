...
How you specify a dimension is different when you use different commands. With [put-metric-data](../../../cli/latest/reference/cloudwatch/put-metric-data.md), you specify
each dimension as `MyName` = `MyValue`, and
with [get-metric-statistics](../../../cli/latest/reference/cloudwatch/get-metric-statistics.md) or [put-metric-alarm](../../../cli/latest/reference/cloudwatch/put-metric-alarm.md) you use the
format `Name=` `MyName`,
...
defined dimension when you use [get-metric-statistics](../../../cli/latest/reference/cloudwatch/get-metric-statistics.md).
...
with [get-metric-statistics](../../../cli/latest/reference/cloudwatch/get-metric-statistics.md).
...
To see what dimensions are defined for a metric, use the [list-metrics](../../../cli/latest/reference/cloudwatch/list-metrics.md) command.

## Publish single data points

To publish a single data point for a new or existing metric, use the [put-metric-data](../../../cli/latest/reference/cloudwatch/put-metric-data.md) command with
...
statistics for the new metric using the [get-metric-statistics](../../../cli/latest/reference/cloudwatch/get-metric-statistics.md)
command. However, it can take up to 15 minutes before the new metric appears in the list
of metrics retrieved using the [list-metrics](../../../cli/latest/reference/cloudwatch/list-metrics.md) command.
