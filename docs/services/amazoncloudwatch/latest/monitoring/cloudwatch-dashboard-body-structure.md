...
the entire command syntax, see [PutDashboard](../../../../reference/amazoncloudwatch/latest/apireference/api-putdashboard.md)
...
[Create flexible dashboards with dashboard variables](cloudwatch-dashboard-variables.md).
...
information, see [Use Live Data](cloudwatch-live-data.md).
...
[Using Metric Math](using-metric-math.md) or [Using Search Expressions in Graphs](using-search-expressions.md) in the Amazon CloudWatch User Guide.
...
Tags and Properties](cloudwatch-metrics-explorer.md)

You can also add metrics explorer widgets to a dashboard using CloudFormation. For
more information, see [AWS::CloudWatch::Dashboard](../../../cloudformation/latest/userguide/aws-resource-cloudwatch-dashboard.md).
