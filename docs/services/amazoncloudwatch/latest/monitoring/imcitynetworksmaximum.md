...
You choose a [percentage of application traffic](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/IMTrafficPercentage.html) to monitor when you create your
...
To update your monitor and change the maximum city-networks limit, see [Edit a monitor in Internet Monitor](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-IM-get-started.edit-monitor.html).
...
percentage settings](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/IMTrafficPercentage.html#IMExploreTrafficGraphs).
...
[queries for Internet Monitor metrics in CloudWatch Metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-IM-view-cw-tools-metrics-dashboard.html) can help you
