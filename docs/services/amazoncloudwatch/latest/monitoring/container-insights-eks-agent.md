...
instructions are supported only on Amazon EKS versions 1.24 and later.

###### Note

You can install Container Insights by following the instructions in any one of the
following sections. You don't need to follow all three sets of instructions.
