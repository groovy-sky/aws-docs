...
key. For more information, see [Customer keys and AWS keys](../../../kms/latest/developerguide/concepts.md#key-mgmt.html)
.
...
users in other accounts to use a KMS key](../../../kms/latest/developerguide/key-policy-modifying-external-accounts.md).
...
see [Troubleshooting\
key access](../../../kms/latest/developerguide/policy-evaluation.md).
