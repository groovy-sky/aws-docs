...
key. For more information, see [Customer keys and AWS keys](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-mgmt.html)
.
...
server-side encryption with Amazon S3-managed encryption keys (SSE-S3)](../../../s3/latest/userguide/usingserversideencryption.md).
...
users in other accounts to use a KMS key](https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-modifying-external-accounts.html).
...
encrypted by a custom AWS KMS key?](https://aws.amazon.com/premiumsupport/knowledge-center/cross-account-access-denied-error-s3).

For more information about troubleshooting access denied issues because of a KMS key,
see [Troubleshooting\
key access](https://docs.aws.amazon.com/kms/latest/developerguide/policy-evaluation.html).
