...
2025\. For more information, see [AIOpsAssistantIncidentReportPolicy](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/managed-policies-cloudwatch.html#managed-policies-QInvestigations-AIOpsAssistantIncidentReportPolicy).
...
details about permissions, see [Security in CloudWatch investigations](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Investigations-Security.html)
...
- [Understanding AI-derived facts in incident reports](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Investigations-IncidentReports-ai-facts.html)

- [Incident report terminology](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Investigations-IncidentReports-terms.html)

- [Generate a report from an investigation](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Investigations-IncidentReports-Generate.html)

- [Using 5 Whys analysis in incident reports](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/incident-report-5whys.html)
