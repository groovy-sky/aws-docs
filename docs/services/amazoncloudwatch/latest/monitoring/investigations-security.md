...
more information, see [AWS KMS keys](../../../kms/latest/developerguide/concepts.md).
...
- [AIOpsConsoleAdminPolicy](managed-policies-cloudwatch.md#managed-policies-QInvestigations-AIOpsConsoleAdminPolicy)– grants an administrator the ability
...
- [AIOpsOperatorAccess](managed-policies-cloudwatch.md#managed-policies-QInvestigations-AIOpsOperatorAccess)– grants a user access to investigation
...
- [AIOpsReadOnlyAccess](managed-policies-cloudwatch.md#managed-policies-QInvestigations-AIOpsReadOnlyAccess)– grants read-only permissions for CloudWatch investigations
...
after October 10, 2025. For more information, see [AIOpsAssistantIncidentReportPolicy](managed-policies-cloudwatch.md#managed-policies-QInvestigations-AIOpsAssistantIncidentReportPolicy).
...
permissions, see [AmazonRDSPerformanceInsightsFullAccess](../../../aws-managed-policy/latest/reference/amazonrdsperformanceinsightsfullaccess.md).
...
investigations. For information about the complete contents of this policy, see [AIOpsAssistantPolicy](managed-policies-cloudwatch.md#managed-policies-QInvestigations-AIOpsAssistant).

You can also choose to attach the general AWS [**ReadOnlyAccess**](../../../aws-managed-policy/latest/reference/readonlyaccess.md) to the investigation group role, in addition
...
policy with the contents of [AIOpsAssistantPolicy](managed-policies-cloudwatch.md#managed-policies-QInvestigations-AIOpsAssistant) and then remove permissions that you don't want to
...
see [kms:ViaService](../../../kms/latest/developerguide/conditions-kms.md#conditions-kms-via-service) and [kms:EncryptionContext: _context-key_](../../../kms/latest/developerguide/conditions-kms.md#conditions-kms-encryption-context) in the
AWS Key Management Service Developer Guide, and [aws:SourceArn](../../../iam/latest/userguide/reference-policies-condition-keys.md#condition-keys-sourcearn) in the IAM User Guide.
...
keys](../../../kms/latest/developerguide/concepts.md#aws-owned-cmk).
...
For more information about AWS KMS, see [AWS Key Management Service](../../../kms/latest/developerguide/overview.md).
