...
For more information, see [The span log group](cloudwatch-transaction-search-ingesting-span-log-groups.md).
...
If you send traces to X-Ray, you can [get started by enabling Transaction Search](cloudwatch-transaction-search-getting-started.md) in the console or with the API.
If you don't send traces to X-Ray, you can use the [CloudWatch Application Signals](cloudwatch-application-signals-enable.md) that provides pre-packaged OpenTelemetry setup with
