...
- Alarms – You can tag alarms using the [tag-resource](../../../cli/latest/reference/cloudwatch/tag-resource.md) AWS CLI command and the
...
you create them by using the [put-insight-rule](../../../cli/latest/reference/cloudwatch/put-insight-rule.md) AWS CLI command and the
[PutInsightRule](../../../../reference/amazoncloudwatch/latest/apireference/api-putinsightrule.md) API.
You can add tags to existing rules by using the [tag-resource](../../../cli/latest/reference/cloudwatch/tag-resource.md) AWS CLI command and the
...
you create them by using the [put-metric-stream](../../../cli/latest/reference/cloudwatch/put-metric-stream.md) AWS CLI command and the
[PutMetricStream](../../../../reference/amazoncloudwatch/latest/apireference/api-putmetricstream.md) API.
You can add tags to existing metric streams by using the [tag-resource](../../../cli/latest/reference/cloudwatch/tag-resource.md) AWS CLI command and the
[TagResource](../../../../reference/amazoncloudwatch/latest/apireference/api-tagresource.md) API.
...
- [TagResource](../../../../reference/amazoncloudwatch/latest/apireference/api-tagresource.md), [UntagResource](../../../../reference/amazoncloudwatch/latest/apireference/api-untagresource.md), and [ListTagsForResource](../../../../reference/amazoncloudwatch/latest/apireference/api-listtagsforresource.md)
in the _Amazon CloudWatch API Reference_

- [tag-resource](../../../cli/latest/reference/cloudwatch/tag-resource.md), [untag-resource](../../../cli/latest/reference/cloudwatch/untag-resource.md), and [list-tags-for-resource](../../../cli/latest/reference/cloudwatch/list-tags-for-resource.md) in the
_Amazon CloudWatch CLI Reference_

- [Working with Tag Editor](../../../arg/latest/userguide/tag-editor.md) in the
