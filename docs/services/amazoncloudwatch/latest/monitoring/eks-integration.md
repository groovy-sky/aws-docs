...
is [`AIOpsAssistantPolicy`](../../../aws-managed-policy/latest/reference/aiopsassistantpolicy.md).
...
Kubernetes group RBAC permission. For more information, see [Creating access entries](../../../eks/latest/userguide/creating-access-entries.md).
