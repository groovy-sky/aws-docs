...
[Aurora DB engine, Region, and instance class support for Database Insights](../../../amazonrds/latest/aurorauserguide/user-databaseinsights-engines.md)
and [Amazon RDS DB engine, Region, and instance class support for Database Insights](../../../amazonrds/latest/userguide/user-databaseinsights-engines.md).
...
[Set up cross-account cross-region monitoring for CloudWatch Database Insights](database-insights-cross-account-cross-region.md)
...
For information about counter metrics for Performance Insights, see [Performance Insights counter metrics](../../../amazonrds/latest/aurorauserguide/user-perfinsights-counters.md).
...
- [Amazon CloudWatch metrics for Amazon Aurora](../../../amazonrds/latest/aurorauserguide/aurora-auroramonitoring-metrics.md) in the _Amazon Aurora User Guide_

- [Amazon CloudWatch metrics for Amazon Relational Database Service](../../../amazonrds/latest/userguide/rds-metrics.md) in the _Amazon RDS User Guide_

- [Amazon CloudWatch metrics for Amazon RDS Performance Insights](../../../amazonrds/latest/aurorauserguide/user-perfinsights-cloudwatch.md) in the _Amazon Aurora User Guide_

- [Amazon CloudWatch metrics for Amazon RDS Performance Insights](../../../amazonrds/latest/userguide/user-perfinsights-cloudwatch.md) in the _Amazon Aurora User Guide_
...
For information about Performance Insights counter metrics, see [Performance Insights counter metrics](../../../amazonrds/latest/userguide/user-perfinsights-counters.md)
