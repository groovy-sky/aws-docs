...
an app monitor](cloudwatch-rum-get-started-create-app-monitor.md). For web applications, you can also enable this by [manually configuring the RUM web\
client](cloudwatch-rum-configure-client.md). Your RUM clients are displayed on the [Application\
Map](servicemap.md) connected to your services, and in the [Service\
detail](servicedetail.md) page of the services they call.
