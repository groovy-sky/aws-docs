...
information about installing and using the AWS CLI, see the [AWS Command Line Interface User Guide](../../../cli/latest/userguide.md).

- [AWS Tools for Windows PowerShell](https://aws.amazon.com/powershell). For
information about installing and using the Tools for Windows PowerShell, see the [AWS Tools for PowerShell User Guide](../../../powershell/latest/userguide.md).
...
[Calling the API by\
making HTTP Query requests](../../../../reference/accounts/latest/apireference/welcome.md).
