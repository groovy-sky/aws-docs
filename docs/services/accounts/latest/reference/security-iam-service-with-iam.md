...
This condition key takes an argument that consists of a list of [AWS Region codes](../../../../general/latest/gr/rande.md#regional-endpoints). It lets you filter the policy to affect
