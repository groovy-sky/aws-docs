...
AWS account, we recommend updating it before closure. For more information, see [Update the root user email address](manage-acct-update-root-user-email.md).

- If you've [enabled multi-factor authentication (MFA)](../../../iam/latest/userguide/id-credentials-mfa-enable-overview.md) on your AWS account
root user, or configured an [MFA device on an\
IAM user](../../../iam/latest/userguide/console-sign-in-mfa.md), MFA isn't removed automatically when you close the
...
the hardware MFA device](../../../iam/latest/userguide/id-credentials-mfa-disable.md) before closing the account. MFA devices
for [IAM users](../../../iam/latest/userguide/id-users-manage.md#id_users_deleting) must be deleted by the account
administrator.
...
[Remove a member account from your organization](../../../organizations/latest/userguide/orgs-manage-accounts-remove-member-account.md) before closing
it.
...
for AWS Organizations](../../../organizations/latest/userguide/orgs-reference-limits.md).
...
member account](../../../controltower/latest/userguide/unmanage-account.md) in the _AWS Control Tower User_
_Guide_.
...
request trail deletion after an AWS account has been closed, see [AWS account closure and trails](../../../awscloudtrail/latest/userguide/cloudtrail-account-closure.md) in the _CloudTrail User_
_Guide_.
...
If you experience any issues during the process of closing your account, see [Troubleshooting issues with AWS account closure](troubleshooting-close-account.md).
...
1. [Sign in to the AWS Management Console as the root user](../../../signin/latest/userguide/introduction-to-root-user-sign-in-tutorial.md) in the
...
3. Choose **Close** next to the account name at the
    ...
    organization is in [All features](../../../organizations/latest/userguide/orgs-getting-started-concepts.md#feature-set) mode.

###### Note

If your organization is using [Consolidated billing](../../../organizations/latest/userguide/orgs-getting-started-concepts.md#feature-set-cb-only) mode, you won't be able to see
...
SDKs, see [Closing a member account in your organization](../../../organizations/latest/userguide/orgs-manage-accounts-close.md) in the
...
1. [Sign in to the AWS Management Console as the root user](../../../signin/latest/userguide/introduction-to-root-user-sign-in-tutorial.md) for the
...
unintended AWS GovCloud (US) charges, see [Closing an AWS GovCloud (US) account](../../../govcloud-us/latest/userguide/closing-govcloud-account.md) in the _AWS GovCloud (US) User Guide_.
...
address. If you don’t receive this email within a few hours, see [Troubleshooting issues with AWS account closure](troubleshooting-close-account.md).
