---
title: "Enable or disable AWS Regions in your account"
---
...
multi-Region fundamentals](../../../prescriptive-guidance/latest/aws-multi-region-fundamentals/introduction.md).
...
[Enable or disable a Region for standalone accounts](#manage-acct-regions-enable-standalone) and to enable an opt-in
...
AWS groups Regions into [partitions](../../../whitepapers/latest/aws-fault-isolation-boundaries/partitions.md). Every Region is in exactly one partition, and each partition
...
endpoints](../../../../general/latest/gr/rande.md#regional-endpoints) in the _AWS General Reference Guide_. For a list
...
an AWS Region](../../../iam/latest/userguide/id-credentials-temp-enable-regions.md).
...
throughput with cross-Region inference](../../../bedrock/latest/userguide/cross-region-inference.md)) and Amazon Q Developer (see [Cross-region\
processing in Amazon Q Developer](../../../amazonq/latest/qdeveloper-ug/cross-region-processing.md)) use cross-region inference. If you use
...
information, see [AWS: Allows enabling and disabling AWS Regions](../../../iam/latest/userguide/reference-policies-examples-aws-enable-disable-regions.md) in the
_IAM User Guide_. You can also use the [`aws:RequestedRegion`](../../../iam/latest/userguide/reference-policies-condition-keys.md#condition-keys-requestedregion) condition key to control
...
After the opt-in Region is enabled, you can select that Region from the Region navigation bar. For steps to select a Region, see [Choosing a Region from the navigation bar in the AWS Management Console](../../../awsconsolehelpdocs/latest/gsg/select-region-procedure.md) and for Region specific console setting in your account, see [Setting the default Region in the AWS Management Console](../../../awsconsolehelpdocs/latest/gsg/change-default-region.md).
...
To view the updated managed policies, see [Updates to Organizations AWS managed policies](../../../organizations/latest/userguide/orgs-reference-available-policies.md#ref-iam-managed-policies-updates).
...
all features, see [Enabling all features in your organization](../../../organizations/latest/userguide/orgs-manage-org-support-all-features.md).

- Enable trusted access for the AWS Account Management service. To set this up, see
[Enable trusted access for AWS Account Management](using-orgs-trusted-access.md).
