...
must [Sign\
in to the AWS Management Console as the root user](../../../signin/latest/userguide/introduction-to-root-user-sign-in-tutorial.md) to close your account. If you can’t
sign in, see [Troubleshooting issues\
with the root user](../../../iam/latest/userguide/troubleshooting-root-user.md).
...
in to the AWS Management Console as the root user](../../../signin/latest/userguide/introduction-to-root-user-sign-in-tutorial.md) to check that your account is closed.
...
member account in your organization](../../../organizations/latest/userguide/orgs-manage-accounts-close.md) in the
...
in to the AWS Management Console as the root user](../../../signin/latest/userguide/introduction-to-root-user-sign-in-tutorial.md) for the management account and close it
from the **Accounts** page. For more information, see [Closing a\
management account in your organization](../../../organizations/latest/userguide/orgs-manage-accounts-close-management.md) in the
_AWS Organizations User Guide_.
...
accounts exceeds 1000. For more information about Organizations quotas, see [Quotas for AWS Organizations](../../../organizations/latest/userguide/orgs-reference-limits.md) in the _AWS Organizations User Guide_.
