...
(ARNs)](../../../../general/general/latest/gr/aws-arns-and-namespaces.md). The account ID portion distinguishes resources in one
...
AWS account as either the [root user](root-user.md) or an IAM
user.
...
Use the [get-caller-identity](../../../cli/latest/reference/sts/get-caller-identity.md) command as follows.
...
Use the [list-buckets](../../../cli/latest/reference/s3api/list-buckets.md) command as follows.
