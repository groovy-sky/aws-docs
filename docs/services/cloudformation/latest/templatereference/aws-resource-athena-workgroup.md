...
listed under [WorkGroupConfiguration](../userguide/aws-resource-athena-workgroup.md#cfn-athena-workgroup-workgroupconfiguration). Each workgroup enables you to
isolate queries for you or your group from other queries in the same account. For more
information, see [CreateWorkGroup](../../../../reference/athena/latest/apireference/api-createworkgroup.md) in
...
_Type_: Array of [Tag](aws-properties-athena-workgroup-tag.md)
