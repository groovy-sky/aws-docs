...
security configuration. For more information see [Use Kerberos Authentication](../../../emr/latest/managementguide/emr-kerberos.md)
...
and included application versions and features, see [https://docs.aws.amazon.com/emr/latest/ReleaseGuide/](../../../emr/latest/releaseguide.md). The release label applies only to Amazon EMR
