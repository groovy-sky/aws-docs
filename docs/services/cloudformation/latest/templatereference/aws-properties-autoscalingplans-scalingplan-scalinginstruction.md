---
title: "AWS::AutoScalingPlans::ScalingPlan ScalingInstruction"
---
...
`ScalingInstruction` is a property of [ScalingPlan](../userguide/aws-resource-autoscalingplans-scalingplan.md) that specifies the scaling instruction for a scalable resource in a
...
generate a forecast. For more information, see [Best practices for scaling plans](../../../autoscaling/plans/userguide/gs-best-practices.md) in the _Scaling Plans User_
_Guide_.
...
_Type_: Array of [TargetTrackingConfiguration](aws-properties-autoscalingplans-scalingplan-targettrackingconfiguration.md)
