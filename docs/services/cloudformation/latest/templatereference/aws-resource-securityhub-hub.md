...
You can use the [`AWS::SecurityHub::Standard`](../userguide/aws-resource-securityhub-standard.md) resource to
...
[DependsOn\
attribute](../userguide/aws-attribute-dependson.md), such as `"DependsOn": "Hub"`, to ensure that you've
