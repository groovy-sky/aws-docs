---
title: "AWS::Cognito::UserPool EmailConfiguration"
---
...
To look up the email delivery limit for the default option, see [Limits](../../../cognito/latest/developerguide/limits.md) in the _Amazon Cognito Developer_
_Guide_.
...
Amazon Cognito creates a _service-linked role_, which is a type of
...
creates, see [Using Service-Linked Roles for Amazon Cognito](../../../cognito/latest/developerguide/using-service-linked-roles.md) in the
...
the user pool Region are the same. For more information, see [Amazon SES email configuration regions](../../../cognito/latest/developerguide/user-pool-email.md#user-pool-email-developer-region-mapping) in the [Amazon Cognito Developer\
Guide](../../../cognito/latest/developerguide/cognito-user-identity-pools.md).
