...
_Type_: [OriginMtlsConfig](aws-properties-cloudfront-distribution-originmtlsconfig.md)
...
- [CustomOriginConfig](../../../../reference/cloudfront/latest/apireference/api-customoriginconfig.md) in the _Amazon CloudFront API Reference_
