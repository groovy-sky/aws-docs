...
for an Existing Domain to Amazon Route 53](../../../route53/latest/developerguide/migratingdns.md) in the
...
_Type_: [HostedZoneConfig](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-hostedzone-hostedzoneconfig.html)
...
_Type_: [HostedZoneFeatures](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-hostedzone-hostedzonefeatures.html)
...
_Type_: Array of [HostedZoneTag](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-hostedzone-hostedzonetag.html)

_Update requires_: [No interruption](../userguide/using-cfn-updating-stacks-update-behaviors.md#update-no-interrupt)

`Name`

The name of the domain. Specify a fully qualified domain name, for example, _www.example.com_.
...
_www.example.com_ (without a trailing dot) and _www.example.com._ (with a trailing dot) as identical.
...
see [Routing\
Internet Traffic to Your Website or Web Application](../../../route53/latest/developerguide/welcome-dns-service.md) in the
_Amazon Route 53 Developer Guide_.
...
see [Logging DNS\
Queries](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/query-logs.html) in the _Amazon Route 53 Developer_
_Guide_.
...
_Type_: [QueryLoggingConfig](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-hostedzone-queryloggingconfig.html)

_Update requires_: [No interruption](../userguide/using-cfn-updating-stacks-update-behaviors.md#update-no-interrupt)

`VPCs`

_Private hosted zones:_ A complex type that contains information about the VPCs that are
...
_Type_: Array of [VPC](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-hostedzone-vpc.html)
