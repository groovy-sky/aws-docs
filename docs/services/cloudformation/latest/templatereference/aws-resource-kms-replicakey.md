...
To create a multi-Region primary key, add an [AWS::KMS::Key](../userguide/aws-resource-kms-key.md)
...
details, see [Multi-Region keys in AWS KMS](../../../kms/latest/developerguide/multi-region-keys-overview.md) in the _AWS Key Management Service Developer Guide_.
...
or [ScheduleKeyDeletion](../../../../reference/kms/latest/apireference/api-schedulekeydeletion.md) operations. Also, while the replica key is being created, its
...
- The key policy must give the caller [PutKeyPolicy](../../../../reference/kms/latest/apireference/api-putkeypolicy.md) permission on
the KMS key. This reduces the risk that the KMS key becomes unmanageable. For more information,
refer to the scenario in the [Default key policy](../../../kms/latest/developerguide/key-policies.md#key-policy-default-allow-root-enable-iam) section of the _AWS Key Management Service Developer Guide_.
...
your KMS key](../../../kms/latest/developerguide/key-state.md) in the _AWS Key Management Service Developer Guide_. For
more information about deleting KMS keys, see the [ScheduleKeyDeletion](../../../../reference/kms/latest/apireference/api-schedulekeydeletion.md)
...
control access to a KMS key. For details, see [Tagging keys](../../../kms/latest/developerguide/tagging-keys.md).

_Required_: No

_Type_: Array of [Tag](aws-properties-kms-replicakey-tag.md)
...
multi-Region keys work](../../../kms/latest/developerguide/multi-region-keys-overview.md#mrk-how-it-works) in the _AWS Key Management Service Developer_
_Guide_.
...
- [ReplicateKey](../../../../reference/kms/latest/apireference/api-replicatekey.md) in the _AWS Key Management Service API_
_Reference_.
...
replica keys](../../../kms/latest/developerguide/multi-region-keys-replicate.md) in the _AWS Key Management Service Developer_
_Guide_.
