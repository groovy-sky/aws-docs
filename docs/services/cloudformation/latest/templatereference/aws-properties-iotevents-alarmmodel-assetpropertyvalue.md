---
title: "AWS::IoTEvents::AlarmModel AssetPropertyValue"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::IoTEvents::AlarmModel AssetPropertyValue
<a name="aws-properties-iotevents-alarmmodel-assetpropertyvalue"></a>
...
## Syntax
<a name="aws-properties-iotevents-alarmmodel-assetpropertyvalue-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-iotevents-alarmmodel-assetpropertyvalue-syntax.json"></a>
...
### YAML
<a name="aws-properties-iotevents-alarmmodel-assetpropertyvalue-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-iotevents-alarmmodel-assetpropertyvalue-properties"></a>
