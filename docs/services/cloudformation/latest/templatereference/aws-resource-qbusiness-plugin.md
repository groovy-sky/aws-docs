...
_Type_: [PluginAuthConfiguration](aws-properties-qbusiness-plugin-pluginauthconfiguration.md)
...
_Type_: [CustomPluginConfiguration](aws-properties-qbusiness-plugin-custompluginconfiguration.md)
...
_Type_: Array of [Tag](aws-properties-qbusiness-plugin-tag.md)
