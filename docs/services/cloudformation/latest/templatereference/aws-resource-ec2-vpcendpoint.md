...
accounts in your organization. For more information, see the [AWS PrivateLink User Guide](../../../vpc/latest/privatelink.md).
...
_Type_: [DnsOptionsSpecification](aws-properties-ec2-vpcendpoint-dnsoptionsspecification.md)
...
_Type_: Array of [Tag](aws-properties-ec2-vpcendpoint-tag.md)
