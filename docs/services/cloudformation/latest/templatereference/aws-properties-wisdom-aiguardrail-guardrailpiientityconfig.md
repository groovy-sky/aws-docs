...
<a name="aws-properties-wisdom-aiguardrail-guardrailpiientityconfig"></a>

PII entity configuration.

## Syntax
<a name="aws-properties-wisdom-aiguardrail-guardrailpiientityconfig-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-wisdom-aiguardrail-guardrailpiientityconfig-syntax.json"></a>

```
{
  "[Action](#cfn-wisdom-aiguardrail-guardrailpiientityconfig-action)" : {{String}},
  "[Type](#cfn-wisdom-aiguardrail-guardrailpiientityconfig-type)" : {{String}}
}
```

### YAML
<a name="aws-properties-wisdom-aiguardrail-guardrailpiientityconfig-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-wisdom-aiguardrail-guardrailpiientityconfig-properties"></a>

`Action`  <a name="cfn-wisdom-aiguardrail-guardrailpiientityconfig-action"></a>
...
`Type`  <a name="cfn-wisdom-aiguardrail-guardrailpiientityconfig-type"></a>
