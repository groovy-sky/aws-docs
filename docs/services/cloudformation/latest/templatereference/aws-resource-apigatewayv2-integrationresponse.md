---
title: "AWS::ApiGatewayV2::IntegrationResponse"
---
...
integration response for an WebSocket API. For more information, see [Set up WebSocket API Integration Responses in API Gateway](../../../apigateway/latest/developerguide/apigateway-websocket-api-integration-responses.md) in the
...
- [CreateIntegrationResponse](../../../apigatewayv2/latest/api-reference/apis-apiid-integrations-integrationid-integrationresponses.md#CreateIntegrationResponse) in the _Amazon_
