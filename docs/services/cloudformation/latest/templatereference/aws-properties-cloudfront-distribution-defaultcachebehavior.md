---
title: "AWS::CloudFront::Distribution DefaultCacheBehavior"
---
...
- [DefaultCacheBehavior](../../../../reference/cloudfront/latest/apireference/api-defaultcachebehavior.md) in the _Amazon CloudFront API Reference_
