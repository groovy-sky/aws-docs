...
_Type_: [AdConditioningConfiguration](aws-properties-mediatailor-playbackconfiguration-adconditioningconfiguration.md)
...
_Type_: [AdDecisionServerConfiguration](aws-properties-mediatailor-playbackconfiguration-addecisionserverconfiguration.md)
...
The configuration for avail suppression, also known as ad suppression. For more information about ad suppression, see [Ad Suppression](../../../mediatailor/latest/ug/ad-behavior.md).
...
The player parameters and aliases used as dynamic variables during session initialization. For more information, see [Domain Variables](../../../mediatailor/latest/ug/variables-domain.md).
...
_Type_: [LogConfiguration](aws-properties-mediatailor-playbackconfiguration-logconfiguration.md)
...
The tags to assign to the playback configuration. Tags are key-value pairs that you can associate with Amazon resources to help with organization, access control, and cost tracking. For more information, see [Tagging AWS Elemental MediaTailor Resources](../../../mediatailor/latest/ug/tagging.md).

_Required_: No

_Type_: Array of [Tag](aws-properties-mediatailor-playbackconfiguration-tag.md)
