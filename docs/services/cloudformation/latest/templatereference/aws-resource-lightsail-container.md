...
_Type_: [PrivateRegistryAccess](aws-properties-lightsail-container-privateregistryaccess.md)
...
names with your container service. Use the [AWS::Lightsail::Certificate](../userguide/aws-resource-lightsail-certificate.md) resource to create a certificate for the public
domain names that you want to use with your container service.

_Required_: No

_Type_: Array of [PublicDomainName](aws-properties-lightsail-container-publicdomainname.md)
...
_Type_: Array of [Tag](aws-properties-lightsail-container-tag.md)
