---
title: "AWS::LakeFormation::DataLakeSettings"
---
...
_Type_: Array of [DataLakePrincipal](aws-properties-lakeformation-datalakesettings-datalakeprincipal.md)
...
For more information, see [External data filtering setting](../../../lake-formation/latest/dg/initial-lf-setup.md#external-data-filter).
...
For more information, see [https://docs.aws.amazon.com/lake-formation/latest/dg/using-cred-vending.html](../../../lake-formation/latest/dg/using-cred-vending.md)
...
For more information, see [Changing the default security settings for your data lake](../../../lake-formation/latest/dg/change-settings.md).

_Required_: No

_Type_: Array of [PrincipalPermissions](aws-properties-lakeformation-datalakesettings-principalpermissions.md)
