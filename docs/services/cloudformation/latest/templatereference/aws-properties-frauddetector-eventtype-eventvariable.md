...
When defining a variable within a event type, you can only use the `EVENT` value for DataSource when the _Inline_ property is set to true.
...
The data type of the event variable. For more information, see [Data types](../../../frauddetector/latest/ug/variables.md#data-types).
...
The type of event variable. For more information, see [Variable types](../../../frauddetector/latest/ug/variables.md#variable-types).
