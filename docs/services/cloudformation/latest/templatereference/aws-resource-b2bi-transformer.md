...
_Type_: [InputConversion](aws-properties-b2bi-transformer-inputconversion.md)
...
_Type_: [Mapping](aws-properties-b2bi-transformer-mapping.md)
...
_Type_: [OutputConversion](aws-properties-b2bi-transformer-outputconversion.md)
...
_Type_: [SampleDocuments](aws-properties-b2bi-transformer-sampledocuments.md)
...
_Type_: Array of [Tag](aws-properties-b2bi-transformer-tag.md)
