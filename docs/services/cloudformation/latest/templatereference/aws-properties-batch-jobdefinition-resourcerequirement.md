...
once. This parameter maps to `Memory` in the [Create a container](https://docs.docker.com/engine/api/v1.23)
...
`CpuShares` in the [Create a container](https://docs.docker.com/engine/api/v1.23) section of the
...
information about Fargate quotas, see [AWS Fargate quotas](../../../../general/latest/gr/ecs-service.md#service-quotas-fargate)
