...
The [deployment package](../../../lambda/latest/dg/gettingstarted-package.md)
...
URI of a [container image](../../../lambda/latest/dg/lambda-images.md) in the
Amazon ECR registry.
...
_Allowed values_: `COPY | REFERENCE`
...
.zip deployment package. If you don't provide a customer managed key, Lambda uses an [AWS owned key](../../../kms/latest/developerguide/concepts.md#aws-owned-cmk).
...
[deployment package](../../../lambda/latest/dg/gettingstarted-package.md).
...
a response module ( [cfn-response](../userguide/cfn-lambda-function-code-cfnresponsemodule.md))
that simplifies sending responses. See [Using AWS Lambda with AWS CloudFormation](../../../lambda/latest/dg/services-cloudformation.md) for
details.
...
Inline Node.js function that lists Amazon S3 buckets in `
                            us-east-1
                        `. This example uses the [AWS SDK for JavaScript v3](../../../../reference/sdk-for-javascript/v3/developer-guide/welcome.md), which is available in the `nodejs18.x` runtime. Before using this example, make sure that your function's execution role has Amazon S3 read permissions.
