---
title: "AWS::AutoScalingPlans::ScalingPlan ApplicationSource"
---
...
`ApplicationSource` is a property of [ScalingPlan](../userguide/aws-resource-autoscalingplans-scalingplan.md) that specifies the application source to use with a scaling plan. You can create one scaling plan per application source.
...
_Type_: Array of [TagFilter](aws-properties-autoscalingplans-scalingplan-tagfilter.md)
