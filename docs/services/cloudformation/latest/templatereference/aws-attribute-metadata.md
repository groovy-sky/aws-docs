...
You can retrieve this data using the [describe-stack-resource](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/describe-stack-resource.html) CLI command or the [DescribeStackResource](../../../../reference/awscloudformation/latest/apireference/api-describestackresource.md) API
operation.
