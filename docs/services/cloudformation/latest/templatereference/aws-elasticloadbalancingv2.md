...
- [AWS::ElasticLoadBalancingV2::TrustStore](aws-resource-elasticloadbalancingv2-truststore.md)

- [AWS::ElasticLoadBalancingV2::TrustStoreRevocation](aws-resource-elasticloadbalancingv2-truststorerevocation.md)
