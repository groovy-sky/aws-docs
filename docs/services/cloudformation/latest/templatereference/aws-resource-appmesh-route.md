...
For more information about routes, see [Routes](../../../app-mesh/latest/userguide/routes.md).
...
_Type_: Array of [Tag](aws-properties-appmesh-route-tag.md)
...
- [Routes](../../../app-mesh/latest/userguide/routes.md) in the _AWS App Mesh User Guide_.

- [CreateRoute](../../../../reference/app-mesh/latest/apireference/api-createroute.md) in
