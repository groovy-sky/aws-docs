...
Guide](../../../amazoncloudwatch/latest/monitoring/cloudwatch-pipelines.md). Additional comprehensive configuration examples can be found in the [CreateTelemetryPipeline API docs](../../../cloudwatch/latest/observabilityadmin/api-createtelemetrypipeline.md#API_CreateTelemetryPipeline_Examples).
