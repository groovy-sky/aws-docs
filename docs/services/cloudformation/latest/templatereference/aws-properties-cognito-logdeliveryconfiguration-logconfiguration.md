...
_Type_: [CloudWatchLogsConfiguration](aws-properties-cognito-logdeliveryconfiguration-cloudwatchlogsconfiguration.md)
...
_Type_: [FirehoseConfiguration](aws-properties-cognito-logdeliveryconfiguration-firehoseconfiguration.md)
...
about message delivery](../../../cognito/latest/developerguide/exporting-quotas-and-usage.md), choose `ERROR` with
...
_Type_: [S3Configuration](aws-properties-cognito-logdeliveryconfiguration-s3configuration.md)
