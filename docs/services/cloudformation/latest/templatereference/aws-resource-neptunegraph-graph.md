...
[Amazon Neptune Analytics](../../../neptune-analytics/latest/userguide/what-is-neptune-analytics.md).
...
_Type_: Array of [Tag](aws-properties-neptunegraph-graph-tag.md)
...
_Type_: [VectorSearchConfiguration](aws-properties-neptunegraph-graph-vectorsearchconfiguration.md)
