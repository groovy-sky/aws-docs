---
title: "AWS::Pinpoint::APNSVoipChannel"
---
...
Notification service (APNs). Before you can use Amazon Pinpoint to send VoIP
notifications to APNs, you have to enable the APNs VoIP channel for an Amazon Pinpoint
application.

The APNSVoipChannel resource represents the status and authentication settings of the
...
Specifies whether to enable the APNs VoIP channel for the Amazon Pinpoint
application.
