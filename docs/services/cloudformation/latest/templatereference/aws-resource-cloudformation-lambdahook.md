...
Hooks](../../../cloudformation-cli/latest/hooks-userguide/lambda-hooks.md) in the _CloudFormation Hooks User_
_Guide_.
...
_Type_: [StackFilters](aws-properties-cloudformation-lambdahook-stackfilters.md)
...
_Type_: [TargetFilters](aws-properties-cloudformation-lambdahook-targetfilters.md)
