...
_Type_: [ExternalInvocationConfiguration](aws-properties-connect-contactflowmodule-externalinvocationconfiguration.md)
...
_Type_: Array of [Tag](aws-properties-connect-contactflowmodule-tag.md)
