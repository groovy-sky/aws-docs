---
title: "AWS::Route53::RecordSetGroup RecordSet"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::Route53::RecordSetGroup RecordSet
<a name="aws-properties-route53-recordsetgroup-recordset"></a>

Information about one record that you want to create.

## Syntax
<a name="aws-properties-route53-recordsetgroup-recordset-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-route53-recordsetgroup-recordset-syntax.json"></a>

```
{
  "[AliasTarget](#cfn-route53-recordsetgroup-recordset-aliastarget)" : {{AliasTarget}},
  "[CidrRoutingConfig](#cfn-route53-recordsetgroup-recordset-cidrroutingconfig)" : {{CidrRoutingConfig}},
  "[Failover](#cfn-route53-recordsetgroup-recordset-failover)" : {{String}},
  "[GeoLocation](#cfn-route53-recordsetgroup-recordset-geolocation)" : {{GeoLocation}},
  "[GeoProximityLocation](#cfn-route53-recordsetgroup-recordset-geoproximitylocation)" : {{GeoProximityLocation}},
  "[HealthCheckId](#cfn-route53-recordsetgroup-recordset-healthcheckid)" : {{String}},
  "[HostedZoneId](#cfn-route53-recordsetgroup-recordset-hostedzoneid)" : {{String}},
  "[HostedZoneName](#cfn-route53-recordsetgroup-recordset-hostedzonename)" : {{String}},
  "[MultiValueAnswer](#cfn-route53-recordsetgroup-recordset-multivalueanswer)" : {{Boolean}},
  "[Name](#cfn-route53-recordsetgroup-recordset-name)" : {{String}},
  "[Region](#cfn-route53-recordsetgroup-recordset-region)" : {{String}},
  "[ResourceRecords](#cfn-route53-recordsetgroup-recordset-resourcerecords)" : {{[ String, ... ]}},
  "[SetIdentifier](#cfn-route53-recordsetgroup-recordset-setidentifier)" : {{String}},
  "[TTL](#cfn-route53-recordsetgroup-recordset-ttl)" : {{String}},
  "[Type](#cfn-route53-recordsetgroup-recordset-type)" : {{String}},
  "[Weight](#cfn-route53-recordsetgroup-recordset-weight)" : {{Integer}}
}
```

### YAML
<a name="aws-properties-route53-recordsetgroup-recordset-syntax.yaml"></a>

```
  [AliasTarget](#cfn-route53-recordsetgroup-recordset-aliastarget): {{
    AliasTarget}}
  [CidrRoutingConfig](#cfn-route53-recordsetgroup-recordset-cidrroutingconfig): {{
    CidrRoutingConfig}}
  [Failover](#cfn-route53-recordsetgroup-recordset-failover): {{String}}
  [GeoLocation](#cfn-route53-recordsetgroup-recordset-geolocation): {{
    GeoLocation}}
  [GeoProximityLocation](#cfn-route53-recordsetgroup-recordset-geoproximitylocation): {{
  ...
  [Name](#cfn-route53-recordsetgroup-recordset-name): {{String}}
  [Region](#cfn-route53-recordsetgroup-recordset-region): {{String}}
  [ResourceRecords](#cfn-route53-recordsetgroup-recordset-resourcerecords): {{
    - String}}
  [SetIdentifier](#cfn-route53-recordsetgroup-recordset-setidentifier): {{String}}
  [TTL](#cfn-route53-recordsetgroup-recordset-ttl): {{String}}
  [Type](#cfn-route53-recordsetgroup-recordset-type): {{String}}
...
## Properties
<a name="aws-properties-route53-recordsetgroup-recordset-properties"></a>

`AliasTarget`  <a name="cfn-route53-recordsetgroup-recordset-aliastarget"></a>
...
*Required*: No
*Type*: [AliasTarget](aws-properties-route53-recordsetgroup-aliastarget.md)
*Update requires*: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)

`CidrRoutingConfig`  <a name="cfn-route53-recordsetgroup-recordset-cidrroutingconfig"></a>
Property description not available.
*Required*: No
*Type*: [CidrRoutingConfig](aws-properties-route53-recordsetgroup-cidrroutingconfig.md)
*Update requires*: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)

`Failover`  <a name="cfn-route53-recordsetgroup-recordset-failover"></a>
...
`GeoLocation`  <a name="cfn-route53-recordsetgroup-recordset-geolocation"></a>
...
*Required*: No
*Type*: [GeoLocation](aws-properties-route53-recordsetgroup-geolocation.md)
*Update requires*: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)

`GeoProximityLocation`  <a name="cfn-route53-recordsetgroup-recordset-geoproximitylocation"></a>
A complex type that contains information about a geographic location.
*Required*: No
*Type*: [GeoProximityLocation](aws-properties-route53-recordsetgroup-geoproximitylocation.md)
*Update requires*: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)

`HealthCheckId`  <a name="cfn-route53-recordsetgroup-recordset-healthcheckid"></a>
...
`HostedZoneId`  <a name="cfn-route53-recordsetgroup-recordset-hostedzoneid"></a>
...
`HostedZoneName`  <a name="cfn-route53-recordsetgroup-recordset-hostedzonename"></a>
...
`MultiValueAnswer`  <a name="cfn-route53-recordsetgroup-recordset-multivalueanswer"></a>
...
`Name`  <a name="cfn-route53-recordsetgroup-recordset-name"></a>
...
`Region`  <a name="cfn-route53-recordsetgroup-recordset-region"></a>
...
*Required*: No
*Type*: String
*Allowed values*: `us-east-1 | us-east-2 | us-west-1 | us-west-2 | ca-central-1 | eu-west-1 | eu-west-2 | eu-west-3 | eu-central-1 | eu-central-2 | ap-southeast-1 | ap-southeast-2 | ap-southeast-3 | ap-northeast-1 | ap-northeast-2 | ap-northeast-3 | eu-north-1 | sa-east-1 | cn-north-1 | cn-northwest-1 | ap-east-1 | me-south-1 | me-central-1 | ap-south-1 | ap-south-2 | af-south-1 | eu-south-1 | eu-south-2 | ap-southeast-4 | il-central-1 | ca-west-1 | ap-southeast-5 | mx-central-1 | ap-southeast-7 | us-gov-east-1 | us-gov-west-1 | ap-east-2 | ap-southeast-6`
*Update requires*: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)

`ResourceRecords`  <a name="cfn-route53-recordsetgroup-recordset-resourcerecords"></a>
...
`SetIdentifier`  <a name="cfn-route53-recordsetgroup-recordset-setidentifier"></a>
...
`TTL`  <a name="cfn-route53-recordsetgroup-recordset-ttl"></a>
...
`Type`  <a name="cfn-route53-recordsetgroup-recordset-type"></a>
...
*Required*: Yes
*Type*: String
*Allowed values*: `SOA | A | TXT | NS | CNAME | MX | NAPTR | PTR | SRV | SPF | AAAA | CAA | DS | TLSA | SSHFP | SVCB | HTTPS`
*Update requires*: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)

`Weight`  <a name="cfn-route53-recordsetgroup-recordset-weight"></a>
