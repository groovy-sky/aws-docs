...
_Type_: [AliasTarget](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-recordsetgroup-aliastarget.html)
...
_Type_: [CidrRoutingConfig](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-recordsetgroup-cidrroutingconfig.html)
...
_Type_: [GeoLocation](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-recordsetgroup-geolocation.html)
...
_Type_: [GeoProximityLocation](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-recordsetgroup-geoproximitylocation.html)
...
Do not provide the `HostedZoneId` if it is already defined in `AWS::Route53::RecordSetGroup`. The creation fails if `HostedZoneId`
is defined in both.
...
Information about the records that you want to create. Each record should be in the format appropriate for the
record type specified by the `Type` property. For information about different record types and their record formats, see
[Values That You Specify When You \
Create or Edit Amazon Route 53 Records](../../../route53/latest/developerguide/resource-record-sets-values.md) in the _Amazon Route 53 Developer Guide_.
...
- [Return values](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53-recordsetgroup.html#aws-resource-route53-recordsetgroup-return-values)
in the topic [AWS::Route53::RecordSetGroup](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53-recordsetgroup.html)

- [ResourceRecordSet](../../../../reference/route53/latest/apireference/api-resourcerecordset.md) in the _Amazon Route 53 API Reference_
