...
Anomaly subscriptions can be associated with one or more [`AWS::CE::AnomalyMonitor`](../userguide/aws-resource-ce-anomalymonitor.md) resources, and they only send notifications
...
anomaly notifications](../../../cost-management/latest/userguide/ad-sns.md).
...
For further information, see the [Examples](../userguide/aws-resource-ce-anomalysubscription.md#aws-resource-ce-anomalysubscription--examples) section of this page.
...
- [AnomalySubscription](../../../../reference/aws-cost-management/latest/apireference/api-anomalysubscription.md) in the _AWS Billing and Cost Management API_
_Reference_.

- [CreateAnomalySubscription](../../../../reference/aws-cost-management/latest/apireference/api-createanomalysubscription.md) in the _AWS Billing and Cost Management API_
_Reference_.

- [DeleteAnomalySubscription](../../../../reference/aws-cost-management/latest/apireference/api-deleteanomalysubscription.md) in the _AWS Billing and Cost Management API_
_Reference_.

- [GetAnomalySubscriptions](../../../../reference/aws-cost-management/latest/apireference/api-getanomalysubscriptions.md) in the _AWS Billing and Cost Management API_
_Reference_.

- [UpdateAnomalySubscription](../../../../reference/aws-cost-management/latest/apireference/api-updateanomalysubscription.md) in the _AWS Billing and Cost Management API_
_Reference_.
