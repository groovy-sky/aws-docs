---
title: "AWS::ECS::Service DeploymentConfiguration"
---
...
_Type_: [CanaryConfiguration](aws-properties-ecs-service-canaryconfiguration.md)
...
_Type_: Array of [DeploymentLifecycleHook](aws-properties-ecs-service-deploymentlifecyclehook.md)
...
_Type_: [LinearConfiguration](aws-properties-ecs-service-linearconfiguration.md)
...
services](../../../amazonecs/latest/developerguide/ecs-services.md).
...
replaces unhealthy tasks, see [Amazon ECS services](../../../amazonecs/latest/developerguide/ecs-services.md).
