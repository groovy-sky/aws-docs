...
_Type_: Array of [DashBaseUrl](aws-properties-mediapackagev2-originendpoint-dashbaseurl.md)
...
For information about compactness, see [DASH manifest compactness](../../../mediapackage/latest/userguide/compacted.md) in the _AWS Elemental MediaPackage v2 User Guide_.
...
_Type_: [DashDvbSettings](aws-properties-mediapackagev2-originendpoint-dashdvbsettings.md)
...
For more information about periods in the DASH manifest, see [Multi-period DASH in AWS Elemental MediaPackage](../../../mediapackage/latest/userguide/multi-period.md).
...
_Type_: [DashProgramInformation](aws-properties-mediapackagev2-originendpoint-dashprograminformation.md)
...
_Type_: [ScteDash](aws-properties-mediapackagev2-originendpoint-sctedash.md)
...
_Type_: [DashSubtitleConfiguration](aws-properties-mediapackagev2-originendpoint-dashsubtitleconfiguration.md)
...
_Type_: [DashUtcTiming](aws-properties-mediapackagev2-originendpoint-dashutctiming.md)
