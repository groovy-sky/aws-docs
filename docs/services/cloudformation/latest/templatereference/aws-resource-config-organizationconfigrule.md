---
title: "AWS::Config::OrganizationConfigRule"
---
...
see [**Service Limits**](../../../config/latest/developerguide/configlimits.md) in the _AWS Config Developer Guide_.
...
[List of AWS Config\
Managed Rules](../../../config/latest/developerguide/managed-rules-by-aws-config.md). If you are adding an AWS Config managed rule, you must specify the rule's identifier for the `RuleIdentifier` key.
...
( [AWS Lambda Developer Guide](../../../config/latest/developerguide/gettingstarted-concepts.md#gettingstarted-concepts-function)) and with Guard ( [Guard GitHub\
