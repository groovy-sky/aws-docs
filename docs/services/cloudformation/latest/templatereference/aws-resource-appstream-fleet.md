...
_Type_: [VolumeConfig](aws-properties-appstream-fleet-volumeconfig.md)
...
_Type_: Array of [Tag](aws-properties-appstream-fleet-tag.md)
...
- [CreateFleet](../../../../reference/appstream2/latest/apireference/api-createfleet.md) in the _Amazon WorkSpaces Applications API Reference_
