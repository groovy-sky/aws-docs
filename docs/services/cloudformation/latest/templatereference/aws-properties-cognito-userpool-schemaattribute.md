...
see [User pool\
attributes](../../../cognito/latest/developerguide/user-pool-settings-attributes.md).
...
You should use [WriteAttributes](../../../../reference/cognito-user-identity-pools/latest/apireference/api-userpoolclienttype.md#CognitoUserPools-Type-UserPoolClientType-WriteAttributes) in the user pool client to control how attributes can
...
Pool](../../../cognito/latest/developerguide/cognito-user-pools-specifying-attribute-mapping.md).
