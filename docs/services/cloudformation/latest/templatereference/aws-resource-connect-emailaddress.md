...
addresses](../../../connect/latest/adminguide/create-email-address1.md) in the Amazon Connect Administrator Guide.
...
_Type_: Array of [AliasConfiguration](aws-properties-connect-emailaddress-aliasconfiguration.md)
...
_Type_: Array of [Tag](aws-properties-connect-emailaddress-tag.md)
