...
_Type_: [S3Location](aws-properties-mwaaserverless-workflow-s3location.md)
...
_Type_: [EncryptionConfiguration](aws-properties-mwaaserverless-workflow-encryptionconfiguration.md)
...
_Type_: [LoggingConfiguration](aws-properties-mwaaserverless-workflow-loggingconfiguration.md)
...
_Type_: [NetworkConfiguration](aws-properties-mwaaserverless-workflow-networkconfiguration.md)
