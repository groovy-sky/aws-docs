...
the sequence of the [custom authentication challenge triggers](../../../cognito/latest/developerguide/user-pool-lambda-challenge.md).
...
_Type_: [InboundFederation](aws-properties-cognito-userpool-inboundfederation.md)

_Update requires_: [No interruption](../userguide/using-cfn-updating-stacks-update-behaviors.md#update-no-interrupt)

`KMSKeyID`

The ARN of an [KMS key](../../../kms/latest/developerguide/concepts.md#master_keys). Amazon Cognito uses the key to encrypt codes and temporary passwords sent to
...
The configuration of a [post authentication Lambda trigger](../../../cognito/latest/developerguide/user-pool-lambda-post-authentication.md) in a user pool. This
...
The configuration of a [post confirmation Lambda trigger](../../../cognito/latest/developerguide/user-pool-lambda-post-confirmation.md) in a user pool. This
...
The configuration of a [pre authentication trigger](../../../cognito/latest/developerguide/user-pool-lambda-pre-authentication.md) in a user pool. This trigger
...
The configuration of a [pre sign-up Lambda trigger](../../../cognito/latest/developerguide/user-pool-lambda-pre-sign-up.md) in a user pool. This trigger
evaluates new users and can bypass confirmation, [link a federated user profile](../../../cognito/latest/developerguide/cognito-user-pools-identity-federation-consolidate-users.md), or block sign-up
requests.
...
The legacy configuration of a [pre token generation Lambda trigger](../../../cognito/latest/developerguide/user-pool-lambda-pre-token-generation.md) in a user
pool.
...
The detailed configuration of a [pre token generation Lambda trigger](../../../cognito/latest/developerguide/user-pool-lambda-pre-token-generation.md) in a user pool. If
you also set an ARN in `PreTokenGeneration`, its value must be identical to
`PreTokenGenerationConfig`.

_Required_: No

_Type_: [PreTokenGenerationConfig](aws-properties-cognito-userpool-pretokengenerationconfig.md)

_Update requires_: [No interruption](../userguide/using-cfn-updating-stacks-update-behaviors.md#update-no-interrupt)

`UserMigration`

The configuration of a [migrate user Lambda trigger](../../../cognito/latest/developerguide/user-pool-lambda-migrate-user.md) in a user pool. This trigger
