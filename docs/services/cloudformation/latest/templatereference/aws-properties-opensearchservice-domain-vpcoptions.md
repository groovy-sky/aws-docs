---
title: "AWS::OpenSearchService::Domain VPCOptions"
---
...
```
{
  "[EgressEnabled](#cfn-opensearchservice-domain-vpcoptions-egressenabled)" : {{Boolean}},
...
`EgressEnabled`  <a name="cfn-opensearchservice-domain-vpcoptions-egressenabled"></a>
