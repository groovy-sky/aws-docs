...
_Type_: Array of [InputRequestDestinationRoute](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-medialive-input-inputrequestdestinationroute.html)
