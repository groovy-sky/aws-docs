---
title: "AWS::CertificateManager::Certificate DomainValidationOption"
---
...
`DomainValidationOption` is a property of the [AWS::CertificateManager::Certificate](../userguide/aws-resource-certificatemanager-certificate.md) resource that specifies the AWS Certificate Manager (ACM) certificate domain to validate. Depending on
