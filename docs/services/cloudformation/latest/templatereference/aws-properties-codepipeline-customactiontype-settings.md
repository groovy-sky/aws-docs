...
<a name="aws-properties-codepipeline-customactiontype-settings"></a>

`Settings` is a property of the `AWS::CodePipeline::CustomActionType` resource that provides URLs that users can access to view information about the CodePipeline custom action.

## Syntax
<a name="aws-properties-codepipeline-customactiontype-settings-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-codepipeline-customactiontype-settings-syntax.json"></a>
...
### YAML
<a name="aws-properties-codepipeline-customactiontype-settings-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-codepipeline-customactiontype-settings-properties"></a>
