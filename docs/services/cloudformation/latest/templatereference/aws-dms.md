...
- [AWS::DMS::DataMigration](aws-resource-dms-datamigration.md)

- [AWS::DMS::DataProvider](aws-resource-dms-dataprovider.md)

- [AWS::DMS::Endpoint](aws-resource-dms-endpoint.md)

- [AWS::DMS::EventSubscription](aws-resource-dms-eventsubscription.md)

- [AWS::DMS::InstanceProfile](aws-resource-dms-instanceprofile.md)

- [AWS::DMS::MigrationProject](aws-resource-dms-migrationproject.md)
