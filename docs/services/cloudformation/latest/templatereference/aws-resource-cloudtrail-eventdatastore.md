...
events, see [Log events by using advanced event selectors](../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md#creating-data-event-selectors-advanced) in the CloudTrail User Guide.
...
items](../../../awscloudtrail/latest/userguide/lake-eds-cli.md#lake-cli-create-eds-config) in the CloudTrail User Guide.

For more information about how to use advanced event selectors to include events outside of AWS events in your event data store, see [Create an integration to log events from outside AWS](../../../awscloudtrail/latest/userguide/lake-integrations-cli.md#lake-cli-create-integration) in the CloudTrail User Guide.

_Required_: No

_Type_: Array of [AdvancedEventSelector](aws-properties-cloudtrail-eventdatastore-advancedeventselector.md)
...
[Managing CloudTrail Lake costs](../../../awscloudtrail/latest/userguide/cloudtrail-lake-manage-costs.md).
...
_Type_: Array of [ContextKeySelector](aws-properties-cloudtrail-eventdatastore-contextkeyselector.md)
...
Indicates if [Lake query federation](../../../awscloudtrail/latest/userguide/query-federation.md) is enabled. By default, Lake query federation is disabled.
...
The federation role must exist in your account and provide the [required minimum permissions](../../../awscloudtrail/latest/userguide/query-federation.md#query-federation-permissions-role).
...
[Create an event data store for CloudTrail Insights events](../../../awscloudtrail/latest/userguide/query-event-data-store-insights.md).
...
_Type_: Array of [InsightSelector](aws-properties-cloudtrail-eventdatastore-insightselector.md)
...
_Type_: Array of [Tag](aws-properties-cloudtrail-eventdatastore-tag.md)
...
[Create an event data store for CloudTrail events](../../../awscloudtrail/latest/userguide/query-event-data-store-cloudtrail.md)
in the _AWS CloudTrail User Guide_.

In this example, `FederationEnabled` is set to `true` to enable [Lake query federation](../../../awscloudtrail/latest/userguide/query-federation.md) and `FederationRoleArn` is set to the
ARN of the federation role used to access the federated resources. The federation role must exist in your account and provide the [required minimum permissions](../../../awscloudtrail/latest/userguide/query-federation.md#query-federation-permissions-role).
