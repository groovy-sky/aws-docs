...
_Type_: Array of [SizeConstraint](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-waf-sizeconstraintset-sizeconstraint.html)
...
- [Define a Size Constraint](#aws-resource-waf-sizeconstraintset--examples--Define_a_Size_Constraint)

- [Associate a SizeConstraintSet with a Web ACL Rule](#aws-resource-waf-sizeconstraintset--examples--Associate_a_SizeConstraintSet_with_a_Web_ACL_Rule)

- [Create a Web ACL](#aws-resource-waf-sizeconstraintset--examples--Create_a_Web_ACL)
