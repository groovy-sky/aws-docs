---
title: "AWS::Greengrass::ConnectorDefinitionVersion Connector"
---
...
In an
CloudFormation template, the `Connectors` property of the [`AWS::Greengrass::ConnectorDefinitionVersion`](../userguide/aws-resource-greengrass-connectordefinitionversion.md) resource contains a list of `Connector` property types.
