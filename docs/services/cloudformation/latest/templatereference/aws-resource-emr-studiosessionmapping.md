---
title: "AWS::EMR::StudioSessionMapping"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::EMR::StudioSessionMapping
<a name="aws-resource-emr-studiosessionmapping"></a>
...
## Syntax
<a name="aws-resource-emr-studiosessionmapping-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-resource-emr-studiosessionmapping-syntax.json"></a>
...
### YAML
<a name="aws-resource-emr-studiosessionmapping-syntax.yaml"></a>
...
## Properties
<a name="aws-resource-emr-studiosessionmapping-properties"></a>
