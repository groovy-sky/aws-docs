---
title: "AWS::Elasticsearch::Domain ElasticsearchClusterConfig"
---
...
as the instance type and the number of instances. For more information, see [Creating and managing Amazon OpenSearch Service domains](../../../opensearch-service/latest/developerguide/createupdatedomains.md) in the _Amazon_
...
multi-AZ domain in Amazon OpenSearch Service](../../../opensearch-service/latest/developerguide/managedomains-multiaz.md).
