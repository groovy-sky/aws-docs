...
For more information about using VPC endpoints with AWS Transfer Family, see [Create a Transfer Family web app in a VPC](../../../transfer/latest/userguide/create-webapp-in-vpc.md).
...
your access endpoint with a custom URL](../../../transfer/latest/userguide/webapp-customize.md).
...
_Type_: [EndpointDetails](aws-properties-transfer-webapp-endpointdetails.md)
...
provider for Transfer Family web apps](../../../transfer/latest/userguide/webapp-identity-center.md).

_Required_: Yes

_Type_: [IdentityProviderDetails](aws-properties-transfer-webapp-identityproviderdetails.md)
...
_Type_: Array of [Tag](aws-properties-transfer-webapp-tag.md)
...
_Type_: [WebAppCustomization](aws-properties-transfer-webapp-webappcustomization.md)
...
_Type_: [WebAppUnits](aws-properties-transfer-webapp-webappunits.md)
