---
title: "AWS::CodeBuild::ReportGroup"
---
...
_Type_: Array of [Tag](aws-properties-codebuild-reportgroup-tag.md)
...
see [Fn::GetAtt](../userguide/intrinsic-function-reference-getatt.md).
