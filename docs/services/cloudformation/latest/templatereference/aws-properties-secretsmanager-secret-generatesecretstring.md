---
title: "AWS::SecretsManager::Secret GenerateSecretString"
---
...
**Required permissions:** `secretsmanager:GetRandomPassword`. For more information, see [IAM policy actions for Secrets Manager](../../../service-authorization/latest/reference/list-awssecretsmanager.md#awssecretsmanager-actions-as-permissions) and [Authentication and access control\
...
- [GetRandomPassword](../../../../reference/secretsmanager/latest/apireference/api-getrandompassword.md) in the AWS Secrets Manager API Reference
