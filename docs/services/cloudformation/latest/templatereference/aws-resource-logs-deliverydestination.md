...
_Type_: [DestinationPolicy](aws-properties-logs-deliverydestination-destinationpolicy.md)
...
_Type_: Array of [Tag](aws-properties-logs-deliverydestination-tag.md)
