...
For more information, see [Prerequisite: Registering your account to publish CloudFormation extensions](../../../cloudformation-cli/latest/userguide/publish-extension.md#publish-extension-prereqs) in the
