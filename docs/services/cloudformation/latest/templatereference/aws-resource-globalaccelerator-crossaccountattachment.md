...
For more information, see [Working with cross-account attachments and resources in AWS Global Accelerator](../../../global-accelerator/latest/dg/cross-account-resources.md) in the _AWS Global Accelerator Developer Guide_.
...
_Type_: Array of [Resource](aws-properties-globalaccelerator-crossaccountattachment-resource.md)
...
in AWS Global Accelerator](../../../global-accelerator/latest/dg/tagging-in-global-accelerator.md) in the _AWS Global Accelerator Developer Guide_.

_Required_: No

_Type_: Array of [Tag](aws-properties-globalaccelerator-crossaccountattachment-tag.md)
