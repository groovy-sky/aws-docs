---
title: "AWS::FMS::Policy NetworkFirewallPolicy"
---
...
architectures with routing](../../../network-firewall/latest/developerguide/architectures.md) in the _Network Firewall Developer_
_Guide_.
...
set [FirewallDeploymentModel](../userguide/aws-properties-fms-policy-thirdpartyfirewallpolicy.md) to
`DISTRIBUTED`.
