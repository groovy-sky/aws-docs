...
Cluster Subnet Groups](../../../redshift/latest/mgmt/working-with-cluster-subnet-groups.md) in the _Amazon Redshift Cluster Management_
_Guide_.
...
_Type_: Array of [Tag](aws-properties-redshift-clustersubnetgroup-tag.md)
