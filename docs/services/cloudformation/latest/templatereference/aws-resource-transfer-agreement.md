...
_Type_: [CustomDirectories](aws-properties-transfer-agreement-customdirectories.md)
...
described in [File names and locations](../../../transfer/latest/userguide/send-as2-messages.md#file-names-as2).
...
_Type_: Array of [Tag](aws-properties-transfer-agreement-tag.md)
