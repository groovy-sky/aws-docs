---
title: "AWS::EMR::InstanceFleetConfig"
---
...
`TaskInstanceFleets` subproperty for the [AWS::EMR::Cluster JobFlowInstancesConfig](../userguide/aws-properties-elasticmapreduce-cluster-jobflowinstancesconfig.md) property instead. To use this
...
_Type_: Array of [InstanceTypeConfig](aws-properties-emr-instancefleetconfig-instancetypeconfig.md)
...
_Type_: [InstanceFleetProvisioningSpecifications](aws-properties-emr-instancefleetconfig-instancefleetprovisioningspecifications.md)
...
_Type_: [InstanceFleetResizingSpecifications](aws-properties-emr-instancefleetconfig-instancefleetresizingspecifications.md)
