...
_Type_: [EncryptionConfig](aws-properties-observabilityadmin-s3tableintegration-encryptionconfig.md)
...
_Type_: Array of [LogSource](aws-properties-observabilityadmin-s3tableintegration-logsource.md)
...
_Type_: Array of [Tag](aws-properties-observabilityadmin-s3tableintegration-tag.md)
