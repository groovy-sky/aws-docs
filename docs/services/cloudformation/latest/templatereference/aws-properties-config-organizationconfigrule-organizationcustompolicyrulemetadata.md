---
title: "AWS::Config::OrganizationConfigRule OrganizationCustomPolicyRuleMetadata"
---
...
the configuration snapshot. For more information, see [ConfigSnapshotDeliveryProperties](../userguide/aws-resource-config-deliverychannel.md#cfn-config-deliverychannel-configsnapshotdeliveryproperties).
