---
title: "AWS::Lightsail::Distribution CacheBehaviorPerPath"
---
...
`CacheBehaviorPerPath` is a property of the [AWS::Lightsail::Distribution](../userguide/aws-resource-lightsail-distribution.md) resource. It describes the per-path cache behavior
