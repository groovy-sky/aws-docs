...
more about when to use [On-Demand versus Spot Instances](../../../gamelift/latest/developerguide/gamelift-ec2-instances.md#gamelift-ec2-instances-spot). You can't update this fleet
property.
...
_Type_: [DeploymentConfiguration](aws-properties-gamelift-containerfleet-deploymentconfiguration.md)
...
role](../../../gamelift/latest/developerguide/setting-up-role.md). This fleet property can't be changed.
...
_Type_: [GameSessionCreationLimitPolicy](aws-properties-gamelift-containerfleet-gamesessioncreationlimitpolicy.md)
...
_Type_: [ConnectionPortRange](aws-properties-gamelift-containerfleet-connectionportrange.md)
...
_Type_: Array of [IpPermission](aws-properties-gamelift-containerfleet-ippermission.md)
...
_Type_: Array of [LocationConfiguration](aws-properties-gamelift-containerfleet-locationconfiguration.md)
...
_Type_: [LogConfiguration](aws-properties-gamelift-containerfleet-logconfiguration.md)
...
protection for individual game sessions using [UpdateGameSession](../../../../reference/awscloudformation/latest/templatereference/gamelift/latest/apireference/api-updategamesession.md).
...
_Type_: Array of [ScalingPolicy](aws-properties-gamelift-containerfleet-scalingpolicy.md)
...
_Type_: Array of [Tag](aws-properties-gamelift-containerfleet-tag.md)
...
The Amazon Resource Name ( [ARN](../../../s3/latest/dev/s3-arn-format.md)) that is assigned to the fleet's game server container group. The ARN value
...
The Amazon Resource Name ( [ARN](../../../s3/latest/dev/s3-arn-format.md)) that is assigned to the fleet's per-instance container group. The ARN value
also identifies the specific container group definition version in use.
