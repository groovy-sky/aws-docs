...
information, see [Prerequisites for using SQL Server High Availability instance standby detection](../../../sql-server-ec2/latest/userguide/prerequisites-and-requirements.md).
