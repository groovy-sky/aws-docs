...
specifications](../../../../reference/launchwizard/latest/apireference/launch-wizard-specifications-sap.md). To retrieve the specifications required to create a deployment for other workloads,
use the [`GetWorkloadDeploymentPattern`](../../../../reference/launchwizard/latest/apireference/api-getworkloaddeploymentpattern.md) operation.
...
_Type_: [Array](aws-properties-launchwizard-deployment-tags.md) of [Tags](aws-properties-launchwizard-deployment-tags.md)
