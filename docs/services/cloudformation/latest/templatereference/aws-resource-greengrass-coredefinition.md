---
title: "AWS::Greengrass::CoreDefinition"
---
...
definition version. To associate a core definition version later, create an [`AWS::Greengrass::CoreDefinitionVersion`](../userguide/aws-resource-greengrass-coredefinitionversion.md) resource and specify
...
core definition version can contain only one [`core`](../userguide/aws-properties-greengrass-coredefinition-core.md).

###### Note

To associate a core definition version after the core definition is created, create
an [`AWS::Greengrass::CoreDefinitionVersion`](../userguide/aws-resource-greengrass-coredefinitionversion.md) resource and specify
the ID of this core definition.
...
- [CreateCoreDefinition](../../../../reference/greengrass/v1/apireference/createcoredefinition-post.md) in the _AWS IoT Greengrass Version 1 API Reference_
