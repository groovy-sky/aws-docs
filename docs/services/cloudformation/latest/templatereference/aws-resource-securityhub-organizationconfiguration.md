...
and member accounts](../../../securityhub/latest/userguide/securityhub-accounts.md) in the _AWS Security Hub CSPM User Guide_.
...
Whether to automatically enable Security Hub CSPM [default standards](../../../securityhub/latest/userguide/securityhub-standards-enable-disable.md)
