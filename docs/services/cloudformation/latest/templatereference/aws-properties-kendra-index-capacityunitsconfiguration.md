---
title: "AWS::Kendra::Index CapacityUnitsConfiguration"
---
...
The amount of extra query capacity for an index and [GetQuerySuggestions](../../../kendra/latest/dg/api-getquerysuggestions.md)
capacity.
