---
title: "AWS::EC2::SpotFleet SpotFleetLaunchSpecification"
---
...
`SpotFleetLaunchSpecification`; you must use [LaunchTemplateConfig](../userguide/aws-properties-ec2-spotfleet-launchtemplateconfig.md).
...
_Type_: Array of [BlockDeviceMapping](aws-properties-ec2-spotfleet-blockdevicemapping.md)
...
_Type_: Array of [InstanceNetworkInterfaceSpecification](aws-properties-ec2-spotfleet-instancenetworkinterfacespecification.md)
...
_Type_: Array of [GroupIdentifier](aws-properties-ec2-spotfleet-groupidentifier.md)
