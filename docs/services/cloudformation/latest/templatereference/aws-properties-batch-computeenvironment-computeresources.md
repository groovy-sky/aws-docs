---
title: "AWS::Batch::ComputeEnvironment ComputeResources"
---
...
required for managed compute environments. For more information, see [Compute Environments](../../../batch/latest/userguide/compute-environments.md)
...
limits](../../../ec2/latest/userguide/ec2-resource-limits.md). For more information, see [Allocation strategies](../../../batch/latest/userguide/allocation-strategies.md) in
the _AWS Batch User Guide_.

When updating a compute environment, changing the allocation strategy requires an
infrastructure update of the compute environment. For more information, see [Updating compute environments](../../../batch/latest/userguide/updating-compute-environments.md) in the _AWS Batch User Guide_. `BEST_FIT` is not supported
...
update of the compute environment. For more information, see [Updating compute environments](../../../batch/latest/userguide/updating-compute-environments.md) in the
...
AWS Batch](../../../batch/latest/userguide/troubleshooting.md#error-desired-vcpus-update) in the _AWS Batch User Guide_.
...
of the compute environment. For more information, see [Updating compute environments](../../../batch/latest/userguide/updating-compute-environments.md) in the
...
_Type_: Array of [Ec2ConfigurationObject](aws-properties-batch-computeenvironment-ec2configurationobject.md)
...
For more information, see [Amazon ECS instance role](../../../batch/latest/userguide/instance-iam-role.md) in the _AWS Batch User Guide_.
...
updates](../../../batch/latest/userguide/optimal-default-instance-troubleshooting.md).
...
type compute table](../../../batch/latest/userguide/instance-type-compute-table.md) in the _AWS Batch User Guide_.
...
parameters that you specify in a [CreateComputeEnvironment](../../../../reference/batch/latest/apireference/api-createcomputeenvironment.md) API operation override the same parameters in the
launch template. You must specify either the launch template ID or launch template name in
the request, but not both. For more information, see [Launch Template Support](../../../batch/latest/userguide/launch-templates.md) in
...
infrastructure update of the compute environment. For more information, see [Updating compute environments](../../../batch/latest/userguide/updating-compute-environments.md) in the _AWS Batch User Guide_.
...
_Type_: [ComputeScalingPolicy](aws-properties-batch-computeenvironment-computescalingpolicy.md)
...
the allocation strategy isn't specified. For more information, see [Amazon EC2 spot fleet role](../../../batch/latest/userguide/spot-fleet-iam-role.md) in the
_AWS Batch User Guide_.
...
not tagged on creation](../../../batch/latest/userguide/troubleshooting.md#spot-instance-no-tag) in the _AWS Batch User Guide_.
...
Zones](../../../eks/latest/userguide/local-zones.md) in the _Amazon EKS User Guide_ and [Amazon ECS\
clusters in Local Zones, Wavelength Zones, and AWS Outposts](../../../amazonecs/latest/developerguide/cluster-regions-zones.md#clusters-local-zones) in the _Amazon ECS_
_Developer Guide_.
...
spot fleet role](../../../batch/latest/userguide/spot-fleet-iam-role.md) in the _AWS Batch User Guide_.

When updating compute environment, changing the type of a compute environment requires
an infrastructure update of the compute environment. For more information, see [Updating compute environments](../../../batch/latest/userguide/updating-compute-environments.md) in the _AWS Batch User Guide_.
...
the AMI ID](../../../batch/latest/userguide/updating-compute-environments.md#updating-compute-environments-ami) in the _AWS Batch User Guide_.
