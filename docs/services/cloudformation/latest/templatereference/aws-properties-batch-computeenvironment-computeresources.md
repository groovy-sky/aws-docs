...
<a name="aws-properties-batch-computeenvironment-computeresources"></a>
...
## Syntax
<a name="aws-properties-batch-computeenvironment-computeresources-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-batch-computeenvironment-computeresources-syntax.json"></a>
...
```
{
  ...
  "[ScalingPolicy](#cfn-batch-computeenvironment-computeresources-scalingpolicy)" : {{ComputeScalingPolicy}},
...
### YAML
<a name="aws-properties-batch-computeenvironment-computeresources-syntax.yaml"></a>
...
```
  ...
  [MinvCpus](#cfn-batch-computeenvironment-computeresources-minvcpus): {{Integer}}
  [PlacementGroup](#cfn-batch-computeenvironment-computeresources-placementgroup): {{String}}
  [ScalingPolicy](#cfn-batch-computeenvironment-computeresources-scalingpolicy): {{
...
## Properties
<a name="aws-properties-batch-computeenvironment-computeresources-properties"></a>
...
*Required*: No
*Type*: String
*Allowed values*: `BEST_FIT_PROGRESSIVE | BEST_FIT_PROGRESSIVE_ORDERED | SPOT_CAPACITY_OPTIMIZED | SPOT_PRICE_CAPACITY_OPTIMIZED | SPOT_CAPACITY_OPTIMIZED_PRIORITIZED`
...
This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.
*Required*: No
*Type*: Array of [Ec2ConfigurationObject](aws-properties-batch-computeenvironment-ec2configurationobject.md)
*Update requires*: [Some interruptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-some-interrupt)
...
`ScalingPolicy`  <a name="cfn-batch-computeenvironment-computeresources-scalingpolicy"></a>
The scaling policy configuration for the compute environment.
This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.
*Required*: No
*Type*: [ComputeScalingPolicy](aws-properties-batch-computeenvironment-computescalingpolicy.md)
*Update requires*: [Some interruptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-some-interrupt)
