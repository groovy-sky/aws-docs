---
title: "AWS::CodeDeploy::DeploymentConfig"
---
...
Health](../../../codedeploy/latest/userguide/instances-health.md) in the AWS CodeDeploy User Guide.

_Required_: No

_Type_: [MinimumHealthyHosts](aws-properties-codedeploy-deploymentconfig-minimumhealthyhosts.md)
...
_Type_: [ZonalConfig](aws-properties-codedeploy-deploymentconfig-zonalconfig.md)
