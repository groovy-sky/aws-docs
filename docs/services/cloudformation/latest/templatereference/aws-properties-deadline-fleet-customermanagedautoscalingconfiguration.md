...
The `CustomerManagedAutoScalingConfiguration` property type specifies Property description not available. for an [AWS::Deadline::Fleet](aws-resource-deadline-fleet.md).
