---
title: "AWS::Cloud9::EnvironmentEC2"
---
...
The `AWS::Cloud9::EnvironmentEC2` resource creates an Amazon EC2 development environment in AWS Cloud9. For more information, see [Creating an Environment](../../../cloud9/latest/user-guide/create-environment.md) in the _AWS Cloud9 User Guide_.
...
_Type_: Array of [Repository](aws-properties-cloud9-environmentec2-repository.md)
...
_Type_: Array of [Tag](aws-properties-cloud9-environmentec2-tag.md)
