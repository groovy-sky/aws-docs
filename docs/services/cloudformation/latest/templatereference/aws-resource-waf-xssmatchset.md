...
_Type_: Array of [XssMatchTuple](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-waf-xssmatchset-xssmatchtuple.html)
...
- [Define Which Part of a Request to Check for Cross-site Scripting](#aws-resource-waf-xssmatchset--examples--Define_Which_Part_of_a_Request_to_Check_for_Cross-site_Scripting)

- [Associate an XssMatchSet with a Web ACL Rule](#aws-resource-waf-xssmatchset--examples--Associate_an_XssMatchSet_with_a_Web_ACL_Rule)

- [Create a Web ACL](#aws-resource-waf-xssmatchset--examples--Create_a_Web_ACL)
