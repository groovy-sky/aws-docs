---
title: "AWS::DataSync::Task TaskReportConfig"
---
...
For more information, see [Task reports](../../../datasync/latest/userguide/task-reports.md).
...
reports](../../../datasync/latest/userguide/task-reports.md#task-report-access).

_Required_: Yes

_Type_: [Destination](aws-properties-datasync-task-destination.md)
...
_Type_: [Overrides](aws-properties-datasync-task-overrides.md)
