...
published by your devices to Device Defender. For API reference, see [CreateCustomMetric](../../../../reference/iot/latest/apireference/api-createcustommetric.md) and for general information, see [Custom\
metrics](../../../iot/latest/developerguide/dd-detect-custom-metrics.md).
...
_Type_: Array of [Tag](aws-properties-iot-custommetric-tag.md)
