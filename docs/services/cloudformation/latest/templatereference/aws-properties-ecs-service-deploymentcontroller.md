---
title: "AWS::ECS::Service DeploymentController"
---
...
- `ROLLING`: When you create a service which uses the _rolling update_
...
- `BLUE_GREEN`: A _blue/green_ deployment strategy ( `BLUE_GREEN`) is a release methodology that reduces downtime and
...
For more information, see [Resource removed from stack but not deleted](../userguide/troubleshooting.md#troubleshooting-errors-resource-removed-not-deleted) in the
...
about how to delete a task set, see [DeleteTaskSet](../../../../reference/amazonecs/latest/apireference/api-deletetaskset.md) in the Amazon Elastic Container Service API Reference.
...
information about how to delete a task set, see [DeleteTaskSet](../../../../reference/amazonecs/latest/apireference/api-deletetaskset.md) in the Amazon Elastic Container Service API Reference.
