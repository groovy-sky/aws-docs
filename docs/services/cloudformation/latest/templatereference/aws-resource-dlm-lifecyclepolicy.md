...
- [CreateLifecyclePolicy](../../../../reference/dlm/latest/apireference/api-createlifecyclepolicy.md) in the
_Amazon Data Lifecycle Manager API Reference_

- [Automating the Amazon EBS Snapshot Lifecycle](../../../ec2/latest/userguide/snapshot-lifecycle.md)
