...
information about these configuration ARNs, see [Getting started with Amazon Q in chat applications](../../../chatbot/latest/adminguide/getting-started.md) and [Resource type defined by AWS Chatbot](../../../service-authorization/latest/reference/list-awschatbot.md#awschatbot-resources-for-iam-policies).
