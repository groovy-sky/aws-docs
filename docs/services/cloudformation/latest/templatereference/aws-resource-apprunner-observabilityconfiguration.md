---
title: "AWS::AppRunner::ObservabilityConfiguration"
---
...
_Type_: Array of [Tag](aws-properties-apprunner-observabilityconfiguration-tag.md)
...
- [Tracing for your App Runner application with X-Ray](../../../apprunner/latest/dg/monitor-xray.md) in the _AWS App Runner Developer Guide_
