...
_Type_: Array of [BgpPeer](aws-properties-directconnect-publicvirtualinterface-bgppeer.md)
...
_Type_: Array of [Tag](aws-properties-directconnect-publicvirtualinterface-tag.md)
