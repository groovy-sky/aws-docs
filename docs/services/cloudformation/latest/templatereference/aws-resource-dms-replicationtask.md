...
[Extra Connection Attributes When Using PostgreSQL as a Source for AWS DMS](../../../dms/latest/userguide/chap-source-postgresql.md#CHAP_Source.PostgreSQL.ConnectionAttrib)
...
[Specifying Task Settings for AWS Database Migration Service Tasks](../../../dms/latest/userguide/chap-tasks-customizingtasks-tasksettings.md)
in the _AWS Database Migration Service User Guide_.
...
[Using Table Mapping to Specify Task Settings](../../../dms/latest/userguide/chap-tasks-customizingtasks-tablemapping.md)
in the _AWS Database Migration Service User Guide_.
...
_Type_: Array of [Tag](aws-properties-dms-replicationtask-tag.md)
...
For more information, see [Specifying Supplemental Data for Task Settings](../../../dms/latest/userguide/chap-tasks-taskdata.md) in the
...
full-load task settings, see [Full-load task settings](../../../dms/latest/userguide/chap-tasks-customizingtasks-tasksettings-timetravel.md).
...
- [CreateReplicationTask](../../../../reference/dms/latest/apireference/api-createreplicationtask.md)
