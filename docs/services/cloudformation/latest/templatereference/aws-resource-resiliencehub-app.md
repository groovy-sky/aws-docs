...
quotas](../../../../general/latest/gr/resiliencehub.md#limits_resiliencehub).
...
about the `appTemplateBody` template, see the sample template in [Sample appTemplateBody template](../../../../reference/resilience-hub/latest/apireference/api-putdraftappversiontemplate.md#API_PutDraftAppVersionTemplate_Examples).
...
[Configure the application configuration parameters](../../../resilience-hub/latest/userguide/app-config-param.md).
...
The type of AppComponent. For more information about the types of AppComponent, see [Grouping resources in an AppComponent](../../../resilience-hub/latest/userguide/appcomponent-grouping.md).
...
_Type_: Array of [EventSubscription](aws-properties-resiliencehub-app-eventsubscription.md)
...
_Type_: [PermissionModel](aws-properties-resiliencehub-app-permissionmodel.md)
...
_Type_: Array of [ResourceMapping](aws-properties-resiliencehub-app-resourcemapping.md)
