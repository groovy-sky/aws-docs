...
Specifies a tag (key-value pair) to apply to a findings filter. A _tag_ is a label that you can define and associate with AWS
...
Macie resources](https://docs.aws.amazon.com/macie/latest/user/tagging-resources.html) in the _Amazon Macie User Guide_.
