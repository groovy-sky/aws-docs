...
For more information, see [Direct Connect link aggregation groups (LAGs)](../../../directconnect/latest/userguide/lags.md) in the _Direct Connect User Guide_.
...
All connections in the LAG must be capable of supporting MAC Security (MACsec). For information about MAC Security (MACsec) prerequisties, see [MACsec prerequisties](../../../directconnect/latest/userguide/direct-connect-mac-sec-getting-started.md#mac-sec-prerequisites) in the _Direct Connect User Guide_.
...
_Type_: Array of [Tag](aws-properties-directconnect-lag-tag.md)
