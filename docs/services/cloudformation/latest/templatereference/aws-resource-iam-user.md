...
for any IAM user. Use [ChangePassword](../../../../reference/iam/latest/apireference/api-changepassword.md) to update
your own existing password in the **My Security Credentials**
page in the AWS Management Console.

For more information about managing passwords, see [Managing passwords](../../../iam/latest/userguide/using-managinglogins.md) in the _IAM User Guide_.
...
for IAM entities](../../../iam/latest/userguide/access-policies-boundaries.md) in the _IAM User Guide_.

For more information about policy types, see [Policy types](../../../iam/latest/userguide/access-policies.md#access_policy-types) in the _IAM User Guide_.
...
user, see [Limitations on IAM Entities](../../../iam/latest/userguide/limitationsonentities.md) in the _IAM User Guide_.
...
For more information about tagging, see [Tagging IAM resources](../../../iam/latest/userguide/id-tags.md) in the
_IAM User Guide_.
...
- [CreateUser](../../../../reference/iam/latest/apireference/api-createuser.md) in the _AWS Identity and Access Management API Reference_
