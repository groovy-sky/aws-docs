---
title: "AWS::SimSpaceWeaver::Simulation"
---
...
see the [detailed tutorial](../../../simspaceweaver/latest/userguide/getting-started-detailed.md) in the _AWSSimSpace Weaver User Guide_.
...
[Snapshots](../../../simspaceweaver/latest/userguide/working-with-snapshots.md)
...
see [IAM\
roles](../../../iam/latest/userguide/id-roles.md) in the _AWS Identity and Access Management User Guide_.
...
The JSON blob that the [DescribeSimulation](../../../../reference/simspaceweaver/latest/apireference/api-describesimulation.md) action returns.
...
[detailed\
tutorial](../../../simspaceweaver/latest/userguide/getting-started-detailed.md) in the _AWS SimSpace Weaver User Guide_.
