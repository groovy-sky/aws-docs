---
title: "AWS::IoTEvents::DetectorModel Sns"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::IoTEvents::DetectorModel Sns
<a name="aws-properties-iotevents-detectormodel-sns"></a>

Information required to publish the Amazon SNS message.

## Syntax
<a name="aws-properties-iotevents-detectormodel-sns-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-iotevents-detectormodel-sns-syntax.json"></a>
...
### YAML
<a name="aws-properties-iotevents-detectormodel-sns-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-iotevents-detectormodel-sns-properties"></a>
