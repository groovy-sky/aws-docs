...
For more information, see [State templates](../../../iot-fleetwise/latest/developerguide/state-templates.md) in the _AWS IoT FleetWise Developer Guide_.
...
_Type_: Array of [Tag](aws-properties-iotfleetwise-statetemplate-tag.md)
