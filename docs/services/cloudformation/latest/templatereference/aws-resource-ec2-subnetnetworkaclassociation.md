...
Associates a subnet with a network ACL. For more information, see [ReplaceNetworkAclAssociation](../../../../reference/awsec2/latest/apireference/apireference-query-replacenetworkaclassociation.md) in the _Amazon EC2 API_
_Reference_.
...
`Retain` deletion policies. For more information, see [DeletionPolicy Attribute](../userguide/aws-attribute-deletionpolicy.md).
