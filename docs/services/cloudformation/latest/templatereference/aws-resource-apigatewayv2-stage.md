...
HTTP APIs](../../../apigateway/latest/developerguide/http-api-stages.md) and [Deploy a WebSocket API in API Gateway](../../../apigateway/latest/developerguide/apigateway-set-up-websocket-deployment.md).
...
- [CreateStage](../../../apigatewayv2/latest/api-reference/apis-apiid-stages.md#CreateStage) in the _Amazon API Gateway_
