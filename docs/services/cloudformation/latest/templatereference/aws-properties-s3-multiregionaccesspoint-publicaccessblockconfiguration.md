...
information about when Amazon S3 considers an object public, see [The Meaning of "Public"](../../../s3/latest/dev/access-control-block-public-access.md#access-control-block-public-access-policy-status) in the _Amazon S3 User Guide_.
