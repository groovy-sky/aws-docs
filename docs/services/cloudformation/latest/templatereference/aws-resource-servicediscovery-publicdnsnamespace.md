---
title: "AWS::ServiceDiscovery::PublicDnsNamespace"
---
...
DNS. For the current quota on the number of namespaces that you can create using the same AWS account, see [AWS Cloud Map quotas](../../../cloud-map/latest/dg/cloud-map-limits.md) in the
...
_Type_: Array of [Tag](aws-properties-servicediscovery-publicdnsnamespace-tag.md)
...
- [CreatePublicDnsNamespace](../../../cloud-map/latest/api/api-createpublicdnsnamespace.md) in the _AWS Cloud Map API Reference_
