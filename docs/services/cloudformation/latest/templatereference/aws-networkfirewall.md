...
- [AWS::NetworkFirewall::TLSInspectionConfiguration](aws-resource-networkfirewall-tlsinspectionconfiguration.md)

- [AWS::NetworkFirewall::VpcEndpointAssociation](aws-resource-networkfirewall-vpcendpointassociation.md)
