...
see [CacheBehaviors](../../../../reference/cloudfront/latest/apireference/api-cachebehaviors.md).
...
request policy instead of this field. For more information, see [Working with policies](../../../amazoncloudfront/latest/developerguide/working-with-policies.md) in the
_Amazon CloudFront Developer Guide_.
...
- [CacheBehavior](../../../../reference/cloudfront/latest/apireference/api-cachebehavior.md) in the _Amazon CloudFront API Reference_
