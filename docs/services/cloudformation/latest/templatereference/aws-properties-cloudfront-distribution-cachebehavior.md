...
you can add to a distribution, see [Quotas](../../../amazoncloudfront/latest/developerguide/cloudfront-limits.md) in the
...
For more information about cache behaviors, see [Cache Behavior Settings](../../../amazoncloudfront/latest/developerguide/distribution-web-values-specify.md#DownloadDistValuesCacheBehavior) in the _Amazon CloudFront Developer Guide_.
...
more information, see [Creating cache policies](../../../amazoncloudfront/latest/developerguide/controlling-the-cache-key.md#cache-key-create-cache-policy) or [Using the managed cache policies](../../../amazoncloudfront/latest/developerguide/using-managed-cache-policies.md) in the
_Amazon CloudFront Developer Guide_.
...
_Type_: [ForwardedValues](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-cloudfront-distribution-forwardedvalues.html)
...
_Type_: Array of [FunctionAssociation](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-cloudfront-distribution-functionassociation.html)
...
_Type_: [GrpcConfig](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-cloudfront-distribution-grpcconfig.html)
...
_Type_: Array of [LambdaFunctionAssociation](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-cloudfront-distribution-lambdafunctionassociation.html)
...
Content Stays in an Edge Cache (Expiration)](../../../amazoncloudfront/latest/developerguide/expiration.md) in the _Amazon CloudFront Developer Guide_.
...
For more information, see [Path Pattern](../../../amazoncloudfront/latest/developerguide/distribution-web-values-specify.md#DownloadDistValuesPathPattern) in the _Amazon CloudFront Developer Guide_.
