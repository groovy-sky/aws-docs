---
title: "AWS::ServiceDiscovery::Service"
---
...
about shared namespaces, see [Cross-account AWS Cloud Map namespace sharing](../../../cloud-map/latest/dg/sharing-namespaces.md) in the
...
_Type_: Array of [Tag](aws-properties-servicediscovery-service-tag.md)
...
- [CreateService](../../../cloud-map/latest/api/api-createservice.md) in the _AWS Cloud Map API Reference_
