...
events that match the pattern you specify here. For more information, see [Filter and Pattern Syntax](../../../amazoncloudwatch/latest/logs/filterandpatternsyntax.md).
...
IAM policy, see [Use a AWS KMS key with an anomaly detector](../../../amazoncloudwatch/latest/logs/logsanomalydetection-kms.md).
