...
_Type_: [RecurrenceRule](aws-properties-applicationsignals-servicelevelobjective-recurrencerule.md)
...
_Type_: [Window](aws-properties-applicationsignals-servicelevelobjective-window.md)
