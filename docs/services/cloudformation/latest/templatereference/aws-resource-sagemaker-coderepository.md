---
title: "AWS::SageMaker::CodeRepository"
---
...
The repository can be hosted either in [AWS CodeCommit](../../../codecommit/latest/userguide/welcome.md)
...
_Type_: Array of [Tag](aws-properties-sagemaker-coderepository-tag.md)
