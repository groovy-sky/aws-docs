...
GuardDuty findings to Amazon S3 buckets](../../../guardduty/latest/ug/guardduty-exportfindings.md) in the _Amazon GuardDuty User Guide_.
...
_Type_: [CFNDestinationProperties](aws-properties-guardduty-publishingdestination-cfndestinationproperties.md)
...
_Type_: Array of [TagItem](aws-properties-guardduty-publishingdestination-tagitem.md)
