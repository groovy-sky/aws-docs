...
For more information about access entries, see [Access entries](../../../eks/latest/userguide/access-entries.md) in the
...
_Type_: Array of [AccessPolicy](aws-properties-eks-accessentry-accesspolicy.md)
...
[IAM best\
practices](../../../iam/latest/userguide/best-practices.md#bp-users-federation-idp) recommend using IAM roles with temporary credentials, rather
...
_Type_: Array of [Tag](aws-properties-eks-accessentry-tag.md)
...
access entries](../../../eks/latest/userguide/access-entries.md#creating-access-entries) in the _Amazon EKS User Guide_.
...
- [Access entries](../../../eks/latest/userguide/access-entries.md) in the _Amazon EKS User Guide_.

- [`CreateAccessEntry`](../../../../reference/eks/latest/apireference/api-createaccessentry.md) in the _Amazon EKS API Reference_.
