...
The version of Apache Kafka. You can use Amazon MSK to create clusters that use [supported Apache Kafka versions](../../../msk/latest/developerguide/supported-kafka-versions.md).
...
_Type_: [Rebalancing](aws-properties-msk-cluster-rebalancing.md)
