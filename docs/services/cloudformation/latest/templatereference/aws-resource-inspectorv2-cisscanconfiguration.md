...
_Type_: [Schedule](aws-properties-inspectorv2-cisscanconfiguration-schedule.md)
...
_Type_: [CisTargets](aws-properties-inspectorv2-cisscanconfiguration-cistargets.md)
