...
_Type_: Array of [BlockDeviceMapping](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-blockdevicemapping.html)
...
_Type_: [CapacityReservationSpecification](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-capacityreservationspecification.html)
...
options for Amazon EC2 instances](../../../ec2/latest/userguide/instance-optimize-cpu.md) in the
_Amazon EC2 User Guide_.

_Required_: No

_Type_: [CpuOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-cpuoptions.html)
...
_Type_: [CreditSpecification](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-creditspecification.html)
...
see [Enable stop protection for your EC2 instances](../../../ec2/latest/userguide/ec2-stop-protection.md) in the
_Amazon EC2 User Guide_.
...
_Type_: [EnclaveOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-enclaveoptions.html)
...
prerequisites](../../../ec2/latest/userguide/hibernating-prerequisites.md). For more information, see [Hibernate your Amazon EC2 instance](../../../ec2/latest/userguide/hibernate.md)
in the _Amazon EC2 User Guide_.

_Required_: No

_Type_: [HibernationOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-hibernationoptions.html)
...
_Type_: [IamInstanceProfile](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-iaminstanceprofile.html)
...
For more information, see [Use a Systems Manager parameter to find an AMI](../../../ec2/latest/userguide/finding-an-ami.md#using-systems-manager-parameter-to-find-AMI) in the _Amazon Elastic Compute Cloud User Guide_.
...
_Type_: [InstanceMarketOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-instancemarketoptions.html)
...
_Type_: [InstanceRequirements](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-instancerequirements.html)

_Update requires_: [No interruption](../userguide/using-cfn-updating-stacks-update-behaviors.md#update-no-interrupt)

`InstanceType`

The instance type. For more information, see [Amazon EC2 instance types](../../../ec2/latest/userguide/instance-types.md) in
...
The name of the key pair. You can create a key pair using [CreateKeyPair](../../../../reference/awsec2/latest/apireference/api-createkeypair.md) or
[ImportKeyPair](../../../../reference/awsec2/latest/apireference/api-importkeypair.md).
...
_Type_: Array of [LicenseSpecification](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-licensespecification.html)
...
_Type_: [MaintenanceOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-maintenanceoptions.html)
...
the Instance Metadata Service options](../../../ec2/latest/userguide/configuring-instance-metadata-options.md) in the
_Amazon EC2 User Guide_.

_Required_: No

_Type_: [MetadataOptions](aws-properties-ec2-launchtemplate-metadataoptions.md)
...
_Type_: [Monitoring](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-monitoring.html)
...
_Type_: Array of [NetworkInterface](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-networkinterface.html)
...
[EC2 instance bandwidth weighting configuration](../../../ec2/latest/userguide/configure-bandwidth-weighting.md).

_Required_: No

_Type_: [NetworkPerformanceOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-networkperformanceoptions.html)
...
_Type_: [Placement](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-placement.html)
...
_Type_: [PrivateDnsNameOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-privatednsnameoptions.html)
...
_Type_: Array of [TagSpecification](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ec2-launchtemplate-tagspecification.html)
...
instance with user data input](../../../ec2/latest/userguide/user-data.md) in the
_Amazon EC2 User Guide_.
...
- [RequestLaunchTemplateData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RequestLaunchTemplateData.html) in the _Amazon EC2 API_
_Reference_
