---
title: "AWS::EC2::LaunchTemplate LaunchTemplateData"
---
...
_Type_: Array of [BlockDeviceMapping](aws-properties-ec2-launchtemplate-blockdevicemapping.md)
...
_Type_: [CapacityReservationSpecification](aws-properties-ec2-launchtemplate-capacityreservationspecification.md)
...
_Type_: [CpuOptions](aws-properties-ec2-launchtemplate-cpuoptions.md)
...
_Type_: [CreditSpecification](aws-properties-ec2-launchtemplate-creditspecification.md)
...
information, see [What is Nitro Enclaves?](../../../enclaves/latest/user/nitro-enclave.md) in the
...
_Type_: [EnclaveOptions](aws-properties-ec2-launchtemplate-enclaveoptions.md)
...
_Type_: [HibernationOptions](aws-properties-ec2-launchtemplate-hibernationoptions.md)
...
_Type_: [IamInstanceProfile](aws-properties-ec2-launchtemplate-iaminstanceprofile.md)
...
_Type_: [InstanceMarketOptions](aws-properties-ec2-launchtemplate-instancemarketoptions.md)
...
[AWS::EC2::Instance](../userguide/aws-properties-ec2-instance.md) AWS CloudFormation resource, you can't specify `InstanceRequirements`.
...
_Type_: [InstanceRequirements](aws-properties-ec2-launchtemplate-instancerequirements.md)
...
information, see [User Provided Kernels](../../../ec2/latest/userguide/userprovidedkernels.md) in
the _Amazon EC2 User Guide_.
...
_Type_: Array of [LicenseSpecification](aws-properties-ec2-launchtemplate-licensespecification.md)
...
_Type_: [MaintenanceOptions](aws-properties-ec2-launchtemplate-maintenanceoptions.md)
...
_Type_: [Monitoring](aws-properties-ec2-launchtemplate-monitoring.md)
...
_Type_: Array of [NetworkInterface](aws-properties-ec2-launchtemplate-networkinterface.md)
...
_Type_: [NetworkPerformanceOptions](aws-properties-ec2-launchtemplate-networkperformanceoptions.md)
...
_Type_: [Placement](aws-properties-ec2-launchtemplate-placement.md)
...
_Type_: [PrivateDnsNameOptions](aws-properties-ec2-launchtemplate-privatednsnameoptions.md)
...
To tag the launch template itself, use [TagSpecifications](../userguide/aws-resource-ec2-launchtemplate.md#cfn-ec2-launchtemplate-tagspecifications).

_Required_: No

_Type_: Array of [TagSpecification](aws-properties-ec2-launchtemplate-tagspecification.md)
...
data must be provided in the [MIME multi-part archive format](https://cloudinit.readthedocs.io/en/latest/topics/format.html). For more information, see [Amazon EC2 user data in launch templates](../../../batch/latest/userguide/launch-templates.md#lt-user-data) in the
...
- [RequestLaunchTemplateData](../../../../reference/awsec2/latest/apireference/api-requestlaunchtemplatedata.md) in the _Amazon EC2 API_
_Reference_
