...
_Type_: Array of [Destination](aws-properties-cloudtrail-channel-destination.md)
...
events, or the name of a partner event source. For information about the source names for available partners, see [Additional information about integration partners](../../../awscloudtrail/latest/userguide/query-event-data-store-integration.md#cloudtrail-lake-partner-information) in the CloudTrail User Guide.
...
_Type_: Array of [Tag](aws-properties-cloudtrail-channel-tag.md)
...
CloudTrail Lake integrations, see [Create an integration with an event source outside of AWS](../../../awscloudtrail/latest/userguide/query-event-data-store-integration.md)
