---
title: "AWS::Greengrass::SubscriptionDefinitionVersion Subscription"
---
...
In an CloudFormation template, the `Subscriptions` property of the [`AWS::Greengrass::SubscriptionDefinitionVersion`](../userguide/aws-resource-greengrass-subscriptiondefinitionversion.md) resource contains a list of `Subscription` property types.
