...
_Type_: Array of [Dependency](aws-properties-synthetics-canary-dependency.md)
...
The Amazon S3 key of your script. For more information, see [Working with Amazon S3 Objects](../../../s3/latest/dev/usingobjects.md).
