...
the [Logging data events](../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md), [Logging network activity events](../../../awscloudtrail/latest/userguide/logging-network-events-with-cloudtrail.md), and [Logging management events](../../../awscloudtrail/latest/userguide/logging-management-events-with-cloudtrail.md) topics in the _AWS CloudTrail User Guide_.
...
_Type_: Array of [AdvancedFieldSelector](aws-properties-cloudtrail-eventdatastore-advancedfieldselector.md)
