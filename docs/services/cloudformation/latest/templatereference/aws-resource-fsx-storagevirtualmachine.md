---
title: "AWS::FSx::StorageVirtualMachine"
---
...
[Volume security style](../../../fsx/latest/ontapguide/volume-security-style.md)
...
[Managing SVMs using the NetApp ONTAP CLI](../../../fsx/latest/ontapguide/managing-resources-ontap-apps.md#vsadmin-ontap-cli) in the _FSx for ONTAP User Guide_.
...
_Type_: Array of [Tag](aws-properties-fsx-storagevirtualmachine-tag.md)
