...
```
{
  ...
  "Properties" : {
      ...
      "[GlobalClusterIdentifier](#cfn-neptune-dbcluster-globalclusteridentifier)" : {{String}},
      "[IamAuthEnabled](#cfn-neptune-dbcluster-iamauthenabled)" : {{Boolean}},
      "[KmsKeyId](#cfn-neptune-dbcluster-kmskeyid)" : {{String}},
      "[NetworkType](#cfn-neptune-dbcluster-networktype)" : {{String}},
...
`GlobalClusterIdentifier`  <a name="cfn-neptune-dbcluster-globalclusteridentifier"></a>
The ID of the Neptune global database to which this new DB cluster should be added. Neptune global databases are supported in [select regions.](https://docs.aws.amazon.com/neptune/latest/userguide/neptune-global-database.html#neptune-gdb-limitations)
*Required*: No
*Type*: String
...
`NetworkType`  <a name="cfn-neptune-dbcluster-networktype"></a>
The network type of the DB cluster.
Valid values:
+ `IPV4` – The network type is IPv4 only.
+ `DUAL` – The network type is dual-stack. The DB cluster supports both IPv4 and IPv6 addressing.
The network type is determined by the `DBSubnetGroup` specified for the DB cluster. A `DBSubnetGroup` can support only the IPv4 protocol or the IPv4 and IPv6 protocols (`DUAL`).
For more information, see [Working with a DB cluster in a VPC](https://docs.aws.amazon.com/neptune/latest/userguide/neptune-dualstack-db-cluster.html) in the *Amazon Neptune User Guide.*
*Required*: No
*Type*: String
