...
For more information, see [Requirements for EBS volume modifications](../../../ebs/latest/userguide/modify-volume-requirements.md).
...
volume, or to create a snapshot of the volume. For more information, see [DeletionPolicy attribute](../userguide/aws-attribute-deletionpolicy.md).
...
and whether encryption by default is enabled. For more information, see [Encryption by default](../../../ebs/latest/userguide/work-with-ebs-encr.md#encryption-by-default) in the
...
[Instances built on the Nitro System](../../../ec2/latest/instancetypes/ec2-nitro-instances.md) can support up to 256,000 IOPS. Other instances can support up to 32,000
IOPS.
