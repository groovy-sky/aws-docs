---
title: "AWS::MediaLive::Channel Av1Settings"
---
...
The `Av1Settings` property type specifies Property description not available. for an [AWS::MediaLive::Channel](aws-resource-medialive-channel.md).
...
_Type_: [Av1ColorSpaceSettings](aws-properties-medialive-channel-av1colorspacesettings.md)
