...
This parameter must be set when using r6gd nodes. For more information, see [Data tiering](../../../memorydb/latest/devguide/data-tiering.md).
...
_Type_: Array of [Tag](aws-properties-memorydb-cluster-tag.md)
