...
_Type_: Array of [Tag](aws-properties-frauddetector-entitytype-tag.md)
...
- [PutEntityType](../../../frauddetector/latest/api/api-putentitytype.md) in the _Amazon Fraud Detector API Reference_

- [Create an entity type](../../../frauddetector/latest/ug/create-an-entity-type.md) in the _Amazon Fraud Detector User Guide_
