---
title: "AWS::ApiGatewayV2::ApiGatewayManagedOverrides RouteOverrides"
---
...
The authorization type for the route. To learn more, see [AuthorizationType](../userguide/aws-resource-apigatewayv2-route.md#cfn-apigatewayv2-route-authorizationtype).
