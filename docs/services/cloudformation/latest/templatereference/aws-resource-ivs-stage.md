...
The `AWS::IVS::Stage` resource specifies an Amazon IVS stage. A stage is a virtual space where participants can exchange video in real time. For more information, see [CreateStage](../../../../reference/ivs/latest/realtimeapireference/api-createstage.md) in the
...
_Type_: [AutoParticipantRecordingConfiguration](aws-properties-ivs-stage-autoparticipantrecordingconfiguration.md)
...
For more information, see [Tag](../userguide/aws-properties-ivs-stage-tag.md).

_Required_: No

_Type_: Array of [Tag](aws-properties-ivs-stage-tag.md)
...
- [Stage](../../../../reference/ivs/latest/realtimeapireference/api-stage.md) data
type

- [CreateStage](../../../../reference/ivs/latest/realtimeapireference/api-createstage.md) API endpoint
