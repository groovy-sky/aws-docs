...
_Type_: Array of [IPSetDescriptor](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-waf-ipset-ipsetdescriptor.html)
...
- [Define IP Addresses](#aws-resource-waf-ipset--examples--Define_IP_Addresses)

- [Associate an IPSet with a Web ACL Rule](#aws-resource-waf-ipset--examples--Associate_an_IPSet_with_a_Web_ACL_Rule)

- [Create a Web ACL](#aws-resource-waf-ipset--examples--Create_a_Web_ACL)
...
The following example associates the `MyIPSetDenylist` IP Set with a web
ACL rule.
