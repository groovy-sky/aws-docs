---
title: "AWS::CloudFront::Distribution ForwardedValues"
---
...
- [ForwardedValues](../../../../reference/cloudfront/latest/apireference/api-forwardedvalues.md) in the _Amazon CloudFront API Reference_
