...
To review the Lambda trigger types that Amazon Cognito invokes at runtime with API requests, see [Connecting API actions to Lambda triggers](../../../cognito/latest/developerguide/cognito-user-pools-working-with-lambda-triggers.md#lambda-triggers-by-event) in the _Amazon Cognito Developer Guide_.
...
_Type_: Array of [AttributeType](aws-properties-cognito-userpooluser-attributetype.md)
...
information, see [Customizing sign-in attributes](../../../cognito/latest/developerguide/user-pool-settings-attributes.md#user-pool-settings-aliases).
...
For more information about the pre sign-up Lambda trigger, see [Pre sign-up Lambda trigger](../../../cognito/latest/developerguide/user-pool-lambda-pre-sign-up.md).
