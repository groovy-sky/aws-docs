---
title: "AWS::Config::ConfigurationRecorder"
---
...
For more information, see [AWS::Config::DeliveryChannel](../userguide/aws-resource-config-deliverychannel.md).
...
call the [StopConfigurationRecorder](../../../../reference/config/latest/apireference/api-stopconfigurationrecorder.md) action of the AWS Config API directly.

For more information, see [Configuration Recorder](../../../config/latest/developerguide/config-concepts.md#config-recorder) in the AWS Config Developer Guide.
...
For more information, see [Permissions for the IAM Role Assigned](../../../config/latest/developerguide/iamrole-permissions.md) to AWS Config in the AWS Config Developer Guide.
...
see [**Identity and Access Management for AWS Config**](../../../config/latest/developerguide/security-iam.md) in the _AWS Config Developer Guide_.
