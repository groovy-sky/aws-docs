...
_Type_: [EFSFileSystemConfig](aws-properties-sagemaker-domain-efsfilesystemconfig.md)
...
_Type_: [FSxLustreFileSystemConfig](aws-properties-sagemaker-domain-fsxlustrefilesystemconfig.md)
...
_Type_: [S3FileSystemConfig](aws-properties-sagemaker-domain-s3filesystemconfig.md)
