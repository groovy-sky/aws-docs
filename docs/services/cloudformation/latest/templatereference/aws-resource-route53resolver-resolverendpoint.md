...
_Type_: Array of [IpAddressRequest](aws-properties-route53resolver-resolverendpoint-ipaddressrequest.md)
...
_Type_: Array of [Tag](aws-properties-route53resolver-resolverendpoint-tag.md)
...
- [ResolverEndpoint](../../../../reference/route53/latest/apireference/api-route53resolver-resolverendpoint.md)
