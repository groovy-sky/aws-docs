...
see [Use Notebook Instances](../../../sagemaker/latest/dg/nbi.md).
...
one instance type can be associated with a notebook instance. For more information, see [Using Elastic Inference in Amazon SageMaker](../../../sagemaker/latest/dg/ei.md).
...
URL of Git repositories in [AWS CodeCommit](../../../codecommit/latest/userguide/welcome.md)
or in any other Git repository. These repositories are cloned at the same level as the
default repository of your notebook instance. For more information, see [Associating Git\
Repositories with SageMaker AI Notebook Instances](../../../sagemaker/latest/dg/nbi-git-repo.md).
...
account, or the URL of a Git repository in [AWS CodeCommit](../../../codecommit/latest/userguide/welcome.md)
...
For more information, see [Notebook Instances Are Internet-Enabled by Default](../../../sagemaker/latest/dg/appendix-additional-considerations.md#appendix-notebook-and-internet-access). You can set the value
...
Notebook Instance](../../../sagemaker/latest/dg/notebook-lifecycle-config.md) in the _Amazon SageMaker Developer Guide_.
...
permissions to assume this role. For more information, see [SageMaker AI Roles](../../../sagemaker/latest/dg/sagemaker-roles.md).
...
_Type_: Array of [Tag](aws-properties-sagemaker-notebookinstance-tag.md)
