...
[Linking your file system to an S3 bucket](../../../fsx/latest/lustreguide/create-dra-linked-data-repo.md).
...
_Type_: Array of [Tag](aws-properties-fsx-datarepositoryassociation-tag.md)
