---
title: "AWS::WAFv2::RuleGroup JA4Fingerprint"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::WAFv2::RuleGroup JA4Fingerprint
<a name="aws-properties-wafv2-rulegroup-ja4fingerprint"></a>
...
## Syntax
<a name="aws-properties-wafv2-rulegroup-ja4fingerprint-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-wafv2-rulegroup-ja4fingerprint-syntax.json"></a>

```
{
  "[FallbackBehavior](#cfn-wafv2-rulegroup-ja4fingerprint-fallbackbehavior)" : {{String}}
}
```

### YAML
<a name="aws-properties-wafv2-rulegroup-ja4fingerprint-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-wafv2-rulegroup-ja4fingerprint-properties"></a>

`FallbackBehavior`  <a name="cfn-wafv2-rulegroup-ja4fingerprint-fallbackbehavior"></a>
