---
title: "AWS::EKS::Nodegroup ScalingConfig"
---
...
Autoscaler](https://github.com/kubernetes/autoscaler), you shouldn't change the `desiredSize` value
...
quotas](../../../eks/latest/userguide/service-quotas.md) in the _Amazon EKS User Guide_.
