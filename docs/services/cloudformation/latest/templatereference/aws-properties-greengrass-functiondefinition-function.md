---
title: "AWS::Greengrass::FunctionDefinition Function"
---
...
In an CloudFormation template, the `Functions` property of the [`FunctionDefinitionVersion`](../userguide/aws-properties-greengrass-functiondefinition-functiondefinitionversion.md) property type contains a list of `Function` property types.
