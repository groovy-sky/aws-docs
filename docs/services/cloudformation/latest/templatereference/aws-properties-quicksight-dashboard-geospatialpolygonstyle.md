---
title: "AWS::QuickSight::Dashboard GeospatialPolygonStyle"
---
...
_Type_: [GeospatialPolygonSymbolStyle](aws-properties-quicksight-dashboard-geospatialpolygonsymbolstyle.md)
