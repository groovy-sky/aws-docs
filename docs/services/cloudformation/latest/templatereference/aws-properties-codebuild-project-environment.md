---
title: "AWS::CodeBuild::Project Environment"
---
...
`Environment` is a property of the [AWS::CodeBuild::Project](../userguide/aws-resource-codebuild-project.md) resource that specifies
...
certificate for the build project. For more information, see [certificate](../../../codebuild/latest/userguide/create-project-cli.md#cli.environment.certificate) in the
...
_Type_: Array of [EnvironmentVariable](aws-properties-codebuild-project-environmentvariable.md)
...
_Type_: [ProjectFleet](aws-properties-codebuild-project-projectfleet.md)
...
For more information, see [Docker images provided by CodeBuild](../../../codebuild/latest/userguide/build-env-ref-available.md) in the _AWS CodeBuild user_
_guide_.
...
`RegistryCredential` is a property of the [AWS::CodeBuild::Project Environment](../userguide/aws-resource-codebuild-project.md#cfn-codebuild-project-environment) property that specifies information about credentials that provide access to a private Docker registry. When this is set:
...
_Type_: [RegistryCredential](aws-properties-codebuild-project-registrycredential.md)
