---
title: "AWS::KinesisAnalytics::Application"
---
...
The `AWS::KinesisAnalytics::Application` resource creates an Amazon Kinesis Data Analytics application. For more information, see the [Amazon Kinesis Data Analytics Developer Guide](../../../kinesisanalytics/latest/dev/what-is.md).
...
Code](../../../kinesisanalytics/latest/dev/how-it-works-app-code.md).
...
_Type_: Array of [Input](aws-properties-kinesisanalytics-application-input.md)
