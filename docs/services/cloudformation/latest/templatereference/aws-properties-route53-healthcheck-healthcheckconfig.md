...
_Type_: [AlarmIdentifier](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-route53-healthcheck-alarmidentifier.html)
...
versa. For more information, see [How Amazon Route 53 Determines Whether an Endpoint Is Healthy](../../../route53/latest/developerguide/dns-failover-determining-health-of-endpoints.md) in the
...
to associate with a `CALCULATED` health check, use the [ChildHealthChecks](../../../../reference/route53/latest/apireference/api-updatehealthcheck.md#Route53-UpdateHealthCheck-request-ChildHealthChecks) element.
...
For more information, see [FullyQualifiedDomainName](../../../../reference/route53/latest/apireference/api-updatehealthcheck.md#Route53-UpdateHealthCheck-request-FullyQualifiedDomainName).
...
more information, see [High-Resolution Metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/publishingMetrics.html#high-resolution-metrics) in the _Amazon CloudWatch User_
_Guide_.
...
For more information, see [How Route 53 Determines Whether an Endpoint Is Healthy](../../../route53/latest/developerguide/dns-failover-determining-health-of-endpoints.md) in the
_Amazon Route 53 Developer Guide_.
...
- [Return values](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53-healthcheck.html#aws-resource-route53-healthcheck-return-values)
in the topic
...
- [HealthCheckConfig](https://docs.aws.amazon.com/Route53/latest/APIReference/API_HealthCheckConfig.html) in the _Amazon Route 53 API Reference_
