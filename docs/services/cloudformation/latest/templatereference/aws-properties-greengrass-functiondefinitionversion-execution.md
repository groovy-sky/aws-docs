---
title: "AWS::Greengrass::FunctionDefinitionVersion Execution"
---
...
In an
CloudFormation template, `Execution` is a property of the [`DefaultConfig`](../userguide/aws-properties-greengrass-functiondefinitionversion-defaultconfig.md) property type for a function definition version and the [`Environment`](../userguide/aws-properties-greengrass-functiondefinitionversion-environment.md) property type for a function.
...
_Type_: [RunAs](aws-properties-greengrass-functiondefinitionversion-runas.md)
