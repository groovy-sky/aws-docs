...
Creates a new identity source. For more information, see [Identity Source](../../../mpa/latest/userguide/mpa-concepts.md) in the _Multi-party approval User Guide_.
...
_Type_: [IdentitySourceParameters](aws-properties-mpa-identitysource-identitysourceparameters.md)
...
_Type_: Array of [Tag](aws-properties-mpa-identitysource-tag.md)
