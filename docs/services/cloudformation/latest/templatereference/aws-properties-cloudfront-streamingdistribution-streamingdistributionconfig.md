---
title: "AWS::CloudFront::StreamingDistribution StreamingDistributionConfig"
---
...
- [StreamingDistributionConfig](../../../../reference/cloudfront/latest/apireference/api-streamingdistributionconfig.md) in the _Amazon CloudFront API Reference_
