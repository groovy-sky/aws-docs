---
title: "AWS::Greengrass::DeviceDefinitionVersion Device"
---
...
In an CloudFormation template, the `Devices` property of the [`AWS::Greengrass::DeviceDefinitionVersion`](../userguide/aws-resource-greengrass-devicedefinitionversion.md) resource contains a list of `Device` property types.
