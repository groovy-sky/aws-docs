...
[Working with parameter groups](../../../amazonrds/latest/userguide/user-workingwithparamgroups.md)
...
parameter groups](../../../amazonrds/latest/userguide/user-workingwithparamgroups.md) in the _Amazon RDS User Guide_, or [Working\
with parameter groups](../../../amazonrds/latest/aurorauserguide/user-workingwithparamgroups.md) in the
...
_Type_: Array of [Tag](aws-properties-rds-dbparametergroup-tag.md)
