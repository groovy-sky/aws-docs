...
- [Configuring a Dynamo DB stream as an event source](../../../lambda/latest/dg/with-ddb.md#services-dynamodb-eventsourcemapping)

- [Configuring a Kinesis stream as an event source](../../../lambda/latest/dg/with-kinesis.md#services-kinesis-eventsourcemapping)

- [Configuring an SQS queue as an event source](../../../lambda/latest/dg/with-sqs.md#events-sqs-eventsource)

- [Configuring an MQ broker as an event source](../../../lambda/latest/dg/with-mq.md#services-mq-eventsourcemapping)

- [Configuring MSK as an event source](../../../lambda/latest/dg/with-msk.md)

- [Configuring Self-Managed Apache Kafka as an event source](../../../lambda/latest/dg/kafka-smaa.md)

- [Configuring Amazon DocumentDB as an event source](../../../lambda/latest/dg/with-documentdb.md)
...
- **Amazon Managed Streaming for Apache Kafka** – The ARN of the cluster or the ARN of the VPC connection (for [cross-account event source mappings](../../../lambda/latest/dg/with-msk.md#msk-multi-vpc)).
...
determine whether Lambda should process an event. For more information, see [Lambda event filtering](../../../lambda/latest/dg/invocation-eventfiltering.md).
...
uses to encrypt your function's [filter criteria](../../../lambda/latest/dg/invocation-eventfiltering.md#filtering-basics).
...
(Amazon MSK, and self-managed Apache Kafka only) The logging configuration for your event source. For more information, see [Event source mapping logging](../../../lambda/latest/dg/esm-logging.md).

_Required_: No

_Type_: [LoggingConfig](aws-properties-lambda-eventsourcemapping-loggingconfig.md)
...
The metrics configuration for your event source. For more information, see [Event source mapping metrics](../../../lambda/latest/dg/monitoring-metrics-types.md#event-source-mapping-metrics).

_Required_: No

_Type_: [MetricsConfig](aws-properties-lambda-eventsourcemapping-metricsconfig.md)
...
For more information, see [provisioned mode](../../../lambda/latest/dg/invocation-eventsourcemapping.md#invocation-eventsourcemapping-provisioned-mode).

_Required_: No

_Type_: [ProvisionedPollerConfig](aws-properties-lambda-eventsourcemapping-provisionedpollerconfig.md)
...
_Type_: Array of [SourceAccessConfiguration](aws-properties-lambda-eventsourcemapping-sourceaccessconfiguration.md)
...
_Type_: Array of [Tag](aws-properties-lambda-eventsourcemapping-tag.md)
