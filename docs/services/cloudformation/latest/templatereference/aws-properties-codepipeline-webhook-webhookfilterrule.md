...
action configuration properties for built-in action types, see [Pipeline Structure Reference Action Requirements](../../../codepipeline/latest/userguide/reference-pipeline-structure.md#action-requirements).
