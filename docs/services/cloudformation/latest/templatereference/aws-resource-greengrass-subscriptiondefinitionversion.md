---
title: "AWS::Greengrass::SubscriptionDefinitionVersion"
---
...
about creating a subscription definition, see [`AWS::Greengrass::SubscriptionDefinition`](../userguide/aws-resource-greengrass-subscriptiondefinition.md).
...
_Type_: Array of [Subscription](aws-properties-greengrass-subscriptiondefinitionversion-subscription.md)
...
- [CreateSubscriptionDefinitionVersion](../../../../reference/greengrass/v1/apireference/createsubscriptiondefinitionversion-post.md) in the _AWS IoT Greengrass Version 1 API Reference_
