...
instance family is `c6i`, not `c6`. For more information, see [Amazon EC2 instance type naming conventions](../../../ec2/latest/instancetypes/instance-type-names.md) in
_Amazon EC2 Instance Types_.
