...
see [Quick\
Start](../../../appsync/latest/devguide/quickstart.md) in the _AWS AppSync Developer_
_Guide_.
...
_Type_: Array of [AdditionalAuthenticationProvider](aws-properties-appsync-graphqlapi-additionalauthenticationprovider.md)
...
`OPENID_CONNECT`, or `AWS_LAMBDA`), see [Security](../../../appsync/latest/devguide/security.md) in
...
logging](../../../appsync/latest/devguide/monitoring.md#cw-metrics) in the _AWS AppSync User Guide_.

_Required_: No

_Type_: [EnhancedMetricsConfig](aws-properties-appsync-graphqlapi-enhancedmetricsconfig.md)
...
variables](../../../appsync/latest/devguide/environmental-variables.md).
...
_Type_: Array of [Tag](aws-properties-appsync-graphqlapi-tag.md)
...
The GraphQL API real-time endpoint URL. For more information, see [Discovering the real-time endpoint from the GraphQL endpoint](../../../appsync/latest/devguide/real-time-websocket-client.md#handshake-details-to-establish-the-websocket-connection).
...
- [CreateGraphqlApi](../../../../reference/appsync/latest/apireference/api-creategraphqlapi.md) operation in the _AWS AppSync API Reference_.
