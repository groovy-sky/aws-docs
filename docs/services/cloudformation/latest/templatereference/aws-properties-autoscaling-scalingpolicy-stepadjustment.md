...
adjustments](https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-scaling-simple-step.html#as-scaling-steps) in the _Amazon EC2 Auto Scaling User Guide_.
