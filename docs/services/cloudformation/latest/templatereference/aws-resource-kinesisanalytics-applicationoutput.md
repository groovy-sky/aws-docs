---
title: "AWS::KinesisAnalytics::ApplicationOutput"
---
...
Output (Destination)](../../../kinesisanalytics/latest/dev/how-it-works-output.md).
...
you can configure, see [Limits](../../../kinesisanalytics/latest/dev/limits.md).
