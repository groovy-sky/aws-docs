---
title: "AWS::S3::Bucket ServerSideEncryptionByDefault"
---
...
information, see [PutBucketEncryption](../../../s3/latest/api/restbucketputencryption.md).
...
encryption for cross-account operations](../../../s3/latest/dev/bucket-encryption.md#bucket-encryption-update-bucket-policy).
...
server-side encryption with S3-managed keys (SSE-S3) by modifying the [Amazon S3 Bucket ServerSideEncryptionByDefault](../userguide/aws-properties-s3-bucket-serversideencryptionbydefault.md) property to specify
