...
corresponding private key. For more information, see [Setting Up Private Channels](../../../ivs/latest/lowlatencyuserguide/private-channels.md)
...
For more information, see [Tag](../userguide/aws-properties-ivs-playbackkeypair-tag.md).

_Required_: No

_Type_: Array of [Tag](aws-properties-ivs-playbackkeypair-tag.md)
...
- [Setting Up Private\
Channels](../../../ivs/latest/lowlatencyuserguide/private-channels.md)

- [PlaybackKeyPair](../../../../reference/ivs/latest/lowlatencyapireference/api-playbackkeypair.md) data type

- [ImportPlaybackKeyPair](../../../../reference/ivs/latest/lowlatencyapireference/api-importplaybackkeypair.md) API endpoint
