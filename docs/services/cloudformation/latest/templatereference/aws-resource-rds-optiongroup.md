...
_Type_: Array of [OptionConfiguration](aws-properties-rds-optiongroup-optionconfiguration.md)
...
_Type_: Array of [Tag](aws-properties-rds-optiongroup-tag.md)
...
options, see [Adding options to Oracle DB instances](../../../amazonrds/latest/userguide/appendix-oracle-options.md)
...
[MySQL\
memcached support](../../../amazonrds/latest/userguide/appendix-mysql-options-memcached.md) in the _Amazon RDS User_
_Guide_.
...
[Support for Native Backup and Restore in SQL Server](../../../amazonrds/latest/userguide/appendix-sqlserver-options-backuprestore.md) in the
