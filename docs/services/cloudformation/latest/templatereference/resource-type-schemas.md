...
In addition to the resource specification, CloudFormation makes available the resource provider schemas for the AWS resources by Region. Each resource provider schema is a JSON-formatted text file that defines the properties and attributes of a specific resource.
...
| Asia Pacific (Malaysia) | [`ap-southeast-5`](https://schema.cloudformation.ap-southeast-5.amazonaws.com/CloudformationSchema.zip) |
| Asia Pacific (Melbourne) | [`ap-southeast-4`](https://schema.cloudformation.ap-southeast-4.amazonaws.com/CloudformationSchema.zip) |
| Asia Pacific (Taipei) | [`ap-east-2`](https://schema.cloudformation.ap-east-2.amazonaws.com/CloudformationSchema.zip) |
| Asia Pacific (Thailand) | [`ap-southeast-7`](https://schema.cloudformation.ap-southeast-7.amazonaws.com/CloudformationSchema.zip) |
...
| Canada West (Calgary) | [`ca-west-1`](https://schema.cloudformation.ca-west-1.amazonaws.com/CloudformationSchema.zip) |
...
| Israel (Tel Aviv) | [`il-central-1`](https://schema.cloudformation.il-central-1.amazonaws.com/CloudformationSchema.zip) |
| Middle East (Bahrain) | [`me-south-1`](https://schema.cloudformation.me-south-1.amazonaws.com/CloudformationSchema.zip) |
| Middle East (UAE) | [`me-central-1`](https://schema.cloudformation.me-central-1.amazonaws.com/CloudformationSchema.zip) |
| Mexico (Central) | [`mx-central-1`](https://schema.cloudformation.mx-central-1.amazonaws.com/CloudformationSchema.zip) |
