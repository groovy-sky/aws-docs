---
title: "AWS::IoTEvents::AlarmModel Sqs"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::IoTEvents::AlarmModel Sqs
<a name="aws-properties-iotevents-alarmmodel-sqs"></a>

Sends information about the detector model instance and the event that triggered the action to an Amazon SQS queue.

## Syntax
<a name="aws-properties-iotevents-alarmmodel-sqs-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-iotevents-alarmmodel-sqs-syntax.json"></a>
...
### YAML
<a name="aws-properties-iotevents-alarmmodel-sqs-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-iotevents-alarmmodel-sqs-properties"></a>
