...
```
{
  ...
  "Properties" : {
      ...
      "[AutomatedSnapshotPauseOptions](#cfn-opensearchservice-domain-automatedsnapshotpauseoptions)" : {{AutomatedSnapshotPauseOptions}},
...
Properties:
  ...
  [AIMLOptions](#cfn-opensearchservice-domain-aimloptions): {{
    AIMLOptions}}
  [AutomatedSnapshotPauseOptions](#cfn-opensearchservice-domain-automatedsnapshotpauseoptions): {{
...
`AutomatedSnapshotPauseOptions`  <a name="cfn-opensearchservice-domain-automatedsnapshotpauseoptions"></a>
The current status of the domain's automated snapshot pause options.
*Required*: No
*Type*: [AutomatedSnapshotPauseOptions](aws-properties-opensearchservice-domain-automatedsnapshotpauseoptions.md)
*Update requires*: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
