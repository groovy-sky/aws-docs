---
title: "Alexa::ASK::Skill SkillPackage"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# Alexa::ASK::Skill SkillPackage
<a name="alexa-properties-ask-skill-skillpackage"></a>
...
## Syntax
<a name="alexa-properties-ask-skill-skillpackage-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="alexa-properties-ask-skill-skillpackage-syntax.json"></a>
...
### YAML
<a name="alexa-properties-ask-skill-skillpackage-syntax.yaml"></a>
...
## Properties
<a name="alexa-properties-ask-skill-skillpackage-properties"></a>
...
*Required*: No
*Type*: [Overrides](alexa-properties-ask-skill-overrides.md)
