...
see [Insights in AWS Security Hub CSPM](../../../securityhub/latest/userguide/securityhub-insights.md) in the _AWS Security Hub CSPM User Guide_.
...
_Type_: [AwsSecurityFindingFilters](aws-properties-securityhub-insight-awssecurityfindingfilters.md)
