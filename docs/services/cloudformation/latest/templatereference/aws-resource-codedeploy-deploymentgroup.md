...
are deployed to, along with other deployment options. For more information, see [CreateDeploymentGroup](https://docs.aws.amazon.com/codedeploy/latest/APIReference/API_CreateDeploymentGroup.html) in the _CodeDeploy API_
_Reference_.
...
Amazon ECS blue/green deployments through CodeDeploy using CloudFormation](../userguide/blue-green.md) for more information.
...
_Type_: [AlarmConfiguration](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-alarmconfiguration.html)
...
_Type_: [AutoRollbackConfiguration](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-autorollbackconfiguration.html)
...
_Type_: [BlueGreenDeploymentConfiguration](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-bluegreendeploymentconfiguration.html)
...
_Type_: [Deployment](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-deployment.html)
...
[Working with Deployment Configurations](https://docs.aws.amazon.com/codedeploy/latest/userguide/deployment-configurations.html) in the _AWS CodeDeploy_
_User Guide_.
...
_Type_: [DeploymentStyle](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-deploymentstyle.html)
...
_Type_: Array of [EC2TagFilter](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-ec2tagfilter.html)
...
_Type_: [EC2TagSet](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-ec2tagset.html)
...
_Type_: Array of [ECSService](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-ecsservice.html)
...
_Type_: [LoadBalancerInfo](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-loadbalancerinfo.html)
...
Instances for CodeDeploy](https://docs.aws.amazon.com/codedeploy/latest/userguide/instances-on-premises.html) in the _AWS CodeDeploy User_
_Guide_. Duplicates are not allowed.
...
_Type_: Array of [TagFilter](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-tagfilter.html)
...
_Type_: [OnPremisesTagSet](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-onpremisestagset.html)
...
Role for AWS CodeDeploy](https://docs.aws.amazon.com/codedeploy/latest/userguide/getting-started-create-service-role.html) in the _AWS CodeDeploy User_
_Guide_.
...
_Type_: Array of [Tag](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-tag.html)
...
_Type_: Array of [TriggerConfig](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-codedeploy-deploymentgroup-triggerconfig.html)
...
The following example creates a deployment group that is associated with Auto Scaling groups and uses an application revision that is stored in a GitHub
repository. You specify the repository information as input parameters.
...
The following example creates a deployment group that uses instance tags to associate
Amazon EC2 instances with the deployment group. The deployment group uses an
application revision that is stored in an Amazon S3 bucket.
...
The following example configures a billing alarm and a notification trigger for the
deployment group.
...
The following example configures an Elastic Load Balancing load balancer for the
deployment group.
...
The following example specifies the target group to use in a deployment. Instances are
