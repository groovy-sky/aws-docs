...
[Sharing Network Firewall resources](../../../network-firewall/latest/developerguide/sharing.md) in the _AWS Network Firewall Developer Guide_.
...
_Type_: [SubnetMapping](aws-properties-networkfirewall-vpcendpointassociation-subnetmapping.md)
...
_Type_: Array of [Tag](aws-properties-networkfirewall-vpcendpointassociation-tag.md)
