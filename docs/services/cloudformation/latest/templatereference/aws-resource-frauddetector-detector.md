---
title: "AWS::FraudDetector::Detector"
---
...
_Type_: Array of [Model](aws-properties-frauddetector-detector-model.md)
...
_Type_: Array of [Rule](aws-properties-frauddetector-detector-rule.md)
...
- [CreateDetectorVersion](../../../frauddetector/latest/api/api-createdetectorversion.md) in the _Amazon Fraud Detector API Reference_.

- [Create a detector version](../../../frauddetector/latest/ug/create-a-detector-version.md) in the _Amazon Fraud Detector User Guide_.
