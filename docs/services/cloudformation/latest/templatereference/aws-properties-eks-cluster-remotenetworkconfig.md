...
_Type_: Array of [RemoteNodeNetwork](aws-properties-eks-cluster-remotenodenetwork.md)
...
_Type_: Array of [RemotePodNetwork](aws-properties-eks-cluster-remotepodnetwork.md)
