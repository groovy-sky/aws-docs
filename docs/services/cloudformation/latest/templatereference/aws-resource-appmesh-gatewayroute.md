---
title: "AWS::AppMesh::GatewayRoute"
---
...
For more information about gateway routes, see [Gateway routes](../../../app-mesh/latest/userguide/gateway-routes.md).
...
_Type_: Array of [Tag](aws-properties-appmesh-gatewayroute-tag.md)
...
- [Gateway routes](../../../app-mesh/latest/userguide/gateway-routes.md) in the _AWS App Mesh User Guide_.

- [CreateGatewayRoute](../../../../reference/app-mesh/latest/apireference/api-creategatewayroute.md) in the _AWS App Mesh API Reference_.
