...
<a name="aws-properties-route53-recordset-aliastarget"></a>
...
## Syntax
<a name="aws-properties-route53-recordset-aliastarget-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-route53-recordset-aliastarget-syntax.json"></a>

```
{
  "[DNSName](#cfn-route53-recordset-aliastarget-dnsname)" : {{String}},
  "[EvaluateTargetHealth](#cfn-route53-recordset-aliastarget-evaluatetargethealth)" : {{Boolean}},
  "[HostedZoneId](#cfn-route53-recordset-aliastarget-hostedzoneid)" : {{String}}
}
```

### YAML
<a name="aws-properties-route53-recordset-aliastarget-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-route53-recordset-aliastarget-properties"></a>

`DNSName`  <a name="cfn-route53-recordset-aliastarget-dnsname"></a>
...
`EvaluateTargetHealth`  <a name="cfn-route53-recordset-aliastarget-evaluatetargethealth"></a>
...
`HostedZoneId`  <a name="cfn-route53-recordset-aliastarget-hostedzoneid"></a>
