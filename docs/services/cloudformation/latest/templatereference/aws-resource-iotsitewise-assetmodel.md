...
property and hierarchy definitions. For more information, see [Defining asset models](../../../iot-sitewise/latest/userguide/define-models.md) in the
...
When creating custom composite models, you need to use [CreateAssetModelCompositeModel](../../../../reference/iot-sitewise/latest/apireference/api-createassetmodelcompositemodel.md). For more information,
see [Creating custom composite models (Components)](../../../iot-sitewise/latest/userguide/create-custom-composite-models.md) in the
_AWS IoT SiteWise User Guide_.

_Required_: No

_Type_: Array of [AssetModelCompositeModel](aws-properties-iotsitewise-assetmodel-assetmodelcompositemodel.md)
...
The external ID of the asset model. For more information, see [Using external IDs](../../../iot-sitewise/latest/userguide/object-ids.md#external-ids) in the _AWS IoT SiteWise User Guide_.
...
information, see [Asset hierarchies](../../../iot-sitewise/latest/userguide/asset-hierarchies.md) in the _AWS IoT SiteWise User Guide_.

You can specify up to 10 hierarchies per asset model. For more
information, see [Quotas](../../../iot-sitewise/latest/userguide/quotas.md) in the _AWS IoT SiteWise User Guide_.

_Required_: No

_Type_: Array of [AssetModelHierarchy](aws-properties-iotsitewise-assetmodel-assetmodelhierarchy.md)
...
[Asset properties](../../../iot-sitewise/latest/userguide/asset-properties.md) in the _AWS IoT SiteWise User Guide_.
...
_Type_: Array of [EnforcedAssetModelInterfaceRelationship](aws-properties-iotsitewise-assetmodel-enforcedassetmodelinterfacerelationship.md)
...
_Type_: Array of [Tag](aws-properties-iotsitewise-assetmodel-tag.md)
