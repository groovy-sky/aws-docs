---
title: "AWS::AppMesh::VirtualService"
---
...
For more information about virtual services, see [Virtual services](../../../app-mesh/latest/userguide/virtual-services.md).
...
_Type_: Array of [Tag](aws-properties-appmesh-virtualservice-tag.md)
...
- [Virtual Services](../../../app-mesh/latest/userguide/virtual-services.md) in the _AWS App Mesh User Guide_.

- [CreateVirtualService](../../../../reference/app-mesh/latest/apireference/api-createvirtualservice.md) in the _AWS App Mesh API Reference_.
