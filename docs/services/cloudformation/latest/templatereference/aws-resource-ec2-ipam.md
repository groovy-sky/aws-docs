...
Organization. For more information, see [What is IPAM?](../../../vpc/latest/ipam/what-is-it-ipam.md) in the
...
policy](../../../vpc/latest/ipam/iam-ipam-policy-examples.md) in the _Amazon VPC IPAM User Guide_.
...
_Type_: Array of [IpamOrganizationalUnitExclusion](aws-properties-ec2-ipam-ipamorganizationalunitexclusion.md)
...
A metered account is an AWS account that is charged for active IP addresses managed in IPAM. For more information, see [Enable cost distribution](../../../vpc/latest/ipam/ipam-enable-cost-distro.md) in the _Amazon VPC IPAM User Guide_.
...
_Type_: Array of [IpamOperatingRegion](aws-properties-ec2-ipam-ipamoperatingregion.md)
...
_Type_: Array of [Tag](aws-properties-ec2-ipam-tag.md)
