---
title: "AWS::Backup::BackupVault LockConfigurationType"
---
...
The `LockConfigurationType` property type specifies configuration for [AWS Backup Vault Lock](../../../aws-backup/latest/devguide/vault-lock.md).
...
To create a vault lock in governance mode, do not include
`ChangeableForDays`. If this parameter is included, the vault lock is
