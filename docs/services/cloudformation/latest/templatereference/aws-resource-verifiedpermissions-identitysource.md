...
proxies for the principal in authorization queries that use the [IsAuthorizedWithToken](../../../../reference/verifiedpermissions/latest/apireference/api-isauthorizedwithtoken.md) operation. These identities take the form of tokens
...
_Type_: [IdentitySourceConfiguration](aws-properties-verifiedpermissions-identitysource-identitysourceconfiguration.md)
