---
title: "AWS::EC2::LocalGatewayRoute"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::EC2::LocalGatewayRoute
<a name="aws-resource-ec2-localgatewayroute"></a>
...
## Syntax
<a name="aws-resource-ec2-localgatewayroute-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-resource-ec2-localgatewayroute-syntax.json"></a>
...
### YAML
<a name="aws-resource-ec2-localgatewayroute-syntax.yaml"></a>
...
## Properties
<a name="aws-resource-ec2-localgatewayroute-properties"></a>
...
## Return values
<a name="aws-resource-ec2-localgatewayroute-return-values"></a>

### Ref
<a name="aws-resource-ec2-localgatewayroute-return-values-ref"></a>
...
### Fn::GetAtt
<a name="aws-resource-ec2-localgatewayroute-return-values-fn--getatt"></a>
...
## See also
<a name="aws-resource-ec2-localgatewayroute--seealso"></a>
