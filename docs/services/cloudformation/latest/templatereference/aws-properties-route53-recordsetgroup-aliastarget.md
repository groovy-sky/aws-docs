...
<a name="aws-properties-route53-recordsetgroup-aliastarget"></a>
...
## Syntax
<a name="aws-properties-route53-recordsetgroup-aliastarget-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-route53-recordsetgroup-aliastarget-syntax.json"></a>

```
{
  "[DNSName](#cfn-route53-recordsetgroup-aliastarget-dnsname)" : {{String}},
  "[EvaluateTargetHealth](#cfn-route53-recordsetgroup-aliastarget-evaluatetargethealth)" : {{Boolean}},
  "[HostedZoneId](#cfn-route53-recordsetgroup-aliastarget-hostedzoneid)" : {{String}}
}
```

### YAML
<a name="aws-properties-route53-recordsetgroup-aliastarget-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-route53-recordsetgroup-aliastarget-properties"></a>

`DNSName`  <a name="cfn-route53-recordsetgroup-aliastarget-dnsname"></a>
...
`EvaluateTargetHealth`  <a name="cfn-route53-recordsetgroup-aliastarget-evaluatetargethealth"></a>
...
`HostedZoneId`  <a name="cfn-route53-recordsetgroup-aliastarget-hostedzoneid"></a>
...
## See also
<a name="aws-properties-route53-recordsetgroup-aliastarget--seealso"></a>
