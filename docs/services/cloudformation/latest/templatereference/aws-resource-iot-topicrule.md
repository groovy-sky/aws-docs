...
rule. For information about working with AWS IoT rules, see [Rules for AWS IoT](../../../iot/latest/developerguide/iot-rules.md) in the _AWS IoT Developer Guide_.
...
_Type_: Array of [Tag](aws-properties-iot-topicrule-tag.md)
