---
title: "AWS::Pinpoint::APNSChannel"
---
...
The APNSChannel resource represents the status and authentication settings for the
APNs channel for an application.
...
The unique identifier for the Amazon Pinpoint application that the APNs channel
applies to.
