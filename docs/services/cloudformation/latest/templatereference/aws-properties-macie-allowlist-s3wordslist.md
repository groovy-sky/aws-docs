---
title: "AWS::Macie::AllowList S3WordsList"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::Macie::AllowList S3WordsList
<a name="aws-properties-macie-allowlist-s3wordslist"></a>
...
## Syntax
<a name="aws-properties-macie-allowlist-s3wordslist-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-macie-allowlist-s3wordslist-syntax.json"></a>
...
### YAML
<a name="aws-properties-macie-allowlist-s3wordslist-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-macie-allowlist-s3wordslist-properties"></a>
