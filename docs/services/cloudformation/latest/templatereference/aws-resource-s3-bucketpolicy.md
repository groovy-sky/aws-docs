...
Overview](https://docs.aws.amazon.com/AmazonS3/latest/dev/access-policy-language-overview.html) in the _Amazon S3 User Guide_.
...
referenced on unauthorized third-party sites. For more information, see [`aws:referer`](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_condition-keys.html#condition-keys-referer) in the _IAM User Guide_.
