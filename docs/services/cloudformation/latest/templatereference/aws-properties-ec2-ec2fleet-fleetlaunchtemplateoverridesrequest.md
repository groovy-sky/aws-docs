---
title: "AWS::EC2::EC2Fleet FleetLaunchTemplateOverridesRequest"
---
...
```
{
  ...
  "[IamInstanceProfile](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-iaminstanceprofile)" : {{IamInstanceProfileSpecification}},
  ...
  "[KeyName](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-keyname)" : {{String}},
  "[MaxPrice](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-maxprice)" : {{String}},
  "[MetadataOptions](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-metadataoptions)" : {{InstanceMetadataOptionsRequest}},
  "[NetworkInterfaces](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-networkinterfaces)" : {{[ NetworkInterfaceSpecificationRequest, ... ]}},
...
```
  ...
  [BlockDeviceMappings](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-blockdevicemappings): {{
    - BlockDeviceMapping}}
  [IamInstanceProfile](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-iaminstanceprofile): {{
  ...
  [KeyName](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-keyname): {{String}}
  [MaxPrice](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-maxprice): {{String}}
  [MetadataOptions](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-metadataoptions): {{
    InstanceMetadataOptionsRequest}}
  [NetworkInterfaces](#cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-networkinterfaces): {{
...
`IamInstanceProfile`  <a name="cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-iaminstanceprofile"></a>
...
*Required*: No
*Type*: [IamInstanceProfileSpecification](aws-properties-ec2-ec2fleet-iaminstanceprofilespecification.md)
*Update requires*: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
...
`KeyName`  <a name="cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-keyname"></a>
...
`MetadataOptions`  <a name="cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-metadataoptions"></a>
...
*Required*: No
*Type*: [InstanceMetadataOptionsRequest](aws-properties-ec2-ec2fleet-instancemetadataoptionsrequest.md)
*Update requires*: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)

`NetworkInterfaces`  <a name="cfn-ec2-ec2fleet-fleetlaunchtemplateoverridesrequest-networkinterfaces"></a>
Property description not available.
*Required*: No
*Type*: Array of [NetworkInterfaceSpecificationRequest](aws-properties-ec2-ec2fleet-networkinterfacespecificationrequest.md)
*Update requires*: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
