...
`FleetLaunchTemplateOverridesRequest` is a property of the [FleetLaunchTemplateConfigRequest](../userguide/aws-properties-ec2-ec2fleet-fleetlaunchtemplateconfigrequest.md) property type.
...
for volumes on Amazon EC2 instances](../../../ec2/latest/userguide/block-device-mapping-concepts.md) in the _Amazon EC2 User_
_Guide_.

_Required_: No

_Type_: Array of [BlockDeviceMapping](aws-properties-ec2-ec2fleet-blockdevicemapping.md)
...
- [FleetLaunchTemplateOverridesRequest](../../../../reference/awsec2/latest/apireference/api-fleetlaunchtemplateoverridesrequest.md) in the _Amazon EC2 API_
_Reference_
