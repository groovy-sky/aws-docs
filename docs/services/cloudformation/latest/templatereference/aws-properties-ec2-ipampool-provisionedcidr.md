---
title: "AWS::EC2::IPAMPool ProvisionedCidr"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::EC2::IPAMPool ProvisionedCidr
<a name="aws-properties-ec2-ipampool-provisionedcidr"></a>
...
## Syntax
<a name="aws-properties-ec2-ipampool-provisionedcidr-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-ec2-ipampool-provisionedcidr-syntax.json"></a>
...
### YAML
<a name="aws-properties-ec2-ipampool-provisionedcidr-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-ec2-ipampool-provisionedcidr-properties"></a>
