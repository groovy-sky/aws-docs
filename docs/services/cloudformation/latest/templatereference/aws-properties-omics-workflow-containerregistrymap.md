...
_Type_: Array of [ImageMapping](aws-properties-omics-workflow-imagemapping.md)
...
_Type_: Array of [RegistryMapping](aws-properties-omics-workflow-registrymapping.md)
