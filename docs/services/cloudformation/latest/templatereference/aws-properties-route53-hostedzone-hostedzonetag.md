---
title: "AWS::Route53::HostedZone HostedZoneTag"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::Route53::HostedZone HostedZoneTag
<a name="aws-properties-route53-hostedzone-hostedzonetag"></a>

A complex type that contains information about a tag that you want to add or edit for the specified health check or hosted zone.

## Syntax
<a name="aws-properties-route53-hostedzone-hostedzonetag-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-route53-hostedzone-hostedzonetag-syntax.json"></a>
...
### YAML
<a name="aws-properties-route53-hostedzone-hostedzonetag-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-route53-hostedzone-hostedzonetag-properties"></a>
...
## See also
<a name="aws-properties-route53-hostedzone-hostedzonetag--seealso"></a>
