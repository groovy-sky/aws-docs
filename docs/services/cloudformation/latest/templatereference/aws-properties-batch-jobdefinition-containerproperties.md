...
_Type_: [FargatePlatformConfiguration](aws-properties-batch-jobdefinition-fargateplatformconfiguration.md)
...
(shown in the [LogConfiguration](../userguide/aws-properties-batch-jobdefinition-containerproperties-logconfiguration.md) data type).
...
The secrets for the container. For more information, see [Specifying sensitive data](../../../batch/latest/userguide/specifying-sensitive-data.md) in the
