---
title: "AWS::Greengrass::ResourceDefinitionVersion ResourceInstance"
---
...
[Access Local\
Resources with Lambda Functions](../../../greengrass/v1/developerguide/access-local-resources.md), [Perform Machine Learning\
...
In an CloudFormation template, the `Resources` property of the [`AWS::Greengrass::ResourceDefinitionVersion`](../userguide/aws-resource-greengrass-resourcedefinitionversion.md) resource contains a list of `ResourceInstance` property types.
