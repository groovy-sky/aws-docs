...
An array of [Tag objects](../../../../reference/redshift-serverless/latest/apireference/api-tag.md) to associate with the snapshot.

_Required_: No

_Type_: Array of [Tag](aws-properties-redshiftserverless-snapshot-tag.md)
