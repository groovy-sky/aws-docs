---
title: "AWS::Greengrass::FunctionDefinitionVersion DefaultConfig"
---
...
In
an CloudFormation template, `DefaultConfig` is a property of the [`AWS::Greengrass::FunctionDefinitionVersion`](../userguide/aws-resource-greengrass-functiondefinitionversion.md) resource.
