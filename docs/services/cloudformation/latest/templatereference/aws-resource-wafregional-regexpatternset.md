...
A friendly name or description of the [AWS::WAFRegional::RegexPatternSet](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-wafregional-regexpatternset.html). You can't change `Name` after you create a `RegexPatternSet`.
