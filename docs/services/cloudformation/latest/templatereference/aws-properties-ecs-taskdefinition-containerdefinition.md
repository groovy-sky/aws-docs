---
title: "AWS::ECS::TaskDefinition ContainerDefinition"
---
...
Containers](../../../amazonecs/latest/developerguide/windows-gmsa.md) and [Using gMSAs for Linux\
Containers](../../../amazonecs/latest/developerguide/linux-gmsa.md).
...
If the task definition is used in a blue/green deployment that uses [AWS::CodeDeploy::DeploymentGroup BlueGreenDeploymentConfiguration](../userguide/aws-properties-codedeploy-deploymentgroup-bluegreendeploymentconfiguration.md), the
`dependsOn` parameter is not supported.

_Required_: No

_Type_: Array of [ContainerDependency](aws-properties-ecs-taskdefinition-containerdependency.md)
...
see [Using gMSAs for Windows Containers](../../../amazonecs/latest/developerguide/windows-gmsa.md) and [Using gMSAs for Linux\
Containers](../../../amazonecs/latest/developerguide/linux-gmsa.md) in the _Amazon Elastic Container Service Developer_
_Guide_.
...
_Type_: Array of [KeyValuePair](aws-properties-ecs-taskdefinition-keyvaluepair.md)
...
_Type_: Array of [EnvironmentFile](aws-properties-ecs-taskdefinition-environmentfile.md)
...
Architecture](../../../amazonecs/latest/developerguide/application-architecture.md) in the _Amazon Elastic Container Service Developer_
_Guide_.
...
_Type_: Array of [HostEntry](aws-properties-ecs-taskdefinition-hostentry.md)
...
_Type_: Array of [MountPoint](aws-properties-ecs-taskdefinition-mountpoint.md)
...
section [DescribeTasks](../../../../reference/amazonecs/latest/apireference/api-describetasks.md)
responses.

_Required_: No

_Type_: Array of [PortMapping](aws-properties-ecs-taskdefinition-portmapping.md)
...
_Type_: Array of [ResourceRequirement](aws-properties-ecs-taskdefinition-resourcerequirement.md)
...
_Type_: [RestartPolicy](aws-properties-ecs-taskdefinition-restartpolicy.md)
...
_Type_: Array of [Secret](aws-properties-ecs-taskdefinition-secret.md)
...
_Type_: Array of [SystemControl](aws-properties-ecs-taskdefinition-systemcontrol.md)
...
values are displayed in the [Ulimit](../../../../reference/amazonecs/latest/apireference/api-ulimit.md) data type. This
...
_Type_: Array of [Ulimit](aws-properties-ecs-taskdefinition-ulimit.md)
...
container image resolution, see [Container image resolution](../../../amazonecs/latest/developerguide/deployment-type-ecs.md#deployment-container-image-stability) in the _Amazon ECS Developer_
_Guide_.
...
_Type_: Array of [VolumeFrom](aws-properties-ecs-taskdefinition-volumefrom.md)
