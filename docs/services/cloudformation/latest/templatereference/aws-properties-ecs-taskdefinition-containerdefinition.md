...
_Guide_. If you're using an Amazon ECS-optimized Linux AMI, your instance needs
...
ECS-optimized Linux AMI](../../../amazonecs/latest/developerguide/ecs-optimized-ami.md) in the _Amazon Elastic Container Service_
_Developer Guide_.
...
_Type_: Array of [ContainerDependency](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-containerdependency.html)
...
Agent Configuration](../../../amazonecs/latest/developerguide/ecs-agent-config.md) in the _Amazon Elastic Container Service_
_Developer Guide_.
...
_Type_: Array of [EnvironmentFile](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-environmentfile.html)
...
_Type_: Array of [HostEntry](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-hostentry.html)
...
_Type_: [FirelensConfiguration](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-firelensconfiguration.html)
...
_Type_: [HealthCheck](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-healthcheck.html)
...
_Type_: [LinuxParameters](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-linuxparameters.html)
...
daemon (shown in the [LogConfiguration](../../../../reference/amazonecs/latest/apireference/api-logconfiguration.md) data type). Additional log drivers may be available in
...
_Type_: [LogConfiguration](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-logconfiguration.html)
...
container](https://docs.docker.com/engine/api/v1.35) section of the [Docker Remote API](https://docs.docker.com/engine/api/v1.35) and the `--memory` option to [docker\
...
_Type_: Array of [MountPoint](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-mountpoint.html)
...
container](https://docs.docker.com/engine/api/v1.35) section of the [Docker Remote API](https://docs.docker.com/engine/api/v1.35) and the `--publish` option to [docker run](https://docs.docker.com/engine/reference/run). If the network
...
_Type_: Array of [PortMapping](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-portmapping.html)
...
_Type_: [RepositoryCredentials](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-repositorycredentials.html)
...
_Type_: Array of [ResourceRequirement](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-resourcerequirement.html)
...
_Type_: [RestartPolicy](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-restartpolicy.html)
...
_Type_: Array of [Secret](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-secret.html)
...
checking your agent version and updating to the latest version, see [Updating the Amazon ECS Container Agent](../../../amazonecs/latest/developerguide/ecs-agent-update.md) in the _Amazon Elastic_
_Container Service Developer Guide_. If you're using an Amazon
...
container agent and `ecs-init`. For more information, see [Amazon ECS-optimized Linux AMI](../../../amazonecs/latest/developerguide/ecs-optimized-ami.md) in the _Amazon Elastic Container_
...
about checking your agent version and updating to the latest version, see [Updating the Amazon ECS Container Agent](../../../amazonecs/latest/developerguide/ecs-agent-update.md) in the _Amazon Elastic_
_Container Service Developer Guide_. If you're using an Amazon
...
_Type_: Array of [SystemControl](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-systemcontrol.html)
...
container](https://docs.docker.com/engine/api/v1.35) section of the [Docker Remote API](https://docs.docker.com/engine/api/v1.35) and the `--ulimit` option to [docker run](https://docs.docker.com/engine/reference/run). Valid naming
...
_Type_: Array of [Ulimit](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-ulimit.html)
...
_Type_: Array of [VolumeFrom](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-ecs-taskdefinition-volumefrom.html)
