...
For more information, see [Lists](../../../frauddetector/latest/ug/lists.md).
...
_Type_: Array of [Tag](aws-properties-frauddetector-list-tag.md)
...
The variable type of the list. For more information, see [Variable types](../../../frauddetector/latest/ug/variables.md#variable-types)
