---
title: "AWS::Greengrass::CoreDefinition Core"
---
...
processes for a Greengrass group. For more information, see [What Is AWS IoT Greengrass?](../../../greengrass/v1/developerguide/what-is-gg.md) in the _AWS IoT Greengrass Version 1 Developer Guide_.

In an CloudFormation template, the `Cores` property of the [`CoreDefinitionVersion`](../userguide/aws-properties-greengrass-coredefinition-coredefinitionversion.md) property type contains a list of `Core` property types. Currently, the
