...
processes for a Greengrass group. For more information, see [What Is AWS IoT Greengrass?](https://docs.aws.amazon.com/greengrass/v1/developerguide/what-is-gg.html) in the _AWS IoT Greengrass Version 1 Developer Guide_.
...
- [Core](https://docs.aws.amazon.com/greengrass/v1/apireference/definitions-core.html) in the _AWS IoT Greengrass Version 1 API Reference_
