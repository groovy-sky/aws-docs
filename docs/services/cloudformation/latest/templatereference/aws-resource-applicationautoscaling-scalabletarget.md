...
using the [DependsOn](../userguide/aws-attribute-dependson.md)
attribute.
...
The following example creates a scalable target for an [AWS::Cassandra::Table](../userguide/aws-resource-cassandra-table.md) resource. Application Auto Scaling can scale the write
