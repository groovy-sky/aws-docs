...
_Type_: [SplunkBufferingHints](aws-properties-kinesisfirehose-deliverystream-splunkbufferinghints.md)
...
- [SplunkDestinationConfiguration](../../../../reference/firehose/latest/apireference/api-splunkdestinationconfiguration.md) in the _Amazon Kinesis Data_
