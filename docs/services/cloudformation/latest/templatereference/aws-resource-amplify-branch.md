...
_Type_: [Backend](aws-properties-amplify-branch-backend.md)
...
more information about skew protection, see [Skew protection for Amplify deployments](../../../amplify/latest/userguide/skew-protection.md) in the _Amplify User_
_Guide_.
...
_Type_: Array of [EnvironmentVariable](aws-properties-amplify-branch-environmentvariable.md)
...
_Type_: Array of [Tag](aws-properties-amplify-branch-tag.md)
