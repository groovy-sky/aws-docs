---
title: "AWS::GameLift::Fleet ResourceCreationLimitPolicy"
---
...
- [ResourceCreationLimitPolicy](../../../../reference/gamelift/latest/apireference/api-resourcecreationlimitpolicy.md) in the _Amazon GameLift API Reference_
