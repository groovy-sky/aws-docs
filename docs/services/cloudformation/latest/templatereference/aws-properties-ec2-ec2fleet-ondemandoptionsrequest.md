---
title: "AWS::EC2::EC2Fleet OnDemandOptionsRequest"
---
...
`OnDemandOptionsRequest` is a property of the [AWS::EC2::EC2Fleet](../userguide/aws-resource-ec2-ec2fleet.md) resource.
...
- [OnDemandOptionsRequest](../../../../reference/awsec2/latest/apireference/api-ondemandoptionsrequest.md) in the _Amazon EC2 API_
_Reference_
