---
title: "AWS::Greengrass::LoggerDefinitionVersion Logger"
---
...
In an CloudFormation template, the `Loggers` property of the [`AWS::Greengrass::LoggerDefinitionVersion`](../userguide/aws-resource-greengrass-loggerdefinitionversion.md) resource contains a list of `Logger` property types.
