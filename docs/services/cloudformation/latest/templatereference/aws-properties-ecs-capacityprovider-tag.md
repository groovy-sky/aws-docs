---
title: "AWS::ECS::CapacityProvider Tag"
---
...
- [Create an Amazon ECS capacity provider](../userguide/aws-resource-ecs-capacityprovider.md#aws-resource-ecs-capacityprovider--examples)
