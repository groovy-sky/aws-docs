...
_Type_: [AdvancedConfiguration](aws-properties-ecs-service-advancedconfiguration.md)
...
multiple target groups. For more information, see [Registering multiple target groups with a service](../../../amazonecs/latest/developerguide/register-multiple-targetgroups.md) in
...
to define two target groups for the load balancer. For more information, see [Blue/green deployment with CodeDeploy](../../../amazonecs/latest/developerguide/deployment-type-bluegreen.md) in the
