...
_Type_: [ServiceConnectAccessLogConfiguration](aws-properties-ecs-service-serviceconnectaccesslogconfiguration.md)
...
_Type_: Array of [ServiceConnectService](aws-properties-ecs-service-serviceconnectservice.md)
