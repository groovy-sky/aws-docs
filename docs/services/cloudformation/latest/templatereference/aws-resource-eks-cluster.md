...
Endpoint Access Control](../../../eks/latest/userguide/cluster-endpoint.md) in the _Amazon EKS User Guide_.
...
Cluster Control Plane Logs](../../../eks/latest/userguide/control-plane-logs.md) in the
...
access your cluster](../../../eks/latest/userguide/cluster-auth.md) and [Launching Amazon EKS\
nodes](../../../eks/latest/userguide/launch-workers.md) in the _Amazon EKS User Guide_.
...
_Type_: [AccessConfig](aws-properties-eks-cluster-accessconfig.md)
...
_Type_: [ComputeConfig](aws-properties-eks-cluster-computeconfig.md)
...
_Type_: [ControlPlaneScalingConfig](aws-properties-eks-cluster-controlplanescalingconfig.md)
...
_Type_: [Array](aws-properties-eks-cluster-encryptionconfig.md) of [EncryptionConfig](aws-properties-eks-cluster-encryptionconfig.md)
...
_Type_: [RemoteNetworkConfig](aws-properties-eks-cluster-remotenetworkconfig.md)
...
information, see [Cluster VPC Considerations](../../../eks/latest/userguide/network-reqs.md) and
[Cluster\
Security Group Considerations](../../../eks/latest/userguide/sec-group-reqs.md) in the _Amazon EKS User_
...
IAM Role](../../../eks/latest/userguide/service-iam-role.md) in the _Amazon EKS User Guide_.
...
_Type_: [StorageConfig](aws-properties-eks-cluster-storageconfig.md)
...
principal](../../../iam/latest/userguide/id-roles-terms-and-concepts.md) to manage the CloudFormation stack. If you don't have
...
_Type_: Array of [Tag](aws-properties-eks-cluster-tag.md)
...
_Type_: [UpgradePolicy](aws-properties-eks-cluster-upgradepolicy.md)
...
_Type_: [ZonalShiftConfig](aws-properties-eks-cluster-zonalshiftconfig.md)
...
node groups. For more information, see [Managed node groups](../../../eks/latest/userguide/managed-node-groups.md) in
...
- [Clusters](../../../eks/latest/userguide/clusters.md) in the _Amazon EKS User_
_Guide_.

- [`CreateCluster`](../../../../reference/eks/latest/apireference/api-createcluster.md) in the _Amazon EKS API Reference_.
