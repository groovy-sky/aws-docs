...
_Type_: Array of [PluginVisualFieldWell](aws-properties-quicksight-dashboard-pluginvisualfieldwell.md)
...
_Type_: [PluginVisualSortConfiguration](aws-properties-quicksight-dashboard-pluginvisualsortconfiguration.md)
...
_Type_: [PluginVisualOptions](aws-properties-quicksight-dashboard-pluginvisualoptions.md)
