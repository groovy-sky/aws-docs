...
_Type_: Array of [CustomerManagedPolicyReference](aws-properties-sso-permissionset-customermanagedpolicyreference.md)
...
The description of the [AWS::SSO::PermissionSet](aws-resource-sso-permissionset.md).
...
policy evaluation logic](../../../iam/latest/userguide/reference-policies-evaluation-logic.md) in the _IAM User_
_Guide_.
...
The tags to attach to the new [AWS::SSO::PermissionSet](aws-resource-sso-permissionset.md).

_Required_: No

_Type_: Array of [Tag](aws-properties-sso-permissionset-tag.md)
