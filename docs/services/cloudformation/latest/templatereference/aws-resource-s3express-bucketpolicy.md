...
submitting it to IAM. For more information, see the AWS::IAM::Policy [PolicyDocument](../userguide/aws-resource-iam-policy.md#cfn-iam-policy-policydocument) resource description in this guide and [Policies and Permissions in Amazon S3](../../../s3/latest/dev/access-policy-language-overview.md) in the _Amazon S3 User_
_Guide_.
