---
title: "AWS::SageMaker::Model ContainerDefinition"
---
...
to Monitor an Inference Pipeline](../../../sagemaker/latest/dg/inference-pipeline-logs-metrics.md). If you don't specify a value for this
...
Amazon SageMaker](../../../sagemaker/latest/dg/your-algorithms.md).
...
Private Docker Registry for Real-Time Inference Containers](../../../sagemaker/latest/dg/your-algorithms-containers-inference-private.md).
...
_Type_: [ImageConfig](aws-properties-sagemaker-model-imageconfig.md)
...
_Type_: [ModelDataSource](aws-properties-sagemaker-model-modeldatasource.md)
...
Parameters](../../../sagemaker/latest/dg/sagemaker-algo-docker-registry-paths.md).
...
Deactivating AWS STS in an AWS Region](../../../iam/latest/userguide/id-credentials-temp-enable-regions.md) in the
...
_Type_: [MultiModelConfig](aws-properties-sagemaker-model-multimodelconfig.md)
