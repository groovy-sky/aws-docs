---
title: "AWS::CertificateManager::Certificate"
---
...
DNS Validation](../../../acm/latest/userguide/dns-validation.md) and [Option 2: Email\
Validation](../../../acm/latest/userguide/email-validation.md).
...
more information about private CAs, see the [AWS Private Certificate Authority](../../../privateca/latest/userguide/pcawelcome.md) user guide. The ARN must have
the following form:
...
_Type_: Array of [DomainValidationOption](aws-properties-certificatemanager-certificate-domainvalidationoption.md)
...
[Key\
algorithms](../../../acm/latest/userguide/acm-certificate-characteristics.md#algorithms-term).
...
_Type_: Array of [Tag](aws-properties-certificatemanager-certificate-tag.md)
...
with a public certificate. You can [validate with DNS](../../../acm/latest/userguide/gs-acm-validate-dns.md) or
[validate with email](../../../acm/latest/userguide/gs-acm-validate-email.md). We recommend that you use DNS validation.
