---
title: "AWS::EC2::SpotFleet SpotFleetRequestConfigData"
---
...
Specifies the configuration of a Spot Fleet request. For more information, see [Spot Fleet](../../../ec2/latest/userguide/spot-fleet.md) in the _Amazon EC2 User Guide_.
...
strategies for Spot Instances](../../../ec2/latest/userguide/spot-fleet-allocation-strategy.md) in the _Amazon EC2 User Guide_.
...
Fleet Prerequisites](../../../ec2/latest/userguide/spot-fleet-requests.md#spot-fleet-prerequisites) in the _Amazon EC2 User Guide_.
...
_Type_: Array of [SpotFleetLaunchSpecification](aws-properties-ec2-spotfleet-spotfleetlaunchspecification.md)
...
_Type_: Array of [LaunchTemplateConfig](aws-properties-ec2-spotfleet-launchtemplateconfig.md)
...
_Type_: Array of [SpotFleetTagSpecification](aws-properties-ec2-spotfleet-spotfleettagspecification.md)
