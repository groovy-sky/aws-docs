...
to the internet. For more information, see the [AWS IoT Greengrass Version 1 Developer Guide](../../../greengrass/v1/developerguide/what-is-gg.md).

###### Note

For AWS Region support, see [CloudFormation Support for AWS IoT Greengrass](../../../greengrass/v1/developerguide/cloudformation-support.md) in the _AWS IoT Greengrass Version 1 Developer Guide_.
...
associate a group version later, create a [`AWS::Greengrass::GroupVersion`](../userguide/aws-resource-greengrass-groupversion.md) resource and specify the ID of
this group.
...
**create-deployment**](../../../../reference/greengrass/v1/apireference/createdeployment-post.md) command in the AWS CLI or from the
...
Support for AWS IoT Greengrass](../../../greengrass/v1/developerguide/cloudformation-support.md) in the _AWS IoT Greengrass Version 1 Developer Guide_.
...
To associate a group version after the group is created, create an [`AWS::Greengrass::GroupVersion`](../userguide/aws-resource-greengrass-groupversion.md) resource and specify the ID of
this group.
...
**greengrass create-deployment**](../../../../reference/greengrass/v1/apireference/createdeployment-post.md) command in the AWS CLI or from the group configuration page in the AWS IoT
...
[CloudFormation Support for AWS IoT Greengrass](../../../greengrass/v1/developerguide/cloudformation-support.md) in the
...
- [CreateGroup](../../../../reference/greengrass/v1/apireference/creategroup-post.md)
