...
_Type_: Array of [CapacityLimit](aws-properties-batch-serviceenvironment-capacitylimit.md)
...
The tags associated with the service environment. Each tag consists of a key and an optional value. For more information, see [Tagging your AWS Batch resources](../../../batch/latest/userguide/using-tags.md).
