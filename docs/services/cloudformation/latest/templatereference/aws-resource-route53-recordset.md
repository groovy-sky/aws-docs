...
_Type_: [AliasTarget](aws-properties-route53-recordset-aliastarget.md)
...
_Type_: [CidrRoutingConfig](aws-properties-route53-recordset-cidrroutingconfig.md)
...
_Type_: [GeoProximityLocation](aws-properties-route53-recordset-geoproximitylocation.md)
...
[Intrinsic Function Reference](../userguide/intrinsic-function-reference.md).
