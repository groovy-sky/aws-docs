...
_Type_: Array of [RelationalDatabaseParameter](aws-properties-lightsail-database-relationaldatabaseparameter.md)
...
_Type_: Array of [Tag](aws-properties-lightsail-database-tag.md)
