---
title: "AWS::StepFunctions::StateMachineAlias"
---
...
Represents a state machine [alias](../../../step-functions/latest/dg/concepts-state-machine-alias.md). An alias routes traffic to one or two versions of the same state machine.
...
The settings that enable gradual state machine deployments. These settings include [Alarms](../userguide/aws-properties-stepfunctions-statemachinealias-deploymentpreference.md#cfn-stepfunctions-statemachinealias-deploymentpreference-alarms), [Interval](../userguide/aws-properties-stepfunctions-statemachinealias-deploymentpreference.md#cfn-stepfunctions-statemachinealias-deploymentpreference-interval), [Percentage](../userguide/aws-properties-stepfunctions-statemachinealias-deploymentpreference.md#cfn-stepfunctions-statemachinealias-deploymentpreference-percentage), [StateMachineVersionArn](../userguide/aws-properties-stepfunctions-statemachinealias-deploymentpreference.md#cfn-stepfunctions-statemachinealias-deploymentpreference-statemachineversionarn), and [Type](../userguide/aws-properties-stepfunctions-statemachinealias-deploymentpreference.md#cfn-stepfunctions-statemachinealias-deploymentpreference-type).
...
_Type_: [DeploymentPreference](aws-properties-stepfunctions-statemachinealias-deploymentpreference.md)
...
The routing configuration of an alias. Routing configuration splits [StartExecution](../../../../reference/step-functions/latest/apireference/api-startexecution.md) requests between one or two versions of the same state machine.

Use `RoutingConfiguration` if you want to explicitly set the alias [weights](../../../../reference/step-functions/latest/apireference/api-routingconfigurationlistitem.md#StepFunctions-Type-RoutingConfigurationListItem-weight). Weight is the percentage of traffic you want to route to a state machine version.
...
_Type_: Array of [RoutingConfigurationVersion](aws-properties-stepfunctions-statemachinealias-routingconfigurationversion.md)
...
For more information about using `Ref`, see [Ref](../userguide/intrinsic-function-reference-ref.md).
...
The following example demonstrates the use of [`StateMachineRevisionId`](../userguide/aws-resource-stepfunctions-statemachineversion.md#cfn-stepfunctions-statemachineversion-statemachinerevisionid) property to return the value of revision ID for the state machine resource. CloudFormation automatically detects if this property's value is different from the value in previous stack and publishes a new version that always points to the most recent revision of your state machine. The example then creates an alias named PROD to deploy this new version.
