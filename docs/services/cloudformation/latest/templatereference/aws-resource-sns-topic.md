...
For more information, see [Amazon SNS endpoints and quotas](../../../../general/latest/gr/sns.md) in the _AWS General Reference_.
...
or a custom CMK. For more information, see [Key terms](../../../sns/latest/dg/sns-server-side-encryption.md#sse-key-terms). For
more examples, see `
                            KeyId
                        ` in the _AWS Key Management Service API Reference_.

This property applies only to [server-side-encryption](../../../sns/latest/dg/sns-server-side-encryption.md).
...
- [Using an CloudFormation template to create a topic that sends messages to Amazon SQS queues](../../../sns/latest/dg/sendmessagetosqs-cloudformation.md) in the _Amazon SNS Developer Guide_

- The [Using CloudFormation](../../../sns/latest/dg/fifo-topic-code-examples.md#fifo-topic-cfn) code example for FIFO topics in the _Amazon SNS Developer Guide_
