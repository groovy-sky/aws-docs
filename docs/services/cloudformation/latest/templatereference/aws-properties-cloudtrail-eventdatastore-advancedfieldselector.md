---
title: "AWS::CloudTrail::EventDataStore AdvancedFieldSelector"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::CloudTrail::EventDataStore AdvancedFieldSelector
<a name="aws-properties-cloudtrail-eventdatastore-advancedfieldselector"></a>

A single selector statement in an advanced event selector.

## Syntax
<a name="aws-properties-cloudtrail-eventdatastore-advancedfieldselector-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-properties-cloudtrail-eventdatastore-advancedfieldselector-syntax.json"></a>
...
### YAML
<a name="aws-properties-cloudtrail-eventdatastore-advancedfieldselector-syntax.yaml"></a>
...
## Properties
<a name="aws-properties-cloudtrail-eventdatastore-advancedfieldselector-properties"></a>
