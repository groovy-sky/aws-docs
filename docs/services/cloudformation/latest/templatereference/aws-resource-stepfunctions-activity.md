...
Activity State Machine](../../../step-functions/latest/dg/tutorial-creating-activity-state-machine.md) in the _AWS Step Functions Developer_
_Guide_ and [CreateActivity](../../../../reference/step-functions/latest/apireference/api-createactivity.md)
...
_Type_: [EncryptionConfiguration](aws-properties-stepfunctions-activity-encryptionconfiguration.md)
...
_Type_: Array of [TagsEntry](aws-properties-stepfunctions-activity-tagsentry.md)
