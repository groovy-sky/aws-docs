---
title: "AWS::EC2::TransitGatewayConnect"
---

This is the new *CloudFormation Template Reference Guide*. Please update your bookmarks and links. For help getting started with CloudFormation, see the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html).

# AWS::EC2::TransitGatewayConnect
<a name="aws-resource-ec2-transitgatewayconnect"></a>
...
## Syntax
<a name="aws-resource-ec2-transitgatewayconnect-syntax"></a>

To declare this entity in your CloudFormation template, use the following syntax:

### JSON
<a name="aws-resource-ec2-transitgatewayconnect-syntax.json"></a>
...
```
{
  ...
  "Properties" : {
      ...
      "[Tags](#cfn-ec2-transitgatewayconnect-tags)" : {{[ Tag, ... ]}},
...
### YAML
<a name="aws-resource-ec2-transitgatewayconnect-syntax.yaml"></a>
...
## Properties
<a name="aws-resource-ec2-transitgatewayconnect-properties"></a>
...
*Required*: No
*Type*: Array of [Tag](aws-properties-ec2-transitgatewayconnect-tag.md)
...
## Return values
<a name="aws-resource-ec2-transitgatewayconnect-return-values"></a>

### Ref
<a name="aws-resource-ec2-transitgatewayconnect-return-values-ref"></a>

When you pass the logical ID of this resource to the intrinsic `Ref` function, `Ref` returns the transit gateway attachment.

### Fn::GetAtt
<a name="aws-resource-ec2-transitgatewayconnect-return-values-fn--getatt"></a>
