---
title: "AWS::AppMesh::VirtualGateway"
---
...
For more information about virtual gateways, see [Virtual gateways](../../../app-mesh/latest/userguide/virtual-gateways.md).
...
the ID of the account that shared the mesh with your account. For more information about mesh sharing, see [Working with shared meshes](../../../app-mesh/latest/userguide/sharing.md).
...
_Type_: Array of [Tag](aws-properties-appmesh-virtualgateway-tag.md)
...
- [Virtual gateways](../../../app-mesh/latest/userguide/virtual-gateways.md) in the _AWS App Mesh User Guide_.

- [CreateVirtualGateway](../../../../reference/app-mesh/latest/apireference/api-createvirtualgateway.md) in the _AWS App Mesh API Reference_.
