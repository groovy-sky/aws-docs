---
title: "AWS::Greengrass::ResourceDefinition"
---
...
definition version. To associate a resource definition version later, create an [`AWS::Greengrass::ResourceDefinitionVersion`](../userguide/aws-resource-greengrass-resourcedefinitionversion.md) resource and
...
resource definition version contains a list of [`resource instance`](../userguide/aws-properties-greengrass-resourcedefinition-resourceinstance.md) property types.

###### Note

To associate a resource definition version after the resource definition is created,
create an [`AWS::Greengrass::ResourceDefinitionVersion`](../userguide/aws-resource-greengrass-resourcedefinitionversion.md) resource and
specify the ID of this resource definition.
...
- [CreateResourceDefinition](../../../../reference/greengrass/v1/apireference/createresourcedefinition-post.md) in the _AWS IoT Greengrass Version 1 API Reference_
