...
- AWS IoT SiteWise Monitor (Classic) see [Create dashboards (AWS CLI)](../../../iot-sitewise/latest/userguide/create-dashboards-using-aws-cli.md)

- AWS IoT SiteWise Monitor (AI-aware) see [Create dashboards (AWS CLI)](../../../iot-sitewise/latest/userguide/create-dashboards-ai-dashboard-cli.md)
...
_Type_: Array of [Tag](aws-properties-iotsitewise-dashboard-tag.md)
...
The [ARN](../../../../general/latest/gr/aws-arns-and-namespaces.md) of the dashboard, which has the following format.
