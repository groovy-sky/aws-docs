...
| --- | --- |
| TAR.GZ | [ https://s3.amazonaws.com/cloudformation-examples/aws-cfn-bootstrap-py3-latest.tar.gz](https://s3.amazonaws.com/cloudformation-examples/aws-cfn-bootstrap-py3-latest.tar.gz)<br />Use Python's pip to install `tar.gz`. To complete the installation for Ubuntu, you must create a symlink:<br />`ln -s /{{<path-to-extracted-tar>}}/aws-cfn-bootstrap-2.0/init/ubuntu/cfn-hup /etc/init.d/cfn-hup` |
