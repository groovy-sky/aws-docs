---
title: "CloudFormation helper scripts reference"
---
...
- [cfn-init](cfn-init.md) – Use to retrieve and
interpret resource metadata, install packages, create files, and start services.

- [cfn-signal](cfn-signal.md) – Use to signal with a
...
- [cfn-get-metadata](cfn-get-metadata.md) – Use to
retrieve metadata for a resource or path to a specific key.

- [cfn-hup](cfn-hup.md) – Use to check for updates to
...
you need helper scripts that support an earlier version of Python, see [Release History for CloudFormation Helper Scripts 1.4](releasehistory-aws-cfn-bootstrap.md#releasehistory-aws-cfn-bootstrap-v1).
