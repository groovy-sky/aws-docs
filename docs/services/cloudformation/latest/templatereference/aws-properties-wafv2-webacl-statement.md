...
A logical rule statement used to combine other rule statements with AND logic. You provide more than one [Statement](../userguide/aws-properties-wafv2-webacl-notstatement.md#cfn-wafv2-webacl-notstatement-statement) within the `AndStatement`.
...
_Type_: [AsnMatchStatement](aws-properties-wafv2-webacl-asnmatchstatement.md)
