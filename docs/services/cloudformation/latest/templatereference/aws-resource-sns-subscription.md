...
topic. For more information, see `
                        ...
                        ` in the _Amazon SNS API Reference_ and [Message delivery retries](../../../sns/latest/dg/sns-message-delivery-retries.md)
...
out unwanted messages. For more information, see `
                            GetSubscriptionAttributes
                        ` in the _Amazon SNS API Reference_ and [Message filtering](../../../sns/latest/dg/sns-message-filtering.md) in the _Amazon SNS Developer Guide_.
...
SQS dead-letter queues](../../../awssimplequeueservice/latest/sqsdeveloperguide/sqs-dead-letter-queues.md) in the _Amazon SQS Developer Guide_.
...
delivery streams](../../../sns/latest/dg/sns-firehose-as-subscriber.md) in the _Amazon SNS Developer Guide._
