---
title: "AWS::AutoScaling::AutoScalingGroup InstanceRequirements"
---
...
Scaling group using attribute-based instance type selection](../../../autoscaling/ec2/userguide/create-asg-instance-type-requirements.md) in the _Amazon_
_EC2 Auto Scaling User Guide_. For help determining which instance types match your
attributes before you apply them to your Auto Scaling group, see [Preview instance types with specified attributes](../../../ec2/latest/userguide/ec2-fleet-attribute-based-instance-type-selection.md#ec2fleet-get-instance-types-from-instance-requirements) in the _Amazon EC2 User_
_Guide for Linux Instances_.

`InstanceRequirements` is a property of the `LaunchTemplateOverrides`
property of the [AWS::AutoScaling::AutoScalingGroup LaunchTemplate](../userguide/aws-properties-autoscaling-autoscalinggroup-launchtemplate.md) property type.
...
For more information, see [Amazon EBS–optimized instances](../../../ec2/latest/userguide/ebs-optimized.md)
...
_Type_: [BaselinePerformanceFactorsRequest](aws-properties-autoscaling-autoscalinggroup-baselineperformancefactorsrequest.md)
...
family. For more information, see [Instance types](../../../ec2/latest/userguide/instance-types.md) in
...
or required. For more information, see [Amazon EC2 instance store](../../../ec2/latest/userguide/instancestorage.md) in
the _Amazon EC2 User Guide_.
