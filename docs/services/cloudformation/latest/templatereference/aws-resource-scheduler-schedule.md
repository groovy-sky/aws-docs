...
see [Schedule types](../../../scheduler/latest/userguide/schedule-types.md) in the _EventBridge Scheduler User Guide_.
...
[Managing targets](../../../scheduler/latest/userguide/managing-targets.md) in the _EventBridge Scheduler User Guide_.
...
[Managing a schedule](../../../scheduler/latest/userguide/managing-schedule.md) in the _EventBridge Scheduler User Guide_.
...
For more information and examples, see [Schedule types on EventBridge Scheduler](../../../scheduler/latest/userguide/schedule-types.md) in the _EventBridge Scheduler User Guide_.
