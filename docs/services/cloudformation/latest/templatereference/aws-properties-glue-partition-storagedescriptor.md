---
title: "AWS::Glue::Partition StorageDescriptor"
---
...
_Type_: Array of [Column](aws-properties-glue-partition-column.md)
...
_Type_: Array of [Order](aws-properties-glue-partition-order.md)
