...
Definitions](../../../amazonecs/latest/developerguide/task-defintions.md) in the _Amazon Elastic Container Service Developer_
_Guide_.
...
[NetworkConfiguration](../../../../reference/amazonecs/latest/apireference/api-networkconfiguration.md) when you create a service or run a task with the task
definition. For more information, see [Task Networking](../../../amazonecs/latest/developerguide/task-networking.md)
...
_Type_: Array of [ContainerDefinition](aws-properties-ecs-taskdefinition-containerdefinition.md)
...
size](../../../amazonecs/latest/developerguide/task-definition-parameters.md#task_size) in the _Amazon Elastic Container Service Developer_
_Guide_.
...
for Amazon ECS](../../../amazonecs/latest/developerguide/security-ecs-iam-role-overview.md) in the _Amazon Elastic Container Service Developer_
_Guide_.
...
Controls](../../../amazonecs/latest/developerguide/task-definition-parameters.md) in the _Amazon Elastic Container Service Developer_
_Guide_.
...
see [ContainerDefinition](../../../../reference/amazonecs/latest/apireference/api-containerdefinition.md).
...
interface, and you must specify a [NetworkConfiguration](../../../../reference/amazonecs/latest/apireference/api-networkconfiguration.md) value when you create a service or run a task with the
task definition. For more information, see [Task Networking](../../../amazonecs/latest/developerguide/task-networking.md)
in the _Amazon Elastic Container Service Developer Guide_.
...
_Type_: Array of [TaskDefinitionPlacementConstraint](aws-properties-ecs-taskdefinition-taskdefinitionplacementconstraint.md)
...
types](../../../amazonecs/latest/developerguide/launch-types.md) in the _Amazon Elastic Container Service Developer_
_Guide_.
...
_Type_: Array of [Tag](aws-properties-ecs-taskdefinition-tag.md)
...
for tasks](../../../amazonecs/latest/developerguide/windows-task-iam-roles.md) in the _Amazon Elastic Container Service Developer Guide_.
...
The list of data volume definitions for the task. For more information, see [Using data volumes in tasks](../../../amazonecs/latest/developerguide/using-data-volumes.md) in the _Amazon Elastic Container_
_Service Developer Guide_.
...
_Type_: Array of [Volume](aws-properties-ecs-taskdefinition-volume.md)
...
`FileSystemId` with your own values. For more information about using Amazon EFS volumes with Amazon ECS, see [Use Amazon EFS volumes with Amazon ECS](../../../amazonecs/latest/developerguide/efs-volumes.md) in the _Amazon ECS Developer Guide_.
