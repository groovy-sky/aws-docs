...
attributes](https://docs.aws.amazon.com/cloud-map/latest/dg/tutorial-private-namespace.html) in the _AWS Cloud Map Developer Guide_.
...
- [RegisterInstance](https://docs.aws.amazon.com/cloud-map/latest/api/API_RegisterInstance.html) in the _AWS Cloud Map API Reference_
