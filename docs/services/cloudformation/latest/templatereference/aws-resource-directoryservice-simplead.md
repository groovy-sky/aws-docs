---
title: "AWS::DirectoryService::SimpleAD"
---
...
Directory](../../../directoryservice/latest/admin-guide/directory-simple-ad.md) in the _Directory Service Admin Guide_.
...
The size of the directory. For valid values, see [CreateDirectory](../../../directoryservice/latest/devguide/api-createdirectory.md) in
...
_Type_: Array of [Tag](aws-properties-directoryservice-simplead-tag.md)

_Update requires_: [No interruption](../userguide/using-cfn-updating-stacks-update-behaviors.md#update-no-interrupt)

`VpcSettings`

A [DirectoryVpcSettings](../../../directoryservice/latest/devguide/api-directoryvpcsettings.md) object that contains additional information for the
operation.
...
- [Getting\
Started with Simple AD](../../../directoryservice/latest/admin-guide/simple-ad-getting-started.md) in the _Directory Service Admin Guide_..

- [CreateDirectory](../../../directoryservice/latest/devguide/api-createdirectory.md) in the _Directory Service API Reference_.
