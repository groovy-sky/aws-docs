...
phone number request see [Request a phone number](../../../sms-voice/latest/userguide/phone-numbers-request.md) in the _AWS End User Messaging SMS_
_User Guide_.
...
_Type_: [MandatoryKeywords](aws-properties-smsvoice-phonenumber-mandatorykeywords.md)
...
_Type_: Array of [OptionalKeyword](aws-properties-smsvoice-phonenumber-optionalkeyword.md)
...
tracking and honoring opt-out request. For more information see [Self-managed opt-outs](../../../sms-voice/latest/userguide/opt-out-list-self-managed.md)
...
_Type_: Array of [Tag](aws-properties-smsvoice-phonenumber-tag.md)
...
_Type_: [TwoWay](aws-properties-smsvoice-phonenumber-twoway.md)
