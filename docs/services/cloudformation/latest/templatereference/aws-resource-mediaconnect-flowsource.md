...
_Type_: [GatewayBridgeSource](aws-properties-mediaconnect-flowsource-gatewaybridgesource.md)
...
_Type_: Array of [Tag](aws-properties-mediaconnect-flowsource-tag.md)
