---
title: "AWS::ECS::TaskDefinition LogConfiguration"
---
...
Amazon ECS logs to CloudWatch](../../../amazonecs/latest/developerguide/using-awslogs.md) in the _Amazon Elastic Container_
...
Partner](../../../amazonecs/latest/developerguide/using-firelens.md).
...
about the account setting, see [Default log driver mode](../../../amazonecs/latest/developerguide/ecs-account-settings.md#default-log-driver-mode) in the _Amazon Elastic_
