...
_Type_: [LinkSharingConfiguration](aws-properties-quicksight-dashboard-linksharingconfiguration.md)
...
_Type_: Array of [ResourcePermission](aws-properties-quicksight-dashboard-resourcepermission.md)
...
_Type_: Array of [Tag](aws-properties-quicksight-dashboard-tag.md)
...
_Type_: [ValidationStrategy](aws-properties-quicksight-dashboard-validationstrategy.md)
