---
title: "AWS::Elasticsearch::Domain EBSOptions"
---
...
io1. For more information about each type, see [Amazon EBS volume types](../../../ec2/latest/userguide/ebsvolumetypes.md) in the
