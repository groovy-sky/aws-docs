---
title: "AWS::Greengrass::SubscriptionDefinition"
---
...
create an [`AWS::Greengrass::SubscriptionDefinitionVersion`](../userguide/aws-resource-greengrass-subscriptiondefinitionversion.md) resource and
...
created. A subscription definition version contains a list of [`subscription`](../userguide/aws-properties-greengrass-subscriptiondefinition-subscription.md) property types.

###### Note

To associate a subscription definition version after the subscription definition is
created, create an [`AWS::Greengrass::SubscriptionDefinitionVersion`](../userguide/aws-resource-greengrass-subscriptiondefinitionversion.md) resource and specify the ID of this subscription definition.
...
For an example of a complete template, see the [`AWS::Greengrass::Group`](../userguide/aws-subscription-greengrass-group.md) subscription.
...
- [CreateSubscriptionDefinition](../../../../reference/greengrass/v1/apireference/createsubscriptiondefinition-post.md) in the _AWS IoT Greengrass Version 1 API Reference_
