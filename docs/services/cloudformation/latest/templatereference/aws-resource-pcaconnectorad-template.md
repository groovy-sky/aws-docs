---
title: "AWS::PCAConnectorAD::Template"
---
...
The Amazon Resource Name (ARN) that was returned when you called [CreateConnector](../../../../reference/pca-connector-ad/latest/apireference/api-createconnector.md).
...
_Type_: [TemplateDefinition](aws-properties-pcaconnectorad-template-templatedefinition.md)
...
The Amazon Resource Name (ARN) that was returned when you called [CreateTemplate](../../../../reference/pca-connector-ad/latest/apireference/api-createtemplate.md) .
