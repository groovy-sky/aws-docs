...
on CloudWatch alarms. For more information, see [Configuring permissions for rollback based on Amazon CloudWatch alarms](../../../appconfig/latest/userguide/getting-started-with-appconfig-cloudwatch-alarms-permissions.md) in the
...
_Type_: Array of [Tag](aws-properties-appconfig-deploymentstrategy-tag.md)
...
- [Creating a deployment strategy](../../../systems-manager/latest/userguide/appconfig-creating-deployment-strategy.md)
