...
For information about setting up receipt rule sets, see the [Amazon SES Developer Guide](../../../ses/latest/dg/receiving-email-concepts.md#receiving-email-concepts-rules).
