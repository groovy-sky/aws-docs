...
[Configure AS2\
connectors](../../../transfer/latest/userguide/configure-as2-connector.md) and [Create SFTP\
connectors](../../../transfer/latest/userguide/configure-sftp-connector.md).
...
_Type_: [ConnectorEgressConfig](aws-properties-transfer-connector-connectoregressconfig.md)
...
_Type_: [SftpConfig](aws-properties-transfer-connector-sftpconfig.md)
...
_Type_: Array of [Tag](aws-properties-transfer-connector-tag.md)
