---
title: "AWS::DMS::ReplicationSubnetGroup"
---
...
[Creating the IAM Roles to Use With the AWS CLI and AWS DMS API](../../../dms/latest/userguide/chap-security-apirole.md)
...
_Type_: Array of [Tag](aws-properties-dms-replicationsubnetgroup-tag.md)
...
- [CreateReplicationSubnetGroup](../../../../reference/dms/latest/apireference/api-createreplicationsubnetgroup.md)
