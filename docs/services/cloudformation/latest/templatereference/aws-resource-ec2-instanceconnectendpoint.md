...
EC2 Instance Connect Endpoint](../../../ec2/latest/userguide/connect-using-ec2-instance-connect-endpoint.md) in the _Amazon EC2 User Guide_.
...
_Type_: Array of [Tag](aws-properties-ec2-instanceconnectendpoint-tag.md)
