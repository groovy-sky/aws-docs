...
For a sample CloudFormation template, see the [AWS Backup Developer Guide](../../../aws-backup/latest/devguide/bam-cfn-integration.md#bam-cfn-frameworks-template).
...
_Type_: Array of [FrameworkControl](aws-properties-backup-framework-frameworkcontrol.md)
...
status](../../../aws-backup/latest/devguide/viewing-frameworks.md) in the _AWS Backup; Developer Guide_.
