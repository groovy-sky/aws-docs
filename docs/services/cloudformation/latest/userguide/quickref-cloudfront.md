...
using an [S3Origin](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-cloudfront-distribution-s3originconfig.html) and legacy origin access identity (OAI). For information about
...
The following example template shows an Amazon CloudFront [Distribution](../templatereference/aws-resource-cloudfront-distribution.md)
using a [CustomOrigin](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-cloudfront-distribution-customoriginconfig.html).
...
for a CloudFront distribution, see [Alias resource record set for a CloudFront distribution](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/quickref-route53.html#scenario-user-friendly-url-for-cloudfront-distribution).
