...
description of each field in a change set, see the [Change](../../../../reference/awscloudformation/latest/apireference/api-change.md) data type in the _AWS CloudFormation API Reference_.

You can use the [console](using-cfn-updating-stacks-changesets-view.md),
AWS CLI, or CloudFormation [DescribeChangeSet](../../../../reference/awscloudformation/latest/apireference/api-describechangeset.md) API operation to view change set details.
