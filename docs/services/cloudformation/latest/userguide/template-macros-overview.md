...
- To process an entire template, reference the macro in the [Transform](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/transform-section-structure.html) section of the
template.
...
to CloudFormation. For more information, see [Macro evaluation order](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros-author.html#template-macros-order).
...
AWS Lambda](https://docs.aws.amazon.com/lambda/latest/dg/lambda-permissions.html) in the _AWS Lambda Developer Guide_ and [Actions,\
resources, and condition keys for AWS Lambda](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awslambda.html) in the
