...
10. (Optional) If your imported resources don't match their expected template configurations,
     ...
     information about importing drifted resources, see [Resolve drift with an import operation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/resource-import-resolve-drift.html).
...
6. (Optional) Run drift detection on the `IMPORT_COMPLETE` stack to make sure the
    ...
    detecting drift, see [Detect drift on an entire CloudFormation stack](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/detect-drift-stack.html).
