...
information about the CloudFormation commands, see [cloudformation](../../../cli/latest/reference/cloudformation.md) in the
...
cmdlets for CloudFormation in the [AWS Tools for PowerShell Cmdlet Reference](../../../powershell/latest/reference/index.md).
...
more information about the API actions for CloudFormation, see [Actions](../../../../reference/awscloudformation/latest/apireference/api-operations.md) in the
