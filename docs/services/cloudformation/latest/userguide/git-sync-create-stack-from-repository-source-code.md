...
Before you continue, complete all [prerequisites](git-sync-prereq.md)
...
14. (Optional) To specify the stack parameters, choose **Add**
    **parameter**, provide a key and value for each parameter, and then
     choose **Next**. For more information, see [Stack deployment file](git-sync-concepts-terms.md#git-sync-concepts-terms-depoyment-file).
...
15. (Optional) To specify stack tags, choose **Add new tag**,
     ...
     **Next**. For more information, see [Stack deployment file](git-sync-concepts-terms.md#git-sync-concepts-terms-depoyment-file).
