...
inline function source codes, see [AWS::Lambda::Function Code](aws-properties-lambda-function-code.md#cfn-lambda-function-code-zipfile).
...
[AWS::CloudFormation::CustomResource](aws-resource-cloudformation-customresource.md) resource
`CFNWaiterCustomResource`
