...
[cfn-signal wait condition data](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/cfn-signal.html)
...
[Custom resource response](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-cloudformation-customresource.html)
...
template](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html)
...
[Hooks per\
account](https://docs.aws.amazon.com/cloudformation-cli/latest/hooks-userguide/what-is-cloudformation-hooks.html)
...
[Hooks per\
resource](https://docs.aws.amazon.com/cloudformation-cli/latest/hooks-userguide/what-is-cloudformation-hooks.html)
...
[Hook\
configuration size](https://docs.aws.amazon.com/cloudformation-cli/latest/hooks-userguide/what-is-cloudformation-hooks.html)
...
[Mapping attributes](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/mappings-section-structure.html)
...
name](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/mappings-section-structure.html)

The maximum size of each mapping name.

255 characters

[Modules](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/modules.html)
...
[Module versions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/modules.html)
...
To register new versions, first use [DeregisterType](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_DeregisterType.html)
...
[Output name](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/outputs-section-structure.html)
...
[Parameter name](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/parameters-section-structure.html)

The maximum size of a parameter name.

255 characters

[Parameter value](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/parameters-section-structure.html)
...
[Private resources](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry.html)
...
[Private resource versions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry.html)
...
operations](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/resources-section-structure.html)
...
Use the [DescribeAccountLimits](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_DescribeAccountLimits.html) API to determine the current limit for an account in a
specific Region.

[Resource name](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/resources-section-structure.html)
...
maximum number of stacks in your AWS account. For more information, see [AWS service quotas](https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html) in the
_AWS General Reference_.

[Stack name](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacks.html)
...
in the maximum number of stack sets in your AWS account. For more information, see [AWS service quotas](https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html) in the
_AWS General Reference_.

[Stack instances](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/what-is-cfnstacksets.html)
...
[StackSets instance operations](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/what-is-cfnstacksets.html)
...
[Template body size in a request](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-guide.html)
...
[Template body size in an Amazon S3 object](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-guide.html)
...
[Template description](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-description-structure.html)
...
[Versions\
per hook](https://docs.aws.amazon.com/cloudformation-cli/latest/hooks-userguide/what-is-cloudformation-hooks.html)
...
- [Macros](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html) are currently not available in the following
Region:

- Asia Pacific (Jakarta)

- [Performing ECS blue/green deployments through CodeDeploy using\
CloudFormation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/blue-green.html) is currently not available in the following Regions:
...
are macros hosted by CloudFormation. For more information about macros, see [Template macros](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html).
