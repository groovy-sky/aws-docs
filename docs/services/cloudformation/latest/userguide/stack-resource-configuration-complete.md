...
![Diagram showing the sequence of events for resource creation and eventual consistency check in a stack.](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/images/configuration-complete.png)
