...
For more information about VPC peering and its limitations, see the [Amazon VPC Peering Guide](../../../vpc/latest/peering.md).

## Prerequisites

1. You need a peer VPC ID, a peer AWS account ID, and a [cross-account\
    access role](../../../iam/latest/userguide/id-roles-common-scenarios-aws-accounts.md) for the peering connection.
...
2. To accept the VPC peering connection, the cross-account access role must be assumable
    ...
    permissions to switch roles](../../../iam/latest/userguide/id-roles-use-permissions-to-switch.md) in the _IAM User Guide_.
...
peering](../../../vpc/latest/peering/security-iam.md) in the _Amazon VPC Peering Guide_.
