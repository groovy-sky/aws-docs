...
more information about these roles, see [Grant self-managed permissions](stacksets-prereqs-self-managed.md).
...
account. For more information, see [Service-linked roles](stacksets-orgs-activate-trusted-access.md#stacksets-orgs-service-linked-roles).
...
profiles](../../../iam/latest/userguide/id-roles-manage-delete.md) in the _IAM User Guide_.
