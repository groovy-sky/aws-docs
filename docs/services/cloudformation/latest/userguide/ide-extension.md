...
your AWS account into your template. The IDE uses the [AWS Cloud Control API (CCAPI)](https://docs.aws.amazon.com/cloudcontrolapi/latest/userguide/what-is-cloudcontrolapi.html) to retrieve the live configuration and
...
(cfn-lint)](https://github.com/aws-cloudformation/cfn-lint) and [AWS CloudFormation Guard](https://docs.aws.amazon.com/cfn-guard/latest/ug/what-is-guard.html). These
...
blocking errors are found, it proceeds to create a [drift-aware change set](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/drift-aware-change-sets.html). The IDE then
...
The IDE automatically performs a [validation check before deployment](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/validate-stack-deployments.html) and validates your template
...
set](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/drift-aware-change-sets.html) that displays any differences between your current template and
...
sets](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/drift-aware-change-sets.html) compare your processed stack configuration with the live resource
