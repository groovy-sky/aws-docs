...
is AWS Secrets Manager?](../../../secretsmanager/latest/userguide/intro.md) in the _AWS Secrets Manager User Guide_.
...
AWS Secrets Manager secrets](../../../secretsmanager/latest/userguide/rotating-secrets.md).
...
To specify a secret stored in Secrets Manager, you must have permission to call [GetSecretValue](../../../../reference/secretsmanager/latest/apireference/api-getsecretvalue.md) for the secret.
