...
parameter of the [DescribeType](../../../../reference/awscloudformation/latest/apireference/api-describetype.md) action in the _AWS CloudFormation API Reference_ and of the
[DescribeType](../../../cli/latest/reference/cloudformation/describe-type.md) command in the _AWS CLI Command Reference_. For more
...
back to the [Code](../templatereference/aws-properties-lambda-function-code.md) property type of the [AWS::Lambda::Function](../templatereference/aws-resource-lambda-function.md) resource, and
...
the value of the `Password` property of the [AWS::IAM::User LoginProfile](../templatereference/aws-properties-iam-user-loginprofile.md) property type, and
therefore CloudFormation can't include it in drift detection results.
