...
linked repositories](https://docs.aws.amazon.com/dtconsole/latest/userguide/configurations.html) in the _Developer Tools Console User_
_Guide_.
...
- [How Git sync works](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/git-sync-concepts-terms.html)

- [Prerequisites](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/git-sync-prereq.html)

- [Create a stack from repository source\
code](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/git-sync-create-stack-from-repository-source-code.html)

- [Enable comments on pull\
requests](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/gitsync-enable-comments-on-pull-requests.html)
