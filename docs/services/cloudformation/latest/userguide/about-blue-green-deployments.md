...
deployment. For more information, see [AWS::CodeDeploy::BlueGreen hook syntax](blue-green-hook-syntax.md).
...
more details on what these resources represent, see [Before you begin an Amazon ECS deployment](../../../codedeploy/latest/userguide/deployment-steps-ecs.md#deployment-steps-prerequisites-ecs) in the _AWS CodeDeploy User_
_Guide_.

RequirementResourceRequired/OptionalInitiates blue/green deployment if replaced?Amazon ECS cluster[AWS::ECS::Cluster](../templatereference/aws-resource-ecs-cluster.md)Optional. The default cluster can be used.NoAmazon ECS service[AWS::ECS::Service](../templatereference/aws-resource-ecs-service.md)Required.NoApplication or Network Load Balancer[AWS::ECS::Service LoadBalancer](../templatereference/aws-properties-ecs-service-loadbalancer.md)Required.NoProduction listener[AWS::ElasticLoadBalancingV2::Listener](../templatereference/aws-resource-elasticloadbalancingv2-listener.md)Required.NoTest listener [AWS::ElasticLoadBalancingV2::Listener](../templatereference/aws-resource-elasticloadbalancingv2-listener.md)Optional.NoTwo target groups[AWS::ElasticLoadBalancingV2::TargetGroup](../templatereference/aws-resource-elasticloadbalancingv2-targetgroup.md)Required.NoAmazon ECS task definition [AWS::ECS::TaskDefinition](../templatereference/aws-resource-ecs-taskdefinition.md)Required.YesContainer for your Amazon ECS application[AWS::ECS::TaskDefinition ContainerDefinition\
Name](../templatereference/aws-properties-ecs-taskdefinition-containerdefinition.md#cfn-ecs-taskdefinition-containerdefinition-name)Required.NoPort for your replacement task set[AWS::ECS::TaskDefinition PortMapping\
ContainerPort](../templatereference/aws-properties-ecs-taskdefinition-portmapping.md#cfn-ecs-taskdefinition-portmapping-containerport)Required.No
...
and condition keys for CodeDeploy](../../../service-authorization/latest/reference/list-awscodedeploy.md) in the _Service Authorization Reference_.
