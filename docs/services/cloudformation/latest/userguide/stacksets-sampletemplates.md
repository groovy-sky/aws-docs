...
CloudFormation StackSets in your enterprise. Templates listed in this section enable [AWS CloudTrail](../../../awscloudtrail/latest/userguide/cloudtrail-user-guide.md) or [AWS Config](../../../config/latest/developerguide/whatisconfig.md) and rules within
it.
