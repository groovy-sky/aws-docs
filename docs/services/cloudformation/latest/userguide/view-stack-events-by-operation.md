...
| ResourceStatus | The status of the resource (CREATE\_COMPLETE, UPDATE\_FAILED, etc.). |
| DetailedStatus | The detailed status of the stack. If CONFIGURATION\_COMPLETE is present, the stack resources configuration phase has completed and the stabilization of the resources is in progress. |
