...
1. Use the [detect-stack-set-drift](../../../cli/latest/reference/cloudformation/detect-stack-set-drift.md) command to detect drift on an entire StackSet
...
2. Because StackSet drift detection operations can be a long-running operation,
    use the [describe-stack-set-operation](../../../cli/latest/reference/cloudformation/describe-stack-set-operation.md) command to monitor the status of drift
...
The [describe-stack-set](../../../cli/latest/reference/cloudformation/describe-stack-set.md) command includes the same detailed drift
...
You can use the [list-stack-instances](../../../cli/latest/reference/cloudformation/list-stack-instances.md) command to return summary
...
The [describe-stack-instance](../../../cli/latest/reference/cloudformation/describe-stack-instance.md) command also returns this
...
4. Once you've identified which stack instances have drifted, you can use the
    ...
    **list-stack-instances** or **describe-stack-instance**
    commands to run the [list-stack-instance-resource-drifts](../../../cli/latest/reference/cloudformation/list-stack-instance-resource-drifts.md) command. This
...
- Use the [stop-stack-set-operation](../../../cli/latest/reference/cloudformation/stop-stack-set-operation.md) command. You must
