...
in AWS Infrastructure Composer](https://docs.aws.amazon.com/infrastructure-composer/latest/dg/using-composer-basics.html).
...
1. To get the template for the stack you want to update, use the [get-template](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/get-template.html) CLI
    command.
...
like [The Ref function](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/resources-section-structure.html#resource-properties-ref)
or [The Fn::GetAtt function](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/resources-section-structure.html#resource-properties-getatt) to set a property based on another resource, CloudFormation will update the referencing
...
- You can verify the JSON or YAML syntax of your template by using the [validate-template](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/service_code_examples.html#validate-template-sdk) CLI command
