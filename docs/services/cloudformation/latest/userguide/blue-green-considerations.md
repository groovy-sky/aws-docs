...
these differences, see [Differences between Amazon ECS blue/green deployments through CodeDeploy and CloudFormation](../../../codedeploy/latest/userguide/deployments-create-ecs-cfn.md#differences-ecs-bg-cfn) in the
