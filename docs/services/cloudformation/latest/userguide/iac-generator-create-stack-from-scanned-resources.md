...
07. On the **Template definition** tab, IaC generator might issue
     ...
     changes. For more information, see [Resolve write-only properties](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/generate-IaC-write-only-properties.html).
