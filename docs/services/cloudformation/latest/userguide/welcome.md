...
CloudFormation is available through the CloudFormation [console](https://console.aws.amazon.com/cloudformation), [API](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference),
...
For an introduction to CloudFormation, see [How CloudFormation works](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/cloudformation-overview.html).

To start using CloudFormation, see [Creating your first stack](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/gettingstarted.walkthrough.html).

## Related information

You can learn more about CloudFormation in this user guide, as well as the following
resources:

- For product details and FAQs, see the [AWS CloudFormation product page](https://aws.amazon.com/cloudformation).

- For pricing information, see [AWS CloudFormation\
