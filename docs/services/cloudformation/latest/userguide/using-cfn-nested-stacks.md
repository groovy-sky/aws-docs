...
separate these common configurations into dedicated templates. Then, you can use the [AWS::CloudFormation::Stack](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-cloudformation-stack.html) resource in other templates to
...
[AWS::CloudFormation::Stack](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-cloudformation-stack.html) resource that references
...
more information, see [Upload local artifacts to an S3 bucket with the AWS CLI](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-cli-package.html).

Next, you can use the [package](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/package.html) command to upload the nested template to an
Amazon S3 bucket.
...
template using the [deploy](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/deploy) command. For nested stacks that contain IAM
...
it rolls back. For more information, see [Control CloudFormation access with AWS Identity and Access Management](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/control-access-with-iam.html).
