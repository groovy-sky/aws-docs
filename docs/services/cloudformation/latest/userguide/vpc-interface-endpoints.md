...
prerequisites in the [Access an AWS service using an interface VPC endpoint](../../../vpc/latest/privatelink/create-interface-endpoint.md) topic in the
...
[CloudFormation endpoints and quotas](../../../../general/latest/gr/cfn.md) page
...
Amazon VPC](../../../vpc/latest/userguide/vpc-dhcp-options.md) in the Amazon VPC User Guide.
...
AWS Command Line Interface (AWS CLI). For more information, see [Create a VPC endpoint](../../../vpc/latest/privatelink/create-interface-endpoint.md#create-interface-endpoint-aws) in the
_AWS PrivateLink Guide_.
...
For a complete list of CloudFormation endpoints, see [CloudFormation endpoints and quotas](../../../../general/latest/gr/cfn.md) in the
...
For more information, see [Control access to VPC endpoints using endpoint policies](../../../vpc/latest/privatelink/vpc-endpoints-access.md) in the
_AWS PrivateLink Guide_.
