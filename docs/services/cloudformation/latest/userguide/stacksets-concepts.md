...
concepts for AWS Organizations](../../../organizations/latest/userguide/orgs-getting-started-concepts.md).
...
that you can use with AWS Organizations](../../../organizations/latest/userguide/orgs-integrate-services-list.md).
...
the concurrency level behaves during StackSet operations. For more information, see [Choose the Concurrency Mode for CloudFormation StackSets](concurrency-mode.md).
...
- A [CreateStackSet](../../../../reference/awscloudformation/latest/apireference/api-createstackset.md) or [UpdateStackSet](../../../../reference/awscloudformation/latest/apireference/api-updatestackset.md) operation on the associated stack
failed.

- The stack was part of a [CreateStackSet](../../../../reference/awscloudformation/latest/apireference/api-createstackset.md) or [UpdateStackSet](../../../../reference/awscloudformation/latest/apireference/api-updatestackset.md) operation that failed, or stopped before
creating or updating the stack.

`INOPERABLE`

A [DeleteStackInstances](../../../../reference/awscloudformation/latest/apireference/api-deletestackinstances.md) operation has failed and left the stack
in an unstable state. Stacks in this state are excluded from further [UpdateStackSet](../../../../reference/awscloudformation/latest/apireference/api-updatestackset.md) operations. You might need to perform a
[DeleteStackInstances](../../../../reference/awscloudformation/latest/apireference/api-deletestackinstances.md) operation, with
