...
05. Under **Permissions**, choose **Service-managed**
    **permissions**.
    ...
    organization's management account has permissions to [Activate trusted access for StackSets with AWS Organizations](stacksets-orgs-activate-trusted-access.md).
...
14. Under **Automatic deployment**, choose whether to
     ...
     or OUs in the future. For more information, see [Enable or disable automatic deployments for StackSets in AWS Organizations](stacksets-orgs-manage-auto-deployment.md).
...
see [Enable or disable automatic deployments for StackSets in AWS Organizations](stacksets-orgs-manage-auto-deployment.md).
...
1. Use the [create-stack-set](../../../cli/latest/reference/cloudformation/create-stack-set.md) command to
    ...
    accounts are removed. For more information, see [Enable or disable automatic deployments for StackSets in AWS Organizations](stacksets-orgs-manage-auto-deployment.md).
...
2. Use the [list-stack-sets](../../../cli/latest/reference/cloudformation/list-stack-sets.md) command to
...
3. Use the [create-stack-instances](../../../cli/latest/reference/cloudformation/create-stack-instances.md) command
...
4. Using the `operation-id` that was returned as part
    ...
    following [describe-stack-set-operation](../../../cli/latest/reference/cloudformation/describe-stack-set-operation.md)
...
[DeploymentTargets](../../../../reference/awscloudformation/latest/apireference/api-deploymenttargets.md).
