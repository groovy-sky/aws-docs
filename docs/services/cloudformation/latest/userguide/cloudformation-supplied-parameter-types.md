...
a default value and allowed values. For more information, see [CloudFormation template Parameters syntax](parameters-section-structure.md).
...
IDs. For information about the Parameter Store, see [Systems Manager Parameter Store](../../../systems-manager/latest/userguide/systems-manager-parameter-store.md).
...
AMI. For more information about public parameters, see [Discovering public parameters in Parameter Store](../../../systems-manager/latest/userguide/parameter-store-finding-public-parameters.md) in the
...
The following [create-stack](../../../cli/latest/reference/cloudformation/create-stack.md) command creates a stack based on the
example template.
...
information, see [Get values stored in other services using dynamic references](dynamic-references.md).
...
**Parameters** tab in the console, or by running [describe-stacks](../../../cli/latest/reference/cloudformation/describe-stacks.md) or [describe-change-set](../../../cli/latest/reference/cloudformation/describe-change-set.md). Remember, these values are
