...
instance's Availability Zone. For more information about the DNS name structure, see [Mounting File Systems](../../../efs/latest/ug/mounting-fs.md) in the
...
for EC2 instances and mount targets, see [Security](../../../efs/latest/ug/security-considerations.md) in the [_Amazon Elastic File System User Guide_](../../../efs/latest/ug.md).
