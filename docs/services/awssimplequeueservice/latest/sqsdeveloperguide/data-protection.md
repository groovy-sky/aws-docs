...
applies to data protection in Amazon Simple Queue Service. As described in this model, AWS is
...
customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with Amazon SQS or other AWS services
