...
02. Choose the mesh that you want to create the route in. All of the
     meshes that you own and that have been [shared](sharing.md) with you are listed.

03. Choose **Virtual routers** in the left
     navigation.

04. Choose the virtual router that you want to associate a new route
     with. If none are listed, then you need to [create a virtual router](https://docs.aws.amazon.com/app-mesh/latest/userguide/virtual_routers.html#create-virtual-router)
     first.

05. In the **Routes** table, choose **Create**
    **route**. To create a route, your account ID must be
     listed as the **Resource owner** of the
     route.

06. For **Route name**, specify the name to use for
     your route.

07. For **Route type**, choose the protocol that you
...
08. (Optional) For **Route priority**, specify a
...
09. (Optional) Choose **Additional configuration**.
...
10. For **Target configuration**, select the existing
    ...
    **target** to add additional targets. The percentage for
     ...
     you must [create](https://docs.aws.amazon.com/app-mesh/latest/userguide/virtual_nodes.html#vn-create-virtual-node) one
     first. If the selected virtual node has multiple listeners,
     **Target port** is **required**.

11. For **Match** configuration, specify:

    _**Match** configuration_
    _is not available for `tcp`_
...
the [create-route](https://docs.aws.amazon.com/cli/latest/reference/appmesh/create-route.html) command in the AWS CLI reference.
...
more information, see [Virtual Nodes](https://docs.aws.amazon.com/app-mesh/latest/userguide/virtual_nodes.html).
...
virtual nodes. For more information, see [Virtual Nodes](https://docs.aws.amazon.com/app-mesh/latest/userguide/virtual_nodes.html).
...
the [delete-route](https://docs.aws.amazon.com/cli/latest/reference/appmesh/delete-route.html) command in the AWS CLI reference.
