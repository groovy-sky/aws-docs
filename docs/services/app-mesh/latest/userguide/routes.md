...
04. Choose the virtual router that you want to associate a new route
     with. If none are listed, then you need to [create a virtual router](virtual-routers.md#create-virtual-router)
     first.
...
10. For **Target configuration**, select the existing
    ...
    **target** to add additional targets. The percentage for
     ...
     you must [create](virtual-nodes.md#vn-create-virtual-node) one
...
the [create-route](../../../cli/latest/reference/appmesh/create-route.md) command in the AWS CLI reference.
...
more information, see [Virtual Nodes](virtual-nodes.md).
...
virtual nodes. For more information, see [Virtual Nodes](virtual-nodes.md).
...
the [delete-route](../../../cli/latest/reference/appmesh/delete-route.md) command in the AWS CLI reference.
