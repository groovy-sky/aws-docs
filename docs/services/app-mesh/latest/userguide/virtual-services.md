...
App Mesh API. For more information, see [Default route retry policy](https://docs.aws.amazon.com/app-mesh/latest/userguide/envoy-defaults.html#default-retry-policy).
...
App Mesh, see the [create-virtual-service](https://docs.aws.amazon.com/cli/latest/reference/appmesh/create-virtual-service.html) command in the AWS CLI reference.
...
App Mesh, see the [delete-virtual-service](https://docs.aws.amazon.com/cli/latest/reference/appmesh/delete-virtual-service.html) command in the AWS CLI reference.
