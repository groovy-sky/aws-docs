...
<a name="sharing-permissions-iam-principal"></a>
...
For more information about the way the AWS Resource Access Manager service uses IAM, see [How AWS RAM uses IAM](https://docs.aws.amazon.com/ram/latest/userguide/security-iam-policies.html) in the *AWS Resource Access Manager User Guide*.

### Granting permissions for a mesh
<a name="sharing-permissions-resource"></a>
