...
AWS RAM uses IAM](https://docs.aws.amazon.com/ram/latest/userguide/security-iam-policies.html) in the _AWS Resource Access Manager User_
_Guide_.
...
a Subnet](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-sharing.html#vpc-sharing-share-subnet).
...
For more information about AWS RAM, see the _[AWS RAM User Guide](https://docs.aws.amazon.com/ram/latest/userguide)_.
...
For instructions, see [Creating a Resource Share](https://docs.aws.amazon.com/ram/latest/userguide/working-with-sharing.html#working-with-sharing-create) in the _AWS RAM User Guide_.
...
more information, see [Creating a service mesh](https://docs.aws.amazon.com/app-mesh/latest/userguide/meshes.html#create-mesh).

###### To share a mesh that you own using the AWS CLI

Use the [create-resource-share](https://docs.aws.amazon.com/cli/latest/reference/ram/create-resource-share.html) command. For the `--resource-arns`
...
For instructions, see [Updating a Resource Share](https://docs.aws.amazon.com/ram/latest/userguide/working-with-sharing.html#working-with-sharing-update) in the _AWS RAM User Guide_.
...
[App Mesh service quotas](https://docs.aws.amazon.com/app-mesh/latest/userguide/service-quotas.html). The AWS Resource Access Manager
service also has quotas. For more information, see [Service\
Quotas](https://docs.aws.amazon.com/ram/latest/userguide/what-is.html#what-is-limits).
