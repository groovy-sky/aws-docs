...
All [supported](https://docs.aws.amazon.com/general/latest/gr/appmesh.html)
...
information, see [Amazon ECR Managed Policies](https://docs.aws.amazon.com/AmazonECR/latest/userguide/ecr_managed_policies.html).
