...
1. In **Primary color**, choose the color that is applied to certain components and your app's navigation. You can choose a
      ...
      App Studio will automatically ensure your colors are accessible. For example, if you choose a light color in light mode, it will be updated to be
      more accessible.

2. In **Header color**, choose the color that is applied to your app's header. You can choose a
       color with the color picker, RGB, HSL, or HEX code.

3. Choose **Default themes** to view and choose from predefined themes, or choose **Randomize** to generate a random
       primary and header color.
