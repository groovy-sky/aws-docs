...
- [Adding an automation action](automations-actions-add-edit-delete.md#automations-actions-add)

- [Viewing and editing automation action properties](automations-actions-add-edit-delete.md#automations-actions-edit)

- [Deleting an automation action](automations-actions-add-edit-delete.md#automations-actions-delete)
...
4. In the right-hand **Action** menu, choose the action you want to add, or drag and drop the action into the canvas. After the action is created, you can
    ...
    action properties and configuring them, see [Automation actions reference](automations-actions-reference.md).
