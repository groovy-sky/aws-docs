...
If you are using GoDaddy, see [Updating DNS records for a domain managed by GoDaddy](https://docs.aws.amazon.com/amplify/latest/userguide/to-add-a-custom-domain-managed-by-godaddy.html) for instructions specific to this provider.
...
- If you're using GoDaddy, go to [Updating DNS records for a domain managed by GoDaddy](https://docs.aws.amazon.com/amplify/latest/userguide/to-add-a-custom-domain-managed-by-godaddy.html).
...
up to 48 hours. For help resolving errors that occur, see [Troubleshooting custom domains](https://docs.aws.amazon.com/amplify/latest/userguide/custom-domain-troubleshoot-guide.html).
