...
information about quotas, see [Amplify Hosting service quotas](https://docs.aws.amazon.com/amplify/latest/userguide/quotas-chapter.html).
...
specific resources. For more information, see [Adding an SSR Compute role to allow access to AWS resources](https://docs.aws.amazon.com/amplify/latest/userguide/amplify-SSR-compute-role.html) .
...
Amplify GitHub App. For migration instructions, see [Migrating an existing OAuth app to the Amplify GitHub App](https://docs.aws.amazon.com/amplify/latest/userguide/setting-up-GitHub-access.html#migrating-to-github-app-auth).
...
code](https://docs.aws.amazon.com/amplify/latest/userguide/getting-started.html).
...
deployments for your app. For instructions on setting up automatic subdomains, see [Setting up automatic subdomains for an Amazon Route 53 custom domain](https://docs.aws.amazon.com/amplify/latest/userguide/to-set-up-automatic-subdomains-for-a-Route-53-custom-domain.html).
