...
- [Team workflows with fullstack Amplify Gen 2 apps](https://docs.aws.amazon.com/amplify/latest/userguide/team-workflows-gen2.html)

- [Team workflows with fullstack Amplify Gen 1 apps](https://docs.aws.amazon.com/amplify/latest/userguide/team-workflows-with-amplify-cli-backend-environments.html)

- [Pattern-based feature branch deployments](https://docs.aws.amazon.com/amplify/latest/userguide/pattern-based-feature-branch-deployments.html)

- [Automatic build-time generation of Amplify config (Gen 1 apps only)](https://docs.aws.amazon.com/amplify/latest/userguide/amplify-config-autogeneration.html)

- [Conditional backend builds (Gen 1 apps only)](https://docs.aws.amazon.com/amplify/latest/userguide/conditional-backends.html)

- [Use Amplify backends across apps (Gen 1 apps only)](https://docs.aws.amazon.com/amplify/latest/userguide/reuse-backends.html)
