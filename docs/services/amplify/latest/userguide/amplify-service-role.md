...
action. For more information, see [Cross-service confused deputy prevention](cross-service-confused-deputy-prevention.md).
...
[Modifying a role\
(console)](../../../iam/latest/userguide/roles-managingrole-editing-console.md) in the _IAM User Guide_.
