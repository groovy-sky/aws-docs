...
certificate. For help with resolving errors that occur, see [Troubleshooting custom domains](https://docs.aws.amazon.com/amplify/latest/userguide/custom-domain-troubleshoot-guide.html).
