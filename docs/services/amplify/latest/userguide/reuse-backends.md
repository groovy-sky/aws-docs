...
4. Select an existing service role to give Amplify the permissions it
       ...
       information about creating a service role, see [Adding a service role with permissions to deploy backend resources](amplify-service-role.md).
...
08. If you need to set up a service role to give Amplify the permissions it
     ...
     this task. For more information about creating a service role, see [Adding a service role with permissions to deploy backend resources](amplify-service-role.md).
