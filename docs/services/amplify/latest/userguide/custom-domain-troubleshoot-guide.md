...
console, consult [Troubleshooting custom domains](troubleshooting-custom-domains.md) in the Amplify troubleshooting
chapter. If you don't see a solution to your issue there, contact Support. For more
