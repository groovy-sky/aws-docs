...
_Examples_ topic of your preferred [programming language](https://docs.aws.amazon.com/amazon-s3-encryption-client/latest/developerguide/programming-languages.html).
