...
- .NET (v2) ( [AWS SDK for .NET](../../../../reference/sdk-for-net/v3/developer-guide/kms-keys-s3-encryption.md))

- Ruby (v2) ( [AWS SDK for Ruby](../../../../reference/sdk-for-ruby/v3/api/aws/s3/encryptionv2/client.md))

- PHP (v3) ( [AWS SDK for PHP](../../../../reference/sdk-for-php/latest/developer-guide/s3-encryption-client.md))
