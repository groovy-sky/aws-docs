...
1. Complete the setup steps in [Setting up for App Runner](https://docs.aws.amazon.com/apprunner/latest/dg/setting-up.html).
...
dashboard. For information about App Runner logs, see [Viewing App Runner logs streamed to CloudWatch Logs](https://docs.aws.amazon.com/apprunner/latest/dg/monitor-cwl.html).
...
Consider also deleting the GitHub and Bitbucket connections that you created as part of this tutorial. For more information, see [Managing App Runner connections](https://docs.aws.amazon.com/apprunner/latest/dg/manage-connections.html).

## What's next

Now that you've deployed your first App Runner service, learn more in the following topics:

- [App Runner architecture and concepts](https://docs.aws.amazon.com/apprunner/latest/dg/architecture.html) – The architecture, main concepts, and AWS resources related to App Runner.

- [Image-based service](https://docs.aws.amazon.com/apprunner/latest/dg/service-source-image.html) and [Code-based service](https://docs.aws.amazon.com/apprunner/latest/dg/service-source-code.html) – The two types of application source that App Runner can deploy.

- [Developing application code for App Runner](https://docs.aws.amazon.com/apprunner/latest/dg/develop.html) – Things you should know when developing or migrating application code for deployment to App Runner.

- [Using the App Runner console](https://docs.aws.amazon.com/apprunner/latest/dg/console.html) – Manage and monitor your service using the App Runner console.

- [Managing your App Runner service](https://docs.aws.amazon.com/apprunner/latest/dg/manage.html) – Manage the lifecycle of your App Runner service.

- [Observability for your App Runner service](https://docs.aws.amazon.com/apprunner/latest/dg/monitor.html) – Get visibility into your App Runner service operations by monitoring metrics, reading logs, handling events, tracking
service action calls, and tracing application events like HTTP calls.

- [App Runner configuration file](https://docs.aws.amazon.com/apprunner/latest/dg/config-file.html) – A configuration-based way to specify options for the build and runtime
behavior of your App Runner service.

- [The App Runner API](https://docs.aws.amazon.com/apprunner/latest/dg/api.html) – Use the App Runner application programming interface (API) to create, read, update, and delete App Runner resources.

- [Security in App Runner](https://docs.aws.amazon.com/apprunner/latest/dg/security.html) – The different ways that AWS and you ensure cloud security while you use App Runner and other services.
