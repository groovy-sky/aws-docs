...
- An SSL/TLS certificate in [AWS Certificate Manager](../../../acm/latest/userguide/acm-overview.md) (ACM) that matches your custom domain. [Request a public ACM certificate](https://docs.aws.amazon.com/acm/latest/userguide/gs-acm-request-public.html)
...
- Create an [IAM\
role with ECS Express Mode](https://github.com/marketplace/actions/amazon-ecs-deploy-express-service-action-for-github-actions) and [Amazon Elastic Container Registry permissions](https://docs.aws.amazon.com/AmazonECR/latest/userguide/ECR_on_ECS.html)
