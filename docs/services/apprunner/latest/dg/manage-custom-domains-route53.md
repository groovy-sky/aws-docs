...
records](../../../route53/latest/developerguide/resource-record-sets-choosing-alias-non-alias.md), in the _Amazon Route 53 Developer Guide_.
...
- **Routing policy**: Choose the applicable routing policy. For more information, see [Choosing a routing policy](../../../route53/latest/developerguide/routing-policy.md).
...
To configure Amazon Route 53 alias record using the Amazon Route 53 API or AWS CLI call the [ChangeResourceRecordSets](../../../../reference/route53/latest/apireference/api-changeresourcerecordsets.md) API action. To learn about the target hosted zone id of Route 53, see [Service endpoints](../../../../general/latest/gr/apprunner.md).
