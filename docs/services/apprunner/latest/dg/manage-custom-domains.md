---
title: "Managing custom domain names for an App Runner service"
---
...
customize domain name resolution for Amazon VPC traffic. For more information about private hosted zones, see [Working with private hosted zones](../../../route53/latest/developerguide/hosted-zones-private.md) in the Route 53
documentation.
...
information about how to resolve issues that are related to the renewal of the certificate, see [Custom domain certificate renewal](manage-custom-domain-troubleshoot.md#certificate-renewal.troubleshoot).
...
- [Certification Authority Authorization (CAA) problems](../../../acm/latest/userguide/troubleshooting-caa.md)
...
You can purchase a domain name from Amazon Route 53 or another provider. To purchase a domain name with Amazon Route 53, see [Registering a new domain](../../../route53/latest/developerguide/domain-register.md), in the _Amazon Route 53 Developer Guide_.

For instructions on how to configure a DNS target in Route 53, see [Routing traffic to your resources](../../../route53/latest/developerguide/dns-routing-traffic-to-resources.md), in
...
the DNS configuration, skip the remainder of the steps in this procedure and then follow the instructions in [Configure an Amazon Route 53 alias record](manage-custom-domains-route53.md).
...
- For more information about **Configure certificate validation**, see [DNS Validation](../../../acm/latest/userguide/dns-validation.md) in the
...
To associate a custom domain with your service using the App Runner API or AWS CLI, call the [AssociateCustomDomain](../api/api-associatecustomdomain.md) API action. When the call succeeds, a [CustomDomain](../api/api-customdomain.md) object is
...
list of [CertificateValidationRecord](../api/api-certificatevalidationrecord.md) objects. The call also returns the target
alias that you can use to configure the DNS target. These are records that you can add to your DNS.

To disassociate a custom domain from your service using the App Runner API or AWS CLI, call the [DisassociateCustomDomain](../api/api-disassociatecustomdomain.md) API action. When the call succeeds, a [CustomDomain](../api/api-customdomain.md) object is returned that describes the custom domain that's being disassociated from
