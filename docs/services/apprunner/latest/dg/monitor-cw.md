---
title: "Viewing App Runner service metrics reported to CloudWatch"
---
...
the monitored resources. For more information, see the [Amazon CloudWatch User Guide](../../../amazoncloudwatch/latest/monitoring.md).
...
the [Amazon CloudWatch User Guide](../../../amazoncloudwatch/latest/monitoring.md).
