...
problems](../../../acm/latest/userguide/troubleshooting-caa.md)
...
- Retrieve your CNAME records using the [DescribeCustomDomains](../api/api-describecustomdomains.md) API or from the
**Custom Domain** settings in
the App Runner
console. For information about stored CNAMEs, see [CertificateValidationRecords](../api/api-customdomain.md#apprunner-Type-CustomDomain-CertificateValidationRecords).
