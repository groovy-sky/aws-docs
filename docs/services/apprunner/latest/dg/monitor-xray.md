---
title: "Tracing for your App Runner application with X-Ray"
---
...
For more information about X-Ray, see the [AWS X-Ray Developer Guide](../../../xray/latest/devguide.md).
...
role, see [Instance role](security-iam-service-with-iam.md#security_iam_service-with-iam-roles-service.instance). Add the `AWSXRayDaemonWriteAccess` managed policy to your
instance role and assign it to your service during creation.

## Enable X-Ray tracing for your App Runner service

When you [create a service](manage-create.md), App Runner disables tracing by default. You can enable X-Ray tracing for your service as
part of configuring observability. For more information, see [Manage observability](manage-configure-observability.md#manage-configure-observability.manage).

If you use the App Runner API or the AWS CLI, the [TraceConfiguration](../api/api-traceconfiguration.md) object within the [ObservabilityConfiguration](../api/api-observabilityconfiguration.md) resource object contains tracing settings. To keep tracing
...
On the **Observability** tab of the [service dashboard page](console.md#console.dashboard) in the App Runner console, choose
...
more information, see [Using ServiceLens to monitor the health of your applications](../../../amazoncloudwatch/latest/monitoring/servicelens.md) in the
