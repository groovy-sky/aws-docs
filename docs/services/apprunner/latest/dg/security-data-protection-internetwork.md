...
App Runner uses Amazon Virtual Private Cloud (Amazon VPC) to create boundaries between resources in your App Runner application and control traffic between them, your on-premises
network, and the internet. For more information about Amazon VPC security, see [Internetwork traffic privacy in\
Amazon VPC](../../../vpc/latest/userguide/vpc-security.md) in the _Amazon VPC User Guide_.
