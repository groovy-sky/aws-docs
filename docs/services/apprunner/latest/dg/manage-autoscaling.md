...
to delete a configuration that's set as the default or in use by an active service. For more information about quotas, see [App Runner resource quotas](architecture.md#architecture.quotas).
...
For more general information about shareable resources, see [Configuring service settings using sharable resources](manage-configure-resources.md).
...
When you [create a service](manage-create.md) using the App Runner console or [update a service\
configuration](manage-configure.md), you can specify an auto scaling configuration.
...
When you call the [CreateService](../api/api-createservice.md) or [UpdateService](../api/api-updateservice.md) App Runner API actions, you can use the `AutoScalingConfigurationArn` parameter to specify an auto scaling
...
- [CreateAutoScalingConfiguration](../api/api-createautoscalingconfiguration.md) – Creates a new auto scaling
configuration or a revision to an existing one.

- [UpdateDefaultAutoScalingConfiguration](../api/api-updatedefaultautoscalingconfiguration.md) –Sets an auto scaling
configuration to be the default. The existing default auto scaling configuration will be set to non-default automatically.

- [ListAutoScalingConfigurations](../api/api-listautoscalingconfigurations.md) – Returns a list of the auto
scaling configurations that are associated with your AWS account, with summary information.

- [ListServicesForAutoScalingConfiguration](../api/api-listservicesforautoscalingconfiguration.md) – Returns a list
of the associated App Runner services using an auto scaling configuration.

- [DescribeAutoScalingConfiguration](../api/api-describeautoscalingconfiguration.md) – Returns a full
description of an auto scaling configuration.

- [DeleteAutoScalingConfiguration](../api/api-deleteautoscalingconfiguration.md) – Deletes an auto scaling
...
configuration [resource quota](architecture.md#architecture.quotas) for your AWS account, you might need to delete unnecessary auto
