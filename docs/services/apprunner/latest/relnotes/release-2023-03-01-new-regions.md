---
title: "Release: App Runner adds supports for AWS Asia Pacific (Singapore), AWS Asia Pacific (Sydney), and AWS Europe (Frankfurt) Regions on March 01, 2023"
---
...
For more information on all the Regions supported by App Runner, see [AWS App Runner endpoints and quotas](../../../../general/latest/gr/apprunner.md) in
