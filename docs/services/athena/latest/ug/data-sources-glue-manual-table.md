...
03. On the **Create Table From S3 bucket data** form, for
     **Table name**, enter a name for the table. For information
     ...
     Athena, see [Name databases, tables, and columns](https://docs.aws.amazon.com/athena/latest/ug/tables-databases-columns-names.html).
...
For information about querying Apache Iceberg tables in Athena, see [Query Apache Iceberg tables](https://docs.aws.amazon.com/athena/latest/ug/querying-iceberg.html). For
information about using Delta Lake tables in Athena, see [Query Linux Foundation Delta Lake tables](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables.html).
...
expressions. For more information, see [Query Apache logs stored in Amazon S3](https://docs.aws.amazon.com/athena/latest/ug/querying-apache-logs.html).
...
and [Open CSV SerDe for processing CSV](https://docs.aws.amazon.com/athena/latest/ug/csv-serde.html).
...
more information about these properties, see [OpenX JSON SerDe](https://docs.aws.amazon.com/athena/latest/ug/openx-json-serde.html).
For information about the Hive SerDe, see [Hive JSON SerDe](https://docs.aws.amazon.com/athena/latest/ug/hive-json-serde.html).
...
10. (Optional) For **Partition details**, add one or more column
     ...
     about partitioning, see [Partition your data](https://docs.aws.amazon.com/athena/latest/ug/partitions.html).
...
12. The **Preview table query** box shows the `CREATE
     ...
     directly](https://docs.aws.amazon.com/athena/latest/ug/creating-tables-how-to.html#to-create-a-table-using-hive-ddl) in the query editor instead of using the form.
