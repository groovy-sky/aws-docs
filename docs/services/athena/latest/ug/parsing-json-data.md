...
- [Convert Athena data types to JSON](https://docs.aws.amazon.com/athena/latest/ug/converting-native-data-types-to-json.html)

- [Convert JSON to Athena data types](https://docs.aws.amazon.com/athena/latest/ug/converting-json-to-native-data-types.html)
