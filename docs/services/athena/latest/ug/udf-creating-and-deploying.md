...
For more information and requirements, see [Publishing applications](../../../serverlessrepo/latest/devguide/serverlessrepo-publishing-applications.md) in the
_AWS Serverless Application Repository Developer Guide_, [AWS SAM template concepts](../../../serverless-application-model/latest/developerguide/serverless-sam-template-basics.md) in the
_AWS Serverless Application Model Developer Guide_, and [Publishing serverless applications using the AWS SAM CLI](../../../serverless-application-model/latest/developerguide/serverless-sam-template-publishing-applications.md).
