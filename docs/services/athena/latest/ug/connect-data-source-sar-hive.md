...
![Choose the name of the Athena data source connector for Hive.](https://docs.aws.amazon.com/images/athena/latest/ug/images/connect-data-source-sar-hive-1.png)

6. Under **Application settings**, enter the parameters for your
    Lambda function.
...
metastore. For steps, see [Configure Athena to use a deployed Hive metastore connector](https://docs.aws.amazon.com/athena/latest/ug/connect-data-source-hive-existing-lambda.html).
