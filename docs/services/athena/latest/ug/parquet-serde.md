...
information, see [Create a table from query results (CTAS)](ctas.md), [Examples of CTAS queries](https://docs.aws.amazon.com/athena/latest/ug/ctas-examples.html) and [Use CTAS and INSERT INTO for ETL and data analysis](ctas-insert-into-etl.md).
