...
design patterns: Optimizing Amazon S3 performance](https://docs.aws.amazon.com/AmazonS3/latest/userguide/request-rate-perf-considerations.html).
...
- If you are using the AWS Glue Data Catalog with Athena, see [AWS Glue endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/glue.html) for service
...
For more information, see [Use partition projection with Amazon Athena](https://docs.aws.amazon.com/athena/latest/ug/partition-projection.html).

## Additional resources

- For information about partitioning options for Firehose data, see [Amazon Data Firehose example](https://docs.aws.amazon.com/athena/latest/ug/partition-projection-kinesis-firehose-example.html).
...
see [Use CTAS and INSERT INTO for ETL and data analysis](https://docs.aws.amazon.com/athena/latest/ug/ctas-insert-into-etl.html).
