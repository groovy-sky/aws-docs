...
1. [Open a new session](https://docs.aws.amazon.com/athena/latest/ug/notebooks-spark-managing.html#opening-a-previously-created-notebook) for a previously
    created notebook.
...
action and its [EngineConfiguration](https://docs.aws.amazon.com/athena/latest/APIReference/API_EngineConfiguration.html) `SparkProperties` parameter to specify the encryption configuration in
