...
For more information about creating views, see [CREATE VIEW and CREATE PROTECTED MULTI DIALECT VIEW](create-view.md) and [Examples of Athena views](https://docs.aws.amazon.com/athena/latest/ug/views-examples.html).
