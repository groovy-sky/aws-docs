...
With [IAM Identity Center](../../../singlesignon/latest/userguide/what-is.md),
...
propagation across applications](../../../singlesignon/latest/userguide/trustedidentitypropagation.md) in the
...
of the Athena [GetWorkGroup](../../../../reference/athena/latest/apireference/api-getworkgroup.md)
API action.
