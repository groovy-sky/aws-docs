...
compression levels in Athena, see [Use ZSTD compression levels](https://docs.aws.amazon.com/athena/latest/ug/compression-support-zstd-levels.html).
...
- For CTAS, see [CTAS table properties](create-table-as.md#ctas-table-properties). For examples, see [Examples of CTAS queries](https://docs.aws.amazon.com/athena/latest/ug/ctas-examples.html).
...
- [Hive table compression](https://docs.aws.amazon.com/athena/latest/ug/compression-support-hive.html)

- [Iceberg table\
compression](https://docs.aws.amazon.com/athena/latest/ug/compression-support-iceberg.html)

- [ZSTD compression\
levels](https://docs.aws.amazon.com/athena/latest/ug/compression-support-zstd-levels.html)
