...
data, and loads it into targets. For more information, see [Authoring Jobs in AWS Glue](../../../glue/latest/dg/author-job-glue.md) in the
...
For more information, see [Working with tables](../../../glue/latest/dg/console-tables.md) in the _AWS Glue Developer Guide_.
...
otherwise suboptimal format for querying in Athena. For more information, see [Triggering AWS Glue jobs](../../../glue/latest/dg/trigger-job.md)
