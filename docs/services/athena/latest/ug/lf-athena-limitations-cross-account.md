...
use this feature to implement [cross-account access](../../../lake-formation/latest/dg/access-control-cross-account.md) to Data Catalog metadata and underlying data. For
...
link](../../../lake-formation/latest/dg/resource-links-about.md) in Lake Formation to the shared database or table. When the recipient
account in Lake Formation queries the owner's table, [CloudTrail](../../../lake-formation/latest/dg/cross-account-logging.md) adds
...
[Cross-account access](../../../lake-formation/latest/dg/access-control-cross-account.md)

[How resource links\
work in Lake Formation](../../../lake-formation/latest/dg/resource-links-about.md)

[Cross-account\
CloudTrail logging](../../../lake-formation/latest/dg/cross-account-logging.md)
