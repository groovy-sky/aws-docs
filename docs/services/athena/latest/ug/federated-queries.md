...
For a list of data source connectors written and tested by Athena, see [Available data source connectors](https://docs.aws.amazon.com/athena/latest/ug/connectors-available.html).
...
underlying data source. For more information, see [Query federated views](https://docs.aws.amazon.com/athena/latest/ug/running-federated-queries.html#running-federated-queries-federated-views).
...
with federated queries or an [external Hive metastore](https://docs.aws.amazon.com/athena/latest/ug/connect-to-data-source-hive.html),
...
information, see [Create a Secrets Manager VPC private endpoint](https://docs.aws.amazon.com/secretsmanager/latest/userguide/vpc-endpoint-overview.html#vpc-endpoint-create) in the _AWS Secrets Manager User Guide_.
...
information, see [Allow access to Athena Federated Query: Example policies](https://docs.aws.amazon.com/athena/latest/ug/federated-query-iam-access.html).
...
`ecr:GetDownloadUrlForLayer`. For more information, see [Amazon ECR permissions](https://docs.aws.amazon.com/lambda/latest/dg/images-create.html#gettingstarted-images-permissions) in the
