...
For restrictions on database names in Athena, see [Name databases, tables, and columns](https://docs.aws.amazon.com/athena/latest/ug/tables-databases-columns-names.html).
