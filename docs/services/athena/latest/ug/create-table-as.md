...
as DML for Service Quotas purposes. For information about Service Quotas in Athena, see [Service Quotas](https://docs.aws.amazon.com/athena/latest/ug/service-limits.html).
...
output location that you specify for Athena query results. For more information, see [Specify a query result location using the Athena console](https://docs.aws.amazon.com/athena/latest/ug/query-results-specify-location-console.html).

For additional information about `CREATE TABLE AS` that is beyond the scope of
this reference topic, see [Create a table from query results (CTAS)](https://docs.aws.amazon.com/athena/latest/ug/ctas.html).
...
console. For more information, see [Work with query results and recent queries](https://docs.aws.amazon.com/athena/latest/ug/querying.html).
...
using these parameters, see [Examples of CTAS queries](https://docs.aws.amazon.com/athena/latest/ug/ctas-examples.html).
...
results location](https://docs.aws.amazon.com/athena/latest/ug/workgroups-settings-override.html), the query fails with an error
message. To see the query results location specified for the
workgroup, [see the\
workgroup's details](https://docs.aws.amazon.com/athena/latest/ug/viewing-details-workgroups.html).
...
client-side settings, Athena uses your [client-side setting](https://docs.aws.amazon.com/athena/latest/ug/query-results-specify-location-console.html) for the query results location
...
see [Optimize Iceberg tables](https://docs.aws.amazon.com/athena/latest/ug/querying-iceberg-data-optimization.html).
...
For more information, see [Optimize Iceberg tables](https://docs.aws.amazon.com/athena/latest/ug/querying-iceberg-data-optimization.html).
...
tables. For more information, see [Optimize Iceberg tables](https://docs.aws.amazon.com/athena/latest/ug/querying-iceberg-data-optimization.html).
...
value is 3. For more information, see [Use ZSTD compression levels](https://docs.aws.amazon.com/athena/latest/ug/compression-support-zstd-levels.html).
...
- [Use CTAS and INSERT INTO for ETL and data analysis](https://docs.aws.amazon.com/athena/latest/ug/ctas-insert-into-etl.html)
