...
- [Data type examples](https://docs.aws.amazon.com/athena/latest/ug/data-types-examples.html)

- [Considerations for data types](https://docs.aws.amazon.com/athena/latest/ug/data-types-considerations.html)

- [Work with timestamp data](https://docs.aws.amazon.com/athena/latest/ug/data-types-timestamps.html)
