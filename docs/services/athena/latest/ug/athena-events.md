...
information, see [What Is Amazon EventBridge?](../../../eventbridge/latest/userguide/eb-what-is.md) For
more information about how to set up rules, see [Getting started with\
Amazon EventBridge](../../../eventbridge/latest/userguide/eb-get-started.md).
...
`errorCategory` and `errorType`, see [Athena error catalog](error-reference.md).
...
[Athena error catalog](error-reference.md).`versionId`The version number for the detail object's schema.`currentState`The state that the query transitioned to at the time of the
...
You can use [AWS User Notifications](../../../notifications/latest/userguide/what-is.md) to set up delivery channels to get notified about
...
email, [Amazon Q Developer in chat applications](../../../chatbot/latest/adminguide/what-is.md) chat notifications, or [AWS Console Mobile Application](../../../consolemobileapp/latest/userguide/what-is-consolemobileapp.md)
...
_Guide_](../../../notifications/latest/userguide/what-is.md).
