...
Client configuration](../../../../reference/sdk-for-cpp/v1/developer-guide/client-config.md) in the _AWS SDK for C++ Developer Guide_.
...
configuration](../../../../reference/sdk-for-cpp/v1/developer-guide/client-config.md) in the _AWS SDK for C++ Developer Guide_. The
...
[AWS Client configuration](../../../../reference/sdk-for-cpp/v1/developer-guide/client-config.md) in the _AWS SDK for C++ Developer Guide_.
...
[ClientConfiguration](../../../../reference/sdk-for-cpp/v1/developer-guide/client-config.md).
...
specified, the driver uses a default Amazon S3 endpoint. For more information, see [ClientConfiguration](../../../../reference/sdk-for-cpp/v1/developer-guide/client-config.md).
