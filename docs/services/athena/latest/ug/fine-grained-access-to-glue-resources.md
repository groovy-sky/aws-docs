...
security in Lake Formation](../../../lake-formation/latest/dg/data-filtering.md).
...
differences, see [Identity-based policies and resource-based policies](../../../iam/latest/userguide/access-policies-identity-vs-resource.md) in the
_IAM User Guide_.
...
policies](../../../iam/latest/userguide/access-policies-create.md) in the _IAM User Guide_.Learn about IAM identity-based policies used in AWS Glue[Identity-based policies (IAM policies)](../../../glue/latest/dg/using-identity-based-policies.md) in the _AWS Glue_
_Developer Guide_.
...
IAM Identity Center](../../../lake-formation/latest/dg/identity-center-integration.md) in the _AWS Lake Formation Developer Guide_.
...
resources, see [List of ARNs in Data Catalog](../../../glue/latest/dg/glue-specifying-resource-arns.md#data-catalog-resource-arns) in the _AWS Glue Developer_
_Guide_.
...
resources reference](../../../glue/latest/dg/api-permissions-reference.md) in the _AWS Glue Developer Guide_.
