...
information about configuring federation for Okta and Amazon Athena, see [Configure SSO for ODBC using the Okta plugin and Okta Identity Provider](https://docs.aws.amazon.com/athena/latest/ug/odbc-okta-plugin.html).
...
roles, see [AssumeRole](https://docs.aws.amazon.com/STS/latest/APIReference/API_AssumeRole.html) in the _AWS Security Token Service API Reference_.
...
steps, see [Retrieve ODBC configuration information from Okta](https://docs.aws.amazon.com/athena/latest/ug/odbc-okta-plugin.html#odbc-okta-plugin-retrieve-odbc-configuration-information-from-okta). The first segment after `https://`, up to and including
...
parameter from the **Embed Link** URL in your Okta application. For
steps, see [Retrieve ODBC configuration information from Okta](https://docs.aws.amazon.com/athena/latest/ug/odbc-okta-plugin.html#odbc-okta-plugin-retrieve-odbc-configuration-information-from-okta). The application ID is the last two segments of the URL, including the forward slash
