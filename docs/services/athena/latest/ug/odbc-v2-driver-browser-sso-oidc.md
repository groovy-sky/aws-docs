...
Enable IAM Identity Center](../../../singlesignon/latest/userguide/get-started-enable-identity-center.md) in the _AWS IAM Identity Center User Guide_.
...
The URL for the AWS access portal. The IAM Identity Center [RegisterClient](../../../../reference/singlesignon/latest/oidcapireference/api-registerclient.md) API action uses this value for the
`issuerUrl` parameter.
...
restricts permissions when an access token is granted. The IAM Identity Center [RegisterClient](../../../../reference/singlesignon/latest/oidcapireference/api-registerclient.md) API action uses this value for the `scopes`
parameter.
...
The identifier for the AWS account that is assigned to the user. The IAM Identity Center [GetRoleCredentials](../../../../reference/singlesignon/latest/portalapireference/api-getrolecredentials.md) API uses this value for the `accountId`
parameter.
...
IAM Identity Center [GetRoleCredentials](../../../../reference/singlesignon/latest/portalapireference/api-getrolecredentials.md) API action uses this value for the `roleName`
parameter.
