...
see [Configure access to prepared statements](https://docs.aws.amazon.com/athena/latest/ug/security-iam-athena-prepared-statements.html).
...
- [Additional resources](https://docs.aws.amazon.com/athena/latest/ug/querying-with-prepared-statements-additional-resources.html)
