...
Athena has a limit of 100 partitions per `CREATE TABLE AS SELECT` ( [CTAS](https://docs.aws.amazon.com/athena/latest/ug/ctas.html)) query. Similarly, you can add a maximum
of 100 partitions to a destination table with an [INSERT INTO](insert-into.md)
statement.
...
The following example adds partitions for the dates from the month of February
    1992.
