...
information, see [View execution plans for SQL queries](https://docs.aws.amazon.com/athena/latest/ug/query-plans.html).
...
console, see [View execution plans for SQL queries](https://docs.aws.amazon.com/athena/latest/ug/query-plans.html).
...
`EXPLAIN` queries, see [Understand Athena EXPLAIN statement results](https://docs.aws.amazon.com/athena/latest/ug/athena-explain-statement-understanding.html).
...
- [View execution plans for SQL queries](https://docs.aws.amazon.com/athena/latest/ug/query-plans.html)
