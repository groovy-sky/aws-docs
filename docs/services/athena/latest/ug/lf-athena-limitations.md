...
additional information, see [Known issues for AWS Lake Formation](../../../lake-formation/latest/dg/limitations.md) in
...
accounts, see [Configure cross-account Data Catalog access](lf-athena-limitations-cross-account.md).
...
For more information, see [DESCRIBE](../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-describe) in the _AWS Lake Formation Developer Guide_.
