...
- [Search for values in JSON arrays](https://docs.aws.amazon.com/athena/latest/ug/searching-for-values.html)

- [Get the length and size of JSON arrays](https://docs.aws.amazon.com/athena/latest/ug/length-and-size.html)

- [Troubleshoot JSON queries](https://docs.aws.amazon.com/athena/latest/ug/json-troubleshooting.html)
