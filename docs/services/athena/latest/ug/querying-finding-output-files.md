...
information, see [Download query results files using the Athena console](saving-query-results.md).
...
output parameter, see [get-query-execution](../../../cli/latest/reference/athena/get-query-execution.md) in the
