...
## 2.2.0.1
<a name="odbc-v2-driver-release-notes-2026-07-06"></a>

Released 2026-07-06

### Fixes
<a name="odbc-v2-driver-release-notes-2026-07-06-fixes"></a>
+ Fixed an issue that caused some browser-based authentication requests to fail because of a missing `Content-Length` header.
+ Fixed an issue that caused query parameters to be truncated when you use `SQL_C_WCHAR` bindings.
+ The license file now includes a reference to the AWS Service Terms.
...
### Fixes
<a name="odbc-v2-driver-release-notes-2026-05-29-fixes"></a>
...
To download the new ODBC v2 driver, see [ODBC 2.x driver download](odbc-v2-driver.md#odbc-v2-driver-download). For connection information, see [Amazon Athena ODBC 2.x](odbc-v2-driver.md). On Windows, uninstall the previous version before upgrading to 2.2.0.0.
