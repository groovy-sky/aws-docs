...
information, see [Partition your data](https://docs.aws.amazon.com/athena/latest/ug/partitions.html).

In Athena, a table and its partitions must use the same data formats but their schemas may
differ. For more information, see [Update tables with partitions](https://docs.aws.amazon.com/athena/latest/ug/updates-and-partitions.html).
...
resources reference](https://docs.aws.amazon.com/glue/latest/dg/api-permissions-reference.html) and [Configure access to databases and tables in the AWS Glue Data Catalog](https://docs.aws.amazon.com/athena/latest/ug/fine-grained-access-to-glue-resources.html). For troubleshooting information
about permissions when using Athena, see the [Permissions](https://docs.aws.amazon.com/athena/latest/ug/troubleshooting-athena.html#troubleshooting-athena-permissions) section of the [Troubleshoot issues in Athena](https://docs.aws.amazon.com/athena/latest/ug/troubleshooting-athena.html) topic.
...
For more information, see [Partition your data](https://docs.aws.amazon.com/athena/latest/ug/partitions.html).
...
For additional considerations regarding working with partitions in Athena, see [Partition your data](https://docs.aws.amazon.com/athena/latest/ug/partitions.html).
