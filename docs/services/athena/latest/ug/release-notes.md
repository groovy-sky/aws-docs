...
the driver, see [Amazon Athena ODBC 2.x release notes](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-release-notes.html). To download the ODBC 2.x driver, see
...
- **Hudi 0.15.0 upgrade** –
You can now use Athena to query Hudi 0.15.0 tables. For more information, see [Query Apache Hudi datasets](https://docs.aws.amazon.com/athena/latest/ug/querying-hudi.html).
...
the driver, see [Amazon Athena JDBC 3.x release notes](https://docs.aws.amazon.com/athena/latest/ug/jdbc-v3-driver-release-notes.html). To download the latest JDBC driver, see
...
the driver, see [Amazon Athena ODBC 2.x release notes](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-release-notes.html). To download the latest JDBC driver, see
[ODBC 2.x driver download](odbc-v2-driver.md#odbc-v2-driver-download).
...
configure the new authentication methods, see [Authenticate with Snowflake](https://docs.aws.amazon.com/athena/latest/ug/connectors-snowflake-authentication.html).
...
this version of
the driver, see [Amazon Athena ODBC 2.x release notes](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-release-notes.html). To download the
...
this version of
the driver, see [Amazon Athena JDBC 3.x release notes](https://docs.aws.amazon.com/athena/latest/ug/jdbc-v3-driver-release-notes.html). To download the
latest JDBC driver, see
[JDBC 3.x driver download](jdbc-v3-driver.md#jdbc-v3-driver-download).
...
information, see [Create S3 Tables in Athena](https://docs.aws.amazon.com/athena/latest/ug/gdc-register-s3-table-bucket-cat.html#gdc-create-s3-tables-athena).
...
query results. For more information, see [Managed query results](https://docs.aws.amazon.com/athena/latest/ug/managed-results.html).
...
For more information, see [Register S3 table bucket catalogs and query Tables from Athena](https://docs.aws.amazon.com/athena/latest/ug/gdc-register-s3-table-bucket-cat.html).
...
centrally stored in the [AWS Glue Data Catalog](https://docs.aws.amazon.com/glue/latest/dg/catalog-and-crawler.html).
...
connector to Amazon DynamoDB](https://docs.aws.amazon.com/athena/latest/ug/connectors-dynamodb.html), you can reuse the properties and permissions
that you specified for the connection for an AWS Glue ETL job that accesses your
data in DynamoDB. For more information, see [Use the Athena console to connect to a data source](https://docs.aws.amazon.com/athena/latest/ug/connect-to-a-data-source-console-steps.html) in the
...
see [Register Redshift data catalogs in Athena](https://docs.aws.amazon.com/athena/latest/ug/gdc-register-rs.html).
...
more information, see [Register S3 table bucket catalogs and query Tables from Athena](https://docs.aws.amazon.com/athena/latest/ug/gdc-register-s3-table-bucket-cat.html).
...
the driver, see [Amazon Athena JDBC 3.x release notes](https://docs.aws.amazon.com/athena/latest/ug/jdbc-v3-driver-release-notes.html). To download the JDBC 3.x driver, see
[JDBC 3.x driver download](jdbc-v3-driver.md#jdbc-v3-driver-download).
...
for views. For more information, see [Query federated views](https://docs.aws.amazon.com/athena/latest/ug/running-federated-queries.html#running-federated-queries-federated-views).

- **Multiple passthrough queries** – You can
now run more than one federated passthrough query in the same query execution.
For more information, see [Use federated passthrough queries](https://docs.aws.amazon.com/athena/latest/ug/federated-query-passthrough.html).
...
vectors](https://docs.delta.io/latest/delta-deletion-vectors.html). For more information, see [Query Linux Foundation Delta Lake tables](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables.html).
...
For information about using Linux Foundation Delta Lake tables with Athena, see [Query Linux Foundation Delta Lake tables](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables.html).
...
language](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ql-reference.select.html). Federated passthrough queries are also useful when you want to run
...
For more information, see [Use federated passthrough queries](https://docs.aws.amazon.com/athena/latest/ug/federated-query-passthrough.html). To upgrade the connectors that you
use today to the latest version, see [Update a data source connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-updating.html).
...
Athena announces ODBC driver version 2.0.3.0. For more information, see the [2.0.3.0](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-release-notes.html#odbc-v2-driver-release-notes-2024-04-08) release notes. To download
...
tables, see [Query Apache Hudi datasets](https://docs.aws.amazon.com/athena/latest/ug/querying-hudi.html).
...
Athena announces ODBC driver version 2.0.2.1. For more information, see the [2.0.2.1](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-release-notes.html#odbc-v2-driver-release-notes-2023-12-07) release notes. To download
the new ODBC v2 driver, see [ODBC 2.x driver download](odbc-v2-driver.md#odbc-v2-driver-download). For connection information, see the [Amazon Athena ODBC 2.x](odbc-v2-driver.md).
...
data to S3 Express One Zone storage and catalog the data with [AWS Glue Data Catalog](https://docs.aws.amazon.com/glue/latest/dg/catalog-and-crawler.html) for a seamless
...
Lake](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-lake.html). AWS CloudTrail Lake is a managed data lake for CloudTrail that you can use
...
federation](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-federation.html) in the _AWS CloudTrail User Guide_.
...
data filter](https://docs.aws.amazon.com/lake-formation/latest/dg/creating-data-filters.html) in the _AWS Lake Formation Developer Guide_.
...
Athena announces ODBC driver version 2.0.2.0. For more information, see the [2.0.2.0](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-release-notes.html#odbc-v2-driver-release-notes-2023-10-17) release notes. To download
the new ODBC v2 driver, see [ODBC 2.x driver download](odbc-v2-driver.md#odbc-v2-driver-download). For connection information, see the [Amazon Athena ODBC 2.x](odbc-v2-driver.md).
...
Delta Lake tables with Athena, see [Query Linux Foundation Delta Lake tables](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables.html).
...
Athena announces ODBC driver version 2.0.1.1. For more information, see the [2.0.1.1](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-release-notes.html#odbc-v2-driver-release-notes-2023-08-10) release notes. To
...
For information about the Google BigQuery connector, see [Amazon Athena Google BigQuery connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-bigquery.html). For information
about updating your existing data source connectors, see [Update a data source connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-updating.html).
...
more information, see the [GetQueryExecution](https://docs.aws.amazon.com/athena/latest/APIReference/API_GetQueryExecution.html) action in the
_Amazon Athena API Reference_.
...
[2.0.1.0](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-release-notes.html#odbc-v2-driver-release-notes-2023-06-29) release notes. To
...
Athena console or the Athena API. For more information, see [Delete a capacity reservation](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-deleting-a-capacity-reservation.html) in the
_Amazon Athena User Guide_ and [DeleteCapacityReservation](https://docs.aws.amazon.com/athena/latest/APIReference/API_DeleteCapacityReservation.html) in the
_Amazon Athena API Reference_.
...
For more information, see [AWS::Athena::CapacityReservation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-capacityreservation.html) in the
...
For information about upgrading your data source connectors, see [Update a data source connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-updating.html).
...
privately using AWS PrivateLink from your [Amazon Virtual Private Cloud (Amazon VPC)](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html), in
...
endpoints, see [AWS\
service endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html) and [Amazon Athena endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/athena.html) in the
...
For more information, see [Work with data source connectors for Apache Spark](https://docs.aws.amazon.com/athena/latest/ug/connectors-spark.html).
...
information, see [Query Apache Hudi datasets](https://docs.aws.amazon.com/athena/latest/ug/querying-hudi.html)
and [Use Hudi metadata for improved performance](https://docs.aws.amazon.com/athena/latest/ug/querying-hudi-metadata-table.html).
...
For more information, see [Work with views](https://docs.aws.amazon.com/athena/latest/ug/views.html) and [Run federated queries](https://docs.aws.amazon.com/athena/latest/ug/running-federated-queries.html).
...
2023.11.1. For instructions on updating the connector, see [Update a data source connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-updating.html).
...
For more information, see [Amazon Athena Google Cloud Storage connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-gcs.html).
...
topics have been added for [Hive table compression](https://docs.aws.amazon.com/athena/latest/ug/compression-support-hive.html), [Iceberg table\
compression](https://docs.aws.amazon.com/athena/latest/ug/compression-support-iceberg.html), and [ZSTD compression\
...
For more information, see [Use an external Hive metastore](https://docs.aws.amazon.com/athena/latest/ug/connect-to-data-source-hive.html).
...
For more information, see [Amazon Athena MSK connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-msk.html).
...
available from the JDBC download page, and [Reuse query results in Athena](https://docs.aws.amazon.com/athena/latest/ug/reusing-query-results.html).

- Ec2InstanceMetadata support – The JDBC
driver now supports the [Ec2InstanceMetadata\
authentication method](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-metadata.html) using IAM [instance profiles](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_switch-role-ec2_instance-profiles.html).
...
connection strings, deployment, and limitations, see [Amazon Athena IBM Db2 connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-ibm-db2.html).
...
console](https://console.aws.amazon.com/athena/home), [drivers](athena-bi-tools-jdbc-odbc.md), or [API](https://docs.aws.amazon.com/athena/latest/APIReference/Welcome.html).

For information about using Iceberg in Athena, see [Query Apache Iceberg tables](https://docs.aws.amazon.com/athena/latest/ug/querying-iceberg.html).
...
For more information on service endpoints, see [AWS service endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html). To learn more
about Athena's service endpoints, see [Amazon Athena endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/athena.html) in the
AWS documentation.
...
[Considerations and limitations](https://docs.aws.amazon.com/athena/latest/ug/connect-to-data-source-hive.html#connect-to-a-data-source-hive-considerations) in
the topic [Use an external Hive metastore](https://docs.aws.amazon.com/athena/latest/ug/connect-to-data-source-hive.html).
...
[View statistics and execution details for completed queries](query-stats.md) and [GetQueryRuntimeStatistics](https://docs.aws.amazon.com/athena/latest/APIReference/API_GetQueryRuntimeStatistics.html).
...
using Athena to query data registered with Lake Formation, see [Use Athena to query data registered with AWS Lake Formation](https://docs.aws.amazon.com/athena/latest/ug/security-athena-lake-formation.html).
...
For more information, see [Reuse query results in Athena](https://docs.aws.amazon.com/athena/latest/ug/reusing-query-results.html).
...
For more information about the Neptune connector, see [Amazon Athena Neptune connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-neptune.html).
...
[external Hive metastore](https://docs.aws.amazon.com/athena/latest/ug/connect-to-data-source-hive.html)
...
[Iceberg\
tables](https://docs.aws.amazon.com/athena/latest/ug/querying-iceberg.html) now succeed when [Object Lock](../../../s3/latest/userguide/object-lock.md) is
...
For more information, see [Amazon Athena Oracle connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-oracle.html).
...
`disable_projection_and_casing` in the [Parameters](https://docs.aws.amazon.com/athena/latest/ug/connectors-dynamodb.html#connectors-dynamodb-parameters) section of the [Amazon Athena DynamoDB connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-dynamodb.html)
page.
...
query runtime statistics](https://docs.aws.amazon.com/athena/latest/APIReference/API_GetQueryRuntimeStatistics.html), also released today.
...
For more information about using Apache Iceberg in Athena, see [Query Apache Iceberg tables](https://docs.aws.amazon.com/athena/latest/ug/querying-iceberg.html).
...
- [Azure Data Lake Storage (ADLS) Gen2](https://docs.aws.amazon.com/athena/latest/ug/connectors-adls-gen2.html)
...
- [SAP\
HANA (Express Edition)](https://docs.aws.amazon.com/athena/latest/ug/connectors-sap-hana.html)
...
[Run federated queries](https://docs.aws.amazon.com/athena/latest/ug/running-federated-queries.html).
...
endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/athena.html).

- For information about enabling an AWS Region that is disabled by
default, see [Enabling a Region](https://docs.aws.amazon.com/general/latest/gr/rande-manage.html#rande-manage-enable).

- For information about querying across Regions, see [Query across regions](https://docs.aws.amazon.com/athena/latest/ug/querying-across-regions.html).
...
quotas](https://docs.aws.amazon.com/general/latest/gr/athena.html#amazon-athena-limits) in the _AWS General Reference_.
...
For more information, see [Athena error catalog](https://docs.aws.amazon.com/athena/latest/ug/error-reference.html).
...
[Injected type](https://docs.aws.amazon.com/athena/latest/ug/partition-projection-supported-types.html#partition-projection-injected-type).
...
transactions are compatible with other services and engines such as [Amazon EMR](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-what-is-emr.html) and [Apache Spark](https://spark.apache.org/) that
...
For more information, see [Use Athena ACID transactions](https://docs.aws.amazon.com/athena/latest/ug/acid-transactions.html).
...
tables, Athena now supports [AWS Glue partition indexes](https://docs.aws.amazon.com/glue/latest/dg/partition-indexes.html).
...
For information about enabling cross-account federated queries, see [Enable cross-account federated queries](https://docs.aws.amazon.com/athena/latest/ug/xacct-fed-query-enable.html). To learn
about querying federated sources, see [Use Amazon Athena Federated Query](federated-queries.md) and [Run federated queries](https://docs.aws.amazon.com/athena/latest/ug/running-federated-queries.html).
...
To learn more about using Hudi with Athena, see [Query Apache Hudi datasets](https://docs.aws.amazon.com/athena/latest/ug/querying-hudi.html).
...
environment variables. For information about configuration options, parameters,
connection strings, deployment, and limitations, see [Amazon Athena Vertica connector](https://docs.aws.amazon.com/athena/latest/ug/connectors-vertica.html).
...
For more information, see [Use Machine Learning (ML) with Amazon Athena](https://docs.aws.amazon.com/athena/latest/ug/querying-mlmodel.html).
...
information about AWS PrivateLink for Athena, see [Connect to Amazon Athena using an interface VPC endpoint](https://docs.aws.amazon.com/athena/latest/ug/interface-vpc-endpoint.html).
...
- [CloudWatch\
Metrics](https://docs.aws.amazon.com/athena/latest/ug/connectors-cwmetrics.html)
...
- [Redis](https://docs.aws.amazon.com/athena/latest/ug/connectors-redis.html)

- [Timestream](https://docs.aws.amazon.com/athena/latest/ug/connectors-timestream.html)

- [TPC\
Benchmark DS (TPC-DS)](https://docs.aws.amazon.com/athena/latest/ug/connectors-tpcds.html)
...
- To get started with using an existing connector, see [Create a data source connection](https://docs.aws.amazon.com/athena/latest/ug/connect-to-a-data-source.html).
...
directly using the [Amazon States Language](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html).
...
For more information, see [Call Athena with Step Functions](https://docs.aws.amazon.com/step-functions/latest/dg/connect-athena.html) in
...
Athena](https://docs.aws.amazon.com/athena/latest/ug/connect-to-a-data-source.html), Okta service for authentication, and connections to VPC
endpoints.
...
For more information, see [Query Apache Hudi datasets](https://docs.aws.amazon.com/athena/latest/ug/querying-hudi.html).

#### CloudFormation Data Catalog Resource

To use Amazon Athena's [federated query\
feature](https://docs.aws.amazon.com/athena/latest/ug/connect-to-a-data-source.html) to query any data source, you must first register your data
...
For more information, see [AWS::Athena::DataCatalog](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-datacatalog.html) in the _CloudFormation User_
_Guide_.
...
implementation](https://docs.aws.amazon.com/athena/latest/ug/datastores-hive-reference-implementation.html) connector that you can use. The connector runs as an
...
In addition to the US East (N. Virginia) Region, the Amazon Athena [federated query](federated-queries.md), [user defined functions (UDFs)](querying-udf.md), [machine learning inference](https://docs.aws.amazon.com/athena/latest/ug/querying-mlmodel.html), and [external Hive metastore](https://docs.aws.amazon.com/athena/latest/ug/connect-to-data-source-hive.html) features are now available in preview in the
...
`AWS::Athena::WorkGroup` resource. For more information, see [AWS::Athena::WorkGroup](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html) in the _CloudFormation User Guide_.
...
Federated Query (Preview)](https://docs.aws.amazon.com/athena/latest/ug/connect-to-a-data-source.html).
...
Services](https://docs.aws.amazon.com/sagemaker/latest/dg/how-it-works-hosting.html). There is no additional setup required. You can invoke
these ML models in your SQL queries from the Athena console, [Athena APIs](https://docs.aws.amazon.com/athena/latest/APIReference/Welcome.html), and through Athena's
[preview JDBC\
...
with Amazon Athena (Preview)](https://docs.aws.amazon.com/athena/latest/ug/querying-mlmodel.html).
...
Connector for External Hive Metastore (Preview)](https://docs.aws.amazon.com/athena/latest/ug/connect-to-data-source-hive.html).
...
AWS Command Line Interface (AWS CLI). For information about creating an interface endpoint, see [Creating an Interface Endpoint](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/vpce-interface.html#create-interface-endpoint).
...
Interface VPC Endpoint](https://docs.aws.amazon.com/athena/latest/ug/interface-vpc-endpoint.html).
...
Pays buckets, see [Requester Pays Buckets](https://docs.aws.amazon.com/AmazonS3/latest/dev/RequesterPaysBuckets.html) in the Amazon Simple Storage Service Developer Guide.
...
For more information about using this feature, see [Use Athena to query data registered with AWS Lake Formation](https://docs.aws.amazon.com/athena/latest/ug/security-athena-lake-formation.html). For more information about
...
Endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html#athena). Released the new version of the ODBC driver with support for
...
best practices](https://docs.aws.amazon.com/whitepapers/latest/tagging-best-practices/tagging-best-practices.html). You can use tags to restrict access to workgroups, and to
...
Keys for Amazon Athena](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonathena.html) in the _Service Authorization Reference_.
...
For more information, see [OpenX JSON SerDe](https://docs.aws.amazon.com/athena/latest/ug/openx-json-serde.html).
...
the Transport Layer Security (TLS) requests. For more information, see [Query Network Load Balancer logs](https://docs.aws.amazon.com/athena/latest/ug/networkloadbalancer-classic-logs.html).
...
For more information about SAML 2.0 support in AWS, see [About SAML 2.0 Federation](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_saml.html)
...
- [Create CTAS queries in the Athena console](https://docs.aws.amazon.com/athena/latest/ug/ctas-console.html),
using [Examples](https://docs.aws.amazon.com/athena/latest/ug/ctas-examples.html). For information about
syntax, see [CREATE TABLE AS](create-table-as.md).

- Transform query results into other storage formats, such as PARQUET, ORC,
AVRO, JSON, and TEXTFILE. For more information, see [Considerations and limitations for CTAS queries](https://docs.aws.amazon.com/athena/latest/ug/ctas-considerations-limitations.html) and
...
time you reference the view in your query. For more information, see [Work with views](https://docs.aws.amazon.com/athena/latest/ug/views.html).
...
(Mumbai), and EU (London) regions. For information, see [Query geospatial data](https://docs.aws.amazon.com/athena/latest/ug/querying-geospatial-data.html) and
[AWS Regions and Endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html#athena).
...
Create named Athena queries with CloudFormation. For more information, see [AWS::Athena::NamedQuery](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-namedquery.html) in the
_AWS CloudFormation User Guide_.
...
unstructured text files such as logs. For more information, see [Grok SerDe](https://docs.aws.amazon.com/athena/latest/ug/grok-serde.html). Added keyboard shortcuts to
...
- Added the AWS CloudTrail SerDe, which has since been superseded by the [Hive JSON SerDe](https://docs.aws.amazon.com/athena/latest/ug/hive-json-serde.html) for reading
