...
your [service\
quotas](https://docs.aws.amazon.com/general/latest/gr/s3.html#limits_s3), or you use certain techniques like partitioning. The following are
...
the [Use partitioning](https://docs.aws.amazon.com/athena/latest/ug/performance-tuning-s3-throttling-optimizing-your-tables.html#performance-tuning-s3-throttling-use-partitioning) section
in this document.
...
- [Reading input files in larger groups](https://docs.aws.amazon.com/glue/latest/dg/grouping-input-files.html) ( _AWS Glue Developer Guide_)
