...
3. [Amazon Athena\
    console](connect-data-source-hive-existing-lambda.md) – In the Amazon Athena console, create a data
...
connect to your Hive metastore. For steps, see [Configure Athena to use a deployed Hive metastore connector](connect-data-source-hive-existing-lambda.md).
