...
[Managing cross-account permissions using both AWS Glue and Lake Formation](../../../lake-formation/latest/dg/hybrid-cross-account.md) in the
_AWS Lake Formation Developer Guide_.

[Configure cross-account access to a shared AWS Glue Data Catalog using Amazon Athena](../../../prescriptive-guidance/latest/patterns/configure-cross-account-access-to-a-shared-aws-glue-data-catalog-using-amazon-athena.md) in
