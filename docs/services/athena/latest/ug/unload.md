...
to your Athena query result location in Amazon S3. For more information, see [Identify query output files](querying-finding-output-files.md#querying-identifying-output-files).
...
can use the [EncryptionConfiguration API](../../../../reference/athena/latest/apireference/api-encryptionconfiguration.md).
...
uses DML query quotas. For quota information, see [Service Quotas](service-limits.md).
...
support](compression-formats.md).
...
[Use ZSTD compression levels](compression-support-zstd-levels.md).
