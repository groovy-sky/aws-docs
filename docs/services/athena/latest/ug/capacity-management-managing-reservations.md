...
[editing capacity](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-editing-capacity-reservations.html), [adding workgroups](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-adding-workgroups-to-a-reservation.html), [removing workgroups](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-removing-a-workgroup-from-a-reservation.html), and for [cancelling](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-cancelling-a-capacity-reservation.html) the reservation.
...
To retrieve these values programmatically, you can call the [GetCapacityReservation](https://docs.aws.amazon.com/athena/latest/APIReference/API_GetCapacityReservation.html) API action. The API refers to **Active**
**DPU** and **Target DPU** as `AllocatedDpus`
and `TargetDpus`.

###### Topics

- [Edit capacity reservations](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-editing-capacity-reservations.html)

- [Add workgroups to a reservation](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-adding-workgroups-to-a-reservation.html)

- [Remove a workgroup from a reservation](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-removing-a-workgroup-from-a-reservation.html)

- [Cancel a capacity reservation](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-cancelling-a-capacity-reservation.html)

- [Delete a capacity reservation](https://docs.aws.amazon.com/athena/latest/ug/capacity-management-deleting-a-capacity-reservation.html)
