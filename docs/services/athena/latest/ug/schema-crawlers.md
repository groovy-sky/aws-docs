...
the crawler can detect and register partitions. For more information, see [Defining crawlers](https://docs.aws.amazon.com/glue/latest/dg/add-crawler.html) in the
...
patterns](https://docs.aws.amazon.com/glue/latest/dg/define-crawler.html#crawler-data-stores-exclude) that you specify for an AWS Glue crawler. For example, if you have an
...
3. On the **AWS Glue** console **Add crawler**
    page, follow the steps to create a crawler. For more information, see [Using AWS Glue Crawlers](https://docs.aws.amazon.com/athena/latest/ug/schema-crawlers.html) in this guide and
    [Populating the\
    AWS Glue Data Catalog](https://docs.aws.amazon.com/glue/latest/dg/populate-catalog-methods.html) in the _AWS Glue Developer Guide_.

###### Note

Athena does not recognize [exclude\
patterns](https://docs.aws.amazon.com/glue/latest/dg/define-crawler.html#crawler-data-stores-exclude) that you specify for an AWS Glue crawler. For example, if you have
...
information, see [Viewing and editing table details](https://docs.aws.amazon.com/glue/latest/dg/console-tables.html#console-tables-details) in the _AWS Glue Developer_
_Guide_.
...
[Handling CSV data enclosed in quotes](https://docs.aws.amazon.com/athena/latest/ug/schema-csv.html#schema-csv-quotes).
