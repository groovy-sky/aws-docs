...
For information on importing Python libraries to Amazon Athena for Apache Spark, see [Import files and Python libraries to Athena for Spark](https://docs.aws.amazon.com/athena/latest/ug/notebooks-import-files-libraries.html).
