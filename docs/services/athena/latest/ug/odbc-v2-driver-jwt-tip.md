...
duration, see [AssumeRole](../../../../reference/sts/latest/apireference/api-assumerole.md).
...
your behalf. For more information about assuming roles, see [AssumeRole](../../../../reference/sts/latest/apireference/api-assumerole.md).
