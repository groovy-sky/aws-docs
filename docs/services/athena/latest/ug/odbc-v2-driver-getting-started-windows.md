...
07. In the **Amazon Athena ODBC Configuration** dialog box, enter the
     following information. For detailed information about these options, see [Main ODBC 2.x connection parameters](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-main-connection-parameters.html).
...
about available authentication types, see [Authentication options](https://docs.aws.amazon.com/athena/latest/ug/odbc-v2-driver-authentication-options.html).
...
credentials, see [Using temporary credentials with AWS resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_use-resources.html) in the
_IAM User Guide_.
