...
- For Apache Iceberg tables only, you can use the [ALTER TABLE CHANGE COLUMN](https://docs.aws.amazon.com/athena/latest/ug/querying-iceberg-alter-table-change-column.html) statement
