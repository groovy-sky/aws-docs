...
cleaning up results after a predetermined retention period. For more information, see [Managed query results](https://docs.aws.amazon.com/athena/latest/ug/managed-results.html).

To set up an Amazon S3 query result location for the first time, see [Specify a query result location using the Athena console](https://docs.aws.amazon.com/athena/latest/ug/query-results-specify-location-console.html).
...
Athena [GetQueryResults](https://docs.aws.amazon.com/athena/latest/APIReference/API_GetQueryResults.html) action. The query result location can be encrypted. If the
...
- [Download query results files using the Athena console](https://docs.aws.amazon.com/athena/latest/ug/saving-query-results.html)

- [View recent queries in the Athena console](https://docs.aws.amazon.com/athena/latest/ug/queries-viewing-history.html)

- [Download multiple recent queries to a CSV file](https://docs.aws.amazon.com/athena/latest/ug/queries-downloading-multiple-recent-queries-to-csv.html)

- [Configure recent query display options](https://docs.aws.amazon.com/athena/latest/ug/queries-recent-queries-configuring-options.html)

- [Keep your query history longer than 45 days](https://docs.aws.amazon.com/athena/latest/ug/querying-keeping-query-history.html)

- [Find query output files in Amazon S3](https://docs.aws.amazon.com/athena/latest/ug/querying-finding-output-files.html)
