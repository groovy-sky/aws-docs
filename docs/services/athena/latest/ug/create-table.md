...
tables in Athena and an example `CREATE TABLE` statement, see [Create tables in Athena](https://docs.aws.amazon.com/athena/latest/ug/creating-tables.html). For an example of
...
[Iceberg](https://docs.aws.amazon.com/athena/latest/ug/querying-iceberg-creating-tables.html) tables,
...
in Athena, see [Name databases, tables, and columns](https://docs.aws.amazon.com/athena/latest/ug/tables-databases-columns-names.html).
...
`float` types internally (see the [June 5, 2018](https://docs.aws.amazon.com/athena/latest/ug/release-notes.html#release-note-2018-06-05) release notes).
...
1970\. For more information, see [Open CSV SerDe for processing CSV](https://docs.aws.amazon.com/athena/latest/ug/csv-serde.html).
...
`1579059880000`). For more information, see [Open CSV SerDe for processing CSV](https://docs.aws.amazon.com/athena/latest/ug/csv-serde.html).
...
Data](https://docs.aws.amazon.com/athena/latest/ug/partitions.html).

###### Note

After you create a table with partitions, run a subsequent query that
consists of the [MSCK REPAIR\
TABLE](https://docs.aws.amazon.com/athena/latest/ug/msck-repair-table.html) clause to refresh partition metadata, for example,
...
partitioned data. For more information about table location, see [Specify a table location in Amazon S3](https://docs.aws.amazon.com/athena/latest/ug/tables-location-format.html). For information about data format and permissions, see [Amazon S3 considerations](https://docs.aws.amazon.com/athena/latest/ug/creating-tables.html#s3-considerations).
...
console, API, or CLI. For more information, see [Create tables for ETL jobs](https://docs.aws.amazon.com/athena/latest/ug/schema-classifier.html) and
[Authoring Jobs in AWS Glue](https://docs.aws.amazon.com/glue/latest/dg/author-job.html) in the
...
from 1 to 22. The default value is 3. For more information, see [Use ZSTD compression levels](https://docs.aws.amazon.com/athena/latest/ug/compression-support-zstd-levels.html).
...
For more information about creating tables, see [Create tables in Athena](https://docs.aws.amazon.com/athena/latest/ug/creating-tables.html).
