...
For more information, see [Work with Athena views](https://docs.aws.amazon.com/athena/latest/ug/views-console.html).
...
revoking permissions on Data Catalog resources](https://docs.aws.amazon.com/lake-formation/latest/dg/granting-catalog-permissions.html) in the
