...
Amazon API Gateway REST APIs, and Application Load Balancers. For more information about AWS WAF, see [AWS WAF](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html)
...
contents of the AWS WAF logs, see [Logging AWS WAF web ACL traffic](https://docs.aws.amazon.com/waf/latest/developerguide/logging.html)
in the _AWS WAF developer guide_.
...
- [Create a table for AWS WAF S3 logs in Athena using partition projection](https://docs.aws.amazon.com/athena/latest/ug/create-waf-table-partition-projection.html)

- [Create a table for AWS WAF S3 logs in Athena using manual partition](https://docs.aws.amazon.com/athena/latest/ug/create-waf-table-manual-partition.html)

- [Create a table for AWS WAF logs without partitioning](https://docs.aws.amazon.com/athena/latest/ug/create-waf-table.html)

- [Example queries for AWS WAF logs](https://docs.aws.amazon.com/athena/latest/ug/query-examples-waf-logs.html)
