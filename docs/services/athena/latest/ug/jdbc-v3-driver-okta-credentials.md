...
see [Retrieve ODBC configuration information from Okta](https://docs.aws.amazon.com/athena/latest/ug/odbc-okta-plugin.html#odbc-okta-plugin-retrieve-odbc-configuration-information-from-okta). The application ID is the last two segments of the URL, including the forward
