...
when you run the [`aws athena\
                        create-work-group`](../../../cli/latest/reference/athena/create-work-group.md) or [`aws athena\
                        update-work-group`](../../../cli/latest/reference/athena/update-work-group.md) command.
