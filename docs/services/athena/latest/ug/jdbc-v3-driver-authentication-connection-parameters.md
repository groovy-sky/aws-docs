---
title: "Authentication connection parameters"
---
...
- [AWS\
configuration profile](jdbc-v3-driver-aws-configuration-profile-credentials.md)

- [Instance\
profile](jdbc-v3-driver-instance-profile-credentials.md)
...
- [Browser Azure\
AD](jdbc-v3-driver-browser-azure-ad-credentials.md)

- [Browser\
SAML](jdbc-v3-driver-browser-saml-credentials.md)
