...
Amazon Athena](https://docs.aws.amazon.com/lake-formation/latest/dg/athena-lf.html) and [Set up permissions\
for a Delta Lake table](https://docs.aws.amazon.com/lake-formation/latest/dg/set-up-delta-table.html) in the
...
`CREATE EXTERNAL TABLE` statement, see the [Get started with Delta Lake tables](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables-getting-started.html) section.
...
[Synchronize Delta Lake metadata](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables-syncing-metadata.html).

###### Topics

- [Supported column data types](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables-supported-data-types-columns.html)

- [Get started with Delta Lake tables](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables-getting-started.html)

- [Query Delta Lake tables with SQL](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables-querying.html)

- [Synchronize Delta Lake metadata](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables-syncing-metadata.html)

- [Additional resources](https://docs.aws.amazon.com/athena/latest/ug/delta-lake-tables-additional-resources.html)
