...
When you use the [CreateWorkGroup](../../../../reference/athena/latest/apireference/api-createworkgroup.md) or [UpdateWorkGroup](../../../../reference/athena/latest/apireference/api-updateworkgroup.md) API to create or update an Athena SQL workgroup, set
