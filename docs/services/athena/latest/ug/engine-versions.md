...
AWS Health Dashboard](https://docs.aws.amazon.com/health/latest/ug/getting-started-phd.html).

Engine versioning is configured per [workgroup](https://docs.aws.amazon.com/athena/latest/ug/workgroups-manage-queries-control-costs.html). You can
...
information, see [Test queries in advance of an engine version upgrade](https://docs.aws.amazon.com/athena/latest/ug/engine-versions-changing.html#engine-versions-testing).

###### Topics

- [Change Athena engine versions](https://docs.aws.amazon.com/athena/latest/ug/engine-versions-changing.html)
