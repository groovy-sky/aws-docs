...
supported connection parameters, see [Amazon Athena JDBC 3.x connection parameters](jdbc-v3-driver-connection-parameters.md).
...
[AWSCredentialsProvider](../../../../reference/awsjavasdk/latest/javadoc/com/amazonaws/auth/awscredentialsprovider.md) interface from the previous AWS SDK for Java.
...
the same functionality in the JDBC 3.x driver, use the [AWS configuration profile credentials](jdbc-v3-driver-aws-configuration-profile-credentials.md) provider
instead.
