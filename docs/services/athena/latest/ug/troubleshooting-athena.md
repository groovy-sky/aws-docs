...
- [Athena error catalog](https://docs.aws.amazon.com/athena/latest/ug/error-reference.html)
...
patterns](https://docs.aws.amazon.com/glue/latest/dg/define-crawler.html#crawler-data-stores-exclude) that you specify an AWS Glue crawler. For example, if you have an
...
more information, see [Specify a query result location](https://docs.aws.amazon.com/athena/latest/ug/query-results-specify-location.html) in the [Work with query results and recent queries](querying.md) topic.
...
[editing\
the table schema in AWS Glue](https://docs.aws.amazon.com/glue/latest/dg/console-tables.html#console-tables-details).

## Federated queries

### Timeout while calling ListTableMetadata

A call to the [ListTableMetadata](https://docs.aws.amazon.com/athena/latest/APIReference/API_ListTableMetadata.html) API can timeout if there are lot of tables in the
...
configuration. For more information, see [Configuring function timeout (console)](https://docs.aws.amazon.com/lambda/latest/dg/configuration-function-common.html#configuration-timeout-console) in the
...
connector. Because the asynchronous nature of [StartQueryExecution](https://docs.aws.amazon.com/athena/latest/APIReference/API_StartQueryExecution.html) ensures that Athena runs the query in the
...
GitHub, or see the documentation for the individual [Athena data source connectors](https://docs.aws.amazon.com/athena/latest/ug/connectors-available.html).
...
The [OpenX JSON SerDe](https://docs.aws.amazon.com/athena/latest/ug/openx-json-serde.html) throws
...
see [JSON SerDe libraries](https://docs.aws.amazon.com/athena/latest/ug/json-serde.html). For more information,
...
The [Hive JSON SerDe](https://docs.aws.amazon.com/athena/latest/ug/hive-json-serde.html) and [OpenX JSON SerDe](https://docs.aws.amazon.com/athena/latest/ug/openx-json-serde.html) libraries expect
...
If you're using the [OpenX JSON SerDe](https://docs.aws.amazon.com/athena/latest/ug/openx-json-serde.html), make sure that the records are separated by
...
classifiers](https://docs.aws.amazon.com/glue/latest/dg/custom-classifier.html#custom-classifier-json). To work around this issue, create a new table without the
...
For more information about the Parquet Hive SerDe, see [Parquet SerDe](https://docs.aws.amazon.com/athena/latest/ug/parquet-serde.html).
...
Check that the time range unit [projection.<columnName>.interval.unit](https://docs.aws.amazon.com/athena/latest/ug/partition-projection-supported-types.html#partition-projection-date-type)
...
information, see [Integer type](https://docs.aws.amazon.com/athena/latest/ug/partition-projection-supported-types.html#partition-projection-integer-type).
...
2. You have a bucket that has [default\
    encryption](https://docs.aws.amazon.com/AmazonS3/latest/userguide/default-bucket-encryption.html) configured to use `SSE-S3`.
...
the Query Editor. You can also write your own [user defined function (UDF)](https://docs.aws.amazon.com/athena/latest/ug/querying-udf.html). For more
information, see [How\
...
contacting Support. For more information, see [Query AWS CloudTrail logs](cloudtrail-logs.md) and [Log Amazon Athena API calls with AWS CloudTrail](https://docs.aws.amazon.com/athena/latest/ug/monitor-with-cloudtrail.html).
...
For information about ways to prevent Amazon S3 throttling when you use Athena, see [Prevent Amazon S3 throttling](https://docs.aws.amazon.com/athena/latest/ug/performance-tuning-s3-throttling.html).
...
- [Name databases, tables, and columns](https://docs.aws.amazon.com/athena/latest/ug/tables-databases-columns-names.html)

- [Data types in Amazon Athena](data-types.md)

- [Choose a SerDe for your data](supported-serdes.md)

- [Use compression in Athena](https://docs.aws.amazon.com/athena/latest/ug/compression-formats.html)
