...
[SageMaker Notebooks](../../../sagemaker-unified-studio/latest/userguide/what-is-sagemaker-unified-studio.md).
...
You can use [workgroups](workgroups-manage-queries-control-costs.md) in
...
When you change the [AWS KMS key](../../../kms/latest/developerguide/concepts.md) for a workgroup, notebooks managed
...
This behavior also applies for updates to [aliases](../../../kms/latest/developerguide/kms-alias.md),
...
12. (Optional) **Tags** – Use this option to add tags to
     your workgroup. For more information, see [Tag Athena resources](tags.md).
...
permissions for notebook-enabled workgroups, see [Troubleshoot Spark-enabled workgroups](notebooks-spark-troubleshooting-workgroups.md).
...
This behavior also applies for updates to [aliases](../../../kms/latest/developerguide/kms-alias.md), which are friendly names for KMS keys.
...
2. (Optional) **Other settings** – Expand this option
    ...
    see [Monitor Apache Spark with CloudWatch metrics](notebooks-spark-metrics.md).

3. (Optional) **Tags** – Use this option to add tags
    to your workgroup. For more information, see [Tag Athena resources](tags.md).
...
see [Use non-Hive table formats in Athena for Spark](notebooks-spark-table-formats.md).
...
through Spark network nodes. For more information, see [Enable Apache Spark encryption](notebooks-spark-encryption.md).
