...
see [Control access through JDBC and ODBC connections](https://docs.aws.amazon.com/athena/latest/ug/policy-actions.html). To submit feedback
...
with Athena (for example, when using an [external Hive metastore](https://docs.aws.amazon.com/athena/latest/ug/connect-to-data-source-hive.html)
