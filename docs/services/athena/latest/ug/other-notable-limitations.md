...
AS](https://docs.aws.amazon.com/athena/latest/ug/create-table-as.html). For a workaround, see [Use CTAS and INSERT INTO to work around the 100 partition limit](https://docs.aws.amazon.com/athena/latest/ug/ctas-insert-into.html).

- Unsupported statements – Unsupported
statements include the following. For a complete list of unsupported DDL statements
in Athena, see [Unsupported DDL](https://docs.aws.amazon.com/athena/latest/ug/unsupported-ddl.html).
...
formats. For more information, see [MERGE INTO](https://docs.aws.amazon.com/athena/latest/ug/merge-into-statement.html).
...
[Use Amazon Athena Federated Query](https://docs.aws.amazon.com/athena/latest/ug/federated-queries.html).
...
querying restored Amazon Glacier objects, see [Query restored Amazon Glacier objects](https://docs.aws.amazon.com/athena/latest/ug/querying-glacier.html).
...
database for AWS Glue metadata, see [Query the AWS Glue Data Catalog](https://docs.aws.amazon.com/athena/latest/ug/querying-glue-catalog.html).
...
the `$path` metadata column in Athena, see [Getting the file locations for source data in Amazon S3](https://docs.aws.amazon.com/athena/latest/ug/select.html#select-path).

For information about maximum query string length, quotas for query timeouts, and quotas
for the active number of DML queries, see [Service Quotas](https://docs.aws.amazon.com/athena/latest/ug/service-limits.html).
