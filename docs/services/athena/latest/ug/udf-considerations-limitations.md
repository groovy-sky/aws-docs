...
Java](https://docs.aws.amazon.com/lambda/latest/dg/lambda-java.html) in the _AWS Lambda Developer Guide_.
...
UDFs. For more information, see [Lambda quotas](https://docs.aws.amazon.com/lambda/latest/dg/limits.html) in the
