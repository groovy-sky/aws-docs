...
For more information, see [Amazon ECR Public Gallery](https://docs.aws.amazon.com/AmazonECR/latest/public/public-gallery.html).
...
more information, see [Amazon ECR public registries](https://docs.aws.amazon.com/AmazonECR/latest/public/public-registries.html).
...
more information, see [Registry authentication in Amazon ECR public](https://docs.aws.amazon.com/AmazonECR/latest/public/public-registry-auth.html).
...
see [Amazon ECR public repositories](https://docs.aws.amazon.com/AmazonECR/latest/public/public-repositories.html).

Repository policy

You can control access to your repositories and the images within them
with repository policies. For more information, see [Public repository policies in Amazon ECR Public](https://docs.aws.amazon.com/AmazonECR/latest/public/public-repository-policies.html).
...
For a quickstart guide on pushing a container image to Amazon ECR Public repository, see [Moving an image through its lifecycle in Amazon ECR Public](https://docs.aws.amazon.com/AmazonECR/latest/public/getting-started-cli.html).
