...
To use the AWS Management Console instead of the AWS CLI, see [Creating an Amazon ECR public repository to store images](https://docs.aws.amazon.com/AmazonECR/latest/public/public-repository-create.html).
...
pulls. For more information, see [Amazon ECR Public service quotas](https://docs.aws.amazon.com/AmazonECR/latest/public/public-service-quotas.html).
