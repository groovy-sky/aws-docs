...
For more information about ARN format, see [Resources](https://docs.aws.amazon.com/AmazonECR/latest/public/security_iam_service-with-iam.html#security_iam_service-with-iam-id-based-policies-resources).
...
- [Setting a repository policy statement in Amazon ECR Public](https://docs.aws.amazon.com/AmazonECR/latest/public/set-public-repository-policy.html)

- [Deleting a public repository policy statement in Amazon ECR Public](https://docs.aws.amazon.com/AmazonECR/latest/public/delete-public-repository-policy.html)

- [Public repository policy examples in Amazon ECR Public](https://docs.aws.amazon.com/AmazonECR/latest/public/public-repository-policy-examples.html)
