...
02. From the navigation bar, choose the Region that the repository to edit is
     in.
...
05. For **Repository logo**, if your repository doesn't have a
...
06. For **Short description** edit the description of the
...
07. For **Content types** select the operating system and system
...
08. For **About**, enter a detailed description for the
     repository. This field is publicly visible on the Amazon ECR Public Gallery on the
     repository detail page. This text
     must
     be in
     the
     GitHub Flavored Markdown format. For examples, see [Specifying the repository catalog data in Amazon ECR public](public-repository-catalog-data.md).

09. For **Usage**, enter details about how to use the images in
