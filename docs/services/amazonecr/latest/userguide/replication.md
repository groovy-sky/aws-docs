...
information, see [Private registry permissions in Amazon ECR](https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-permissions.html).
...
- [Private image replication examples for Amazon ECR](https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-settings-examples.html)

- [Configuring private image replication in Amazon ECR](https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-settings-configure.html)

- [Removing private image replication settings in Amazon ECR](https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-settings-remove.html)
...
done by setting a private registry permissions policy. For more information, see [Private registry permissions in Amazon ECR](https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-permissions.html).
...
AWS Regions](https://docs.aws.amazon.com/general/latest/gr/rande-manage.html) in the _Amazon Web Services General Reference_.
...
format](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arns-syntax) in the _AWS General Reference_.
...
example, see [Example: Configuring cross-Region replication using a repository filter](https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-settings-examples.html#registry-settings-examples-crr-filter).
