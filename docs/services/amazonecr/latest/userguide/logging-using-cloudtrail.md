...
For more information, see the [AWS CloudTrail User Guide](../../../awscloudtrail/latest/userguide.md).
...
- [Creating a trail for your AWS account](../../../awscloudtrail/latest/userguide/cloudtrail-create-and-update-a-trail.md)
...
All Amazon ECR API actions are logged by CloudTrail and are documented in the [Amazon Elastic Container Registry API Reference](../../../../reference/amazonecr/latest/apireference.md).
...
For examples of these common tasks, see [CloudTrail log entry examples](#cloudtrail-examples).
...

{
    ...
    "userIdentity": {
        "type": "AssumedRole",
        "principalId": "AWS_ACCESS_KEY_ID_REDACTED:account_name",
