...
in these policies, see [Actions](https://docs.aws.amazon.com/AmazonECR/latest/APIReference/API_Operations.html) in the
...
workflow. For more information, see [Amazon ECR service-linked role for pull through cache](https://docs.aws.amazon.com/AmazonECR/latest/userguide/slr-pullthroughcache.html).
...
Amazon ECR to perform actions on your behalf. For more information, see [Using service-linked roles for Amazon ECR](https://docs.aws.amazon.com/AmazonECR/latest/userguide/using-service-linked-roles.html).
...
[Amazon ECR service-linked role for pull through cache](https://docs.aws.amazon.com/AmazonECR/latest/userguide/slr-pullthroughcache.html)
...
[ECRTemplateServiceRolePolicy](https://docs.aws.amazon.com/AmazonECR/latest/userguide/slr-rct.html) – New
policy
...
[AWSECRPullThroughCache\_ServiceRolePolicy](https://docs.aws.amazon.com/AmazonECR/latest/userguide/slr-pullthroughcache.html) – Update
