...
information on setting repository policies, see [Setting a private repository policy statement in Amazon ECR](set-repository-policy.md).
...
Condition Context Keys](../../../iam/latest/userguide/reference-policies-condition-keys.md). The `aws:sourceIp` IPv4 values use
the standard CIDR notation. For more information, see [IP Address Condition Operators](../../../iam/latest/userguide/reference-policies-elements-condition-operators.md#Conditions_IPAddress) in the _IAM User Guide_.
...
CodeBuild](../../../codebuild/latest/userguide/sample-ecr.md) in the _AWS CodeBuild User Guide_.
