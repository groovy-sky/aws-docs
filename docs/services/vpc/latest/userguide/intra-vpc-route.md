---
title: "Inspect traffic between subnets"
---
...
![Inspect subnet traffic](https://docs.aws.amazon.com/images/vpc/latest/userguide/images/middlebox-intra-vpc_updated.png)
...
DestinationTargetPurpose`VPC CIDR`LocalLocal route`Subnet B CIDR``appliance-eni`Route traffic destined for subnet B to the middlebox
...
DestinationTargetPurpose`VPC CIDR`LocalLocal route`Subnet A CIDR``appliance-eni`Route traffic destined for subnet A to the middlebox
...
DestinationTargetPurpose`VPC CIDR`LocalLocal route
