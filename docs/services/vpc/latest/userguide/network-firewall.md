---
title: "Filter network traffic using AWS Network Firewall"
---
...
[AWS Network Firewall Developer Guide](../../../network-firewall/latest/developerguide/firewalls.md).

You implement Network Firewall with the following AWS resources.

Network Firewall resourceDescriptionFirewallA firewall connects a firewall policy's network traffic filtering
...
For more information, see [Firewalls in\
AWS Network Firewall](../../../network-firewall/latest/developerguide/firewalls.md).

Firewall policyA firewall policy defines the monitoring and protection behavior for a
...
For more
information, see [Firewall\
policies in AWS Network Firewall](../../../network-firewall/latest/developerguide/firewall-policies.md).

Rule groupA rule group is a reusable set of criteria for inspecting and handling
...
For more information, see [Rule groups in\
AWS Network Firewall](../../../network-firewall/latest/developerguide/rule-groups.md).
...
multiple accounts using a single account in Firewall Manager. For more information, see [AWS Firewall Manager](../../../waf/latest/developerguide/fms-chapter.md)
