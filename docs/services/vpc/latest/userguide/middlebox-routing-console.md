---
title: "Middlebox routing wizard"
---
...
- Routing traffic to a Gateway Load Balancer. For more information, see the [User Guide for Gateway Load Balancers](../../../elasticloadbalancing/latest/gateway.md).
...
- [Redirect VPC traffic to a security appliance](working-with-routing-console.md)
...
Review [Middlebox routing wizard considerations](#console-routes-considerations). Then, make sure that you
...
Source or Destination Checking](../../../ec2/latest/userguide/using-eni.md#change_source_dest_check) in the
_Amazon EC2 User Guide_.

- The route tables and routes that the middlebox routing wizard creates count toward your
quotas. For more information, see [Route tables](amazon-vpc-limits.md#vpc-limits-route-tables).
