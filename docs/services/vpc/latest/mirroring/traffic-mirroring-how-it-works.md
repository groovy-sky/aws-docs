...
![Traffic from source A and source B is mirrored to mirror target D using filter A.](https://docs.aws.amazon.com/images/vpc/latest/mirroring/images/traffic-mirroring.png)
