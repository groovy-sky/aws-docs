---
title: "What is Traffic Mirroring?"
---
...
- Session — Establishes a relationship between a
...
Linux. For more information, see [AWS Command Line Interface](https://aws.amazon.com/cli).
...
hash to sign the request and handling errors. For more information, see [Amazon VPC actions](../../../../reference/awsec2/latest/apireference/operationlist-query-vpc.md) in the
...
to be charged for Traffic Mirroring until you [delete all active traffic mirror sessions](create-traffic-mirroring-session.md). For example, you'll
...
[Data transfer charges apply](../../../cur/latest/userguide/cur-data-transfers-charges.md). If your traffic mirroring targets are behind a gateway or network load balancer, data processing for the load balancing services also applies.

For information about pricing for Traffic Mirroring, see **Network Analysis** on
the [Amazon VPC pricing](https://aws.amazon.com/vpc/pricing) page.
