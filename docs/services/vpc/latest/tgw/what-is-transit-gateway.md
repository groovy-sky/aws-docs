---
title: "What is AWS Transit Gateway for Amazon VPC?"
---
...
AWS data centers is automatically encrypted at the physical layer.
...
- Associations — Each attachment is associated with
exactly one route table. Each route table can be associated with zero to many
attachments.

- Route propagation — A VPC, VPN connection, or
...
Windows, macOS, and Linux. For more information, see [AWS Command Line Interface](https://aws.amazon.com/cli).
...
[Amazon EC2 API Reference](../../../../reference/awsec2/latest/apireference.md).
...
and [Flexible cost allocation](metering-policy.md).
