...
make it available to other AWS customers. For more information, see [AWS PrivateLink concepts](concepts.md).
...
![Connect to an AWS service, an endpoint service in another AWS account, a partner service, a VPC resource, or VPC Lattice service network.](https://docs.aws.amazon.com/images/vpc/latest/privatelink/images/use-cases.png)
...
- [Access\
AWS services](privatelink-access-aws-services.md)
...
about commands for AWS PrivateLink, see [ec2](../../../cli/latest/reference/ec2/index.md) in the _AWS CLI Command Reference_.
...
- [AWS::EC2::VPCEndpoint](../../../cloudformation/latest/userguide/aws-resource-ec2-vpcendpoint.md)

- [AWS::EC2::VPCEndpointConnectionNotification](../../../cloudformation/latest/userguide/aws-resource-ec2-vpcendpointconnectionnotification.md)

- [AWS::EC2::VPCEndpointService](../../../cloudformation/latest/userguide/aws-resource-ec2-vpcendpointservice.md)

- [AWS::EC2::VPCEndpointServicePermissions](../../../cloudformation/latest/userguide/aws-resource-ec2-vpcendpointservicepermissions.md)

- [AWS::ElasticLoadBalancingV2::LoadBalancer](../../../cloudformation/latest/userguide/aws-resource-elasticloadbalancingv2-loadbalancer.md)
...
actions](../../../../reference/awsec2/latest/apireference/operation-list-privatelink.md) in the _Amazon EC2 API Reference_.
