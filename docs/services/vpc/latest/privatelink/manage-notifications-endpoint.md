---
title: "Receive alerts for interface endpoint events"
---
...
5. For **Notification ARN**, choose the [Amazon Resource Name](../../../glossary/latest/reference/glos-chap.md#ARN) (ARN) for the SNS topic that
    you created.
