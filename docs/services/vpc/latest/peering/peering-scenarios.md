---
title: "VPC peering connection networking scenarios"
---
...
connections in the Amazon VPC console, see [VPC peering connections](working-with-vpc-peering.md).
...
Amazon VPC console, see [VPC peering connections](working-with-vpc-peering.md).
