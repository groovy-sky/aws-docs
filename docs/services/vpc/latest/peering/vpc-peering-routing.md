---
title: "Update your route tables for a VPC peering connection"
---
...
of the VPC peering connection. For more information, see [Configure route tables](../userguide/vpc-route-tables.md) in the _Amazon VPC User Guide_.
...
Route tableDestinationTargetVPC A`VPC A CIDR`Local`VPC B CIDR`pcx- `11112222`VPC B`VPC B CIDR`Local`VPC A CIDR`pcx- `11112222`
...
connections, see [Common VPC peering connection configurations](peering-configurations.md).
...
packets back to the source. For more information, see [Routing for response traffic](peering-configurations-partial-access.md#peering-incorrect-response-routing).

- Your account has a [quota](../userguide/amazon-vpc-limits.md)
...
6. For **Destination**, enter the IPv4 address range to which the
    ...
    `10.0.0.0/24`, or a specific IP address `10.0.0.7/32`.
...
6. For **Destination**, enter the IPv6 address range for the peer VPC.
...
For more information, see [Route tables](../userguide/vpc-route-tables.md)
in the _Amazon VPC User Guide_.

###### To add or replace a route using the command line

- [create-route](../../../cli/latest/reference/ec2/create-route.md) and
[replace-route](../../../cli/latest/reference/ec2/replace-route.md)(AWS CLI)

- [New-EC2Route](../../../powershell/latest/reference/items/new-ec2route.md) and
[Set-EC2Route](../../../powershell/latest/reference/items/set-ec2route.md)(AWS Tools for Windows PowerShell)
