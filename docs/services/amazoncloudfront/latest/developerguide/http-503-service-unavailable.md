...
distribution. To help prevent this, follow the [Load testing CloudFront](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/load-testing.html)
...
For more information about testing CloudFront Functions, see [Test functions](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/test-function.html).
...
service quotas](https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-limits.html) in the _AWS Lambda Developer Guide_.
