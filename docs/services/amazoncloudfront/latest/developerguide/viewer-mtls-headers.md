...
implementing revocation checks, see [Revocation using CloudFront Connection Function and KVS](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/revocation-connection-function-kvs.html).
