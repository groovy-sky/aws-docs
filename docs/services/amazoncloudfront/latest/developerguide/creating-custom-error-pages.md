...
information, see [Configure error response behavior](custom-error-pages-procedure.md).
...
status code 416 to CloudFront. For more information, see [Change response codes returned by CloudFront](custom-error-pages-response-code.md). However,
