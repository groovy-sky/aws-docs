...
- [Prerequisites](functions-tutorial.md#functions-tutorial-prerequisites)

- [Create the function](functions-tutorial.md#functions-tutorial-create)

- [Verify the function](functions-tutorial.md#functions-tutorial-verify)
