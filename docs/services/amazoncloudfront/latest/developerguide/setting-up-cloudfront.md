...
isn't available for, see the [Amazon CloudFront API Reference](../../../../reference/cloudfront/latest/apireference/welcome.md) for information about API actions and about how to make API requests.
...
AWS CLI, see [Install or update to the latest version of the AWS CLI](../../../cli/latest/userguide/getting-started-install.md) in the _AWS Command Line Interface User Guide_.
...
AWS Tools for Windows PowerShell](../../../powershell/latest/userguide/pstools-getting-set-up.md) in the
