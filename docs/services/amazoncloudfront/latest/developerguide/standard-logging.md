...
standard logging (v2). For more information, see [Configure standard logging (legacy)](standard-logging-legacy-s3.md).
...
- [CloudWatch Logs](../../../amazoncloudwatch/latest/logs/aws-logs-and-resource-policy.md#AWS-logs-infrastructure-V2-CloudWatchLogs)

- [Firehose](../../../amazoncloudwatch/latest/logs/aws-logs-and-resource-policy.md#AWS-logs-infrastructure-V2-Firehose)

- [Amazon S3](../../../amazoncloudwatch/latest/logs/aws-logs-and-resource-policy.md#AWS-logs-infrastructure-V2-S3)
...
account) must have the required permissions. For more information, see the [Enable standard logging for cross-account delivery](#enable-standard-logging-cross-accounts) section or the [Cross-account delivery example](../../../amazoncloudwatch/latest/logs/aws-logs-and-resource-policy.md#vended-logs-crossaccount-example) in the _Amazon CloudWatch Logs User_
_Guide_.
...
- [Enable standard logging (CloudFront console)](standard-logging.md#access-logging-console)

- [Enable standard logging (CloudWatch API)](standard-logging.md#enable-access-logging-api)
...
1. Use the CloudFront console to
    [update an existing\
    distribution](howtoupdatedistribution.md#HowToUpdateDistributionProcedure).
...
1. For **Field selection**, select the log field
       ...
       [access log\
       fields](standard-logs-reference.md#BasicDistributionFileFormat) and a subset of [real-time access log\
       fields](#standard-logging-real-time-log-selection).
...
You can find the ARN from the **Distribution** page in
    the CloudFront console or you can use the [GetDistribution](../../../../reference/cloudfront/latest/apireference/api-getdistribution.md) API operation. A
    distribution ARN follows the format:
    `arn:aws:cloudfront::123456789012:distribution/d111111abcdef8`

2. Next, use the CloudWatch [PutDeliverySource](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putdeliverysource.md) API operation to create a delivery source for
    the distribution.
...
4. ###### Example AWS CLI put-delivery-source command
      ...
      **Output**
      ...
      ```
3. Use the [PutDeliveryDestination](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putdeliverydestination.md) API operation to
...
If you're delivering logs cross-account, you must use the [PutDeliveryDestinationPolicy](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putdeliverydestinationpolicy.md) API operation to assign an
...
4. Use the [CreateDelivery](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-createdelivery.md) API operation to link the
...
- [Delivery](../../../cloudformation/latest/userguide/aws-resource-logs-delivery.md)

- [DeliveryDestination](../../../cloudformation/latest/userguide/aws-resource-logs-deliverydestination.md)

- [DeliverySource](../../../cloudformation/latest/userguide/aws-resource-logs-deliverysource.md)
...
delivery destination. For more information, see [S3DeliveryConfiguration](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-s3deliveryconfiguration.md).
...
For more information, see [PutDeliveryDestination](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putdeliverydestination.md) in the _Amazon CloudWatch Logs API_
_Reference_.
...
- To update a distribution by using the CloudFront API, see [UpdateDistribution](../../../../reference/cloudfront/latest/apireference/api-updatedistribution.md) in the
...
Reference](../../../../reference/amazoncloudwatchlogs/latest/apireference/welcome.md).

## Access log fields

You can select the same log fields that standard logging (legacy) supports. For more information,
see [log file fields](standard-logs-reference.md#BasicDistributionFileFormat).
...
standard logging. For more information about the required permissions, see [Logs sent to CloudWatch Logs](../../../amazoncloudwatch/latest/logs/aws-logs-and-resource-policy.md#AWS-logs-infrastructure-V2-CloudWatchLogs) in the _Amazon CloudWatch Logs User Guide_.

###### Notes

- When you specify the name of the CloudWatch Logs log group, only use the regex
pattern `[\w-]`. For more information, see the [PutDeliveryDestination](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putdeliverydestination.md#API_PutDeliveryDestination_RequestSyntax) API operation in the
_Amazon CloudWatch Logs API Reference_.

- Verify that your log group resource policy doesn't exceed the size limit.
See the [Log group resource policy size limit considerations](../../../amazoncloudwatch/latest/logs/aws-logs-and-resource-policy.md#AWS-logs-infrastructure-V2-CloudWatchLogs) section in
...
Amazon Data Firehose delivery stream](../../../firehose/latest/dev/basic-create.md).

After you create your delivery stream, you must have the required permissions to allow
standard logging. For more information, see [Logs sent to Firehose](../../../amazoncloudwatch/latest/logs/aws-logs-and-resource-policy.md#AWS-logs-infrastructure-V2-Firehose) in the _Amazon CloudWatch Logs User Guide_.

###### Note

When you specify the name of the Firehose stream, only use the regex pattern
`[\w-]`. For more information, see the [PutDeliveryDestination](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putdeliverydestination.md#API_PutDeliveryDestination_RequestSyntax) API operation in the
_Amazon CloudWatch Logs API Reference_.
...
logging. For more information, see [Logs sent to Amazon S3](../../../amazoncloudwatch/latest/logs/aws-logs-and-resource-policy.md#AWS-logs-infrastructure-V2-S3) in the _Amazon CloudWatch Logs User Guide_.
...
information, see the [PutDeliveryDestination](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-putdeliverydestination.md#API_PutDeliveryDestination_RequestSyntax) API operation in the
_Amazon CloudWatch Logs API Reference_.
...
information, see the [CreateDelivery](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-createdelivery.md) API operation.
...
[S3DeliveryConfiguration](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-s3deliveryconfiguration.md) element in the
_Amazon CloudWatch Logs API Reference_.
...
- For more information about the suffix path, see [S3DeliveryConfiguration](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-s3deliveryconfiguration.md).
...
command. For more information, see [DeleteDeliverySource](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-deletedeliverysource.md) in the _Amazon CloudWatch Logs API_
_Reference_.
...
information, see [DeleteDeliverySource](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-deletedeliverysource.md) in the _Amazon CloudWatch Logs API_
_Reference_.
...
[UpdateDeliveryConfiguration](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-updatedeliveryconfiguration.md) API operation to specify a different suffix
...
- [DeleteLogGroup](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-deleteloggroup.md) in the _Amazon CloudWatch Logs API Reference_

###### Firehose

- [DeleteDeliveryStream](../../../../reference/firehose/latest/apireference/api-deletedeliverystream.md) in the _Amazon Data Firehose API_
_Reference_
