...
information, see [Logging Amazon CloudFront API calls using AWS CloudTrail](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/logging_using_cloudtrail.html).
...
To use this module in the function code, make sure that you have [associated a key value store](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/kvs-with-functions-associate.html) with the
function.
