...
about creating signed URLs by using a custom policy, see [Create a signed URL using a custom policy](private-content-creating-signed-url-custom-policy.md). For
information about creating signed cookies by using a custom policy, see [Set signed cookies using a custom policy](private-content-setting-signed-cookie-custom-policy.md).
...
name](../../../route53/latest/developerguide/routing-to-cloudfront-distribution.md) in the _Amazon Route 53 Developer Guide_.
