...
- [Enable standard logging (legacy) (CloudFront console)](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/standard-logging-legacy-s3.html#standard-logs-legacy-enable-console)

- [Enable standard logging (legacy) (CloudFront API)](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/standard-logging-legacy-s3.html#standard-logs-legacy-enable-api)

### Enable standard logging (legacy) (CloudFront console)

###### To enable standard logs for a CloudFront distribution (console)

1. Use the CloudFront console to create a [new distribution](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-creating-console.html) or
    [update an existing\
    one](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/HowToUpdateDistribution.html#HowToUpdateDistributionProcedure).
...
- To update a distribution using the CloudFront console, see [Update a distribution](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/HowToUpdateDistribution.html).

- To update a distribution using the CloudFront API, see [UpdateDistribution](https://docs.aws.amazon.com/cloudfront/latest/APIReference/API_UpdateDistribution.html) in the
