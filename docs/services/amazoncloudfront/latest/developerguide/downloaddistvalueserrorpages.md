...
error page is cached in CloudFront edge caches. For more information, see [Create a custom error page for specific HTTP status codes](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/creating-custom-error-pages.html).
