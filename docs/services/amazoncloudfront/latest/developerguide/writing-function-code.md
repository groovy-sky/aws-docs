...
latency-sensitive CDN customizations. Your function code can manipulate the requests and
...
examples, see [CloudFront Functions examples for CloudFront](service-code-examples-cloudfront-functions-examples.md) and the [amazon-cloudfront-functions repository](https://github.com/aws-samples/amazon-cloudfront-functions) on GitHub.
