...
runs the function. When you [test a function](test-function.md), you create
...
run. For more information see [Restrictions on all edge functions](edge-function-restrictions-all.md).
...
page](creating-custom-error-pages.md) that you have specified for the same status code.
...
- [Query strings values or query string objects](functions-event-structure.md#functions-event-structure-query)

- [Special considerations for headers](functions-event-structure.md#functions-event-structure-headers)

- [Duplicate query strings, headers, and cookies (multiValue array)](functions-event-structure.md#functions-event-structure-multivalue)

- [Cookie attributes](functions-event-structure.md#functions-event-structure-cookie-attributes)
