...
date. For more information, see [Manage how long content stays in the cache (expiration)](expiration.md).
...
For more information, see [Update existing files using versioned file names](#ReplacingObjects).
