...
statements. The examples include utility functions based on the [AWS SDK for .NET](https://aws.amazon.com/sdkfornet) that can be useful in .NET
applications.
...
- **Signed URLs** – [AmazonCloudFrontUrlSigner](../../../../reference/sdkfornet/v3/apidocs/items/cloudfront/tcloudfronturlsigner.md)

- **Signed cookies** – [AmazonCloudFrontCookieSigner](../../../../reference/sdkfornet/v3/apidocs/items/cloudfront/tcloudfrontcookiesigner.md)
...
separate package. For more information about using them, see [CookieSigner and UrlSigner](../../../../reference/sdk-for-net/v4/developer-guide/net-dg-v4.md#net-dg-v4-CookieSigner-UrlSigner) in the
_AWS SDK for .NET (V4) Developer Guide_.

- Creating a URL signature is just one part of the process of serving
private content using a signed URL. For more information, see [Use signed URLs](private-content-signed-urls.md). For more information
about using signed cookies, see [Use signed cookies](private-content-signed-cookies.md).
...
C#](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/samples/AWS_PrivateCF_Distributions.zip).

###### Note

The `keyId` is returned when you upload a public key to CloudFront.
For more information, see ![6](https://docs.aws.amazon.com/images/AmazonCloudFront/latest/DeveloperGuide/images/callouts/6.png)[&Key-Pair-Id](private-content-creating-signed-url-canned-policy.md).
