...
- [You specified a missing object from the Amazon S3 origin](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/troubleshooting-distributions.html#missing-object-in-s3-bucket)

- [Your Amazon S3 origin is missing IAM permissions](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/troubleshooting-distributions.html#access-denied-origin-missing-iam-permissions)

- [You're using invalid credentials or don't have sufficient permissions](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/troubleshooting-distributions.html#access-denied-missing-iam-permissions)
...
information about access denied error messages, see [Troubleshooting access denied error messages](https://docs.aws.amazon.com/IAM/latest/UserGuide/troubleshoot_access-denied.html) in
the _IAM User Guide_.

For information about how IAM works with CloudFront, see [Identity and Access Management for Amazon CloudFront](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/security-iam.html).
