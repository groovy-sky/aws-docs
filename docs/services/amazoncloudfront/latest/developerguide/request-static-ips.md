...
For more information about quotas related to Anycast static IP lists, see [Amazon CloudFront endpoints and quotas](../../../../general/latest/gr/cf-region.md#limits_cloudfront) in the
...
2. Create a connection group. For more information, see [Create custom connection\
    group](custom-connection-group.md).
