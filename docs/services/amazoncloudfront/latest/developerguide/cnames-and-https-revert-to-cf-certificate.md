...
1. Run the AWS CLI command `list-server-certificates` to get
       ...
       more information, see [list-server-certificates](../../../cli/latest/reference/iam/list-server-certificates.md) in the
       _AWS CLI Command Reference_.

2. Run the AWS CLI command `delete-server-certificate` to
       delete the certificate. For more information, see [delete-server-certificate](../../../cli/latest/reference/iam/delete-server-certificate.md) in the
       _AWS CLI Command Reference_.
