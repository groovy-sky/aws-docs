...
For more code examples that demonstrate creating a signature, see [Code examples for creating a signature for a signed URL](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateCFSignatureCodeAndExamples.html).
