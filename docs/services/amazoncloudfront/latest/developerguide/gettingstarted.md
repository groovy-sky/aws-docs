...
- [Get started with a CloudFront standard distribution](gettingstarted-simpledistribution.md)

- [Get started with a standard distribution (AWS CLI)](get-started-cli-tutorial.md)
