...
For details on forwarding certificate information to origins, see [Forward Headers to origins](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/viewer-mtls-headers.html).
