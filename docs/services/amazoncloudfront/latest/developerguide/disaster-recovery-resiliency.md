...
In addition to the support of AWS global infrastructure, Amazon CloudFront offers an
_origin failover_ feature to help support your data resiliency needs.
CloudFront is a global service that delivers your content through a worldwide network of data
centers called _edge locations_ or _points of_
_presence_ (POPs). If your content is not already cached in an edge location,
CloudFront retrieves it from an origin that you've identified as the source for the definitive
version of the content.

You can improve resiliency and increase availability for specific scenarios by setting up
...
more information, see [Optimize high availability with CloudFront origin failover](high-availability-origin-failover.md).
