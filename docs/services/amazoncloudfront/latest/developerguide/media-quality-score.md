...
MediaPackage](../../../mediapackage/latest/userguide/mqcs.md) in the _AWS Elemental MediaPackage V2 User Guide_.
...
- [Create a channel and endpoint](../../../mediapackage/latest/userguide/getting-started.md)

- [Enable the media\
quality score](../../../mediapackage/latest/userguide/mqcs.md)
