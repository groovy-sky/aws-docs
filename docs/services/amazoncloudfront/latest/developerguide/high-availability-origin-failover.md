...
09. Under **Origin selection criteria**, specify how your
    ...
    **Media quality score**
    ...
    information, see [Media quality-aware resiliency](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/media-quality-score.html).
...
trigger](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/lambda-cloudfront-trigger-events.html) for an origin group when you create the cache behavior. When you
