...
For more information about AWS RAM, see the [AWS RAM User Guide](../../../ram/latest/userguide.md).
...
a Resource Share](../../../ram/latest/userguide/working-with-sharing.md#working-with-sharing-create) in the _AWS RAM User Guide_.

###### To share a VPC origin that you own using the AWS CLI

Use the [create-resource-share](../../../cli/latest/reference/ram/create-resource-share.md) command.
...
**Pending** tab. For more information, see [Accepting shared resources](../../../ram/latest/userguide/working-with-shared-invitations.md) in the _AWS RAM User Guide_.
...
For more information about managing permissions in AWS RAM, see [Managing permissions in AWS RAM](../../../ram/latest/userguide/security-ram-permissions.md) in the _AWS Resource Access Manager User_
_Guide_.
...
For more information, see [Service quotas for AWS RAM](../../../ram/latest/userguide/service-quotas.md) in
