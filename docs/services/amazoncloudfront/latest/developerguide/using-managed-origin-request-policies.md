...
This policy includes all values (headers, cookies, and query strings) from the
viewer request, and all [CloudFront headers](adding-cloudfront-headers.md)
...
This policy also includes additional [CloudFront request headers](adding-cloudfront-headers.md) for HTTP protocol, HTTP version, TLS version, and
