...
- [CopyDistribution](../../../../reference/cloudfront/latest/apireference/api-copydistribution.md)

- [CreateContinuousDeploymentPolicy](../../../../reference/cloudfront/latest/apireference/api-createcontinuousdeploymentpolicy.md)
...
policy, use [UpdateDistribution](../../../../reference/cloudfront/latest/apireference/api-updatedistribution.md) (on the primary distribution) to attach the
...
To update the configuration of a staging distribution, use [UpdateDistribution](../../../../reference/cloudfront/latest/apireference/api-updatedistribution.md) (on the staging distribution) to modify the
...
To update a continuous deployment policy, use [UpdateContinuousDeploymentPolicy](../../../../reference/cloudfront/latest/apireference/api-updatecontinuousdeploymentpolicy.md).
...
distribution, use [UpdateDistributionWithStagingConfig](../../../../reference/cloudfront/latest/apireference/api-updatedistributionwithstagingconfig.md).
