...
## Feedback channels
<a name="dsql-feedback-channels"></a>

**Aurora DSQL Discord server**
Join the [Aurora DSQL Discord server](https://discord.com/invite/nEF6ksFWru) to connect with the AWS team and community. Share feature requests, discuss migration challenges, and get real-time feedback.

**AWS Support**
If you have an AWS Support plan, create a support case to discuss your specific requirements and timeline needs.

**AWS re:Post**
Use [AWS re:Post](https://repost.aws/) to ask questions and share feedback with the community and AWS experts.

## Effective feature requests
<a name="dsql-feature-request-best-practices"></a>
