...
compact or human-readable identifiers are needed. These values involve allocation and caching
behavior described in the [CREATE SEQUENCE](create-sequence-syntax-support.md) documentation.
