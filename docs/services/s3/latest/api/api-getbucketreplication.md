...
Type: Array of [ReplicationRule](https://docs.aws.amazon.com/AmazonS3/latest/API/API_ReplicationRule.html) data types
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/s3-2006-03-01/GetBucketReplication)
