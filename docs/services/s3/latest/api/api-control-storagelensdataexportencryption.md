---
title: "StorageLensDataExportEncryption"
---
...
Type: [SSEKMS](api-control-ssekms.md) data type

Required: No

**SSES3**

Type: [SSES3](api-control-sses3.md) data type
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/s3control-2018-08-20/StorageLensDataExportEncryption)
