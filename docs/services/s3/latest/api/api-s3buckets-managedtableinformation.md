...
Type: [ReplicationInformation](api-s3buckets-replicationinformation.md) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/s3tables-2018-05-10/ManagedTableInformation)
