...
and Endpoints](https://docs.aws.amazon.com/general/latest/gr/s3.html) in the _AWS General Reference_.
...
Configuration](https://docs.aws.amazon.com/cli/latest/topic/s3-config.html).
