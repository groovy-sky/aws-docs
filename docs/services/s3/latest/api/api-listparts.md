...
For more information on multipart uploads, see [Uploading Objects Using Multipart Upload](https://docs.aws.amazon.com/AmazonS3/latest/dev/uploadobjusingmpu.html) in
...
Type: [Initiator](https://docs.aws.amazon.com/AmazonS3/latest/API/API_Initiator.html) data type
...
Type: Array of [Part](https://docs.aws.amazon.com/AmazonS3/latest/API/API_Part.html) data types
