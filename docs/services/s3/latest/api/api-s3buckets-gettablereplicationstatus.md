...
Type: Array of [ReplicationDestinationStatusModel](https://docs.aws.amazon.com/AmazonS3/latest/API/API_s3Buckets_ReplicationDestinationStatusModel.html) objects
