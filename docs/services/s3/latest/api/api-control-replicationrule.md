...
Type: [Destination](api-control-destination.md) data type
...
Type: [DeleteMarkerReplication](api-control-deletemarkerreplication.md) data type
...
Type: [ExistingObjectReplication](api-control-existingobjectreplication.md) data type
...
Type: [ReplicationRuleFilter](api-control-replicationrulefilter.md) data type
...
rules on Outposts](../userguide/replication-between-outposts.md) in the _Amazon S3 User Guide_.
...
Type: [SourceSelectionCriteria](api-control-sourceselectioncriteria.md) data type
...
- [AWS SDK for C++](../../../../reference/goto/sdkforcpp/s3control-2018-08-20/replicationrule.md)

- [AWS SDK for Java V2](../../../../reference/goto/sdkforjavav2/s3control-2018-08-20/replicationrule.md)

- [AWS SDK for Ruby V3](../../../../reference/goto/sdkforrubyv3/s3control-2018-08-20/replicationrule.md)
