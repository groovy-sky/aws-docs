...
conditional requests](../userguide/conditional-requests.md) in the _Amazon S3 User Guide_ or [RFC 7232](https://datatracker.ietf.org/doc/rfc7232).
...
Versioning-Enabled Buckets](../dev/addingobjectstoversioningenabledbuckets.md) in the _Amazon S3 User Guide_. For information
about returning the versioning state of a bucket, see [GetBucketVersioning](api-getbucketversioning.md).
...
Authentication](../dev/restauthentication.md).
...
The canned ACL to apply to the object. For more information, see [Canned ACL](../dev/acl-overview.md#CannedACL) in the
_Amazon S3 User Guide_.
...
List (ACL) Overview](../dev/acl-overview.md) and [Managing ACLs Using the REST API](../dev/acl-using-rest-api.md) in the
_Amazon S3 User Guide_.
...
**[x-amz-checksum-md5](#API_PutObject_RequestSyntax)**

This header can be used as a data integrity check to verify that the data received is the same data
that was originally sent. This header specifies the Base64 encoded, 128-bit `MD5`
digest of the object. For more information, see [Checking object integrity in the Amazon S3\
User Guide](../userguide/checking-object-integrity.md).
...
**[x-amz-checksum-sha512](#API_PutObject_RequestSyntax)**
...
**[x-amz-checksum-xxhash128](#API_PutObject_RequestSyntax)**
...
**[x-amz-checksum-xxhash3](#API_PutObject_RequestSyntax)**
...
**[x-amz-checksum-xxhash64](#API_PutObject_RequestSyntax)**
...
Lock, see [Object Lock](../dev/object-lock.md) in
...
information, see [Using Server-Side Encryption](../dev/usingserversideencryption.md) in
the _Amazon S3 User Guide_.
...
information about object metadata, see [Object Key and Metadata](../dev/usingmetadata.md) in the _Amazon S3_
_User Guide_.
...
For more information about website hosting in Amazon S3, see [Hosting Websites on Amazon S3](../dev/websitehosting.md) and [How to Configure Website Page\
Redirects](../dev/how-to-page-redirect.md) in the _Amazon S3 User Guide_.
...
integrity in the Amazon S3 User Guide](../userguide/checking-object-integrity.md).

**[x-amz-checksum-md5](#API_PutObject_ResponseSyntax)**
...
**[x-amz-checksum-sha512](#API_PutObject_ResponseSyntax)**

The Base64 encoded, 512-bit `SHA512` digest of the object. This header is present if
...
**[x-amz-checksum-xxhash128](#API_PutObject_ResponseSyntax)**

The Base64 encoded, 128-bit `XXHASH128` checksum of the object. This header is present if
the object was uploaded with the `XXHASH128` checksum algorithm. For more information, see
[Checking\
object integrity in the Amazon S3 User Guide](../userguide/checking-object-integrity.md).

**[x-amz-checksum-xxhash3](#API_PutObject_ResponseSyntax)**
...
**[x-amz-checksum-xxhash64](#API_PutObject_ResponseSyntax)**
...
If the expiration is configured for the object (see [PutBucketLifecycleConfiguration](api-putbucketlifecycleconfiguration.md)) in the _Amazon S3 User Guide_, the response
...
Versioning-Enabled Buckets](../dev/addingobjectstoversioningenabledbuckets.md) in the _Amazon S3 User Guide_. For information about
returning the versioning state of a bucket, see [GetBucketVersioning](api-getbucketversioning.md).
...
following response. For more information, see [Transitioning Objects: General Considerations](../dev/object-lifecycle-mgmt.md#lifecycle-transition-general-considerations).
...
Tagging and Access Control Policies](../dev/object-tagging.md#tagging-and-policies) in the _Amazon S3 User Guide_.
