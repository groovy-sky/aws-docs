...
Type: [Index](https://docs.aws.amazon.com/AmazonS3/latest/API/API_S3VectorBuckets_Index.html) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/s3vectors-2025-07-15/GetIndex)
