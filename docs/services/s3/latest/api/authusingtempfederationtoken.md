...
available AWS SDKs, see [Sample Code and Libraries](https://aws.amazon.com/code).
...
For more information, see [AWS Identity and Access Management FAQs](https://aws.amazon.com/iam/faqs).
...
Your First IAM user and Administrators Group](https://docs.aws.amazon.com/IAM/latest/UserGuide/getting-started_create-admin-group.html) in the
_IAM User Guide_.
...
about sending authenticated requests, see [Making requests](makingrequests.md).
...
Your IAM user User and Administrators Group](https://docs.aws.amazon.com/IAM/latest/UserGuide/getting-started_create-admin-group.html) in the
_IAM User Guide_.
...
Security Credentials](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp.html) in the _IAM User Guide_. For
information about providing temporary security credentials to your federated users and
applications, see [Making requests](makingrequests.md).
...
identity federation, see [AWS Identity and Access Management FAQs](https://aws.amazon.com/iam/faqs).
...
IAM user and Administrators Group](https://docs.aws.amazon.com/IAM/latest/UserGuide/getting-started_create-admin-group.html) in the
_IAM User Guide_.
...
credentials for your federated users and applications, see [Making requests](makingrequests.md).
...
who requested the temporary security credentials. For more information, see [AWS Identity and Access Management FAQs](https://aws.amazon.com/iam/faqs).
