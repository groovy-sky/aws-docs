...
Creates a replication configuration or replaces an existing one. For more information, see [Replication](../dev/replication.md) in the
...
can invoke this request for a specific AWS Region by using the [`aws:RequestedRegion`](../../../iam/latest/userguide/reference-policies-condition-keys.md#condition-keys-requestedregion) condition key.
...
For information about enabling versioning on a bucket, see [Using Versioning](../dev/versioning.md).
...
with SSE Using KMS keys](../dev/replication-config-for-kms-objects.md).
...
operation. For more information about permissions, see [Specifying Permissions in a Policy](../dev/using-with-s3-actions.md)
and [Managing\
Access Permissions to Your Amazon S3 Resources](../userguide/s3-access-control.md).

###### Note

To perform this operation, the user or role performing the action must have the [iam:PassRole](../../../iam/latest/userguide/id-roles-use-passrole.md) permission.
...
For more examples of replication configuration, see [Replication Configuration Overview](../dev/replication-add-config.md#replication-config-example-configs) in the _Amazon S3 User Guide._
...
Control](../dev/replication-time-control.md).
...
- [AWS Command Line Interface V2](../../../goto/cli2/s3-2006-03-01/putbucketreplication.md)

- [AWS SDK for .NET V4](../../../../reference/goto/dotnetsdkv4/s3-2006-03-01/putbucketreplication.md)

- [AWS SDK for C++](../../../../reference/goto/sdkforcpp/s3-2006-03-01/putbucketreplication.md)

- [AWS SDK for Go v2](../../../../reference/goto/sdkforgov2/s3-2006-03-01/putbucketreplication.md)

- [AWS SDK for Java V2](../../../../reference/goto/sdkforjavav2/s3-2006-03-01/putbucketreplication.md)

- [AWS SDK for JavaScript V3](../../../../reference/goto/sdkforjavascriptv3/s3-2006-03-01/putbucketreplication.md)

- [AWS SDK for Kotlin](../../../../reference/goto/sdkforkotlin/s3-2006-03-01/putbucketreplication.md)

- [AWS SDK for PHP V3](../../../../reference/goto/sdkforphpv3/s3-2006-03-01/putbucketreplication.md)

- [AWS SDK for Python](../../../goto/boto3/s3-2006-03-01/putbucketreplication.md)

- [AWS SDK for Ruby V3](../../../../reference/goto/sdkforrubyv3/s3-2006-03-01/putbucketreplication.md)
