...
Gets the status of a maintenance job for a table. For more information, see [S3 Tables maintenance](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-maintenance.html) in the _Amazon Simple Storage Service User Guide_.
...
Type: String to [TableMaintenanceJobStatusValue](https://docs.aws.amazon.com/AmazonS3/latest/API/API_s3Buckets_TableMaintenanceJobStatusValue.html) object map
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/s3tables-2018-05-10/GetTableMaintenanceJobStatus)
