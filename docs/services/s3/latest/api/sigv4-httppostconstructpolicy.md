...
policy, see [Example: Browser-Based Upload using HTTP POST (Using AWS Signature Version 4)](sigv4-post-example.md).
...
For more information about Amazon DevPay, see [Using DevPay](../userguide/usingdevpay.md) in
...
use to test your signature calculations. For more information, see [Example: Browser-Based Upload using HTTP POST (Using AWS Signature Version 4)](sigv4-post-example.md).
