...
(see [Making requests](makingrequests.md)) using the
...
Credentials](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp.html) in the _IAM User Guide_. For more
information about making requests, see [Making requests](makingrequests.md).
...
First IAM user and Administrators Group](https://docs.aws.amazon.com/IAM/latest/UserGuide/getting-started_create-admin-group.html) in the
_IAM User Guide_.
...
4. Create an instance of the `AmazonS3Client` class by passing
...
requests, see [Making requests](makingrequests.md).
