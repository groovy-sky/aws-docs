...
Type: [EstablishedMultiRegionAccessPointPolicy](https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_EstablishedMultiRegionAccessPointPolicy.html) data type
...
Type: [ProposedMultiRegionAccessPointPolicy](https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_ProposedMultiRegionAccessPointPolicy.html) data type
