...
To do that, use the REST API. For more information, see [Versioning](../userguide/versioning.md). For more options, use the [GetObjectExtended (SOAP API)](https://docs.aws.amazon.com/AmazonS3/latest/API/SOAPGetObjectExtended.html) operation.
...
the file. For more information, see [GetObjectExtended (SOAP API)](https://docs.aws.amazon.com/AmazonS3/latest/API/SOAPGetObjectExtended.html).
