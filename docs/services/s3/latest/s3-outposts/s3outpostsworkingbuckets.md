---
title: "Working with S3 on Outposts buckets"
---
...
and tagging. For more information, see [What is Amazon S3 on Outposts?](s3onoutposts.md)
...
VPC and an endpoint for the same VPC. For more information, see [Networking for S3 on Outposts](s3outpostsnetworking.md).
