...
[What is\
AWS Outposts?](https://docs.aws.amazon.com/outposts/latest/userguide/what-is-outposts.htm) in the _AWS Outposts User Guide_.
...
environments with limited to no connectivity. For more information, see [Outpost connectivity to AWS Regions](https://docs.aws.amazon.com/outposts/latest/userguide/how-outposts-works.html#region-connectivity) in the _AWS Outposts User Guide_.
...
bucket naming rules](../userguide/bucketnamingrules.md). In S3 on Outposts, bucket names are unique to an
...
access point ARN or access point alias. For more information about access point aliases, see [Using a bucket-style alias for your S3 on Outposts bucket access point](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/s3-outposts-access-points-alias.html).
...
For more information about buckets, see [Working with S3 on Outposts buckets](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/S3OutpostsWorkingBuckets.html).
...
For more information about object keys, see [Working with S3 on Outposts objects](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/S3OutpostsWorkingObjects.html).
...
For more information, see [Managing S3 Versioning for your S3 on Outposts bucket](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/S3OutpostsManagingVersioning.html).
...
you modify these (or any other) objects with other operations, such as [PutObject](../api/api-putobject.md), the new objects get a unique version ID.
...
(SSE-S3). For more information, see [Data encryption in S3 on Outposts](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/s3-outposts-data-encryption.html).
...
control access to groups of objects that begin with a common [prefix](https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#keyprefix) or end with a given extension, such as
`.html`.
...
For more information about access point aliases, see [Using a bucket-style alias for your S3 on Outposts bucket access point](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/s3-outposts-access-points-alias.html).
...
For more information, see [Accessing your S3 on Outposts buckets and objects](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/S3OutpostsNetworking.html#AccessingS3Outposts).
...
- [S3 Block Public Access](../userguide/access-control-block-public-access.md) – Block public access to buckets
and objects. For buckets on Outposts, Block Public Access is always enabled
by default.

- [AWS Identity and Access Management\
(IAM)](https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3OutpostsIAM.html) – IAM is a web service that helps you securely
...
- [S3 on Outposts access points](https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3OutpostsWorkingBuckets.html) – Manage data access for shared
...
- [Bucket\
policies](../userguide/bucket-policies.md) – Use IAM-based policy language to configure
resource-based permissions for your S3 buckets and the objects in
them.

- [AWS Resource Access Manager\
(AWS RAM)](https://docs.aws.amazon.com/AmazonS3/latest/userguide/outposts-sharing-with-ram.html) – Securely share your S3 on Outposts capacity
...
[Monitoring\
tools](https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3OutpostsManaging.html).

- [Amazon CloudWatch metrics for S3 on Outposts](https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3OutpostsCapacity.html#S3OutpostsCloudWatchMetrics) – Track the
operational health of your resources and understand your capacity
availability.

- [Amazon CloudWatch Events events for S3 on Outposts](https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3OutpostsNotificationsCWE.html) – Create a rule for
...
- [AWS CloudTrail logs\
for S3 on Outposts](https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3OutpostsCloudtrail.html) – Record actions taken by a user, a
...
consistency model](../userguide/welcome.md#ConsistencyModel) in the _Amazon S3 User Guide_.
...
Outposts](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/snapshots-outposts.html) – Use Amazon EBS local snapshots on Outposts to store
snapshots of volumes on an Outpost locally in S3 on Outposts.

- [Amazon Relational Database Service (Amazon RDS) on\
Outposts](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-on-outposts.html) – Use Amazon RDS local backups to store your Amazon RDS backups
...
Linux. To get started, see the [AWS Command Line Interface User Guide](https://docs.aws.amazon.com/cli/latest/userguide). For more information about
the commands that you can use with S3 on Outposts, see [s3api](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/index.html), [s3control](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/index.html), and [s3outposts](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3outposts/index.html) in the _AWS CLI Command Reference_.
...
on AWS](https://aws.amazon.com/tools).
...
rack pricing](https://aws.amazon.com/outposts/rack/pricing).
...
- [How is Amazon S3 on Outposts different from Amazon S3?](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/S3OnOutpostsRestrictionsLimitations.html)

- [Getting started with Amazon S3 on Outposts](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/S3OutpostsGS.html)
...
- [Security in S3 on Outposts](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/s3outposts-security.html)

- [Managing S3 on Outposts storage](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/S3OutpostsManaging.html)

- [Developing with Amazon S3 on Outposts](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/S3OutpostsDeveloping.html)
