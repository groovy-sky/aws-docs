---
title: "Creating an S3 on Outposts bucket"
---
...
private cloud (VPC), see [AWS PrivateLink for S3 on Outposts](../userguide/s3-outposts-privatelink-interface-endpoints.md).
