...
processing, and data residency. You can use S3 on Outposts through the AWS Management Console, AWS Command Line Interface
(AWS CLI), AWS SDKs, or REST API. For more information, see [What is Amazon S3 on Outposts?](s3onoutposts.md)
...
information. For more information, see [Uploading an object using multipart upload](../userguide/mpu-upload-object.md) in the _Amazon Simple Storage Service User Guide_.
