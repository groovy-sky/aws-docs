...
Outposts buckets or for a list of specific Outposts buckets, you must [create a trail manually in CloudTrail](../../../awscloudtrail/latest/userguide/cloudtrail-create-a-trail-using-the-console-first-time.md). For more information about CloudTrail log file
...
more information, see [Creating and managing a lifecycle configuration for your Amazon S3 on Outposts bucket](s3outpostslifecyclemanaging.md).
...
events, see [Data events](../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md#logging-data-events) in the _AWS CloudTrail User Guide_.
...
in the CloudTrail console, see [Creating and updating a trail with the console](../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md#logging-data-events) in
...
console, see
[Logging data events for Amazon S3 Objects](../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md#logging-data-events-examples) in the
...
[Log S3 on Outposts events](../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md#creating-data-event-selectors-CLI-outposts) in the
_AWS CloudTrail User Guide_.
...
logging for data events in AWS CloudTrail](../user-guide/enable-cloudtrail-events.md).
