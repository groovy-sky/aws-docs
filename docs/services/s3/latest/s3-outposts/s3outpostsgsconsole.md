...
started by using the AWS CLI or AWS SDK for Java, see [Getting started by using the AWS CLI and SDK for Java](https://docs.aws.amazon.com/AmazonS3/latest/s3-outposts/S3OutpostsGSCLIJava.html).
