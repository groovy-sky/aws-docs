...
because those tables already exist. To delete your metadata tables, see [Delete a metadata table](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-delete-table.html#delete-metadata-table-procedure).
...
1. Delete your existing metadata table configuration. For step-by-step instructions, see [Deleting metadata table configurations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-delete-configuration.html).

2. Create a new metadata table configuration. For step-by-step instructions, see [Creating metadata table configurations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-create-configuration.html).
...
longer need the old journal table, you can delete it. For step-by-step instructions, see [Deleting metadata tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-delete-table.html). If you've retained your old journal table and want to join
it with your new one, see [Joining custom metadata with S3 metadata tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-join-custom-metadata.html) for examples of how
to join two tables.
