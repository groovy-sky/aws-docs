...
2. Using Account A credentials, sign in to the [IAM console](https://console.aws.amazon.com/iam/home?) to
      ...
      2. Grant administrator privileges to
          **AccountAadmin** by attaching a user
          ...
          Policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_manage.html) in the
          _IAM User Guide_.
3. While you are in the IAM console, note the **IAM user**
      **Sign-In URL** on the **Dashboard**. All
      ...
      For more information, see [How Users\
       Sign in to Your Account](https://docs.aws.amazon.com/IAM/latest/UserGuide/getting-started_how-users-sign-in.html) in
       _IAM User Guide_.
...
3. Save the administrator user credentials, also referred to as profiles. You can
    ...
    enter. For more information, see [Setting up the tools for the walkthroughs](https://docs.aws.amazon.com/AmazonS3/latest/userguide/policy-eval-walkthrough-download-awscli.html).
...
For instructions, go to [Step 2: Upload an object to your bucket](https://docs.aws.amazon.com/AmazonS3/latest/userguide/GetStartedWithS3.html#uploading-an-object-bucket).
...
users (console)](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html#id_users_create_console) in the _IAM User Guide_.
...
For instructions, see [Managing IAM policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_inline-using.html) in the
_IAM User Guide_.
...
1. Add the `UserDave` profile to the AWS CLI config file. For more
    information about the config file, see [Setting up the tools for the walkthroughs](https://docs.aws.amazon.com/AmazonS3/latest/userguide/policy-eval-walkthrough-download-awscli.html).
