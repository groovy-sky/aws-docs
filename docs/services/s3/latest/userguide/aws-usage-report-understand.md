...
codes](https://docs.aws.amazon.com/global-infrastructure/latest/regions/aws-region-billing-codes.html) in the _AWS Regions and Availability Zones User_
_Guide_.
...
For more information on S3 error codes under HTTP `3XX` and `4XX` status codes that aren't billed, see [Billing for Amazon S3 error responses](https://docs.aws.amazon.com/AmazonS3/latest/userguide/ErrorCodeBilling.html).
