...
5. The grantee accesses the S3 data using those temporary credentials. See [Accessing S3 data using credentials vended by S3 Access Grants](https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-grants-get-data.html).
...
For the maximum number of locations that you can register in your S3 Access Grants instance, see [S3 Access Grants limitations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-grants-limitations.html). For more information about registering an S3 Access Grants location, see [Register a location](access-grants-location-register.md).
...
For the maximum number of grants that you can create in your S3 Access Grants instance, see [S3 Access Grants limitations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-grants-limitations.html). For more information about creating grants, see [Create grants](https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-grants-grant-create.html).
