...
configurations in JSON and XML, see [Elements of a CORS configuration](managecorsusing.md).
...
and AWS Service Namespaces](../../../../general/latest/gr/aws-arns-and-namespaces.md) in the _Amazon Web Services General Reference_.

You can use the AWS SDK to manage cross-origin resource sharing (CORS) for a bucket.
For more information about CORS, see [Using cross-origin resource sharing (CORS)](cors.md).
...
- [PutBucketCors](../api/restbucketputcors.md)

- [GetBucketCors](../api/restbucketgetcors.md)

- [DeleteBucketCors](../api/restbucketdeletecors.md)

- [OPTIONS object](../api/restoptionsobject.md)
