...
encryption](https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucket-encryption.html), [S3 Versioning](https://docs.aws.amazon.com/AmazonS3/latest/userguide/versioning-workflows.html), and
[S3 Requester Pays](https://docs.aws.amazon.com/AmazonS3/latest/userguide/RequesterPaysBuckets.html) are set at the
...
settings for each dataset. Additionally, in a multi-tenant bucket, [cost allocation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/BucketBilling.html) can become complex as you work to
...
bucket encryption](https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucket-encryption.html), [S3 Versioning](https://docs.aws.amazon.com/AmazonS3/latest/userguide/versioning-workflows.html),
and [S3 Requester Pays](https://docs.aws.amazon.com/AmazonS3/latest/userguide/RequesterPaysBuckets.html) in a way that is
...
deploy and track any changes to your infrastructure. For more information, see [AWS::S3::Bucket](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3-bucket.html) in the _AWS CloudFormation User Guide_.
