...
see
[List the version of objects in an Amazon S3 bucket](../../../code-library/latest/ug/s3-example-s3-listobjectversions-section.md).
...
see [Retrieving the metadata of an object version](retmetaofobjversion.md).
