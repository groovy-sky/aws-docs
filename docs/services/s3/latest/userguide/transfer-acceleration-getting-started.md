...
For example, suppose that you currently have a REST API application using [PutObject](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectPUT.html) that uses the
