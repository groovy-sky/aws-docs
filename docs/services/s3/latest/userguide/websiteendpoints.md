...
Endpoints](../../../../general/latest/gr/s3.md#s3_website_region_endpoints).
...
with Route 53](website-hosting-custom-domain-walkthrough.md).
...
For a complete list of Amazon S3 endpoints, see [Amazon S3 endpoints and quotas](../../../../general/latest/gr/s3.md) in the
