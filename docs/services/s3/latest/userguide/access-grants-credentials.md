...
have granted this identity access to the data. Then, S3 Access Grants uses the [AssumeRole](../../../../reference/sts/latest/apireference/api-assumerole.md) API operation to obtain a temporary
...
For additional information, see [GetDataAccess](../api/api-control-getdataaccess.md) in the _Amazon Simple Storage Service API Reference_.
...
S3 Access Grants, see [GetDataAccess](../api/api-control-getdataaccess.md) in the
