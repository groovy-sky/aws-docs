...
you can specify when [attaching it to or excluding it from a S3 Storage Lens dashboard](storage-lens-groups-dashboard-console.md).
...
dashboards, see [Attaching or removing S3 Storage Lens groups to or from your dashboard](storage-lens-groups-dashboard-console.md).
...
[attach a Storage Lens group to a dashboard](storage-lens-groups-dashboard-console.md), you must specify the group
...
You can [create a Storage Lens group](storage-lens-groups-create.md) that includes up to 10 object tag filters. The
...
activate [attribute-based access control (ABAC)](../../../iam/latest/userguide/introduction-attribute-based-access-control.md). ABAC is an authorization strategy
...
access to AWS resources](../../../iam/latest/userguide/access-tags.md#access_tags_control-resources).
...
S3 Storage Lens group metrics are included in the [Amazon S3 Storage Lens metrics export](storage-lens-understanding-metrics-export-schema.md) for the dashboard that the Storage Lens group
