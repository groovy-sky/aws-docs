...
_[Amazon EventBridge User Guide](https://docs.aws.amazon.com/eventbridge/latest/userguide)_.
...
on the [CloudTrail console](https://console.aws.amazon.com/cloudtrail). For more
information about CloudTrail, see the [_AWS CloudTrail User Guide_](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/how-cloudtrail-works.html).
...
To do this, you create a rule by following all the steps in [Creating EventBridge rules that react to events](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-create-rule.html). You paste the following
