---
title: "Metadata table limitations and restrictions"
---
...
otherwise the query might not work. For examples, see [Example metadata table queries](metadata-tables-example-queries.md).
