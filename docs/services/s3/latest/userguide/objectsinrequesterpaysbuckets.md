...
in your signature calculation. For more information, see [Using an Authorization Header](../api/sigv4-auth-using-authorization-header.md) in the _Amazon S3 API Reference_
.
...
objects from a Requester Pays bucket. For more information, see [Error Responses](../api/errorresponses.md) in the _Amazon Simple Storage Service API Reference_.
