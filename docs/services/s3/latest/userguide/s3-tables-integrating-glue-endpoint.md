...
- [Have access to a data lake administrator account](../../../lake-formation/latest/dg/initial-lf-config.md#create-data-lake-admin)
...
For additional information about the AWS Glue Iceberg REST endpoint implementation, see [Connecting to the Data Catalog using AWS Glue Iceberg REST endpoint](../../../glue/latest/dg/connect-glu-iceberg-rest.md) in the _AWS Glue User Guide_.
