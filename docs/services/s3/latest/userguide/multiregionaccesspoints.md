...
[AWS Global Accelerator](https://docs.aws.amazon.com/global-accelerator/latest/dg) to automatically route over the AWS global
...
- [Making requests through a Multi-Region Access Point](https://docs.aws.amazon.com/AmazonS3/latest/userguide/MultiRegionAccessPointRequests.html)
