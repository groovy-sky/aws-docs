...
in your [PutBucketLogging](../api/api-putbucketlogging.md) configuration.
...
_grants_) in your [PutBucketLogging](../api/api-putbucketlogging.md) configuration. Instead, you must use a bucket
...
For
more information, see [Viewing the properties for an S3 general purpose bucket](view-bucket-properties.md).

To enable logging, you submit a [PutBucketLogging](../api/restbucketputlogging.md) request to add the logging configuration on
...
[PutBucketLogging](../api/restbucketputlogging.md).
...
To retrieve the logging configuration on a bucket, use the [GetBucketLogging](../api/restbucketgetlogging.md) API
operation.
...
[PutBucketLogging](../api/api-putbucketlogging.md) configuration.
...
If the destination bucket uses the Bucket owner enforced setting for
Object Ownership, you can't include destination (target) grants in your [PutBucketLogging](../api/api-putbucketlogging.md) configuration. For more information,
