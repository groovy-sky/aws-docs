...
more information, see [Expiring journal table records](metadata-tables-expire-journal-table-records.md).
...
- [S3 Metadata journal tables schema](metadata-tables-schema.md)

- [S3 Metadata live inventory tables schema](metadata-tables-inventory-schema.md)

- [Configuring metadata tables](metadata-tables-configuring.md)

- [Querying metadata tables](metadata-tables-querying.md)

- [Troubleshooting S3 Metadata](metadata-tables-troubleshooting.md)
