...
information, see [Working with objects in a versioning-enabled bucket](manage-objects-versioned-bucket.md).
...
high-level S3 commands with the AWS CLI](../../../cli/latest/userguide/using-s3-commands.md) in the _AWS Command Line Interface User Guide_.
...
For an example of how to empty a bucket using AWS SDK for Java, see [Deleting a general purpose bucket](delete-bucket.md). The code deletes all
...
non-current versions](versioning-workflows.md), [delete markers](deletemarker.md), and
[incomplete multipart uploads](mpu-abort-incomplete-mpu-lifecycle-config.md).
...
more information, see [Configuring a bucket lifecycle configuration to delete incomplete multipart uploads](mpu-abort-incomplete-mpu-lifecycle-config.md).
...
off logging for a trail](../../../awscloudtrail/latest/userguide/cloudtrail-delete-trails-console.md) in the _AWS CloudTrail User Guide_.
...
elements: Effect](../../../iam/latest/userguide/reference-policies-elements-effect.md) in the _IAM User Guide_.
