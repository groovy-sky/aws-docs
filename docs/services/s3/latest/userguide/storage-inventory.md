...
You can query Amazon S3 Inventory with standard SQL queries by using [Amazon Athena](../../../athena/latest/ug/what-is.md), [Amazon Redshift Spectrum](https://docs.aws.amazon.com/redshift/latest/dg/c-getting-started-using-spectrum.html), and other
...
information about using Athena to query your inventory files, see [Querying Amazon S3 Inventory with Amazon Athena](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-inventory-athena-query.html).
...
the destination bucket. For more information, see [Inventory manifest](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-inventory-location.html#storage-inventory-location-manifest).
...
was created and how it is encrypted. For more information, see [Object](https://docs.aws.amazon.com/AmazonS3/latest/API/API_Object.html) in the _Amazon Simple Storage Service API Reference_.
...
that's used to create the checksum for the object. For more information, see [Using supported checksum algorithms](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity-upload.html#using-additional-checksums).
...
encrypted with server-side encryption. For more information, see [Protecting data with encryption](https://docs.aws.amazon.com/AmazonS3/latest/userguide/UsingEncryption.html).
...
information, see [Uploading and copying objects using multipart upload in Amazon S3](https://docs.aws.amazon.com/AmazonS3/latest/userguide/mpuoverview.html).

- **Object owner** – The canonical user ID of the owner of the object. For more information, see [Find the canonical user ID for your AWS account](https://docs.aws.amazon.com/accounts/latest/reference/manage-acct-identifiers.html#FindCanonicalId) in the
_AWS Account Management Reference Guide_.

- **Replication status** – Set to
`PENDING`, `COMPLETED`, `FAILED`, or
`REPLICA`. For more information, see [Getting replication status information](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-status.html).

- **S3 Bucket Key status** – Set to
`ENABLED` or `DISABLED`. Indicates whether the object uses an
S3 Bucket Key for SSE-KMS. For more information, see [Using Amazon S3 Bucket Keys](https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucket-key.html).
...
For more information, see [Working with the Object ACL field](https://docs.aws.amazon.com/AmazonS3/latest/userguide/objectacl.html) and [Access control list (ACL) overview](acl-overview.md).
...
in Amazon Athena. For query examples, see [Querying Amazon S3 Inventory with Amazon Athena](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-inventory-athena-query.html).
...
see [Expiring objects](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-expire-general-considerations.html).
...
information about expiration actions in S3 Lifecycle, see [Expiring objects](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-expire-general-considerations.html).
...
metadata with the AWS CLI or the AWS SDKS. For more information, see [`HeadObject`](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectHEAD.html) in the
...
- [Configuring Amazon S3 Inventory](https://docs.aws.amazon.com/AmazonS3/latest/userguide/configure-inventory.html)

- [Locating your inventory list](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-inventory-location.html)

- [Setting up Amazon S3 Event Notifications for inventory completion](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-inventory-notification.html)
...
- [Converting empty version ID strings in Amazon S3 Inventory reports to null strings](https://docs.aws.amazon.com/AmazonS3/latest/userguide/inventory-configure-bops.html)
