...
To start visualizing the data for a Storage Lens group, you must first [attach your Storage Lens group to an S3 Storage Lens dashboard](storage-lens-groups-dashboard-console.md#storage-lens-groups-attach-dashboard-console). If you need to manage
...
[attribute-based access control (ABAC)](../../../iam/latest/userguide/introduction-attribute-based-access-control.md). ABAC is an authorization strategy that
...
to AWS resources](../../../iam/latest/userguide/access-tags.md#access_tags_control-resources).
