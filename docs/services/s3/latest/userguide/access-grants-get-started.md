...
StepsDescription1[Create an S3 Access Grants instance](access-grants-instance.md)

To get started, initiate an S3 Access Grants instance that will contain your
individual access grants.

2[Register a location](access-grants-location.md)
...
3[Create grants](access-grants-grant.md)
...
4[Request\
access to S3 data](access-grants-credentials.md)
...
5[Access S3 data](access-grants-get-data.md)
