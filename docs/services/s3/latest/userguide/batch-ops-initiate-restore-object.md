---
title: "Restore objects with Batch Operations"
---
...
Using a **Restore** ( [S3InitiateRestoreObjectOperation](../api/api-control-s3initiaterestoreobjectoperation.md)) operation in your S3 Batch Operations
...
If your [S3InitiateRestoreObjectOperation](../api/api-control-s3initiaterestoreobjectoperation.md) job tries to restore an object
