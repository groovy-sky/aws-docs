...
Maintenance operationPropertyConfigurable at table bucket level?Configurable at table level?Default valueMinimum valueRelated Iceberg maintenance routineControlling S3 Tables APICompaction`targetFileSizeMB`NoYes512MB64MB`rewriteDataFiles`[`PutTableMaintenanceConfiguration`](../api/api-s3tables-puttablemaintenanceconfiguration.md)Snapshot management`minimumSnapshots`NoYes11[`ExpireSnapshots`](https://iceberg.apache.org/docs/latest/maintenance) `retainLast```[`PutTableMaintenanceConfiguration`](../api/api-s3tables-puttablemaintenanceconfiguration.md)Snapshot management`maximumSnapshotAge`NoYes120 hours1 hour[`ExpireSnapshots`](https://iceberg.apache.org/docs/latest/maintenance) `expireOlderThan`[`PutTableMaintenanceConfiguration`](../api/api-s3tables-puttablemaintenanceconfiguration.md)Unreferenced file removal`unreferencedDays`YesNo3 days1 days[`deleteOrphanFiles`](https://iceberg.apache.org/docs/latest/maintenance)[`PutTableBucketMaintenanceConfiguration`](../api/api-s3tables-puttablebucketmaintenanceconfiguration.md)Unreferenced file removal`nonCurrentDays`YesNo10 days1 daysN/A[`PutTableBucketMaintenanceConfiguration`](../api/api-s3tables-puttablebucketmaintenanceconfiguration.md)
