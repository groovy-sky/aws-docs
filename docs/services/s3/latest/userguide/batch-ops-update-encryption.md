...
The Batch Operations [`UpdateObjectEncryption`](https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_UpdateObjectEncryptionOperation.html) operation updates the
...
_Amazon S3API Reference_](https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_SSEKMSFilter.html).
...
For more information about `UpdateObjectEncryption`, see [Updating server-side encryption for existing data](https://docs.aws.amazon.com/AmazonS3/latest/userguide/update-sse-encryption.html).
