...
creating Lambda functions, see [Writing Lambda functions for S3 Object Lambda Access Points](https://docs.aws.amazon.com/AmazonS3/latest/userguide/olap-writing-lambda.html). For more
information about prebuilt functions, see [Using AWS built Lambda functions](https://docs.aws.amazon.com/AmazonS3/latest/userguide/olap-examples.html).
...
For information about how to create an Object Lambda Access Point by using the REST API, see [`CreateAccessPointForObjectLambda`](https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_CreateAccessPointForObjectLambda.html) in the _Amazon Simple Storage Service API Reference_.
...
information about built functions, see [Using AWS built Lambda functions](https://docs.aws.amazon.com/AmazonS3/latest/userguide/olap-examples.html).
...
09. (Optional) For **Range and part number**, you must enable this
     ...
     headers and part numbers, see [Working with Range and partNumber headers](https://docs.aws.amazon.com/AmazonS3/latest/userguide/range-get-olap.html).
...
11. (Optional) Under **Object Lambda Access Point policy**, set a resource policy.
     ...
     Object Lambda Access Point resource policies see, [Configuring IAM policies for Object Lambda Access Points](https://docs.aws.amazon.com/AmazonS3/latest/userguide/olap-policies.html).
...
modifying the template's default configuration, see [Automate S3 Object Lambda setup with a CloudFormation template](https://docs.aws.amazon.com/AmazonS3/latest/userguide/olap-using-cfn-template.html).
...
functions, see [Writing Lambda functions for S3 Object Lambda Access Points](https://docs.aws.amazon.com/AmazonS3/latest/userguide/olap-writing-lambda.html). To use your custom
function with the AWS CLI, see [Using Lambda with the\
AWS CLI](https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-awscli.html) in the _AWS Lambda Developer Guide_.

- Use an AWS prebuilt Lambda function. For more information about prebuilt
functions, see [Using AWS built Lambda functions](https://docs.aws.amazon.com/AmazonS3/latest/userguide/olap-examples.html).
...
For information about modifying the AWS CloudFormation template's default configuration, see [Automate S3 Object Lambda setup with a CloudFormation template](https://docs.aws.amazon.com/AmazonS3/latest/userguide/olap-using-cfn-template.html).

For information about configuring Object Lambda Access Points by using CloudFormation without the template, see [`AWS::S3ObjectLambda::AccessPoint`](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3objectlambda-accesspoint.html) in the
...
10. On the **Configure stack options page**, choose **Next**.
    ...
    For more information about the optional settings on this page, see [Setting\
     AWS CloudFormation stack options](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/cfn-console-add-tags.html) in the
     _AWS CloudFormation User Guide_.

11. On the **Review** page, choose **Create stack**.

For more information about configuring Object Lambda Access Points by using the AWS CDK, see [`AWS::S3ObjectLambda` Construct Library](https://docs.aws.amazon.com/cdk/api/latest/docs/aws-s3objectlambda-readme.html) in the
