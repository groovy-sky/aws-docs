...
several hours. For visibility into replication times, you can use [S3 Replication Time Control (S3 RTC)](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-time-control.html#enabling-replication-time-control).
...
[Receiving replication failure events with Amazon S3 Event Notifications](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-metrics.html).
...
owner](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-change-owner.html).
...
buckets can't be configured as a Requester Pays bucket. For more information, see [Using Requester Pays general purpose buckets for storage transfers and usage](https://docs.aws.amazon.com/AmazonS3/latest/userguide/RequesterPaysBuckets.html).
...
objects](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-walkthrough-4.html).
...
replicate objects. For an example, see [Configuring replication for buckets in different accounts](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-walkthrough-2.html).
...
Amazon Simple Queue Service (Amazon SQS), Amazon Simple Notification Service (Amazon SNS), or AWS Lambda. For more information, see [Receiving replication failure events with Amazon S3 Event Notifications](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-metrics-events.html).
...
reasons](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-failure-codes.html).
...
For additional troubleshooting tips for working with Batch Operations, see [Troubleshooting S3 Batch Operations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/troubleshooting-batch-operations.html).
...
more information, see [Restoring an archived object](restoring-objects.md) and [Restore objects (Batch Operations)](https://docs.aws.amazon.com/AmazonS3/latest/userguide/batch-ops-initiate-restore-object.html).
...
replication failure reason](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-failure-codes.html).
...
common errors, see [Amazon S3 replication failure reasons](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-metrics-events.html#replication-failure-codes).
