...
05. Choose **Switch to wizard**.
    ...
    Bucket](../../../route53/latest/developerguide/routingtos3bucket.md#routing-to-s3-bucket-configuring).
...
Website endpoints](../../../../general/latest/gr/s3.md#s3_website_region_endpoints). For more information about the alias
target, see [Value/route traffic to](../../../route53/latest/developerguide/resource-record-sets-values-alias.md#rrsets-values-alias-alias-target) in the
...
For a complete list of Amazon S3 website endpoints, see [Amazon S3 Website endpoints](../../../../general/latest/gr/s3.md#s3_website_region_endpoints). For more information
about the alias target, see [Value/route traffic to](../../../route53/latest/developerguide/resource-record-sets-values-alias.md#rrsets-values-alias-alias-target) in the
_Amazon Route 53 Developer Guide_.
...
domain](../../../route53/latest/developerguide/domain-name-servers-glue-records.md).
