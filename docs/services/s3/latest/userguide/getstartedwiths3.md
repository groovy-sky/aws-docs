...
of the AWS Management Console](../../../awsconsolehelpdocs/latest/gsg/getting-started.md#change-language) in the _AWS Management Console Getting Started Guide_.
...
(users, user groups, and roles)](../../../iam/latest/userguide/id.md) in the _IAM User Guide_.
...
Amazon S3: High-level ( [s3](../../../cli/latest/userguide/cli-services-s3-commands.md)) commands and API-level ( [s3api](../../../cli/latest/userguide/cli-services-s3-apicommands.md) and `s3control` commands. The high-level S3
...
Code Sample Catalog](../../../code-samples/latest/catalog/welcome.md) have sample code and
