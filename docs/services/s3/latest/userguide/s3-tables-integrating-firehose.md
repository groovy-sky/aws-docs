---
title: "Streaming data to tables with Amazon Data Firehose"
---
...
delivering it. To learn more about Amazon Data Firehose, see [What is Amazon Data Firehose?](../../../firehose/latest/dev/what-is-this-service.md)
...
3. Grant the Firehose service role explicit permissions to your table or table's namespace. For more information, see [Grant necessary permissions](../../../firehose/latest/dev/apache-iceberg-prereq.md#s3-tables-prerequisites).
...
Firehose needs an IAM [service role](../../../iam/latest/userguide/id-roles-create-for-service.md) with specific
...
If error logging is enabled, Firehose also sends data delivery errors to your
    ...
    Amazon Data Firehose Using CloudWatch Logs](../../../firehose/latest/dev/controlling-access.md#using-iam-iceberg).
...
- [Grant necessary permissions](../../../firehose/latest/dev/apache-iceberg-prereq.md#s3-tables-prerequisites) to the Firehose service role you created to access tables.
...
records to a single Iceberg table](../../../firehose/latest/dev/apache-iceberg-format-input-record.md).
...
08. Configure database and table names using **Unique Key configuration**,
     ...
     incoming records to a single Iceberg table](../../../firehose/latest/dev/apache-iceberg-format-input-record.md) and [Route incoming\
     records to different Iceberg tables](../../../firehose/latest/dev/apache-iceberg-format-input-record-different.md) in the _Amazon Data Firehose Developer_
    _Guide_.
...
stream](../../../firehose/latest/dev/apache-iceberg-stream.md) in the _Amazon Data Firehose Developer Guide_.
