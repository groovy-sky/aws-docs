...
five supported Regions. For more information about Multi-Region Access Point supported Regions, see [Multi-Region Access Point restrictions and limitations](multiregionaccesspointrestrictions.md).
...
AWS SDKs](../../../../reference/sdkref/latest/guide/feature-s3-mrap.md#s3-mrap-sdk-compat).
...
Replication](multiregionaccesspointbucketreplication.md).
...
compatibility](../../../../reference/sdkref/latest/guide/feature-s3-mrap.md#s3-mrap-sdk-compat) with the SigV4A algorithm. Verify that your SDK version
...
error. To resolve this issue, use any of the listed [Regional endpoints for AWS STS](../../../iam/latest/userguide/id-credentials-temp-enable-regions.md#id_credentials_region-endpoints).
...
Requester Pays](requesterpaysexamples.md), the requester will pay for the
bucket
