...
can set up AWS Cost and Usage Reports. For more information, see [What are AWSCost and Usage Reports?](../../../cur/latest/userguide/what-is-cur.md) in the _AWS Data_
_Exports Guide_.

You can also download a usage report that gives more detail about your Amazon S3 storage
usage than the billing reports. For more information, see [AWS usage reports for Amazon S3](aws-usage-report.md).
