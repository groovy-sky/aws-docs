...
more information about the SQL elements that are supported by Amazon S3 Select, see [SQL reference for Amazon S3 Select](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-select-sql-reference.html).
...
For more information about constructing an Amazon S3 Select request, see [SelectObjectContent](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectSELECTContent.html) in the
...
- [Examples of using Amazon S3 Select on an object](https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-select.html)
