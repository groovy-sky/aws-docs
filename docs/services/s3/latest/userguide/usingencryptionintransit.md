...
see [Configuring hybrid post-quantum TLS for your client](https://docs.aws.amazon.com/AmazonS3/latest/userguide/pqtls-how-to.html).
...
- **AWS CloudTrail** – [AWS CloudTrail](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html) is a service that provides a record of actions taken by a
...
Policies](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scps.html) (SCPs), [Resource Control\
Policies](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_rcps.html) (RCPs), and [VPC endpoint\
...
You can use the [S3 condition key](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html#amazons3-policy-keys) `s3:TlsVersion` to restrict access to Amazon S3 buckets based on the TLS
...
condition key](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_condition-keys.html) in your S3 bucket policy to check whether the request was
