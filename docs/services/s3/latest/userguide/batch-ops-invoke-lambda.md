...
or Amazon S3 REST API. For more information about using Lambda, see [Getting Started with AWS Lambda](../../../lambda/latest/dg/getting-started.md) in the
...
return messages. For more information about using Lambda with Amazon S3 events, see [Using AWS Lambda with Amazon S3](../../../lambda/latest/dg/with-s3.md) in the
_AWS Lambda Developer Guide_.
...
versions. For more information, see [Introduction to AWS Lambda Versioning](../../../lambda/latest/dg/versioning-intro.md) in the
_AWS Lambda Developer Guide_.
...
an updated JSON schema, and specify [InvocationSchemaVersion](../api/api-control-lambdainvokeoperation.md#AmazonS3-Type-control_LambdaInvokeOperation-InvocationSchemaVersion) 2.0 (not 1.0) when you
create the job. This updated schema allows you to specify optional key-value pairs
for [UserArguments](../api/api-control-lambdainvokeoperation.md#AmazonS3-Type-control_LambdaInvokeOperation-UserArguments), which you can use to modify certain
...
S3 Batch Operations. If you have never created a Lambda function before, see [Tutorial: Using AWS Lambda with Amazon S3](../../../lambda/latest/dg/with-s3-example.md)
...
interfaces](../../../lambda/latest/dg/java-handler.md#java-handler-interfaces) in the _AWS Lambda User Guide_.
