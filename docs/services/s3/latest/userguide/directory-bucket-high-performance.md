...
gateway VPC endpoints, see [Networking for directory buckets](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-networking.html)
...
operations (with the exception of [CopyObject](https://docs.aws.amazon.com/AmazonS3/latest/userguide/directory-buckets-objects-copy.html)). For more information, see [Authorizing Zonal endpoint API operations with CreateSession](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-create-session.html).

The [supported AWS SDKs\
for S3 Express One Zone](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-SDKs.html#s3-express-getting-started-accessing-sdks) handle session establishment and refreshment on your
...
supported API operationss and unsupported features, see [Differences for directory buckets](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-differences.html).
...
directory buckets is set only at the bucket level. For more information, see [Authorizing Regional endpoint API operations with IAM](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-security-iam.html).

- [S3 Block Public\
Access](https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-control-block-public-access.html) – All S3 Block Public Access settings are enabled
by default at the bucket level. This default setting can't be modified.

- [S3 Object Ownership](https://docs.aws.amazon.com/AmazonS3/latest/userguide/about-object-ownership.html) (bucket
...
- [AWS Identity and Access Management (IAM)](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-security-iam.html) –
...
[Authorizing Regional endpoint API operations with IAM](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-security-iam.html). Unlike object-management
actions, bucket management actions cannot be cross-account. Only the bucket
owner can perform those actions.

- [Bucket\
policies](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-security-iam-example-bucket-policies.html) – Use IAM-based policy language to configure
...
more information about S3 Express One Zone permissions and policies, see [Authorizing Regional endpoint API operations with IAM](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-security-iam.html).
...
- [Amazon CloudWatch metrics](https://docs.aws.amazon.com/AmazonS3/latest/userguide/cloudwatch-monitoring.html) –
...
`NumberOfObjects`. For more information, see [Monitoring metrics with Amazon CloudWatch](https://docs.aws.amazon.com/AmazonS3/latest/userguide/cloudwatch-monitoring.html).

- [AWS CloudTrail logs](https://docs.aws.amazon.com/AmazonS3/latest/userguide/cloudtrail-logging-s3-info.html) – AWS CloudTrail is an
...
information, see [Logging with AWS CloudTrail for S3 Express One Zone](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-one-zone-logging.html).
...
- [S3 Batch Operations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/batch-ops-create-job.html) – Use
...
- [Import](https://docs.aws.amazon.com/AmazonS3/latest/userguide/create-import-job.html)
...
- [PyTorch on AWS](https://docs.aws.amazon.com/sagemaker/latest/dg/pytorch.html) – PyTorch on AWS
...
For more information about using the AWS SDKs with S3 Express One Zone, see [AWS SDKs](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-SDKs.html#s3-express-getting-started-accessing-sdks).
...
AWS KMS keys (DSSE-KMS). For more information, see [Data protection and encryption](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-data-protection.html).
...
For more information, see [S3 additional checksum best practices](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-optimizing-performance.html#s3-express-optimizing-performance-checksums).
...
signs requests by using AWS Sigv4. For more information, see [Authenticating Requests (AWS Signature Version 4)](https://docs.aws.amazon.com/AmazonS3/latest/API/sig-v4-authenticating-requests.html) in the
...
- [Amazon Elastic Compute Cloud (Amazon EC2)](https://docs.aws.amazon.com/ec2/index.html) – Amazon EC2
...
- [AWS Lambda](https://docs.aws.amazon.com/lambda/latest/dg/welcome.html.html) – Lambda is a compute service that lets you run
...
(Amazon EKS)](https://docs.aws.amazon.com/eks/latest/userguide/what-is-eks.html) – Amazon EKS is a managed service that eliminates the need
...
- [Amazon Elastic Container Service (Amazon ECS)](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/Welcome.html) – Amazon ECS is a fully managed container
...
- [Amazon SageMaker\
Training](https://docs.aws.amazon.com/sagemaker/latest/dg/how-it-works-training.html) – Review the options for training models with Amazon
...
- [Amazon EMR](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-what-is-emr.html) – Amazon EMR is a managed cluster platform that simplifies
running big data frameworks, such as Apache Hadoop and
Apache Spark, on AWS to process and analyze vast amounts of
data.

- [AWSCloudTrail](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html) – AWSCloudTrail is s an AWS service
...
- [S3 Express One Zone Availability Zones and Regions](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-Endpoints.html)
...
- [Regional and Zonal endpoints for directory buckets in an Availability Zone](https://docs.aws.amazon.com/AmazonS3/latest/userguide/endpoint-directory-buckets-AZ.html)
