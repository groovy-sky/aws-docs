...
using these access policy alternatives, see [Walkthroughs that use policies to manage access to your Amazon S3 resources](example-walkthroughs-managing-access.md).
...
access. For more information, see [Controlling ownership of objects and disabling ACLs for your bucket](about-object-ownership.md).

The following is an illustration of the context-based evaluation for an object operation.

![Illustration that shows the context-based evaluation for an object operation.](https://docs.aws.amazon.com/images/AmazonS3/latest/userguide/images/AccessControlAuthorizationFlowObjectResource.png)
...
![Illustration that shows an object operation request.](https://docs.aws.amazon.com/images/AmazonS3/latest/userguide/images/example50-policy-eval-logic.png)
