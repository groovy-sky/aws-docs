...
configuration on your general purpose bucket. For more information, see [Deleting metadata table configurations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-delete-configuration.html).
...
information, see [Deleting metadata table configurations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-delete-configuration.html) and [Deleting metadata tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-delete-table.html).
...
To delete your metadata tables, see [Deleting metadata tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-delete-table.html).
...
can create an inventory table and expire journal table records. For more information, see [Enabling inventory tables on metadata configurations created before July 15, 2025](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-create-configuration.html#metadata-tables-migration).
...
about migrating from V1 of S3 Metadata to V2, see [Enabling inventory tables on metadata configurations created before July 15, 2025](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-create-configuration.html#metadata-tables-migration).
...
For more information, see [Viewing metadata table configurations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-view-configuration.html).
