...
Amazon S3](https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance-guidelines.html) for you to consider when planning
...
set of objects, you can use a cache such as [Amazon CloudFront](https://docs.aws.amazon.com/cloudfront/index.html), [Amazon ElastiCache](https://docs.aws.amazon.com/elasticache/index.html), or [AWS Elemental MediaStore](https://docs.aws.amazon.com/mediastore/index.html) to optimize performance.
...
delivery of popular Amazon S3 content. For information about CloudFront, see the [Amazon CloudFront Developer Guide](../../../amazoncloudfront/latest/developerguide.md).
...
performance, see the blog post [Turbocharge Amazon S3 with Amazon ElastiCache for Redis](https://aws.amazon.com/blogs/storage/turbocharge-amazon-s3-with-amazon-elasticache-for-redis).
...
about MediaStore, see the [AWS Elemental MediaStore User Guide](https://docs.aws.amazon.com/mediastore/latest/ug).
...
information about back-off techniques, see [Retry behavior](https://docs.aws.amazon.com/sdkref/latest/guide/feature-retry-behavior.html) in the
...
If you are using AWS Key Management Service (AWS KMS) for server-side encryption, see [Quotas](https://docs.aws.amazon.com/kms/latest/developerguide/limits.html) in the _AWS Key Management Service Developer Guide_
...
connections to GET or PUT data in parallel. For example, this is supported by [Amazon S3 Transfer Manager](https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/transfer-manager.html) in the AWS Java SDK, and most of the other AWS SDKs
...
see the [Amazon Simple Storage Service API Reference](../api.md).
...
[Configuring fast, secure file transfers using Amazon S3 Transfer Acceleration](transfer-acceleration.md) is
...
through CloudFront and to provide rapid responses to DNS queries made to [Amazon Route 53](https://docs.aws.amazon.com/route53/index.html).
...
whether Transfer Acceleration helps client request performance is to use the [Amazon S3 Transfer Acceleration Speed Comparison tool](https://s3-accelerate-speedtest.s3-accelerate.amazonaws.com/en/accelerate-speed-comparsion.html). Network configurations and conditions
...
information about using Transfer Acceleration with different AWS SDKs, see [Enabling and using S3 Transfer Acceleration](transfer-acceleration-examples.md).
