...
permissions](../../../lake-formation/latest/dg/lf-permissions-overview.md) in the _AWS Lake Formation Developer Guide_.
...
see [Cross-account data sharing in Lake Formation](../../../lake-formation/latest/dg/cross-account-permissions.md) in the _AWS Lake Formation Developer_
_Guide_.
...
1. Make sure that you're running the following AWS CLI commands as a data lake administrator. For more
    ...
    data lake administrator](../../../lake-formation/latest/dg/initial-lf-config.md#create-data-lake-admin) in the _AWS Lake Formation Developer_
_Guide_.
