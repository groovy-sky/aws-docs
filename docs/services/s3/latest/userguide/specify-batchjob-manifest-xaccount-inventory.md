...
manifest in the source or destination account, see [Using a CSV manifest to copy objects across AWS accounts](https://docs.aws.amazon.com/AmazonS3/latest/userguide/specify-batchjob-manifest-xaccount-csv.html).
