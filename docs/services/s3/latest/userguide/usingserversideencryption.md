...
about the REST APIs, see [Using the REST API](https://docs.aws.amazon.com/AmazonS3/latest/userguide/specifying-s3-encryption.html#SSEUsingRESTAPI).
...
see [PUT Object](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectPUT.html).
...
information, see [POST Object](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectPOST.html).
...
concepts](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html) in the _AWS Key Management Service Developer Guide_.
