---
title: "Using the Amazon S3 Transfer Acceleration Speed Comparison tool"
---
...
For a list of the Regions supported by Amazon S3, see [Amazon S3 endpoints and quotas](../../../../general/latest/gr/s3.md) in the
