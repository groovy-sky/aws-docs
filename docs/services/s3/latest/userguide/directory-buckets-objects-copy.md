...
more information, see [Using multipart uploads with directory buckets](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-using-multipart-upload.html).
