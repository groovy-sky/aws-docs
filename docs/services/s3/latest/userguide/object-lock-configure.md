...
directly from the AWS Management Console. For more information, see [What is CloudShell?](../../../cloudshell/latest/userguide/welcome.md) in the
...
For examples of how to enable Object Lock when creating a new S3 bucket with the AWS SDKs, see [Code examples](../api/s3-example-s3-lcreatebucket-section.md) in the _Amazon S3 API Reference_.

For examples of how to get the current Object Lock configuration with the AWS SDKs, see [Code examples](../api/s3-example-s3-getobjectlockconfiguration-section.md) in the _Amazon S3 API Reference_.

For an interactive scenario demonstrating different Object Lock features using the AWS SDKs, see [Code examples](../api/s3-example-s3-scenario-objectlock-section.md) in the _Amazon S3 API Reference_.
...
For examples of how to enable Object Lock for an existing S3 bucket with the AWS SDKs, see [Code examples](../api/s3-example-s3-putobjectlockconfiguration-section.md) in the _Amazon S3 API Reference_.
...
For examples of how to set a legal hold on an object with the AWS SDKs, see [Code examples](../api/s3-example-s3-putobjectlegalhold-section.md) in the _Amazon S3 API Reference_.

For examples of how to get the current legal hold status with the AWS SDKs, see [Code examples](../api/s3-example-s3-getobjectlegalholdconfiguration-section.md) in the _Amazon S3 API Reference_.
...
For examples of how to set a retention period on an object with the AWS SDKs, see [Code examples](../api/s3-example-s3-putobjectretention-section.md) in the _Amazon S3 API Reference_.

For examples of how to get the retention period on an object with the AWS SDKs, see [Code examples](../api/s3-example-s3-getobjectlockconfiguration-section.md) in the _Amazon S3 API Reference_.

For an interactive scenario demonstrating different Object Lock features using the AWS SDKs, see [Code examples](../api/s3-example-s3-getobjectlockconfiguration-section.md) in the _Amazon S3 API Reference_.
...
For examples of how to set a default retention period on an existing S3 bucket with the AWS SDKs, see [Code examples](../api/s3-example-s3-putobjectlockconfiguration-section.md) in the _Amazon S3 API Reference_.
