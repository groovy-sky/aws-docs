...
which AWS Regions your account can use](https://docs.aws.amazon.com/accounts/latest/reference/manage-acct-regions.html) in the _AWS Account Management Reference Guide_.
...
permissions, see [Setting up permissions for live replication](https://docs.aws.amazon.com/AmazonS3/latest/userguide/setting-repl-config-perm-overview.html).
...
For more information, see [Setting up live replication overview](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-how-setup.html).
...
invoking [CopyObject](../api/api-copyobject.md) or [UploadPartCopy](https://docs.aws.amazon.com/AmazonS3/latest/API/API_UploadPartCopy.html)
...
For information about considerations for Batch Replication, see [S3 Batch Replication considerations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-batch-replication-batch.html#batch-replication-considerations).

### S3 Replication Time Control

For information about best practices and considerations for S3 Replication Time Control (S3 RTC), see [Best practices and guidelines for S3 RTC](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-time-control.html#rtc-best-practices).
