...
keys, see [Key states of AWS KMS keys](../../../kms/latest/developerguide/key-state.md) in the
...
AWS KMS keys](../../../kms/latest/developerguide/key-state.md) in the _AWS Key Management Service Developer Guide_.
