...
For more information, see [restore-object](../../../cli/latest/reference/s3api/restore-object.md) in the _AWS CLI Command Reference_.

Amazon S3 provides an API operation for you to initiate the restoration of an archived
object. For more information, see [RestoreObject](../api/restobjectpostrestore.md) in the _Amazon Simple Storage Service API Reference_.
