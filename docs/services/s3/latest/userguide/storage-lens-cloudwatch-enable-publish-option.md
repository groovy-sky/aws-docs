...
10. (Optional) Configure your metrics export.
    ...
    For more information about how to configure a metrics export, see step [Using the S3 console](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage_lens_creating_dashboard.html#storage_lens_console_creating).
