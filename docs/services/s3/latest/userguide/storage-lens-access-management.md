...
Object Ownership to bucket owner enforced, you can disable [access control lists (ACLs)](acl-overview.md) and take ownership of every object in your bucket.
...
03. In the **Dashboards** list, choose the name of the dashboard
     that you want to view.

04. To view more detailed bucket-level metrics, choose the
     **Bucket** tab.

05. In the **Distribution by buckets for _date_** section, choose the **%**
...
06. To view the bucket owner enforced settings in context, scroll down to the
...
09. (Optional) Under **Page size**, choose the number of buckets
...
information, see [Prerequisites for disabling ACLs](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-ownership-migrating-acls-prerequisites.html).
