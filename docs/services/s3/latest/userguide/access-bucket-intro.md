...
hosting a website on Amazon S3, see [Tutorial: Configuring a static website on Amazon S3](hostingwebsiteons3setup.md).
...
see [Getting started with a secure static website](../../../amazoncloudfront/latest/developerguide/getting-started-secure-static-website-cloudformation-template.md).

###### Note

Amazon S3 supports both [virtual-hosted–style](virtualhosting.md#virtual-hosted-style-access) and [path-style URLs](virtualhosting.md#path-style-access) for static website access. Because buckets can be accessed
using path-style and virtual-hosted–style URLs, we recommend that you create
buckets with DNS-compliant bucket names. For more information, see [General purpose bucket quotas, limitations, and restrictions](bucketrestrictions.md).
...
through a file interface. For more information, see [Mount an Amazon S3 bucket as a local file system](mountpoint.md).
...
information, see [Managing multi-Region traffic with Multi-Region Access Points](multiregionaccesspoints.md).
