...
- Learn about [Table naming for S3 Storage Lens export to S3 Tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-lens-s3-tables-naming.html)

- Learn about [Understanding S3 Storage Lens table schemas](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-lens-s3-tables-schemas.html)
