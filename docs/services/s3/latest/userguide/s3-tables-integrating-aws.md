...
- [Create a table\
bucket.](s3-tables-buckets-create.md)
...
- [Update to the latest version of the AWS Command Line Interface (AWS CLI)](../../../cli/latest/userguide/getting-started-install.md#getting-started-install-instructions).
...
The AWS analytics services integration process has been updated to use IAM permissions by default. If you've already set up the integration, you can continue to use your current integration. However, if you want to change your existing integration to use IAM permissions instead, see [_AWS Lake Formation Developer Guide_](../../../lake-formation/latest/dg/create-s3-tables-catalog.md). You can also redo the integration to delete your existing setup in AWS Glue Data Catalog and AWS Lake Formation and re-run the integration. This will remove all existing Lake Formation grants and associated access permissions to the `s3tablescatalog`.
...
1. Open the AWS Lake Formation console at [https://console.aws.amazon.com/lakeformation/](https://console.aws.amazon.com/lakeformation), and sign in as a
    ...
    [Create a data\
    lake administrator](../../../lake-formation/latest/dg/initial-lf-config.md#create-data-lake-admin) in the _AWS Lake Formation Developer_
_Guide_.
