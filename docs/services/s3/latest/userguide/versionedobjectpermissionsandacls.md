...
For more information, see [GetObjectAcl](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectGETacl.html) in the _Amazon Simple Storage Service API Reference_.
