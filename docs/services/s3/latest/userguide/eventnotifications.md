...
more information, see [General purpose buckets configuration options](usingbucket.md#bucket-config-options-intro). Amazon S3 provides an API for you to manage
this subresource.
...
[Amazon S3 service quotas](https://docs.aws.amazon.com/general/latest/gr/s3.html#limits_s3) in _AWS General Reference_.
