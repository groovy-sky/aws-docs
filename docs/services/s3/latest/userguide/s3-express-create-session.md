...
bucket in an identity-based policy or a bucket policy. For more information, see [Authorizing Regional endpoint API operations with IAM](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-security-iam.html). If you're
...
`x-amz-create-session-mode` parameter for [CreateSession](https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateSession.html) in the _Amazon S3 API_
...
For more information, see [CreateSession](https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateSession.html) in
