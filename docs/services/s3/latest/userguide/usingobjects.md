...
50 TB. For more information, see [Uploading objects](upload-objects.md).
...
information about sharing objects, see [Sharing objects with presigned URLs](shareobjectpresignedurl.md).
