...
quotas and how to request a quota increase, see [Quotas](https://docs.aws.amazon.com/kms/latest/developerguide/limits.html) in the _AWS Key Management Service Developer Guide_.
...
For more information, see [Configuring an S3 Bucket Key at the object level](https://docs.aws.amazon.com/AmazonS3/latest/userguide/configuring-bucket-key-object.html).
...
API operations, see [Uploading an object using multipart upload](https://docs.aws.amazon.com/AmazonS3/latest/userguide/mpu-upload-object.html).
