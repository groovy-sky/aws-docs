---
title: "Using tags with S3 tables"
---
...
For additional example policies and more
information, see [Controlling\
access during AWS requests](../../../iam/latest/userguide/access-tags.md#access_tags_control-requests) in the _AWS Identity and Access Management User_
_Guide_.
