...
[Launch an Amazon EMR cluster with S3 Access Grants](../../../emr/latest/managementguide/emr-access-grants.md)

**Amazon EMR on EKS**

[Launch an Amazon EMR on EKS cluster with S3 Access Grants](../../../emr/latest/emr-on-eks-developmentguide/access-grants.md)

**Amazon EMR Serverless application**

[Launch an Amazon EMR Serverless application with S3 Access Grants](../../../emr/latest/emr-serverless-userguide/access-grants.md)

**Amazon Redshift**

[Amazon Redshift integration with Amazon S3 Access Grants](../../../redshift/latest/mgmt/redshift-iam-access-control-sso-s3idc.md)

**Amazon SageMaker AI Studio**

[Adding Amazon S3 data to Amazon SageMaker AI Unified Studio](../../../sagemaker-unified-studio/latest/userguide/adding-existing-s3-data.md)
...
[Amazon S3 Access Grants with AWS Glue](../../../glue/latest/dg/security-s3-access-grants.md)

**AWS IAM Identity Center**

[Trusted identity propagation across applications](../../../singlesignon/latest/userguide/trustedidentitypropagation.md)

**AWS Transfer Family**

[Configure Amazon S3 Access Grants](../../../transfer/latest/userguide/webapp-access-grant.md) for AWS Transfer Family
