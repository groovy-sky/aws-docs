...
- [Cost optimization for tables with Intelligent-Tiering](https://docs.aws.amazon.com/AmazonS3/latest/userguide/tables-intelligent-tiering.html)
...
- [Accessing table data](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-access.html)

- [Working with Apache Iceberg V3](https://docs.aws.amazon.com/AmazonS3/latest/userguide/working-with-apache-iceberg-v3.html)

- [Replicating S3 tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-replication-tables.html)

- [S3 Tables AWS Regions, endpoints, and service quotas](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-regions-quotas.html)

- [Making requests to S3 Tables over IPv6](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-ipv6.html)

- [Security for S3 Tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-security-overview.html)

- [Logging and monitoring for S3 Tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-monitoring-overview.html)
...
AWS Identity and Access Management (IAM) and [Service Control Policies](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scps.html) in AWS Organizations. S3 Tables uses a
...
For more information about how the integration works, see [Integrating Amazon S3 Tables with AWS analytics services](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-integrating-aws.html).
...
- [**AWS Glue**](https://docs.aws.amazon.com/glue/latest/dg/what-is-glue.html) – AWS Glue is a serverless data-integration service that allows
...
- [**Amazon EMR**](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-what-is-emr.html) – Amazon EMR is a managed cluster platform that simplifies running
big data frameworks, such as Apache Hadoop and Apache
Spark, on AWS to process and analyze vast amounts of data.

- [**Amazon Redshift**](https://docs.aws.amazon.com/redshift/latest/mgmt/welcome.html) – Amazon Redshift is a petabyte-scale
...
- [**Quick**](https://docs.aws.amazon.com/quicksight/latest/user/welcome.html) – Quick is a
...
- [**AWS Lake Formation**](https://docs.aws.amazon.com/lake-formation/latest/dg/what-is-lake-formation.html.html) – Lake Formation is a managed
