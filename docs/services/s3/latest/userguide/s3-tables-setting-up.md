...
- [AWS managed policies for S3 Tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-security-iam-awsmanpol.html)

- [Granting access with SQL semantics](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-tables-sql.html)
