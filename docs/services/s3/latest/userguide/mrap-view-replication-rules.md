---
title: "View the replication rules for your Multi-Region Access Point"
---
...
rules, see
[Managing replication rules by using the Amazon S3\
console](disable-replication.md).
...
5. Scroll down to the **Replication rules** section. This
    section lists all of the replication rules that have been created for your
    Multi-Region Access Point.

###### Note

If you’ve added a bucket from another account to this Multi-Region Access Point, you must
have the `s3:GetBucketReplication` permission from the bucket
owner to view the replication rules for that bucket.
