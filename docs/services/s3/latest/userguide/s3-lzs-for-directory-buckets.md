...
[DescribeAvailabilityZones](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeAvailabilityZones.html) API operation. This API operation lists information about Local Zones, including their Local Zone IDs, parent Region names, network border
...
concepts](https://docs.aws.amazon.com/local-zones/latest/ug/concepts-local-zones.html) in the AWS Local Zones _User Guide_.
...
VPC endpoints to access directory buckets and objects in Local Zones, see [Private connectivity from your VPC](https://docs.aws.amazon.com/AmazonS3/latest/userguide/connectivity-lz-directory-buckets.html).
