...
- [PUT Object](../api/restobjectput.md)

- [PUT Object - Copy](../api/restobjectcopy.md)
...
- [Upload Part](../api/mpuploaduploadpart.md)
...
- [Get Object](../api/restobjectget.md)

- [Head Object](../api/restobjecthead.md)
...
`ObjectMetadata` as a parameter. For more information, see [Uploading an object using multipart upload](mpu-upload-object.md).
...
information, see [Using the AWS SDKs (low-level API)](mpu-upload-object.md#mpu-upload-low-level).
...
To upload an object to Amazon S3, use the [Aws\\S3\\S3Client::putObject()](../../../../reference/aws-sdk-php/v3/api/api-s3-2006-03-01.md#putobject) method. To add the
...
server-side encryption when you call the [Aws\\S3\\S3Client::createMultipartUpload()](../../../../reference/aws-sdk-php/v3/api/api-s3-2006-03-01.md#createmultipartupload) method. To add the
...
multipart upload API operation, see [Using the AWS SDKs (low-level API)](mpu-upload-object.md#mpu-upload-low-level).
...
the [CreateMultipartUpload](../../../../reference/aws-sdk-php/v3/api/api-s3-2006-03-01.md#createmultipartupload) API operation. For an example of using the
`setOption()` method with the high-level multipart upload API
operation, see [Uploading an object using multipart upload](mpu-upload-object.md).

To determine the encryption state of an existing object, retrieve the object
metadata by calling the [Aws\\S3\\S3Client::headObject()](../../../../reference/aws-sdk-php/v3/api/api-s3-2006-03-01.md#headobject) method as shown in the following PHP code
example.
...
using the [Aws\\S3\\S3Client::copyObject()](../../../../reference/aws-sdk-php/v3/api/api-s3-2006-03-01.md#copyobject) method and delete the source object. By
...
- [AWS SDK for PHP for Amazon S3 Aws\\S3\\S3Client Class](../../../../reference/aws-sdk-php/v3/api/class-aws-s3-s3client.md)
...
For examples of setting up encryption using CloudFormation, see [Create a bucket with default encryption](../../../cloudformation/latest/userguide/aws-properties-s3-bucket-serversideencryptionrule.md#aws-properties-s3-bucket-serversideencryptionrule--examples--Create_a_bucket_with_default_encryption) and the [Create a bucket by using AWS KMS server-side encryption with an S3 Bucket Key](../../../cloudformation/latest/userguide/aws-properties-s3-bucket-serversideencryptionrule.md#aws-properties-s3-bucket-serversideencryptionrule--examples--Create_a_bucket_using_AWS_KMS_server-side_encryption_with_an_S3_Bucket_Key)
