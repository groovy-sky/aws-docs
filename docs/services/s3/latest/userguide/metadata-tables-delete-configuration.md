...
those tables already exist. To delete your metadata tables, see [Deleting metadata tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-delete-table.html).

To delete your metadata tables, see [Delete a metadata table](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-delete-table.html#delete-metadata-table-procedure). To delete
