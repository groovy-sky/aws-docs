...
The REST-specific headers. For more information, see [PutObject](../api/api-putobject.md).
...
writable buckets. For more information, see [HTML forms](../userguide/httppostforms.md) and [Upload examples](../userguide/httppostexamples.md) in the
...
interpret user-defined metadata. For more information, see [PutObject](../api/api-putobject.md).
...
information, see [PutBucketLifecycleConfiguration](../api/api-putbucketlifecycleconfiguration.md).
