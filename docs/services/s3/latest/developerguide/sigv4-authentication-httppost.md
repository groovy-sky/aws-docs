...
![AWS signature calculation process with StringToSign, SigningKey, and Signature steps.](https://docs.aws.amazon.com/images/AmazonS3/latest/developerguide/images/sigV4-post.png)
