---
title: "Use GetBucketTagging with a CLI"
---
...
- For API details, see
[GetBucketTagging](https://docs.aws.amazon.com/powershell/v4/reference)
...
- For API details, see
[GetBucketTagging](https://docs.aws.amazon.com/powershell/v5/reference)
