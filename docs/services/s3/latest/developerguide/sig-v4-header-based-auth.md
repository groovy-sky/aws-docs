...
![AWS4-HMAC-SHA256 signature process diagram showing canonical request, StringToSign, and signature steps.](https://docs.aws.amazon.com/images/AmazonS3/latest/developerguide/images/sigV4-using-auth-header.png)
...
action, see [GetObject](../api/api-getobject.md).
...
For information about the API action, see [PutObject](../api/api-putobject.md).
...
see [GetBucketLifecycleConfiguration](../api/api-getbucketlifecycleconfiguration.md).
...
action, see [ListObjects](../api/api-listobjects.md).
