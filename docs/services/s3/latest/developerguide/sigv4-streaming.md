...
![The process of calculating the seed signature.](https://docs.aws.amazon.com/images/AmazonS3/latest/developerguide/images/sigV4-auth-header-chunked-seed-signature.png)
...
![The process of calculating the seed signature showing various components of the string to sign.](https://docs.aws.amazon.com/images/AmazonS3/latest/developerguide/images/sigV4-auth-header-chunk-signature.png)
...
For information about the API action, see [PutObject](../api/api-putobject.md). The general request syntax is as follows:
