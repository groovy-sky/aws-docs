...
![Comparison of S3 PUT workflow with customer to server to S3, versus POST workflow with direct customer to S3 transfer.](https://docs.aws.amazon.com/images/AmazonS3/latest/developerguide/images/s3_post.png)
...
![StringToSign, Signing Key, and Signature.](https://docs.aws.amazon.com/images/AmazonS3/latest/developerguide/images/sigV4-post.png)
