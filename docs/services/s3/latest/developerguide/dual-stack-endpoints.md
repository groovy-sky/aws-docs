...
For more information, about endpoint name style, see [Accessing and listing an Amazon S3 bucket](../userguide/access-bucket-intro.md). For a list of Amazon S3 endpoints, see [Regions\
...
now have dual-stack support. For more information about VPC endpoints for Amazon S3, see [AWS PrivateLink for Amazon S3](../userguide/privatelink-interface-endpoints.md).
