...
2. Create a new user with permissions limited to the services and actions that you want
    ...
    (Console)](../../../iam/latest/userguide/id-users-create.md#id_users_create_console), and follow the instructions through step 8.
...
Use the AWS SDKs to send authenticated requests. For more information about sending authenticated requests, see [AWS security credentials](../../../iam/latest/userguide/security-creds.md) or [IAM Identity Center Authentication](../../../../reference/sdkref/latest/guide/access-sso.md).

Java

For information about authenticating requests using the AWS SDK for Java, see [Using shared config and credentials files to globally configure AWS SDKs and tools](../../../../reference/sdkref/latest/guide/file-format.md) and [Authentication and access using AWS SDKs and tools](../../../../reference/sdkref/latest/guide/access.md) in the AWS SDKs and Tools Reference Guide.
...
For more information, see [Making requests using AWS account or IAM user credentials](../userguide/authusingacctorusercredentials.md) >.
...
AWS credentials](../../../../reference/sdk-for-net/latest/developer-guide/net-dg-config-creds.md) in the _SDK for .NET Developer_
_Guide_.
...
profiles in an application](../../../../reference/sdk-for-net/latest/developer-guide/creds-locate.md) in the _SDK for .NET Developer Guide_.
...
publicly available. For more information, see [Creating Anonymous Clients](../../../../reference/sdk-for-php/v3/developer-guide/guide-credentials-anonymous.md) in the [AWS SDK for PHP\
...
information about setting up shared credentials, see [Making requests using AWS account or IAM user credentials](../userguide/authusingacctorusercredentials.md).
...
- [AWS SDK for PHP\
for Amazon S3 Aws\\S3\\S3Client Class](../../../../reference/aws-sdk-php/v3/api/class-aws-s3-s3client.md)
