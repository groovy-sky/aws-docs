...
Browser-Based Uploads Using POST (AWS Signature Version 4)](../api/sigv4-authentication-httppost.md) in the
_Amazon Simple Storage Service API Reference_.

The following figure shows an upload using Amazon S3 POST.

![An upload using Amazon S3 POST.](https://docs.aws.amazon.com/images/AmazonS3/latest/developerguide/images/s3_post.png)
