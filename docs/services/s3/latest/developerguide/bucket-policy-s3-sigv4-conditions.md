...
- _Presigned POST_ — upload files directly to S3 using pre-signed POST. For more information, see [Amazon S3 POST Policy](../api/sigv4-httppostconstructpolicy.md).
