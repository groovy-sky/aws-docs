...
API that include a
[CreateBucketConfiguration](../api/api-createbucketconfiguration.md)
...
see [AWS Regions and Endpoints](../../../../general/latest/gr/rande.md)
...
![Steps that occur when a DNS server routes requests from the client to facility B.](https://docs.aws.amazon.com/images/AmazonS3/latest/developerguide/images/DNS_virthost.png)
...
![Steps that occur when a client sends a request to B and is redirected to C.](https://docs.aws.amazon.com/images/AmazonS3/latest/developerguide/images/DNS_virthost_redirect.png)
