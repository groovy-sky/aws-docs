...
- [Creating a custom control from scratch in AWS Audit Manager](https://docs.aws.amazon.com/audit-manager/latest/userguide/customize-control-from-scratch.html)

- [Making an editable copy of a control in AWS Audit Manager](https://docs.aws.amazon.com/audit-manager/latest/userguide/customize-control-from-existing.html)
