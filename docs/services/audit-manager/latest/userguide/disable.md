---
title: "Disabling AWS Audit Manager"
---
...
information about data retention, see [Data Protection](data-protection.md) in
this guide.
...
Before you disable Audit Manager, you can run the [update-settings](../../../cli/latest/reference/auditmanager/update-settings.md) command to set your preferred data
...
When you're ready to disable Audit Manager, run the [deregister-account](../../../cli/latest/reference/auditmanager/deregister-account.md) command.
...
When you're ready to disable Audit Manager, call the [DeregisterAccount](../../../../reference/audit-manager/latest/apireference/api-deregisteraccount.md) operation.
...
user. For more information, see [Setting up AWS Audit Manager with the recommended settings](setting-up.md).
...
assessment](edit-assessment.md) and choose **Save**
without making any changes.

## Additional resources

- For more information about data retention in Audit Manager, see [Data\
Protection](data-protection.md) in this guide.
