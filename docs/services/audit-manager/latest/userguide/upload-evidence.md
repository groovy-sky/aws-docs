...
- [Importing manual evidence files from Amazon S3](https://docs.aws.amazon.com/audit-manager/latest/userguide/import-from-s3.html)

- [Uploading manual evidence files from your browser](https://docs.aws.amazon.com/audit-manager/latest/userguide/upload-from-computer.html)

- [Entering free-form text responses as manual evidence](https://docs.aws.amazon.com/audit-manager/latest/userguide/enter-text-response.html)

- To learn which file formats you can use, see [Supported file formats for manual evidence](https://docs.aws.amazon.com/audit-manager/latest/userguide/supported-manual-evidence-files.html).
...
- For troubleshooting assistance, see [I can’t upload manual evidence to a control](https://docs.aws.amazon.com/audit-manager/latest/userguide/control-issues.html#cannot-upload-manual-evidence).
