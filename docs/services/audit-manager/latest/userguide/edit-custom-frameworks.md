...
To edit the tags for a framework, open the framework and choose the [framework tags tab](https://docs.aws.amazon.com/audit-manager/latest/userguide/review-frameworks.html). There you can view and edit the tags that are associated
with the framework.
...
control sets. To add more control sets than the console currently allows, use the [UpdateAssessmentFramework](https://docs.aws.amazon.com/audit-manager/latest/APIReference/API_UpdateAssessmentFramework.html) API that Audit Manager provides.
...
Audit Manager environment by deleting the framework. For instructions, see [Deleting a custom framework in AWS Audit Manager](https://docs.aws.amazon.com/audit-manager/latest/userguide/delete-custom-framework.html).

## Additional resources

For solutions to framework issues in Audit Manager, see [Troubleshooting framework issues](https://docs.aws.amazon.com/audit-manager/latest/userguide/framework-issues.html).
