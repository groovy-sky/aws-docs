...
- [Step 1: Edit assessment details](https://docs.aws.amazon.com/audit-manager/latest/userguide/edit-assessment.html#edit-specify-details)

- [Step 2: Edit AWS accounts in scope](https://docs.aws.amazon.com/audit-manager/latest/userguide/edit-assessment.html#edit-accounts)

- [Step 3: Edit audit owners](https://docs.aws.amazon.com/audit-manager/latest/userguide/edit-assessment.html#edit-choose-audit-owners)

  - [Audit owner permissions](https://docs.aws.amazon.com/audit-manager/latest/userguide/edit-assessment.html#edit-choose-audit-owners-permissions)
- [Step 4: Review and save](https://docs.aws.amazon.com/audit-manager/latest/userguide/edit-assessment.html#edit-review-and-create)
...
To edit the delegated administrator for Audit Manager, see [Changing a delegated administrator](https://docs.aws.amazon.com/audit-manager/latest/userguide/change-delegated-admin.html).
...
change the status of that control. For instructions, see [Changing the status of an assessment control in AWS Audit Manager](https://docs.aws.amazon.com/audit-manager/latest/userguide/change-assessment-control-status.html).

When you no longer need to collect evidence for the entire assessment, you can change the
assessment status to inactive. For instructions, see [Changing the status of an assessment to inactive in AWS Audit Manager](https://docs.aws.amazon.com/audit-manager/latest/userguide/change-assessment-status-to-inactive.html).
