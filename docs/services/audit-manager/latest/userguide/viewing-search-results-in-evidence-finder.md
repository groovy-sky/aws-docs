...
**Results** table. If needed, you can [view your recent results](../../../awscloudtrail/latest/userguide/query-results.md) in the
...
export them as a CSV file. For instructions, see [Exporting your search results from evidence finder](exporting-search-results-from-evidence-finder.md).
