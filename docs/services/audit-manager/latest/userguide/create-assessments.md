...
This topic builds on the [Tutorial for Audit Owners: Creating an assessment](https://docs.aws.amazon.com/audit-manager/latest/userguide/tutorial-for-audit-owners.html). You'll find detailed instructions on this page that
...
- You completed all the prerequisites that are described in [Setting up AWS Audit Manager with the recommended settings](https://docs.aws.amazon.com/audit-manager/latest/userguide/setting-up.html). You must use your AWS account and the Audit Manager console to
...
- [Step 1: Specify assessment details](https://docs.aws.amazon.com/audit-manager/latest/userguide/create-assessments.html#specify-details)

- [Step 2: Specify AWS accounts in scope](https://docs.aws.amazon.com/audit-manager/latest/userguide/create-assessments.html#specify-accounts)

- [Step 3: Specify audit owners](https://docs.aws.amazon.com/audit-manager/latest/userguide/create-assessments.html#choose-audit-owners)

  - [Audit owner permissions](https://docs.aws.amazon.com/audit-manager/latest/userguide/create-assessments.html#choose-audit-owners-permissions)
- [Step 4: Review and create](https://docs.aws.amazon.com/audit-manager/latest/userguide/create-assessments.html#review-and-create)
...
The default assessment report destination is based on your [assessment settings](https://docs.aws.amazon.com/audit-manager/latest/userguide/settings-destination.html).
...
AWS Config](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_manage-rules.html).

For example, suppose that you’re creating an assessment for CIS v1.2.0. This framework
has a control named [1.9 – Ensure IAM password policy requires a minimum length of 14 or greater](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-cis-controls.html#securityhub-cis-controls-1.9). In
AWS Config, the [iam-password-policy](https://docs.aws.amazon.com/config/latest/developerguide/iam-password-policy.html) rule
...
scope, [edit the assessment](https://docs.aws.amazon.com/audit-manager/latest/userguide/edit-assessment.html). The removed account no longer shows in the list during editing,
...
responsible for managing the Audit Manager assessment. We recommend that they use the [AWSAuditManagerAdministratorAccess](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSAuditManagerAdministratorAccess.html) policy.
...
assessment status](https://docs.aws.amazon.com/audit-manager/latest/userguide/change-assessment-status-to-inactive.html) to _inactive_. Alternatively, you
can stop evidence collection for a specific control by [change the control\
status](https://docs.aws.amazon.com/audit-manager/latest/userguide/change-assessment-control-status.html) to _inactive_.
...
collection is based on the evidence type. To learn more, see [Evidence collection frequency](https://docs.aws.amazon.com/audit-manager/latest/userguide/how-evidence-is-collected.html#frequency) in this guide.

## Next steps

To revisit your assessment at a later date, see [Finding your assessments in AWS Audit Manager](https://docs.aws.amazon.com/audit-manager/latest/userguide/access-assessments.html). You can follow these steps to locate your assessment so
