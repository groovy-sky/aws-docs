...
report from your search results. For instructions, see [Generating an assessment report from your search results](exporting-search-results-from-evidence-finder.md#generate-one-time-report-from-search-results). You can share this report with
