...
evidence](https://docs.aws.amazon.com/audit-manager/latest/userguide/concepts.html#evidence) for controls that use AWS Config and Security Hub CSPM as a data source type. Multiple
...
Catalog. For more information, see [I see that a control domain is marked as “outdated”. What does this mean?](https://docs.aws.amazon.com/audit-manager/latest/userguide/evidence-finder-issues.html#outdated-control-domains).
