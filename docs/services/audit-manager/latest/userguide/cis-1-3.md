...
Benchmark](https://www.cisecurity.org/benchmark/amazon_web_services) v1.3.0, a set of security configuration best practices for AWS.
...
posts](https://aws.amazon.com/blogs/security/tag/cis-aws-foundations-benchmark) on the _AWS Security Blog_.
...
the systems that your organization uses. The _CIS_
_Controls_ are foundational best practice guidelines for your organization to
...
v1.3.0, Level 13255Center for Internet Security (CIS) Amazon Web Services (AWS) Benchmark
v1.3.0, Level 1 and 24965
...
1. [AuditManager\_ConfigDataSourceMappings\_CIS-AWS-Benchmark-v1.3.0,-Level-1.zip](https://docs.aws.amazon.com/audit-manager/latest/userguide/samples/AuditManager_ConfigDataSourceMappings_CIS-AWS-Benchmark-v1.3.0,-Level-1.zip)

2. [AuditManager\_ConfigDataSourceMappings\_CIS-AWS-Benchmark-v1.3.0,-Level-1-and-2.zip](https://docs.aws.amazon.com/audit-manager/latest/userguide/samples/AuditManager_ConfigDataSourceMappings_CIS-AWS-Benchmark-v1.3.0,-Level-1-and-2.zip)
