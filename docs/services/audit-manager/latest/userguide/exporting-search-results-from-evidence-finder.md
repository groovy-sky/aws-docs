...
- [Generating an assessment report from your search results](exporting-search-results-from-evidence-finder.md#generate-one-time-report-from-search-results)

- [Exporting your search results into a CSV file](exporting-search-results-from-evidence-finder.md#export-search-results)

  - [Viewing your results after you've exported them](exporting-search-results-from-evidence-finder.md#viewing-results-after-export)
...
report is ready. You can then go to the Audit Manager download center and [download your assessment report](download-center.md#download-a-file).
...
to a report from the assessment page](generate-assessment-report-include-evidence.md).
...
Audit Manager uses [CloudTrail Lake](../../../awscloudtrail/latest/userguide/cloudtrail-lake.md) functionality to
...
more, see [CloudTrail sign file structure](../../../awscloudtrail/latest/userguide/cloudtrail-results-file-validation-sign-file-structure.md) in the _AWS CloudTrail Developer_
...
For instructions, see [Validate saved query results](../../../awscloudtrail/latest/userguide/cloudtrail-query-results-validation-intro.md) in the _AWS CloudTrail Developer_
_Guide_.
...
[updating your export destination settings](settings-export-destination.md).
...
the bucket ARN, and list CloudTrail as the service principal. We provide an [example permission policy](security-iam-resource-based-policy-examples.md) that you can use. For instructions
...
For more tips, see [Configuration tips for your export destination](settings-export-destination.md#settings-export-destination-tips). If you encounter any issues when
...
2. (Optional) To change this bucket, follow the procedure to [update your export destination settings](settings-export-destination.md).
3. Choose **Confirm**.
...
To find your CSV file and check its status, go to the Audit Manager [Audit Manager download center](download-center.md). When the exported file is ready,
you can [download your CSV file](download-center.md#download-a-file) from the download center.
