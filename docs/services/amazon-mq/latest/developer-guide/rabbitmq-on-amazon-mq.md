...
- [Editing broker preferences](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/amazon-mq-rabbitmq-editing-broker-preferences.html)
...
- [Resolving RabbitMQ paused queue synchronization](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-queue-sync.html)

- [Reducing the number of connections and channels](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/reducing-connections-and-channels.html)
...
- [Using OAuth 2.0 authentication and authorization for Amazon MQ for RabbitMQ](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/oauth-tutorial.html)

- [Using IAM authentication and authorization for Amazon MQ for RabbitMQ](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-iam-tutorial.html)

- [Using LDAP authentication and authorization for Amazon MQ for RabbitMQ](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-ldap-tutorial.html)

- [Using HTTP authentication and authorization for Amazon MQ for RabbitMQ](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-http-tutorial.html)

- [Using SSL certificate authentication for Amazon MQ for RabbitMQ](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-ssl-tutorial.html)

- [Using mTLS for AMQP and management endpoints](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-mtls-tutorial.html)

- [Connecting your JMS application](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-tutorial-jms.html)
...
VPC attributes. For more information, see [DNS Support in your VPC](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-dns.html#vpc-dns-support) in the _Amazon VPC User Guide_.
