...
[SDK Reference guide](../../../../reference/sdkref/latest/guide/feature-endpoints.md).
...
[AWS General Reference](../../../../general/latest/gr/amazon-mq.md).

## Connect to Amazon MQ using AWS PrivateLink

[AWS PrivateLink](../../../vpc/latest/privatelink/what-is-privatelink.md)
...
[interface VPC endpoint](../../../vpc/latest/privatelink/create-interface-endpoint.md)
...
[Dual-stack and FIPS endpoints](../../../../reference/sdkref/latest/guide/feature-endpoints.md)
...
[Using endpoints in the AWS CLI](../../../cli/v1/userguide/cli-configure-endpoints.md)

You can also determine user access to the VPC endpoints using VPC endpoint policies.
For more information, see
[Control access to VPC endpoints using endpoint policies](../../../vpc/latest/privatelink/vpc-endpoints-access.md).
