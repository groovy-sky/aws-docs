---
title: "Getting started: Creating and connecting to an ActiveMQ broker"
---
...
_broker instance type_ (for example, `mq.m5.large`). For more information, see [What is an Amazon MQ for ActiveMQ broker?](amazon-mq-basic-elements.md#broker).
...
[Option 1: Amazon MQ single-instance brokers](amazon-mq-broker-architecture.md#single-broker-deployment).
...
[Option 2: Amazon MQ active/standby brokers for high availability](amazon-mq-broker-architecture.md#active-standby-broker-deployment).
