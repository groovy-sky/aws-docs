...
specific AWS accounts. To request an increase for a limit, see [AWS Service Quotas](https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html) in the
...
For more information on viewing current connection limits in Amazon CloudWatch, see [Monitoring Amazon MQ brokers using Amazon CloudWatch](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/security-logging-monitoring-cloudwatch.html).
