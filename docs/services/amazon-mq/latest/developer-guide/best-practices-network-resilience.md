...
We recommend regularly monitoring [CloudWatch metrics](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/amazon-mq-accessing-metrics.html) and alarms for your Amazon MQ for RabbitMQ broker
...
You can set up [CloudWatch alarms](https://docs.aws.amazon.com/Ihttps:/docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Alarm-On-Metrics.html)
