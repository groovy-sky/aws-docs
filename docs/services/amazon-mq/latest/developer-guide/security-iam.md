---
title: "Identity and access Management for Amazon MQ"
---
...
- [Amazon MQ Identity-based policy examples](security-iam-id-based-policy-examples.md)
...
- [Troubleshooting Amazon MQ identity and access](security-iam-troubleshoot.md)
...
administrator if you cannot access features (see [Troubleshooting Amazon MQ identity and access](security-iam-troubleshoot.md))

- **Service administrator** \- determine user access and
submit permission requests (see [How Amazon MQ works with IAM](security-iam-service-with-iam.md))

- **IAM administrator** \- write policies to manage
access (see [Amazon MQ Identity-based policy examples](security-iam-id-based-policy-examples.md))
