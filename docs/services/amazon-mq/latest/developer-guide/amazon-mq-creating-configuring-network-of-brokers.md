...
information about VPCs, see [What is Amazon VPC?](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html)
in the _Amazon VPC User Guide_ and [What is VPC Peering?](https://docs.aws.amazon.com/vpc/latest/peering/Welcome.html) in the
...
more information about creating users, see [Creating an ActiveMQ broker user](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/amazon-mq-listing-managing-users.html).
...
Make sure that you [enable inbound connections](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/amazon-mq-working-java-example.html#quick-start-allow-inbound-connections) _from your local machine_ for broker `MyBroker1`
