...
- [Default resource limits for m7g single-instance deployment](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-resource-limits-configuration.html#default-values-single-instance)

- [Default resource limits for m7g cluster deployment](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-resource-limits-configuration.html#default-values-cluster-brokers)
...
- [Maximum resource limits for m7g single-instance deployment](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-resource-hard-limit.html#sizing-guidelines-m7g-single-instance)

- [Maximum resource limits for m7g cluster deployment](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-resource-hard-limit.html#sizing-guidelines-m7g-cluster)

- [Maximum resource limits for m5 single-instance deployment](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-resource-hard-limit.html#sizing-guidelines-single-instance)

- [Maximum resource limits for m5 cluster deployment](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/sizing-guidelines-cluster.html)

- [Error messages](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/rabbitmq-resource-hard-limit.html#sizing-guidelines-limits-error-messages)
