...
This tutorial describes how to configure [OAuth 2.0 authentication](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/oauth-for-amq-for-rabbitmq.html) for your Amazon MQ for RabbitMQ brokers using Amazon Cognito as the OAuth 2.0 provider.
