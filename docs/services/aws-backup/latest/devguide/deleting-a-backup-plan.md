...
console or use [`DeleteBackupSelection`](api-deletebackupselection.md).
...
backups, delete them from the backup vault using the steps in [Deleting backups](deleting-backups.md).
