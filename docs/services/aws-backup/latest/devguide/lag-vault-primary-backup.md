...
![Backup workflow diagram showing primary resources routing to backup vault and logically air-gapped vault.](https://docs.aws.amazon.com/images/aws-backup/latest/devguide/images/lag-vault-primary-backup-execution.png)
