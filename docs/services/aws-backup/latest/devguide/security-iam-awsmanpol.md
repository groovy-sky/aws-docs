...
For more information, see [Managed policies](../../../iam/latest/userguide/access-policies-managed-vs-inline.md)
...
To view the permissions for this policy, see [AWSBackupAuditAccess](../../../aws-managed-policy/latest/reference/awsbackupauditaccess.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupDataTransferAccess](../../../aws-managed-policy/latest/reference/awsbackupdatatransferaccess.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupFullAccess](../../../aws-managed-policy/latest/reference/awsbackupfullaccess.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupGatewayServiceRolePolicyForVirtualMachineMetadataSync](../../../aws-managed-policy/latest/reference/awsbackupgatewayservicerolepolicyforvirtualmachinemetadatasync.md) in the
...
To view the permissions for this policy, see [AWSBackupGuardDutyRolePolicyForScans](../../../aws-managed-policy/latest/reference/awsbackupguarddutyrolepolicyforscans.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupOperatorAccess](../../../aws-managed-policy/latest/reference/awsbackupoperatoraccess.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupOrganizationAdminAccess](../../../aws-managed-policy/latest/reference/awsbackuporganizationadminaccess.md) in the _AWS Managed Policy Reference_.

### AWSBackupRestoreAccessForSAPHANA

This policy provides AWS Backup permission to restore a backup of SAP HANA on Amazon EC2.

To view the permissions for this policy, see [AWSBackupRestoreAccessForSAPHANA](../../../aws-managed-policy/latest/reference/awsbackuprestoreaccessforsaphana.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupSearchOperatorAccess](../../../aws-managed-policy/latest/reference/awsbackupsearchoperatoraccess.md) in the _AWS Managed Policy Reference_.
...
see [Using roles to back up and copy](using-service-linked-roles-awsserviceroleforbackup.md).

To view the permissions for this policy, see [AWSBackupServiceLinkedRolePolicyforBackup](../../../aws-managed-policy/latest/reference/awsbackupservicelinkedrolepolicyforbackup.md) in the _AWS Managed Policy Reference_.

### AWSBackupServiceLinkedRolePolicyForBackupTest

To view the permissions for this policy, see [AWSBackupServiceLinkedRolePolicyForBackupTest](../../../aws-managed-policy/latest/reference/awsbackupservicelinkedrolepolicyforbackuptest.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupServiceRolePolicyForBackup](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforbackup.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupServiceRolePolicyForRestores](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforrestores.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupServiceRolePolicyForS3Backup](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyfors3backup.md) in the _AWS Managed Policy_
_Reference_.
...
To view the permissions for this policy, see [AWSBackupServiceRolePolicyForS3Restore](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyfors3restore.md) in the _AWS Managed Policy Reference_.
...
To view the permissions for this policy, see [AWSBackupServiceRolePolicyForScans](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforscans.md) in the _AWS Managed Policy Reference_.

### AWSServiceRolePolicyForBackupReports

AWS Backup uses this policy for the [AWSServiceRoleForBackupReports](using-service-linked-roles-awsserviceroleforbackupreports.md) service-linked role. This service-linked role
...
Start with the following statements from [AWSBackupServiceRolePolicyForBackup](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforbackup.md):
...
Start with the `RDSPermissions` statement from [AWSBackupServiceRolePolicyForRestores](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforrestores.md).
...
Start with the `DSQLRestorePermissions` statement from [AWSBackupServiceRolePolicyForRestores](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforrestores.md).
...
Start with the following statements from [AWSBackupServiceRolePolicyForRestores](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforrestores.md):
...
Start with the `EBSPermissions` statement from [AWSBackupServiceRolePolicyForRestores](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforrestores.md).
...
Start with the `EFSPermissions` statement from [AWSBackupServiceRolePolicyForRestores](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforrestores.md).
...
Start with [AWSBackupServiceRolePolicyForS3Backup](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyfors3backup.md).
...
Start with [AWSBackupServiceRolePolicyForS3Restore](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyfors3restore.md).
...
Start with the `BackupGatewayBackupPermissions` statement from [AWSBackupServiceRolePolicyForBackup](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforbackup.md).

###### Restore

Start with the `GatewayRestorePermissions` statement from [AWSBackupServiceRolePolicyForRestores](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforrestores.md).
...
- Add the following statements from [AWSBackupServiceRolePolicyForRestores](../../../aws-managed-policy/latest/reference/awsbackupservicerolepolicyforrestores.md) to your IAM role for restores:
