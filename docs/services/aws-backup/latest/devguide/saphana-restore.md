...
- [StartRestoreJob API for SAP HANA on EC2](#w2aac17c33c43c11)
...
## [StartRestoreJob API](api-startrestorejob.md) for SAP HANA on EC2
...
[StartRestoreJob metadata](api-startrestorejob.md#API_StartRestoreJob_RequestBody) for SAP HANA-specific items.

To retrieve the relevant metadata, you can use the call [`GetRecoveryPointRestoreMetadata`](api-getrecoverypointrestoremetadata.md).
...
Systems Manager for SAP](../../../ssm-sap/latest/userguide/what-is-ssm-for-sap.md) by calling [`StartApplicationRefresh`](../../../../reference/ssmsap/latest/apireference/api-startapplicationrefresh.md), or you can wait for the scheduled
...
AWS BackInt Agent and AWS Systems Manager for SAP](../../../sap/latest/sap-hana/aws-backint-agent-installing-configuring.md) on your SAP application server and
...
Backint Agent For SAP HANA](../../../sap/latest/sap-hana/aws-backint-agent-troubleshooting.md).
