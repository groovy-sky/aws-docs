...
available operations, see AWS Backup [Operations](../../../../reference/aws-backup/latest/apireference/api-operations.md).
...
(see [Operations](../../../../reference/aws-backup/latest/apireference/api-operations.md)). To grant
...
AWS Backup API and required permissions for actionsAWS Backup API operationsRequired permissions (API actions)Resources[CreateBackupPlan](../../../../reference/aws-backup/latest/apireference/api-createbackupplan.md)`backup:CreateBackupPlan``arn:aws:backup:region:account-id:backup-plan:*`[CreateBackupSelection](../../../../reference/aws-backup/latest/apireference/api-createbackupselection.md)`backup:CreateBackupSelection``arn:aws:backup:region:account-id:backup-plan:*`[CreateBackupVault](../../../../reference/aws-backup/latest/apireference/api-createbackupvault.md)
...
[DeleteBackupPlan](../../../../reference/aws-backup/latest/apireference/api-deletebackupplan.md)`backup:DeleteBackupPlan``arn:aws:backup:region:account-id:backup-plan:*`[DeleteBackupSelection](../../../../reference/aws-backup/latest/apireference/api-deletebackupselection.md)`backup:DeleteBackupSelection``arn:aws:backup:region:account-id:backup-plan:*`[DeleteBackupVault](../../../../reference/aws-backup/latest/apireference/api-deletebackupvault.md)`backup:DeleteBackupVault` 1`arn:aws:backup:region:account-id:backup-vault:*`[DeleteBackupVaultAccessPolicy](../../../../reference/aws-backup/latest/apireference/api-deletebackupvaultaccesspolicy.md)`backup:DeleteBackupVaultAccessPolicy``arn:aws:backup:region:account-id:backup-vault:*`[DeleteBackupVaultNotifications](../../../../reference/aws-backup/latest/apireference/api-deletebackupvaultnotifications.md)`backup:DeleteBackupVaultNotifications` 1`arn:aws:backup:region:account-id:backup-vault:*`[DeleteRecoveryPoint](../../../../reference/aws-backup/latest/apireference/api-deleterecoverypoint.md)`backup:DeleteRecoveryPoint` 12[DescribeBackupJob](../../../../reference/aws-backup/latest/apireference/api-describebackupjob.md)`backup:DescribeBackupJob`[DescribeBackupVault](../../../../reference/aws-backup/latest/apireference/api-describebackupvault.md)`backup:DescribeBackupVault` 1`arn:aws:backup:region:account-id:backup-vault:*`[DescribeProtectedResource](../../../../reference/aws-backup/latest/apireference/api-describeprotectedresource.md)`backup:DescribeProtectedResource`[DescribeRecoveryPoint](../../../../reference/aws-backup/latest/apireference/api-describerecoverypoint.md)`backup:DescribeRecoveryPoint` 1`arn:aws:backup:region:account-id:backup-vault:*`

2

[DescribeRestoreJob](../../../../reference/aws-backup/latest/apireference/api-describerestorejob.md)`backup:DescribeRestoreJob`[DescribeRegionSettings](../../../../reference/aws-backup/latest/apireference/api-describeregionsettings.md)`backup:DescribeRegionSettings`[ExportBackupPlanTemplate](../../../../reference/aws-backup/latest/apireference/api-exportbackupplantemplate.md)`backup:ExportBackupPlanTemplate`[GetBackupPlan](../../../../reference/aws-backup/latest/apireference/api-getbackupplan.md)`backup:GetBackupPlan``arn:aws:backup:region:account-id:backup-plan:*`[GetBackupPlanFromJSON](../../../../reference/aws-backup/latest/apireference/api-getbackupplanfromjson.md)`backup:GetBackupPlanFromJSON`[GetBackupPlanFromTemplate](../../../../reference/aws-backup/latest/apireference/api-getbackupplanfromtemplate.md)`backup:GetBackupPlanFromTemplate``arn:aws:backup:region:account-id:backup-plan:*`[GetBackupSelection](../../../../reference/aws-backup/latest/apireference/api-getbackupselection.md)`backup:GetBackupSelection``arn:aws:backup:region:account-id:backup-plan:*`[GetBackupVaultAccessPolicy](../../../../reference/aws-backup/latest/apireference/api-getbackupvaultaccesspolicy.md)`backup:GetBackupVaultAccessPolicy` 1`arn:aws:backup:region:account-id:backup-vault:*`[GetBackupVaultNotifications](../../../../reference/aws-backup/latest/apireference/api-getbackupvaultnotifications.md)`backup:GetBackupVaultNotifications` 1`arn:aws:backup:region:account-id:backup-vault:*`[GetRecoveryPointRestoreMetadata](../../../../reference/aws-backup/latest/apireference/api-getrecoverypointrestoremetadata.md)`backup:GetRecoveryPointRestoreMetadata` 1`arn:aws:backup:region:account-id:backup-vault:*`[GetSupportedResourceTypes](../../../../reference/aws-backup/latest/apireference/api-getsupportedresourcetypes.md)`backup:GetSupportedResourceTypes`[ListBackupJobs](../../../../reference/aws-backup/latest/apireference/api-listbackupjobs.md)`backup:ListBackupJobs`[ListBackupPlans](../../../../reference/aws-backup/latest/apireference/api-listbackupplans.md)`backup:ListBackupPlans`[ListBackupPlanTemplates](../../../../reference/aws-backup/latest/apireference/api-listbackupplantemplates.md)`backup:ListBackupPlanTemplates`[ListBackupPlanVersions](../../../../reference/aws-backup/latest/apireference/api-listbackupplanversions.md)`backup:ListBackupPlanVersions``arn:aws:backup:region:account-id:backup-plan:*`[ListBackupSelections](../../../../reference/aws-backup/latest/apireference/api-listbackupselections.md)`backup:ListBackupSelections``arn:aws:backup:region:account-id:backup-plan:*`[ListBackupVaults](../../../../reference/aws-backup/latest/apireference/api-listbackupvaults.md)`backup:ListBackupVaults``arn:aws:backup:region:account-id:backup-vault:*`[ListProtectedResources](../../../../reference/aws-backup/latest/apireference/api-listprotectedresources.md)`backup:ListProtectedResources`[ListRecoveryPointsByBackupVault](../../../../reference/aws-backup/latest/apireference/api-listrecoverypointsbybackupvault.md)`backup:ListRecoveryPointsByBackupVault` 1`arn:aws:backup:region:account-id:backup-vault:*`[ListRecoveryPointsByResource](../../../../reference/aws-backup/latest/apireference/api-listrecoverypointsbyresource.md)`backup:ListRecoveryPointsByResource`[ListRestoreJobs](../../../../reference/aws-backup/latest/apireference/api-listrestorejobs.md)`backup:ListRestoreJobs`[ListTags](../../../../reference/aws-backup/latest/apireference/api-listtags.md)`backup:ListTags`[PutBackupVaultAccessPolicy](../../../../reference/aws-backup/latest/apireference/api-putbackupvaultaccesspolicy.md)`backup:PutBackupVaultAccessPolicy` 1`arn:aws:backup:region:account-id:backup-vault:*`[PutBackupVaultLockConfiguration](../../../../reference/aws-backup/latest/apireference/api-putbackupvaultlockconfiguration.md)`backup:PutBackupVaultLockConfiguration` 1`arn:aws:backup:region:account-id:backup-vault:*`[PutBackupVaultNotifications](../../../../reference/aws-backup/latest/apireference/api-putbackupvaultnotifications.md)`backup:PutBackupVaultNotifications` 1`arn:aws:backup:region:account-id:backup-vault:*`[StartBackupJob](../../../../reference/aws-backup/latest/apireference/api-startbackupjob.md)`backup:StartBackupJob``arn:aws:backup:region:account-id:backup-vault:*`[StartRestoreJob](../../../../reference/aws-backup/latest/apireference/api-startrestorejob.md)`backup:StartRestoreJob`
...
[StopBackupJob](../../../../reference/aws-backup/latest/apireference/api-stopbackupjob.md)`backup:StopBackupJob`[TagResource](../../../../reference/aws-backup/latest/apireference/api-tagresource.md)`backup:TagResource``arn:aws:backup:region:account-id:recovery-point:*`[UntagResource](../../../../reference/aws-backup/latest/apireference/api-untagresource.md)`backup:UntagResource`[UpdateBackupPlan](../../../../reference/aws-backup/latest/apireference/api-updatebackupplan.md)`backup:UpdateBackupPlan``arn:aws:backup:region:account-id:backup-plan:*`[UpdateRecoveryPointLifecycle](../../../../reference/aws-backup/latest/apireference/api-updaterecoverypointlifecycle.md)`backup:UpdateRecoveryPointLifecycle` 1`arn:aws:backup:region:account-id:backup-vault:*`

2

[UpdateRegionSettings](../../../../reference/aws-backup/latest/apireference/api-updateregionsettings.md)
