...
To restore a backup programmatically, use the [StartRestoreJob](https://docs.aws.amazon.com/aws-backup/latest/devguide/API_StartRestoreJob.html) API operation.
...
that your backup was created with, you can call [GetRecoveryPointRestoreMetadata](https://docs.aws.amazon.com/aws-backup/latest/devguide/API_GetRecoveryPointRestoreMetadata.html). Restore metadata examples are also
...
AWS resources](https://docs.aws.amazon.com/tag-editor/latest/userguide/tagging.html) for more information about tag limits.
...
permissions](https://docs.aws.amazon.com/aws-backup/latest/devguide/access-control.html#backup-api-permissions-ref).
...
- [Restoring an Amazon Aurora cluster](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-aur.html)

- [Amazon Aurora DSQL restore](https://docs.aws.amazon.com/aws-backup/latest/devguide/restore-auroradsql.html)

- [Restore CloudFormation stacks](https://docs.aws.amazon.com/aws-backup/latest/devguide/restore-application-stacks.html)

- [Restoring a DocumentDB cluster](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-docdb.html)

- [Restore a Amazon DynamoDB table](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-dynamodb.html)

- [Restore an Amazon EBS volume](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-ebs.html)

- [Restore an Amazon EC2 instance](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-ec2.html)
...
- [Restore an FSx file system](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-fsx.html)

- [Restore a Neptune cluster](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-nep.html)

- [Restore an RDS database](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-rds.html)

- [Restore an Amazon Redshift cluster](https://docs.aws.amazon.com/aws-backup/latest/devguide/redshift-restores.html)

- [Amazon Redshift Serverless restore](https://docs.aws.amazon.com/aws-backup/latest/devguide/redshift-serverless-restore.html)

- [Restore an SAP HANA database on an Amazon EC2 instance](https://docs.aws.amazon.com/aws-backup/latest/devguide/saphana-restore.html)

- [Restore S3 data using AWS Backup](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-s3.html)

- [Restore a Storage Gateway volume](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-storage-gateway.html)

- [Restore an Amazon Timestream table](https://docs.aws.amazon.com/aws-backup/latest/devguide/timestream-restore.html)

- [Restore a virtual machine using AWS Backup](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-vm.html)
