...
![Example Service Connect network showing minimal HA services](https://docs.aws.amazon.com/images/AmazonECS/latest/developerguide/images/serviceconnect.png)
...
_endpoint_. Multiple client aliases can be assigned to an
...
name, and the port. For more information about endpoints in general, see [endpoint](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#endpoint) in the _AWS glossary_ in the
...
- [Amazon ECS Service Connect with shared AWS Cloud Map namespaces](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-connect-shared-namespaces.html)
