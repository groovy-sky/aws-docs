...
- [Deleting an Archive in Amazon Glacier Using the AWS SDK for Java](https://docs.aws.amazon.com/amazonglacier/latest/dev/deleting-an-archive-using-java.html)

- [Deleting an Archive in Amazon Glacier Using the AWS SDK for .NET](https://docs.aws.amazon.com/amazonglacier/latest/dev/deleting-an-archive-using-dot-net.html)

- [Deleting an Amazon Glacier Archive Using the REST API](https://docs.aws.amazon.com/amazonglacier/latest/dev/deleting-an-archive-using-rest.html)

- [Deleting an Archive in Amazon Glacier Using the AWS Command Line Interface](https://docs.aws.amazon.com/amazonglacier/latest/dev/deleting-an-archive-using-cli.html)
