...
see [Signing Requests](https://docs.aws.amazon.com/amazonglacier/latest/dev/amazon-glacier-signing-requests.html).
...
- [Signing Requests](https://docs.aws.amazon.com/amazonglacier/latest/dev/amazon-glacier-signing-requests.html)

- [Computing Checksums](https://docs.aws.amazon.com/amazonglacier/latest/dev/checksum-calculations.html)

- [Error Responses](https://docs.aws.amazon.com/amazonglacier/latest/dev/api-error-responses.html)
