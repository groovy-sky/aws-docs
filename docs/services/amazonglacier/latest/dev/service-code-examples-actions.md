---
title: "Actions for Amazon Glacier using AWS SDKs"
---
...
These excerpts call the Amazon Glacier API and are code excerpts from larger programs that must be run in context. You can see actions in context in [Scenarios for Amazon Glacier using AWS SDKs](service_code_examples_scenarios.md).

 The following examples include only the most commonly used actions. For a complete list, see the [Amazon Glacier API Reference](https://docs.aws.amazon.com/amazonglacier/latest/dev/amazon-glacier-api.html).
