...
- [Configuring Vault Notifications in Amazon Glacier Using the AWS SDK for Java](https://docs.aws.amazon.com/amazonglacier/latest/dev/configuring-notifications-sdk-java.html)

- [Configuring Vault Notifications in Amazon Glacier Using the AWS SDK for .NET](https://docs.aws.amazon.com/amazonglacier/latest/dev/configuring-notifications-sdk-dotnet.html)

- [Configuring Vault Notifications in Amazon Glacier Using the REST API](https://docs.aws.amazon.com/amazonglacier/latest/dev/configuring-notifications-rest-api.html)

- [Configuring Vault Notifications by Using the Amazon Glacier Console](https://docs.aws.amazon.com/amazonglacier/latest/dev/configuring-notifications-console.html)

- [Configuring Vault Notifications Using the AWS Command Line Interface](https://docs.aws.amazon.com/amazonglacier/latest/dev/configuring-notifications-cli.html)
...
Started with Amazon SNS](https://docs.aws.amazon.com/sns/latest/gsg/Welcome.html).
