...
- [Download an Archive from a Vault in Amazon Glacier by Using the AWS SDK for Java](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-download-archive-java.html)

- [Download an Archive from a Vault in Amazon Glacier by Using the AWS SDK for .NET](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-download-archive-dotnet.html)
