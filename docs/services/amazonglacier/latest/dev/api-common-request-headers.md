...
For more information, see [Signing Requests](amazon-glacier-signing-requests.md).
...
Condition: Required only for the [Upload Archive (POST archive)](api-archive-post.md) API.
...
The computed SHA256 checksum of an entire payload that is uploaded with either [Upload Archive (POST archive)](api-archive-post.md) or [Upload Part (PUT uploadID)](api-upload-part.md). This header
...
Condition: Required for streaming API, [Upload Archive (POST archive)](api-archive-post.md) and [Upload Part (PUT uploadID)](api-upload-part.md).
...
The computed SHA256 tree-hash checksum for an uploaded archive ( [Upload Archive (POST archive)](api-archive-post.md)) or
archive part ( [Upload Part (PUT uploadID)](api-upload-part.md)). For more information about
calculating this checksum, see [Computing Checksums](checksum-calculations.md).

Type: String

Default: None

Condition: Required for [Upload Archive (POST archive)](api-archive-post.md)
and [Upload Part (PUT uploadID)](api-upload-part.md).
