...
Signature Version 4](https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html). The process for calculating a signature can be broken into
three tasks:
...
The following example walks you through the details of creating a signature for [Create Vault (PUT vault)](https://docs.aws.amazon.com/amazonglacier/latest/dev/api-vault-put.html). The example could be used as a
reference to check your signature calculation method. For more information, see [Signing AWS API requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html) in the
_IAM User Guide_.
...
access key `AKIAIOSFODNN7EXAMPLE`, the header (with line breaks added for
readability) is:
...
[Upload Archive (POST archive)](https://docs.aws.amazon.com/amazonglacier/latest/dev/api-archive-post.html) and [Upload Part (PUT uploadID)](https://docs.aws.amazon.com/amazonglacier/latest/dev/api-upload-part.html) are streaming operations
...
calculation is different from the SHA256 tree hash ( [Computing Checksums](https://docs.aws.amazon.com/amazonglacier/latest/dev/checksum-calculations.html)). Besides trivial cases, the SHA 256 hash
...
The following example walks you through the details of creating a signature for [Upload Archive (POST archive)](https://docs.aws.amazon.com/amazonglacier/latest/dev/api-archive-post.html), one of the two
...
key `AKIAIOSFODNN7EXAMPLE` is shown below (with line breaks added for
readability):
