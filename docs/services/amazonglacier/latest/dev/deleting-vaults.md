---
title: "Deleting a Vault in Amazon Glacier"
---
...
For information about deleting archives, see [Deleting an Archive in Amazon Glacier](deleting-an-archive.md).
...
- [Deleting a Vault in Amazon Glacier Using the AWS SDK for Java](../../../../reference/amazonglacier/latest/dev/deleting-vaults-sdk-java.md)

- [Deleting a Vault in Amazon Glacier Using the AWS SDK for .NET](../../../../reference/amazonglacier/latest/dev/deleting-vaults-sdk-dotnet.md)
