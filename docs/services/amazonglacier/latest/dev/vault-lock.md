...
- [Locking a Vault by Using the Amazon Glacier API](https://docs.aws.amazon.com/amazonglacier/latest/dev/vault-lock-how-to-api.html)
...
- [Locking a Vault by Using the Amazon Glacier Console](https://docs.aws.amazon.com/amazonglacier/latest/dev/vault-lock-walkthrough.html)
...
[Vault Lock Policies](https://docs.aws.amazon.com/amazonglacier/latest/dev/vault-lock-policy.html).
...
2. Use the lock ID to complete the lock process. If the Vault Lock policy doesn't
    ...
    For information about how to use the Amazon Glacier API to lock a vault, see [Locking a Vault by Using the Amazon Glacier API](https://docs.aws.amazon.com/amazonglacier/latest/dev/vault-lock-how-to-api.html).
