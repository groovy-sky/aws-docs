...
- [Get Data Retrieval Policy (GET policy)](https://docs.aws.amazon.com/amazonglacier/latest/dev/api-GetDataRetrievalPolicy.html)
...
- [Set Data Retrieval Policy (PUT policy)](https://docs.aws.amazon.com/amazonglacier/latest/dev/api-SetDataRetrievalPolicy.html)
