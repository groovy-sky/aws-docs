...
information about deleting a vault programmatically, see [Deleting a Vault in Amazon Glacier](https://docs.aws.amazon.com/amazonglacier/latest/dev/deleting-vaults.html).
...
3. Select the option button next to the empty vault that you want to delete. If the vault is
    ...
    information, see [Deleting an Archive in Amazon Glacier](https://docs.aws.amazon.com/amazonglacier/latest/dev/deleting-an-archive.html).
