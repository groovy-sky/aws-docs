...
upload is suitable. For more information, see [Uploading Large Archives in Parts (Multipart Upload)](https://docs.aws.amazon.com/amazonglacier/latest/dev/uploading-archive-mpu.html).

###### Topics

- [Upload an Archive to a Vault in Amazon Glacier by Using the AWS SDK for Java](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-upload-archive-java.html)

- [Upload an Archive to a Vault in Amazon Glacier by Using the AWS SDK for .NET](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-upload-archive-dotnet.html)
