---
title: "Working with Archives in Amazon Glacier"
---
...
for Amazon Glacier](../../../cli/latest/reference/glacier/index.md). To install the AWS CLI, go to [AWS Command Line Interface](http://aws.amazon.com/cli).
...
For
more information, see [Uploading an Archive in Amazon Glacier](uploading-an-archive.md).
...
Reference for Amazon Glacier](../../../cli/latest/reference/glacier/index.md). To install the AWS CLI, go to [AWS Command Line Interface](http://aws.amazon.com/cli).
...
archive, see [Downloading an Archive in Amazon Glacier](downloading-an-archive.md).
...
more information, see [Deleting an Archive in Amazon Glacier](deleting-an-archive.md).
