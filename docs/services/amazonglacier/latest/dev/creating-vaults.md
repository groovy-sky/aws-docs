---
title: "Creating a Vault in Amazon Glacier"
---
...
see [Regions and Endpoints](../../../../general/latest/gr/rande.md#glacier_region) in the _AWS_
_General Reference_.
...
- [Creating a Vault in Amazon Glacier Using the AWS SDK for Java](../../../../reference/amazonglacier/latest/dev/creating-vaults-sdk-java.md)

- [Creating a Vault in Amazon Glacier Using the AWS SDK for .NET](../../../../reference/amazonglacier/latest/dev/creating-vaults-dotnet-sdk.md)
