...
This operation deletes the notification configuration set for a vault [Set Vault Notification Configuration (PUT notification-configuration)](api-vault-notifications-put.md).
...
- [AWS Command Line Interface](../../../cli/latest/reference/glacier/delete-vault-notifications.md)
