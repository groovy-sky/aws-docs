...
To install the AWS CLI, see [AWS Command Line Interface](http://aws.amazon.com/cli). For more information about using Amazon Glacier with the AWS CLI, see the [AWS CLI Reference for Amazon Glacier](https://docs.aws.amazon.com/cli/latest/reference/glacier/index.html). For examples of using the AWS CLI to upload archives to Amazon Glacier, see [Using Amazon Glacier with the AWS Command Line Interface](https://docs.aws.amazon.com/cli/latest/userguide/cli-using-glacier.html).
...
- [Step 1: Before You Begin with Amazon Glacier](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-before-you-begin.html)

- [Step 2: Create a Vault in Amazon Glacier](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-create-vault.html)

- [Step 3: Upload an Archive to a Vault in Amazon Glacier](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-upload-archive.html)

- [Step 4: Download an Archive from a Vault in Amazon Glacier](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-download-archive.html)

- [Step 5: Delete an Archive from a Vault in Amazon Glacier](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-delete-archive.html)

- [Step 6: Delete a Vault in Amazon Glacier](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-delete-vault.html)

- [Where Do I Go From Here?](https://docs.aws.amazon.com/amazonglacier/latest/dev/getting-started-where-do-i-go-next.html)
