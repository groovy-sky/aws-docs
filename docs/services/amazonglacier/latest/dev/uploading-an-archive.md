...
for Amazon Glacier](https://docs.aws.amazon.com/cli/latest/reference/glacier/index.html). To install the AWS CLI, go to [AWS Command Line Interface](http://aws.amazon.com/cli). The following **Uploading**
...
archives greater than 100 MB. For more information, see [Uploading an Archive in a Single Operation](https://docs.aws.amazon.com/amazonglacier/latest/dev/uploading-archive-single-operation.html).
...
information, see [Uploading Large Archives in Parts (Multipart Upload)](https://docs.aws.amazon.com/amazonglacier/latest/dev/uploading-archive-mpu.html).
