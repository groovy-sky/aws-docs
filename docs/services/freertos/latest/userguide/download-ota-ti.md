...
1. Follow the instructions in [Get Started with FreeRTOS](https://docs.aws.amazon.com/freertos/latest/userguide/freertos-getting-started.html) to import the `aws_demos` project into Code Composer
    Studio, configure your AWS IoT endpoint, your Wi-Fi SSID and password, and a private key and certificate
    for your board.
...
3. Build the solution and make sure it builds without errors.
...
5. Run the project on your board to confirm it can connect to Wi-Fi and the AWS IoT
    MQTT message broker.
