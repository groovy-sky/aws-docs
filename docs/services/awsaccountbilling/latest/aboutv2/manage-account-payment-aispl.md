...
- [Signing up for AWS India](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-account-payment-aispl.html#aisplsignup)

- [Managing your AWS India account](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-account-payment-aispl.html#manage-aispl-account)

  - [Adding or editing a Permanent Account Number](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-account-payment-aispl.html#aispl-add-pan)

  - [Editing multiple Permanent Account Numbers](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-account-payment-aispl.html#aispl-edit-pan)

  - [Editing multiple Goods and Services Tax numbers](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-account-payment-aispl.html#aispl-edit-gst)

  - [Viewing a tax invoice](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-account-payment-aispl.html#aispl-view-tax)
- [Changing the seller of record to or from AWS India](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-account-payment-aispl.html#aispl-edit-SOR)

## Signing up for AWS India

AWS India is a local seller of AWS in India. To sign up for an AWS India account, see
[Manage accounts in India](https://docs.aws.amazon.com/accounts/latest/reference/managing-accounts-india.html) in the _AWS Account Management_
_Reference Guide_.
...
For more information about these tasks, see [Managing your AWS India account](https://docs.aws.amazon.com/accounts/latest/reference/managing-accounts-india.html#manage-aispl-account) in the
...
outside of AWS India. For more information, see [Viewing eligible credit or debit cards for AWS India invoices](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/edit-aispl-payment-method.html#aispl-payment-view).
