...
- AWS CLI: [invite-organization-to-transfer-responsibility](../../../cli/latest/reference/organizations/invite-organization-to-transfer-responsibility.md)
...
- AWS SDKs: [InviteOrganizationToTransferResponsibility](../../../../reference/organizations/latest/apireference/api-inviteorganizationtotransferresponsibility.md)
...
using the . For more information, see [View invitation](orgs-transfer-billing-view-invitation.md).
