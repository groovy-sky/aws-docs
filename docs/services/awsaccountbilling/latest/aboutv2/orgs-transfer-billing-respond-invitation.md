...
console or using the . For more information, see [View transfers](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-view-transfer.html). If you
