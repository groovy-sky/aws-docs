...
cost category. For more information, see [Using cost categories with other cost management and optimization services](cost-categories-other-cost-management.md).
