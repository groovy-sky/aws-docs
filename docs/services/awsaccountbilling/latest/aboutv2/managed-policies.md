...
## [`AWSPurchaseOrdersServiceRolePolicy`](../../../aws-managed-policy/latest/reference/awspurchaseordersservicerolepolicy.md)
...
To view the permissions for this policy, see [AWSPurchaseOrdersServiceRolePolicy](../../../aws-managed-policy/latest/reference/awspurchaseordersservicerolepolicy.md) in the _AWS Managed Policy Reference_.

## [`AWSBillingReadOnlyAccess`](../../../aws-managed-policy/latest/reference/awsbillingreadonlyaccess.md)
...
To view the permissions for this policy, see [AWSBillingReadOnlyAccess](../../../aws-managed-policy/latest/reference/awsbillingreadonlyaccess.md) in the _AWS Managed Policy Reference_.

## [`Billing`](../../../aws-managed-policy/latest/reference/billing.md)
...
To view the permissions for this policy, see [Billing](../../../aws-managed-policy/latest/reference/billing.md) in the _AWS Managed Policy Reference_.

## [`AWSAccountActivityAccess`](../../../aws-managed-policy/latest/reference/awsaccountactivityaccess.md)

This managed policy grants users permission to view the **Account**
**activity** page.

To view the permissions for this policy, see [AWSAccountActivityAccess](../../../aws-managed-policy/latest/reference/awsaccountactivityaccess.md) in the _AWS Managed Policy Reference_.

## [`AWSPriceListServiceFullAccess`](../../../aws-managed-policy/latest/reference/awspricelistservicefullaccess.md)

This managed policy grants users full access to the AWS Price List Service.

To view the permissions for this policy, see [AWSPriceListServiceFullAccess](../../../aws-managed-policy/latest/reference/awspricelistservicefullaccess.md) in the _AWS Managed Policy Reference_.
