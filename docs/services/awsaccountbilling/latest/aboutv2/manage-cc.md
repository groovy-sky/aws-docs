...
If you're paying with a Chinese yuan credit card, see [Use a Chinese yuan credit card](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-payment-cny.html#yuan-cc).
...
7. (Optional) Enter the tag key and value. You can add up to 50 tags. For more information on tags, see [Managing Your Payments using tags](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-payments-tags.html).
...
your bank's website. For more information, see [Managing your payment verifications](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-cc-verification.html).
...
- [Add a direct debit account](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-cc.html#adding-direct-debit-account)

- [Update direct debit account](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-cc.html#updating-direct-debit-account)
...
15. (Optional) Enter the tag key and value. You can add up to 50 tags. For more information on tags, see [Managing Your Payments using tags](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/manage-payments-tags.html).
