...
1. Review your affected IAM policies in your AWS account. To do so, follow the steps in
    ...
    See [How to use the affected policies tool](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-security-iam-tool.html).
...
- To edit policies manually in the IAM console, see [Editing customer managed policies (console)](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_manage-edit.html#edit-inline-policy-console) in the
_IAM User Guide_.
...
- [Mapping for aws-portal:ViewAccount](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-iam-mapping-reference.html#mapping-for-aws-portalviewaccount)

- [Mapping for aws-portal:ViewBilling](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-iam-mapping-reference.html#mapping-for-aws-portalviewbilling)

- [Mapping for aws-portal:ViewPaymentMethods](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-iam-mapping-reference.html#mapping-for-aws-portalviewpaymentmethods)

- [Mapping for aws-portal:ViewUsage](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-iam-mapping-reference.html#mapping-for-aws-portalviewusage)

- [Mapping for aws-portal:ModifyAccount](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-iam-mapping-reference.html#mapping-for-aws-portalmodifyaccount)

- [Mapping for aws-portal:ModifyBilling](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-iam-mapping-reference.html#mapping-for-aws-portalmodifybilling)

- [Mapping for aws-portal:ModifyPaymentMethods](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-iam-mapping-reference.html#mapping-for-aws-portalmodifypaymentmethods)

- [Mapping for purchase-orders:ViewPurchaseOrders](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-iam-mapping-reference.html#mapping-for-purchase-ordersviewpurchaseorders)

- [Mapping for purchase-orders:ModifyPurchaseOrders](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-iam-mapping-reference.html#mapping-for-purchase-ordersmodifypurchaseorders)
