...
For more information, see [Manage ACH direct debit payment methods](manage-cc.md#manage-debit).
...
information, see [Designate a default payment method](manage-payment-method.md#manage-designate-default) and [Managing credit card and ACH direct debit](manage-cc.md).
