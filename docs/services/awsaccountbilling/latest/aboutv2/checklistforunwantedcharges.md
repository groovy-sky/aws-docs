...
information, see [Reserved Instances](../../../ec2/latest/userguide/ec2-reserved-instances.md) in the
...
see the [Savings Plans User Guide](../../../savingsplans/latest/userguide/what-is-savings-plans.md).
...
First, [terminate all instances of your software](../../../marketplace/latest/buyerguide/buyer-getting-started.md#step-6-terminate-your-instance) in
...
Environment](../../../elasticbeanstalk/latest/dg/using-features-terminating.md) in the _AWS Elastic Beanstalk Developer Guide_.
...
Balancer](../../../elasticloadbalancing/latest/userguide/us-endloadbalancing02.md) in the _Elastic Load Balancing User Guide_.
...
more information, see the [AWS OpsWorks User Guide](../../../opsworks/latest/userguide/welcome.md).
...
doesn't delete the bundle. For more information, see [Deregistering your AMI](../../../ec2/latest/userguide/deregister-ami.md) in the
_Amazon EC2 User Guide_.
...
for volumes that you don’t need anymore. For more information, see [Deleting an Amazon EBS volume](../../../ec2/latest/userguide/ebs-deleting-volume.md) in the
_Amazon EC2 User Guide_.
...
For more information about deleting snapshots, see [Deleting an Amazon EBS snapshot](../../../ec2/latest/userguide/ebs-deleting-snapshot.md) in
the _Amazon EC2 User Guide_.
...
[How snapshots\
work](../../../ec2/latest/userguide/ebssnapshots.md#how_snapshots_work) in the _Amazon EC2 User Guide_.
...
Guide](../../../cur/latest/userguide/what-is-cur.md).
