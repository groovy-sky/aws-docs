...
**preferences** page. For more information, see [Using fine-grained AWS Billing actions](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/migrate-granularaccess-whatis.html#migrate-user-permissions).

The Billing preferences page contains the following sections.

###### Contents

- [Invoice delivery preferences](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#invoice-delivery-preferences)

  - [Additional invoice email](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#additional-invoice-emails)
- [Alert preferences](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#alert-preferences)

- [Procurement portal settings](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#procurement-portal)

  - [Next steps](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#procurement-portal-next)
- [Credit sharing preferences](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#credit-sharing-preferences)

- [Savings Plans and Reserved Instances discount sharing preferences](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#reserved-instances-savings-plans-preferences)

  - [Understanding Sharing Options](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#understanding-sharing-options)

  - [Managing Basic Discount Sharing](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#managing-basic-discount-sharing)

  - [Setting Up Group Sharing](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#setting-up-group-sharing)

  - [Modifying Existing Groups](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#modifying-existing-groups)
- [Detailed billing reports (legacy)](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-pref.html#detailed-reports-legacy-preferences)
...
For more information about detailed billing reports, see [Detailed Billing Reports](https://docs.aws.amazon.com/cur/latest/userguide/detailed-billing.html) in
