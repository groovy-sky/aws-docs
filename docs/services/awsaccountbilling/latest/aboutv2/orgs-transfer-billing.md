...
- [Sending invitations](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-send-invitation.html)

- [Viewing invitations](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-view-invitation.html)

- [Canceling invitations](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-cancel-invitation.html)

- [Responding to invitations](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-respond-invitation.html)

- [Viewing transfers](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-view-transfer.html)

- [Updating transfers](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-update-transfer.html)

- [Withdrawing transfers](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-stop-transfer.html)

- [Viewing Billing and Cost Management data as a Bill Transfer account](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-view-account.html)

- [Quotas](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-quotas.html)

- [Best practices](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/orgs_transfer_billing-best-practices.html)
...
see [AWS Organizations terminology and concepts](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_getting-started_concepts.html#organization-structure).
...
- **Pricing privacy**: After a transfer starts, the _bill-transfer account_ manages the pricing seen by the _bill-source account_ using [AWS Billing Conductor](https://docs.aws.amazon.com/aws-cost-management/aws-billing-conductor).
