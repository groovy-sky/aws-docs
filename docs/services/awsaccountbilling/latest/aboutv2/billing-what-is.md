...
[Tasks that require root user credentials](https://docs.aws.amazon.com/IAM/latest/UserGuide/root-user-tasks.html) in the _IAM User Guide_.
...
more information, see [About IAM Access](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/control-access-billing.html#ControllingAccessWebsite-Activate).
...
**preferences** page. For more information, see [Controlling access to Cost Explorer](https://docs.aws.amazon.com/cost-management/latest/userguide/ce-access.html).
...
For more information, see [Volume discounts](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/useconsolidatedbilling-effective.html#useconsolidatedbilling-discounts).

- **No extra fee** – Consolidated billing is offered
at no additional cost.

For more information about Organizations, see the [AWS Organizations User\
Guide](https://docs.aws.amazon.com/organizations/latest/userguide).
