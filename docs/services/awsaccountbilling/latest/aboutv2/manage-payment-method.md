...
your credit cards and direct debit accounts. For more information, see [Managing credit card and ACH direct debit](manage-cc.md) and [Manage ACH direct debit payment methods](manage-cc.md#manage-debit).
...
more information, see [Using payment profiles](manage-paymentprofiles.md).
...
specifies each currency you prefer to use. For more information, see [Using payment profiles](manage-paymentprofiles.md).
