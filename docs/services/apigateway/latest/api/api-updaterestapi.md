...
**[restapi\_id](#API_UpdateRestApi_RequestSyntax)**
...
**[patchOperations](#API_UpdateRestApi_RequestSyntax)**
...
**[apiKeySource](#API_UpdateRestApi_ResponseSyntax)**
...
**[apiStatus](#API_UpdateRestApi_ResponseSyntax)**
...
**[apiStatusMessage](#API_UpdateRestApi_ResponseSyntax)**

The status message of the RestApi. When the status message is `UPDATING` you can still invoke it.

Type: String

**[binaryMediaTypes](#API_UpdateRestApi_ResponseSyntax)**

The list of binary media types supported by the RestApi. By default, the RestApi supports only UTF-8-encoded text payloads.

Type: Array of strings

**[createdDate](#API_UpdateRestApi_ResponseSyntax)**

The timestamp when the API was created.

Type: Timestamp

**[description](#API_UpdateRestApi_ResponseSyntax)**

The API's description.

Type: String

**[disableExecuteApiEndpoint](#API_UpdateRestApi_ResponseSyntax)**
...
**[endpointAccessMode](#API_UpdateRestApi_ResponseSyntax)**
...
**[endpointConfiguration](#API_UpdateRestApi_ResponseSyntax)**
...
**[id](#API_UpdateRestApi_ResponseSyntax)**

The API's identifier. This identifier is unique across all of your APIs in API Gateway.

Type: String

**[minimumCompressionSize](#API_UpdateRestApi_ResponseSyntax)**

A nullable integer that is used to enable compression (with non-negative between 0 and 10485760 (10M) bytes, inclusive) or disable compression (with a null value) on an API. When compression is enabled, compression or decompression is not applied on the payload if the payload size is smaller than this value. Setting it to zero allows compression for any payload size.

Type: Integer

**[name](#API_UpdateRestApi_ResponseSyntax)**

The API's name.

Type: String

**[policy](#API_UpdateRestApi_ResponseSyntax)**

A stringified JSON policy document that applies to this RestApi regardless of the caller and Method configuration.

Type: String

**[rootResourceId](#API_UpdateRestApi_ResponseSyntax)**

The API's root resource ID.

Type: String

**[securityPolicy](#API_UpdateRestApi_ResponseSyntax)**
...
**[tags](#API_UpdateRestApi_ResponseSyntax)**

The collection of tags. Each tag element is associated with a given resource.

Type: String to string map

**[version](#API_UpdateRestApi_ResponseSyntax)**

A version identifier for the API.

Type: String

**[warnings](#API_UpdateRestApi_ResponseSyntax)**
...
- [AWS Command Line Interface V2](../../../goto/cli2/apigateway-2015-07-09/updaterestapi.md)

- [AWS SDK for .NET V4](../../../../reference/goto/dotnetsdkv4/apigateway-2015-07-09/updaterestapi.md)

- [AWS SDK for C++](../../../../reference/goto/sdkforcpp/apigateway-2015-07-09/updaterestapi.md)

- [AWS SDK for Go v2](../../../../reference/goto/sdkforgov2/apigateway-2015-07-09/updaterestapi.md)

- [AWS SDK for Java V2](../../../../reference/goto/sdkforjavav2/apigateway-2015-07-09/updaterestapi.md)

- [AWS SDK for JavaScript V3](../../../../reference/goto/sdkforjavascriptv3/apigateway-2015-07-09/updaterestapi.md)

- [AWS SDK for Kotlin](../../../../reference/goto/sdkforkotlin/apigateway-2015-07-09/updaterestapi.md)

- [AWS SDK for PHP V3](../../../../reference/goto/sdkforphpv3/apigateway-2015-07-09/updaterestapi.md)

- [AWS SDK for Python](../../../goto/boto3/apigateway-2015-07-09/updaterestapi.md)

- [AWS SDK for Ruby V3](../../../../reference/goto/sdkforrubyv3/apigateway-2015-07-09/updaterestapi.md)
