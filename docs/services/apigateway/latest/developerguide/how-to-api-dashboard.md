...
2. You must have the API deployed at least once. Follow the instructions in [Deploy REST APIs in API Gateway](https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-deploy-api.html).
...
more information about how to set up method-level logging, see [Override stage-level settings](https://docs.aws.amazon.com/apigateway/latest/developerguide/set-up-stages.html#how-to-method-override).
