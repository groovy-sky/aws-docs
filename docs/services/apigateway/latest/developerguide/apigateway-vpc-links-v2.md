...
To create a VPC link V2, all resources involved must be owned by the same AWS account. The following [create-vpc-link](../../../cli/latest/reference/apigatewayv2/create-vpc-link.md) command creates a VPC link:
...
The following [delete-vpc-link](../../../cli/latest/reference/apigatewayv2/delete-vpc-link.md) command deletes a VPC link.
