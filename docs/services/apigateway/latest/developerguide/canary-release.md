...
adding [canary settings](../api/api-stage.md#canarySettings)
to the [stage](../api/api-stage.md) of a regular [deployment](../api/api-deployment.md). The canary settings
...
- A [percentage of API\
traffic](../api/api-stage.md#percentTraffic), between 0.0 and 100.0 inclusive, for the canary release.

- [Stage variables\
for the canary release](../api/api-stage.md#stageVariableOverrides) that can override production release stage
variables.

- The [use of the stage\
cache](../api/api-stage.md#useStageCache) for canary requests, if the [useStageCache](../api/api-stage.md#useStageCache) is
