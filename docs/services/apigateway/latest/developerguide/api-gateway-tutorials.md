...
we recommend that you complete [Tutorial: Create a REST API with a Lambda proxy integration](api-gateway-create-api-as-simple-proxy-for-lambda.md).
...
- [Tutorial: Create a REST API using AWS SDKs or the AWS CLI](../../../../reference/apigateway/latest/developerguide/api-gateway-create-api-cli-sdk.md)
