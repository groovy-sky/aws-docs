...
[Lambda authorizers](apigateway-use-lambda-authorizer.md) (formerly
known as custom authorizers), you can use an [Amazon Cognito user pool](../../../cognito/latest/developerguide/cognito-user-identity-pools.md) to
...
pool, obtain an [identity or access token](../../../cognito/latest/developerguide/amazon-cognito-user-pools-using-tokens-with-identity-providers.md) for the user, and then call the API method with one of
...
of specified access-protected resources. For more information, see [Using Tokens with User Pools](../../../cognito/latest/developerguide/amazon-cognito-user-pools-using-tokens-with-identity-providers.md) and [Resource Server and\
Custom Scopes](../../../cognito/latest/developerguide/cognito-user-pools-define-resource-servers.md).
...
identity token or access token. To learn more about using the SDKs, see [Code examples for Amazon Cognito using AWS SDKs](../../../cognito/latest/developerguide/service-code-examples.md).
...
use with the permissions of an IAM role, use [Amazon Cognito Federated Identities](../../../cognito/latest/developerguide/cognito-identity.md). For each API resource endpoint HTTP method, set the
