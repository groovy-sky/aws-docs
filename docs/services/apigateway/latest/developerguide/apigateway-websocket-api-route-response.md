...
The following [create-route-response](../../../cli/latest/reference/apigatewayv2/create-route-response.md) command creates a route response for the
`$default` route. You can identify the API ID and route ID by using the [get-apis](../../../cli/latest/reference/apigatewayv2/get-apis.md) and [get-routes](../../../cli/latest/reference/apigatewayv2/get-routes.md) commands.
