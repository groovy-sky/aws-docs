...
about managing access permissions with IAM, see [Identity and access management for Amazon API Gateway](https://docs.aws.amazon.com/apigateway/latest/developerguide/security-iam.html)
