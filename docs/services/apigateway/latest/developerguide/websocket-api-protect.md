---
title: "Protect your WebSocket APIs in API Gateway"
---
...
For more information about generating SSL certificates, see [Generate and configure an SSL certificate for backend authentication in API Gateway](getting-started-client-side-ssl-authentication.md). The rest of this section covers setting throttling targets.
...
You can configure route-level throttling by using the AWS CLI. The following [update-stage](../../../cli/latest/reference/apigatewayv2/update-stage.md) command configures custom throttling
for the specified stage and route of an API:
