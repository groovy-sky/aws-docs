...
of the Amazon API Gateway Control Service. To use the API Gateway Export API, you need to sign your API requests. For more information about signing requests, see [Signing AWS API requests](../../../iam/latest/userguide/reference-aws-signing.md) in the _IAM User Guide_. You have options to include the API Gateway
...
API, see [GetExport](../api/api-getexport.md).
...
[Regions and Endpoints](../../../../general/latest/gr/rande.md#apigateway_region).
