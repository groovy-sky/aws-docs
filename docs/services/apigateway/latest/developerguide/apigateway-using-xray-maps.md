...
[Use\
the X-Ray trace map](../../../xray/latest/devguide/aws-xray-interface-console.md#xray-console-servicemap).
...
segments for the Lambda service and Lambda function. For more information, see [AWS Lambda and AWS X-Ray](../../../xray/latest/devguide/xray-services-lambda.md).
...
[Use\
Latency Histograms](../../../xray/latest/devguide/aws-xray-interface-console.md#xray-console-histograms).
...
[View traces and trace details](../../../xray/latest/devguide/aws-xray-interface-console.md#xray-console-traces).
