...
AWS GovCloud (US). For the full list of supported Regions, see [Amazon API Gateway Endpoints and Quotas](../../../../general/latest/gr/apigateway.md) in the AWS General Reference.
...
Resource Types and Resource Relationships](../../../config/latest/developerguide/resource-config-reference.md):
...
For more information about AWS Config, see the [AWS Config Developer Guide](../../../config/latest/developerguide.md). For pricing information, see
...
_must_ [redeploy](how-to-deploy-api.md) the API to propagate the changes.
...
To initially set up AWS Config, see the following topics in the [AWS Config Developer Guide](../../../config/latest/developerguide.md).

- [Setting Up AWS Config with the\
Console](../../../config/latest/developerguide/gs-console.md)

- [Setting Up AWS Config with the\
AWS CLI](../../../config/latest/developerguide/gs-cli.md)
...
Resources AWS Config Records](../../../config/latest/developerguide/select-resources.md).
...
History](../../../config/latest/developerguide/view-manage-resource.md) in the AWS Config Developer Guide.
...
API Gateway resources. You can use predefined [AWS Config Managed Rules](../../../config/latest/developerguide/managed-rules-by-aws-config.md), or
...
an [Amazon Simple Notification Service Developer Guide](../../../sns/latest/dg.md) (Amazon SNS) topic. To programmatically consume the data in these AWS Config
alerts, use an Amazon Simple Queue Service (Amazon SQS) queue as the notification endpoint for the Amazon SNS
topic.

To learn more about setting up and using rules, see [Evaluating Resources with Rules](../../../config/latest/developerguide/evaluate-config.md) in
the [AWS Config Developer Guide](../../../config/latest/developerguide.md).
