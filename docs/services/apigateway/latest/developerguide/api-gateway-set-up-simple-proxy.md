...
proxy integration or an HTTP proxy integration. For details, see [Amazon API Gateway important notes](api-gateway-known-issues.md).
...
integration or Lambda proxy [integration](../api/api-integration.md).
...
limitations](api-gateway-known-issues.md).
