...
[DocumentationPart](../api/api-documentationpart.md) resource for a supported API
entity.
...
[Tutorial: Create a REST API with a Lambda proxy integration](api-gateway-create-api-as-simple-proxy-for-lambda.md). To learn more information about the capabilities of API Gateway that you might use while
