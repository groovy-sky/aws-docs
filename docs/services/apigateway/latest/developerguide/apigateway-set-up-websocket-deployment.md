...
deployment](api-gateway-basic-concept.md#apigateway-definition-api-deployment) and associate it with a [stage](api-gateway-basic-concept.md#apigateway-definition-api-stage). Each stage is a snapshot of the
...
The following [create-stage](../../../cli/latest/reference/apigatewayv2/create-stage.md) command creates a new stage and associates it with the deployment:
...
created deployment ID ( `deployment-id`). The following [update-stage](../../../cli/latest/reference/apigatewayv2/update-stage.md) command updates
