...
policy language information, see [Overview of IAM Policies](../../../iam/latest/userguide/access-policies.md) and [AWS Identity and Access Management Policy Reference](../../../iam/latest/userguide/reference-policies.md) in
the _IAM User Guide_.

For information about how an AWS service decides whether a given request should be
allowed or denied, see [Determining Whether a Request is Allowed or Denied](../../../iam/latest/userguide/reference-policies-evaluation-logic.md#policy-eval-denyallow).
...
Deny](../../../iam/latest/userguide/reference-policies-evaluation-logic.md#AccessPolicyLanguage_Interplay).
