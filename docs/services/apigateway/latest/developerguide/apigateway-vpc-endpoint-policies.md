...
No contentThe invoker is evaluated as an anonymous userValid [SigV4 or SigV4a](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_sigv.html) signatureThe invoker is evaluated as the authenticated IAM identity from the signatureInvalid [SigV4 or SigV4a](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_sigv.html) signatureAPI Gateway denies accessNon-SigV4 authorization information such as a bearer tokenThe invoker is evaluated as an anonymous user
