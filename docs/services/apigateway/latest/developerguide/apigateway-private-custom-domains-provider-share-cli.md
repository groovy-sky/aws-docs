...
```
    ...
    The following [update-domain-name](../../../cli/latest/reference/apigateway/update-domain-name.md) command updates the
...
```
    ...
    Use the following [update-domain-name](../../../cli/latest/reference/apigateway/update-domain-name.md) command to update the
...
The following [update-domain-name](../../../cli/latest/reference/apigateway/update-domain-name.md) command to updates the
    `managementPolicy` using `patch-managementPolicy.json`.
