...
This extension applies to the `apiKey` type security scheme in [OpenAPI 2](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/2.0.md) and [OpenAPI 3.](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.1.md)
...
[authorizer.authType](../api/api-authorizer.md#apigw-Type-Authorizer-authType)
