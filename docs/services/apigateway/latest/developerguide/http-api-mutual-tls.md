---
title: "How to turn on mutual TLS authentication for your HTTP APIs in API Gateway"
---
...
authentication operations](apigateway-control-access-to-api.md) that API Gateway supports. API Gateway forwards the certificates that clients provide to
...
`execute-api` endpoint. To learn more, see [Disable the default endpoint for HTTP APIs](http-api-disable-default-endpoint.md).
...
in API requests. You can find more information at [Custom domain names for HTTP APIs in API Gateway](http-api-custom-domain-names.md).
...
The following [cp](../../../cli/latest/reference/s3/cp.md) AWS CLI command uploads
...
configuring a custom domain name, see [Set up a Regional custom domain name in API Gateway](apigateway-regional-api-custom-domain-create.md).
...
name to use mutual TLS. The following [create-domain-name](../../../cli/latest/reference/apigatewayv2/create-domain-name.md) creates a
...
for API operations. To learn more, see [Set up a Regional custom domain name in API Gateway](apigateway-regional-api-custom-domain-create.md).
...
Use [Amazon S3\
versioning](../../../s3/latest/userguide/versioning.md) to maintain multiple versions of your truststore. When you update
...
The following [update-domain-name](../../../cli/latest/reference/apigatewayv2/update-domain-name.md) command
...
The following [update-domain-name](../../../cli/latest/reference/apigatewayv2/update-domain-name.md)
...
don't have control of but you can prove ownership of the domain name, [contact Support](https://console.aws.amazon.com/support/cases) to open a ticket.
...
valid certificate into ACM. For more information about validation see [Validating domain ownership](../../../acm/latest/userguide/domain-ownership-validation.md).
...
renewal](../../../acm/latest/userguide/troubleshooting-renewal.md) guide.
