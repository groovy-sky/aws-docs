...
the `selectionPattern` property of the [IntegrationResponse](../api/api-integrationresponse.md)
...
For example, use the following [put-integration-response](../../../cli/latest/reference/apigateway/put-integration-response.md) to set up a
...
[method response](api-gateway-method-settings-method-response.md#setup-method-response-status-code). Otherwise,
...
call the [update-integration-response](../../../cli/latest/reference/apigateway/update-integration-response.md) operation to replace the
