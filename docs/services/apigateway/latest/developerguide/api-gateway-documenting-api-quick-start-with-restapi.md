...
To add documentation for an [API](../api/api-restapi.md), add a [DocumentationPart](../api/api-documentationpart.md)
resource
for the API entity:
...
call the [documentationpart:update](../api/api-updatedocumentationpart.md) operation.
...
To add documentation for the root resource of an API, add a [DocumentationPart](../api/api-documentationpart.md)
resource targeted for the corresponding [Resource](../api/api-resource.md) resource:
...
To create documentation for a child resource of an API, add a [DocumentationPart](../api/api-documentationpart.md)
resource targeted for the corresponding [Resource](../api/api-resource.md) resource:
...
[DocumentationPart](../api/api-documentationpart.md)
resource targeted for the [Resource](../api/api-resource.md) resource:
...
The [DocumentationPart](../api/api-documentationpart.md) instance of a `RESOURCE` entity cannot be inherited by any of its child
resources.

## Document a `METHOD` entity

To add documentation for a method of an API, add a [DocumentationPart](../api/api-documentationpart.md)
resource targeted for the corresponding [Method](../api/api-method.md) resource:
...
entity, call the [documentationpart:update](../api/api-updatedocumentationpart.md) operation, supplying a new
`properties` map:
...
To add documentation for a request query parameter, add a [DocumentationPart](../api/api-documentationpart.md)
...
To add documentation for a path parameter, add a [DocumentationPart](../api/api-documentationpart.md)
...
To add documentation for a request body, add a [DocumentationPart](../api/api-documentationpart.md)
...
To add documentation for a request header, add a [DocumentationPart](../api/api-documentationpart.md)
...
To add documentation for a response of a status code, add a [DocumentationPart](../api/api-documentationpart.md)
resource targeted for the corresponding [MethodResponse](../api/api-methodresponse.md)
resource.
...
To add documentation for a response header, add a [DocumentationPart](../api/api-documentationpart.md)
...
To add documentation for an API authorizer, add a [DocumentationPart](../api/api-documentationpart.md)
...
The [DocumentationPart](../api/api-documentationpart.md) instance of an `AUTHORIZER` entity cannot be inherited by any of its child
resources.
...
To add documentation for an API model, add a [DocumentationPart](../api/api-documentationpart.md)
...
The [DocumentationPart](../api/api-documentationpart.md) instance of a `MODEL` entity cannot be inherited by any of its child
resources.

## Update documentation parts

To update the documentation parts of any type of API entities, submit a PATCH
request on a [DocumentationPart](../api/api-documentationpart.md) instance of a specified part identifier to replace
...
on a [DocumentationParts](../api/api-documentationpart.md) collection.
