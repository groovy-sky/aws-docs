...
`API_MAPPING_ONLY`. For information about how to set the routing mode, see [Set the routing mode for your custom domain name](https://docs.aws.amazon.com/apigateway/latest/developerguide/set-routing-mode.html).
