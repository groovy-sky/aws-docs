...
information, see [Set up to use API Gateway](https://docs.aws.amazon.com/apigateway/latest/developerguide/setting-up.html).
...
You can modify your Lambda function for this exercise, as long as the function's response aligns with the [format that API Gateway requires](https://docs.aws.amazon.com/apigateway/latest/developerguide/set-up-lambda-proxy-integrations.html#api-gateway-simple-proxy-for-lambda-output-format).
