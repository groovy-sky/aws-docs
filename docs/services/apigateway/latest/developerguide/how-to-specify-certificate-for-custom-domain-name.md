...
domain name SSL/TLS certificate are dictated by [CloudFront](../../../amazoncloudfront/latest/developerguide/distribution-web-values-specify.md). For example, the maximum size of the public key
...
objects](../../../amazoncloudfront/latest/developerguide/using-https.md) and [Create\
signed URLs and signed cookies](../../../amazoncloudfront/latest/developerguide/private-content-trusted-signers.md).
