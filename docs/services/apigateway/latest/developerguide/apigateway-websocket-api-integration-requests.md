...
1. If you chose **VPC link**, do the following:
   ...
   1. From the **VPC link** dropdown list, select a VPC link. You can select `[Use Stage Variables]` and enter **${stageVariables.vpcLinkId}** in the text box below the list.
