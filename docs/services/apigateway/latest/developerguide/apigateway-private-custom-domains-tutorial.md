...
The following [create-domain-name](../../../cli/latest/reference/apigateway/create-domain-name.md)
...
The following [create-base-path-mapping](../../../cli/latest/reference/apigateway/create-base-path-mapping.md) command
...
tutorial, follow the steps in [API provider: Share your private custom domain name using AWS RAM](apigateway-private-custom-domains-provider-share.md).
...
using your domain name](../../../route53/latest/developerguide/routing-to-api-gateway.md).
...
The following [change-resource-record-sets](../../../cli/latest/reference/route53/change-resource-record-sets.md) command creates a DNS record for your private custom domain
name:
...
[Delete an\
interface endpoint](../../../vpc/latest/privatelink/delete-interface-endpoint.md).
