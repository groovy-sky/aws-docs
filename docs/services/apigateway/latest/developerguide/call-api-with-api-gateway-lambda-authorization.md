...
![Call API with Lambda authorization allow token](https://docs.aws.amazon.com/apigateway/latest/developerguide/images/custom-auth-call-api-with-allow-token.png)
...
![Call API with Lambda authorization deny token](https://docs.aws.amazon.com/apigateway/latest/developerguide/images/custom-auth-call-api-with-deny-token.png)
...
![Call API with Lambda authorization unauthorized token](https://docs.aws.amazon.com/apigateway/latest/developerguide/images/custom-auth-call-api-with-unauthorized-token.png)
...
![Call API with Lambda authorization fail token](https://docs.aws.amazon.com/apigateway/latest/developerguide/images/custom-auth-call-api-with-fail-token.png)
