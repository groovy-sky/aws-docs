...
authentication operations](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-control-access-to-api.html) that API Gateway supports. API Gateway forwards the certificates that clients provide to
