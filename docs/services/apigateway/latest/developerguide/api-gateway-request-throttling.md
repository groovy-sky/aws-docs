...
1. [Per-client or per-method throttling\
    ...
    plan](api-gateway-create-usage-plans.md#api-gateway-usage-plan-create)

2. [Per-method throttling limits that you set for an API stage](set-up-stages.md#how-to-stage-settings)
...
For more
information about how to use the AWS Management Console to create stage-level throttling targets, see [Modify stage settings](set-up-stages.md#how-to-stage-settings). For more information
about how to use the AWS CLI to create stage-level throttling targets, see [create-stage](../../../cli/latest/reference/apigateway/create-stage.md).
...
[Create a usage plan](api-gateway-create-usage-plans.md#api-gateway-usage-plan-create). In the API Gateway
