---
title: "Subscribe to session extension errors in Amazon Connect Customer AI agent workspace"
---

# Subscribe to session extension errors in Amazon Connect Customer AI agent workspace
