---
title: "Subscribe a callback function when an Amazon Connect Customer AI agent workspace contact starts ACW"
---

# Subscribe a callback function when an Amazon Connect Customer AI agent workspace contact starts ACW
