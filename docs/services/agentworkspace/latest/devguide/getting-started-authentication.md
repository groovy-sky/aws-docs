---
title: "Authentication for applications in Amazon Connect Customer AI agent workspace"
---

# Authentication for applications in Amazon Connect Customer AI agent workspace

Apps in the Amazon Connect Customer AI agent workspace must provide their own authentication to
their users. It
...
within Amazon Connect Customer AI agent workspace, unless third-party application
...
your application is embedded within the Amazon Connect Customer AI agent workspace in an iframe and
...
experiences when accessing your application within the Amazon Connect Customer AI agent workspace
with Google Chrome.
