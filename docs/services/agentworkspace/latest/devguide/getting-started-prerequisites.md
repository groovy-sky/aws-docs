...
permissions, see the [IAM role required for creating applications in Amazon Connect Agent Workspace](appendix-role-required.md)

- An Amazon Connect user in that instance that has permissions to update security
profiles
