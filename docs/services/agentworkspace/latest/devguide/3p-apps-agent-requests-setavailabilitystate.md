---
title: "Set the agent state with the given agent state ARN in Amazon Connect Customer AI agent workspace"
---

# Set the agent state with the given agent state ARN in Amazon Connect Customer AI agent workspace
