---
title: "Set the voice enhancement mode in Amazon Connect Customer AI agent workspace"
---

# Set the voice enhancement mode in Amazon Connect Customer AI agent workspace

Sets the voice enhancement mode of the user that's currently logged in to Amazon Connect
Customer AI agent workspace. The voice enhancement mode can have the following values:
