...
- [Customize the Amazon Connect agent workspace](../../../connect/latest/adminguide/agent-workspace.md)

- [Third-party applications (3P apps) in the Amazon Connect agent workspace](../../../connect/latest/adminguide/3p-apps.md)

- [Working with third-party applications in the Amazon Connect Agent Workspace](getting-started.md)
