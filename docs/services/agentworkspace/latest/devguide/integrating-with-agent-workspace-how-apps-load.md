...
<a name="integrating-with-agent-workspace-how-apps-load"></a>
...
![Applications that have been onboarded will appear in the Agent applications menu.](https://docs.aws.amazon.com/agentworkspace/latest/devguide/images/integrating-with-agent-workspace-how-apps-load.png)
