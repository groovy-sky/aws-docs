...
runtime and its guides [here](https://docs.aws.amazon.com/appsync/latest/devguide/configuring-resolvers-js.html).
...
template overview](https://docs.aws.amazon.com/appsync/latest/devguide/resolver-mapping-template-reference-overview.html#aws-appsync-resolver-mapping-template-reference-overview) for more information.
...
more complete tutorial focusing on pipeline resolvers, you can go to [Tutorial: Pipeline Resolvers](https://docs.aws.amazon.com/appsync/latest/devguide/tutorial-pipeline-resolvers.html#aws-appsync-tutorial-pipeline-resolvers)
