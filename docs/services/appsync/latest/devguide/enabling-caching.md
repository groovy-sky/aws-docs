...
For more information, see the [ApiCache](https://docs.aws.amazon.com/appsync/latest/APIReference/API_ApiCache.html) data type in the AWS AppSync API Reference.
...
AWS AppSync [compresses](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/ServingCompressedFiles.html#compressed-content-cloudfront-notes) objects on a best-effort basis. In rare cases, AWS AppSync may skip compression based on a variety of factors, including current capacity.
