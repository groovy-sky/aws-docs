---
title: "Identity and access management for AWS AppSync"
---
...
(have permissions) to use AWS AppSync resources. IAM is an AWS service that you can
...
- [How AWS AppSync works with IAM](security-iam-service-with-iam.md)

- [Identity-based policies for AWS AppSync](security-iam-id-based-policy-examples.md)

- [Troubleshooting AWS AppSync identity and access](security-iam-troubleshoot.md)
...
administrator if you cannot access features (see [Troubleshooting AWS AppSync identity and access](security-iam-troubleshoot.md))

- **Service administrator** \- determine user access and
submit permission requests (see [How AWS AppSync works with IAM](security-iam-service-with-iam.md))

- **IAM administrator** \- write policies to manage
access (see [Identity-based policies for AWS AppSync](security-iam-id-based-policy-examples.md))
