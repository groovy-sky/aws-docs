...
![AWS AppSync sidebar menu with APIs, Todo API highlighted, and other options listed.](https://docs.aws.amazon.com/images/appsync/latest/devguide/images/explorer-example-6.png)
...
the [AWS Amplify toolchain](https://aws-amplify.github.io/) to automate the process of
...
toolchain](https://aws-amplify.github.io/) page to run your app.

## Supplemental reading

- [Designing GraphQL APIs with AWS AppSync](designing-a-graphql-api.md) \- This is a
