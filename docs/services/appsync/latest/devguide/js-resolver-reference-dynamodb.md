...
- [GetItem](js-aws-appsync-resolver-reference-dynamodb-getitem.md) \- The GetItem request lets you tell the DynamoDB function to make a
...
- [PutItem](js-aws-appsync-resolver-reference-dynamodb-putitem.md) \- The PutItem request mapping document lets you tell the DynamoDB
...
- [UpdateItem](js-aws-appsync-resolver-reference-dynamodb-updateitem.md) \- The UpdateItem request enables you to tell the DynamoDB
...
- [DeleteItem](js-aws-appsync-resolver-reference-dynamodb-deleteitem.md) \- The DeleteItem request lets you tell the DynamoDB function to
make a DeleteItem request to DynamoDB, and enables you to specify the key of the item in
DynamoDB and conditions for the operation to succeed.

- [Query](js-aws-appsync-resolver-reference-dynamodb-query.md) \- The Query request object lets you tell the DynamoDB resolver to make
...
- [Scan](js-aws-appsync-resolver-reference-dynamodb-scan.md) \- The Scan request lets you tell the DynamoDB function to make a Scan
...
- [Sync](js-aws-appsync-resolver-reference-dynamodb-sync.md) \- The Sync request object lets you retrieve all the results from a
...
- [BatchGetItem](js-aws-appsync-resolver-reference-dynamodb-batch-get-item.md) \- The BatchGetItem request object lets you tell the DynamoDB
...
- [BatchDeleteItem](js-aws-appsync-resolver-reference-dynamodb-batch-delete-item.md) \- The BatchDeleteItem request object lets you tell the
...
- [BatchPutItem](js-aws-appsync-resolver-reference-dynamodb-batch-put-item.md) \- The BatchPutItem request object lets you tell the DynamoDB
...
- [TransactGetItems](js-aws-appsync-resolver-reference-dynamodb-transact-get-items.md) \- The TransactGetItems request object lets you to tell
...
- [Type system (request mapping)](js-aws-appsync-resolver-reference-dynamodb-typed-values-request.md) \- Learn more about how DynamoDB typing is
integrated into AWS AppSync requests.

- [Type system (response mapping)](js-aws-appsync-resolver-reference-dynamodb-typed-values-responses.md) \- Learn more about how DynamoDB types are
converted automatically to GraphQL or JSON in a response payload.

- [Filters](js-aws-appsync-resolver-reference-dynamodb-filter.md) \- Learn more about filters for query and scan operations.

- [Condition expressions](js-aws-appsync-resolver-reference-dynamodb-condition-expressions.md) \- Learn more about condition expressions for
PutItem, UpdateItem, and DeleteItem operations.

- [Transaction condition expressions](js-aws-appsync-resolver-reference-dynamodb-transaction-condition-expressions.md) \- Learn more about condition expressions
for TransactWriteItems operations.

- [Projections](js-aws-appsync-resolver-reference-dynamodb-projections.md) \- Learn more about how to specify attributes in read
operations.
