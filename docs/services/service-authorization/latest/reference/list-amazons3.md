...
[AllowVendedLogDeliveryForResource](../../../s3/latest/userguide/serverlogs.md)Grants permission to configure server access logs delivery to CloudWatchRead

[bucket\*](#amazons3-bucket)

[s3:resourceArnBeingAuthorized](#amazons3-s3_resourceArnBeingAuthorized)

[s3:deliverySourceArn](#amazons3-s3_deliverySourceArn)

[s3:logType](#amazons3-s3_logType)
