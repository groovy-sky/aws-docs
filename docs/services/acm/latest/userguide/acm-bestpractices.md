...
including grant terminology, see [Grants in AWS KMS](../../../kms/latest/developerguide/grants.md) in the
_AWS Key Management Service Developer Guide_.

If you want more granular control than restricting the use of
`kms:CreateGrant` by account, you can limit
`kms:CreateGrant` to specific certificates using [kms:EncryptionContext](../../../kms/latest/developerguide/conditions-kms.md#conditions-kms-encryption-context) condition keys. Specify `arn:aws:acm`
...
ACM certificate. ACM performs [Managed certificate renewal in AWS Certificate Manager](managed-renewal.md) to automatically renew your Amazon-issued
...
For more information, see [AWS Certificate Manager DNS validation](dns-validation.md) and [AWS Certificate Manager email validation](email-validation.md).
...
`options` parameter of the [request-certificate](../../../cli/latest/reference/acm/request-certificate.md)
...
can use the [update-certificate-options](../../../cli/latest/reference/acm/update-certificate-options.md) command or the [UpdateCertificateOptions](../../../../reference/acm/latest/apireference/api-updatecertificateoptions.md) API operation to opt out.
...
The following example shows you how to use the [request-certificate](../../../cli/latest/reference/acm/request-certificate.md)
...
renewed, use the [update-certificate-options](../../../cli/latest/reference/acm/update-certificate-options.md) command. This command does not return a
value.
...
[Creating a\
Trail](../../../awscloudtrail/latest/userguide/cloudtrail-create-and-update-a-trail.md). Go to [Using CloudTrail with AWS Certificate Manager](cloudtrail.md) to
