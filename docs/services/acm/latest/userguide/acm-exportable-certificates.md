...
deployment. For more information, see [Amazon EventBridge support for ACM](https://docs.aws.amazon.com/acm/latest/userguide/supported-events.html).
...
information, see [Data protection in AWS Certificate Manager](https://docs.aws.amazon.com/acm/latest/userguide/data-protection.html).
...
- Monitor certificate deployments using [Amazon EventBridge metrics and alarms](https://docs.aws.amazon.com/acm/latest/userguide/supported-events.html).
