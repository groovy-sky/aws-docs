...
(have permissions) to use ACM resources. IAM is an AWS service that you can
...
- [How AWS Certificate Manager works with IAM](https://docs.aws.amazon.com/acm/latest/userguide/security_iam_service-with-iam.html)

- [Identity-based policy examples for AWS Certificate Manager](https://docs.aws.amazon.com/acm/latest/userguide/security_iam_id-based-policy-examples.html)

- [ACM API permissions: Actions and resources reference](https://docs.aws.amazon.com/acm/latest/userguide/authen-apipermissions.html)

- [AWS managed policies for AWS Certificate Manager](https://docs.aws.amazon.com/acm/latest/userguide/security-iam-awsmanpol.html)

- [Use condition keys with ACM](acm-conditions.md)

- [Use a service-linked role (SLR) with ACM](acm-slr.md)

- [Troubleshooting AWS Certificate Manager identity and access](https://docs.aws.amazon.com/acm/latest/userguide/security_iam_troubleshoot.html)
...
administrator if you cannot access features (see [Troubleshooting AWS Certificate Manager identity and access](https://docs.aws.amazon.com/acm/latest/userguide/security_iam_troubleshoot.html))

- **Service administrator** \- determine user access and
submit permission requests (see [How AWS Certificate Manager works with IAM](https://docs.aws.amazon.com/acm/latest/userguide/security_iam_service-with-iam.html))

- **IAM administrator** \- write policies to manage
access (see [Identity-based policy examples for AWS Certificate Manager](https://docs.aws.amazon.com/acm/latest/userguide/security_iam_id-based-policy-examples.html))
