...
To see what quotas can be adjusted, see the [ACM quotas table](https://docs.aws.amazon.com/general/latest/gr/acm.html#limits_acm) in the _AWS General Reference_
...
you if you use email validation. For more information, see [Domain validation](https://docs.aws.amazon.com/acm/latest/userguide/acm-bestpractices.html#best-practices-validating).
...
information, see [Request a private certificate in AWS Certificate Manager](https://docs.aws.amazon.com/acm/latest/userguide/gs-acm-request-private.html). You can also issue private
certificates by using the standalone AWS Private CA service. For more information, see
[Issue a Private End-Entity\
Certificate](https://docs.aws.amazon.com/privateca/latest/userguide/PcaIssueCert.html).

A private CA that has been deleted will count towards
your quota until the end of its restoration period. For more information, see [Deleting Your Private CA](https://docs.aws.amazon.com/acm-pca/latest/userguide/PCADeleteCA.html).200**Number of Private Certificates per CA**
**(lifetime)**1,000,000
...
information on `IssueCertificate`, see the [endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/acm-pca.html#limits_acm-pca) for
AWS Private CA.
