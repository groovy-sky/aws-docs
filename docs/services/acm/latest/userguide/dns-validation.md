...
Resource Record Sets](../../../route53/latest/developerguide/resource-record-sets-deleting.md) in the _Route 53 Developer Guide_. For
...
Problems](troubleshooting-dns-validation.md).
...
[ACM Console does not display "Create records in Route 53" button](troubleshooting-dns-validation.md#troubleshooting-route53-1).
...
[Working\
with Resource Record Sets](../../../route53/latest/developerguide/rrsets-working-with.md).
...
you do encounter problems, see [Troubleshoot DNS validation problems](troubleshooting-dns-validation.md).
