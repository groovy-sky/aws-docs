...
- [HTTP redirect issues](https://docs.aws.amazon.com/acm/latest/userguide/http-validation-redirect-issues.html)

- [Validation timeout](https://docs.aws.amazon.com/acm/latest/userguide/http-validation-timeout.html)
