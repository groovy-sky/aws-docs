...
information about AWS Private CA, see [AWS Private Certificate Authority User Guide](../../../privateca/latest/userguide.md).

###### Note

If you want to export public certificates issued through ACM, see [ACM exportable public certificates](acm-exportable-certificates.md).
...
Use the [export-certificate](../../../cli/latest/reference/acm/export-certificate.md) command to export a private certificate and
