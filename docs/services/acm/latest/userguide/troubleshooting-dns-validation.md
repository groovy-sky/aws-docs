...
resources in an Amazon VPC [private hosted zone](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-dns.html#vpc-private-hosted-zones), untrusted domains in your private PKI, and self-signed
certificates.
...
record. For more information, see [(Optional) Configure a CAA record](https://docs.aws.amazon.com/acm/latest/userguide/setup.html#setup-caa).
