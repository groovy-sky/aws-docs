...
1. Create an Amazon EventBridge rule. For more information, see [Creating Amazon EventBridge\
    rules that react to events](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-create-rule.html).
...
In the **Targets** section, you can choose from among
    ...
    implementation, see [Responding to an event with a Lambda function](https://docs.aws.amazon.com/acm/latest/userguide/event-lambda-response.html).
