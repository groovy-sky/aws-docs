...
Services That Work with IAM](../../../iam/latest/userguide/reference-aws-services-that-work-with-iam.md) and look for the services that have
...
[Service-Linked Role Permissions](../../../iam/latest/userguide/using-service-linked-roles.md#service-linked-role-permissions) in the
_IAM User Guide_.
...
information, see [Problems with the ACM service-linked role (SLR)](slr-problems.md).
...
account. To learn more, see [A New Role Appeared in My IAM Account](../../../iam/latest/userguide/troubleshoot-roles.md#troubleshoot_roles_new-role-appeared).
...
- Using the IAM API [CreateServiceLinkedRole](../../../../reference/iam/latest/apireference/api-createservicelinkedrole.md) or the corresponding AWS CLI command
[create-service-linked-role](../../../cli/latest/reference/iam/create-service-linked-role.md), create an SLR with the
...
role using IAM. For more information, see [Editing a Service-Linked Role](../../../iam/latest/userguide/using-service-linked-roles.md#edit-service-linked-role) in the
_IAM User Guide_.
...
information, see [Deleting a Service-Linked Role](../../../iam/latest/userguide/using-service-linked-roles.md#delete-service-linked-role) in the
_IAM User Guide_.
