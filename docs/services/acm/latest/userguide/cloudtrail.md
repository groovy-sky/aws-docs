...
History](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/view-cloudtrail-events.html). When supported event activity occurs in ACM, that activity is
...
- [Overview\
for Creating a Trail](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-create-and-update-a-trail.html)
...
- [ACM API actions supported in CloudTrail logging](https://docs.aws.amazon.com/acm/latest/userguide/acm-supported-actions-in-cloudtrail.html)

- [Logging API calls for integrated services](https://docs.aws.amazon.com/acm/latest/userguide/ct-related.html)
