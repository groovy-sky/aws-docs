...
For more information about pod identity associations, see [EKS Pod Identity](https://docs.aws.amazon.com/eks/latest/userguide/pod-identities.html) in the _Amazon EKS User Guide_.
