...
signed by a private certificate authority (CA) created and managed by [AWS Private CA](https://docs.aws.amazon.com/privateca/latest/userguide/PcaWelcome.html). The CA may either reside in your
...
- [Set up to use AWS Certificate Manager](https://docs.aws.amazon.com/acm/latest/userguide/setup.html)
