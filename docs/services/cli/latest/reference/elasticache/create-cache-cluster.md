...
[![Amazon Web Services logo](https://docs.aws.amazon.com/cli/latest/_static/logo.png)](../../index.md)
...
\[ [aws](../index.md#cli-aws) . [elasticache](index.md#cli-aws-elasticache) \]

# create-cache-cluster [¶](\#create-cache-cluster "Permalink to this heading")
...
`--cache-cluster-id` (string) \[required\]
...
> ### Note
>
> > For region availability, see [Supported Node Types](../../../../amazonelasticache/latest/dg/cachenodes-supportedtypes.md#CacheNodes.SupportedTypesByRegion)
>
...
>
> > **Important:** You can upgrade to a newer engine version (see [Selecting a Cache Engine and Version](../../../../amazonelasticache/latest/dg/selectengine.md#VersionManagement) ), but you cannot downgrade to an earlier engine version. If you want to use an earlier engine version, you must delete the existing cluster or replication group and create it anew with the earlier engine version.
...
> ### Warning
>
> If you’re going to launch your cluster in an Amazon VPC, you need to create a subnet group before you start creating a cluster. For more information, see [Subnets and Subnet Groups](../../../../amazonelasticache/latest/dg/subnetgroups.md) .
...
## Global Options [¶](\#global-options "Permalink to this heading")
...
To use the following examples, you must have the AWS CLI installed and configured. See the [Getting started guide](../../userguide/cli-chap-getting-started.md) in the _AWS CLI User Guide_ for more information.

Unless otherwise stated, all examples have unix-like quotation rules. These examples will need to be adapted to your terminal’s quoting rules. See [Using quotation marks with strings](../../userguide/cli-usage-parameters-quoting-strings.md) in the _AWS CLI User Guide_ .
...
For more information, see [Creating a Cluster](../../../../amazonelasticache/latest/red-ug/clusters-create.md) in the _Elasticache User Guide_.
