...
widget](lake-dashboard-custom-widgets-new.md).
...
06. From **Actions**, choose **Add sample**
    **widget**.

07. Choose the event data store you'd like to run the query on. You can only choose event data stores that exist in your account.

08. Choose the sample widget you'd like to add. By default, all sample widgets
     are shown. You can filter by a widget type (for example, IAM
     widgets).

09. Choose **View query** to view the query for the selected
     widget.
