...
The `IncludeGlobalServiceEvents` value remains `true` after conversion. CloudTrail delivers global service events only to single-Region trails in US East (N. Virginia).
