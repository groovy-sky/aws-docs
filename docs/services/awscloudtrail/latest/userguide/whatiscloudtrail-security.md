---
title: "Security in AWS CloudTrail"
---
...
responsibility model](https://aws.amazon.com/compliance/shared-responsibility-model) describes this as security _of_ the cloud and security _in_ the cloud:
...
and verify the effectiveness of our security as part of the [AWS compliance programs](https://aws.amazon.com/compliance/programs). To
learn about the compliance programs that apply to AWS CloudTrail, see [AWS Services in Scope by\
...
using CloudTrail. The following topics show you how to configure CloudTrail to meet your
security and compliance objectives. You also learn how to use other AWS services that help you
to monitor and secure your CloudTrail resources.
