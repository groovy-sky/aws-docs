...
When you use CloudTrail with an AWS Organizations organization, you can assign any account within the organization to act as a CloudTrail delegated administrator to manage the organization's trails and event data stores on behalf of the organization. A delegated administrator is a member account in an organization that can perform the same administrative tasks (except as [noted](#cloudtrail-org-tasks)) in CloudTrail as the management account.
...
| --- | --- | --- | --- |
| Add or remove delegated administrator accounts. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Create an organization trail. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes1 | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| View a list of organization trails. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes |
| Update an organization trail. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes1, 2 | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Delete an organization trail. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Create an organization event data store for CloudTrail events or AWS Config configuration items. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Enable Insights on an organization event data store. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Update an organization event data store. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes2 | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Start and stop event ingestion on an organization event data store. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Enable Lake query federation on an organization event data store3. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Disable Lake query federation on an organization event data store. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Delete an organization event data store. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Copy trail events to an organization event data store. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Run queries on organization event data stores. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| View a managed dashboard for an organization event data store. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Enable the Highlights dashboard for organization event data stores. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |
| Create a widget for a custom dashboard that queries an organization event data store. | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | ![](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No |

1The delegated administrator can only configure a CloudWatch Logs log group using the AWS CLI or CloudTrail `CreateTrail` or `UpdateTrail` API operations. Both the CloudWatch Logs log group and log role must exist in the calling account.
