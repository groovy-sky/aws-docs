...
+ You can suppress recursive events generated by CloudTrail delivery operations with the `--no-recursive-logging` option. For more information, see [Suppressing recursive events with recursive logging](cloudtrail-trail-recursive-logging.md).
