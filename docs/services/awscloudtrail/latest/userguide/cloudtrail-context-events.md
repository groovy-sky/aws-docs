...
+ For events involving more than 100 resources, the `eventContext` field will only include resource tag information for the first 100 resources, sorted alphabetically by ARN.
