...
The following [allocate-hosts](https://docs.aws.amazon.com/cli/latest/reference/ec2/allocate-hosts.html)
...
The following [run-instances](https://docs.aws.amazon.com/cli/latest/reference/ec2/run-instances.html)
