...
Security is a shared responsibility between AWS and you. For more information, see [Security in Amazon EC2](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-security.html). AWS provides security groups as
...
- [Create a security group for your Amazon EC2 instance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/creating-security-group.html)

- [Change the security groups for your Amazon EC2 instance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/changing-security-group.html)

- [Delete an Amazon EC2 security group](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/deleting-security-group.html)
