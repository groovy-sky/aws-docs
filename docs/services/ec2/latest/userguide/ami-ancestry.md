...
[CreateImage](creating-an-ami-ebs.md#how-to-create-ebs-ami), [CopyImage](copyingamis.md#ami-copy-steps), or [CreateRestoreImageTask](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/store-restore-how-it-works.html#CreateRestoreImageTask).
