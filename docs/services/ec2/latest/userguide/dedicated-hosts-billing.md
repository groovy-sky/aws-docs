...
information about releasing a Dedicated Host, see [Release an Amazon EC2 Dedicated Host](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/dedicated-hosts-releasing.html).
...
[AWS Savings\
Plans User Guide](https://docs.aws.amazon.com/savingsplans/latest/userguide).
