...
+ [Enable enhanced networking on your instance](enabling_enhanced_networking.md)
...
+ **Windows instances** – If the instance is running Windows Server 2008 R2 SP1, ensure that it has the [SHA-2 code signing support update](https://support.microsoft.com/en-us/help/4474419/sha-2-code-signing-support-update).
