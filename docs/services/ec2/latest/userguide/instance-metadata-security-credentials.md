...
you get an `AccessDenied` error. For more information, see [Update a role trust policy](../../../iam/latest/userguide/id-roles-update-role-trust-policy.md) in the _IAM User Guide_.
...
[I can't access the temporary security credentials on my EC2 instance](../../../iam/latest/userguide/troubleshoot-iam-ec2.md#troubleshoot_iam-ec2_no-keys)
