...
information, see [Launch templates](../../../autoscaling/ec2/userguide/launch-templates.md) in the
...
Use the [delete-key-pair](../../../cli/latest/reference/ec2/delete-key-pair.md) command.
...
Use the [Remove-EC2KeyPair](../../../powershell/latest/reference/items/remove-ec2keypair.md) cmdlet.
