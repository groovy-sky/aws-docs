...
- [Add and remove tags](using-tags-console.md)
...
Practices AWS Whitepaper](../../../whitepapers/latest/tagging-best-practices/tagging-best-practices.md).
...
tag keys and values are set on your existing resources. For more information, see [Example: Tag resources](examplepolicies-ec2.md#iam-example-taggingresources).
...
information, see [View tags for your EC2 instances using instance metadata](work-with-tags-in-imds.md).
...
For more information, see [Control access using attribute-based access](iam-policies-for-amazon-ec2.md#control-access-with-tags).
...
volumes and snapshots](../../../awsaccountbilling/latest/aboutv2/checklistforunwantedcharges.md#checkebsvolumes) in the _AWS Billing User Guide_.
