...
[Amazon \
File Cache User Guide](https://docs.aws.amazon.com/fsx/latest/FileCacheGuide/what-is.html).
...
To get started, see [Getting started with Amazon File Cache](https://docs.aws.amazon.com/fsx/latest/FileCacheGuide/getting-started.html) in the _Amazon File Cache User Guide_.
