...
To create an AMI that supports EC2 instance attestation, see [Attestable AMIs](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/attestable-ami.html).
...
You're charged for the snapshots until you [deregister the AMI](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/deregister-ami.html)
...
information, see [Preserve data when an instance is terminated](preserving-volumes-on-termination.md).
      ...
      3. To add an instance store volume, see [Add instance store volumes to an Amazon EC2 AMI](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/adding-instance-storage-ami.html).
...
licensing information to be present on the AMI. For more information, see [Understand AMI billing information](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-billing-info.html). When creating an
...
08. For **Boot mode**, choose the boot mode
        ...
        information, see [Set the boot mode of an Amazon EC2 AMI](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/set-ami-boot-mode.html).
