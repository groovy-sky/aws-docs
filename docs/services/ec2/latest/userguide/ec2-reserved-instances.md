...
- [Use your Reserved Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-reserved-instances.html)

- [How billing works with Reserved Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts-reserved-instances-application.html)

- [Buy Reserved Instances for Amazon EC2](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-concepts-buying.html)
...
- [Exchange Convertible Reserved Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-convertible-exchange.html)

- [Reserved Instance quotas](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-limits.html)
...
information, see [Amazon EC2 Dedicated Instances](dedicated-instance.md).

- **Platform**: The operating system; for
example, Windows or Linux/Unix. For more information, see [Choosing a platform](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-concepts-buying.html#ri-choosing-platform).
...
be able to [modify](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-modifying.html), [exchange](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-convertible-exchange.html), or [sell](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-general.html) your Reserved Instance if your needs
change.
...
shorter term lengths on the Reserved Instance Marketplace. For more information, see [Sell Reserved Instances for Amazon EC2 in the Reserved Instance Marketplace](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-general.html).
...
For more information, see [Types of Reserved Instances (offering classes)](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/reserved-instances-types.html).

###### Important

After you purchase a Reserved Instance, you cannot cancel your purchase. However, you might be
able to [modify](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-modifying.html), [exchange](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-convertible-exchange.html), or [sell](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-general.html) your Reserved Instance if your needs change.
