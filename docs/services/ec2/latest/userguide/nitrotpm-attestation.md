...
more information about how you can obtain the reference measurements, see [Build the sample image description](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/build-sample-ami.html).
...
The next step is to launch a [Nitro-TPM enabled EC2 instance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/enable-nitrotpm-prerequisites.html#nitrotpm-instancetypes)
with the Attestable AMI. After you have launched the instance, you can use the [NitroTPM tools](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/attestation-get-doc.html) to generate the _Attestation Document_. Then you can compare the actual measurements
...
information, see [Isolate data from your own operators](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/isolate-data-operators.html).

For an example, see the [sample Amazon Linux 2023 image description](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/build-sample-ami.html) that creates
...
- [Integrating with AWS KMS](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/attestation-attest.html)
