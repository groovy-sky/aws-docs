...
Use the [Copy-S3Object](https://docs.aws.amazon.com/powershell/latest/reference/items/Copy-S3Object.html)
...
The [aws s3 cp](https://docs.aws.amazon.com/cli/latest/reference/s3/cp.html) command is similar to the Unix
...
The [aws s3 sync](https://docs.aws.amazon.com/cli/latest/reference/s3/sync.html) command can synchronize an entire Amazon S3 bucket to a
