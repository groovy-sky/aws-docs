...
- **File access** – Use [Amazon S3 Files](../../../s3/latest/userguide/s3-files.md) to mount
an S3 bucket as a high performance file system on your instance.

- **Object access** – Use the [Amazon S3\
API](../../../s3/latest/api.md), AWS CLI, AWS SDKs, or tools like wget to copy objects to and from
S3.
...
Files](../../../s3/latest/userguide/s3-files.md) in the _Amazon S3 User Guide_.

- An EC2 instance running Linux OS with an instance profile attached to it. For
information about the required permissions to mount the file system, see [IAM roles and policies](../../../s3/latest/userguide/s3-files-prereq-policies.md#s3-files-prereq-iam) in the _Amazon S3 User Guide_.
...
groups settings, see [Security groups](../../../s3/latest/userguide/s3-files-prereq-policies.md#s3-files-prereq-security-groups) in the _Amazon S3 User Guide_.
...
6. Under **Advanced details**, attach an instance profile to
    ...
    access the S3 bucket. [Learn more about required permissions](../../../s3/latest/userguide/s3-files-prereq-policies.md#s3-files-prereq-iam).
...
1. [Connect\
    to your EC2 instance](connect.md) through Secure Shell (SSH) or by using EC2
...
2. If you are using other [supported Linux distributions](https://github.com/aws/efs-utils?tab=readme-ov-file), you can do the
       following:
...
3. For other Linux distributions, see the [efs-utils](https://github.com/aws/efs-utils?tab=readme-ov-file) repository on _GitHub_.
...
access management for Amazon S3](../../../s3/latest/userguide/security-iam.md) and [Downloading\
an object](../../../s3/latest/userguide/download-objects.md) in the _Amazon S3 User Guide_.
...
You can use the [AWS Tools for Windows PowerShell](https://aws.amazon.com/powershell)
to move objects to and from Amazon S3.

Use the [Copy-S3Object](../../../powershell/latest/reference/items/copy-s3object.md) cmdlet to copy an Amazon S3 object to your Windows
instance as follows.
...
detail page](https://aws.amazon.com/cli).

The [aws s3 cp](../../../cli/latest/reference/s3/cp.md) command is
...
The [aws s3 sync](../../../cli/latest/reference/s3/sync.md) command can
...
examples for Amazon S3 using AWS SDKs](../../../s3/latest/api/service-code-examples.md) in the
