...
endpoint is only supported on [Nitro-based instances](instance-types.md#instance-hypervisor-type) in [IPv6-supported subnets](../../../vpc/latest/userguide/configure-subnets.md#subnet-ip-address-range) (dual stack or IPv6 only).
...
metadata. For more information, see [View tags for your EC2 instances using instance metadata](work-with-tags-in-imds.md).
...
more information about enforcement, see [Enforce IMDSv2 at the account level](configuring-imds-new-instances.md#enforce-imdsv2-at-the-account-level).
