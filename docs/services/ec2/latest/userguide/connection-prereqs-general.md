...
If you prefer, you can use the [describe-instances](../../../cli/latest/reference/ec2/describe-instances.md)
(AWS CLI) or [Get-EC2Instance](../../../powershell/latest/reference/items/get-ec2instance.md) (AWS Tools for Windows PowerShell) commands.
...
If you prefer, you can use the [describe-instances](../../../cli/latest/reference/ec2/describe-instances.md)
(AWS CLI) or [Get-EC2Instance](../../../powershell/latest/reference/items/get-ec2instance.md) (AWS Tools for Windows PowerShell) commands. For more information about IPv6,
...
instance. For more information, see [Identify the public key specified at launch](describe-keys.md#identify-key-pair-specified-at-launch).
...
convert the `.pem` file to `.ppk`, see [Convert your private key using PuTTYgen](connect-linux-inst-from-windows.md#putty-private-key).
...
installing the AWS CLI, see [Getting started with the AWS CLI](../../../cli/latest/userguide/cli-chap-getting-started.md) in the
...
use the [get-console-output](../../../cli/latest/reference/ec2/get-console-output.md) command. If the output is large,
[you can pipe it to a text file](../../../cli/latest/userguide/cli-usage-output-format.md), where it might be easier
to read.
...
[Get-EC2ConsoleOutput](../../../powershell/latest/reference/items/get-ec2consoleoutput.md)
cmdlet.
