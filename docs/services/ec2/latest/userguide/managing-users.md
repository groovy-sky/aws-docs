...
information, see [IAM\
users](https://docs.aws.amazon.com/IAM/latest/UserGuide/id.html#id_iam-users) in the _IAM User Guide_.
...
information, see [Connect to your Linux instance using a public IP address and EC2 Instance Connect](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connect-linux-inst-eic.html).
