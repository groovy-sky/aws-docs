...
4. **Start SSM Service**
      ...
      You can use Run Command to upgrade your
       ...
       and SSM Agent. For more information, see [Update SSM Agent using Run Command](https://docs.aws.amazon.com/systems-manager/latest/userguide/run-command-tutorial-update-software.html) in the
...
5. **Optimize ENA**
      ...
      When selected, ENA settings are configured to ensure that ENA
       ...
       for AWS. For more information, see [Configure Receive side scaling CPU affinity](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/enhanced-networking-os.html#windows-rss-cpu-affinity).
...
7. **Enable Jumbo Frames**
      ...
      Select to enable Jumbo Frames. Jumbo Frames can have unintended
       ...
       information about Jumbo Frames, see [Jumbo frames (9001 MTU)](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/network_mtu.html#jumbo_frame_instances).
...
requirements. For details, see the [Task definitions for EC2Launch v2 startup tasks](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2launch-v2-task-definitions.html).
...
user data may run more times than you intend it to. For more information, see [Service runs user data more than once](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2launchv2-troubleshooting.html#ec2launchv2-troubleshooting-user-data-more-than-once) in the
