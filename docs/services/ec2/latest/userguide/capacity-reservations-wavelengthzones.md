...
Zones](https://docs.aws.amazon.com/wavelength/latest/developerguide/wavelength-quotas.html) in the _AWS Wavelength Developer Guide_.
...
1. Enable the Wavelength Zone for use in your AWS account. For more information,
    see [Get\
    started with AWS Wavelength](https://docs.aws.amazon.com/wavelength/latest/developerguide/get-started-wavelength.html) in the _AWS Wavelength Developer_
_Guide_.
