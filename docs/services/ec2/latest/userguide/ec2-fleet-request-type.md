...
instances that could not be launched. For more information, see [Configure an EC2 Fleet of type instant](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instant-fleet.html).
