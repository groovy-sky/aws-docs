...
- EC2 Fleet – [Example 10: Launch Spot Instances in a price-capacity-optimized fleet](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-examples.html#ec2-fleet-config11)

- Spot Fleet – [Example 11: Launch Spot Instances in a priceCapacityOptimized fleet](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet-examples.html#fleet-config11)
...
- EC2 Fleet – [Example 8: Launch Spot Instances in a capacity-optimized fleet](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-examples.html#ec2-fleet-config9)

- Spot Fleet – [Example 9: Launch Spot Instances in a capacity-optimized fleet](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet-examples.html#fleet-config9)

For example JSON configurations that use the **capacity optimized**
**prioritized** allocation strategy, see the following:

- EC2 Fleet – [Example 9: Launch Spot Instances in a capacity-optimized fleet with priorities](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-examples.html#ec2-fleet-config10)

- Spot Fleet – [Example 10: Launch Spot Instances in a capacity-optimized fleet with priorities](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet-examples.html#fleet-config10)
