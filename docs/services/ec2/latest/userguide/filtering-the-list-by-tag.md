...
Add the following filter to the [describe-tags](../../../cli/latest/reference/ec2/describe-tags.md)
...
Add the following filter to the [Get-EC2Tag](../../../powershell/latest/reference/items/get-ec2tag.md)
