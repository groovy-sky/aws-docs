...
your instance. If you hibernate your Spot Instance ( [user-initiated hibernation](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/hibernating-instances.html)), you
...
with [UEFI Secure Boot](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/uefi-secure-boot.html)
enabled.
...
For more information, see [Spot Instance interruptions](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-interruptions.html).
