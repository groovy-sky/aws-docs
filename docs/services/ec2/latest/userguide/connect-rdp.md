...
[Systems Manager Fleet Manager](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connect-rdp-fleet-manager.html) or
...
8. If the RDP connection is successful, the RDP client displays the Windows login screen and then the Windows desktop. If you receive an error message instead,
    see [Remote Desktop can't connect to the remote computer](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/troubleshoot-connect-windows-instance.html#rdp-issues). When you are finished with the RDP connection, you can close the RDP client.
