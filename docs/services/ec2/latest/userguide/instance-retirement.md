...
information, see [Update the primary contact for your AWS account](../../../accounts/latest/reference/manage-acct-update-contact-primary.md) and [Update the alternate contacts for your AWS account](../../../accounts/latest/reference/manage-acct-update-contact-alternate.md) in the
...
Use the following [describe-instance-status](../../../cli/latest/reference/ec2/describe-instance-status.md)
