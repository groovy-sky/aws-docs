...
Use the following [monitor-instances](../../../cli/latest/reference/ec2/monitor-instances.md)
command.
...
Use the [unmonitor-instances](../../../cli/latest/reference/ec2/unmonitor-instances.md)
command.
...
Use the [Start-EC2InstanceMonitoring](../../../powershell/latest/reference/items/start-ec2instancemonitoring.md)
cmdlet.
...
Use the [Stop-EC2InstanceMonitoring](../../../powershell/latest/reference/items/stop-ec2instancemonitoring.md)
cmdlet.
