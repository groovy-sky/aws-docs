...
- [Volume limits for instances built on the Nitro System](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/volume_limits.html#nitro-system-limits)

  - [Dedicated EBS volume limit](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/volume_limits.html#dedicated-limit)

  - [Shared EBS volume limit](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/volume_limits.html#shared-limit)
- [Volume limits for Xen-based instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/volume_limits.html#xen-limits)

  - [Linux instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/volume_limits.html#linux-specific-volume-limits)

  - [Windows instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/volume_limits.html#windows-specific-volume-limits)
...
For more information, see [Xen-based instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html#instance-hypervisor-type).
...
from Red Hat to Citrix PV drivers, see [Upgrade PV drivers on EC2 Windows instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Upgrading_PV_drivers.html).
...
[How volumes are attached and mapped for Amazon EC2 Windows instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-windows-volumes.html).
