...
- [Keep an Amazon EBS root volume after an Amazon EC2 instance terminates](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/configure-root-volume-delete-on-termination.html)

- [Replace the root volume for an Amazon EC2 instance without stopping it](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/replace-root.html)
...
other purpose. For more information, see [Amazon EBS volumes](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-volumes.html).
