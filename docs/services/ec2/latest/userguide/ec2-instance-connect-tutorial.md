...
environment, we recommend that your IAM policy is configured to provide [least-privilege permissions](../../../iam/latest/userguide/best-practices.md#grant-least-privilege). For example IAM policies, see [Grant IAM permissions for EC2 Instance Connect](ec2-instance-connect-configure-iam-role.md).
