...
5. Verify your AMI tools installation using the [ec2-ami-tools-version](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-tools-commands.html#ami-tools-version) command.
...
3. Verify your AMI tools installation using the [ec2-ami-tools-version](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-tools-commands.html#ami-tools-version)
       command.
...
6. You can verify your AMI tools installation using the [ec2-ami-tools-version](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-tools-commands.html#ami-tools-version)
    command.
