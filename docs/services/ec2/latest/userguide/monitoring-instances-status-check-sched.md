...
AWS Health with Amazon EventBridge](https://docs.aws.amazon.com/health/latest/ug/cloudwatch-events-health.html).
...
checks for instances in an Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-health-checks.html) in the
...
Use the [describe-instance-status](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-instance-status.html) command. If the instance
...
- [Manage Amazon EC2 instances scheduled to stop or retire](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/schedevents_actions_retire.html)

- [Manage Amazon EC2 instances scheduled for reboot](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/schedevents_actions_reboot.html)

- [Manage Amazon EC2 instances scheduled for maintenance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/schedevents_actions_maintenance.html)

- [View scheduled events that affect your Amazon EC2 instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/viewing_scheduled_events.html)

- [Customize scheduled event notifications for your EC2 instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/customizing_scheduled_event_notifications.html)

- [Reschedule a scheduled event for an EC2 instance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/reschedule-event.html)

- [Create custom event windows for scheduled events that affect your Amazon EC2 instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/event-windows.html)
