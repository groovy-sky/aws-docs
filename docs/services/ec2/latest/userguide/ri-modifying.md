---
title: "Modify Reserved Instances"
---
...
For more information, see [Exchange Convertible Reserved Instances](ri-convertible-exchange.md).
...
effective date of the modified Reserved Instances by using the [describe-reserved-instances](../../../cli/latest/reference/ec2/describe-reserved-instances.md) command.
...
family](../instancetypes/instance-type-names.md) (indicated by a letter, for example, T) and [generation](../instancetypes/instance-type-names.md)
...
Use the [modify-reserved-instances](../../../cli/latest/reference/ec2/modify-reserved-instances.md) command. You can provide the
...
Use the [describe-reserved-instances-modifications](../../../cli/latest/reference/ec2/describe-reserved-instances-modifications.md) command. The
...
Use the [Edit-EC2ReservedInstance](../../../powershell/latest/reference/items/edit-ec2reservedinstance.md) cmdlet. You can provide the
...
Use the [Get-EC2ReservedInstancesModification](../../../powershell/latest/reference/items/get-ec2reservedinstancesmodification.md) cmdlet. The status
