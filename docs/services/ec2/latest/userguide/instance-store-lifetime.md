...
| [The instance type is changed](ec2-instance-resize.md) | The data does not persist \* |
| [An EBS-backed AMI is created from the instance](creating-an-ami-ebs.md) | The data does not persist in the created AMI \*\* |
| [An Amazon S3-backed AMI is created from the instance](creating-an-ami-instance-store.md) (Linux instances) | The data persists in the AMI bundle uploaded to Amazon S3 \*\*\* |
