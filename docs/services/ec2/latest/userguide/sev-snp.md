...
hardware. For more information, see [Attest an Amazon EC2 instance with AMD SEV-SNP](snp-attestation.md).
...
If you configure a Spot Instance to launch with [AMD SEV-SNP](sev-snp.md) enabled,
