...
instance](https://docs.aws.amazon.com/linux/al2/ug/processor_state_control.html) in the _Amazon Linux 2 User Guide_. These procedures were written for, and apply to Amazon Linux; however, they might also work for other Linux distributions
