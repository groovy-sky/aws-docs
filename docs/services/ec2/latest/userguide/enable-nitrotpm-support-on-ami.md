---
title: "Enable a Linux AMI for NitroTPM"
---
...
2. After the instance reaches the `running` state, create a snapshot
    of the instance's root volume. For more information, see [Create a snapshot of an EBS volume](../../../ebs/latest/userguide/ebs-create-snapshot.md).
...
The following is an example [register-image](../../../cli/latest/reference/ec2/register-image.md) command.
...
The following is an example for the [Register-EC2Image](../../../powershell/latest/reference/items/register-ec2image.md) cmdlet.
