...
more information, see [A New Role Appeared in My Account](../../../iam/latest/userguide/troubleshoot-roles.md#troubleshoot_roles_new-role-appeared) in the
_IAM User Guide_.
...
and [Using Key Policies in AWS KMS](../../../kms/latest/developerguide/key-policies.md)
in the _AWS Key Management Service Developer Guide_.

###### To grant the **AWSServiceRoleForEC2Spot** role permissions to use the customer managed key

- Use the [create-grant](../../../cli/latest/reference/kms/create-grant.md) command to add a grant to the customer managed key and to
