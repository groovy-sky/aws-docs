...
- [Create snapshots](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-creating-snapshot.html) of your EBS volumes so that you can create new
...
5. If you backed up data to an EBS snapshot,
    [create a volume from the snapshot](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-creating-volume.html#ebs-create-volume-from-snapshot) and then [attach the volume](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-attaching-volume.html) to the new instance.

To move an EBS volume from the original instance to the new instance,
    [detach the volume](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-detaching-volume.html)
    from the original instance and then [attach the volume](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-attaching-volume.html) to the new instance.
