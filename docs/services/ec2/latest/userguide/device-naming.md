...
- AWS PV: [Paravirtual drivers for Windows instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/xen-drivers-overview.html)

- AWS NVMe: [AWS NVMe drivers](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/aws-nvme-drivers.html)
...
(Nitro-based instances), including how to identify the EBS device, see [Amazon EBS and NVMe](https://docs.aws.amazon.com/ebs/latest/userguide/nvme-ebs-volumes.html)
...
[Windows launch agents on Amazon EC2 Windows instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/configure-launch-agents.html), and
