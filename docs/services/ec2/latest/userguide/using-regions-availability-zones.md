...
For the list of available Regions, see [AWS Regions](../../../global-infrastructure/latest/regions/aws-regions.md).
...
endpoints for Amazon EC2, see [Amazon EC2 service endpoints](../devguide/ec2-endpoints.md) in the _Amazon EC2 Developer Guide_.

For more information, see [AWS Regions](../../../global-infrastructure/latest/regions/aws-regions.md) in
...
For the list of Availability Zones by Region, see [AWS Availability Zones](../../../global-infrastructure/latest/regions/aws-availability-zones.md).
...
For more information, see [AWS Availability Zones](../../../global-infrastructure/latest/regions/aws-availability-zones.md) in
the _AWS Regions and Availability Zones User_
_Guide_.
...
created in a Local Zone can serve local users with low-latency communications. For more information, see [What is AWS Local Zones?](../../../local-zones/latest/ug/what-is-aws-local-zones.md) in the _AWS Local Zones User Guide_.
...
For the list of available Local Zones, see [Available Local Zones](../../../local-zones/latest/ug/available-local-zones.md)
...
started with AWS Local Zones](../../../local-zones/latest/ug/getting-started.md) in the _AWS Local Zones User_
_Guide_.
...
For the list of available Wavelength Zones, see [Available Wavelength Zones](../../../wavelength/latest/developerguide/available-wavelength-zones.md) in the _AWS Wavelength Guide_.
...
For step-by-step directions to launch an instance in a Wavelength Zone, see [Get started with AWS Wavelength](../../../wavelength/latest/developerguide/get-started-wavelength.md) in the _AWS Wavelength Developer Guide_.
...
For more information, see [Get started with Outposts racks](../../../outposts/latest/userguide/get-started-outposts.md) or [Get started with Outposts servers](../../../outposts/latest/server-userguide/get-started-outposts.md).
...
The following [create-volume](../../../cli/latest/reference/ec2/create-volume.md) command creates an empty 50 GB volume on the specified
Outpost.
...
them. For more information about modifying a volume without detaching it, see [Request modifications to your EBS volumes](../../../ebs/latest/userguide/requesting-ebs-volume-modifications.md) in the _Amazon EBS User Guide_.
...
information, see [I/O\
operation timeout](../../../ebs/latest/userguide/nvme-ebs-volumes.md#timeout-nvme-ebs-volumes) in the _Amazon EBS User Guide_.
...
application. For more information, see [Instance store volume limits](instance-store-volumes.md).
