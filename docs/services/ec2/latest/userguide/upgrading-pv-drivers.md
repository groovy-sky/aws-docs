...
01. We recommend that you create a backup in case you need to roll back your
    ...
    runbook. For more information, see [AWS-CreateImage](https://docs.aws.amazon.com/systems-manager-automation-runbooks/latest/userguide/automation-aws-createimage.html) in the
...
04. For the instructions for how to install or upgrade the AWS PV driver
     package using Distributor, see the procedures in [Install or update packages](https://docs.aws.amazon.com/systems-manager/latest/userguide/distributor-working-with-packages-deploy.html) in the _AWS Systems Manager User_
    _Guide_.
...
10. Verify that the driver version is the same as the latest version listed in
     the Driver Version History table. For more information, see [AWS PV driver package history](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/xen-drivers-overview.html#pv-driver-history) Open
...
If you previously disabled [TCP offloading](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/pvdrivers-troubleshooting.html#citrix-tcp-offloading) using Netsh for Citrix PV drivers we
...
in the [Paravirtual drivers for Windows instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/xen-drivers-overview.html)
page.
...
Driver Version History table. For more information, see [AWS PV driver package history](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/xen-drivers-overview.html#pv-driver-history) Open Disk
...
09. To complete the upgrade process, verify that the new driver was installed.
     ...
     **AWS PV Storage Host Adapter**. Verify that the
     ...
     Version History table. For more information, see [AWS PV driver package history](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/xen-drivers-overview.html#pv-driver-history).
...
see [Install the latest version of EC2Config](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UsingConfig_Install.html).
...
01. Connect to your instance and log in as the local administrator. For more
     information about connecting to your instance, see [Connect to your Windows instance using RDP](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connecting_to_windows_instance.html).
