...
User Guide](../../../savingsplans/latest/userguide/what-is-savings-plans.md).
...
Use the [describe-images](../../../cli/latest/reference/ec2/describe-images.md) command and check the value of
`PlatformDetails`.
...
Use the [Get-EC2Image](../../../powershell/latest/reference/items/get-ec2image.md) cmdlet and check the value of
`PlatformDetails`.
...
1. Find available Reserved Instances using the [describe-reserved-instances-offerings](../../../cli/latest/reference/ec2/describe-reserved-instances-offerings.md) command.
...
2. Use the [purchase-reserved-instances-offering](../../../cli/latest/reference/ec2/purchase-reserved-instances-offering.md) command to buy
...
3. Use the [describe-reserved-instances](../../../cli/latest/reference/ec2/describe-reserved-instances.md) command to get the
...
1. Find available Reserved Instances using the [Get-EC2ReservedInstancesOffering](../../../powershell/latest/reference/items/get-ec2reservedinstancesoffering.md) cmdlet. Specify
...
2. Use the [New-EC2ReservedInstance](../../../powershell/latest/reference/items/new-ec2reservedinstance.md) cmdlet to buy your Reserved Instance.
...
3. Use the [Get-EC2ReservedInstance](../../../powershell/latest/reference/items/get-ec2reservedinstance.md) cmdlet to get the status of
...
Use the [delete-queued-reserved-instances](../../../cli/latest/reference/ec2/delete-queued-reserved-instances.md) command.
...
Use the [Remove-EC2QueuedReservedInstance](../../../powershell/latest/reference/items/remove-ec2queuedreservedinstance.md) cmdlet.
