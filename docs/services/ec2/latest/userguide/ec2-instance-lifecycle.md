...
more information, see [Avoiding Unexpected Charges](../../../awsaccountbilling/latest/aboutv2/checklistforunwantedcharges.md) in the _AWS Billing User Guide_.
...
see [Reserved Instances for Amazon EC2 overview](ec2-reserved-instances.md)
