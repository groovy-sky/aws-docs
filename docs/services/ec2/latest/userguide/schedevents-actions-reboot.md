...
- **Reschedule the reboot:** You can [reschedule](reschedule-event.md) the instance reboot to
a date and time that suits you.

- **Perform a user-initiated reboot:** You
can manually [reboot](ec2-instance-reboot.md) the
...
to events in AWS Health](../../../health/latest/ug/automating-instance-actions.md) in the _AWS Health User Guide_.
...
Use the [modify-instance-maintenance-options](../../../cli/latest/reference/ec2/modify-instance-maintenance-options.md) command and
...
Use the [Edit-EC2InstanceMaintenanceOption](../../../powershell/latest/reference/items/edit-ec2instancemaintenanceoption.md)
cmdlet.
...
Use the [Edit-EC2InstanceMaintenanceOption](../../../powershell/latest/reference/items/edit-ec2instancemaintenanceoption.md) cmdlet.
