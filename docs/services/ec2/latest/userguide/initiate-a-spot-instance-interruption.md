...
The AWS FIS console opens. For more information, see [Tutorial: Test Spot Instance interruptions using AWS FIS](../../../fis/latest/userguide/fis-tutorial-spot-interruptions.md) in the
