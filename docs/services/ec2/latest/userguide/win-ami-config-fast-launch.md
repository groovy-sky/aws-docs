...
more information, see [Recycle Bin](https://docs.aws.amazon.com/ebs/latest/userguide/recycle-bin.html)
in the _Amazon EBS User Guide_.

This feature is not the same as [EBS fast snapshot restore](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-fast-snapshot-restore.html).
...
[Manage costs for EC2 Fast Launch underlying resources](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/win-fast-launch-manage-costs.html).

###### Contents

- [Key terms](#win-fast-launch-key-terms)

- [EC2 Fast Launch prerequisites for Windows](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/win-start-fast-launch-prereqs.html)

- [Configure EC2 Fast Launch settings for your Amazon EC2 Windows Server AMI](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/win-fast-launch-configure.html)

- [View AMIs with EC2 Fast Launch enabled](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/win-view-fast-launch.html)

- [Manage costs for EC2 Fast Launch underlying resources](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/win-fast-launch-manage-costs.html)

- [Monitor EC2 Fast Launch](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/win-fast-launch-monitor.html)

- [Service-linked role for EC2 Fast Launch](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/slr-windows-fast-launch.html)

- [Troubleshoot Windows EC2 Fast Launch](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/win-fast-launch-troubleshoot.html)
