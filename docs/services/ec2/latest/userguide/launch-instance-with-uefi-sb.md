...
see [UEFI Secure Boot](../../../linux/al2023/ug/uefi-secure-boot.md)
...
more information, see [Create a Linux AMI with custom UEFI Secure Boot keys](create-ami-with-uefi-secure-boot.md).
...
[import-image](../../../cli/latest/reference/ec2/import-image.md) command.
