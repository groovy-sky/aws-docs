...
1. In Registry Editor, choose **HKEY\_LOCAL\_MACHINE**, then select **File**, **Load Hive**.
...
1. In Registry Editor, choose **HKEY\_LOCAL\_MACHINE**\\{{your-key-name}}, then select **File**, **Unload Hive**.
