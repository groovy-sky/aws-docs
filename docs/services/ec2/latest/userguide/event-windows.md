...
Use the [create-instance-event-window](../../../cli/latest/reference/ec2/create-instance-event-window.md) command.
...
Use the [New-EC2InstanceEventWindow](../../../powershell/latest/reference/items/new-ec2instanceeventwindow.md)
cmdlet.
...
Use the [associate-instance-event-window](../../../cli/latest/reference/ec2/associate-instance-event-window.md) command.
...
Use the [Register-EC2InstanceEventWindow](../../../powershell/latest/reference/items/register-ec2instanceeventwindow.md)
cmdlet.
...
Use the [disassociate-instance-event-window](../../../cli/latest/reference/ec2/disassociate-instance-event-window.md) command.
...
Use the [Unregister-EC2InstanceEventWindow](../../../powershell/latest/reference/items/unregister-ec2instanceeventwindow.md)
cmdlet.
...
Use the [modify-instance-event-window](../../../cli/latest/reference/ec2/modify-instance-event-window.md) command.
...
Use the [Edit-EC2InstanceEventWindow](../../../powershell/latest/reference/items/edit-ec2instanceeventwindow.md)
cmdlet.
...
Use the [delete-instance-event-window](../../../cli/latest/reference/ec2/delete-instance-event-window.md) command and specify
...
Use the [Remove-EC2InstanceEventWindow](../../../powershell/latest/reference/items/remove-ec2instanceeventwindow.md)
cmdlet.
