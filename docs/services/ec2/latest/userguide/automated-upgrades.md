...
information, see the _[AWS Systems Manager User Guide](../../../systems-manager/latest/userguide.md)_.
...
Automation runbook reference](../../../systems-manager-automation-runbooks/latest/userguide/automation-runbook-reference.md) in the
...
Server](../../../systems-manager/latest/userguide/ssm-agent-windows.md).
...
Follow these steps to upgrade your Windows Server instance using the [AWSEC2-CloneInstanceAndUpgradeWindows](../../../systems-manager-automation-runbooks/latest/userguide/automation-awsec2-cloneinstanceandupgradewindows.md) automation runbook.
...
and AWS AMIs. For more information, see [Configure EC2 instance permissions](../../../systems-manager/latest/userguide/setup-instance-permissions.md#instance-profile-add-permissions) in the
_AWS Systems Manager User Guide_.
...
The [AWSEC2-CloneInstanceAndUpgradeSQLServer](../../../systems-manager-automation-runbooks/latest/userguide/automation-awsec2-cloneinstanceandupgradesqlserver.md) script creates
...
The following limitations apply when using the [AWSEC2-CloneInstanceAndUpgradeSQLServer](../../../systems-manager-automation-runbooks/latest/userguide/automation-awsec2-cloneinstanceandupgradesqlserver.md) runbook to perform an
automated upgrade:
...
Follow these steps to upgrade your SQL Server using the [AWSEC2-CloneInstanceAndUpgradeSQLServer](../../../systems-manager-automation-runbooks/latest/userguide/automation-awsec2-cloneinstanceandupgradesqlserver.md) automation runbook.
...
03. Take an Amazon EBS snapshot of the volume and copy the snapshot ID onto a
     clipboard for later use. For more information, see [Create Amazon EBS snapshots](../../../ebs/latest/userguide/ebs-creating-snapshot.md) in the **Amazon EBS User Guide**.
...
05. In the AWS Systems Manager console, in the left navigation pane, choose
     **Managed Instances**. Verify that your EC2
     ...
     [Where Are My Instances?](../../../systems-manager/latest/userguide/troubleshooting-remote-commands.md#where-are-instances) in the
     _AWS Systems Manager User Guide_.
