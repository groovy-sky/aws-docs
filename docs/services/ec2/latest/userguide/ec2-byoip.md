...
[Bring your own IP\
addresses (BYOIP)](../../../global-accelerator/latest/dg/using-byoip.md) in the _AWS Global Accelerator Developer Guide_. To
bring your own IP address range for use with Amazon VPC IP Address Manager, see [Tutorial: Bring your IP addresses to IPAM](../../../vpc/latest/ipam/tutorials-byoip-ipam.md) in the
...
IP addresses to IPAM](../../../vpc/latest/ipam/tutorials-byoip-ipam.md) in the _Amazon VPC IPAM User_
_guide_.
...
advertisable](byoip-onboard.md#byoip-provision-non-public).
...
see [Integrate \
IPAM with AWS Organizations](../../../vpc/latest/ipam/enable-integ-ipam.md) in the _Amazon VPC IPAM User Guide_.
...
A [Local Zone](../../../local-zones/latest/ug/how-local-zones-work.md) is an extension of an AWS Region in geographic proximity to
...
If you have Local Zones enabled (see [Enable a Local Zone](../../../local-zones/latest/ug/getting-started.md#getting-started-find-local-zone)), you can choose a network border group for Local Zones
