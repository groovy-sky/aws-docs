...
[Create a VPC](https://docs.aws.amazon.com/vpc/latest/userguide/create-vpc.html) in the _Amazon VPC User Guide_.
...
- Configure an internet gateway. For more information, see [Connect to the internet using an internet gateway](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Internet_Gateway.html) in the
_Amazon VPC User Guide_.

- Configure a public NAT gateway. For more information, see [Access the internet \
from a private subnet](https://docs.aws.amazon.com/vpc/latest/userguide/nat-gateway-scenarios.html#public-nat-internet-access) in the _Amazon VPC User Guide_.
...
- [Manage AMI sharing with an organization or OU](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/share-amis-org-ou-manage.html)

- [Shared Capacity Reservations](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/capacity-reservation-sharing.html)

- [Shared placement groups](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/share-placement-group.html)

- [Cross-account Amazon EC2 Dedicated Host sharing](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/dh-sharing.html)

For more information about shared subnets, see [Share your VPC with other accounts](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-sharing.html)
