...
**Usage operation** corresponds to the [lineitem/Operation](../../../cur/latest/userguide/lineitem-columns.md#Lineitem-details-O-Operation) column on your AWS Cost and Usage Report
...
page in the Amazon EC2 console, or in the response that is returned by the [describe-images](../../../cli/latest/reference/ec2/describe-images.md) or
...
pages in the Amazon EC2 console, or in the response that is returned by the [describe-images](../../../cli/latest/reference/ec2/describe-images.md) or
[Get-EC2Image](../../../powershell/latest/reference/items/get-ec2image.md)
command.
...
2 If you are running Spot Instances, the [lineitem/Operation](../../../cur/latest/userguide/lineitem-columns.md#Lineitem-details-O-Operation) on your AWS Cost and Usage Report might be
