...
See [Create a resource share](../../../ram/latest/userguide/working-with-sharing-create.md) in the _AWS RAM User Guide_.
...
Use the [New-RAMResourceShare](../../../powershell/latest/reference/items/new-ramresourceshare.md) cmdlet.
