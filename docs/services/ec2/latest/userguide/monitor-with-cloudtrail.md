...
The Amazon EC2 API is integrated with [AWS CloudTrail](https://docs.aws.amazon.com/awscloudtrail/latest/userguide), a service that
...
that are logged to CloudTrail, see the [Amazon EC2 API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference). For example, calls to the [RunInstances](../../../../reference/awsec2/latest/apireference/api-runinstances.md),
[DescribeInstances](../../../../reference/awsec2/latest/apireference/api-describeinstances.md),
and [StopInstances](../../../../reference/awsec2/latest/apireference/api-stopinstances.md)
...
record contents](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-event-reference-record-contents.html) in the _AWS CloudTrail User Guide_.
...
7. The page displays the events that correspond to the [SendSSHPublicKey](https://docs.aws.amazon.com/ec2-instance-connect/latest/APIReference/API_SendSSHPublicKey.html)
...
If you have configured your AWS account to collect CloudTrail events in an
    ...
    viewing your CloudTrail log files](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/get-and-view-cloudtrail-log-files.html) in the _AWS CloudTrail User Guide_.
