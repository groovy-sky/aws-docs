...
Amazon Time Sync Service](configure-ec2-ntp.md) on your EC2 instances. For a backup to the local Amazon Time Sync Service on your instances,
or to connect resources outside of Amazon EC2 to the Amazon Time Sync Service, you can use the [public Amazon Time Sync Service](configure-time-sync.md) located at `time.aws.com`. The public Amazon Time Sync Service, like
...
[PTP hardware clock](configure-ec2-ntp.md#connect-to-the-ptp-hardware-clock).
...
support the PTP hardware clock](configure-ec2-ntp.md#ptp-hardware-clock-requirements).
