...
Use the [allocate-hosts](../../../cli/latest/reference/ec2/allocate-hosts.md) command.
...
Use the [New-EC2Host](../../../powershell/latest/reference/items/new-ec2host.md) cmdlet.
...
Use the [modify-hosts](../../../cli/latest/reference/ec2/modify-hosts.md) command and specify the `host-recovery`
...
Use the [Edit-host](../../../powershell/latest/reference/items/edit-ec2host.md) cmdlet.
