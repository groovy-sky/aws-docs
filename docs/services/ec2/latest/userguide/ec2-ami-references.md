...
Use the [describe-image-references](../../../cli/latest/reference/ec2/describe-image-references.md) command with the
...
Use the [describe-image-references](../../../cli/latest/reference/ec2/describe-image-references.md) command with both the
...
Use the [Get-EC2ImageReference](../../../powershell/latest/reference/items/get-ec2imagereference.md) cmdlet with the
...
Use the [Get-EC2ImageReference](../../../powershell/latest/reference/items/get-ec2imagereference.md) cmdlet with both the
