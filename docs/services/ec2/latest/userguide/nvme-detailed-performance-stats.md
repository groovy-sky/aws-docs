...
[Amazon EBS \
detailed performance statistics](https://docs.aws.amazon.com/ebs/latest/userguide/nvme-detailed-performance-stats.html), they also include detailed latency histograms broken down
...
2. Make sure that you're using AWSNVMe driver version `1.7.0` or later.
    For more information about updating the AWSNVMe driver, see [AWS NVMe drivers](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/aws-nvme-drivers.html).

3. Get the disk number for the volume. For more information, see [Map NVMe disks on Amazon EC2 Windows \
    instance to volumes](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/windows-list-disks-nvme.html).
