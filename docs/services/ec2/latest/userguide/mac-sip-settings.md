...
[Connect to the instance using SSH](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connect-to-mac-instance.html#mac-instance-ssh),
...
silicon Mac instance using the GUI. If you previously [connected to the instance using the GUI](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connect-to-mac-instance.html#mac-instance-vnc), or if you are using an x86
...
1. [Connect to the instance using SSH](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connect-to-mac-instance.html#mac-instance-ssh).
