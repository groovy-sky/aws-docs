...
![CPU billing usage of a t3.large instance.](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/images/t3-cpu-usage.png)
...
![The breakeven CPU usage point for a t3.large instance is 42.5%.](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/images/T3-unltd-when-to-use.png)
