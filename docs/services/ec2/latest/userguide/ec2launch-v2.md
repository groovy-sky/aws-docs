...
For more information, see [Windows event logs](ec2launchv2-troubleshooting.md#ec2launchv2-windows-event-logs).
...
agent to run. The stage is implied. For example tasks, see [Example: user data](ec2launch-v2-settings.md#ec2launch-v2-example-user-data).
...
configuration schema and details, see [EC2Launch v2 task configuration](ec2launch-v2-settings.md#ec2launch-v2-task-configuration).
...
- [Configure EC2Launch v2 settings for Windows instances](ec2launch-v2-settings.md)

- [Task definitions for EC2Launch v2 startup tasks](ec2launch-v2-task-definitions.md)

- [Troubleshoot issues with the EC2Launch v2 agent](ec2launchv2-troubleshooting.md)
