...
roles](using-service-linked-roles.md)
...
The number of instances for which the Fleet reserves capacity depends on the [total target capacity](crfleet-concepts.md#target-capacity) and
the [instance type\
weights](crfleet-concepts.md#instance-weight) that you specify. The instance type for which it
reserves capacity depends on the [allocation strategy](crfleet-concepts.md#allocation-strategy) and [instance type priorities](crfleet-concepts.md#instance-priority)
that you use.
