...
Networking](enhanced-networking.md).
...
(for example, T2), [Mac1 instances](ec2-mac-instances.md),
...
group](cr-cpg.md). Note that you can't reserve capacity using zonal Reserved Instances, as
...
deployment. For more information, see [Placement groups on AWS Outposts](placement-groups-outpost.md).
