...
[Nitro-based instances](instance-types.md#instance-hypervisor-type) in [IPv6-supported subnets](../../../vpc/latest/userguide/configure-subnets.md#subnet-ip-address-range) (dual stack or IPv6 only).
...
Alice launches four instances using the [run-instances](../../../cli/latest/reference/ec2/run-instances.md) command,
