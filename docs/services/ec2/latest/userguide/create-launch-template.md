...
05. Under **Instance type**, you can either keep
    ...
    type selection](../../../autoscaling/ec2/userguide/create-mixed-instances-group-attribute-based-instance-type-selection.md) and [Specify attributes for instance type selection for EC2 Fleet or Spot Fleet](ec2-fleet-attribute-based-instance-type-selection.md).
...
Use the [create-launch-template](../../../cli/latest/reference/ec2/create-launch-template.md) command.
...
Use the [New-EC2LaunchTemplate](../../../powershell/latest/reference/items/new-ec2launchtemplate.md) cmdlet.
...
- Use the [get-launch-template-data](../../../cli/latest/reference/ec2/get-launch-template-data.md) command and specify the
...
- Use the [create-launch-template](../../../cli/latest/reference/ec2/create-launch-template.md) command to create a launch
...
[shared](../../../systems-manager/latest/userguide/parameter-store-shared-parameters.md) with other AWS accounts. You can centrally store and manage
...
A Systems Manager parameter is a user-defined key-value pair that you create in the [AWS Systems Manager Parameter Store](../../../systems-manager/latest/userguide/systems-manager-parameter-store.md). The Parameter Store provides a central place
...
[Creating Systems Manager parameters](../../../systems-manager/latest/userguide/sysman-paramstore-su-create.md) in the
...
create new, successive versions of the parameter. Systems Manager supports [parameter labels](../../../systems-manager/latest/userguide/sysman-paramstore-labels.md) that you can map to specific versions of a
parameter.
...
- Use the [create-launch-template](../../../cli/latest/reference/ec2/create-launch-template.md) command to create the
...
Use the [describe-launch-template-versions](../../../cli/latest/reference/ec2/describe-launch-template-versions.md) command and include the
...
supported by Amazon EC2, see [Calling AMI public parameters](../../../systems-manager/latest/userguide/parameter-store-public-parameters-ami.md).

- For information about sharing parameters with other AWS accounts or
through AWS Organizations, see [Working with shared parameters](../../../systems-manager/latest/userguide/parameter-store-shared-parameters.md).
...
IDs](../../../systems-manager/latest/userguide/parameter-store-ec2-aliases.md).
...
- If you use [attribute-based instance selection](ec2-fleet-attribute-based-instance-type-selection.md) in your EC2 Fleet, you can't
