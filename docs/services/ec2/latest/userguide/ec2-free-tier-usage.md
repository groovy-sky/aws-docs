...
AWS Free Tier](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/free-tier.html) in the _AWS Billing User Guide_.
...
_**on or after July 15, 2025, see [Tracking your AWS Free Tier usage](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/tracking-free-tier-usage.html) in the**_
...
- For the instructions to delete your instance, see [Terminate Amazon EC2 instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-instances.html).
...
**View**. For more information, see [View resources across Regions using AWS Global View](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/global-view.html).
...
6. To view your resource usage for all AWS services under the AWS Free Tier,
    ...
    **View all AWS Free Tier offers**. For more information,
    see [Trying\
    services using AWS Free Tier](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-free-tier.html) in the _AWS_
