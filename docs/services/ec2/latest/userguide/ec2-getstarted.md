...
and connect to an EC2 instance. An _instance_ is a virtual server
...
- An image – A template that contains the software to run on your
instance, such as the operating system.

- A key pair – A set of security credentials that you use to prove your
identity when connecting to your instance. The public key is on your instance
and the private key is on your computer.

- A network – A virtual private cloud (VPC) is a virtual network dedicated to your
...
![An instance with a security group, key pair, and EBS root volume.](https://docs.aws.amazon.com/images/AWSEC2/latest/UserGuide/images/get-started-diagram.png)
...
Free Tier, see [Track your Free Tier usage for Amazon EC2](ec2-free-tier-usage.md).
...
02. In the navigation bar at the top of the screen, we display the current AWS Region —
     for example, **Ohio**. You can use the selected Region, or
     optionally select a Region that is closer to you.

03. From the EC2 console dashboard, in the **Launch instance** pane,
     choose **Launch instance**.

04. Under **Name and tags**, for **Name**, enter
...
08. Under **Network settings**, notice that we selected your default VPC,
...
09. Under **Configure storage**, notice that we configured a root volume
...
to your instance, see [Troubleshoot issues connecting to your Amazon EC2 Linux instance](troubleshootinginstancesconnecting.md) for assistance.
...
now and then start it again later. For more information, see [Stop and start Amazon EC2 instances](stop-start.md).
...
[Tutorials for launching EC2 instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-launch-tutorials.html).

- Learn how to track your Amazon EC2 Free Tier usage using the console. For more information,
see [Track your Free Tier usage for Amazon EC2](ec2-free-tier-usage.md).
...
AWS Free Tier usage](../../../awsaccountbilling/latest/aboutv2/tracking-free-tier-usage.md) in the
...
For more information, see [AWS Systems Manager Run Command](https://docs.aws.amazon.com/systems-manager/latest/userguide/run-command.html) in the _AWS Systems Manager User Guide_.
