...
file with the [create-fleet](https://docs.aws.amazon.com/cli/latest/reference/ec2/create-fleet.html)
...
information, see [Configuration options for your EC2 Fleet or Spot Fleet](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-configuration-strategies.html).
...
[AWS SDKs](../../../../reference/awsec2/latest/apireference/api-createfleet.md#API_CreateFleet_SeeAlso), and [CloudFormation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-ec2fleet.html).
...
For fleet configuration examples, see [Example CLI configurations for EC2 Fleet](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-examples.html).

There is currently no console support for creating an EC2 Fleet.

###### To create an EC2 Fleet

Use the [create-fleet](https://docs.aws.amazon.com/cli/latest/reference/ec2/create-fleet.html) command to create the fleet and specify
...
information, see [Status checks for Amazon EC2 instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/monitoring-system-instance-status-check.html).
...
file. For a description of each parameter, see [create-fleet](https://docs.aws.amazon.com/cli/latest/reference/ec2/create-fleet.html).
