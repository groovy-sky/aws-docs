...
To verify the authenticity of an instance identity document after you retrieve it, see [Verify instance identity document](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/verify-iid.html).
