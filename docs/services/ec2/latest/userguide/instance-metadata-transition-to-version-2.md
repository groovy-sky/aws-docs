...
[Use a supported AWS SDK](configuring-instance-metadata-service.md#use-a-supported-sdk-version-for-imdsv2).
...
For more information, see [Instance metrics](viewing-metrics-with-cloudwatch.md#ec2-cloudwatch-metrics).
...
**Existing instances:** Use the [ModifyInstanceMetadataOptions](../../../../reference/awsec2/latest/apireference/api-modifyinstancemetadataoptions.md) API to require the use of
IMDSv2 on existing instances. For more information, see [Modify instance metadata options for existing instances](configuring-imds-existing-instances.md).
...
When you [create a launch template](../../../cli/latest/reference/ec2/create-launch-template.md) or [create a launch configuration](../../../cli/latest/reference/autoscaling/create-launch-configuration.md), you must configure the
...
**Existing instances in an Auto Scaling group:** Use the [ModifyInstanceMetadataOptions](../../../../reference/awsec2/latest/apireference/api-modifyinstancemetadataoptions.md) API to require the use of
...
**New AMIs:** Use the [register-image](../../../cli/latest/reference/ec2/register-image.md)
CLI command to set the `ImdsSupport` parameter to
`v2.0` when creating a new AMI.

**Existing AMIs:** Use the [modify-image-attribute](../../../cli/latest/reference/ec2/modify-image-attribute.md) CLI command to set the
...
- Can't modify an existing instance using the [ModifyInstanceMetadataOptions](../../../../reference/awsec2/latest/apireference/api-modifyinstancemetadataoptions.md) API to re-enable
IMDSv1.
...
information on SCPs, see [Service control policies](../../../organizations/latest/userguide/orgs-manage-policies-scps.md) in the _AWS Organizations User Guide_.
...
**Metadata** tab in the [Supported declarative policies](../../../organizations/latest/userguide/orgs-manage-policies-declarative-syntax.md#declarative-policy-examples) section in the _AWS Organizations User Guide_.
...
Use the CloudWatch metric `MetadataNoToken`. This metric shows
    ...
    more information, see [Instance metrics](../../../en-us/awsec2/latest/userguide/viewing-metrics-with-cloudwatch.md#ec2-cloudwatch-metrics).
...
see [Installing or\
updating to the latest version of the AWS CLI](../../../cli/latest/userguide/getting-started-install.md) in the
...
You can enforce the use of IMDSv2 at the account level for each AWS Region.
    ...
    the [Supported declarative policies](../../../organizations/latest/userguide/orgs-manage-policies-declarative-syntax.md#declarative-policy-examples) section in the _AWS Organizations User Guide_.

To prevent a reversal of enforcement, you should use an IAM policy to prevent access to
    the [ModifyInstanceMetadataDefaults](../../../../reference/awsec2/latest/apireference/api-modifyinstancemetadatadefaults.md) API. For more information,
...
These condition keys control the use of the [RunInstances](../../../../reference/awsec2/latest/apireference/api-runinstances.md) and the [ModifyInstanceMetadataOptions](../../../../reference/awsec2/latest/apireference/api-modifyinstancemetadataoptions.md) APIs and corresponding CLIs. If a
