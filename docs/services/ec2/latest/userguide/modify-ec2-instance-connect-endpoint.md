...
Use the [modify-instance-connect-endpoint](../../../cli/latest/reference/ec2/modify-instance-connect-endpoint.md) command
...
Use the [describe-instance-connect-endpoints](../../../cli/latest/reference/ec2/describe-instance-connect-endpoints.md) command
...
Use the [Edit-EC2InstanceConnectEndpoint](../../../powershell/latest/reference/items/edit-ec2instanceconnectendpoint.md) cmdlet
and specify the EC2 Instance Connect Endpoint and the parameters to modify. The
following example modifies all the parameters in a single
request.
...
Use the [Get-EC2InstanceConnectEndpoint](../../../powershell/latest/reference/items/get-ec2instanceconnectendpoint.md) command to
