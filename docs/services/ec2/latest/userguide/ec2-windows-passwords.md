...
reset procedures, see [Reset the Windows administrator password for an Amazon EC2 Windows instance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ResettingAdminPassword.html).
