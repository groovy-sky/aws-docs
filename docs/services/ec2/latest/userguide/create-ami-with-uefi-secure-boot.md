...
release 2023.1. For more information, see [UEFI Secure Boot on AL2023](https://docs.aws.amazon.com/linux/al2023/ug/uefi-secure-boot.html)
...
Use the [get-instance-uefi-data](https://docs.aws.amazon.com/cli/latest/reference/ec2/get-instance-uefi-data.html) command and
...
You can now export your UEFI variable store with the [get-instance-uefi-data](https://docs.aws.amazon.com/cli/latest/reference/ec2/get-instance-uefi-data.html) CLI command, or
...
Use [register-image](https://docs.aws.amazon.com/cli/latest/reference/ec2/register-image.html) to pass your UEFI
