...
services for an application, such as a billing application. For more information, see [AWS Cloud Map namespaces](https://docs.aws.amazon.com/cloud-map/latest/dg/working-with-namespaces.html).
...
checker. For more information, see [AWS Cloud Map services](https://docs.aws.amazon.com/cloud-map/latest/dg/working-with-services.html).
...
instances. For more information, see [AWS Cloud Map service instances](https://docs.aws.amazon.com/cloud-map/latest/dg/working-with-instances.html).
...
- [Identity and Access Management for AWS Cloud Map](https://docs.aws.amazon.com/cloud-map/latest/dg/security-iam.html)
