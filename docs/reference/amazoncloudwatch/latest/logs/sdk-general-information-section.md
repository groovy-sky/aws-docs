---
title: "Using CloudWatch Logs with an AWS SDK"
---
...
[AWS Tools for PowerShell code examples](../../../../services/code-library/latest/ug/powershell-5-code-examples.md)
...
For examples specific to CloudWatch Logs, see [Code examples for CloudWatch Logs using AWS SDKs](../../../../services/amazoncloudwatch/latest/logs/service-code-examples.md).
