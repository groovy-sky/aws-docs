...
Create a mute rule that mutes specific alarms every day from 2:00 AM to 4:00
AM UTC.
...
Create a mute rule that mutes specific alarms every Saturday for 4
hours.
...
- [AWS SDK for Python](https://docs.aws.amazon.com/goto/boto3/monitoring-2010-08-01/PutAlarmMuteRule)
