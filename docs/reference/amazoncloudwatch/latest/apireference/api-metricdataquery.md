...
time series. For more information, see [Metric Math Syntax and Functions](../../../../services/amazoncloudwatch/latest/monitoring/using-metric-math.md#metric-math-syntax) in the _Amazon CloudWatch User_
_Guide_.
...
[Metric Math Syntax and Functions](../../../../services/amazoncloudwatch/latest/monitoring/using-metric-math.md#metric-math-syntax) in the _Amazon CloudWatch User_
_Guide_.
