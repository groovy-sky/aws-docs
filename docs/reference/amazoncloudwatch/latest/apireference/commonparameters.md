...
for that action. For more information about Signature Version 4, see [Signing AWS API requests](../../../../services/iam/latest/userguide/reference-sigv.md) in the _IAM User Guide_.
...
For more information, see [Create a signed AWS API request](../../../../services/iam/latest/userguide/reference-sigv-create-signed-request.md) in the _IAM User Guide_.
...
overrides the value of the Date header. For more information, see [Elements of an AWS API request signature](../../../../services/iam/latest/userguide/reference-sigv-signing-elements.md) in the _IAM User Guide_.
...
For more information about specifying signed headers, see [Create a signed AWS API request](../../../../services/iam/latest/userguide/reference-sigv-create-signed-request.md) in the _IAM User Guide_.
