...
gateway security group referencing feature](https://docs.aws.amazon.com/vpc/latest/tgw/tgw-vpc-attachments.html#vpc-attachment-security) has been disabled), or if a
...
Type: Array of [StaleSecurityGroup](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_StaleSecurityGroup.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/ec2-2016-11-15/DescribeStaleSecurityGroups)
