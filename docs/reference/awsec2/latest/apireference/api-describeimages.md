...
consistency in the Amazon EC2 API](https://docs.aws.amazon.com/ec2/latest/devguide/eventual-consistency.html) in the _Amazon EC2 Developer_
_Guide_.
...
Type: Array of [Image](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Image.html) objects
