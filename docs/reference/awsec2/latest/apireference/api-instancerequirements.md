...
the [launch instance\
wizard](../../../../services/ec2/latest/userguide/ec2-launch-instance-wizard.md) or with the [RunInstances API](api-runinstances.md), you
can't specify `InstanceRequirements`.

For more information, see [Create mixed instances group using attribute-based instance type selection](../../../../services/autoscaling/ec2/userguide/create-mixed-instances-group-attribute-based-instance-type-selection.md) in
the _Amazon EC2 Auto Scaling User Guide_, and also [Specify attributes for instance type selection for EC2 Fleet or Spot Fleet](../../../../services/ec2/latest/userguide/ec2-fleet-attribute-based-instance-type-selection.md) and [Spot\
