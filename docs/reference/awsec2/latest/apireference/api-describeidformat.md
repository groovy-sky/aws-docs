...
they explicitly override the settings by running the [ModifyIdFormat](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ModifyIdFormat.html) command. Resources
...
Type: Array of [IdFormat](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_IdFormat.html) objects
