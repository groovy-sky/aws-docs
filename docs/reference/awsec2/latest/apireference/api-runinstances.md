...
[Instance\
types](../../../../services/ec2/latest/userguide/instance-types.md).
...
You can create a [launch template](../../../../services/ec2/latest/userguide/ec2-launch-templates.md),
...
information, see [CreateTags](api-createtags.md) and [Tagging your Amazon EC2\
resources](../../../../services/ec2/latest/userguide/using-tags.md).
...
For more information, see [Ensuring idempotency in Amazon EC2 API requests](../../../../services/ec2/latest/devguide/ec2-api-idempotency.md).
...
The CPU options for the instance. For more information, see [Optimize CPU options](../../../../services/ec2/latest/userguide/instance-optimize-cpu.md) in the _Amazon EC2 User Guide_.

Type: [CpuOptionsRequest](api-cpuoptionsrequest.md) object
...
launch, use [ModifyInstanceCreditSpecification](api-modifyinstancecreditspecification.md). For more information, see [Burstable\
...
Type: [CreditSpecificationRequest](api-creditspecificationrequest.md) object
...
see [Enable stop protection for your EC2 instances](../../../../services/ec2/latest/userguide/ec2-stop-protection.md).
...
Type: Array of [ElasticGpuSpecification](api-elasticgpuspecification.md) objects
...
Type: Array of [ElasticInferenceAccelerator](api-elasticinferenceaccelerator.md) objects
...
Type: [EnclaveOptionsRequest](api-enclaveoptionsrequest.md) object
...
Type: [HibernationOptionsRequest](api-hibernationoptionsrequest.md) object
...
Type: [InstanceMarketOptionsRequest](api-instancemarketoptionsrequest.md) object
...
The name of the key pair. For more information, see [Create a key pair for your EC2 instance](../../../../services/ec2/latest/userguide/create-key-pairs.md).
...
Type: Array of [LicenseConfigurationRequest](api-licenseconfigurationrequest.md) objects
...
Type: [InstanceMaintenanceOptionsRequest](api-instancemaintenanceoptionsrequest.md) object
...
The metadata options for the instance. For more information, see [Configure the Instance Metadata Service options](../../../../services/ec2/latest/userguide/configuring-instance-metadata-options.md).

Type: [InstanceMetadataOptionsRequest](api-instancemetadataoptionsrequest.md) object
...
Type: [RunInstancesMonitoringEnabled](api-runinstancesmonitoringenabled.md) object
...
Type: Array of [InstanceNetworkInterfaceSpecification](api-instancenetworkinterfacespecification.md) objects
...
Type: [InstanceNetworkPerformanceOptionsRequest](api-instancenetworkperformanceoptionsrequest.md) object
...
Type: [Placement](api-placement.md) object
...
Type: [PrivateDnsNameOptionsRequest](api-privatednsnameoptionsrequest.md) object
...
Type: Array of [InstanceSecondaryInterfaceSpecificationRequest](api-instancesecondaryinterfacespecificationrequest.md) objects
...
For more information, see [Run commands at launch using instance user data](../../../../services/ec2/latest/userguide/user-data.md).
...
- [AWS Command Line Interface V2](../../../../services/goto/cli2/ec2-2016-11-15/runinstances.md)

- [AWS SDK for .NET V4](../../../goto/dotnetsdkv4/ec2-2016-11-15/runinstances.md)
...
- [AWS SDK for Python](../../../../services/goto/boto3/ec2-2016-11-15/runinstances.md)
