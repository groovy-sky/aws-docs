...
Type: Array of [CapacityManagerCondition](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CapacityManagerCondition.html) objects
...
Type: Array of [CapacityManagerDimension](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CapacityManagerDimension.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/ec2-2016-11-15/GetCapacityManagerMetricDimensions)
