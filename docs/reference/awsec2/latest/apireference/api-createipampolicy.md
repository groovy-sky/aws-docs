...
For more information, see [Define public IPv4 allocation strategy with IPAM policies](https://docs.aws.amazon.com/vpc/latest/ipam/define-public-ipv4-allocation-strategy-with-ipam-policies.html) in the _Amazon VPC IPAM User Guide_.
...
Type: [IpamPolicy](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_IpamPolicy.html) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/ec2-2016-11-15/CreateIpamPolicy)
