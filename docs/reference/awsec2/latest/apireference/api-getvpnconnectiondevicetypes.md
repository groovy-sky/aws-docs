...
device](https://docs.aws.amazon.com/vpn/latest/s2svpn/your-cgw.html) in the _AWS Site-to-Site VPN User Guide_.
...
Type: Array of [VpnConnectionDeviceType](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_VpnConnectionDeviceType.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/ec2-2016-11-15/GetVpnConnectionDeviceTypes)
