...
Disable the IPAM account. For more information, see [Enable integration with AWS Organizations](https://docs.aws.amazon.com/vpc/latest/ipam/enable-integ-ipam.html) in the _Amazon VPC IPAM User Guide_.
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/ec2-2016-11-15/DisableIpamOrganizationAdminAccount)
