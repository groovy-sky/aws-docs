...
EventBridge](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/fleet-monitor.html) in the _Amazon EC2 User Guide_.
...
Type: Array of [HistoryRecord](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_HistoryRecord.html) objects
