...
+  `free-tier-eligible` - A Boolean that indicates whether this instance type can be used under the AWS Free Tier (`true` \| `false`).
...
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/ec2-2016-11-15/DescribeInstanceTypes)
...
+  [AWS SDK for Python (Boto3)](https://docs.aws.amazon.com/goto/boto3/ec2-2016-11-15/DescribeInstanceTypes)
