...
SIP for Amazon EC2 instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/mac-sip-settings.html#mac-sip-configure) in the _Amazon EC2 User Guide_.
...
Type: Array of [MacModificationTask](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_MacModificationTask.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/ec2-2016-11-15/DescribeMacModificationTasks)
