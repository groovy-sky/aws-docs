...
Type: Array of [MovingAddressStatus](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_MovingAddressStatus.html) objects
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/ec2-2016-11-15/DescribeMovingAddresses)
