...
**[Key](#API_UpdateItem_RequestSyntax)**
...
**[TableName](#API_UpdateItem_RequestSyntax)**
...
**[ConditionExpression](#API_UpdateItem_RequestSyntax)**
...
**[ExpressionAttributeNames](#API_UpdateItem_RequestSyntax)**
...
**[ExpressionAttributeValues](#API_UpdateItem_RequestSyntax)**
...
**[ReturnConsumedCapacity](#API_UpdateItem_RequestSyntax)**
...
**[ReturnItemCollectionMetrics](#API_UpdateItem_RequestSyntax)**
...
**[ReturnValues](#API_UpdateItem_RequestSyntax)**
...
**[ReturnValuesOnConditionCheckFailure](#API_UpdateItem_RequestSyntax)**
...
**[UpdateExpression](#API_UpdateItem_RequestSyntax)**
...
**[Attributes](#API_UpdateItem_ResponseSyntax)**
...
**[ConsumedCapacity](#API_UpdateItem_ResponseSyntax)**
...
This example updates the `Thread` table, changing the
`LastPostedBy` attribute, but only if `LastPostedBy`
is currently " `fred@example.com`". All of the item's attributes, as
...
The following example increments the `Replies` attribute in the
`Thread` table whenever someone posts a reply. Because
`ReturnValues` is set to `NONE`, no output appears in
