...
running it multiple times on the same item or attribute does _not_
...
**[Key](#API_DeleteItem_RequestSyntax)**
...
**[TableName](#API_DeleteItem_RequestSyntax)**
...
**[ConditionExpression](#API_DeleteItem_RequestSyntax)**
...
**[ExpressionAttributeNames](#API_DeleteItem_RequestSyntax)**
...
**[ExpressionAttributeValues](#API_DeleteItem_RequestSyntax)**
...
**[ReturnConsumedCapacity](#API_DeleteItem_RequestSyntax)**
...
**[ReturnItemCollectionMetrics](#API_DeleteItem_RequestSyntax)**
...
**[ReturnValues](#API_DeleteItem_RequestSyntax)**
...
**[ReturnValuesOnConditionCheckFailure](#API_DeleteItem_RequestSyntax)**
...
**[Attributes](#API_DeleteItem_ResponseSyntax)**
...
**[ConsumedCapacity](#API_DeleteItem_ResponseSyntax)**
...
The following example deletes an item from the `Thread` table, but
only if that item does not already have an attribute named `Replies`.
Because `ReturnValues` is set to `ALL_OLD`, the response
