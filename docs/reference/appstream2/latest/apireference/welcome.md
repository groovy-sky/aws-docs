...
You can call the WorkSpaces Applications API operations by using an interface VPC endpoint (interface endpoint). For more information, see [Access WorkSpaces Applications API Operations and CLI Commands Through an Interface VPC Endpoint](../../../../services/appstream2/latest/developerguide/access-api-cli-through-interface-vpc-endpoint.md) in the _Amazon WorkSpaces Applications Administration Guide_.
