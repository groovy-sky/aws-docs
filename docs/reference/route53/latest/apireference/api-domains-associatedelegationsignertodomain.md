...
Type: [DnssecSigningAttributes](https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_DnssecSigningAttributes.html) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/route53domains-2014-05-15/AssociateDelegationSignerToDomain)
