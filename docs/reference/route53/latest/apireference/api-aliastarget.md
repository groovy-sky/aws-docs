...
_Alias resource record sets only:_ The value that you specify
...
checks](../../../../services/route53/latest/developerguide/dns-failover.md) are recommended instead for failover scenarios.
...
checks](../../../../services/route53/latest/developerguide/dns-failover.md) that monitor your application's ability to access the service
instead.

For more information and examples, see [Amazon Route 53 Health Checks\
and DNS Failover](../../../../services/route53/latest/developerguide/dns-failover.md) in the _Amazon Route 53 Developer_
_Guide_.
...
_Alias resource records sets only_: The value used depends on where
