...
See [Public and private hosted zones](api-actions-by-function-actions-by-function-public-private-hosted-zones.md).
...
See [Reusable delegation sets](api-actions-by-function-actions-by-function-reusable-delegation-sets.md).
...
See [Resource record sets](api-actions-by-function-actions-by-function-resource-record-sets.md).
...
See [Traffic policies](api-actions-by-function-actions-by-function-traffic-policies.md)
and [Traffic policy instances](api-actions-by-function-actions-by-function-traffic-policy-instances.md).
...
See [Health checks](api-actions-by-function-actions-by-function-health-checks.md).
...
See [Domain registration](api-actions-by-function-api-actions-by-function-domain-registration.md).

**DNS –DNSSEC**

You can protect your domain from DNS spoofing or a man-in-the-middle attack, by configuring
Domain Name System Security Extensions (DNSSEC). See [DNS—DNSSEC](api-actions-by-function-api-actions-by-function-dnssec.md).
...
See [Public DNS query logs](api-actions-by-function-actions-by-function-public-dns-query-logs.md).

You can also configure Route 53 Resolver to log information about the DNS queries that originate in Amazon VPCs.
See [Private DNS query logs](api-actions-by-function-actions-by-function-resolver-query-logs.md).
...
See [Route 53 Resolver endpoints](api-actions-by-function-actions-by-function-resolver-endpoints.md)
and [Route 53 Resolver rules](api-actions-by-function-actions-by-function-resolver-rules.md).
...
See [Tags](api-actions-by-function-api-actions-by-function-tags.md).
...
See [Limits (quotas) for accounts, hosted zones, and reusable delegation sets](api-actions-by-function-api-actions-by-function-limits.md).
