...
[AWS Tools for PowerShell code examples](https://docs.aws.amazon.com/code-library/latest/ug/powershell_5_code_examples.html)
...
For examples specific to Route 53, see [Code examples for Route 53 using AWS SDKs](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/service_code_examples.html).
