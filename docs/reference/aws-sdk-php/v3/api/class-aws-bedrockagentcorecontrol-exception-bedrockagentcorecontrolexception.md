...
## BedrockAgentCoreControlException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Bedrock Agent Core Control Plane Fronting Layer** service.

### Table of Contents  [header link](class-aws-bedrockagentcorecontrol-exception-bedrockagentcorecontrolexception-toc.md)

#### Methods  [header link](class-aws-bedrockagentcorecontrol-exception-bedrockagentcorecontrolexception-toc-methods.md)
...
### Methods  [header link](class-aws-bedrockagentcorecontrol-exception-bedrockagentcorecontrolexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bedrockagentcorecontrol-exception-bedrockagentcorecontrolexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bedrockagentcorecontrol-exception-bedrockagentcorecontrolexception-top.md)
