...
- [Exception](namespace-aws-b2bi-exception.md)

## B2biException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS B2B Data Interchange** service.

### Table of Contents  [header link](class-aws-b2bi-exception-b2biexception-toc.md)

#### Methods  [header link](class-aws-b2bi-exception-b2biexception-toc-methods.md)
...
### Methods  [header link](class-aws-b2bi-exception-b2biexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-b2bi-exception-b2biexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-b2bi-exception-b2biexception-top.md)
