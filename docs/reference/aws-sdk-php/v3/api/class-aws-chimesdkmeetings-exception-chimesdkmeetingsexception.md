...
## ChimeSDKMeetingsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Chime SDK Meetings** service.

### Table of Contents  [header link](class-aws-chimesdkmeetings-exception-chimesdkmeetingsexception-toc.md)

#### Methods  [header link](class-aws-chimesdkmeetings-exception-chimesdkmeetingsexception-toc-methods.md)
...
### Methods  [header link](class-aws-chimesdkmeetings-exception-chimesdkmeetingsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-chimesdkmeetings-exception-chimesdkmeetingsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-chimesdkmeetings-exception-chimesdkmeetingsexception-top.md)
