...
- [Exception](namespace-aws-cloudwatch-exception.md)

## CloudWatchException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon CloudWatch service.

### Table of Contents  [header link](class-aws-cloudwatch-exception-cloudwatchexception-toc.md)

#### Methods  [header link](class-aws-cloudwatch-exception-cloudwatchexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudwatch-exception-cloudwatchexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudwatch-exception-cloudwatchexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudwatch-exception-cloudwatchexception-top.md)
