...
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.workspacesweb.exception.html)

## WorkSpacesWebException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon WorkSpaces Web** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.WorkSpacesWeb.Exception.WorkSpacesWebException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.WorkSpacesWeb.Exception.WorkSpacesWebException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.WorkSpacesWeb.Exception.WorkSpacesWebException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.WorkSpacesWeb.Exception.WorkSpacesWebException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.WorkSpacesWeb.Exception.WorkSpacesWebException.html#top)
