...
- [Exception](namespace-aws-s3outposts-exception.md)
...
### Table of Contents  [header link](class-aws-s3outposts-exception-s3outpostsexception-toc.md)

#### Methods  [header link](class-aws-s3outposts-exception-s3outpostsexception-toc-methods.md)
...
### Methods  [header link](class-aws-s3outposts-exception-s3outpostsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-s3outposts-exception-s3outpostsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-s3outposts-exception-s3outpostsexception-top.md)
