...
### Table of Contents  [header link](class-aws-exception-unresolvedendpointexception-toc.md)

#### Interfaces  [header link](class-aws-exception-unresolvedendpointexception-toc-interfaces.md)
...
#### Methods  [header link](class-aws-exception-unresolvedendpointexception-toc-methods.md)
...
### Methods  [header link](class-aws-exception-unresolvedendpointexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-exception-unresolvedendpointexception-toc-methods.md)
- Methods
  - [appendMonitoringEvent()](class-aws-hasmonitoringeventstrait.md#method_appendMonitoringEvent)
...
[Back To Top](class-aws-exception-unresolvedendpointexception-top.md)
