...
## EC2InstanceConnectException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS EC2 Instance Connect** service.

### Table of Contents  [header link](class-aws-ec2instanceconnect-exception-ec2instanceconnectexception-toc.md)

#### Methods  [header link](class-aws-ec2instanceconnect-exception-ec2instanceconnectexception-toc-methods.md)
...
### Methods  [header link](class-aws-ec2instanceconnect-exception-ec2instanceconnectexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-ec2instanceconnect-exception-ec2instanceconnectexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-ec2instanceconnect-exception-ec2instanceconnectexception-top.md)
