...
## BatchException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Batch** service.

### Table of Contents  [header link](class-aws-batch-exception-batchexception-toc.md)

#### Methods  [header link](class-aws-batch-exception-batchexception-toc-methods.md)
...
### Methods  [header link](class-aws-batch-exception-batchexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-batch-exception-batchexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-batch-exception-batchexception-top.md)
