...
## CloudFormationException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the AWS CloudFormation service.

### Table of Contents  [header link](class-aws-cloudformation-exception-cloudformationexception-toc.md)

#### Methods  [header link](class-aws-cloudformation-exception-cloudformationexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudformation-exception-cloudformationexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudformation-exception-cloudformationexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudformation-exception-cloudformationexception-top.md)
