...
- [Exception](namespace-aws-amplifybackend-exception.md)

## AmplifyBackendException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AmplifyBackend** service.

### Table of Contents  [header link](class-aws-amplifybackend-exception-amplifybackendexception-toc.md)

#### Methods  [header link](class-aws-amplifybackend-exception-amplifybackendexception-toc-methods.md)
...
### Methods  [header link](class-aws-amplifybackend-exception-amplifybackendexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-amplifybackend-exception-amplifybackendexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-amplifybackend-exception-amplifybackendexception-top.md)
