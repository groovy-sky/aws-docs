...
- [Exception](namespace-aws-customerprofiles-exception.md)

## CustomerProfilesException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Connect Customer Profiles** service.

### Table of Contents  [header link](class-aws-customerprofiles-exception-customerprofilesexception-toc.md)

#### Methods  [header link](class-aws-customerprofiles-exception-customerprofilesexception-toc-methods.md)
...
### Methods  [header link](class-aws-customerprofiles-exception-customerprofilesexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-customerprofiles-exception-customerprofilesexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-customerprofiles-exception-customerprofilesexception-top.md)
