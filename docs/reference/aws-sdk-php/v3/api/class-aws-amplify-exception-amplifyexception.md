...
## AmplifyException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Amplify** service.

### Table of Contents  [header link](class-aws-amplify-exception-amplifyexception-toc.md)

#### Methods  [header link](class-aws-amplify-exception-amplifyexception-toc-methods.md)
...
### Methods  [header link](class-aws-amplify-exception-amplifyexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-amplify-exception-amplifyexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-amplify-exception-amplifyexception-top.md)
