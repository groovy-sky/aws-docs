...
## DocDBElasticException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon DocumentDB Elastic Clusters** service.

### Table of Contents  [header link](class-aws-docdbelastic-exception-docdbelasticexception-toc.md)

#### Methods  [header link](class-aws-docdbelastic-exception-docdbelasticexception-toc-methods.md)
...
### Methods  [header link](class-aws-docdbelastic-exception-docdbelasticexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-docdbelastic-exception-docdbelasticexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-docdbelastic-exception-docdbelasticexception-top.md)
