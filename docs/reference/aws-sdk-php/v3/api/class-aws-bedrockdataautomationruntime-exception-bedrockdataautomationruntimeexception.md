...
## BedrockDataAutomationRuntimeException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Runtime for Amazon Bedrock Data Automation** service.

### Table of Contents  [header link](class-aws-bedrockdataautomationruntime-exception-bedrockdataautomationruntimeexception-toc.md)

#### Methods  [header link](class-aws-bedrockdataautomationruntime-exception-bedrockdataautomationruntimeexception-toc-methods.md)
...
### Methods  [header link](class-aws-bedrockdataautomationruntime-exception-bedrockdataautomationruntimeexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bedrockdataautomationruntime-exception-bedrockdataautomationruntimeexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bedrockdataautomationruntime-exception-bedrockdataautomationruntimeexception-top.md)
