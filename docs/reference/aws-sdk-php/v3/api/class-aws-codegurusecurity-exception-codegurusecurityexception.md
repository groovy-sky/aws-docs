...
## CodeGuruSecurityException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon CodeGuru Security** service.

### Table of Contents  [header link](class-aws-codegurusecurity-exception-codegurusecurityexception-toc.md)

#### Methods  [header link](class-aws-codegurusecurity-exception-codegurusecurityexception-toc-methods.md)
...
### Methods  [header link](class-aws-codegurusecurity-exception-codegurusecurityexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codegurusecurity-exception-codegurusecurityexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codegurusecurity-exception-codegurusecurityexception-top.md)
