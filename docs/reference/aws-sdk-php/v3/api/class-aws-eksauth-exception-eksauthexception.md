...
- [Exception](namespace-aws-eksauth-exception.md)

## EKSAuthException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon EKS Auth** service.

### Table of Contents  [header link](class-aws-eksauth-exception-eksauthexception-toc.md)

#### Methods  [header link](class-aws-eksauth-exception-eksauthexception-toc-methods.md)
...
### Methods  [header link](class-aws-eksauth-exception-eksauthexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-eksauth-exception-eksauthexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-eksauth-exception-eksauthexception-top.md)
