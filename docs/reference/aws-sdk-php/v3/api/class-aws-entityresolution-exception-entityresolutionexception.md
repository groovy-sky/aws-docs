...
## EntityResolutionException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS EntityResolution** service.

### Table of Contents  [header link](class-aws-entityresolution-exception-entityresolutionexception-toc.md)

#### Methods  [header link](class-aws-entityresolution-exception-entityresolutionexception-toc-methods.md)
...
### Methods  [header link](class-aws-entityresolution-exception-entityresolutionexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-entityresolution-exception-entityresolutionexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-entityresolution-exception-entityresolutionexception-top.md)
