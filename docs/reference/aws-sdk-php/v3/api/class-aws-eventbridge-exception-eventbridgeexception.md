...
## EventBridgeException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon EventBridge** service.

### Table of Contents  [header link](class-aws-eventbridge-exception-eventbridgeexception-toc.md)

#### Methods  [header link](class-aws-eventbridge-exception-eventbridgeexception-toc-methods.md)
...
### Methods  [header link](class-aws-eventbridge-exception-eventbridgeexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-eventbridge-exception-eventbridgeexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-eventbridge-exception-eventbridgeexception-top.md)
