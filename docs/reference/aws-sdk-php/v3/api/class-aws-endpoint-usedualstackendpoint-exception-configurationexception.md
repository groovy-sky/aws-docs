...
- [Exception](namespace-aws-endpoint-usedualstackendpoint-exception.md)
...
### Table of Contents  [header link](class-aws-endpoint-usedualstackendpoint-exception-configurationexception-toc.md)

#### Interfaces  [header link](class-aws-endpoint-usedualstackendpoint-exception-configurationexception-toc-interfaces.md)
...
#### Methods  [header link](class-aws-endpoint-usedualstackendpoint-exception-configurationexception-toc-methods.md)
...
### Methods  [header link](class-aws-endpoint-usedualstackendpoint-exception-configurationexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-endpoint-usedualstackendpoint-exception-configurationexception-toc-methods.md)
- Methods
  - [appendMonitoringEvent()](class-aws-hasmonitoringeventstrait.md#method_appendMonitoringEvent)
...
[Back To Top](class-aws-endpoint-usedualstackendpoint-exception-configurationexception-top.md)
