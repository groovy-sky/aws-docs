...
## ConnectContactLensException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Connect Contact Lens** service.

### Table of Contents  [header link](class-aws-connectcontactlens-exception-connectcontactlensexception-toc.md)

#### Methods  [header link](class-aws-connectcontactlens-exception-connectcontactlensexception-toc-methods.md)
...
### Methods  [header link](class-aws-connectcontactlens-exception-connectcontactlensexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-connectcontactlens-exception-connectcontactlensexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-connectcontactlens-exception-connectcontactlensexception-top.md)
