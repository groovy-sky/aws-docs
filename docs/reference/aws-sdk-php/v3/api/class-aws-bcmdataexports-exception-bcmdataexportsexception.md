...
## BCMDataExportsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Billing and Cost Management Data Exports** service.

### Table of Contents  [header link](class-aws-bcmdataexports-exception-bcmdataexportsexception-toc.md)

#### Methods  [header link](class-aws-bcmdataexports-exception-bcmdataexportsexception-toc-methods.md)
...
### Methods  [header link](class-aws-bcmdataexports-exception-bcmdataexportsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bcmdataexports-exception-bcmdataexportsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bcmdataexports-exception-bcmdataexportsexception-top.md)
