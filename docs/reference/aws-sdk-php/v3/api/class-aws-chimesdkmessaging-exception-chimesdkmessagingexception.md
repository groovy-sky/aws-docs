...
- [Exception](namespace-aws-chimesdkmessaging-exception.md)

## ChimeSDKMessagingException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Chime SDK Messaging** service.

### Table of Contents  [header link](class-aws-chimesdkmessaging-exception-chimesdkmessagingexception-toc.md)

#### Methods  [header link](class-aws-chimesdkmessaging-exception-chimesdkmessagingexception-toc-methods.md)
...
### Methods  [header link](class-aws-chimesdkmessaging-exception-chimesdkmessagingexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-chimesdkmessaging-exception-chimesdkmessagingexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-chimesdkmessaging-exception-chimesdkmessagingexception-top.md)
