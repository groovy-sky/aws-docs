...
## ApiGatewayManagementApiException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AmazonApiGatewayManagementApi** service.

### Table of Contents  [header link](class-aws-apigatewaymanagementapi-exception-apigatewaymanagementapiexception-toc.md)

#### Methods  [header link](class-aws-apigatewaymanagementapi-exception-apigatewaymanagementapiexception-toc-methods.md)
...
### Methods  [header link](class-aws-apigatewaymanagementapi-exception-apigatewaymanagementapiexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-apigatewaymanagementapi-exception-apigatewaymanagementapiexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-apigatewaymanagementapi-exception-apigatewaymanagementapiexception-top.md)
