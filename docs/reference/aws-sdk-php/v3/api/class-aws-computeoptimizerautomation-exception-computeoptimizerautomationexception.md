...
- [Exception](namespace-aws-computeoptimizerautomation-exception.md)

## ComputeOptimizerAutomationException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Compute Optimizer Automation** service.

### Table of Contents  [header link](class-aws-computeoptimizerautomation-exception-computeoptimizerautomationexception-toc.md)

#### Methods  [header link](class-aws-computeoptimizerautomation-exception-computeoptimizerautomationexception-toc-methods.md)
...
### Methods  [header link](class-aws-computeoptimizerautomation-exception-computeoptimizerautomationexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-computeoptimizerautomation-exception-computeoptimizerautomationexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-computeoptimizerautomation-exception-computeoptimizerautomationexception-top.md)
