...
- [Exception](namespace-aws-emr-exception.md)

## EmrException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon Elastic MapReduce service.

### Table of Contents  [header link](class-aws-emr-exception-emrexception-toc.md)

#### Methods  [header link](class-aws-emr-exception-emrexception-toc-methods.md)
...
### Methods  [header link](class-aws-emr-exception-emrexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-emr-exception-emrexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-emr-exception-emrexception-top.md)
