...
## DetectiveException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Detective** service.

### Table of Contents  [header link](class-aws-detective-exception-detectiveexception-toc.md)

#### Methods  [header link](class-aws-detective-exception-detectiveexception-toc-methods.md)
...
### Methods  [header link](class-aws-detective-exception-detectiveexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-detective-exception-detectiveexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-detective-exception-detectiveexception-top.md)
