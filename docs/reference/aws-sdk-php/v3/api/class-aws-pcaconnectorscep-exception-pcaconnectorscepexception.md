...
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.pcaconnectorscep.exception.html)

## PcaConnectorScepException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Private CA Connector for SCEP** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PcaConnectorScep.Exception.PcaConnectorScepException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PcaConnectorScep.Exception.PcaConnectorScepException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PcaConnectorScep.Exception.PcaConnectorScepException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PcaConnectorScep.Exception.PcaConnectorScepException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PcaConnectorScep.Exception.PcaConnectorScepException.html#top)
