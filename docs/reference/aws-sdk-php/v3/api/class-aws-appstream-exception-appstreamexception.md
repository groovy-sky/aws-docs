...
## AppstreamException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon AppStream** service.

### Table of Contents  [header link](class-aws-appstream-exception-appstreamexception-toc.md)

#### Methods  [header link](class-aws-appstream-exception-appstreamexception-toc-methods.md)
...
### Methods  [header link](class-aws-appstream-exception-appstreamexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-appstream-exception-appstreamexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-appstream-exception-appstreamexception-top.md)
