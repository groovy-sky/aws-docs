...
- [PartnerCentralAccount](namespace-aws-partnercentralaccount.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.partnercentralaccount.exception.html)

## PartnerCentralAccountException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Partner Central Account API** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PartnerCentralAccount.Exception.PartnerCentralAccountException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PartnerCentralAccount.Exception.PartnerCentralAccountException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PartnerCentralAccount.Exception.PartnerCentralAccountException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PartnerCentralAccount.Exception.PartnerCentralAccountException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PartnerCentralAccount.Exception.PartnerCentralAccountException.html#top)
