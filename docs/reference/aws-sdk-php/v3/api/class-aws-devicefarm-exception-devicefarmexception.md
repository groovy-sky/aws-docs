...
## DeviceFarmException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon DeviceFarm service.

### Table of Contents  [header link](class-aws-devicefarm-exception-devicefarmexception-toc.md)

#### Methods  [header link](class-aws-devicefarm-exception-devicefarmexception-toc-methods.md)
...
### Methods  [header link](class-aws-devicefarm-exception-devicefarmexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-devicefarm-exception-devicefarmexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-devicefarm-exception-devicefarmexception-top.md)
