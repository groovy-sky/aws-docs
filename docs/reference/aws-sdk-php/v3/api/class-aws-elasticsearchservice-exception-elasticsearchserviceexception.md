...
## ElasticsearchServiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Elasticsearch Service** service.

### Table of Contents  [header link](class-aws-elasticsearchservice-exception-elasticsearchserviceexception-toc.md)

#### Methods  [header link](class-aws-elasticsearchservice-exception-elasticsearchserviceexception-toc-methods.md)
...
### Methods  [header link](class-aws-elasticsearchservice-exception-elasticsearchserviceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-elasticsearchservice-exception-elasticsearchserviceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-elasticsearchservice-exception-elasticsearchserviceexception-top.md)
