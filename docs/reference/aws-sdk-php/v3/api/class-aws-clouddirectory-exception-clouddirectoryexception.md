...
## CloudDirectoryException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon CloudDirectory** service.

### Table of Contents  [header link](class-aws-clouddirectory-exception-clouddirectoryexception-toc.md)

#### Methods  [header link](class-aws-clouddirectory-exception-clouddirectoryexception-toc-methods.md)
...
### Methods  [header link](class-aws-clouddirectory-exception-clouddirectoryexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-clouddirectory-exception-clouddirectoryexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-clouddirectory-exception-clouddirectoryexception-top.md)
