...
## CloudWatchLogsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon CloudWatch Logs service.

### Table of Contents  [header link](class-aws-cloudwatchlogs-exception-cloudwatchlogsexception-toc.md)

#### Methods  [header link](class-aws-cloudwatchlogs-exception-cloudwatchlogsexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudwatchlogs-exception-cloudwatchlogsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudwatchlogs-exception-cloudwatchlogsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudwatchlogs-exception-cloudwatchlogsexception-top.md)
