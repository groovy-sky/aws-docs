...
## DataExchangeException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Data Exchange** service.

### Table of Contents  [header link](class-aws-dataexchange-exception-dataexchangeexception-toc.md)

#### Methods  [header link](class-aws-dataexchange-exception-dataexchangeexception-toc-methods.md)
...
### Methods  [header link](class-aws-dataexchange-exception-dataexchangeexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-dataexchange-exception-dataexchangeexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-dataexchange-exception-dataexchangeexception-top.md)
