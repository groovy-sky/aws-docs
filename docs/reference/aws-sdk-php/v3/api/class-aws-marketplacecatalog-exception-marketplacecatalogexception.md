...
- [MarketplaceCatalog](namespace-aws-marketplacecatalog.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.marketplacecatalog.exception.html)

## MarketplaceCatalogException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Marketplace Catalog Service** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MarketplaceCatalog.Exception.MarketplaceCatalogException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MarketplaceCatalog.Exception.MarketplaceCatalogException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MarketplaceCatalog.Exception.MarketplaceCatalogException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MarketplaceCatalog.Exception.MarketplaceCatalogException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MarketplaceCatalog.Exception.MarketplaceCatalogException.html#top)
