...
## ChimeException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Chime** service.

### Table of Contents  [header link](class-aws-chime-exception-chimeexception-toc.md)

#### Methods  [header link](class-aws-chime-exception-chimeexception-toc-methods.md)
...
### Methods  [header link](class-aws-chime-exception-chimeexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-chime-exception-chimeexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-chime-exception-chimeexception-top.md)
