...
- [ChimeSDKMediaPipelines](namespace-aws-chimesdkmediapipelines.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.chimesdkmediapipelines.exception.html)

## ChimeSDKMediaPipelinesException     extends [AwsException](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Exception.AwsException.html)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Chime SDK Media Pipelines** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ChimeSDKMediaPipelines.Exception.ChimeSDKMediaPipelinesException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ChimeSDKMediaPipelines.Exception.ChimeSDKMediaPipelinesException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ChimeSDKMediaPipelines.Exception.ChimeSDKMediaPipelinesException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ChimeSDKMediaPipelines.Exception.ChimeSDKMediaPipelinesException.html#toc-methods)
- Methods
  - [\_\_construct()](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Exception.AwsException.html#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ChimeSDKMediaPipelines.Exception.ChimeSDKMediaPipelinesException.html#top)
