...
- [Exception](namespace-aws-applicationcostprofiler-exception.md)

## ApplicationCostProfilerException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Application Cost Profiler** service.

### Table of Contents  [header link](class-aws-applicationcostprofiler-exception-applicationcostprofilerexception-toc.md)

#### Methods  [header link](class-aws-applicationcostprofiler-exception-applicationcostprofilerexception-toc-methods.md)
...
### Methods  [header link](class-aws-applicationcostprofiler-exception-applicationcostprofilerexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-applicationcostprofiler-exception-applicationcostprofilerexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-applicationcostprofiler-exception-applicationcostprofilerexception-top.md)
