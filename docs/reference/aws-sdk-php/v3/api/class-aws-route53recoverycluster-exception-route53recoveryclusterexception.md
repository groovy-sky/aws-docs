...
- [Route53RecoveryCluster](namespace-aws-route53recoverycluster.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.route53recoverycluster.exception.html)

## Route53RecoveryClusterException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Route53 Recovery Cluster** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryCluster.Exception.Route53RecoveryClusterException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryCluster.Exception.Route53RecoveryClusterException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryCluster.Exception.Route53RecoveryClusterException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryCluster.Exception.Route53RecoveryClusterException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryCluster.Exception.Route53RecoveryClusterException.html#top)
