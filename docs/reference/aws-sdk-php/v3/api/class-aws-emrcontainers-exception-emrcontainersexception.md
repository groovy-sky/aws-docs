...
- [Exception](namespace-aws-emrcontainers-exception.md)

## EMRContainersException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon EMR Containers** service.

### Table of Contents  [header link](class-aws-emrcontainers-exception-emrcontainersexception-toc.md)

#### Methods  [header link](class-aws-emrcontainers-exception-emrcontainersexception-toc-methods.md)
...
### Methods  [header link](class-aws-emrcontainers-exception-emrcontainersexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-emrcontainers-exception-emrcontainersexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-emrcontainers-exception-emrcontainersexception-top.md)
