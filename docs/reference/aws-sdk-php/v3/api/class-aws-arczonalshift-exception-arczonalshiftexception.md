...
## ARCZonalShiftException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS ARC - Zonal Shift** service.

### Table of Contents  [header link](class-aws-arczonalshift-exception-arczonalshiftexception-toc.md)

#### Methods  [header link](class-aws-arczonalshift-exception-arczonalshiftexception-toc-methods.md)
...
### Methods  [header link](class-aws-arczonalshift-exception-arczonalshiftexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-arczonalshift-exception-arczonalshiftexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-arczonalshift-exception-arczonalshiftexception-top.md)
