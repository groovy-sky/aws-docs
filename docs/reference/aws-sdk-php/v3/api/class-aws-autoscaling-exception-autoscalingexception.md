...
- [Exception](namespace-aws-autoscaling-exception.md)

## AutoScalingException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error while interacting with the Auto Scaling service.

### Table of Contents  [header link](class-aws-autoscaling-exception-autoscalingexception-toc.md)

#### Methods  [header link](class-aws-autoscaling-exception-autoscalingexception-toc-methods.md)
...
### Methods  [header link](class-aws-autoscaling-exception-autoscalingexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-autoscaling-exception-autoscalingexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-autoscaling-exception-autoscalingexception-top.md)
