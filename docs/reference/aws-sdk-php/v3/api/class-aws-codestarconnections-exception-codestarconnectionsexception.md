...
## CodeStarconnectionsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS CodeStar connections** service.

### Table of Contents  [header link](class-aws-codestarconnections-exception-codestarconnectionsexception-toc.md)

#### Methods  [header link](class-aws-codestarconnections-exception-codestarconnectionsexception-toc-methods.md)
...
### Methods  [header link](class-aws-codestarconnections-exception-codestarconnectionsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codestarconnections-exception-codestarconnectionsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codestarconnections-exception-codestarconnectionsexception-top.md)
