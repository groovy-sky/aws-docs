...
- [KinesisAnalytics](namespace-aws-kinesisanalytics.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.kinesisanalytics.exception.html)

## KinesisAnalyticsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Kinesis Analytics** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.KinesisAnalytics.Exception.KinesisAnalyticsException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.KinesisAnalytics.Exception.KinesisAnalyticsException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.KinesisAnalytics.Exception.KinesisAnalyticsException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.KinesisAnalytics.Exception.KinesisAnalyticsException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.KinesisAnalytics.Exception.KinesisAnalyticsException.html#top)
