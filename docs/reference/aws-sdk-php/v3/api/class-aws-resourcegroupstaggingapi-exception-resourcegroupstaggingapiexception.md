...
- [ResourceGroupsTaggingAPI](namespace-aws-resourcegroupstaggingapi.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.resourcegroupstaggingapi.exception.html)

## ResourceGroupsTaggingAPIException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Resource Groups Tagging API** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceGroupsTaggingAPI.Exception.ResourceGroupsTaggingAPIException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceGroupsTaggingAPI.Exception.ResourceGroupsTaggingAPIException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceGroupsTaggingAPI.Exception.ResourceGroupsTaggingAPIException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceGroupsTaggingAPI.Exception.ResourceGroupsTaggingAPIException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceGroupsTaggingAPI.Exception.ResourceGroupsTaggingAPIException.html#top)
