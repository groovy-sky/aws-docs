...
- [ServiceDiscovery](namespace-aws-servicediscovery.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.servicediscovery.exception.html)

## ServiceDiscoveryException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Route 53 Auto Naming** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ServiceDiscovery.Exception.ServiceDiscoveryException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ServiceDiscovery.Exception.ServiceDiscoveryException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ServiceDiscovery.Exception.ServiceDiscoveryException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ServiceDiscovery.Exception.ServiceDiscoveryException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ServiceDiscovery.Exception.ServiceDiscoveryException.html#top)
