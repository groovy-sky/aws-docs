...
- [Exception](namespace-aws-connectcampaignsv2-exception.md)

## ConnectCampaignsV2Exception     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AmazonConnectCampaignServiceV2** service.

### Table of Contents  [header link](class-aws-connectcampaignsv2-exception-connectcampaignsv2exception-toc.md)

#### Methods  [header link](class-aws-connectcampaignsv2-exception-connectcampaignsv2exception-toc-methods.md)
...
### Methods  [header link](class-aws-connectcampaignsv2-exception-connectcampaignsv2exception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-connectcampaignsv2-exception-connectcampaignsv2exception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-connectcampaignsv2-exception-connectcampaignsv2exception-top.md)
