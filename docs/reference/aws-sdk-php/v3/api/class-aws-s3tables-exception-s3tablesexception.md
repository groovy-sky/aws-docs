...
- [Exception](namespace-aws-s3tables-exception.md)
...
### Table of Contents  [header link](class-aws-s3tables-exception-s3tablesexception-toc.md)

#### Methods  [header link](class-aws-s3tables-exception-s3tablesexception-toc-methods.md)
...
### Methods  [header link](class-aws-s3tables-exception-s3tablesexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-s3tables-exception-s3tablesexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-s3tables-exception-s3tablesexception-top.md)
