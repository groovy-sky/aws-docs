...
## BedrockAgentRuntimeException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Agents for Amazon Bedrock Runtime** service.

### Table of Contents  [header link](class-aws-bedrockagentruntime-exception-bedrockagentruntimeexception-toc.md)

#### Methods  [header link](class-aws-bedrockagentruntime-exception-bedrockagentruntimeexception-toc-methods.md)
...
### Methods  [header link](class-aws-bedrockagentruntime-exception-bedrockagentruntimeexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bedrockagentruntime-exception-bedrockagentruntimeexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bedrockagentruntime-exception-bedrockagentruntimeexception-top.md)
