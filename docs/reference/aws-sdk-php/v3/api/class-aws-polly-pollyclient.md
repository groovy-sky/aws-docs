...
## PollyClient     extends [AwsClient](class-aws-awsclient.md)   in package    - [Aws](package-aws.md)
...
`
    public
                    createSynthesizeSpeechPreSignedUrl(array<string|int, mixed> $args) : string`
...
parameters array for `SynthesizeSpeech`
