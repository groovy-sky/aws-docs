...
### Table of Contents  [header link](class-aws-crypto-materialsproviderv3-toc.md)

#### Interfaces  [header link](class-aws-crypto-materialsproviderv3-toc-interfaces.md)

[MaterialsProviderInterfaceV3](class-aws-crypto-materialsproviderinterfacev3.md)

#### Methods  [header link](class-aws-crypto-materialsproviderv3-toc-methods.md)

[decryptCek()](class-aws-crypto-materialsproviderv3-method-decryptcek.md)
: string Takes an encrypted content encryption key (CEK) and material description
for use decrypting the key according to the Provider's specifications.[generateCek()](class-aws-crypto-materialsproviderv3-method-generatecek.md)
: array<string\|int, mixed> [generateIv()](class-aws-crypto-materialsproviderv3-method-generateiv.md)
: string [getWrapAlgorithmName()](class-aws-crypto-materialsproviderv3-method-getwrapalgorithmname.md)
...
### Methods  [header link](class-aws-crypto-materialsproviderv3-methods.md)

#### decryptCek()  [header link](class-aws-crypto-materialsproviderv3-method-decryptcek.md)
...
#### generateCek()  [header link](class-aws-crypto-materialsproviderv3-method-generatecek.md)
...
#### getWrapAlgorithmName()  [header link](class-aws-crypto-materialsproviderv3-method-getwrapalgorithmname.md)
...
- Table Of Contents
  - [Methods](class-aws-crypto-materialsproviderv3-toc-methods.md)
- Methods
  - [decryptCek()](class-aws-crypto-materialsproviderv3-method-decryptcek.md)
  - [generateCek()](class-aws-crypto-materialsproviderv3-method-generatecek.md)
  - [generateIv()](class-aws-crypto-materialsproviderv3-method-generateiv.md)
  - [getWrapAlgorithmName()](class-aws-crypto-materialsproviderv3-method-getwrapalgorithmname.md)
  - [isSupportedKeySize()](class-aws-crypto-materialsproviderv3-method-issupportedkeysize.md)

[Back To Top](class-aws-crypto-materialsproviderv3-top.md)
