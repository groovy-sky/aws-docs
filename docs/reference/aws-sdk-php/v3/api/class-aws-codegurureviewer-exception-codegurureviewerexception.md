...
- [Exception](namespace-aws-codegurureviewer-exception.md)

## CodeGuruReviewerException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon CodeGuru Reviewer** service.

### Table of Contents  [header link](class-aws-codegurureviewer-exception-codegurureviewerexception-toc.md)

#### Methods  [header link](class-aws-codegurureviewer-exception-codegurureviewerexception-toc-methods.md)
...
### Methods  [header link](class-aws-codegurureviewer-exception-codegurureviewerexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codegurureviewer-exception-codegurureviewerexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codegurureviewer-exception-codegurureviewerexception-top.md)
