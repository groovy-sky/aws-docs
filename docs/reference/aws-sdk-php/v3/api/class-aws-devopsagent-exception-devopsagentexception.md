...
- [Exception](namespace-aws-devopsagent-exception.md)

## DevOpsAgentException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS DevOps Agent Service** service.

### Table of Contents  [header link](class-aws-devopsagent-exception-devopsagentexception-toc.md)

#### Methods  [header link](class-aws-devopsagent-exception-devopsagentexception-toc-methods.md)
...
### Methods  [header link](class-aws-devopsagent-exception-devopsagentexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-devopsagent-exception-devopsagentexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-devopsagent-exception-devopsagentexception-top.md)
