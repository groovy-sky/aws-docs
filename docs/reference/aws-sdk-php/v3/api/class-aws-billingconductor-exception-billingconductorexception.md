...
- [Exception](namespace-aws-billingconductor-exception.md)

## BillingConductorException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWSBillingConductor** service.

### Table of Contents  [header link](class-aws-billingconductor-exception-billingconductorexception-toc.md)

#### Methods  [header link](class-aws-billingconductor-exception-billingconductorexception-toc-methods.md)
...
### Methods  [header link](class-aws-billingconductor-exception-billingconductorexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-billingconductor-exception-billingconductorexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-billingconductor-exception-billingconductorexception-top.md)
