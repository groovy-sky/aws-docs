...
- [Exception](namespace-aws-s3vectors-exception.md)
...
### Table of Contents  [header link](class-aws-s3vectors-exception-s3vectorsexception-toc.md)

#### Methods  [header link](class-aws-s3vectors-exception-s3vectorsexception-toc-methods.md)
...
### Methods  [header link](class-aws-s3vectors-exception-s3vectorsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-s3vectors-exception-s3vectorsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-s3vectors-exception-s3vectorsexception-top.md)
