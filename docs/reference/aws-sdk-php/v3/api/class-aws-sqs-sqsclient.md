...
## SqsClient     extends [AwsClient](class-aws-awsclient.md)   in package    - [Aws](package-aws.md)
...
`
    public
                    getQueueArn(string $queueUrl) : string`
...
The queue URL to perform the action on.
