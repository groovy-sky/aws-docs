...
- [Exception](namespace-aws-bedrockdataautomation-exception.md)

## BedrockDataAutomationException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Data Automation for Amazon Bedrock** service.

### Table of Contents  [header link](class-aws-bedrockdataautomation-exception-bedrockdataautomationexception-toc.md)

#### Methods  [header link](class-aws-bedrockdataautomation-exception-bedrockdataautomationexception-toc-methods.md)
...
### Methods  [header link](class-aws-bedrockdataautomation-exception-bedrockdataautomationexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bedrockdataautomation-exception-bedrockdataautomationexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bedrockdataautomation-exception-bedrockdataautomationexception-top.md)
