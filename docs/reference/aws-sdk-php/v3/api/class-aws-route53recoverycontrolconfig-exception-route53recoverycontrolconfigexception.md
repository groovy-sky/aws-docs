...
- [Route53RecoveryControlConfig](namespace-aws-route53recoverycontrolconfig.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.route53recoverycontrolconfig.exception.html)

## Route53RecoveryControlConfigException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Route53 Recovery Control Config** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryControlConfig.Exception.Route53RecoveryControlConfigException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryControlConfig.Exception.Route53RecoveryControlConfigException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryControlConfig.Exception.Route53RecoveryControlConfigException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryControlConfig.Exception.Route53RecoveryControlConfigException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryControlConfig.Exception.Route53RecoveryControlConfigException.html#top)
