...
## DirectoryServiceDataException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Directory Service Data** service.

### Table of Contents  [header link](class-aws-directoryservicedata-exception-directoryservicedataexception-toc.md)

#### Methods  [header link](class-aws-directoryservicedata-exception-directoryservicedataexception-toc-methods.md)
...
### Methods  [header link](class-aws-directoryservicedata-exception-directoryservicedataexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-directoryservicedata-exception-directoryservicedataexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-directoryservicedata-exception-directoryservicedataexception-top.md)
