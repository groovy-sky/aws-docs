...
- [Exception](namespace-aws-appfabric-exception.md)

## AppFabricException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AppFabric** service.

### Table of Contents  [header link](class-aws-appfabric-exception-appfabricexception-toc.md)

#### Methods  [header link](class-aws-appfabric-exception-appfabricexception-toc-methods.md)
...
### Methods  [header link](class-aws-appfabric-exception-appfabricexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-appfabric-exception-appfabricexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-appfabric-exception-appfabricexception-top.md)
