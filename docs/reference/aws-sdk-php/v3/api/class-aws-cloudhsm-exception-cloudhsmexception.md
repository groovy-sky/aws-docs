...
## CloudHsmException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

AWS CloudHSM exception.

### Table of Contents  [header link](class-aws-cloudhsm-exception-cloudhsmexception-toc.md)

#### Methods  [header link](class-aws-cloudhsm-exception-cloudhsmexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudhsm-exception-cloudhsmexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudhsm-exception-cloudhsmexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudhsm-exception-cloudhsmexception-top.md)
