...
## BedrockAgentException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Agents for Amazon Bedrock** service.

### Table of Contents  [header link](class-aws-bedrockagent-exception-bedrockagentexception-toc.md)

#### Methods  [header link](class-aws-bedrockagent-exception-bedrockagentexception-toc-methods.md)
...
### Methods  [header link](class-aws-bedrockagent-exception-bedrockagentexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bedrockagent-exception-bedrockagentexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bedrockagent-exception-bedrockagentexception-top.md)
