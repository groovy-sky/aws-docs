...
- [Exception](namespace-aws-braket-exception.md)

## BraketException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Braket** service.

### Table of Contents  [header link](class-aws-braket-exception-braketexception-toc.md)

#### Methods  [header link](class-aws-braket-exception-braketexception-toc-methods.md)
...
### Methods  [header link](class-aws-braket-exception-braketexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-braket-exception-braketexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-braket-exception-braketexception-top.md)
