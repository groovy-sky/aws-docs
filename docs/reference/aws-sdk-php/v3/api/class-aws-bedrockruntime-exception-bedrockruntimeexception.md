...
## BedrockRuntimeException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Bedrock Runtime** service.

### Table of Contents  [header link](class-aws-bedrockruntime-exception-bedrockruntimeexception-toc.md)

#### Methods  [header link](class-aws-bedrockruntime-exception-bedrockruntimeexception-toc-methods.md)
...
### Methods  [header link](class-aws-bedrockruntime-exception-bedrockruntimeexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bedrockruntime-exception-bedrockruntimeexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bedrockruntime-exception-bedrockruntimeexception-top.md)
