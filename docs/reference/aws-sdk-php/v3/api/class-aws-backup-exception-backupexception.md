...
## BackupException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Backup** service.

### Table of Contents  [header link](class-aws-backup-exception-backupexception-toc.md)

#### Methods  [header link](class-aws-backup-exception-backupexception-toc-methods.md)
...
### Methods  [header link](class-aws-backup-exception-backupexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-backup-exception-backupexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-backup-exception-backupexception-top.md)
