...
- [Exception](namespace-aws-appmesh-exception.md)

## AppMeshException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS App Mesh** service.

### Table of Contents  [header link](class-aws-appmesh-exception-appmeshexception-toc.md)

#### Methods  [header link](class-aws-appmesh-exception-appmeshexception-toc-methods.md)
...
### Methods  [header link](class-aws-appmesh-exception-appmeshexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-appmesh-exception-appmeshexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-appmesh-exception-appmeshexception-top.md)
