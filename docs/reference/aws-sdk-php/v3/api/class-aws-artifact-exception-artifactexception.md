...
## ArtifactException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Artifact** service.

### Table of Contents  [header link](class-aws-artifact-exception-artifactexception-toc.md)

#### Methods  [header link](class-aws-artifact-exception-artifactexception-toc-methods.md)
...
### Methods  [header link](class-aws-artifact-exception-artifactexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-artifact-exception-artifactexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-artifact-exception-artifactexception-top.md)
