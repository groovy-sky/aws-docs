...
## CloudTrailDataException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS CloudTrail Data Service** service.

### Table of Contents  [header link](class-aws-cloudtraildata-exception-cloudtraildataexception-toc.md)

#### Methods  [header link](class-aws-cloudtraildata-exception-cloudtraildataexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudtraildata-exception-cloudtraildataexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudtraildata-exception-cloudtraildataexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudtraildata-exception-cloudtraildataexception-top.md)
