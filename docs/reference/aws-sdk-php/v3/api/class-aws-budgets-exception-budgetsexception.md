...
- [Exception](namespace-aws-budgets-exception.md)

## BudgetsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Budgets** service.

### Table of Contents  [header link](class-aws-budgets-exception-budgetsexception-toc.md)

#### Methods  [header link](class-aws-budgets-exception-budgetsexception-toc-methods.md)
...
### Methods  [header link](class-aws-budgets-exception-budgetsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-budgets-exception-budgetsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-budgets-exception-budgetsexception-top.md)
