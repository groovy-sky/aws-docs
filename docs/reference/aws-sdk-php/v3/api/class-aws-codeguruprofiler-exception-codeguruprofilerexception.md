...
- [Exception](namespace-aws-codeguruprofiler-exception.md)

## CodeGuruProfilerException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon CodeGuru Profiler** service.

### Table of Contents  [header link](class-aws-codeguruprofiler-exception-codeguruprofilerexception-toc.md)

#### Methods  [header link](class-aws-codeguruprofiler-exception-codeguruprofilerexception-toc-methods.md)
...
### Methods  [header link](class-aws-codeguruprofiler-exception-codeguruprofilerexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codeguruprofiler-exception-codeguruprofilerexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codeguruprofiler-exception-codeguruprofilerexception-top.md)
