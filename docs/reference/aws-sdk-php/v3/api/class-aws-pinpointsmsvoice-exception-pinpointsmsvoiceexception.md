...
- [PinpointSMSVoice](namespace-aws-pinpointsmsvoice.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.pinpointsmsvoice.exception.html)

## PinpointSMSVoiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Pinpoint SMS and Voice Service** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PinpointSMSVoice.Exception.PinpointSMSVoiceException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PinpointSMSVoice.Exception.PinpointSMSVoiceException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PinpointSMSVoice.Exception.PinpointSMSVoiceException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PinpointSMSVoice.Exception.PinpointSMSVoiceException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.PinpointSMSVoice.Exception.PinpointSMSVoiceException.html#top)
