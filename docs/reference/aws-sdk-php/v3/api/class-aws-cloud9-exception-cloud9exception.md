...
## Cloud9Exception     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Cloud9** service.

### Table of Contents  [header link](class-aws-cloud9-exception-cloud9exception-toc.md)

#### Methods  [header link](class-aws-cloud9-exception-cloud9exception-toc-methods.md)
...
### Methods  [header link](class-aws-cloud9-exception-cloud9exception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloud9-exception-cloud9exception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloud9-exception-cloud9exception-top.md)
