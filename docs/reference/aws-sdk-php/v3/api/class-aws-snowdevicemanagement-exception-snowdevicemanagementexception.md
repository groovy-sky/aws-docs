...
- [SnowDeviceManagement](namespace-aws-snowdevicemanagement.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.snowdevicemanagement.exception.html)

## SnowDeviceManagementException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Snow Device Management** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.SnowDeviceManagement.Exception.SnowDeviceManagementException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.SnowDeviceManagement.Exception.SnowDeviceManagementException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.SnowDeviceManagement.Exception.SnowDeviceManagementException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.SnowDeviceManagement.Exception.SnowDeviceManagementException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.SnowDeviceManagement.Exception.SnowDeviceManagementException.html#top)
