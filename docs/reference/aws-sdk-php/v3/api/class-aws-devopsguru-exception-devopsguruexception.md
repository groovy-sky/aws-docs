...
## DevOpsGuruException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon DevOps Guru** service.

### Table of Contents  [header link](class-aws-devopsguru-exception-devopsguruexception-toc.md)

#### Methods  [header link](class-aws-devopsguru-exception-devopsguruexception-toc-methods.md)
...
### Methods  [header link](class-aws-devopsguru-exception-devopsguruexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-devopsguru-exception-devopsguruexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-devopsguru-exception-devopsguruexception-top.md)
