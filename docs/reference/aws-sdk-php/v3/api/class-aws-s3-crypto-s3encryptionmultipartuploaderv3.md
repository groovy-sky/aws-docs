...
## S3EncryptionMultipartUploaderV3     extends [MultipartUploader](class-aws-s3-multipartuploader.md)   in package    - [Aws](package-aws.md)       Uses  [CipherBuilderTrait](class-aws-crypto-cipher-cipherbuildertrait.md), [CryptoParamsTraitV3](class-aws-s3-crypto-cryptoparamstraitv3.md), [EncryptionTraitV3](class-aws-crypto-encryptiontraitv3.md), [UserAgentTrait](class-aws-s3-crypto-useragenttrait.md)

Encapsulates the execution of a multipart upload of an encrypted object to S3.

### Table of Contents  [header link](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-toc.md)

#### Constants  [header link](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-toc-constants.md)

[CRYPTO\_VERSION](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-constant-crypto-version.md)
= '3.0' [PART\_MAX\_NUM](class-aws-s3-multipartuploader-constant-part-max-num.md)
...
#### Methods  [header link](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-toc-methods.md)

[\_\_construct()](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-method-construct.md)
...
service for the specified upload's information.[isSupportedCipher()](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-method-issupportedcipher.md)
: bool Returns if the passed cipher name is supported for encryption by the SDK.

### Constants  [header link](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-constants.md)

#### CRYPTO\_VERSION  [header link](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-constant-crypto-version.md)
...
### Methods  [header link](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-methods.md)

#### \_\_construct()  [header link](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-method-construct.md)
...
#### isSupportedCipher()  [header link](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-method-issupportedcipher.md)
...
- Table Of Contents
  - [Constants](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-toc-constants.md)
  - [Methods](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-toc-methods.md)
- Constants
  - [CRYPTO\_VERSION](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-constant-crypto-version.md)
...
- Methods
  ...
  - [isSupportedCipher()](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-method-issupportedcipher.md)

[Back To Top](class-aws-s3-crypto-s3encryptionmultipartuploaderv3-top.md)
