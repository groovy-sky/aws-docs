...
- [Exception](namespace-aws-account-exception.md)

## AccountException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Account** service.

### Table of Contents  [header link](class-aws-account-exception-accountexception-toc.md)

#### Methods  [header link](class-aws-account-exception-accountexception-toc-methods.md)
...
### Methods  [header link](class-aws-account-exception-accountexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-account-exception-accountexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-account-exception-accountexception-top.md)
