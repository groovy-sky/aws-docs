...
- [MigrationHubOrchestrator](namespace-aws-migrationhuborchestrator.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.migrationhuborchestrator.exception.html)

## MigrationHubOrchestratorException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Migration Hub Orchestrator** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MigrationHubOrchestrator.Exception.MigrationHubOrchestratorException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MigrationHubOrchestrator.Exception.MigrationHubOrchestratorException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MigrationHubOrchestrator.Exception.MigrationHubOrchestratorException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MigrationHubOrchestrator.Exception.MigrationHubOrchestratorException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.MigrationHubOrchestrator.Exception.MigrationHubOrchestratorException.html#top)
