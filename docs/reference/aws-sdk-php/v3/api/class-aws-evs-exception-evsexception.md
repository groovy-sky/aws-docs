...
- [Exception](namespace-aws-evs-exception.md)

## EvsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Elastic VMware Service** service.

### Table of Contents  [header link](class-aws-evs-exception-evsexception-toc.md)

#### Methods  [header link](class-aws-evs-exception-evsexception-toc-methods.md)
...
### Methods  [header link](class-aws-evs-exception-evsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-evs-exception-evsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-evs-exception-evsexception-top.md)
