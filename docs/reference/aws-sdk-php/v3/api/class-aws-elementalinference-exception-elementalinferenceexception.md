...
## ElementalInferenceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Elemental Inference** service.

### Table of Contents  [header link](class-aws-elementalinference-exception-elementalinferenceexception-toc.md)

#### Methods  [header link](class-aws-elementalinference-exception-elementalinferenceexception-toc-methods.md)
...
### Methods  [header link](class-aws-elementalinference-exception-elementalinferenceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-elementalinference-exception-elementalinferenceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-elementalinference-exception-elementalinferenceexception-top.md)
