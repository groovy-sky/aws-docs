...
## AppIntegrationsServiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon AppIntegrations Service** service.

### Table of Contents  [header link](class-aws-appintegrationsservice-exception-appintegrationsserviceexception-toc.md)

#### Methods  [header link](class-aws-appintegrationsservice-exception-appintegrationsserviceexception-toc-methods.md)
...
### Methods  [header link](class-aws-appintegrationsservice-exception-appintegrationsserviceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-appintegrationsservice-exception-appintegrationsserviceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-appintegrationsservice-exception-appintegrationsserviceexception-top.md)
