...
- [BCMRecommendedActions](namespace-aws-bcmrecommendedactions.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.bcmrecommendedactions.exception.html)

## BCMRecommendedActionsException     extends [AwsException](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Exception.AwsException.html)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Billing and Cost Management Recommended Actions** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.BCMRecommendedActions.Exception.BCMRecommendedActionsException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.BCMRecommendedActions.Exception.BCMRecommendedActionsException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.BCMRecommendedActions.Exception.BCMRecommendedActionsException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.BCMRecommendedActions.Exception.BCMRecommendedActionsException.html#toc-methods)
- Methods
  - [\_\_construct()](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Exception.AwsException.html#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.BCMRecommendedActions.Exception.BCMRecommendedActionsException.html#top)
