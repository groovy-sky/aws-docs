...
- [Exception](namespace-aws-bcmrecommendedactions-exception.md)

## BCMRecommendedActionsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Billing and Cost Management Recommended Actions** service.

### Table of Contents  [header link](class-aws-bcmrecommendedactions-exception-bcmrecommendedactionsexception-toc.md)

#### Methods  [header link](class-aws-bcmrecommendedactions-exception-bcmrecommendedactionsexception-toc-methods.md)
...
### Methods  [header link](class-aws-bcmrecommendedactions-exception-bcmrecommendedactionsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bcmrecommendedactions-exception-bcmrecommendedactionsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bcmrecommendedactions-exception-bcmrecommendedactionsexception-top.md)
