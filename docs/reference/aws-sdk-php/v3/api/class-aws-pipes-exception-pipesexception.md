...
- [Exception](namespace-aws-pipes-exception.md)
...
### Table of Contents  [header link](class-aws-pipes-exception-pipesexception-toc.md)

#### Methods  [header link](class-aws-pipes-exception-pipesexception-toc-methods.md)
...
### Methods  [header link](class-aws-pipes-exception-pipesexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-pipes-exception-pipesexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-pipes-exception-pipesexception-top.md)
