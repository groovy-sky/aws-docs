...
## ElasticBeanstalkException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the AWS Elastic Beanstalk service.

### Table of Contents  [header link](class-aws-elasticbeanstalk-exception-elasticbeanstalkexception-toc.md)

#### Methods  [header link](class-aws-elasticbeanstalk-exception-elasticbeanstalkexception-toc-methods.md)
...
### Methods  [header link](class-aws-elasticbeanstalk-exception-elasticbeanstalkexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-elasticbeanstalk-exception-elasticbeanstalkexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-elasticbeanstalk-exception-elasticbeanstalkexception-top.md)
