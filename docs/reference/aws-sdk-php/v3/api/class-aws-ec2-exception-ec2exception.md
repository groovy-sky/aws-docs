...
- [Exception](namespace-aws-ec2-exception.md)

## Ec2Exception     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon Elastic Compute Cloud service.

### Table of Contents  [header link](class-aws-ec2-exception-ec2exception-toc.md)

#### Methods  [header link](class-aws-ec2-exception-ec2exception-toc-methods.md)
...
### Methods  [header link](class-aws-ec2-exception-ec2exception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-ec2-exception-ec2exception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-ec2-exception-ec2exception-top.md)
