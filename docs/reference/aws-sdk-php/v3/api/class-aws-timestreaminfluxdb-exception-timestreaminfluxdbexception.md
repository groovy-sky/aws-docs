...
- [TimestreamInfluxDB](namespace-aws-timestreaminfluxdb.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.timestreaminfluxdb.exception.html)

## TimestreamInfluxDBException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Timestream InfluxDB** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.TimestreamInfluxDB.Exception.TimestreamInfluxDBException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.TimestreamInfluxDB.Exception.TimestreamInfluxDBException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.TimestreamInfluxDB.Exception.TimestreamInfluxDBException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.TimestreamInfluxDB.Exception.TimestreamInfluxDBException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.TimestreamInfluxDB.Exception.TimestreamInfluxDBException.html#top)
