...
## AugmentedAIRuntimeException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Augmented AI Runtime** service.

### Table of Contents  [header link](class-aws-augmentedairuntime-exception-augmentedairuntimeexception-toc.md)

#### Methods  [header link](class-aws-augmentedairuntime-exception-augmentedairuntimeexception-toc-methods.md)
...
### Methods  [header link](class-aws-augmentedairuntime-exception-augmentedairuntimeexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-augmentedairuntime-exception-augmentedairuntimeexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-augmentedairuntime-exception-augmentedairuntimeexception-top.md)
