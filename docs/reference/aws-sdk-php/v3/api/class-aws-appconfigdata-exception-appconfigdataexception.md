...
## AppConfigDataException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS AppConfig Data** service.

### Table of Contents  [header link](class-aws-appconfigdata-exception-appconfigdataexception-toc.md)

#### Methods  [header link](class-aws-appconfigdata-exception-appconfigdataexception-toc-methods.md)
...
### Methods  [header link](class-aws-appconfigdata-exception-appconfigdataexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-appconfigdata-exception-appconfigdataexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-appconfigdata-exception-appconfigdataexception-top.md)
