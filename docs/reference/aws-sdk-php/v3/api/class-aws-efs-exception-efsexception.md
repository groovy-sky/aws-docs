...
## EfsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Amazon EFS exception.

### Table of Contents  [header link](class-aws-efs-exception-efsexception-toc.md)

#### Methods  [header link](class-aws-efs-exception-efsexception-toc-methods.md)
...
### Methods  [header link](class-aws-efs-exception-efsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-efs-exception-efsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-efs-exception-efsexception-top.md)
