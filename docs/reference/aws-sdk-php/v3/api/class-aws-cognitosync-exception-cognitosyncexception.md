...
## CognitoSyncException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon Cognito Sync service.

### Table of Contents  [header link](class-aws-cognitosync-exception-cognitosyncexception-toc.md)

#### Methods  [header link](class-aws-cognitosync-exception-cognitosyncexception-toc-methods.md)
...
### Methods  [header link](class-aws-cognitosync-exception-cognitosyncexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cognitosync-exception-cognitosyncexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cognitosync-exception-cognitosyncexception-top.md)
