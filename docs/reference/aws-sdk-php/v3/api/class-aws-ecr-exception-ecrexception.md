...
- [Exception](namespace-aws-ecr-exception.md)

## EcrException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon EC2 Container Registry** service.

### Table of Contents  [header link](class-aws-ecr-exception-ecrexception-toc.md)

#### Methods  [header link](class-aws-ecr-exception-ecrexception-toc-methods.md)
...
### Methods  [header link](class-aws-ecr-exception-ecrexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-ecr-exception-ecrexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-ecr-exception-ecrexception-top.md)
