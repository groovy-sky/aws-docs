...
## ComputeOptimizerException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Compute Optimizer** service.

### Table of Contents  [header link](class-aws-computeoptimizer-exception-computeoptimizerexception-toc.md)

#### Methods  [header link](class-aws-computeoptimizer-exception-computeoptimizerexception-toc-methods.md)
...
### Methods  [header link](class-aws-computeoptimizer-exception-computeoptimizerexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-computeoptimizer-exception-computeoptimizerexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-computeoptimizer-exception-computeoptimizerexception-top.md)
