...
- [ResourceExplorer2](namespace-aws-resourceexplorer2.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.resourceexplorer2.exception.html)

## ResourceExplorer2Exception     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Resource Explorer** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceExplorer2.Exception.ResourceExplorer2Exception.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceExplorer2.Exception.ResourceExplorer2Exception.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceExplorer2.Exception.ResourceExplorer2Exception.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceExplorer2.Exception.ResourceExplorer2Exception.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.ResourceExplorer2.Exception.ResourceExplorer2Exception.html#top)
