...
## BCMDashboardsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Billing and Cost Management Dashboards** service.

### Table of Contents  [header link](class-aws-bcmdashboards-exception-bcmdashboardsexception-toc.md)

#### Methods  [header link](class-aws-bcmdashboards-exception-bcmdashboardsexception-toc-methods.md)
...
### Methods  [header link](class-aws-bcmdashboards-exception-bcmdashboardsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bcmdashboards-exception-bcmdashboardsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bcmdashboards-exception-bcmdashboardsexception-top.md)
