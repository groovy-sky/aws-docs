...
- [Exception](namespace-aws-billing-exception.md)

## BillingException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Billing** service.

### Table of Contents  [header link](class-aws-billing-exception-billingexception-toc.md)

#### Methods  [header link](class-aws-billing-exception-billingexception-toc-methods.md)
...
### Methods  [header link](class-aws-billing-exception-billingexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-billing-exception-billingexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-billing-exception-billingexception-top.md)
