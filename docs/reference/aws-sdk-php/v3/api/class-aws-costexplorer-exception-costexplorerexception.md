...
- [Exception](namespace-aws-costexplorer-exception.md)

## CostExplorerException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Cost Explorer Service** service.

### Table of Contents  [header link](class-aws-costexplorer-exception-costexplorerexception-toc.md)

#### Methods  [header link](class-aws-costexplorer-exception-costexplorerexception-toc-methods.md)
...
### Methods  [header link](class-aws-costexplorer-exception-costexplorerexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-costexplorer-exception-costexplorerexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-costexplorer-exception-costexplorerexception-top.md)
