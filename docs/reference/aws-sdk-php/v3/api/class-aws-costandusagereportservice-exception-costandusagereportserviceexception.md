...
- [Exception](namespace-aws-costandusagereportservice-exception.md)

## CostandUsageReportServiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Cost and Usage Report Service** service.

### Table of Contents  [header link](class-aws-costandusagereportservice-exception-costandusagereportserviceexception-toc.md)

#### Methods  [header link](class-aws-costandusagereportservice-exception-costandusagereportserviceexception-toc-methods.md)
...
### Methods  [header link](class-aws-costandusagereportservice-exception-costandusagereportserviceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-costandusagereportservice-exception-costandusagereportserviceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-costandusagereportservice-exception-costandusagereportserviceexception-top.md)
