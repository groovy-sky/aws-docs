...
## CognitoIdentityProviderException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Cognito Identity Provider** service.

### Table of Contents  [header link](class-aws-cognitoidentityprovider-exception-cognitoidentityproviderexception-toc.md)

#### Methods  [header link](class-aws-cognitoidentityprovider-exception-cognitoidentityproviderexception-toc-methods.md)
...
### Methods  [header link](class-aws-cognitoidentityprovider-exception-cognitoidentityproviderexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cognitoidentityprovider-exception-cognitoidentityproviderexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cognitoidentityprovider-exception-cognitoidentityproviderexception-top.md)
