...
## ControlCatalogException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Control Catalog** service.

### Table of Contents  [header link](class-aws-controlcatalog-exception-controlcatalogexception-toc.md)

#### Methods  [header link](class-aws-controlcatalog-exception-controlcatalogexception-toc-methods.md)
...
### Methods  [header link](class-aws-controlcatalog-exception-controlcatalogexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-controlcatalog-exception-controlcatalogexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-controlcatalog-exception-controlcatalogexception-top.md)
