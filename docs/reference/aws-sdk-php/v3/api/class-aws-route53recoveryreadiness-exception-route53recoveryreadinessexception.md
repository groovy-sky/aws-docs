...
- [Route53RecoveryReadiness](namespace-aws-route53recoveryreadiness.md)
- [Exception](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.route53recoveryreadiness.exception.html)

## Route53RecoveryReadinessException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Route53 Recovery Readiness** service.

### Table of Contents  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryReadiness.Exception.Route53RecoveryReadinessException.html\#toc)

#### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryReadiness.Exception.Route53RecoveryReadinessException.html\#toc-methods)
...
### Methods  [header link](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryReadiness.Exception.Route53RecoveryReadinessException.html\#methods)
...
- Table Of Contents
  - [Methods](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryReadiness.Exception.Route53RecoveryReadinessException.html#toc-methods)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](https://docs.aws.amazon.com/aws-sdk-php/v3/api/class-Aws.Route53RecoveryReadiness.Exception.Route53RecoveryReadinessException.html#top)
