...
The ID or name of the application that includes the environment that you want to delete.
...
The ID or name of the environment that you want to delete.
Length Constraints: Minimum length of 1. Maximum length of 64.
Required: Yes
...
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/appconfig-2019-10-09/DeleteEnvironment)
...
+  [AWS SDK for Python (Boto3)](https://docs.aws.amazon.com/goto/boto3/appconfig-2019-10-09/DeleteEnvironment)
