...
Type: [CapacityReservation](https://docs.aws.amazon.com/athena/latest/APIReference/API_CapacityReservation.html) object
...
- [AWS SDK for Python](https://docs.aws.amazon.com/goto/boto3/athena-2017-05-18/GetCapacityReservation)
