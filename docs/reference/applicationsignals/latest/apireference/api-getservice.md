...
Type: [Service](https://docs.aws.amazon.com/applicationsignals/latest/APIReference/API_Service.html) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/application-signals-2024-04-15/GetService)
