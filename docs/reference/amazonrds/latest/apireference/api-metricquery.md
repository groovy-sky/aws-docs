...
Type: [PerformanceInsightsMetricQuery](api-performanceinsightsmetricquery.md) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/rds-2014-10-31/MetricQuery)
