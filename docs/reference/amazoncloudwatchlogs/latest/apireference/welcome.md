...
CloudWatch Logs commands in the AWS CLI, CloudWatch Logs API, or CloudWatch
Logs SDK.

For more information about CloudWatch Logs features, see the
[Amazon CloudWatch Logs User Guide](../../../../services/amazoncloudwatch/latest/logs/whatiscloudwatchlogs.md).
...
- **Monitor AWS CloudTrail logged events**: You
