...
Type: [SuppressionPeriod](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_SuppressionPeriod.html) object
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/logs-2014-03-28/UpdateAnomaly)
