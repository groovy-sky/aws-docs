...
calculation in AWS Signature Version 4 (see [Authenticating Requests (AWS Signature Version 4)](../../../../services/s3/latest/developerguide/sig-v4-authenticating-requests.md)) can be a complex undertaking, and we
...
header for authentication, see [Authenticating Requests: Using the Authorization Header (AWS Signature Version 4)](../../../../services/s3/latest/developerguide/sigv4-auth-using-authorization-header.md).
...
for authentication, see [Authenticating Requests: Using Query Parameters (AWS Signature Version 4)](../../../../services/s3/latest/developerguide/sigv4-query-string-auth.md).
