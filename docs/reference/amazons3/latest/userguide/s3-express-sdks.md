...
AWS SDKs, Amazon S3 console, AWS Command Line Interface (AWS CLI), and Amazon S3 REST API.
...
You can use the AWS Command Line Interface (AWS CLI) to create directory buckets and use supported
