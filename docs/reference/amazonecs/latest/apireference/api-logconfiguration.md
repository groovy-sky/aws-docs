...
Amazon ECS logs to CloudWatch](../../../../services/amazonecs/latest/developerguide/using-awslogs.md) in the _Amazon Elastic Container_
...
For more information, see [awslogs-datetime-format](https://docs.docker.com/config/containers/logging/awslogs).
...
For more information, see [awslogs-multiline-pattern](https://docs.docker.com/config/containers/logging/awslogs).
...
container log driver](http://aws.amazon.com/blogs/containers/preventing-log-loss-with-non-blocking-mode-in-the-awslogs-container-log-driver).
...
about the account setting, see [Default log driver mode](../../../../services/amazonecs/latest/developerguide/ecs-account-settings.md#default-log-driver-mode) in the _Amazon Elastic_
...
FireLens for Amazon ECS Tasks](http://aws.amazon.com/blogs/containers/under-the-hood-firelens-for-amazon-ecs-tasks).
