...
Before proceeding further, you must have already completed the steps in [Generate SDKs for REST APIs in API Gateway](how-to-generate-sdk.md).

###### Note

The generated SDK is not compatible with Android 4.4 and earlier. For more information, see
[Amazon API Gateway important notes](../../../../services/apigateway/latest/developerguide/api-gateway-known-issues.md).
