...
For complete details about how to use the primary contact operations, see [Update the primary contact for your AWS account](../../../../services/accounts/latest/reference/manage-acct-update-contact-primary.md).
...
[all features\
enabled](../../../../services/organizations/latest/userguide/orgs-manage-org-support-all-features.md), and the organization must have [trusted access](../../../../services/organizations/latest/userguide/services-that-can-integrate-account.md)
enabled for the Account Management service, and optionally a [delegated\
administrator](../../../../services/organizations/latest/userguide/orgs-getting-started-concepts.md#delegated-admin) account assigned.
