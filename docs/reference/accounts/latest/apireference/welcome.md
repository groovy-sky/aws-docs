...
addition to the email address associated with the [root user](../../../../services/accounts/latest/reference/root-user.md) of
...
calls the operation. The [identity](../../../../services/iam/latest/userguide/id.md) in the account that is calling the operation is typically an IAM
...
web service. To learn more about the Account Management Query API, see [Calling the API by making HTTP Query\
requests](../../../../services/accounts/latest/reference/query-requests.md) in the AWS Account Management Reference Guide. Account Management supports GET and POST requests for all actions. That
...
application that uses Signature Version 2, you do not have to update it to use Signature
Version 4. However, some operations now require Signature Version 4. The documentation for
operations that require version 4 indicates this requirement. For more information, see
[Signing AWS\
API requests](../../../../services/iam/latest/userguide/reference-aws-signing.md) in the _IAM User Guide_.
...
or post your feedback and questions in the [Account Management support forum](http://forums.aws.amazon.com/forum.jspa?forumID=219). For more information about the AWS support forums, see
...
made, and so on. For more about Account Management and its support for CloudTrail, see [Logging AWS Account Management\
API calls using AWS CloudTrail](../../../../services/accounts/latest/reference/monitoring-cloudtrail.md). To learn more
about CloudTrail, including how to turn it on and find your log files, see the [CloudTrail User Guide](../../../../services/awscloudtrail/latest/userguide.md).

This document was last published on June 11, 2026.
