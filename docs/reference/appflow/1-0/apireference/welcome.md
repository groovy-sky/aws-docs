...
- [Actions](api-operations.md): An alphabetical list of all Amazon AppFlow API operations.

- [Data\
types](api-types.md): An alphabetical list of all Amazon AppFlow data types.

- [Common parameters](commonparameters.md): Parameters that all Query operations can use.

- [Common\
errors](commonerrors.md): Client and server errors that all operations can return.

If you're new to Amazon AppFlow, we recommend that you review the [Amazon AppFlow\
User Guide](../../../../services/appflow/latest/userguide/what-is-appflow.md).
