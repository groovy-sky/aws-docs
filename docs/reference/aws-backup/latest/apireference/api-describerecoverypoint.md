...
ID is transferred from the [logical ID](../../../../services/cloudformation/latest/userguide/resources-section-structure.md#resources-section-structure-syntax) within a stack.
...
availability by resource](../../../../services/aws-backup/latest/devguide/backup-feature-availability.md#features-by-resource) table. AWS Backup ignores this expression for other resource types.
...
[Recovery point status](../../../../services/aws-backup/latest/devguide/applicationstackbackups.md#cfnrecoverypointstatus) in the _AWS Backup Developer_
_Guide_.
...
Delete the recovery points](../../../../services/aws-backup/latest/devguide/gs-cleanup-resources.md#cleanup-backups) in the _Clean up resources_
