...
Recovery point count value displayed in the console can be an approximation. Use [`ListRecoveryPointsByBackupVault`](../../../../services/aws-backup/latest/devguide/api-listrecoverypointsbybackupvault.md) API to obtain the exact
count.
