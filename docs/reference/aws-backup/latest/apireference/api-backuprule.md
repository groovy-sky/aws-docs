...
For more information about AWS cron expressions, see [Schedule Expressions for Rules](../../../../services/amazoncloudwatch/latest/events/scheduledevents.md) in the _Amazon CloudWatch Events User_
_Guide_.
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/backup-2018-11-15/BackupRule)
