...
management](../../../../services/aws-backup/latest/devguide/whatisbackup.md#full-management).

For a list of resource types and whether each supports full AWS Backup management,
see the [Feature availability by resource](../../../../services/aws-backup/latest/devguide/backup-feature-availability.md#features-by-resource) table.

If `"DynamoDB":false`, you can enable full AWS Backup management for
DynamoDB backup by enabling [AWS Backup's advanced DynamoDB backup features](../../../../services/aws-backup/latest/devguide/advanced-ddb-backup.md#advanced-ddb-backup-enable-cli).
