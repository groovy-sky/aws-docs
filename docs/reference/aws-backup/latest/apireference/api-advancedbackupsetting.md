...
Backup](../../../../services/aws-backup/latest/devguide/windows-backups.md).
...
CloudFormation template to enable Windows VSS](../../../../services/aws-backup/latest/devguide/integrate-cloudformation-with-aws-backup.md) in the _AWS Backup User Guide_.
...
- [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/backup-2018-11-15/AdvancedBackupSetting)
