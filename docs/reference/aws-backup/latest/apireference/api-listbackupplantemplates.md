...
Type: Array of [BackupPlanTemplatesListMember](API_BackupPlanTemplatesListMember.md) objects
...
+  [AWS SDK for Python (Boto3)](https://docs.aws.amazon.com/goto/boto3/backup-2018-11-15/ListBackupPlanTemplates)
