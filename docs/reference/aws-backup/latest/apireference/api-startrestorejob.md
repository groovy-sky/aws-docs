...
- [Metadata for Amazon Aurora](../../../../services/aws-backup/latest/devguide/restoring-aur.md#aur-restore-cli)

- [Metadata for Amazon DocumentDB](../../../../services/aws-backup/latest/devguide/restoring-docdb.md#docdb-restore-cli)

- [Metadata for AWS CloudFormation](../../../../services/aws-backup/latest/devguide/restore-application-stacks.md#restoring-cfn-cli)

- [Metadata for Amazon DynamoDB](../../../../services/aws-backup/latest/devguide/restoring-dynamodb.md#ddb-restore-cli)

- [Metadata for Amazon EBS](../../../../services/aws-backup/latest/devguide/restoring-ebs.md#ebs-restore-cli)

- [Metadata for Amazon EC2](../../../../services/aws-backup/latest/devguide/restoring-ec2.md#restoring-ec2-cli)

- [Metadata for Amazon EFS](../../../../services/aws-backup/latest/devguide/restoring-efs.md#efs-restore-cli)

- [Metadata for Amazon EKS](../../../../services/aws-backup/latest/devguide/restoring-eks.md#eks-restore-backup-section)

- [Metadata for Amazon FSx](../../../../services/aws-backup/latest/devguide/restoring-fsx.md#fsx-restore-cli)

- [Metadata for Amazon Neptune](../../../../services/aws-backup/latest/devguide/restoring-nep.md#nep-restore-cli)

- [Metadata for Amazon RDS](../../../../services/aws-backup/latest/devguide/restoring-rds.md#rds-restore-cli)

- [Metadata for Amazon Redshift](../../../../services/aws-backup/latest/devguide/redshift-restores.md#redshift-restore-api)

- [Metadata for AWS Storage Gateway](../../../../services/aws-backup/latest/devguide/restoring-storage-gateway.md#restoring-sgw-cli)

- [Metadata for Amazon S3](../../../../services/aws-backup/latest/devguide/restoring-s3.md#s3-restore-cli)

- [Metadata for Amazon Timestream](../../../../services/aws-backup/latest/devguide/timestream-restore.md#timestream-restore-api)

- [Metadata for virtual machines](../../../../services/aws-backup/latest/devguide/restoring-vm.md#vm-restore-cli)
