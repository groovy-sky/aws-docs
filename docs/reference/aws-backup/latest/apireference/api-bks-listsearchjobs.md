...
Type: Array of [SearchJobSummary](API_BKS_SearchJobSummary.md) objects
...
+  [AWS SDK for Python (Boto3)](https://docs.aws.amazon.com/goto/boto3/backupsearch-2018-05-10/ListSearchJobs)
