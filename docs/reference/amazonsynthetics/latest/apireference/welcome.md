...
create and manage _canaries_, which are modular, lightweight scripts
...
the Health of Your Applications](../../../../services/amazoncloudwatch/latest/monitoring/servicelens.md) in the _Amazon CloudWatch User_
_Guide_.
