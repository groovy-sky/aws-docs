...
the elements that make up a file system policy, see [Amazon EFS Resource-based policies](../../../../services/efs/latest/ug/access-control-overview.md#access-control-manage-access-intro-resource-policies).
