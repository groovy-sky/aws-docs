...
[encryption\
context](../../../../services/kms/latest/developerguide/concepts-encrypt-context.md). You can specify only one type of encryption context. An empty map is
...
operation](../../../../services/kms/latest/developerguide/concepts-cryptographic-operations.md) request. The grant allows the operation only when the encryption
...
operation](../../../../services/kms/latest/developerguide/concepts-cryptographic-operations.md) request. The grant allows the cryptographic operation only when the
