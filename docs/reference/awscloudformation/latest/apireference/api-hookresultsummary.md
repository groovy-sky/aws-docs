---
title: "HookResultSummary"
---

# HookResultSummary
<a name="API_HookResultSummary"></a>

A `ListHookResults` call returns a summary of a Hook invocation.

## Contents
<a name="API_HookResultSummary_Contents"></a>
...
## See Also
<a name="API_HookResultSummary_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/cloudformation-2010-05-15/HookResultSummary)
+  [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudformation-2010-05-15/HookResultSummary)
+  [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudformation-2010-05-15/HookResultSummary)
