...
The output for the [ListExports](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_ListExports.html) action.

Type: Array of [Export](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_Export.html) objects
