...
# TypeSummary
<a name="API_TypeSummary"></a>

Contains summary information about the specified CloudFormation extension.

## Contents
<a name="API_TypeSummary_Contents"></a>
...
For more information, see [Publishing extensions to make them available for public use](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/publish-extension.html) in the * AWS CloudFormation Command Line Interface (CLI) User Guide*.
Type: String
...
## See Also
<a name="API_TypeSummary_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/cloudformation-2010-05-15/TypeSummary)
+  [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudformation-2010-05-15/TypeSummary)
+  [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudformation-2010-05-15/TypeSummary)
