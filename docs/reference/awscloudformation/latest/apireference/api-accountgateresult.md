---
title: "AccountGateResult"
---

# AccountGateResult
<a name="API_AccountGateResult"></a>
...
For more information, see [Prevent failed StackSets deployments using target account gates](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-account-gating.html) in the * AWS CloudFormation User Guide*.

## Contents
<a name="API_AccountGateResult_Contents"></a>
...
## See Also
<a name="API_AccountGateResult_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/cloudformation-2010-05-15/AccountGateResult)
+  [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudformation-2010-05-15/AccountGateResult)
+  [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudformation-2010-05-15/AccountGateResult)
