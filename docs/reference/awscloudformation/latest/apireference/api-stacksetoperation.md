---
title: "StackSetOperation"
---

# StackSetOperation
<a name="API_StackSetOperation"></a>

The structure that contains information about a StackSet operation.

## Contents
<a name="API_StackSetOperation_Contents"></a>
 ...
 ** DeploymentTargets **
The AWS Organizations accounts affected by the stack operation. Valid only if the StackSet uses service-managed permissions.
...
For more information, see [Performing drift detection on CloudFormation StackSets](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-drift.html) in the * AWS CloudFormation User Guide*.
...
Type: [StackSetOperationStatusDetails](API_StackSetOperationStatusDetails.md) object
Required: No
...
## See Also
<a name="API_StackSetOperation_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/cloudformation-2010-05-15/StackSetOperation)
+  [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudformation-2010-05-15/StackSetOperation)
+  [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudformation-2010-05-15/StackSetOperation)
