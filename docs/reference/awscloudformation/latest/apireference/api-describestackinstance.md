...
For a list of stack instances that are associated with a specific StackSet, use [ListStackInstances](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_ListStackInstances.html).
...
Type: [StackInstance](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_StackInstance.html) object
