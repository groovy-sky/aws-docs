...
**If an item with the specified _Key_ is found in**
**the table:**
...
If a _set_ of values is specified, then those values are
...
(This is a _set_ operation, not mathematical
...
**If no item with the specified _Key_ is**
**found:**
...
For more information, see [Data Types](../../../../services/dynamodb/latest/developerguide/howitworks-namingrulesdatatypes.md#HowItWorks.DataTypes) in the _Amazon DynamoDB Developer Guide_.
...
- [AWS SDK for C++](../../../goto/sdkforcpp/dynamodb-2012-08-10/attributevalueupdate.md)

- [AWS SDK for Java V2](../../../goto/sdkforjavav2/dynamodb-2012-08-10/attributevalueupdate.md)

- [AWS SDK for Ruby V3](../../../goto/sdkforrubyv3/dynamodb-2012-08-10/attributevalueupdate.md)
