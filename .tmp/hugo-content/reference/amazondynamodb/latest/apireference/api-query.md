...
the Results](../../../../services/dynamodb/latest/developerguide/query.md#Query.Pagination) in the _Amazon DynamoDB Developer Guide_.
...
For additional information on how to use the Query API, please see [Working\
with Queries](../../../../services/dynamodb/latest/developerguide/query.md).
...
**[TableName](#API_Query_RequestSyntax)**
...
**[AttributesToGet](#API_Query_RequestSyntax)**
...
**[ConditionalOperator](#API_Query_RequestSyntax)**
...
**[ConsistentRead](#API_Query_RequestSyntax)**
...
**[ExclusiveStartKey](#API_Query_RequestSyntax)**
...
**[ExpressionAttributeNames](#API_Query_RequestSyntax)**
...
**[ExpressionAttributeValues](#API_Query_RequestSyntax)**
...
the value of the _ProductStatus_ attribute was one of the following:
...
For more information on expression attribute values, see [Specifying Conditions](../../../../services/dynamodb/latest/developerguide/expressions-specifyingconditions.md) in the _Amazon DynamoDB Developer_
_Guide_.
...
**[FilterExpression](#API_Query_RequestSyntax)**
...
Expressions](../../../../services/dynamodb/latest/developerguide/query-filterexpression.md) in the _Amazon DynamoDB Developer_
_Guide_.
...
**[IndexName](#API_Query_RequestSyntax)**
...
**[KeyConditionExpression](#API_Query_RequestSyntax)**
...
- `sortKeyName` `BETWEEN` `:sortkeyval1` `AND` `:sortkeyval2` \- true if the sort key value is greater than or equal
...
_Size_ is a reserved word:

- `Size = :myval`

To work around this, define a placeholder (such a `#S`) to represent the
attribute name _Size_. `KeyConditionExpression` then is as
follows:

- `#S = :myval`

For a list of reserved words, see [Reserved Words](../../../../services/dynamodb/latest/developerguide/reservedwords.md)
...
Placeholders for Attribute Names and Values](../../../../services/dynamodb/latest/developerguide/expressionplaceholders.md) in the _Amazon DynamoDB_
_Developer Guide_.
...
**[KeyConditions](#API_Query_RequestSyntax)**

This is a legacy parameter. Use `KeyConditionExpression` instead. For more
information, see [KeyConditions](../../../../services/dynamodb/latest/developerguide/legacyconditionalparameters-keyconditions.md) in the _Amazon DynamoDB Developer_
_Guide_.
...
operation to continue the operation. For more information, see [Query and Scan](../../../../services/dynamodb/latest/developerguide/queryandscan.md) in the _Amazon DynamoDB Developer_
_Guide_.
...
**[ProjectionExpression](#API_Query_RequestSyntax)**
...
**[QueryFilter](#API_Query_RequestSyntax)**

This is a legacy parameter. Use `FilterExpression` instead. For more
information, see [QueryFilter](../../../../services/dynamodb/latest/developerguide/legacyconditionalparameters-queryfilter.md) in the _Amazon DynamoDB Developer_
_Guide_.
...
**[ReturnConsumedCapacity](#API_Query_RequestSyntax)**
...
**[ScanIndexForward](#API_Query_RequestSyntax)**
...
**[Select](#API_Query_RequestSyntax)**
...
**[ConsumedCapacity](#API_Query_ResponseSyntax)**
...
**[Count](#API_Query_ResponseSyntax)**
...
**[Items](#API_Query_ResponseSyntax)**
...
**[LastEvaluatedKey](#API_Query_ResponseSyntax)**
...
**[ScannedCount](#API_Query_ResponseSyntax)**

The number of items evaluated, before any `QueryFilter` is applied. A high
`ScannedCount` value with few, or no, `Count` results
indicates an inefficient `Query` operation. For more information, see [Count and ScannedCount](../../../../services/dynamodb/latest/developerguide/scan.md#Scan.Count) in the _Amazon DynamoDB Developer_
_Guide_.
...
the _Reply_ table, `PostedBy-Index`, to facilitate
...
- [AWS Command Line Interface V2](../../../../services/goto/cli2/dynamodb-2012-08-10/query.md)

- [AWS SDK for .NET V4](../../../goto/dotnetsdkv4/dynamodb-2012-08-10/query.md)

- [AWS SDK for C++](../../../goto/sdkforcpp/dynamodb-2012-08-10/query.md)

- [AWS SDK for Go v2](../../../goto/sdkforgov2/dynamodb-2012-08-10/query.md)

- [AWS SDK for Java V2](../../../goto/sdkforjavav2/dynamodb-2012-08-10/query.md)

- [AWS SDK for JavaScript V3](../../../goto/sdkforjavascriptv3/dynamodb-2012-08-10/query.md)

- [AWS SDK for Kotlin](../../../goto/sdkforkotlin/dynamodb-2012-08-10/query.md)

- [AWS SDK for PHP V3](../../../goto/sdkforphpv3/dynamodb-2012-08-10/query.md)

- [AWS SDK for Python](../../../../services/goto/boto3/dynamodb-2012-08-10/query.md)

- [AWS SDK for Ruby V3](../../../goto/sdkforrubyv3/dynamodb-2012-08-10/query.md)
