...
AWS SDK for Java 2.x, see [Modifying an existing application to use DAX](../../../../services/dynamodb/latest/developerguide/dax-client-modify-your-app.md).
...
interfaces](programming-sdks-interfaces-document.md).
