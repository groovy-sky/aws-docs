...
by a private certificate authority (CA) and exported with the [ExportCertificate](../apireference/api-exportcertificate.md) function. At
...
Renewal Permissions to ACM](../../../../services/privateca/latest/userguide/assign-permissions.md#PcaPermissions).
