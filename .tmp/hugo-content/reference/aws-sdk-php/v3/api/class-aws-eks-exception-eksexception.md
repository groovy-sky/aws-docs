...
## EKSException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Elastic Container Service for Kubernetes** service.

### Table of Contents  [header link](class-aws-eks-exception-eksexception-toc.md)

#### Methods  [header link](class-aws-eks-exception-eksexception-toc-methods.md)
...
### Methods  [header link](class-aws-eks-exception-eksexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-eks-exception-eksexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-eks-exception-eksexception-top.md)
