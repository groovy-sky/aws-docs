...
## ConnectCasesException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Connect Cases** service.

### Table of Contents  [header link](class-aws-connectcases-exception-connectcasesexception-toc.md)

#### Methods  [header link](class-aws-connectcases-exception-connectcasesexception-toc-methods.md)
...
### Methods  [header link](class-aws-connectcases-exception-connectcasesexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-connectcases-exception-connectcasesexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-connectcases-exception-connectcasesexception-top.md)
