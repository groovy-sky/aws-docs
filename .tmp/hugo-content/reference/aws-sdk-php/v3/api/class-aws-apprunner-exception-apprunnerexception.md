...
## AppRunnerException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS App Runner** service.

### Table of Contents  [header link](class-aws-apprunner-exception-apprunnerexception-toc.md)

#### Methods  [header link](class-aws-apprunner-exception-apprunnerexception-toc-methods.md)
...
### Methods  [header link](class-aws-apprunner-exception-apprunnerexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-apprunner-exception-apprunnerexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-apprunner-exception-apprunnerexception-top.md)
