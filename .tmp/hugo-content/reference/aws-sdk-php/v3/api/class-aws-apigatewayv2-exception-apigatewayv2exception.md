...
- [Exception](namespace-aws-apigatewayv2-exception.md)

## ApiGatewayV2Exception     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AmazonApiGatewayV2** service.

### Table of Contents  [header link](class-aws-apigatewayv2-exception-apigatewayv2exception-toc.md)

#### Methods  [header link](class-aws-apigatewayv2-exception-apigatewayv2exception-toc-methods.md)
...
### Methods  [header link](class-aws-apigatewayv2-exception-apigatewayv2exception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-apigatewayv2-exception-apigatewayv2exception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-apigatewayv2-exception-apigatewayv2exception-top.md)
