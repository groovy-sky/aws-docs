...
## CloudControlApiException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Cloud Control API** service.

### Table of Contents  [header link](class-aws-cloudcontrolapi-exception-cloudcontrolapiexception-toc.md)

#### Methods  [header link](class-aws-cloudcontrolapi-exception-cloudcontrolapiexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudcontrolapi-exception-cloudcontrolapiexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudcontrolapi-exception-cloudcontrolapiexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudcontrolapi-exception-cloudcontrolapiexception-top.md)
