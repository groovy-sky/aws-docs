...
## CodeDeployException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with AWS CodeDeploy.

### Table of Contents  [header link](class-aws-codedeploy-exception-codedeployexception-toc.md)

#### Methods  [header link](class-aws-codedeploy-exception-codedeployexception-toc-methods.md)
...
### Methods  [header link](class-aws-codedeploy-exception-codedeployexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codedeploy-exception-codedeployexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codedeploy-exception-codedeployexception-top.md)
