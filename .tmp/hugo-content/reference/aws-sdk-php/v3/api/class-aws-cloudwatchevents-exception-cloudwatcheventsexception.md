...
## CloudWatchEventsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon CloudWatch Events** service.

### Table of Contents  [header link](class-aws-cloudwatchevents-exception-cloudwatcheventsexception-toc.md)

#### Methods  [header link](class-aws-cloudwatchevents-exception-cloudwatcheventsexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudwatchevents-exception-cloudwatcheventsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudwatchevents-exception-cloudwatcheventsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudwatchevents-exception-cloudwatcheventsexception-top.md)
