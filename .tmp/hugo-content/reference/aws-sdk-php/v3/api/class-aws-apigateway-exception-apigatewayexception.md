...
## ApiGatewayException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS API Gateway** service.

### Table of Contents  [header link](class-aws-apigateway-exception-apigatewayexception-toc.md)

#### Methods  [header link](class-aws-apigateway-exception-apigatewayexception-toc-methods.md)
...
### Methods  [header link](class-aws-apigateway-exception-apigatewayexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-apigateway-exception-apigatewayexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-apigateway-exception-apigatewayexception-top.md)
