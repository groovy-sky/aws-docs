...
## DynamoDbException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon DynamoDB service.

### Table of Contents  [header link](class-aws-dynamodb-exception-dynamodbexception-toc.md)

#### Methods  [header link](class-aws-dynamodb-exception-dynamodbexception-toc-methods.md)
...
### Methods  [header link](class-aws-dynamodb-exception-dynamodbexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-dynamodb-exception-dynamodbexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-dynamodb-exception-dynamodbexception-top.md)
