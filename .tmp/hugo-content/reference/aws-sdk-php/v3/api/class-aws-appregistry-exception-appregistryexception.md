...
## AppRegistryException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Service Catalog App Registry** service.

### Table of Contents  [header link](class-aws-appregistry-exception-appregistryexception-toc.md)

#### Methods  [header link](class-aws-appregistry-exception-appregistryexception-toc-methods.md)
...
### Methods  [header link](class-aws-appregistry-exception-appregistryexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-appregistry-exception-appregistryexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-appregistry-exception-appregistryexception-top.md)
