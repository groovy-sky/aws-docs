...
## ACMPCAException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Certificate Manager Private Certificate Authority** service.

### Table of Contents  [header link](class-aws-acmpca-exception-acmpcaexception-toc.md)

#### Methods  [header link](class-aws-acmpca-exception-acmpcaexception-toc-methods.md)
...
### Methods  [header link](class-aws-acmpca-exception-acmpcaexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-acmpca-exception-acmpcaexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-acmpca-exception-acmpcaexception-top.md)
