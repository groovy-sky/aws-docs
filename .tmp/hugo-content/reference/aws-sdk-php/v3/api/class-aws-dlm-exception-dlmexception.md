...
## DLMException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Data Lifecycle Manager** service.

### Table of Contents  [header link](class-aws-dlm-exception-dlmexception-toc.md)

#### Methods  [header link](class-aws-dlm-exception-dlmexception-toc-methods.md)
...
### Methods  [header link](class-aws-dlm-exception-dlmexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-dlm-exception-dlmexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-dlm-exception-dlmexception-top.md)
