...
- [Exception](namespace-aws-athena-exception.md)

## AthenaException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Athena** service.

### Table of Contents  [header link](class-aws-athena-exception-athenaexception-toc.md)

#### Methods  [header link](class-aws-athena-exception-athenaexception-toc-methods.md)
...
### Methods  [header link](class-aws-athena-exception-athenaexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-athena-exception-athenaexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-athena-exception-athenaexception-top.md)
