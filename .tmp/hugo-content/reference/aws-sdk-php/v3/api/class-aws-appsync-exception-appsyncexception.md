...
## AppSyncException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS AppSync** service.

### Table of Contents  [header link](class-aws-appsync-exception-appsyncexception-toc.md)

#### Methods  [header link](class-aws-appsync-exception-appsyncexception-toc-methods.md)
...
### Methods  [header link](class-aws-appsync-exception-appsyncexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-appsync-exception-appsyncexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-appsync-exception-appsyncexception-top.md)
