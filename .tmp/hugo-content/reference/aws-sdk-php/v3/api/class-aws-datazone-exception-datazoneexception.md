...
## DataZoneException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon DataZone** service.

### Table of Contents  [header link](class-aws-datazone-exception-datazoneexception-toc.md)

#### Methods  [header link](class-aws-datazone-exception-datazoneexception-toc-methods.md)
...
### Methods  [header link](class-aws-datazone-exception-datazoneexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-datazone-exception-datazoneexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-datazone-exception-datazoneexception-top.md)
