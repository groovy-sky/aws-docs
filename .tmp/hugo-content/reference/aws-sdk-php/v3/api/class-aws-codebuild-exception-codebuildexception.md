...
## CodeBuildException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS CodeBuild** service.

### Table of Contents  [header link](class-aws-codebuild-exception-codebuildexception-toc.md)

#### Methods  [header link](class-aws-codebuild-exception-codebuildexception-toc-methods.md)
...
### Methods  [header link](class-aws-codebuild-exception-codebuildexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codebuild-exception-codebuildexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codebuild-exception-codebuildexception-top.md)
