...
## BedrockException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Bedrock** service.

### Table of Contents  [header link](class-aws-bedrock-exception-bedrockexception-toc.md)

#### Methods  [header link](class-aws-bedrock-exception-bedrockexception-toc-methods.md)
...
### Methods  [header link](class-aws-bedrock-exception-bedrockexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bedrock-exception-bedrockexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bedrock-exception-bedrockexception-top.md)
