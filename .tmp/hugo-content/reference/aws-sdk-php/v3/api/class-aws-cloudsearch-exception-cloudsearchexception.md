...
## CloudSearchException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon CloudSearch service.

### Table of Contents  [header link](class-aws-cloudsearch-exception-cloudsearchexception-toc.md)

#### Methods  [header link](class-aws-cloudsearch-exception-cloudsearchexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudsearch-exception-cloudsearchexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudsearch-exception-cloudsearchexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudsearch-exception-cloudsearchexception-top.md)
