...
- [Exception](namespace-aws-codeartifact-exception.md)

## CodeArtifactException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **CodeArtifact** service.

### Table of Contents  [header link](class-aws-codeartifact-exception-codeartifactexception-toc.md)

#### Methods  [header link](class-aws-codeartifact-exception-codeartifactexception-toc-methods.md)
...
### Methods  [header link](class-aws-codeartifact-exception-codeartifactexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codeartifact-exception-codeartifactexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codeartifact-exception-codeartifactexception-top.md)
