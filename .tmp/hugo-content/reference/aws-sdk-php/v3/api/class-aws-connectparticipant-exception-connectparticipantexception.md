...
## ConnectParticipantException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Connect Participant Service** service.

### Table of Contents  [header link](class-aws-connectparticipant-exception-connectparticipantexception-toc.md)

#### Methods  [header link](class-aws-connectparticipant-exception-connectparticipantexception-toc-methods.md)
...
### Methods  [header link](class-aws-connectparticipant-exception-connectparticipantexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-connectparticipant-exception-connectparticipantexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-connectparticipant-exception-connectparticipantexception-top.md)
