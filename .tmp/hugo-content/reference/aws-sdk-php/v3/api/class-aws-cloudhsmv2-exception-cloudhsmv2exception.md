...
- [Exception](namespace-aws-cloudhsmv2-exception.md)

## CloudHSMV2Exception     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS CloudHSM V2** service.

### Table of Contents  [header link](class-aws-cloudhsmv2-exception-cloudhsmv2exception-toc.md)

#### Methods  [header link](class-aws-cloudhsmv2-exception-cloudhsmv2exception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudhsmv2-exception-cloudhsmv2exception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudhsmv2-exception-cloudhsmv2exception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudhsmv2-exception-cloudhsmv2exception-top.md)
