...
- [Exception](namespace-aws-ebs-exception.md)

## EBSException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Elastic Block Store** service.

### Table of Contents  [header link](class-aws-ebs-exception-ebsexception-toc.md)

#### Methods  [header link](class-aws-ebs-exception-ebsexception-toc-methods.md)
...
### Methods  [header link](class-aws-ebs-exception-ebsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-ebs-exception-ebsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-ebs-exception-ebsexception-top.md)
