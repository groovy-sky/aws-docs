...
- [Exception](namespace-aws-bedrockagentcore-exception.md)

## BedrockAgentCoreException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Bedrock AgentCore Data Plane Fronting Layer** service.

### Table of Contents  [header link](class-aws-bedrockagentcore-exception-bedrockagentcoreexception-toc.md)

#### Methods  [header link](class-aws-bedrockagentcore-exception-bedrockagentcoreexception-toc-methods.md)
...
### Methods  [header link](class-aws-bedrockagentcore-exception-bedrockagentcoreexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-bedrockagentcore-exception-bedrockagentcoreexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-bedrockagentcore-exception-bedrockagentcoreexception-top.md)
