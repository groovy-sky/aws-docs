...
## DataPipelineException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the AWS Data Pipeline service.

### Table of Contents  [header link](class-aws-datapipeline-exception-datapipelineexception-toc.md)

#### Methods  [header link](class-aws-datapipeline-exception-datapipelineexception-toc-methods.md)
...
### Methods  [header link](class-aws-datapipeline-exception-datapipelineexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-datapipeline-exception-datapipelineexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-datapipeline-exception-datapipelineexception-top.md)
