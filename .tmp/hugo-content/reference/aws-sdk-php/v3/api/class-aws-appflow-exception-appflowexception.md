...
## AppflowException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Appflow** service.

### Table of Contents  [header link](class-aws-appflow-exception-appflowexception-toc.md)

#### Methods  [header link](class-aws-appflow-exception-appflowexception-toc-methods.md)
...
### Methods  [header link](class-aws-appflow-exception-appflowexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-appflow-exception-appflowexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-appflow-exception-appflowexception-top.md)
