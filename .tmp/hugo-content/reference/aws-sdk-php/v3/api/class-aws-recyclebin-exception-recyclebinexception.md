...
- [Exception](namespace-aws-recyclebin-exception.md)
...
### Table of Contents  [header link](class-aws-recyclebin-exception-recyclebinexception-toc.md)

#### Methods  [header link](class-aws-recyclebin-exception-recyclebinexception-toc-methods.md)
...
### Methods  [header link](class-aws-recyclebin-exception-recyclebinexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-recyclebin-exception-recyclebinexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-recyclebin-exception-recyclebinexception-top.md)
