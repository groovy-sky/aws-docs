...
- [Exception](namespace-aws-codepipeline-exception.md)

## CodePipelineException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon CodePipeline service.

### Table of Contents  [header link](class-aws-codepipeline-exception-codepipelineexception-toc.md)

#### Methods  [header link](class-aws-codepipeline-exception-codepipelineexception-toc-methods.md)
...
### Methods  [header link](class-aws-codepipeline-exception-codepipelineexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codepipeline-exception-codepipelineexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codepipeline-exception-codepipelineexception-top.md)
