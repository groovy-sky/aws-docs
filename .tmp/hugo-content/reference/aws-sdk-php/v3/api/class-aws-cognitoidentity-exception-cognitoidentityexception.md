...
- [Exception](namespace-aws-cognitoidentity-exception.md)

## CognitoIdentityException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon Cognito Identity Logs service.

### Table of Contents  [header link](class-aws-cognitoidentity-exception-cognitoidentityexception-toc.md)

#### Methods  [header link](class-aws-cognitoidentity-exception-cognitoidentityexception-toc-methods.md)
...
### Methods  [header link](class-aws-cognitoidentity-exception-cognitoidentityexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cognitoidentity-exception-cognitoidentityexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cognitoidentity-exception-cognitoidentityexception-top.md)
