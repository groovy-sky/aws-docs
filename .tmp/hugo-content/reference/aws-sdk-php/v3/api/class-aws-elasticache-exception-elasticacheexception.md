...
## ElastiCacheException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon ElastiCache service.

### Table of Contents  [header link](class-aws-elasticache-exception-elasticacheexception-toc.md)

#### Methods  [header link](class-aws-elasticache-exception-elasticacheexception-toc-methods.md)
...
### Methods  [header link](class-aws-elasticache-exception-elasticacheexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-elasticache-exception-elasticacheexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-elasticache-exception-elasticacheexception-top.md)
