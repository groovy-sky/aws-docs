...
- [Exception](namespace-aws-glue-exception.md)
...
### Table of Contents  [header link](class-aws-glue-exception-glueexception-toc.md)

#### Methods  [header link](class-aws-glue-exception-glueexception-toc-methods.md)
...
### Methods  [header link](class-aws-glue-exception-glueexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-glue-exception-glueexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-glue-exception-glueexception-top.md)
