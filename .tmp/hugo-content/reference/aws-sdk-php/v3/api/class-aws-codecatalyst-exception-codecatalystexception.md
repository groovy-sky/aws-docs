...
- [Exception](namespace-aws-codecatalyst-exception.md)

## CodeCatalystException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon CodeCatalyst** service.

### Table of Contents  [header link](class-aws-codecatalyst-exception-codecatalystexception-toc.md)

#### Methods  [header link](class-aws-codecatalyst-exception-codecatalystexception-toc-methods.md)
...
### Methods  [header link](class-aws-codecatalyst-exception-codecatalystexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codecatalyst-exception-codecatalystexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codecatalyst-exception-codecatalystexception-top.md)
