...
- [Exception](namespace-aws-appconfig-exception.md)

## AppConfigException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon AppConfig** service.

### Table of Contents  [header link](class-aws-appconfig-exception-appconfigexception-toc.md)

#### Methods  [header link](class-aws-appconfig-exception-appconfigexception-toc-methods.md)
...
### Methods  [header link](class-aws-appconfig-exception-appconfigexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-appconfig-exception-appconfigexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-appconfig-exception-appconfigexception-top.md)
