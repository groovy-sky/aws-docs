...
- [Exception](namespace-aws-ssmsap-exception.md)
...
### Table of Contents  [header link](class-aws-ssmsap-exception-ssmsapexception-toc.md)

#### Methods  [header link](class-aws-ssmsap-exception-ssmsapexception-toc-methods.md)
...
### Methods  [header link](class-aws-ssmsap-exception-ssmsapexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-ssmsap-exception-ssmsapexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-ssmsap-exception-ssmsapexception-top.md)
