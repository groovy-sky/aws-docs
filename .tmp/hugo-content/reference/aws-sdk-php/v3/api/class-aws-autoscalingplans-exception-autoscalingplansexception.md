...
## AutoScalingPlansException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Auto Scaling Plans** service.

### Table of Contents  [header link](class-aws-autoscalingplans-exception-autoscalingplansexception-toc.md)

#### Methods  [header link](class-aws-autoscalingplans-exception-autoscalingplansexception-toc-methods.md)
...
### Methods  [header link](class-aws-autoscalingplans-exception-autoscalingplansexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-autoscalingplans-exception-autoscalingplansexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-autoscalingplans-exception-autoscalingplansexception-top.md)
