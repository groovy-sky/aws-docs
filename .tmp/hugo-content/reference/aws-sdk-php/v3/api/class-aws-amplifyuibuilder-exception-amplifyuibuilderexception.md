...
## AmplifyUIBuilderException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Amplify UI Builder** service.

### Table of Contents  [header link](class-aws-amplifyuibuilder-exception-amplifyuibuilderexception-toc.md)

#### Methods  [header link](class-aws-amplifyuibuilder-exception-amplifyuibuilderexception-toc-methods.md)
...
### Methods  [header link](class-aws-amplifyuibuilder-exception-amplifyuibuilderexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-amplifyuibuilder-exception-amplifyuibuilderexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-amplifyuibuilder-exception-amplifyuibuilderexception-top.md)
