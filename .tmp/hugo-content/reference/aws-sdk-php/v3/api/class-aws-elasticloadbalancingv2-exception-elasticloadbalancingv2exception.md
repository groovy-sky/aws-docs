...
- [Exception](namespace-aws-elasticloadbalancingv2-exception.md)

## ElasticLoadBalancingV2Exception     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Elastic Load Balancing** service.

### Table of Contents  [header link](class-aws-elasticloadbalancingv2-exception-elasticloadbalancingv2exception-toc.md)

#### Methods  [header link](class-aws-elasticloadbalancingv2-exception-elasticloadbalancingv2exception-toc-methods.md)
...
### Methods  [header link](class-aws-elasticloadbalancingv2-exception-elasticloadbalancingv2exception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-elasticloadbalancingv2-exception-elasticloadbalancingv2exception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-elasticloadbalancingv2-exception-elasticloadbalancingv2exception-top.md)
