...
## CloudSearchDomainClient     extends [AwsClient](class-aws-awsclient.md)   in package    - [Aws](package-aws.md)
...
`
    public
            static        convertGetToPost(RequestInterface $r) : RequestInterface`
