...
## ComprehendMedicalException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Comprehend Medical** service.

### Table of Contents  [header link](class-aws-comprehendmedical-exception-comprehendmedicalexception-toc.md)

#### Methods  [header link](class-aws-comprehendmedical-exception-comprehendmedicalexception-toc-methods.md)
...
### Methods  [header link](class-aws-comprehendmedical-exception-comprehendmedicalexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-comprehendmedical-exception-comprehendmedicalexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-comprehendmedical-exception-comprehendmedicalexception-top.md)
