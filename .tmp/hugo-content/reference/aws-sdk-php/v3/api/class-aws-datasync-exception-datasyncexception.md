...
## DataSyncException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS DataSync** service.

### Table of Contents  [header link](class-aws-datasync-exception-datasyncexception-toc.md)

#### Methods  [header link](class-aws-datasync-exception-datasyncexception-toc-methods.md)
...
### Methods  [header link](class-aws-datasync-exception-datasyncexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-datasync-exception-datasyncexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-datasync-exception-datasyncexception-top.md)
