...
## BackupGatewayException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Backup Gateway** service.

### Table of Contents  [header link](class-aws-backupgateway-exception-backupgatewayexception-toc.md)

#### Methods  [header link](class-aws-backupgateway-exception-backupgatewayexception-toc-methods.md)
...
### Methods  [header link](class-aws-backupgateway-exception-backupgatewayexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-backupgateway-exception-backupgatewayexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-backupgateway-exception-backupgatewayexception-top.md)
