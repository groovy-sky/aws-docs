...
## drsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Elastic Disaster Recovery Service** service.

### Table of Contents  [header link](class-aws-drs-exception-drsexception-toc.md)

#### Methods  [header link](class-aws-drs-exception-drsexception-toc-methods.md)
...
### Methods  [header link](class-aws-drs-exception-drsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-drs-exception-drsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-drs-exception-drsexception-top.md)
