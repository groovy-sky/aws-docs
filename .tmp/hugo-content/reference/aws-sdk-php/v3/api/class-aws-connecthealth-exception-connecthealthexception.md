...
- [Exception](namespace-aws-connecthealth-exception.md)

## ConnectHealthException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Connect Health** service.

### Table of Contents  [header link](class-aws-connecthealth-exception-connecthealthexception-toc.md)

#### Methods  [header link](class-aws-connecthealth-exception-connecthealthexception-toc-methods.md)
...
### Methods  [header link](class-aws-connecthealth-exception-connecthealthexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-connecthealth-exception-connecthealthexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-connecthealth-exception-connecthealthexception-top.md)
