...
## CloudWatchRUMException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **CloudWatch RUM** service.

### Table of Contents  [header link](class-aws-cloudwatchrum-exception-cloudwatchrumexception-toc.md)

#### Methods  [header link](class-aws-cloudwatchrum-exception-cloudwatchrumexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudwatchrum-exception-cloudwatchrumexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudwatchrum-exception-cloudwatchrumexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudwatchrum-exception-cloudwatchrumexception-top.md)
