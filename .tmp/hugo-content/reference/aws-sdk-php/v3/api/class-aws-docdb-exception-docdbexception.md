...
## DocDBException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon DocumentDB with MongoDB compatibility** service.

### Table of Contents  [header link](class-aws-docdb-exception-docdbexception-toc.md)

#### Methods  [header link](class-aws-docdb-exception-docdbexception-toc-methods.md)
...
### Methods  [header link](class-aws-docdb-exception-docdbexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-docdb-exception-docdbexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-docdb-exception-docdbexception-top.md)
