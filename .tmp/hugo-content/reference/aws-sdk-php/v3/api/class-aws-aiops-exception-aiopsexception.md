...
- [Exception](namespace-aws-aiops-exception.md)

## AIOpsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS AI Ops** service.

### Table of Contents  [header link](class-aws-aiops-exception-aiopsexception-toc.md)

#### Methods  [header link](class-aws-aiops-exception-aiopsexception-toc-methods.md)
...
### Methods  [header link](class-aws-aiops-exception-aiopsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-aiops-exception-aiopsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-aiops-exception-aiopsexception-top.md)
