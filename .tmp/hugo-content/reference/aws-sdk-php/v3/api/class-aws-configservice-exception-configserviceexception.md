...
- [Exception](namespace-aws-configservice-exception.md)

## ConfigServiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the AWS Config service.

### Table of Contents  [header link](class-aws-configservice-exception-configserviceexception-toc.md)

#### Methods  [header link](class-aws-configservice-exception-configserviceexception-toc-methods.md)
...
### Methods  [header link](class-aws-configservice-exception-configserviceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-configservice-exception-configserviceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-configservice-exception-configserviceexception-top.md)
