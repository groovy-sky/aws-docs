...
## ControlTowerException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Control Tower** service.

### Table of Contents  [header link](class-aws-controltower-exception-controltowerexception-toc.md)

#### Methods  [header link](class-aws-controltower-exception-controltowerexception-toc-methods.md)
...
### Methods  [header link](class-aws-controltower-exception-controltowerexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-controltower-exception-controltowerexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-controltower-exception-controltowerexception-top.md)
