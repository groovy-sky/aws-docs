...
## CodeStarNotificationsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS CodeStar Notifications** service.

### Table of Contents  [header link](class-aws-codestarnotifications-exception-codestarnotificationsexception-toc.md)

#### Methods  [header link](class-aws-codestarnotifications-exception-codestarnotificationsexception-toc-methods.md)
...
### Methods  [header link](class-aws-codestarnotifications-exception-codestarnotificationsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codestarnotifications-exception-codestarnotificationsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codestarnotifications-exception-codestarnotificationsexception-top.md)
