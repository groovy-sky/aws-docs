...
### Table of Contents  [header link](class-aws-s3-s3transfer-progress-multiprogressbarformat-toc.md)

#### Constants  [header link](class-aws-s3-s3transfer-progress-multiprogressbarformat-toc-constants.md)

[FORMAT\_PARAMETERS](class-aws-s3-s3transfer-progress-multiprogressbarformat-constant-format-parameters.md)
= \['completed', 'failed', 'total', 'percent', 'progress\_bar'\] [FORMAT\_TEMPLATE](class-aws-s3-s3transfer-progress-multiprogressbarformat-constant-format-template.md)
= "\[\|progress\_bar\|\] \|percent\|% " . "Completed: \|completed\|/\|total\|, Failed: \|failed\|/\|total\|"

#### Methods  [header link](class-aws-s3-s3transfer-progress-multiprogressbarformat-toc-methods.md)
...
: array<string\|int, mixed> [getFormatParameters()](class-aws-s3-s3transfer-progress-multiprogressbarformat-method-getformatparameters.md)
: array<string\|int, mixed> [getFormatTemplate()](class-aws-s3-s3transfer-progress-multiprogressbarformat-method-getformattemplate.md)
...
### Constants  [header link](class-aws-s3-s3transfer-progress-multiprogressbarformat-constants.md)

#### FORMAT\_PARAMETERS  [header link](class-aws-s3-s3transfer-progress-multiprogressbarformat-constant-format-parameters.md)
...
#### FORMAT\_TEMPLATE  [header link](class-aws-s3-s3transfer-progress-multiprogressbarformat-constant-format-template.md)
...
### Methods  [header link](class-aws-s3-s3transfer-progress-multiprogressbarformat-methods.md)
...
#### getFormatParameters()  [header link](class-aws-s3-s3transfer-progress-multiprogressbarformat-method-getformatparameters.md)
...
#### getFormatTemplate()  [header link](class-aws-s3-s3transfer-progress-multiprogressbarformat-method-getformattemplate.md)
...
- Table Of Contents
  - [Constants](class-aws-s3-s3transfer-progress-multiprogressbarformat-toc-constants.md)
  - [Methods](class-aws-s3-s3transfer-progress-multiprogressbarformat-toc-methods.md)
- Constants
  - [FORMAT\_PARAMETERS](class-aws-s3-s3transfer-progress-multiprogressbarformat-constant-format-parameters.md)
  - [FORMAT\_TEMPLATE](class-aws-s3-s3transfer-progress-multiprogressbarformat-constant-format-template.md)
- Methods
  - [\_\_construct()](class-aws-s3-s3transfer-progress-abstractprogressbarformat.md#method___construct)
  ...
  - [getFormatParameters()](class-aws-s3-s3transfer-progress-multiprogressbarformat-method-getformatparameters.md)
  - [getFormatTemplate()](class-aws-s3-s3transfer-progress-multiprogressbarformat-method-getformattemplate.md)
...
[Back To Top](class-aws-s3-s3transfer-progress-multiprogressbarformat-top.md)
