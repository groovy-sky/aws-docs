...
## DirectConnectException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the AWS Direct Connect service.

### Table of Contents  [header link](class-aws-directconnect-exception-directconnectexception-toc.md)

#### Methods  [header link](class-aws-directconnect-exception-directconnectexception-toc-methods.md)
...
### Methods  [header link](class-aws-directconnect-exception-directconnectexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-directconnect-exception-directconnectexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-directconnect-exception-directconnectexception-top.md)
