...
## ApplicationSignalsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon CloudWatch Application Signals** service.

### Table of Contents  [header link](class-aws-applicationsignals-exception-applicationsignalsexception-toc.md)

#### Methods  [header link](class-aws-applicationsignals-exception-applicationsignalsexception-toc-methods.md)
...
### Methods  [header link](class-aws-applicationsignals-exception-applicationsignalsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-applicationsignals-exception-applicationsignalsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-applicationsignals-exception-applicationsignalsexception-top.md)
