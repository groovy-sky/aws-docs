...
- [Exception](namespace-aws-cleanrooms-exception.md)

## CleanRoomsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Clean Rooms Service** service.

### Table of Contents  [header link](class-aws-cleanrooms-exception-cleanroomsexception-toc.md)

#### Methods  [header link](class-aws-cleanrooms-exception-cleanroomsexception-toc-methods.md)
...
### Methods  [header link](class-aws-cleanrooms-exception-cleanroomsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cleanrooms-exception-cleanroomsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cleanrooms-exception-cleanroomsexception-top.md)
