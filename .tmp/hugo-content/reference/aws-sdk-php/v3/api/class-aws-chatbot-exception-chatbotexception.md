...
- [Exception](namespace-aws-chatbot-exception.md)

## ChatbotException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **chatbot** service.

### Table of Contents  [header link](class-aws-chatbot-exception-chatbotexception-toc.md)

#### Methods  [header link](class-aws-chatbot-exception-chatbotexception-toc-methods.md)
...
### Methods  [header link](class-aws-chatbot-exception-chatbotexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-chatbot-exception-chatbotexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-chatbot-exception-chatbotexception-top.md)
