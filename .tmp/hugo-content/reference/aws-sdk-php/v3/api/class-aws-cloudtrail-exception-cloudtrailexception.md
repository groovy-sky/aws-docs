...
## CloudTrailException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the AWS CloudTrail service.

### Table of Contents  [header link](class-aws-cloudtrail-exception-cloudtrailexception-toc.md)

#### Methods  [header link](class-aws-cloudtrail-exception-cloudtrailexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudtrail-exception-cloudtrailexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudtrail-exception-cloudtrailexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudtrail-exception-cloudtrailexception-top.md)
