...
## ECRPublicException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Elastic Container Registry Public** service.

### Table of Contents  [header link](class-aws-ecrpublic-exception-ecrpublicexception-toc.md)

#### Methods  [header link](class-aws-ecrpublic-exception-ecrpublicexception-toc-methods.md)
...
### Methods  [header link](class-aws-ecrpublic-exception-ecrpublicexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-ecrpublic-exception-ecrpublicexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-ecrpublic-exception-ecrpublicexception-top.md)
