...
### Table of Contents  [header link](class-aws-s3control-exception-s3controlexception-toc.md)

#### Methods  [header link](class-aws-s3control-exception-s3controlexception-toc-methods.md)
...
### Methods  [header link](class-aws-s3control-exception-s3controlexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-s3control-exception-s3controlexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-s3control-exception-s3controlexception-top.md)
