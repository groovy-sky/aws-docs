...
## AcmException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Certificate Manager** service.

### Table of Contents  [header link](class-aws-acm-exception-acmexception-toc.md)

#### Methods  [header link](class-aws-acm-exception-acmexception-toc-methods.md)
...
### Methods  [header link](class-aws-acm-exception-acmexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-acm-exception-acmexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-acm-exception-acmexception-top.md)
