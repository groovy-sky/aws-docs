...
## CleanRoomsMLException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **cleanrooms-ml** service.

### Table of Contents  [header link](class-aws-cleanroomsml-exception-cleanroomsmlexception-toc.md)

#### Methods  [header link](class-aws-cleanroomsml-exception-cleanroomsmlexception-toc-methods.md)
...
### Methods  [header link](class-aws-cleanroomsml-exception-cleanroomsmlexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cleanroomsml-exception-cleanroomsmlexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cleanroomsml-exception-cleanroomsmlexception-top.md)
