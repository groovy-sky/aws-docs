...
- [Exception](namespace-aws-backupsearch-exception.md)

## BackupSearchException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Backup Search** service.

### Table of Contents  [header link](class-aws-backupsearch-exception-backupsearchexception-toc.md)

#### Methods  [header link](class-aws-backupsearch-exception-backupsearchexception-toc-methods.md)
...
### Methods  [header link](class-aws-backupsearch-exception-backupsearchexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-backupsearch-exception-backupsearchexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-backupsearch-exception-backupsearchexception-top.md)
