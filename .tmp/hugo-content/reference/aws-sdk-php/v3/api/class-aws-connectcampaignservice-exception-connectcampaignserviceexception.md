...
## ConnectCampaignServiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AmazonConnectCampaignService** service.

### Table of Contents  [header link](class-aws-connectcampaignservice-exception-connectcampaignserviceexception-toc.md)

#### Methods  [header link](class-aws-connectcampaignservice-exception-connectcampaignserviceexception-toc-methods.md)
...
### Methods  [header link](class-aws-connectcampaignservice-exception-connectcampaignserviceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-connectcampaignservice-exception-connectcampaignserviceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-connectcampaignservice-exception-connectcampaignserviceexception-top.md)
