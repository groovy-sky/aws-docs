...
## AuditManagerException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Audit Manager** service.

### Table of Contents  [header link](class-aws-auditmanager-exception-auditmanagerexception-toc.md)

#### Methods  [header link](class-aws-auditmanager-exception-auditmanagerexception-toc-methods.md)
...
### Methods  [header link](class-aws-auditmanager-exception-auditmanagerexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-auditmanager-exception-auditmanagerexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-auditmanager-exception-auditmanagerexception-top.md)
