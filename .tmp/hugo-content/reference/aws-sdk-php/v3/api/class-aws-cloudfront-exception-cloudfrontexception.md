...
## CloudFrontException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon CloudFront service.

### Table of Contents  [header link](class-aws-cloudfront-exception-cloudfrontexception-toc.md)

#### Methods  [header link](class-aws-cloudfront-exception-cloudfrontexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudfront-exception-cloudfrontexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudfront-exception-cloudfrontexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudfront-exception-cloudfrontexception-top.md)
