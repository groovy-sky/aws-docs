...
- [Exception](namespace-aws-ssm-exception.md)
...
### Table of Contents  [header link](class-aws-ssm-exception-ssmexception-toc.md)

#### Methods  [header link](class-aws-ssm-exception-ssmexception-toc-methods.md)
...
### Methods  [header link](class-aws-ssm-exception-ssmexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-ssm-exception-ssmexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-ssm-exception-ssmexception-top.md)
