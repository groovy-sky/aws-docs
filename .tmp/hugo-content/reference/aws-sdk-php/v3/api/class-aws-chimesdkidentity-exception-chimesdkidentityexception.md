...
- [Exception](namespace-aws-chimesdkidentity-exception.md)

## ChimeSDKIdentityException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Chime SDK Identity** service.

### Table of Contents  [header link](class-aws-chimesdkidentity-exception-chimesdkidentityexception-toc.md)

#### Methods  [header link](class-aws-chimesdkidentity-exception-chimesdkidentityexception-toc-methods.md)
...
### Methods  [header link](class-aws-chimesdkidentity-exception-chimesdkidentityexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-chimesdkidentity-exception-chimesdkidentityexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-chimesdkidentity-exception-chimesdkidentityexception-top.md)
