...
- [Exception](namespace-aws-odb-exception.md)
...
### Table of Contents  [header link](class-aws-odb-exception-odbexception-toc.md)

#### Methods  [header link](class-aws-odb-exception-odbexception-toc-methods.md)
...
### Methods  [header link](class-aws-odb-exception-odbexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-odb-exception-odbexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-odb-exception-odbexception-top.md)
