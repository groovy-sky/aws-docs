...
## DatabaseMigrationServiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Database Migration Service** service.

### Table of Contents  [header link](class-aws-databasemigrationservice-exception-databasemigrationserviceexception-toc.md)

#### Methods  [header link](class-aws-databasemigrationservice-exception-databasemigrationserviceexception-toc-methods.md)
...
### Methods  [header link](class-aws-databasemigrationservice-exception-databasemigrationserviceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-databasemigrationservice-exception-databasemigrationserviceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-databasemigrationservice-exception-databasemigrationserviceexception-top.md)
