...
## CloudFrontKeyValueStoreException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon CloudFront KeyValueStore** service.

### Table of Contents  [header link](class-aws-cloudfrontkeyvaluestore-exception-cloudfrontkeyvaluestoreexception-toc.md)

#### Methods  [header link](class-aws-cloudfrontkeyvaluestore-exception-cloudfrontkeyvaluestoreexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudfrontkeyvaluestore-exception-cloudfrontkeyvaluestoreexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudfrontkeyvaluestore-exception-cloudfrontkeyvaluestoreexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudfrontkeyvaluestore-exception-cloudfrontkeyvaluestoreexception-top.md)
