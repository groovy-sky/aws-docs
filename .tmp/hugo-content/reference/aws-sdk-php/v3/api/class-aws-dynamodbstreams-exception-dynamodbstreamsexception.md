...
- [Exception](namespace-aws-dynamodbstreams-exception.md)

## DynamoDbStreamsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Amazon DynamoDB Streams service.

### Table of Contents  [header link](class-aws-dynamodbstreams-exception-dynamodbstreamsexception-toc.md)

#### Methods  [header link](class-aws-dynamodbstreams-exception-dynamodbstreamsexception-toc-methods.md)
...
### Methods  [header link](class-aws-dynamodbstreams-exception-dynamodbstreamsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-dynamodbstreams-exception-dynamodbstreamsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-dynamodbstreams-exception-dynamodbstreamsexception-top.md)
