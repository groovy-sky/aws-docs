...
## CodeConnectionsException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS CodeConnections** service.

### Table of Contents  [header link](class-aws-codeconnections-exception-codeconnectionsexception-toc.md)

#### Methods  [header link](class-aws-codeconnections-exception-codeconnectionsexception-toc-methods.md)
...
### Methods  [header link](class-aws-codeconnections-exception-codeconnectionsexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codeconnections-exception-codeconnectionsexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codeconnections-exception-codeconnectionsexception-top.md)
