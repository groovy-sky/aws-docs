...
## S3SignatureV4     extends [SignatureV4](class-aws-signature-signaturev4.md)   in package    - [Aws](package-aws.md)       Uses  [SignatureTrait](class-aws-signature-signaturetrait.md)

Amazon S3 signature version 4 support.

### Table of Contents  [header link](class-aws-signature-s3signaturev4-toc.md)

#### Constants  [header link](class-aws-signature-s3signaturev4-toc-constants.md)
...
#### Methods  [header link](class-aws-signature-s3signaturev4-toc-methods.md)
...
query string.[presign()](class-aws-signature-s3signaturev4-method-presign.md)
: [RequestInterface](class-psr-http-message-requestinterface.md)Always add a x-amz-content-sha-256 for data integrity.[signRequest()](class-aws-signature-s3signaturev4-method-signrequest.md)
...
### Constants  [header link](class-aws-signature-s3signaturev4-constants.md)
...
### Methods  [header link](class-aws-signature-s3signaturev4-methods.md)
...
#### presign()  [header link](class-aws-signature-s3signaturev4-method-presign.md)
...
#### signRequest()  [header link](class-aws-signature-s3signaturev4-method-signrequest.md)
...
- Table Of Contents
  - [Constants](class-aws-signature-s3signaturev4-toc-constants.md)
  - [Methods](class-aws-signature-s3signaturev4-toc-methods.md)
- Constants
  - [AMZ\_CONTENT\_SHA256\_HEADER](class-aws-signature-signaturev4-constant-amz-content-sha256-header.md)
...
- Methods
  ...
  - [presign()](class-aws-signature-s3signaturev4-method-presign.md)
  - [signRequest()](class-aws-signature-s3signaturev4-method-signrequest.md)

[Back To Top](class-aws-signature-s3signaturev4-top.md)
