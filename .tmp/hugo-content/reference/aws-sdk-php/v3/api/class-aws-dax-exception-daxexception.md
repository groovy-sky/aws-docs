...
## DAXException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon DynamoDB Accelerator (DAX)** service.

### Table of Contents  [header link](class-aws-dax-exception-daxexception-toc.md)

#### Methods  [header link](class-aws-dax-exception-daxexception-toc-methods.md)
...
### Methods  [header link](class-aws-dax-exception-daxexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-dax-exception-daxexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-dax-exception-daxexception-top.md)
