...
## ApplicationDiscoveryServiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS Application Discovery Service** service.

### Table of Contents  [header link](class-aws-applicationdiscoveryservice-exception-applicationdiscoveryserviceexception-toc.md)

#### Methods  [header link](class-aws-applicationdiscoveryservice-exception-applicationdiscoveryserviceexception-toc-methods.md)
...
### Methods  [header link](class-aws-applicationdiscoveryservice-exception-applicationdiscoveryserviceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-applicationdiscoveryservice-exception-applicationdiscoveryserviceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-applicationdiscoveryservice-exception-applicationdiscoveryserviceexception-top.md)
