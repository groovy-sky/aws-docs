...
##### Tags  [header link](class-aws-s3-crypto-s3encryptionmultipartuploader-tags.md)

deprecated

### Table of Contents  [header link](class-aws-s3-crypto-s3encryptionmultipartuploader-toc.md)

#### Constants  [header link](class-aws-s3-crypto-s3encryptionmultipartuploader-toc-constants.md)

[CRYPTO\_VERSION](class-aws-s3-crypto-s3encryptionmultipartuploader-constant-crypto-version.md)
= '1n' [PART\_MAX\_NUM](class-aws-s3-multipartuploader-constant-part-max-num.md)
...
#### Methods  [header link](class-aws-s3-crypto-s3encryptionmultipartuploader-toc-methods.md)

[\_\_construct()](class-aws-s3-crypto-s3encryptionmultipartuploader-method-construct.md)
...
service for the specified upload's information.[isSupportedCipher()](class-aws-s3-crypto-s3encryptionmultipartuploader-method-issupportedcipher.md)
: bool Returns if the passed cipher name is supported for encryption by the SDK.

### Constants  [header link](class-aws-s3-crypto-s3encryptionmultipartuploader-constants.md)

#### CRYPTO\_VERSION  [header link](class-aws-s3-crypto-s3encryptionmultipartuploader-constant-crypto-version.md)
...
### Methods  [header link](class-aws-s3-crypto-s3encryptionmultipartuploader-methods.md)

#### \_\_construct()  [header link](class-aws-s3-crypto-s3encryptionmultipartuploader-method-construct.md)
...
#### isSupportedCipher()  [header link](class-aws-s3-crypto-s3encryptionmultipartuploader-method-issupportedcipher.md)
...
- Table Of Contents
  - [Constants](class-aws-s3-crypto-s3encryptionmultipartuploader-toc-constants.md)
  - [Methods](class-aws-s3-crypto-s3encryptionmultipartuploader-toc-methods.md)
- Constants
  - [CRYPTO\_VERSION](class-aws-s3-crypto-s3encryptionmultipartuploader-constant-crypto-version.md)
...
- Methods
  ...
  - [isSupportedCipher()](class-aws-s3-crypto-s3encryptionmultipartuploader-method-issupportedcipher.md)

[Back To Top](class-aws-s3-crypto-s3encryptionmultipartuploader-top.md)
