...
## AccessAnalyzerException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Access Analyzer** service.

### Table of Contents  [header link](class-aws-accessanalyzer-exception-accessanalyzerexception-toc.md)

#### Methods  [header link](class-aws-accessanalyzer-exception-accessanalyzerexception-toc-methods.md)
...
### Methods  [header link](class-aws-accessanalyzer-exception-accessanalyzerexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-accessanalyzer-exception-accessanalyzerexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-accessanalyzer-exception-accessanalyzerexception-top.md)
