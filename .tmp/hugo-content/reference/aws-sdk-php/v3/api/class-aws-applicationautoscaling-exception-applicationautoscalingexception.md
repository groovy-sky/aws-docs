...
## ApplicationAutoScalingException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Application Auto Scaling** service.

### Table of Contents  [header link](class-aws-applicationautoscaling-exception-applicationautoscalingexception-toc.md)

#### Methods  [header link](class-aws-applicationautoscaling-exception-applicationautoscalingexception-toc-methods.md)
...
### Methods  [header link](class-aws-applicationautoscaling-exception-applicationautoscalingexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-applicationautoscaling-exception-applicationautoscalingexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-applicationautoscaling-exception-applicationautoscalingexception-top.md)
