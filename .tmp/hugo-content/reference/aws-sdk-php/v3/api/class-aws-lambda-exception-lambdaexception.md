...
### Table of Contents  [header link](class-aws-lambda-exception-lambdaexception-toc.md)

#### Methods  [header link](class-aws-lambda-exception-lambdaexception-toc-methods.md)
...
### Methods  [header link](class-aws-lambda-exception-lambdaexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-lambda-exception-lambdaexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception.md#method___construct)
...
[Back To Top](class-aws-lambda-exception-lambdaexception-top.md)
