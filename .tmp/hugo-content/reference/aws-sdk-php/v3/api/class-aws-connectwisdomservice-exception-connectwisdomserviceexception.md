...
## ConnectWisdomServiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Connect Wisdom Service** service.

### Table of Contents  [header link](class-aws-connectwisdomservice-exception-connectwisdomserviceexception-toc.md)

#### Methods  [header link](class-aws-connectwisdomservice-exception-connectwisdomserviceexception-toc-methods.md)
...
### Methods  [header link](class-aws-connectwisdomservice-exception-connectwisdomserviceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-connectwisdomservice-exception-connectwisdomserviceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-connectwisdomservice-exception-connectwisdomserviceexception-top.md)
