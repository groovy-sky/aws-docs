...
- [Exception](namespace-aws-connect-exception.md)

## ConnectException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Connect Service** service.

### Table of Contents  [header link](class-aws-connect-exception-connectexception-toc.md)

#### Methods  [header link](class-aws-connect-exception-connectexception-toc-methods.md)
...
### Methods  [header link](class-aws-connect-exception-connectexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-connect-exception-connectexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-connect-exception-connectexception-top.md)
