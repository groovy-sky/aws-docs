...
## CodeCommitException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **AWS CodeCommit** service.

### Table of Contents  [header link](class-aws-codecommit-exception-codecommitexception-toc.md)

#### Methods  [header link](class-aws-codecommit-exception-codecommitexception-toc-methods.md)
...
### Methods  [header link](class-aws-codecommit-exception-codecommitexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-codecommit-exception-codecommitexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-codecommit-exception-codecommitexception-top.md)
