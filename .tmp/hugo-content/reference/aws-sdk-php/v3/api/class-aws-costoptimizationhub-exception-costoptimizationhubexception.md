...
## CostOptimizationHubException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Cost Optimization Hub** service.

### Table of Contents  [header link](class-aws-costoptimizationhub-exception-costoptimizationhubexception-toc.md)

#### Methods  [header link](class-aws-costoptimizationhub-exception-costoptimizationhubexception-toc-methods.md)
...
### Methods  [header link](class-aws-costoptimizationhub-exception-costoptimizationhubexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-costoptimizationhub-exception-costoptimizationhubexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-costoptimizationhub-exception-costoptimizationhubexception-top.md)
