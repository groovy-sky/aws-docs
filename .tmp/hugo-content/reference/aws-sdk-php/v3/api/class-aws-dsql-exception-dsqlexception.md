...
## DSQLException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Aurora DSQL** service.

### Table of Contents  [header link](class-aws-dsql-exception-dsqlexception-toc.md)

#### Methods  [header link](class-aws-dsql-exception-dsqlexception-toc-methods.md)
...
### Methods  [header link](class-aws-dsql-exception-dsqlexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-dsql-exception-dsqlexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-dsql-exception-dsqlexception-top.md)
