...
- [Exception](namespace-aws-comprehend-exception.md)

## ComprehendException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **Amazon Comprehend** service.

### Table of Contents  [header link](class-aws-comprehend-exception-comprehendexception-toc.md)

#### Methods  [header link](class-aws-comprehend-exception-comprehendexception-toc-methods.md)
...
### Methods  [header link](class-aws-comprehend-exception-comprehendexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-comprehend-exception-comprehendexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-comprehend-exception-comprehendexception-top.md)
