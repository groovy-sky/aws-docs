...
## ElasticLoadBalancingException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the Elastic Load Balancing service.

### Table of Contents  [header link](class-aws-elasticloadbalancing-exception-elasticloadbalancingexception-toc.md)

#### Methods  [header link](class-aws-elasticloadbalancing-exception-elasticloadbalancingexception-toc-methods.md)
...
### Methods  [header link](class-aws-elasticloadbalancing-exception-elasticloadbalancingexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-elasticloadbalancing-exception-elasticloadbalancingexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-elasticloadbalancing-exception-elasticloadbalancingexception-top.md)
