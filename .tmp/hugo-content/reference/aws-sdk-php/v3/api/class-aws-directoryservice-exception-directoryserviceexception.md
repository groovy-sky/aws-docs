...
## DirectoryServiceException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

AWS Directory Service Exception

### Table of Contents  [header link](class-aws-directoryservice-exception-directoryserviceexception-toc.md)

#### Methods  [header link](class-aws-directoryservice-exception-directoryserviceexception-toc-methods.md)
...
### Methods  [header link](class-aws-directoryservice-exception-directoryserviceexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-directoryservice-exception-directoryserviceexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-directoryservice-exception-directoryserviceexception-top.md)
