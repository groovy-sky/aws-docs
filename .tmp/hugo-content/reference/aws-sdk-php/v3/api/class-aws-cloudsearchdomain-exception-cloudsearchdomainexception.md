...
## CloudSearchDomainException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with an Amazon CloudSearch Domain.

### Table of Contents  [header link](class-aws-cloudsearchdomain-exception-cloudsearchdomainexception-toc.md)

#### Methods  [header link](class-aws-cloudsearchdomain-exception-cloudsearchdomainexception-toc-methods.md)
...
### Methods  [header link](class-aws-cloudsearchdomain-exception-cloudsearchdomainexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-cloudsearchdomain-exception-cloudsearchdomainexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-cloudsearchdomain-exception-cloudsearchdomainexception-top.md)
