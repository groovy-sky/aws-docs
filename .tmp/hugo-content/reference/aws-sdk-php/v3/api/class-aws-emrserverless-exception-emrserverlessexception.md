...
## EMRServerlessException     extends [AwsException](class-aws-exception-awsexception.md)   in package    - [Aws](package-aws.md)

Represents an error interacting with the **EMR Serverless** service.

### Table of Contents  [header link](class-aws-emrserverless-exception-emrserverlessexception-toc.md)

#### Methods  [header link](class-aws-emrserverless-exception-emrserverlessexception-toc-methods.md)
...
### Methods  [header link](class-aws-emrserverless-exception-emrserverlessexception-methods.md)
...
- Table Of Contents
  - [Methods](class-aws-emrserverless-exception-emrserverlessexception-toc-methods.md)
- Methods
  - [\_\_construct()](class-aws-exception-awsexception-method-construct.md)
...
[Back To Top](class-aws-emrserverless-exception-emrserverlessexception-top.md)
