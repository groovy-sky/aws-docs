...
can't use `SpotFleetLaunchSpecification`; you must use [LaunchTemplateConfig](api-launchtemplateconfig.md).
...
Type: [SpotFleetMonitoring](api-spotfleetmonitoring.md) object
...
You must use [LaunchTemplateConfig](api-launchtemplateconfig.md) instead.
...
Type: Array of [SpotFleetTagSpecification](api-spotfleettagspecification.md) objects
...
_unit_ hour (where the instance price is divided by the specified
...
- [AWS SDK for C++](../../../goto/sdkforcpp/ec2-2016-11-15/spotfleetlaunchspecification.md)

- [AWS SDK for Java V2](../../../goto/sdkforjavav2/ec2-2016-11-15/spotfleetlaunchspecification.md)

- [AWS SDK for Ruby V3](../../../goto/sdkforrubyv3/ec2-2016-11-15/spotfleetlaunchspecification.md)
