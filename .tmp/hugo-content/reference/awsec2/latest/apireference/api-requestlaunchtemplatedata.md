...
see [Enable stop protection for your EC2 instances](../../../../services/ec2/latest/userguide/ec2-stop-protection.md) in the
_Amazon EC2 User Guide_.
...
The instance type. For more information, see [Amazon EC2 instance types](../../../../services/ec2/latest/userguide/instance-types.md) in
...
information, see [User provided kernels](../../../../services/linux/al2/ug/userprovidedkernels.md) in the
...
The name of the key pair. You can create a key pair using [CreateKeyPair](api-createkeypair.md) or
...
instance with user data input](../../../../services/ec2/latest/userguide/user-data.md) in the
_Amazon EC2 User Guide_.
