...
Amazon S3. Application requests made to a Multi-Region Access Point global endpoint use [AWS Global Accelerator](../../../global-accelerator/latest/dg.md) to automatically route over the AWS
...
more information, see [Backing up your Amazon S3 data](backup-for-s3.md).
