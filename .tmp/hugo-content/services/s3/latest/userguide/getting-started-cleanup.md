...
resources that you allocated so that you no longer accrue charges. After you delete your
AWS resources, your website is no longer available.
...
disabled distribution at any time. After you delete a disabled distribution, it is no
longer available.
...
Before you delete the hosted zone, you must delete the record sets that you created.
You don't need to delete the NS and SOA records; these are automatically deleted when
you delete the hosted zone.
...
2. In the list of domain names, select your domain name, and then choose
    **Go to Record Sets**.

3. In the list of record sets, select the _A_ records that you
    created.
...
1. Continuing from the previous procedure, choose **Back to Hosted**
**Zones**.

2. Select your domain name, and then choose **Delete Hosted**
**Zone**.
...
2. Under **Buckets**, choose your bucket name, and then choose
    **Properties**.
