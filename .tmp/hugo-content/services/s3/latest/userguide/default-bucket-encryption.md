...
[Quotas](../../../kms/latest/developerguide/limits.md) in the _AWS Key Management Service Developer Guide_.
...
encryption KMS keys](../../../kms/latest/developerguide/concepts.md#symmetric-cmks) in the
_AWS Key Management Service Developer Guide_.
...
For more information, see [PutBucketEncryption](../api/restbucketputencryption.md) in the _Amazon Simple Storage Service API Reference_.
