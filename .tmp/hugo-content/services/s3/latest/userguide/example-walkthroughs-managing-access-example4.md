...
[Sign in to the AWS Management Console as an IAM user](../../../iam/latest/userguide/getting-started-how-users-sign-in.md) in the
_IAM User Guide_.
...
11. Choose **Show policy document** and verify the trust
    ...
    The following trust policy establishes trust with Account C, by allowing
     it the `sts:AssumeRole` action. For more information, see [AssumeRole](../../../../reference/sts/latest/apireference/api-assumerole.md)
...
For step-by-step instructions, see
    [Creating IAM users (AWS Management Console)](../../../iam/latest/userguide/id-users-create.md#id_users_create_console) in the _IAM User Guide_.
...
A. For step-by-step instructions, see [Deleting an IAM user](../../../iam/latest/userguide/id-users-manage.md#id_users_deleting) in the
_IAM User Guide_.
...
- [Creating a role to\
delegate permissions to an IAM user](../../../iam/latest/userguide/id-roles-create-for-user.md)

- [Tutorial:\
Delegate Access Across AWS accounts Using IAM Roles](../../../iam/latest/userguide/tutorial-cross-account-with-roles.md)

- [Managing IAM\
policies](../../../iam/latest/userguide/access-policies-manage.md)
