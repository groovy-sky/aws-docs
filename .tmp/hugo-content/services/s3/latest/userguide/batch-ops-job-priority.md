...
For more information about job priority, see [Assigning job priority](batch-ops-job-priority.md).

For examples of how to update job priority with the AWS SDK for Java, see [Update the priority of a batch job](../api/s3-control-example-s3-control-updatejobpriority-section.md) in the _Amazon S3 API Reference_.
