...
- [Effect](../../../iam/latest/userguide/reference-policies-elements-effect.md) – What the effect will be when the user
...
Policy Elements: Effect](../../../iam/latest/userguide/reference-policies-elements-effect.md) in the
_IAM User Guide_.
...
For complete policy language information, see [Policies and permissions in IAM](../../../iam/latest/userguide/access-policies.md) and
...
permissions. For more information, see [AWS security credentials](../../../../general/latest/gr/root-vs-iam.md) and
