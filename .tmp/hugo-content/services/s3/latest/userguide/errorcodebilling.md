...
more information, see [REST Authentication](restauthentication.md) and [SOAP\
Authentication](soapauthentication.md).NotSignedUpYour account is not signed up for the Amazon S3 service. You must sign up before you can use
