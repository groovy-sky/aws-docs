...
zone as described in [Tutorial: Configuring a static website using a custom domain registered with Route 53](website-hosting-custom-domain-walkthrough.md), you must clean up the Route 53
hosted zone settings that are related to the bucket. For more information, see [Step 2: Delete the Route 53 hosted zone](getting-started-cleanup.md#getting-started-cleanup-route53).
...
your Classic Load Balancer](../../../elasticloadbalancing/latest/classic/access-log-collection.md) in the _User Guide for Classic Load Balancers_ and [Access logs for your\
Application Load Balancer](../../../elasticloadbalancing/latest/application/load-balancer-access-logs.md) in the _User Guide for Application Load Balancers_.
...
IAM user](../../../iam/latest/userguide/id-users-change-permissions.md) in the _IAM User Guide_. For troubleshooting information,
...
policies](../../../organizations/latest/userguide/orgs-manage-policies-scps.md) and [resource control\
policies](../../../organizations/latest/userguide/orgs-manage-policies-rcps.md) in the _AWS Organizations User Guide_.
...
an AWS SDK or CLI](../api/s3-example-s3-deletebucket-section.md) in the _Amazon Simple Storage Service API Reference_. For information
...
For examples of how to delete a bucket with the AWS SDK for Java, see [Delete a bucket](../api/s3-example-s3-deletebucket-section.md) in the _Amazon S3 API Reference_.
...
versions](deletingobjectversions.md).
...
High-Level S3 Commands with the AWS Command Line Interface](../../../cli/latest/userguide/using-s3-commands.md) in the _AWS Command Line Interface User Guide_.
