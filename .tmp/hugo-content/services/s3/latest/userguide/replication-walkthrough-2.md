...
1. In this example, you create source and destination buckets in two different
    ...
    information about setting credential profiles and using named profiles, see [Configuration and credential file settings](../../../cli/latest/userguide/cli-configure-files.md) in the _AWS Command Line Interface User Guide_.
