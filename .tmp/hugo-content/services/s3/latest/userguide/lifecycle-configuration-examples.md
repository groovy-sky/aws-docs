...
parts. For more information about multipart uploads, see [Uploading and copying objects using multipart upload in Amazon S3](mpuoverview.md).
...
header in a [PutBucketLifecycleConfiguration](../api/api-putbucketlifecycleconfiguration.md) request.

The following example shows how to use the
`x-amz-transition-object-size-minimum-default` header in a [PutBucketLifecycleConfiguration](../api/api-putbucketlifecycleconfiguration.md) request to apply the
