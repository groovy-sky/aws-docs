...
For additional information on block public access at an organization level, see [S3 policy](../../../organizations/latest/userguide/orgs-manage-policies-s3.md) in the _AWS Organizations user_
_guide_.
...
Policy Variable](../../../iam/latest/userguide/reference-policies-variables.md)) for one or more of the following:
...
When using [multivalued context keys](../../../iam/latest/userguide/reference-policies-condition-single-vs-multi-valued-context-keys.md), you must use the `ForAllValues` or
