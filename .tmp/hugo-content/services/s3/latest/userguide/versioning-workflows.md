...
the versioning state of the bucket. For more information, see [Configuring MFA delete](multifactorauthenticationdelete.md).
...
information, see the S3 Versioning section of [Troubleshooting versioning](troubleshooting-versioning.md).
