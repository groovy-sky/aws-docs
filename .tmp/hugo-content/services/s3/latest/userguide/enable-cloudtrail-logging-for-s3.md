...
of specific buckets, you must [create a trail manually in CloudTrail](../../../awscloudtrail/latest/userguide/cloudtrail-create-a-trail-using-the-console-first-time.md).
...
that you're monitoring. For more information, see [What is AWS Organizations?](../../../organizations/latest/userguide/orgs-introduction.md) in the
...
information, see [AWS CLI examples for filtering data events](../../../awscloudtrail/latest/userguide/filtering-data-events.md#filtering-data-events-deleteobjects) in the _AWS CloudTrail_
_User Guide_.
...
[Logging data events](../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md) in the _AWS CloudTrail User Guide_.

To disable CloudTrail data events logging for objects in an S3 bucket, see [Deleting a trail with the CloudTrail console](../../../awscloudtrail/latest/userguide/cloudtrail-delete-trails-console.md) in the
_AWS CloudTrail User Guide_.
...
files](../../../awscloudtrail/latest/userguide/cloudtrail-working-with-log-files.md) in the _AWS CloudTrail User Guide_
