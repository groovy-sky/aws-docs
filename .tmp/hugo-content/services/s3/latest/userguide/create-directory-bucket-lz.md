...
`--x-s3`. You can obtain a list of Local Zone IDs by using the [DescribeAvailabilityZones](../../../../reference/awsec2/latest/apireference/api-describeavailabilityzones.md) API operation.
...
your IAM policies. For more information, see [Authenticating and authorizing for directory buckets in Local Zones](iam-directory-bucket-lz.md).
...
For a list of Regions that support directory buckets, see [Regional and Zonal endpoints for directory buckets](s3-express-regions-and-zones.md).
