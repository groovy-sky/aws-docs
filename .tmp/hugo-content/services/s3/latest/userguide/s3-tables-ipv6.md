...
For a complete list of endpoints for S3 Tables, see [Amazon Simple Storage Service endpoints and quotas](../../../../general/latest/gr/s3.md).
...
To use the dual-stack endpoint in the AWS CLI, see [Using dual-stack endpoints from the AWS CLI](../api/dual-stack-endpoints.md#dual-stack-endpoints-cli).
