...
stored in, you can use Amazon S3 Storage Lens. For more information, see [Monitoring your storage activity and usage with Amazon S3 Storage Lens](storage-lens.md) and [Amazon S3 Storage Lens metrics glossary](storage-lens-metrics-glossary.md).
...
[HeadObject](../api/api-headobject.md) or [GetObject](../api/api-getobject.md) API
operations)
...
**versions**. For more information, see [Listing objects in a versioning-enabled bucket](list-obj-version-enabled-bucket.md).

The following figure shows that a [ListObjectsV2](../api/api-listobjectsv2.md) or
