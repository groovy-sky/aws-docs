...
_tags_. With job tags, you can control access to your Batch Operations jobs and enforce
...
[AWS Identity and Access Management (IAM) policy language](../../../iam/latest/userguide/access-iam-tags.md). For
...
control (ABAC)](../../../iam/latest/userguide/introduction-attribute-based-access-control.md). ABAC is an IAM authorization strategy that defines permissions by
...
Managing Object Lock with Batch Operations
