...
AWS Identity and Access Management (IAM) principals is to define [IAM permission policies](user-policies.md) and
[S3\
...
IAM principals allowed per account](../../../../general/latest/gr/iam-service.md).
...
broker](../../../iam/latest/userguide/id-roles-common-scenarios-federated-users.md) pattern, in which you implement access-decision logic and dynamically
...
propagation](../../../singlesignon/latest/userguide/trustedidentitypropagation.md) feature of AWS IAM Identity Center, your applications can make requests to
...
trusted identity propagation, each [AWS CloudTrail](../../../awscloudtrail/latest/userguide/cloudtrail-user-guide.md) data
