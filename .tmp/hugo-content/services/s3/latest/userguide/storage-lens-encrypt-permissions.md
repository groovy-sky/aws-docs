...
- [Create a\
KMS key](../../../kms/latest/developerguide/create-keys.md)

- [Key\
policies in AWS KMS](../../../kms/latest/developerguide/key-policies.md)

You can also use the AWS KMS `PUT` key policy API operation ( [PutKeyPolicy](../../../../reference/kms/latest/apireference/api-putkeypolicy.md)) to copy the key policy to the customer managed keys that you want
