...
encrypted with the default settings for the table bucket. For more information, see [Specifying encryption for tables](s3-tables-kms-specify.md#specify-kms-table).
...
see [Permission requirements for S3 Tables SSE-KMS encryption](s3-tables-kms-permissions.md)
...
specify a table when granting these permissions. For more information, see [Granting Lake Formation permission on a table or database](grant-permissions-tables.md#grant-lf-table).
