...
asymmetric KMS keys](../../../kms/latest/developerguide/find-symm-asymm.md) in the
_AWS Key Management Service Developer Guide_.
...
[customer managed\
AWS KMS key](../../../kms/latest/developerguide/concepts.md#customer-cmk) that you created. If you specify
