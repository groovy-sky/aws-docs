...
- [list-multipart-uploads](../../../cli/latest/reference/s3api/list-multipart-uploads.md)‐list in-progress multipart uploads.
...
For examples of how to list multipart uploads with the AWS SDK for Java, see [List multipart uploads](../api/s3-example-s3-listmultipartuploads-section.md) in the _Amazon S3 API Reference_.
