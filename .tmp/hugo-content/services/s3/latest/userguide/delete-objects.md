...
Object](../api/restobjectdelete.md). For more information about using the CLI to delete an object,
...
requires it, you can send REST requests directly. For more information, see [DELETE Object](../api/restobjectdelete.md) in the
...
Object](../api/restobjectdelete.md) in the _Amazon Simple Storage Service API Reference_
...
For more examples, and examples in other languages, see [Use `DeleteObject` with an AWS SDK or CLI](../api/s3-example-s3-deleteobject-section.md) in the _Amazon S3 API reference_.
...
For examples of how to delete a single object with the AWS SDK for Java, see [Delete an object](../api/s3-example-s3-deleteobject-section.md) in the _Amazon S3 API Reference_.
...
object from a versioned bucket, see [Using the REST API](deletinganobjectsusingrest.md).
