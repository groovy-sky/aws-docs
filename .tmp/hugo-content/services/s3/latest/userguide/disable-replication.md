...
a bucket, see [Using the S3 console](replication-walkthrough1.md#enable-replication).
...
5. You can change your replication rules in the following ways:
   - To enable or disable a replication rule, choose the option button to the left of the
     ...
     see [Replicating existing objects with Batch Replication](s3-batch-replication-batch.md).
...
[aws:s3:bucket-pause-replication](../../../fis/latest/userguide/fis-actions-reference.md#bucket-pause-replication) and [Pause S3 Replication](../../../fis/latest/userguide/cross-region-scenario.md#cross-region-scenario-actions-pause-s3-replication) in the _AWS Fault Injection Service User_
_Guide_.
...
S3 Batch Replication. For more information, see [Replicating existing objects with Batch Replication](s3-batch-replication-batch.md).
