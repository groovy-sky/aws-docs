...
`example.com` bucket. For more information, see [Configuring a Static Website Using a Custom Domain Name](../dev/website-hosting-custom-domain-walkthrough.md).
...
[PutBucketWebsite](../api/api-putbucketwebsite.md) in the _Amazon Simple Storage Service API Reference_.
...
page requests, you can submit a [PUT Object - Copy](../api/restobjectcopy.md)
...
When you retrieve the object using the [GET Object](../api/restobjectget.md) action, along
