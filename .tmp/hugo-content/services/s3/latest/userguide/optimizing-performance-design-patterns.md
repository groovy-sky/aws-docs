...
Amazon S3](optimizing-performance-guidelines.md) for you to consider when planning
...
set of objects, you can use a cache such as [Amazon CloudFront](../../../cloudfront/index.md), [Amazon ElastiCache](../../../elasticache/index.md), or [AWS Elemental MediaStore](../../../mediastore/index.md) to optimize performance.
...
about MediaStore, see the [AWS Elemental MediaStore User Guide](../../../mediastore/latest/ug.md).
...
information about back-off techniques, see [Retry behavior](../../../../reference/sdkref/latest/guide/feature-retry-behavior.md) in the
...
If you are using AWS Key Management Service (AWS KMS) for server-side encryption, see [Quotas](../../../kms/latest/developerguide/limits.md) in the _AWS Key Management Service Developer Guide_
...
connections to GET or PUT data in parallel. For example, this is supported by [Amazon S3 Transfer Manager](../../../../reference/sdk-for-java/latest/developer-guide/transfer-manager.md) in the AWS Java SDK, and most of the other AWS SDKs
...
through CloudFront and to provide rapid responses to DNS queries made to [Amazon Route 53](../../../route53/index.md).
