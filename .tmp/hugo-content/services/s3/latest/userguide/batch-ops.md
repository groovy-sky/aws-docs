...
information about using Batch Operations with S3 Express One Zone and directory buckets, see [Using Batch Operations with directory buckets](directory-buckets-objects-batch-ops.md).
...
The operation is the type of API [action](../api/api-operations.md), such as copying objects, that you want the Batch Operations job to run. Each
...
information about the operations that S3 Batch Operations supports, see [Operations supported by S3 Batch Operations](batch-ops-operations.md).
...
(CSV)-formatted [Cataloging and analyzing your data with S3 Inventory](storage-inventory.md) report
...
that was performed by the job. For more information about monitoring jobs, see [Managing S3 Batch Operations jobs](batch-ops-managing-jobs.md).
