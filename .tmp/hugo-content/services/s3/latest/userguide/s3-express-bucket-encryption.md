...
about configuring default encryption, see [Configuring default encryption](default-bucket-encryption.md).
...
AWS CloudTrail, see [Monitoring default encryption with AWS CloudTrail and Amazon EventBridge](bucket-encryption-tracking.md).
