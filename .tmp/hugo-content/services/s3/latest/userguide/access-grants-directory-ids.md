...
feature. For more information, see [Trusted identity propagation across applications](../../../singlesignon/latest/userguide/trustedidentitypropagation.md).
...
provisioning](../../../singlesignon/latest/userguide/provision-automatically.md) in the _AWS IAM Identity Center User_
_Guide_.
...
you can create a local one in the same account and AWS Region as your S3 Access Grants instance. If you have an IAM Identity Center instance configured in a different AWS Region, you can also [replicate](../../../singlesignon/latest/userguide/replicate-to-additional-region.md) this instance to the same AWS Region as your S3 Access Grants instance. Such a configuration
...
- Set up [Automatic\
provisioning](../../../singlesignon/latest/userguide/provision-automatically.md) in IAM Identity Center to synchronize user and group information from
...
identity propagation across applications](../../../singlesignon/latest/userguide/trustedidentitypropagation.md) in the _AWS IAM Identity Center User Guide_.
...
instance](access-grants-instance.md). If you've already created your S3 Access Grants instance, see [Associate or disassociate your IAM Identity Center instance](access-grants-instance-idc.md).
...
credentials to S3 data](access-grants-credentials.md) on the users' behalf. Unlike IAM users and roles
