...
see [How users sign in to your account](../../../iam/latest/userguide/getting-started-how-users-sign-in.md) in
_IAM User Guide_.
...
4. In the Amazon S3 console, attach the following bucket policy to
    ...
    how to find account IDs, see [Finding your AWS account ID](../../../../general/latest/gr/acct-identifiers.md#FindingYourAccountIdentifiers).
...
1. Add user Dave credentials to the AWS CLI config file and create a new profile,
    `UserDaveAccountA`. For more information, see [Setting up the tools for the walkthroughs](policy-eval-walkthrough-download-awscli.md).
...
step-by-step instructions, see [Deleting an IAM user](../../../iam/latest/userguide/id-users-manage.md#id_users_deleting) in the
_IAM User Guide_.
