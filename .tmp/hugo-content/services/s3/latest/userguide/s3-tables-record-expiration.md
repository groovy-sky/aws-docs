...
table, see [Expiring journal table records](metadata-tables-expire-journal-table-records.md). Note that record expiration
...
Amazon S3](../api/developing-s3.md) in the _Amazon Simple Storage Service API Reference_.
...
run the [put-table-record-expiration-configuration](../../../cli/latest/reference/s3tables/put-table-record-expiration-configuration.md) command.
...
[get-table-record-expiration-job-status](../../../cli/latest/reference/s3tables/get-table-record-expiration-job-status.md) command. In your request, specify the Amazon
