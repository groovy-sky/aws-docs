...
For more information, see [Authorization policies in AWS Organizations](../../../organizations/latest/userguide/orgs-manage-policies-authorization-policies.md) in the _AWS Organizations User_
_Guide_.
...
enabling request metrics, see [Creating a CloudWatch metrics configuration for all the objects in your bucket](configure-request-metrics-bucket.md).
