...
The following AWS CLI example puts a lifecycle configuration policy on an Outposts bucket. This
...
2. Submit the JSON file as part of the
    ...
    For more information about this command, see [put-bucket-lifecycle-configuration](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/put-bucket-lifecycle-configuration.html) in the
    _AWS CLI Reference_.
...
The following SDK for Java example puts a lifecycle configuration on an Outposts bucket. This
...
For more information, see [PutBucketLifecycleConfiguration](../api/api-control-putbucketlifecycleconfiguration.md) in the
...
information about this command, see [get-bucket-lifecycle-configuration](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/get-bucket-lifecycle-configuration.html) in the _AWS CLI_
_Reference_.
...
The following SDK for Java example gets a lifecycle configuration for an Outposts bucket. For more
information, see [GetBucketLifecycleConfiguration](../api/api-control-getbucketlifecycleconfiguration.md) in the
_Amazon Simple Storage Service API Reference_.
