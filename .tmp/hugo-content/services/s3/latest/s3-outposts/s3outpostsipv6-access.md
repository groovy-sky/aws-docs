...
[S3 on Outposts object actions](../userguide/s3outpostsapi.md) (such as `PutObject` or
...
For more information, see [Using S3 on Outposts dual-stack endpoints](s3-outposts-dual-stack-endpoints.md).
...
actions](../userguide/s3outpostsapi.md) aren’t supported across IPv6 networks.
...
operations](../userguide/s3outpostsapi.md#S3OutpostsAPIsBucket) and [S3 on Outposts API\
operations](../userguide/s3outpostsapi.md#S3OutpostsAPIs) work the same way whether you’re accessing S3 on Outposts over an
IPv6 protocol or IPv4 protocol. However, be aware that [S3 on Outposts object\
actions](../userguide/s3outpostsapi.md) (such as `PutObject` or `GetObject`) aren’t supported
over IPv6 networks.
...
condition operators](../../../iam/latest/userguide/reference-policies-elements.md#Conditions_IPAddress). The following S3 on Outposts bucket policy identifies the
...
both IPv6 and IPv4, see [Restrict access to specific IP addresses](s3outposts-example-bucket-policies.md#S3Outposts-example-bucket-policies-IP-1).
...
For more information about IAM, see the [IAM User Guide](../../../iam/latest/userguide.md). For information about editing
S3 on Outposts bucket policies, see [Adding or editing a bucket policy for an Amazon S3 on Outposts bucket](s3outpostsbucketpolicyedit.md).
...
or other private connections. The IPv6 support for [AWS PrivateLink for S3 on Outposts](../userguide/s3-outposts-privatelink-interface-endpoints.md) also allows you to integrate AWS PrivateLink with dual-stack
...
To update the supported IP address type from IPv4 to IPv6, see [Modify the supported IP address type](../../../vpc/latest/privatelink/configure-endpoint-service.md#supported-ip-address-types) in the _AWS PrivateLink User_
_Guide_.
...
create a VPC endpoint using the AWS Management Console, see [Access an AWS service using an interface VPC endpoint](../../../vpc/latest/privatelink/create-interface-endpoint.md#create-interface-endpoint) in the
...
they can be used. For more information, see [Accept and reject endpoint connection requests](../../../vpc/latest/privatelink/configure-endpoint-service.md#accept-reject-connection-requests) in the
_AWS PrivateLink User Guide_.
