...
To get started with S3 on Outposts by using the console, see the following topics. To get
started by using the AWS CLI or AWS SDK for Java, see [Getting started by using the AWS CLI and SDK for Java](s3outpostsgsclijava.md).
...
associated with the bucket so that you can immediately begin storing objects in your
bucket.
...
08. In the **Outposts access point settings** section, enter the access point
    ...
    Access point names must be unique within the account for this Region and Outpost, and
     comply with the [access point restrictions and limitations](../userguide/access-points-restrictions-limitations.md).
...
upload an object to your bucket. For more information, see [Upload an object to an S3 on Outposts bucket](s3outpostsuploadobjects.md).
