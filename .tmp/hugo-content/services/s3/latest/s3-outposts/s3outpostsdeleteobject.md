...
more information about this command, see [delete-object](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/delete-object.html) in the _AWS CLI_
_Reference_.
...
this command, replace each `user input
                                    placeholder` with your own information. For
more information about this command, see [delete-objects](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/delete-objects.html) in the _AWS CLI_
_Reference_.
...
more information, see [DeleteObject](../api/api-deleteobject.md)
...
point ARN for the Outpost. For more information, see [DeleteObjects](../api/api-deleteobjects.md) in the
