...
these operations, see [Amazon S3 API operations for managing objects](s3outpostsapi.md#S3OutpostsAPIsObject).
...
bucket-naming rules, see [Working with S3 on Outposts buckets](s3outpostsworkingbuckets.md).
...
of S3 on Outposts control plane operations, see [Amazon S3 Control API operations for managing buckets](s3outpostsapi.md#S3OutpostsAPIsBucket).
