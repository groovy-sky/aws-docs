...
[What is\
AWS Outposts?](../../../outposts/latest/userguide/what-is-outposts.md) in the _AWS Outposts User Guide_.
...
environments with limited to no connectivity. For more information, see [Outpost connectivity to AWS Regions](../../../outposts/latest/userguide/how-outposts-works.md#region-connectivity) in the _AWS Outposts User Guide_.
...
access point ARN or access point alias. For more information about access point aliases, see [Using a bucket-style alias for your S3 on Outposts bucket access point](s3-outposts-access-points-alias.md).
...
(SSE-S3). For more information, see [Data encryption in S3 on Outposts](s3-outposts-data-encryption.md).
...
control access to groups of objects that begin with a common [prefix](../../../../general/latest/gr/glos-chap.md#keyprefix) or end with a given extension, such as
`.html`.
...
For more information about access point aliases, see [Using a bucket-style alias for your S3 on Outposts bucket access point](s3-outposts-access-points-alias.md).
...
(IAM)](../userguide/s3outpostsiam.md) – IAM is a web service that helps you securely
...
- [S3 on Outposts access points](../userguide/s3outpostsworkingbuckets.md) – Manage data access for shared
...
(AWS RAM)](../userguide/outposts-sharing-with-ram.md) – Securely share your S3 on Outposts capacity
...
[Monitoring\
tools](../userguide/s3outpostsmanaging.md).

- [Amazon CloudWatch metrics for S3 on Outposts](../userguide/s3outpostscapacity.md#S3OutpostsCloudWatchMetrics) – Track the
operational health of your resources and understand your capacity
availability.

- [Amazon CloudWatch Events events for S3 on Outposts](../userguide/s3outpostsnotificationscwe.md) – Create a rule for
...
- [AWS CloudTrail logs\
for S3 on Outposts](../userguide/s3outpostscloudtrail.md) – Record actions taken by a user, a
...
- [Amazon Elastic Compute Cloud (Amazon EC2)](../../../ec2/index.md)
...
Outposts](../../../ec2/latest/userguide/snapshots-outposts.md) – Use Amazon EBS local snapshots on Outposts to store
snapshots of volumes on an Outpost locally in S3 on Outposts.

- [Amazon Relational Database Service (Amazon RDS) on\
Outposts](../../../amazonrds/latest/userguide/rds-on-outposts.md) – Use Amazon RDS local backups to store your Amazon RDS backups
locally on your Outpost.

- [AWS DataSync](../../../datasync/latest/userguide/getting-started.md)
...
Linux. To get started, see the [AWS Command Line Interface User Guide](../../../cli/latest/userguide.md). For more information about
