...
Credentials](../../../iam/latest/userguide/id-credentials-temp.md) in the _IAM User Guide_. For more
...
First IAM user and Administrators Group](../../../iam/latest/userguide/getting-started-create-admin-group.md) in the
_IAM User Guide_.
