...
codes. For more information, see [Error responses](errorresponses.md).
...
- _Description:_ There is a problem with your AWS account that prevents
...
- _Description:_ All access to this Amazon S3 resource has been disabled.
...
- _Description:_ The email address you provided is associated with more
than one account.
...
- _Description:_ The Content-MD5 you specified did not match what we
received.
...
- _Description:_ The requested bucket name is not available. The bucket
...
- _Description:_ The bucket you tried to create already exists, and you own
...
- _Description:_ Cross-location logging not allowed. Buckets in one
...
- _Description:_ Your proposed upload is smaller than the minimum allowed
object size.
...
- _Description:_ Your proposed upload exceeds the maximum allowed object
size.
...
- _Description:_ Indicates that the versioning configuration specified in
...
- _Description:_ You did not provide the number of bytes specified by the
...
- _Description:_ The AWS access key ID you provided does not exist in our
records.
...
- _Description:_ The request is not valid with the current state of the
bucket.
...
- _Description:_ The encryption request you specified is not valid. The
...
- _Description:_ The specified location constraint is not valid. For more
information about Regions, see [How to Select a Region for Your\
Buckets](../dev/usingbucket.md#access-bucket-intro).
...
- _Description:_ The action is not valid for the current state of the
object.
...
- _Description:_ One or more of the specified parts could not be found. The
...
- _Description:_ The list of parts was not in ascending order. Parts list
...
- _Description:_ All access to this object has been disabled. Please
contact AWS Support for further assistance.
...
- _Description:_ SOAP requests must be made over an HTTPS
connection.
...
- _Description:_ Amazon S3 Transfer Acceleration is not supported for buckets
...
- _Description:_ Amazon S3 Transfer Accelerate endpoint only supports virtual
style requests.
...
- _Description:_ Amazon S3 Transfer Accelerate is not configured on this
bucket.
...
- _Description:_ Amazon S3 Transfer Acceleration is not supported on this
...
- _Description:_ Amazon S3 Transfer Acceleration cannot be enabled on this
bucket. Contact AWS Support for more information.
...
- _Description:_ The target bucket for logging does not exist, is not owned
...
- _Description:_ The provided token is malformed or otherwise
invalid.
...
- _Description:_ The XML you provided was not well-formed or did not
...
- _Description:_ This happens when the user sends malformed XML (XML that
...
- _Description:_ Your POST request fields preceding the upload file were
too large.
...
- _Description:_ Your metadata headers exceed the maximum allowed metadata
size.
...
- _Description:_ A SOAP attachment was expected, but none were
found.
...
- _Description:_ This happens when the user sends an empty XML document as
...
- _Description:_ There is no such thing as a logging status subresource for
a key.
...
- _Description:_ The specified multipart upload does not exist. The upload
...
- _Description:_ Indicates that the version ID specified in the request
...
- _Description:_ A header you provided implies functionality that is not
implemented.
...
- _Description:_ Your account is not signed up for the Amazon S3 service. You
must sign up before you can use Amazon S3. You can sign up at the following URL: [Amazon S3](http://aws.amazon.com/s3)
...
- _Description:_ A conflicting conditional action is currently in progress
...
- _Description:_ The bucket you are attempting to access must be addressed
...
- _Description:_ At least one of the preconditions you specified did not
hold.
...
- _Description:_ Bucket POST must be of the enclosure-type
multipart/form-data.
...
- _Description:_ Your socket connection to the server was not read from or
...
- _Description:_ The difference between the request time and the server's
time is too large.
...
- _Description:_ The request signature we calculated does not match the
signature you provided. Check your AWS secret access key and signing method. For more
information, see [REST Authentication](../dev/restauthentication.md) and [SOAP Authentication](../dev/soapauthentication.md) for
details.
...
- _Description:_ You have attempted to create more buckets than
allowed.
...
- _Description:_ The email address you provided does not match any account
on record.
...
- _Description:_ The bucket POST must contain the specified field name. If
...
- [AWS SDK for C++](../../../../reference/goto/sdkforcpp/s3-2006-03-01/error.md)

- [AWS SDK for Java V2](../../../../reference/goto/sdkforjavav2/s3-2006-03-01/error.md)

- [AWS SDK for Ruby V3](../../../../reference/goto/sdkforrubyv3/s3-2006-03-01/error.md)
