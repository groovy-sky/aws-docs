...
This action creates an Amazon S3 bucket. To create an Amazon S3 on Outposts bucket, see [`CreateBucket`](api-control-createbucket.md).
...
more information, see [Virtual hosting of buckets](../dev/virtualhosting.md) in the _Amazon S3 User Guide_.
...
S3 Express One Zone](../userguide/s3-express-one-zone.md#s3-express-features) in the _Amazon S3 User Guide_.
...
Type: [BucketInfo](api-bucketinfo.md) data type
...
Type: [LocationInfo](api-locationinfo.md) data type
...
For a list of the valid values for all of the AWS Regions, see [Regions and Endpoints](../../../../general/latest/gr/rande.md#s3_region).
...
When creating buckets with tags, note that tag-based conditions using `aws:ResourceTag` and `s3:BucketTag` condition keys are applicable only after ABAC is enabled on the bucket. To learn more, see [Enabling ABAC in general purpose buckets](../userguide/buckets-tagging-enable-abac.md).
...
- [AWS Command Line Interface V2](../../../goto/cli2/s3-2006-03-01/createbucket.md)

- [AWS SDK for .NET V4](../../../../reference/goto/dotnetsdkv4/s3-2006-03-01/createbucket.md)

- [AWS SDK for C++](../../../../reference/goto/sdkforcpp/s3-2006-03-01/createbucket.md)

- [AWS SDK for Go v2](../../../../reference/goto/sdkforgov2/s3-2006-03-01/createbucket.md)

- [AWS SDK for Java V2](../../../../reference/goto/sdkforjavav2/s3-2006-03-01/createbucket.md)

- [AWS SDK for JavaScript V3](../../../../reference/goto/sdkforjavascriptv3/s3-2006-03-01/createbucket.md)

- [AWS SDK for Kotlin](../../../../reference/goto/sdkforkotlin/s3-2006-03-01/createbucket.md)

- [AWS SDK for PHP V3](../../../../reference/goto/sdkforphpv3/s3-2006-03-01/createbucket.md)

- [AWS SDK for Python](../../../goto/boto3/s3-2006-03-01/createbucket.md)

- [AWS SDK for Ruby V3](../../../../reference/goto/sdkforrubyv3/s3-2006-03-01/createbucket.md)
