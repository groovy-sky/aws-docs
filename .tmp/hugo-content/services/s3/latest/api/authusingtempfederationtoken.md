...
Your First IAM user and Administrators Group](../../../iam/latest/userguide/getting-started-create-admin-group.md) in the
_IAM User Guide_.
...
Your IAM user User and Administrators Group](../../../iam/latest/userguide/getting-started-create-admin-group.md) in the
_IAM User Guide_.
...
Security Credentials](../../../iam/latest/userguide/id-credentials-temp.md) in the _IAM User Guide_. For
...
IAM user and Administrators Group](../../../iam/latest/userguide/getting-started-create-admin-group.md) in the
_IAM User Guide_.
