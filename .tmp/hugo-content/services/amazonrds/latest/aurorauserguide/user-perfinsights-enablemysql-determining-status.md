...
![Shows that the settings for the performance_schema parameter are modified.](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_schema_user.png)
