...
For more information about available Aurora PostgreSQL extension versions, see [Extension versions for Amazon Aurora PostgreSQL](../aurorapostgresqlreleasenotes/aurorapostgresql-extensions.md) in
...
`pg_stat_database`, see [The Statistics Collector](https://www.postgresql.org/docs/current/monitoring-stats.html) in the _PostgreSQL_
_documentation_.
