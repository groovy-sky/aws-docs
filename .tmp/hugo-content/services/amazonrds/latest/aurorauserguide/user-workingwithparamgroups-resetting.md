...
To reset some or all of the parameters in a DB parameter group, use the AWS CLI [`reset-db-parameter-group`](../../../cli/latest/reference/rds/reset-db-parameter-group.md) command with the
