...
When you run the [create-db-cluster](../../../cli/latest/reference/rds/create-db-cluster.md) or [create-global-cluster](../../../cli/latest/reference/rds/create-global-cluster.md) AWS CLI command,
...
When you use the [CreateDBCluster](../../../../reference/amazonrds/latest/apireference/api-createdbcluster.md) or [CreateGlobalCluster](../../../../reference/amazonrds/latest/apireference/api-createglobalcluster.md)
Amazon RDS API
