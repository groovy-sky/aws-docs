...
- [Upgrading or switching existing clusters to use Aurora Serverless v2](aurora-serverless-v2-upgrade.md#aurora-serverless-v2.getting-started-general-procedure)

  - [Upgrade paths for MySQL-compatible clusters to use Aurora Serverless v2](aurora-serverless-v2-upgrade.md#serverless-v2-upgrade-paths-ams)

  - [Upgrade paths for PostgreSQL-compatible clusters to use Aurora Serverless v2](aurora-serverless-v2-upgrade.md#serverless-v2-upgrade-paths-apg)
...
- [Comparison of Aurora Serverless v2 and Aurora Serverless v1](aurora-serverless-v2-upgrade.md#aurora-serverless.comparison)

  - [Comparison of Aurora Serverless v2 and Aurora Serverless v1 requirements](aurora-serverless-v2-upgrade.md#aurora-serverless.comparison-requirements)

  - [Comparison of Aurora Serverless v2 and Aurora Serverless v1 scaling and availability](aurora-serverless-v2-upgrade.md#aurora-serverless.comparison-scaling)

  - [Comparison of Aurora Serverless v2 and Aurora Serverless v1 feature support](aurora-serverless-v2-upgrade.md#aurora-serverless.comparison-features)

  - [Adapting Aurora Serverless v1 use cases to Aurora Serverless v2](aurora-serverless-v2-upgrade.md#aurora-serverless.comparison-approaches)
- [Upgrading from an Aurora Serverless v1 cluster to Aurora Serverless v2](aurora-serverless-v2-upgrade.md#aurora-serverless-v2.upgrade-from-serverless-v1-procedure)
  ...
  - [Aurora MySQL–compatible DB clusters](aurora-serverless-v2-upgrade.md#sv1-to-sv2-ams)

  - [Aurora PostgreSQL–compatible DB clusters](aurora-serverless-v2-upgrade.md#sv1-to-sv2-apg)
- [Migrating from an on-premises database to Aurora Serverless v2](aurora-serverless-v2-upgrade.md#aurora-serverless-v2.migrate-from-on-prem)
...
see [Creating a DB cluster that uses Aurora Serverless v2](aurora-serverless-v2-create.md).
...
Use the procedures in [How to perform an in-place upgrade](auroramysql-upgrading-procedure.md).

- If you have a PostgreSQL-compatible provisioned cluster running PostgreSQL version 11 or 12, follow the upgrade
instructions for Aurora PostgreSQL version 13. Use the procedures in [Performing a major version upgrade](user-upgradedbinstance-postgresql-majorversion.md).
...
Minor version upgrades are applied automatically as they become available. For more information, see [Aurora Serverless v1 and Aurora database engine versions](aurora-serverless-relnotes.md).
...
more information, see [Using Amazon Aurora Blue/Green Deployments for database updates](blue-green-deployments.md).
...
2. Create a blue/green deployment. Follow the procedure in [Creating a blue/green deployment in Amazon Aurora](blue-green-deployments-creating.md).
