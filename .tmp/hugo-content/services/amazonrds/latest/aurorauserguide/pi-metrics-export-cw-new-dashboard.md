...
![Performance Insights dashboard with export to CloudWatch button](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/PI-ExprtToCW.png)

6. Choose **Export as new dashboard**.

![Export to CloudWatch window with export as new dashboard option selected](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/PI-ExprtToCW-NewDashboard.png)
...
![Banner with successful message](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/PI-ExprtToCW-SuccessBanner.png)
