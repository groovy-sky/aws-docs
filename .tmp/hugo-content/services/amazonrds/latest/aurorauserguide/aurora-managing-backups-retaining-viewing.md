...
To describe your retained automated backups using the RDS API, call the [`DescribeDBClusterAutomatedBackups`](../../../../reference/amazonrds/latest/apireference/api-describedbclusterautomatedbackups.md)
