...
[Tutorial: Create a web server and an Amazon Aurora DB cluster](tut-webappwithrds.md). For more information about Amazon VPC, see
...
If you created this VPC to complete [Tutorial: Create a web server and an Amazon Aurora DB cluster](tut-webappwithrds.md),
create the DB cluster
by following the instructions in [Create an Amazon Aurora DB cluster](chap-tutorials-webserverdb-createdbcluster.md).
