...
The `pg_tle` extension, its schema and functions, and all artifacts are removed. To
    ...
    process again. For more information, see [Setting up Trusted Language Extensions in your Aurora PostgreSQL DB cluster](postgresql-trusted-language-extension-setting-up.md).
