...
For a list of scenarios involving Amazon Aurora DB clusters in a VPC , see [Scenarios for accessing a DB cluster in a VPC](user-vpc-scenarios.md).
...
For more information, see [Scenarios for accessing a DB cluster in a VPC](user-vpc-scenarios.md).
...
modifying a DB cluster, see [Modifying an Amazon Aurora DB cluster](aurora-modifying.md).
...
We recommend that you run the [modify-db-cluster](../../../cli/latest/reference/rds/modify-db-cluster.md)
...
If you are using the AWS CLI, run the [describe-db-clusters](../../../cli/latest/reference/rds/describe-db-clusters.md) command, and make sure that the
...
For more information about Aurora MySQL versions, see the [_Release Notes for Aurora MySQL_](../auroramysqlreleasenotes/welcome.md).
...
For more information about Aurora PostgreSQL versions, see the [_Release Notes for Aurora PostgreSQL_](../aurorapostgresqlreleasenotes/welcome.md).
...
clusters. For an illustration of this scenario, see [A DB cluster in a VPC accessed by an Amazon EC2 instance in the same VPC](user-vpc-scenarios.md#USER_VPC.Scenario1).
...
**Public access** option, see [Modifying a DB instance in a DB cluster](aurora-modifying.md#Aurora.Modifying.Instance).
...
instructions on how to create a security group for your DB cluster, see [Create a VPC security group for a private DB cluster](chap-tutorials-webserverdb-createvpc.md#CHAP_Tutorials.WebServerDB.CreateVPC.SecurityGroupDB), or
