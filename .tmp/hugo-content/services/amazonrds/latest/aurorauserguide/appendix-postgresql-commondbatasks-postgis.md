...
learn more about PostGIS, see [PostGIS.net](https://postgis.net/).
...
- [PostGIS extension\
versions](#CHAP_PostgreSQL.Extensions.PostGIS)
...
Security](https://postgis.net/workshops/postgis-intro/security.html).
...
To learn more about this extension, see [Tiger Geocoder](https://postgis.net/docs/Extras.html) in
...
identifier (26986) and default tolerance (0.5). To learn more, see [CreateTopology](https://postgis.net/docs/CreateTopology.html) in the
...
current PostgreSQL version. For details, see [PostGIS extension versions](#CHAP_PostgreSQL.Extensions.PostGIS).
...
information about upgrading the PostgreSQL engine, see [Testing an upgrade of your production DB cluster to a new major version](user-upgradedbinstance-postgresql-majorversion.md#USER_UpgradeDBInstance.PostgreSQL.MajorVersion.Upgrade.preliminary).

You can check for available PostGIS extension version updates on your Aurora PostgreSQL DB cluster
...
to PostGIS 3. For more information, see [Upgrading PostGIS 2 to PostGIS 3](#PostgreSQL.Extensions.PostGIS.versions.upgrading.2-to-3).

If you upgraded this extension to prepare for a major version upgrade of the
PostgreSQL engine, you can continue with other preliminary tasks. For more information, see [Testing an upgrade of your production DB cluster to a new major version](user-upgradedbinstance-postgresql-majorversion.md#USER_UpgradeDBInstance.PostgreSQL.MajorVersion.Upgrade.preliminary).

## PostGIS extension versions

We recommend that you install the versions of all extensions such as PostGIS as listed
in [Extension versions for Aurora PostgreSQL-Compatible Edition](../aurorapostgresqlreleasenotes/aurorapostgresql-extensions.md) in the
_Release Notes for Aurora PostgreSQL_.
To get a list of versions that
...
You can find version information in the following sections in the
_Release Notes for Aurora PostgreSQL_:

- [Extension versions for Aurora PostgreSQL 14](../aurorapostgresqlreleasenotes/aurorapostgresql-extensions.md#AuroraPostgreSQL.Extensions.14)

- [Extension versions for Aurora PostgreSQL-Compatible Edition 13](../aurorapostgresqlreleasenotes/aurorapostgresql-extensions.md#AuroraPostgreSQL.Extensions.13)

- [Extension versions for Aurora PostgreSQL-Compatible Edition 12](../aurorapostgresqlreleasenotes/aurorapostgresql-extensions.md#AuroraPostgreSQL.Extensions.12)

- [Extension versions for Aurora PostgreSQL-Compatible Edition 11](../aurorapostgresqlreleasenotes/aurorapostgresql-extensions.md#AuroraPostgreSQL.Extensions.11)

- [Extension versions for Aurora PostgreSQL-Compatible Edition 10](../aurorapostgresqlreleasenotes/aurorapostgresql-extensions.md#AuroraPostgreSQL.Extensions.10)

- [Extension versions for Aurora PostgreSQL-Compatible Edition 9.6](../aurorapostgresqlreleasenotes/aurorapostgresql-extensions.md#AuroraPostgreSQL.Extensions.96)
...
1. Identify the default version of PostGIS that's available to the
    PostgreSQL version on your Aurora PostgreSQL DB
    cluster.
    To do so, run
    the following query.
...
2. Identify the versions of PostGIS installed in each database on the writer instance of your Aurora PostgreSQL DB
    cluster.
    In other
