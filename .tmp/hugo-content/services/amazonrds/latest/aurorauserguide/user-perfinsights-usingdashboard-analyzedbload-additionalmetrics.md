...
- [Accessing more SQL text in the Performance Insights dashboard](user-perfinsights-usingdashboard-sqltextsize.md)

- [Viewing SQL statistics in the Performance Insights dashboard](user-perfinsights-usingdashboard-analyzedbload-additionalmetrics-analyzingsqllevel.md)
...
![SQL text](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/sql-text-apg.png)

To learn how to see more than the default 500 bytes of SQL text, see [Accessing more SQL text in the Performance Insights dashboard](user-perfinsights-usingdashboard-sqltextsize.md).
...
![Selected SQL digest](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_4b.png)
...
![Top SQL](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_4.png)
...
![DB load by waits](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_6.png)
...
![Top SQL table with literal query selected](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf-insights-sql-ids-open.png)
...
![Statistics preferences](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf-insights-sql-ids-preferences-icon.png)
...
![Preferences window](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf-insights-sql-ids-preferences.png)
