...
this feature, see [Monitoring Amazon Aurora with Database Activity Streams](dbactivitystreams.md).
...
this feature, see [Using Amazon Aurora machine learning with Aurora MySQL](mysql-ml.md).
...
DB cluster's route table, see [Working with a DB cluster in a VPC](user-vpc-workingwithrdsinstanceinavpc.md). For more information about configuring NAT in your VPC, see [NAT gateways](../../../vpc/latest/userguide/vpc-nat-gateway.md). For more information about configuring VPC endpoints, see
[VPC endpoints](../../../vpc/latest/userguide/vpc-endpoints.md). You can also create an S3 gateway endpoint to access your S3 bucket.
...
your VPC security group. For more information on ephemeral ports for network ACLs, see [Ephemeral ports](../../../vpc/latest/userguide/vpc-network-acls.md#nacl-ephemeral-ports) in the _Amazon Virtual Private Cloud_
_User Guide_.
