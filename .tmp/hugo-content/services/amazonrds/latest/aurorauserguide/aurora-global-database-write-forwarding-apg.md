...
[Aurora global databases with Aurora PostgreSQL](concepts-aurora-fea-regions-db-eng-feature-globaldatabase.md#Concepts.Aurora_Fea_Regions_DB-eng.Feature.GlobalDatabase.apg).
...
option works when you create a new secondary cluster using the [create-db-cluster](../../../cli/latest/reference/rds/create-db-cluster.md) command.
It also works when you modify an existing secondary cluster using the [modify-db-cluster](../../../cli/latest/reference/rds/modify-db-cluster.md) command. It
