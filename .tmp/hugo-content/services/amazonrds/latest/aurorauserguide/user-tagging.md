...
[create-db-snapshot](../../../cli/latest/reference/rds/create-db-snapshot.md) AWS CLI
command. Or you might supply at least one tag to the [CreateDBSnapshot](../../../../reference/amazonrds/latest/apireference/api-createdbsnapshot.md) API operation. In
