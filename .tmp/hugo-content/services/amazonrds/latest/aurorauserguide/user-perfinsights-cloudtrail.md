...
Events with CloudTrail Event History](../../../awscloudtrail/latest/userguide/view-cloudtrail-events.md) in _AWS CloudTrail User Guide._
...
Reference](../../../../reference/performance-insights/latest/apireference/welcome.md). For example, calls to the
