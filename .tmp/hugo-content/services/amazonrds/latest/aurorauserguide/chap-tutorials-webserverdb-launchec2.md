...
![Configure Instance Details](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/Tutorial_WebServer_14.png)
...
9. Complete [Create an Amazon Aurora DB cluster](chap-tutorials-webserverdb-createdbcluster.md).
