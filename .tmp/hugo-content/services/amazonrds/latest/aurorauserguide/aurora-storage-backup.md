...
For more information on sharing snapshots, see [Sharing a DB cluster snapshot](aurora-share-snapshot.md). For
more information on copying snapshots, see [DB cluster snapshot copying](aurora-copy-snapshot.md).
