...
how to modify the DB cluster parameter, see [Modifying parameters in a DB cluster parameter groupin Amazon Aurora](user-workingwithparamgroups-modifyingcluster.md).
...
(babelfishpg\_tsql.version value = Default)
...
Server returns PRELOGIN messages with user defined SQL Server
version
...
DatabaseMetaData.getDatabaseProductVersion() returns user
defined SQL Server version
