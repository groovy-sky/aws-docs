...
KMS key policy. For more information, see [Key policies in AWS KMS](../../../kms/latest/developerguide/key-policies.md)
...
For more information about the dimensions that you can use with the `GetResourceMetrics` API, see [DimensionGroup](../../../../reference/performance-insights/latest/apireference/api-dimensiongroup.md).
