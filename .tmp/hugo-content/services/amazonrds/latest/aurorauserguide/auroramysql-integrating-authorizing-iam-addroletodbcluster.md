...
1. Add the role to the list of associated roles for a DB cluster by using the RDS console, the [add-role-to-db-cluster](../../../cli/latest/reference/rds/add-role-to-db-cluster.md) AWS CLI command, or the
    [AddRoleToDBCluster](../../../../reference/amazonrds/latest/apireference/api-addroletodbcluster.md) RDS API operation.
