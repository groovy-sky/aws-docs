...
![Filter metrics](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_0a.png)
...
![Filter metrics by time interval](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_0c.png)

In the following screenshot, the DB load interval is 5 hours.

![Set time interval to 5 hours](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_1.png)
...
![DB load for a specified time interval](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_zoom_in.png)
...
![Zoom in on the selected DB load](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_zoom_in_b.png)

6. (Optional) To refresh your data automatically, select **Auto**
**refresh**.

![Set automatic refresh](https://docs.aws.amazon.com/images/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_1b.png)
