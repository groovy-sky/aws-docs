...
turning on Performance Insights, see [Turning Performance Insights on and off for Aurora](user-perfinsights-enabling.md).
...
- [Creating a performance analysis report in Performance Insights](user-perfinsights-usingdashboard-creatingperfanlysisreport.md)

- [Viewing a performance analysis report in Performance Insights](user-perfinsights-usingdashboard-viewperfanalysisreport.md)

- [Adding tags to a performance analysis report in Performance Insights](user-perfinsights-usingdashboard-manageperfanalysisreporttags.md)

- [Deleting a performance analysis report in Performance Insights](user-perfinsights-usingdashboard-deleteperfanalysisreport.md)
