...
The [`DescribeDBLogFiles`](../../../../reference/amazonrds/latest/apireference/api-describedblogfiles.md) API operation that
...
To publish Oracle logs, you can use the [`modify-db-instance`](../../../cli/latest/reference/rds/modify-db-instance.md) command with the following
parameters:
