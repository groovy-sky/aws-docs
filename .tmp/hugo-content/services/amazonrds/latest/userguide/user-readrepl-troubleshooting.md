...
information about events and subscribing to events, see [Working with Amazon RDS event notification](user-events.md). If a MySQL error message is returned, review the
