...
![Choose a retention period for your Performance Insights data.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/pi-retention-periods.png)

To learn how to set a retention period using the AWS CLI, see [Turning Performance Insights on and off for Amazon RDS](user-perfinsights-enabling.md).
