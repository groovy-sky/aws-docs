...
To help protect against invalid customization, RDS Custom has automation software
    ...
    IP address. For more information, see [Amazon RDS Custom host replacement](custom-concept.md#custom-troubleshooting.host-problems).
...
problems. For more information, see [RDS Custom support perimeter](custom-concept.md#custom-troubleshooting.support-perimeter).
