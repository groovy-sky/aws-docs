...
![Image of the PostgreSQL log file after setting up pgAudit.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/pgaudit-log-example.png)
...
For information on viewing the logs, see [Monitoring Amazon RDS log files](user-logaccess.md).
