...
To describe your retained automated backups using the RDS API, call the [`DescribeDBInstanceAutomatedBackups`](../../../../reference/amazonrds/latest/apireference/api-describedbinstanceautomatedbackups.md)
