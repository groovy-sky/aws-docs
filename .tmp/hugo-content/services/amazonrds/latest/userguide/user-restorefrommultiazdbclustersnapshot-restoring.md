...
To restore a snapshot to a Multi-AZ DB cluster, use the AWS CLI command [restore-db-cluster-from-snapshot](../../../cli/latest/reference/rds/restore-db-cluster-from-snapshot.md).
