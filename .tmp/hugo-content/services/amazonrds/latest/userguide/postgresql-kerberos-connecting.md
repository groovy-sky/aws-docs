...
and other details needed for connection, see [Connect to a PostgreSQL DB instance](chap-gettingstarted-creatingconnecting-postgresql.md#CHAP_GettingStarted.Connecting.PostgreSQL).
