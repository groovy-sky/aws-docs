...
Delete replicated backups by using the [`delete-db-instance-automated-backup`](../../../cli/latest/reference/rds/delete-db-instance-automated-backup.md) AWS CLI command.
