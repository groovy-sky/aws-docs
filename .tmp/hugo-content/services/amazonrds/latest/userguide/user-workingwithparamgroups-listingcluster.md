...
To list all DB cluster parameter groups for an AWS account, use the AWS CLI [`describe-db-cluster-parameter-groups`](../../../cli/latest/reference/rds/describe-db-clusterparameter-groups.md) command.
...
To list all DB cluster parameter groups for an AWS account, use the RDS API [`DescribeDBClusterParameterGroups`](../../../../reference/amazonrds/latest/apireference/api-describedbclusterparametergroups.md) action.
