...
For information
about creating a custom DB parameter group, see [Parameter groups for Amazon RDS](user-workingwithparamgroups.md). Next, you
...
07. Add `pgaudit` to the list in the **Values** field. Use
    ...
    ![Image of the shared_preload_libaries parameter with pgAudit added.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/apg_rpg_shared_preload_pgaudit.png)

08. Reboot the RDS for PostgreSQL DB instance so that
...
13. Find the `pgaudit.log` parameter in the list and set to the appropriate value for your
    ...
    ![Image of the pgaudit.log parameter with setting.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/rpg_set_pgaudit-log-level.png)
