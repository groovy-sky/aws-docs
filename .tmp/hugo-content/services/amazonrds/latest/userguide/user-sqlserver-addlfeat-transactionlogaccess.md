...
Amazon S3 bucket or [create a new bucket](../../../s3/latest/userguide/creatingabucket.md) to use for your transaction log backup files.
...
names (ARNs)](../../../../general/latest/gr/aws-arns-and-namespaces.md) and [Amazon Resource Names (ARNs) in Amazon RDS](user-tagging-arn.md).
...
[Setting up access to transaction log backups](user-sqlserver-addlfeat-transactionlogaccess-enabling.md).
