...
you migrate as soon as possible. For more information, see [Migrate from EC2-Classic to a VPC](../../../ec2/latest/userguide/vpc-migrate.md) in the _Amazon EC2 User Guide_ and the blog [EC2-Classic Networking is Retiring – Here’s How to Prepare](https://aws.amazon.com/blogs/aws/ec2-classic-is-retiring-heres-how-to-prepare).
...
you can restore the data if the migration fails. For more information, see [Backing up, restoring, and exporting data](chap-commontasks-backuprestore.md).
...
see [Working with option groups](user-workingwithoptiongroups.md).
...
[Restoring to a DB instance](user-restorefromsnapshot.md) and [Restoring a DB instance to a specified time for Amazon RDS](user-pit.md).
