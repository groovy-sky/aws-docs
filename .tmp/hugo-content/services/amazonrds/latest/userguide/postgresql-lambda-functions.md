...
For more details about invoking Lambda functions, see also [Invoke](../../../lambda/latest/dg/api-invoke.md) in
...
formats, see [Lambda function name formats](../../../lambda/latest/dg/api-invoke.md#API_Invoke_RequestParameters) in the _AWS Lambda Developer Guide._
...
An HTTP status response code. For more information, see [Lambda Invoke response elements](../../../lambda/latest/dg/api-invoke.md#API_Invoke_ResponseElements) in the _AWS Lambda Developer Guide._
