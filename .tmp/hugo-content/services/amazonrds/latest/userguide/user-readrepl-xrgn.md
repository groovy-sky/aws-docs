...
availability with cross-Region replication, see [Supported Regions and DB engines for cross-Region read replicas in Amazon RDS](concepts-rds-fea-regions-db-eng-feature-crossregionreadreplicas.md).
...
[`create-db-instance-read-replica`](../../../cli/latest/reference/rds/create-db-instance-read-replica.md) command. In this
case, you use [`create-db-instance-read-replica`](../../../cli/latest/reference/rds/create-db-instance-read-replica.md) from the
...
For information about ARNs, see [Amazon Resource Names (ARNs) in Amazon RDS](user-tagging-arn.md).

To create a read replica in a different AWS Region from the source DB instance,
you can use the AWS CLI [`create-db-instance-read-replica`](../../../cli/latest/reference/rds/create-db-instance-read-replica.md) command from the
...
option, see [create-db-instance-read-replica](../../../cli/latest/reference/rds/create-db-instance-read-replica.md) in the _AWS CLI Command Reference_.
...
For information about replication lag time, see [Monitoring read replication](user-readrepl-monitoring.md).
...
AWS CLI command [create-db-instance-read-replica](../../../cli/latest/reference/rds/create-db-instance-read-replica.md). You can't specify a custom
...
and permissions in IAM](../../../iam/latest/userguide/access-policies.md) in the
_IAM User Guide_.
...
AWS Region](../../../iam/latest/userguide/id-credentials-temp-enable-regions.md) in the _IAM User Guide_.
