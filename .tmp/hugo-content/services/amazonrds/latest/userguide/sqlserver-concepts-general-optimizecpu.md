...
DB instance, to optimize licensing costs for DB instances. See [DB instance classes that support Optimize CPU](sqlserver-concepts-general-optimizecpu-support.md) to find the allowed values for core count for a selected instance type.

- **threadsPerCore** –
Specify the threads per core to define the number of threads per CPU core.
See [DB instance classes that support Optimize CPU](sqlserver-concepts-general-optimizecpu-support.md)
...
[DB instance classes that support Optimize CPU](sqlserver-concepts-general-optimizecpu-support.md).
...
- Optimize CPU is available on select instances. See [DB instance classes that support Optimize CPU](sqlserver-concepts-general-optimizecpu-support.md).
