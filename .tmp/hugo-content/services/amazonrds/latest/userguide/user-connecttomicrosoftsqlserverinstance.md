...
see [Creating and connecting to a Microsoft SQL Server DB instance](chap-gettingstarted-creatingconnecting-sqlserver.md).
...
1. Make sure that its status is `available`. You can check this on the details page for your instance in the
    AWS Management Console or by using the [describe-db-instances](../../../cli/latest/reference/rds/describe-db-instances.md) AWS CLI
    command.
