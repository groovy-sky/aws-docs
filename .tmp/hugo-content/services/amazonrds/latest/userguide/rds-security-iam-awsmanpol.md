...
actions on your behalf. For more information, see [Service-linked role permissions for Amazon RDS](usingwithrds-iam-servicelinkedroles.md#service-linked-role-permissions).
...
For more information about this policy, including the JSON policy document, see [AmazonRDSCustomInstanceProfileRolePolicy](../../../aws-managed-policy/latest/reference/amazonrdscustominstanceprofilerolepolicy.md) in the
