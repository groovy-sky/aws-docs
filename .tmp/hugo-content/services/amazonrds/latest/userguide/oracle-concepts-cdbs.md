...
Oracle Database 21c CDB. For more information, see [Converting an RDS for Oracle non-CDB to a CDB](oracle-cdb-converting.md).
...
for a non-CDB. For more information about migrating data, see [Importing data into Oracle on Amazon RDS](oracle-procedural-importing.md).
