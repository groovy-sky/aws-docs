...
For a complete list of dimensions for the Amazon RDS engines, see [DB load sliced by dimensions](user-perfinsights-usingdashboard-components.md#USER_PerfInsights.UsingDashboard.Components.AvgActiveSessions.dims).
...
- SQL Server: [Analyzing SQL Server execution plans using the Performance Insights dashboard for Amazon RDS](user-perfinsights-usingdashboard-accessplanssqlserver.md)
...
query text limit. For more information, see [Accessing more SQL text in the Performance Insights dashboard](user-perfinsights-usingdashboard-sqltextsize.md).
