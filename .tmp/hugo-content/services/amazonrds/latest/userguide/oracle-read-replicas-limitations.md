...
For more information about upgrading the DB engine version, see [Upgrading the RDS for Oracle DB engine](user-upgradedbinstance-oracle.md).
...
For more information about option groups, see [Working with option groups](user-workingwithoptiongroups.md).
...
restricted sessions. For more information about restricted sessions, see [Enabling and disabling restricted sessions](appendix-oracle-commondbatasks-restrictedsession.md).
...
information, see [Enabling and disabling block change tracking](appendix-oracle-commondbatasks-blockchangetracking.md).
