...
for engines on RDS Extended Support. For more information, see [Amazon RDS Extended Support versions for RDS for MySQL](mysql-concepts-versionmgmt.md#mysql-extended-support-releases) and [Amazon RDS Extended Support updates for RDS for PostgreSQL](../postgresqlreleasenotes/postgresql-extendedsupport.md) in the _Amazon RDS for PostgreSQL_
_Release Notes_.
