...
3. In a SQL client, connect to the new DB instance, and call the [mysql.rds\_group\_replication\_set\_recovery\_channel](mysql-stored-proc-active-active-clusters.md#mysql_rds_group_replication_set_recovery_channel) stored procedure. Replace
...
4. Using the SQL client, call the [mysql.rds\_group\_replication\_start](mysql-stored-proc-active-active-clusters.md#mysql_rds_group_replication_start) stored procedure to start replication:
...
4. In a SQL client, connect to the new DB instance, and call the [mysql.rds\_group\_replication\_set\_recovery\_channel](mysql-stored-proc-active-active-clusters.md#mysql_rds_group_replication_set_recovery_channel) stored procedure. Replace
    `group_replication_user_password` with the password for the `rdsgrprepladmin` user.
...
5. Using the SQL client, call the [mysql.rds\_group\_replication\_start](mysql-stored-proc-active-active-clusters.md#mysql_rds_group_replication_start) stored procedure to start replication:
