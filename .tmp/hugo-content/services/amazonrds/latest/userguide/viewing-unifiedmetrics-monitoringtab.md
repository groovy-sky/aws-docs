...
![Banner with navigation to new monitoring view.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/NewMonitoringViewOption.png)

5. Choose **Go to new monitoring view** to open the Performance Insights dashboard
    with Performance Insights and CloudWatch metrics for your DB instance.
...
![Modify DB instance to turn on Performance Insights.](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/Monitoring_modifyInstnc_banner.png)
