...
see [AWS::RDS::DBInstance](../../../cloudformation/latest/userguide/aws-resource-rds-dbinstance.md)
...
For more information about DB option groups, see [Working with option groups](user-workingwithoptiongroups.md).
...
database release. For more information, see [Upgrading an Oracle DB snapshot](user-upgradedbsnapshot-oracle.md).
...
uses the multi-tenant configuration. For more information, see [Backing up and restoring a CDB](oracle-concepts-single-tenant-snapshots.md).
...
all its tenant databases. You can use [describe-db-snapshot-tenant-databases](../../../cli/latest/reference/rds/describe-db-snapshot-tenant-databases.md) to inspect the tenant
