...
see [Setting up Trusted Language Extensions in your RDS for PostgreSQL DB instance](postgresql-trusted-language-extension-setting-up.md).
...
To continue setting up your system for Trusted Language Extensions, see [Setting up Trusted Language Extensions in your RDS for PostgreSQL DB instance](postgresql-trusted-language-extension-setting-up.md).
