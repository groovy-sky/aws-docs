...
Sysprep](../../../ec2/latest/windowsguide/creating-ebsbacked-winami.md#sysprep-using-ec2launchv2).
...
To troubleshoot SSM endpoints, see [Unable to connect to SSM endpoints](../../../systems-manager/latest/userguide/troubleshooting-ssm-agent.md#systems-manager-ssm-agent-troubleshooting-endpoint-access) and [Use ssm-cli to troubleshoot managed node\
availability](../../../systems-manager/latest/userguide/ssm-cli.md#agent-ts-ssm-cli).
...
For more information, see [Modifying an RDS Custom for SQL Server DB instance](custom-managing-modify-sqlserver.md) and [Upgrading a DB instance engine version](user-upgradedbinstance-upgrading.md).
