...
expression. Amazon RDS zero-ETL integrations use [Maxwell filter syntax](https://maxwells-daemon.io/filtering) for data filtering.
...
`database.table`
for RDS for MySQL, or
`database.schema.table`
for RDS for PostgreSQL. You can specify literal names, or define regular
expressions.

###### Note

For RDS for MySQL, regular expressions are supported in both the database and
table name. For RDS for PostgreSQL, regular expressions are supported only in the
...
![Data filters for a zero-ETL integration](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/zero-etl-filter.png)
...
![Data filters for a zero-ETL integration in the RDS console](https://docs.aws.amazon.com/images/AmazonRDS/latest/UserGuide/images/zero-etl-filter-data.png)
