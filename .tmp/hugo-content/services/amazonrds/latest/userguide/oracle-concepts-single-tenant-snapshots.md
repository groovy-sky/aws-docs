...
- To find tenant databases in a snapshot, use the CLI command [describe-db-snapshot-tenant-databases](../../../../reference/amazonrds/latest/apireference/api-describedbsnapshottenantdatabases.md).
...
see [Performing common RMAN tasks for Oracle DB instances](appendix-oracle-commondbatasks-rman.md).
