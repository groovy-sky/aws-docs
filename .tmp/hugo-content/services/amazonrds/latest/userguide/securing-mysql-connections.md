...
For more information about `rds_superuser_role`, see [Role-based privilege model for RDS for MySQL](appendix-mysql-commondbatasks-privilege-model.md).
...
operation or run the [modify-db-instance](../../../cli/latest/reference/rds/modify-db-instance.md) AWS CLI command and specify a new master user password
