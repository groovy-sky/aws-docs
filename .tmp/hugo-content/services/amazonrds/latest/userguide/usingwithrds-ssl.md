...
or [Creating a Multi-AZ DB cluster for Amazon RDS](create-multi-az-db-cluster.md)
.
...
or [Modifying a Multi-AZ DB cluster for Amazon RDS](modify-multi-az-db-cluster.md)
.
...
a DB instance using the [create-db-instance](../../../cli/latest/reference/rds/create-db-instance.md) or [modify-db-instance](../../../cli/latest/reference/rds/modify-db-instance.md) command. You can set the CA for a Multi-AZ DB cluster using the [create-db-cluster](../../../cli/latest/reference/rds/create-db-cluster.md) or [modify-db-cluster](../../../cli/latest/reference/rds/modify-db-cluster.md) command.
...
DB instance by using the [describe-db-instances](../../../cli/latest/reference/rds/describe-db-instances.md) command. You can view the details about the CA for a
Multi-AZ DB cluster by using the [describe-db-clusters](../../../cli/latest/reference/rds/describe-db-clusters.md) command.
