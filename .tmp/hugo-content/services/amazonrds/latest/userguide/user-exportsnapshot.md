...
- [Monitoring snapshot exports for Amazon RDS](user-exportsnapshot-monitoring.md)

- [Canceling a snapshot export task for Amazon RDS](user-exportsnapshot-canceling.md)

- [Failure messages for Amazon S3 export tasks for Amazon RDS](user-exportsnapshot-failure-msg.md)

- [Troubleshooting RDS for PostgreSQL permissions errors](user-exportsnapshot-postgres-permissions.md)

- [File naming conventions for exports to Amazon S3 for Amazon RDS](user-exportsnapshot-filenames.md)

- [Data conversion when exporting to an Amazon S3 bucket for Amazon RDS](user-exportsnapshot-data-types.md)
...
The KMS key policy must include both the `kms:CreateGrant` and `kms:DescribeKey` permissions.
    For more information on using KMS keys in Amazon RDS, see [AWS KMS key management](overview-encryption-keys.md).
...
information on version and Region availability with exporting snapshots to S3, see [Supported Regions and DB engines for exporting snapshots to S3 in Amazon RDS](concepts-rds-fea-regions-db-eng-feature-exportsnapshottos3.md).
