...
After you associate the extension to one of your AWS AppConfig applications, environments, or
configuration profiles, AWS AppConfig publishes a message to the topic after every configuration
...
field. For information about creating an extension, see [Walkthrough: Creating custom AWS AppConfig extensions](working-with-appconfig-extensions-creating-custom.md).

## Using the extension

This section describes how to use the `AWS AppConfig deployment events to Amazon SNS`
extension.

###### Step 1: Configure AWS AppConfig to publish messages to a topic

Add an access control policy to your Amazon SNS topic granting AWS AppConfig
( `appconfig.amazonaws.com`) publish permissions ( `sns:Publish`).
For more information, see [Example cases for Amazon SNS access\
control](../../../sns/latest/dg/sns-access-policy-use-cases.md).
...
association. You create the association by using the AWS AppConfig console or the [CreateExtensionAssociation](../../../../reference/appconfig/2019-10-09/apireference/api-createextensionassociation.md) API action. When you create the association, you
...
Here's a sample of the message sent to the Amazon SNS topic when the extension is
invoked.
