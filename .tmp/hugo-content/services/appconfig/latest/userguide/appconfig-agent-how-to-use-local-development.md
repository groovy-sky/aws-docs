...
`LOCAL_DEVELOPMENT_DIRECTORY` directory, see [Feature flag samples for AWS AppConfig Agent local development mode](appconfig-agent-how-to-use-local-development-samples.md).
