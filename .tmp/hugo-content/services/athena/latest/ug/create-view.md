...
about Athena views, see [Work with views](views.md).
...
like Amazon Athena and Amazon Redshift. For more information about AWS Glue Data Catalog views, see [Use Data Catalog views in Athena](views-glue.md).
...
replacing it. For more information, see [Create views](views-console.md#creating-views).
