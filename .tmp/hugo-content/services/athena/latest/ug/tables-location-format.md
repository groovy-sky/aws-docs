...
limitations](../../../s3/latest/dev/bucketrestrictions.md) in the _Amazon Simple Storage Service User Guide_.
...
alias for your access point](../../../s3/latest/userguide/access-points-alias.md) in the _Amazon S3 User Guide_.
