...
form](creating-tables-how-to.md#to-create-a-table-using-the-wizard), or use a JDBC or an ODBC driver. Athena uses Apache Hive to define tables
...
For information about storage classes, see [Storage classes](../../../s3/latest/dev/storage-class-intro.md), [Changing\
the storage class of an object in amazon S3](../../../s3/latest/dev/chgstoclsofobj.md), [Transitioning to the GLACIER storage class (object archival)](../../../s3/latest/userguide/lifecycle-transition-general-considerations.md#before-deciding-to-archive-objects),
and [Requester Pays buckets](../../../s3/latest/dev/requesterpaysbuckets.md) in the
...
For more information, see [Request rate and performance considerations](../../../s3/latest/dev/request-rate-perf-considerations.md).
...
creating [Iceberg](querying-iceberg-creating-tables.md) tables,
