...
[S3 Access\
Grants and directory identities](../../../s3/latest/userguide/access-grants-directory-ids.md) in the
...
using the Amazon S3 console](../../../s3/latest/userguide/add-bucket-policy.md) in the _Amazon S3 User Guide_.
...
For more information, see [Specify a table location in Amazon S3](tables-location-format.md) and [Using access points](../../../s3/latest/userguide/access-points.md)
in the _Amazon S3 User Guide_.

## Use CalledVia context keys to allow only calls from Athena to another service

For added security, you can use the [aws:CalledVia](../../../iam/latest/userguide/reference-policies-condition-keys.md#condition-keys-calledvia) global condition context key. The
...
the `aws:CalledVia` context key. For more information, see [Use CalledVia context keys for Athena](security-iam-athena-calledvia.md).
...
- [Example\
walkthroughs: Managing access](../../../s3/latest/userguide/example-walkthroughs-managing-access.md) in the
