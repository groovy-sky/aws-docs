...
the [AWS Glue CLI](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/update-table.html), the [AWS Glue API](../../../glue/latest/dg/aws-glue-api-catalog-tables.md#aws-glue-api-catalog-tables-UpdateTable), or the [AWS Glue SDK](../../../../reference/glue/latest/dg/sdk-general-information-section.md).
