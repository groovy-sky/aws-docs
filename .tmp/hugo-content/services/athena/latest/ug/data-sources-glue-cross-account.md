...
01. Follow the steps in [Configure cross-account access to AWS Glue data catalogs](security-iam-cross-account-glue-catalog-access.md) to ensure that
...
After these steps, the borrower should see
    `ownerCatalog` when it calls the [ListDataCatalogs](../../../../reference/athena/latest/apireference/api-listdatacatalogs.md) API operation.
