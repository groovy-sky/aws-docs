...
For more information, see [What is S3 Express One Zone?](../../../s3/latest/userguide/s3-express-one-zone.md) in
...
Lake table using a dummy schema, see [Synchronize Delta Lake metadata](delta-lake-tables-syncing-metadata.md).
...
2. Use a [CREATE TABLE](create-table.md) statement in
    ...
    in Athena, see [Create tables in Athena](creating-tables.md)
