...
Amazon Quick](../../../quicksight/latest/user/welcome.md) in the _Amazon Quick User Guide_ and [Connect to Amazon Athena with ODBC and JDBC drivers](athena-bi-tools-jdbc-odbc.md).
...
information, see [Use AWS Glue Data Catalog to connect to your data](data-sources-glue.md) and
[What is\
AWS Glue](../../../glue/latest/dg/what-is-glue.md) in the _AWS Glue Developer Guide_.
...
natural language input. To learn more, see [SQL Analytics](../../../sagemaker-unified-studio/latest/userguide/sql-query.md) in the SageMaker Unified Studio user guide.
