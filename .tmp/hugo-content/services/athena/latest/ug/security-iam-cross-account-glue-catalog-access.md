...
For more information about cross-account access in AWS Glue, see [Granting cross-account access](../../../glue/latest/dg/cross-account-access.md) in
...
- [Data Catalog example policies](datacatalogs-example-policies.md) \- Shows how to write
...
between customer managed keys and AWS managed keys, see [Customer keys and AWS keys](../../../kms/latest/developerguide/concepts.md#key-mgmt) in the
...
API](../../../../reference/iam/latest/apireference/api-operations.md). The following procedures use the IAM console.
...
role, you can use the AWS Glue console or the AWS Glue [PutResourcePolicy](../../../glue/latest/webapi/api-putresourcepolicy.md)
...
After you finish, we recommend that you use the [AWS Glue API](../../../glue/latest/dg/aws-glue-api.md) to make some test
...
catalog contextually by passing it in through the [QueryExecutionContext](../../../../reference/athena/latest/apireference/api-queryexecutioncontext.md).
...
permissions?](../../../s3/latest/user-guide/set-bucket-permissions.md) in the _Amazon Simple Storage Service User Guide_.
...
`<arn>` is the [AWS Glue Data Catalog ARN](../../../glue/latest/dg/glue-specifying-resource-arns.md#data-catalog-resource-arns) that you want to use. In the example, Athena uses this
...
additional API operations might be necessary. For more information, see [Data Catalog example policies](datacatalogs-example-policies.md).
...
[ListDataCatalogs](../../../../reference/athena/latest/apireference/api-listdatacatalogs.md)
API operation.
...
Amazon Athena](../../../prescriptive-guidance/latest/patterns/configure-cross-account-access-to-a-shared-aws-glue-data-catalog-using-amazon-athena.md) in the _AWS Prescriptive Guidance_
_Patterns_ guide.
...
- [Granting cross-account access](../../../glue/latest/dg/cross-account-access.md) in the
