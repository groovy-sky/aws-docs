...
[Granting\
cross-account access](../../../glue/latest/dg/cross-account-access.md) in the _AWS Glue User Guide_.
...
policy](../../../lambda/latest/dg/access-control-resource-based.md) to the Lambda function and [principal](../../../s3/latest/userguide/access-policy-language-overview.md) access to its spill bucket in Amazon S3.
...
that Account A assumes by calling the AWS Security Token Service [AssumeRole](../../../../reference/sts/latest/apireference/api-assumerole.md) API action.
...
1. Use the IAM console or the AWS CLI to create the
    ...
    using custom trust policies](../../../iam/latest/userguide/id-roles-create-for-custom.md) in the _IAM User Guide_.
