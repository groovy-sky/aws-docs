...
Follow [Setting up a trusted token issuer](../../../iam/latest/userguide/id-roles-providers-create-oidc.md) guide to setup trusted token
...
For more information, see [Identity providers and federation](../../../iam/latest/userguide/id-roles-providers.md).
...
4. Add the following inline policy to grant access to the user for [CreateTokenWithIAM](../../../../reference/singlesignon/latest/oidcapireference/api-createtokenwithiam.md), [ListTagsForResource](../../../../reference/athena/latest/apireference/api-listtagsforresource.md), and [AssumeRoleWithWebIdentity](../../../../reference/sts/latest/apireference/api-assumerolewithwebidentity.md) permissions.
JSON
...
propagation](../../../singlesignon/latest/userguide/customermanagedapps-trusted-identity-propagation-set-up-your-own-app-oauth2.md) with the following considerations for Athena.
...
- When [specifying application credentials](../../../singlesignon/latest/userguide/customermanagedapps-trusted-identity-propagation-set-up-your-own-app-oauth2.md#customermanagedapps-trusted-identity-propagation-set-up-your-own-app-OAuth2-specify-application-credentials), add the ARN for AWS IAM
...
on JDBC installation, see [Get started with the JDBC 3.x driver](jdbc-v3-driver-getting-started.md). You can choose to install ODBC
drivers based on the supported platform. For more information, see [Get started with the ODBC 2.x driver](odbc-v2-driver-getting-started.md). Based on the driver that you
want to use, provide the parameters listed in:

- [JDBC auth plugin\
connection parameters](jdbc-v3-driver-jwt-tip-credentials.md)

- [ODBC auth plugin connection\
parameters](odbc-v2-driver-jwt-tip.md)
...
07. Choose **Connect to a database** and find Athena JDBC
     ...
     information, see [Configuring the driver](jdbc-v3-driver-getting-started.md#jdbc-v3-driver-configuring-the-driver).

08. Provide the following details

1. **Workgroup** – The workgroup in which you
    want to run queries. For information about workgroups, see [WorkGroup](../../../../reference/athena/latest/apireference/api-workgroup.md).

2. **Region** – The AWS Region where the
    queries will be run. For a list of regions, see [Amazon Athena endpoints and quotas](../../../../general/latest/gr/athena.md).
...
5. **ApplicationRoleArn** – The ARN of the
    ...
    information about ARN roles, see [AssumeRole](../../../../reference/sts/latest/apireference/api-assumerole.md) in the AWS Security Token Service API reference.
...
6. **WorkgroupArn** – The ARN of the
    ...
    information about workgroups, see [WorkGroup](../../../../reference/athena/latest/apireference/api-workgroup.md).
...
09. Choose **OK** and close the window. DBeaver will start
    ...
    **connection** before choosing **OK**, it
    ...
    information, see [Prerequisites and considerations for trusted token issuers](../../../singlesignon/latest/userguide/using-apps-with-trusted-token-issuer.md#trusted-token-issuer-prerequisites).
    To handle this, JDBC implements an in-memory cache, whose lifecycle is
    dependent on the main driver instance. For ODBC, a [file cache](odbc-v2-driver-jwt-tip.md#odbc-v2-driver-jwt-tip-file-cache) is
...
10. Open **SQL query editor** and start running your queries.
     See [Cloudtrail logs](../../../awscloudtrail/latest/userguide/cloudtrail-user-guide.md) to verify the propagated identity of the
     user.
