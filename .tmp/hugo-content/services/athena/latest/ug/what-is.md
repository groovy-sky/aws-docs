...
Amazon Simple Storage Service (Amazon S3) using standard [SQL](ddl-sql-reference.md). With a few actions in the AWS Management Console, you
...
Spark applications using Python or [Use Athena Spark APIs](notebooks-spark-api-list.md).
...
automatically—running queries in parallel—so results are fast, even with large
