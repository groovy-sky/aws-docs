...
For information about updating your SSM Agent version, see [Installing and Configuring SSM Agent](../../../systems-manager/latest/userguide/ssm-agent.md) in the
...
(Amazon EC2)](../../../../general/latest/gr/rande.md#ec2_region) in the _Amazon Web Services General Reference_.
...
including the `namespace` field, see [CloudWatch agent configuration file: Metrics section](cloudwatch-agent-configuration-file-details.md#CloudWatch-Agent-Configuration-File-Metricssection).
...
agent. For more information, see [Manually create or edit the CloudWatch agent configuration file](cloudwatch-agent-configuration-file-details.md).
