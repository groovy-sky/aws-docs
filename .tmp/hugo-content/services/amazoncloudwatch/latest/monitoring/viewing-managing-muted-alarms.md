...
**Programmatically checking alarm mute status:** To programmatically determine if an alarm is currently muted, you can use the [ListAlarmMuteRules](../../../../reference/amazoncloudwatch/latest/apireference/api-listalarmmuterules.md) API with the alarm name as a filter criteria. This API returns all active mute rules that are affecting the specified alarm, allowing you to integrate mute status checks into your automation workflows, monitoring dashboards, or operational tools.

For example: To check if an alarm named "HighCPUAlarm" is currently muted, call the [ListAlarmMuteRules](../../../../reference/amazoncloudwatch/latest/apireference/api-listalarmmuterules.md) API with the filter parameter set to the alarm name. The response will include all mute rules targeting that alarm, along with their current status (SCHEDULED, ACTIVE, or EXPIRED).
...
You can manage alarm mute rules programmatically using the CloudWatch API. For more information, see [PutAlarmMuteRule](../../../../reference/amazoncloudwatch/latest/apireference/api-putalarmmuterule.md), [GetAlarmMuteRule](../../../../reference/amazoncloudwatch/latest/apireference/api-getalarmmuterule.md), [ListAlarmMuteRules](../../../../reference/amazoncloudwatch/latest/apireference/api-listalarmmuterules.md), and [DeleteAlarmMuteRule](../../../../reference/amazoncloudwatch/latest/apireference/api-deletealarmmuterule.md).
