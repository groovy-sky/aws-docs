...
see [NAT Gateways](../../../vpc/latest/userguide/vpc-nat-gateway.md).
...
For more information, see [Verifying prerequisites for Container Insights in CloudWatch](container-insights-prerequisites.md).
