...
2. Create the Firehose delivery stream. For more information, see
    [Creating a Firehose stream](../../../firehose/latest/dev/basic-create.md).
...
You can use CloudFormation to set up a metric stream. For more information, see [AWS::CloudWatch::MetricStream](../../../cloudformation/latest/userguide/aws-resource-cloudwatch-metricstream.md).
...
4. Create the stream in CloudFormation. For more information,
    see [AWS::CloudWatch::MetricStream](../../../cloudformation/latest/userguide/aws-resource-cloudwatch-metricstream.md).
...
2. Create the Firehose delivery stream. For more information, see
    [Creating an Amazon Data Firehose Delivery Stream](../../../firehose/latest/dev/basic-create.md).
...
4. Create the metric stream. The metric stream resource
    ...
    [Using L1 constructs](../../../cdk/latest/guide/constructs.md#constructs_l1_using.html).
