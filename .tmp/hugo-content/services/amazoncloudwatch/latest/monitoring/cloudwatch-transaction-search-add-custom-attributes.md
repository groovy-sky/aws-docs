...
After these attributes have been added to the span, they become available to search and analyze in [the Transaction Search visual editor](cloudwatch-transaction-search-search-analyze-spans.md).
...
After you add these events, they become available in the [Transaction Search visual editor](cloudwatch-transaction-search-search-analyze-spans.md).
