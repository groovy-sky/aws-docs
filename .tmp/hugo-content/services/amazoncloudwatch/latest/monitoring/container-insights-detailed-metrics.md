...
more information about the additional metrics and dimensions collected, see [Amazon EKS and Kubernetes Container Insights with enhanced observability metrics](container-insights-metrics-enhanced-eks.md).
...
in [Upgrading to Container Insights with enhanced observability for Amazon EKS in CloudWatch](container-insights-upgrade-enhanced.md).
