...
For more information about creating alarm mute rules programmatically, see [PutAlarmMuteRule](../../../../reference/amazoncloudwatch/latest/apireference/api-putalarmmuterule.md).
