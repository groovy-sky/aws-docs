...
agent and how to install it, see [Collect metrics, logs, and traces using the CloudWatch agent](install-cloudwatch-agent.md).
...
AWS CloudTrail](../../../awscloudtrail/latest/userguide/cloudtrail-user-guide.md), [Creating a trail with the CloudTrail console](../../../awscloudtrail/latest/userguide/cloudtrail-create-and-update-a-trail.md), [Working with CloudTrail\
trails](../../../awscloudtrail/latest/userguide/cloudtrail-trails.md) and [Sending events to CloudWatch Logs](../../../awscloudtrail/latest/userguide/send-cloudtrail-events-to-cloudwatch-logs.md).
...
about the CloudWatch agent and how to install it, see [Container Insights](containerinsights.md).
...
Insights](../../../amazonrds/latest/userguide/user-databaseinsights.md).
