...
Amazon EC2 Auto Scaling and Application Auto Scaling. This feature is available only in the AWS Management Console.
...
**alarms**, and select **Hide Auto Scaling alarms**.
