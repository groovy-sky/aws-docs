...
- Container logs routing from Amazon ECS containers to CloudWatch using [`awslogs` log driver](../../../amazonecs/latest/developerguide/using-awslogs.md).

- Container logs routing from Amazon ECS containers to CloudWatch using [FireLens container\
log router](../../../amazonecs/latest/developerguide/using-firelens.md).

- Container logs routing from Amazon EKS or Kubernetes running on Amazon EC2 to CloudWatch using
[Fluent Bit or Fluentd log processor](container-insights-eks-logs.md) with Container Insights.
...
CloudWatch agent](cloudwatch-agent-procstat-process-metrics.md)
...
Standard log class](../logs/cloudwatch-logs-log-classes.md) to enable monitoring.
