...
Container Insights collects data as _performance log events_ using [embedded metric format](cloudwatch-embedded-metric-format.md). These performance
...
metrics is available for Amazon EKS. For more information, see [Container Insights with OpenTelemetry metrics for Amazon EKS](container-insights-otel-metrics.md).
