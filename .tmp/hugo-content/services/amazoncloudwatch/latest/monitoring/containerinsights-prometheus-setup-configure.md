...
For an example of this process, see [Tutorial for adding a new Prometheus scrape target: Prometheus API Server metrics](#ContainerInsights-Prometheus-Setup-new-exporters).
...
more information, see [Detailed guide for autodiscovery on Amazon ECS clusters](containerinsights-prometheus-setup-autodiscovery-ecs.md).
...
available on [Github](https://github.com/prometheus/prometheus/blob/main/documentation/examples/prometheus-kubernetes.yml).
...
02. Make sure you have the correct AWS Region selected.

03. In the navigation pane, choose **Dashboards**.

04. Choose **Create Dashboard**. Enter a name for the new
     dashboard, and choose **Create dashboard**.

05. In **Add to this dashboard**, choose
     **Cancel**.

06. Choose **Actions**, **View/edit**
    **source**.

07. Download the following JSON file: [Kubernetes API Dashboard source](https://raw.githubusercontent.com/aws-samples/amazon-cloudwatch-container-insights/latest/k8s-deployment-manifest-templates/deployment-mode/service/cwagent-prometheus/sample_cloudwatch_dashboards/kubernetes_api_server/cw_dashboard_kubernetes_api_server.json).

08. Open the JSON file that you downloaded with a text editor, and make the
     following changes:
...
09. Copy the entire JSON blob and paste it into the text box in the CloudWatch
