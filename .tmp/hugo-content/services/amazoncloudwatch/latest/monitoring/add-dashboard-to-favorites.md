...
1. (Optional) You also can favorite a dashboard
       ...
       from the list
       and choosing the star symbol
       next
       to the dashboard name.
4. To access the favorites list, choose **Favorites and**
**recents** in the navigation pane. The menu contains two columns.
    One
    contains
    your favorite dashboards, alarms, and log groups, and
    the other column
    contains
    the dashboards, alarms, and log groups that you recently visited.
