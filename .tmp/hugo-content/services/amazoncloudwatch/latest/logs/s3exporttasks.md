...
At a command prompt, run the following [create-bucket](../../../cli/latest/reference/s3api/create-bucket.md)
...
2. Set the policy that you just added as the access policy on your bucket
    by using the [put-bucket-policy](../../../cli/latest/reference/s3api/put-bucket-policy.md) command. This policy enables CloudWatch Logs to
...
2. At a command prompt, use the following [create-export-task](../../../cli/latest/reference/logs/create-export-task.md) command to create the export
    task.
