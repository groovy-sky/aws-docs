...
and determining which log groups to exclude, see [Log recursion prevention](subscriptions-recursion-prevention.md).
...
parameter. For more information, see [describe-account-policies¶](../../../cli/latest/reference/logs/describe-account-policies.md).
...
shards, it is throttled. For more information about stream volume limits, see [Quotas and Limits](../../../streams/latest/dev/service-sizes-and-limits.md) in the Amazon Kinesis Data Streams documentation.
...
more information, see [On-demand mode](../../../streams/latest/dev/how-do-i-size-a-stream.md#ondemandmode).
...
2. Wait a few minutes for the stream to become active. You can verify whether
    the stream is active by using the [describe-stream](../../../cli/latest/reference/kinesis/describe-stream.md)
...
information about Lambda limits, see [AWS Lambda Limits](../../../lambda/latest/dg/limits.md).
...
more information about this problem, see [Log recursion prevention](subscriptions-recursion-prevention.md) .
...
automatically decompress the logs. For more information, see [Writing to Kinesis Data Firehose Using CloudWatch Logs](../../../firehose/latest/dev/writing-with-cloudwatch-logs.md).
