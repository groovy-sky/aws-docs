...
Keys](../../../kms/latest/developerguide/symmetric-asymmetric.md).
...
To create a KMS key use the following [create-key](../../../cli/latest/reference/kms/create-key.md) command:
...
`policy.json` using the following [get-key-policy](../../../cli/latest/reference/kms/get-key-policy.md)
command:
...
Finally, add the updated policy using the following [put-key-policy](../../../cli/latest/reference/kms/put-key-policy.md)
command:
...
Use the [disassociate-kms-key](../../../cli/latest/reference/logs/disassociate-kms-key.md) command as follows:
...
[disassociate-kms-key](../../../cli/latest/reference/logs/disassociate-kms-key.md) command:
