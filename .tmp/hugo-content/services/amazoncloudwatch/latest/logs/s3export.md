...
information about subscriptions, see [Real-time processing of log data with subscriptions](subscriptions.md).
...
- [Describe export tasks (CLI)](describeexporttasks.md)

- [Cancel an export task (CLI)](cancelexporttask.md)
