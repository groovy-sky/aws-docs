...
- [Step 1: Create the integration with OpenSearch Service](opensearch-dashboards-integrate.md)

- [Step 2: Create vended logs dashboards](opensearch-dashboards-create.md)

- [View, edit, or delete vended logs dashboards](opensearch-dashboards-manage.md)

- [IAM policies for users](opensearch-dashboards-userroles.md)

- [Permissions that the integration needs](opensearch-dashboards-createrole.md)
