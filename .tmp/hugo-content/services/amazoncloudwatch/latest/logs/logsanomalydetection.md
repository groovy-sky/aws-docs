...
_detector_ for continuous monitoring, or by using the [anomaly detection](cwl-querysyntax-anomaly.md) command in CloudWatch Logs
...
returned by the [ListAnomalies](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-listanomalies.md) API operation. After this time period has elapsed for an
...
well. For more information about pattern analysis, see [Pattern analysis](cwl-analyzelogdata-patterns.md).
