...
in the previous procedure. For more information, see [CreateApp](../../../../reference/amplify/latest/apireference/api-createapp.md#API_CreateApp_RequestSyntax) in the _Amplify API reference_ and [AWS::Amplify::App](../../../cloudformation/latest/userguide/aws-resource-amplify-app.md) in the _AWS CloudFormation User Guide_.
