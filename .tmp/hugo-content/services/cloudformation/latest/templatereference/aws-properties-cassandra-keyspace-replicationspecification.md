...
to add an AWS Region to a keyspace](../../../keyspaces/latest/devguide/howitworks-replication-permissions-addreplica.md)
in the _Amazon Keyspaces Developer Guide_.

For more information about multi-Region replication, see [Multi-Region replication](../../../keyspaces/latest/devguide/multiregion-replication.md)
in the _Amazon Keyspaces Developer Guide_.
...
AWS Regions disabled by default](../../../keyspaces/latest/devguide/multiregion-replication-how-it-works.md#howitworks_mrr_opt_in) in the _Amazon Keyspaces Developer Guide_.
