...
[Address](../../../../reference/awsec2/latest/apireference/api-address.md) data type. One way to retrieve this value is by calling the EC2
...
public-facing. For details, see [Create an internet-facing endpoint for your server](../../../transfer/latest/userguide/create-server-in-vpc.md#create-internet-facing-endpoint).
...
You can edit the `SecurityGroupIds` property in the [UpdateServer](../../../transfer/latest/userguide/api-updateserver.md) API only if you are changing the `EndpointType`
