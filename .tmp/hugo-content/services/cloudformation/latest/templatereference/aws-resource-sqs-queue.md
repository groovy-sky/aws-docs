...
[limits related\
to queues](../../../awssimplequeueservice/latest/sqsdeveloperguide/limits-queues.md) and is unique within the scope of your queues.
...
- [Request Parameters](../../../../reference/kms/latest/apireference/api-describekey.md#API_DescribeKey_RequestParameters) in the _AWS Key Management Service API Reference_

- The Key Management Service (KMS) section of the [Security best practices for AWS Key Management Service](../../../kms/latest/developerguide/best-practices.md) in the _AWS Key Management Service Developer Guide_
...
that ID for the queue name. For more information, see [Name type](../userguide/aws-properties-name.md) in the _CloudFormation User Guide_.
...
tag](../userguide/aws-properties-resource-tags.md) in the _CloudFormation User Guide_.
