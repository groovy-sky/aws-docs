...
Regions](../../../acm/latest/userguide/acm-regions.md) in the _AWS Certificate Manager User_
_Guide_.
...
_Type_: Array of [IpPermission](aws-properties-gamelift-fleet-ippermission.md)
...
property is set to `ON_DEMAND`. Learn more about when to use [On-Demand versus Spot Instances](../../../gamelift/latest/developerguide/gamelift-ec2-instances.md#gamelift-ec2-instances-spot). This fleet property can't be changed after the fleet is created.
...
[Access external resources from a game server](../../../../reference/gamelift/latest/developerguide/gamelift-sdk-server-resources.md). This attribute is used with fleets where `ComputeType` is
`EC2`.
...
with other AWS resources from your fleets](../../../../reference/gamelift/latest/developerguide/gamelift-sdk-server-resources.md). This attribute is used with
...
[Amazon GameLift Servers service locations](../../../gamelift/latest/developerguide/gamelift-regions.md) for managed hosting.

_Required_: No

_Type_: Array of [LocationConfiguration](aws-properties-gamelift-fleet-locationconfiguration.md)
...
Learn more about VPC peering in [VPC Peering with Amazon GameLift Servers Fleets](../../../gamelift/latest/developerguide/vpc-peering.md).
...
_Type_: [PlayerGatewayConfiguration](aws-properties-gamelift-fleet-playergatewayconfiguration.md)
...
**How it works:** When enabled, game clients connect to relay endpoints instead of to your game servers. Player gateway validates player gateway tokens and routes traffic to the appropriate game server. Your game backend calls [GetPlayerConnectionDetails](../../../../reference/gamelift/latest/apireference/api-getplayerconnectiondetails.md) to retrieve relay endpoints and player gateway tokens for your game clients. To learn more about this topic, see [DDoS protection with Amazon GameLift Servers player gateway](../../../gameliftservers/latest/developerguide/ddos-protection-intro.md).
...
- `ENABLED` \-\- Player gateway is available in fleet locations where it is supported. Your game backend can call [GetPlayerConnectionDetails](../../../../reference/gamelift/latest/apireference/api-getplayerconnectiondetails.md) to obtain a player gateway token and endpoints for game clients.
...
_Type_: Array of [ScalingPolicy](aws-properties-gamelift-fleet-scalingpolicy.md)
...
_Type_: Array of [Tag](aws-properties-gamelift-fleet-tag.md)
...
The Amazon Resource Name ( [ARN](../../../s3/latest/dev/s3-arn-format.md)) that is assigned to a Amazon GameLift Servers fleet resource and uniquely identifies it. ARNs are unique across all Regions. Format is `arn:aws:gamelift:<region>::fleet/fleet-a1234567-b8c9-0d1e-2fa3-b45c6d7e8912`. In a GameLift fleet ARN, the resource ID matches the `FleetId`
value.
...
- [Setting up GameLift fleets](../../../gamelift/latest/developerguide/fleets-intro.md) in the _Amazon GameLift Developer_
_Guide_

- [CreateFleet](../../../../reference/gamelift/latest/apireference/api-createfleet.md) in the _Amazon GameLift API Reference_
