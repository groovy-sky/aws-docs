...
opt-out keywords, see [SMS opt out](../../../sms-voice/latest/userguide/opt-out-list-keywords.md) in the AWS End User Messaging SMS User Guide.
...
_Type_: Array of [Tag](aws-properties-smsvoice-optoutlist-tag.md)
