...
`MinimumHealthyHosts` is a property of the [DeploymentConfig](../userguide/aws-resource-codedeploy-deploymentconfig.md) resource that defines how many instances must remain healthy
...
Health](../../../codedeploy/latest/userguide/instances-health.md) in the _AWS CodeDeploy User Guide_.
