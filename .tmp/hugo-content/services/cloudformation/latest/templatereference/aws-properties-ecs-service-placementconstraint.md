...
constraint type is `distinctInstance`. For more information, see [Cluster query language](../../../amazonecs/latest/developerguide/cluster-query-language.md) in the _Amazon Elastic_
