...
gateway. For more information, see [NAT gateways](../../../vpc/latest/userguide/vpc-nat-gateway.md) in the _Amazon VPC User Guide_.
...
address by viewing its details. For more information, see [Allocate an Elastic IP address](../../../vpc/latest/userguide/vpc-eips.md#allocate-eip)
...
_Type_: Array of [AvailabilityZoneAddress](aws-properties-ec2-natgateway-availabilityzoneaddress.md)
...
Secondary EIP allocation IDs. For more information, see [Create a NAT gateway](../../../vpc/latest/userguide/nat-gateway-working-with.md)
in the _Amazon VPC User Guide_.
...
\[Private NAT gateway only\] The number of secondary private IPv4 addresses you want to assign to the NAT gateway. For more information about secondary addresses, see [Create a NAT gateway](../../../vpc/latest/userguide/vpc-nat-gateway.md#nat-gateway-creating) in the _Amazon Virtual Private Cloud User Guide_.
...
Secondary private IPv4 addresses. For more information about secondary addresses, see [Create a NAT gateway](../../../vpc/latest/userguide/vpc-nat-gateway.md#nat-gateway-creating) in the _Amazon Virtual Private Cloud User Guide_.
...
_Type_: Array of [Tag](aws-properties-ec2-natgateway-tag.md)
