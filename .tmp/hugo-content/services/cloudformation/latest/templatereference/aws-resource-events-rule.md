...
the state. You can disable a rule using [DisableRule](../../../../reference/eventbridge/latest/apireference/api-disablerule.md).
...
bus that you have created. For more information, see [CreateEventBus](../../../../reference/eventbridge/latest/apireference/api-createeventbus.md).
...
Budgets](../../../awsaccountbilling/latest/aboutv2/budgets-managing-costs.md).
...
[Generating\
CloudFormation templates from an EventBridge rule](../../../eventbridge/latest/userguide/rule-generate-template.md)
...
that runs on a schedule](../../../eventbridge/latest/userguide/eb-create-rule-schedule.md).
...
operations. For more information, see [Logging management events](../../../awscloudtrail/latest/userguide/logging-management-events-with-cloudtrail.md#logging-management-events) in the _CloudTrail User_
_Guide_, and [Filtering management events from AWS services](../../../eventbridge/latest/userguide/eb-service-event.md#eb-service-event-cloudtrail) in the
_Amazon EventBridge User Guide_.

This value is only valid for rules on the [default](../../../eventbridge/latest/userguide/eb-what-is-how-it-works-concepts.md#eb-bus-concepts-buses) event bus
or [custom event buses](../../../eventbridge/latest/userguide/eb-create-event-bus.md).
It does not apply to [partner event buses](../../../eventbridge/latest/userguide/eb-saas.md).
...
For a list of services you can configure as targets for events, see [EventBridge targets](../../../eventbridge/latest/userguide/eb-targets.md)
...
and Access Control](../../../eventbridge/latest/userguide/auth-and-access-control-eventbridge.md) in the _Amazon EventBridge User Guide_.
...
For more information about enabling cross-account events, see [PutPermission](../../../../reference/eventbridge/latest/apireference/api-putpermission.md).
...
_Type_: Array of [Target](aws-properties-events-rule-target.md)
