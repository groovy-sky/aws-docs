...
more information about inference experiments, see [Shadow tests](../../../sagemaker/latest/dg/shadow-tests.md).
...
variants. For more information, see [View, monitor, and edit shadow tests](../../../sagemaker/latest/dg/shadow-tests-view-monitor-edit.md).
...
_Type_: Array of [ModelVariantConfig](aws-properties-sagemaker-inferenceexperiment-modelvariantconfig.md)
...
_Type_: Array of [Tag](aws-properties-sagemaker-inferenceexperiment-tag.md)
...
- `Cancelled` \- When you conclude your experiment early using the [StopInferenceExperiment](../../../../reference/sagemaker/latest/apireference/api-stopinferenceexperiment.md) API, or if any operation fails with an unexpected error, it shows
as cancelled.
