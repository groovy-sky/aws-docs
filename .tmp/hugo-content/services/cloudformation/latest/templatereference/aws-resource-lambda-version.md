...
The `AWS::Lambda::Version` resource creates a [version](../../../lambda/latest/dg/versioning-aliases.md) from the current code and configuration of a
...
_Type_: [FunctionScalingConfig](aws-properties-lambda-version-functionscalingconfig.md)
...
_Type_: [RuntimePolicy](aws-properties-lambda-version-runtimepolicy.md)
