...
more information about the available processors to use in a transformer, see [Processors that you can use](../../../amazoncloudwatch/latest/logs/cloudwatch-logs-transformation-processors.md#CloudWatch-Logs-Transformation-Processors).
...
_Type_: Array of [Processor](aws-properties-logs-transformer-processor.md)
