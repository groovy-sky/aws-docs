...
consumer group ID specified, you cannot update this value. For more information, see [Customizable consumer group ID](../../../lambda/latest/dg/with-kafka-process.md#services-smaa-topic-add).
