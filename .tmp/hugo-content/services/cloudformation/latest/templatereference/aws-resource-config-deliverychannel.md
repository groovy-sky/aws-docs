...
For more information, see [How S3 Object Lock works](../../../s3/latest/userguide/object-lock-overview.md).
...
For more information, see [Deliver Configuration Items](../../../config/latest/developerguide/how-does-config-work.md#delivery-channel) in the AWS Config Developer Guide.
...
For more information, see [AWS::Config::ConfigurationRecorder](../userguide/aws-resource-config-configurationrecorder.md).

For more information, see [Managing the Delivery Channel](../../../config/latest/developerguide/manage-delivery-channel.md) in the AWS Config Developer Guide.
...
see [Name Type](../userguide/aws-properties-name.md).
...
that bucket must have policies that grant access permissions to AWS Config. For more information, see [Permissions for the Amazon S3 Bucket](../../../config/latest/developerguide/s3-bucket-policy.md) in the _AWS Config_
_Developer Guide_.
...
information, see [Permissions for the Amazon SNS Topic](../../../config/latest/developerguide/sns-topic-policy.md) in the _AWS Config_
_Developer Guide_.
