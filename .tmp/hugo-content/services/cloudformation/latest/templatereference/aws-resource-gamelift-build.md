...
[Migrate to server SDK version 5.](../../../../reference/gamelift/latest/developerguide/reference-serversdk5-migration.md)
...
with custom game servers](../../../gamelift/latest/developerguide/integration-custom-intro.md). By default Amazon GameLift Servers sets this value to
`4.0.2`.
...
use [TagResource](../../../../reference/gamelift/latest/apireference/api-tagresource.md), [UntagResource](../../../../reference/gamelift/latest/apireference/api-untagresource.md), and
[ListTagsForResource](../../../../reference/gamelift/latest/apireference/api-listtagsforresource.md) to add, remove, and view tags. The maximum tag limit
may be lower than stated. See the AWS General Reference for actual tagging
limits.

_Required_: No

_Type_: Array of [Tag](aws-properties-gamelift-build-tag.md)
...
The Amazon Resource Name ( [ARN](../../../s3/latest/dev/s3-arn-format.md)) that is assigned to a Amazon GameLift Servers build resource and uniquely identifies it. ARNs are unique across all Regions. Format is `arn:aws:gamelift:<region>::build/build-a1234567-b8c9-0d1e-2fa3-b45c6d7e8912`. In a GameLift build ARN, the resource ID matches the
_BuildId_ value.
...
- [CreateBuild](../../../../reference/gamelift/latest/apireference/api-createbuild.md) in the _Amazon GameLift API Reference_
