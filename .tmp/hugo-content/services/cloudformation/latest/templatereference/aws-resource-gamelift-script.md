...
see [Migrating from Node.js 10 to 24](../../../gamelift/latest/realtimeguide/realtime-script.md#realtime-script-nodejs-migration).
...
_Type_: [S3Location](aws-properties-gamelift-script-s3location.md)
...
_Type_: Array of [Tag](aws-properties-gamelift-script-tag.md)
...
- [CreateScript](../../../../reference/gamelift/latest/apireference/api-createscript.md) in the _Amazon GameLift API Reference_
