...
For more information, see [Access Management](../../../../general/latest/gr/aws-arns-and-namespaces.md)
...
_Type_: [HostedZoneFeatures](aws-properties-route53-hostedzone-hostedzonefeatures.md)
...
_Type_: Array of [HostedZoneTag](aws-properties-route53-hostedzone-hostedzonetag.md)
...
deputy problem](../../../iam/latest/userguide/confused-deputy.md) in the _AWS_
_IAM User Guide_.
...
see [Logging DNS\
Queries](../../../route53/latest/developerguide/query-logs.md) in the _Amazon Route 53 Developer_
_Guide_.
...
the query logging configuration. For more information, see [DeleteQueryLoggingConfig](../../../../reference/route53/latest/apireference/api-deletequeryloggingconfig.md).
...
_Type_: Array of [VPC](aws-properties-route53-hostedzone-vpc.md)
