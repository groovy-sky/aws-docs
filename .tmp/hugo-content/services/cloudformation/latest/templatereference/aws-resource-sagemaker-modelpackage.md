...
For more information, see [`CreateModelPackage`](../../../../reference/sagemaker/latest/apireference/api-createmodelpackage.md).
...
_Type_: Array of [AdditionalInferenceSpecificationDefinition](aws-properties-sagemaker-modelpackage-additionalinferencespecificationdefinition.md)
...
Package on AWS Marketplace](../../../sagemaker/latest/dg/sagemaker-mkt-list.md).
...
_Type_: [ModelCard](aws-properties-sagemaker-modelpackage-modelcard.md)
...
_Type_: [SecurityConfig](aws-properties-sagemaker-modelpackage-securityconfig.md)
...
A list of the tags associated with the model package. For more information, see [Tagging AWS resources](../../../../general/latest/gr/aws-tagging.md) in the _AWS General_
_Reference Guide_.

_Required_: No

_Type_: Array of [Tag](aws-properties-sagemaker-modelpackage-tag.md)
