...
For information about the maximum number of task sets and other quotas, see [Amazon ECS service quotas](../../../amazonecs/latest/developerguide/service-quotas.md) in the _Amazon Elastic Container Service_
_Developer Guide_.
...
_Type_: Array of [CapacityProviderStrategyItem](aws-properties-ecs-taskset-capacityproviderstrategyitem.md)
...
ECS launch types](../../../amazonecs/latest/developerguide/launch-types.md) in the _Amazon Elastic Container Service Developer_
_Guide_.
...
_Type_: Array of [LoadBalancer](aws-properties-ecs-taskset-loadbalancer.md)
...
_Type_: Array of [ServiceRegistry](aws-properties-ecs-taskset-serviceregistry.md)
...
_Type_: Array of [Tag](aws-properties-ecs-taskset-tag.md)
