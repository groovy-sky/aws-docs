...
The type of Amazon EC2 instances to use for brokers. Depending on the [broker type](../../../msk/latest/developerguide/broker-instance-types.md), Amazon MSK supports the following broker sizes:
