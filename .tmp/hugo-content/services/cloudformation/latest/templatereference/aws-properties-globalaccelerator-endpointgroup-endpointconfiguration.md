...
For more information, see [Preserve Client IP Addresses](../../../global-accelerator/latest/dg/preserve-client-ip-address.md) in the _AWS Global Accelerator Developer Guide_.
...
and third endpoints, and 6/20 is routed to the last endpoint. For more information, see [Endpoint Weights](../../../global-accelerator/latest/dg/about-endpoints-endpoint-weights.md) in the
