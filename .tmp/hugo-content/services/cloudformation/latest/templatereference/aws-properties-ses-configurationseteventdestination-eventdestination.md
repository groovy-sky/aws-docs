...
_Type_: [EventBridgeDestination](aws-properties-ses-configurationseteventdestination-eventbridgedestination.md)
...
event type only occurs when you send email using the [`SendEmail`](../../../../reference/ses/latest/apireference-v2/api-sendemail.md) or [`SendBulkEmail`](../../../../reference/ses/latest/apireference-v2/api-sendbulkemail.md) API operations.)
...
management](../../../ses/latest/dg/sending-email-subscription-management.md).
