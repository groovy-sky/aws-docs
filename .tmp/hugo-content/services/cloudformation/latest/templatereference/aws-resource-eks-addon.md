...
add-ons](../../../eks/latest/userguide/eks-add-ons.md) in the _Amazon EKS User Guide_.
...
_Type_: [NamespaceConfig](aws-properties-eks-addon-namespaceconfig.md)
...
using EKS Pod Identity](../../../eks/latest/userguide/add-ons-iam.md) in the _Amazon EKS User Guide_.

_Required_: No

_Type_: Array of [PodIdentityAssociation](aws-properties-eks-addon-podidentityassociation.md)
...
update operation. For more information, see [`UpdateAddon`](../../../../reference/eks/latest/apireference/api-updateaddon.md).
...
permissions assigned to the node IAM role. For more information, see [Amazon EKS node IAM role](../../../eks/latest/userguide/create-node-role.md) in the _Amazon EKS User Guide_.
...
IAM roles for service accounts on your cluster](../../../eks/latest/userguide/enable-iam-roles-for-service-accounts.md) in the
...
_Type_: Array of [Tag](aws-properties-eks-addon-tag.md)
...
- [Amazon EKS add-ons](../../../eks/latest/userguide/eks-add-ons.md) in the _Amazon EKS User Guide_.

- [`CreateAddon`](../../../../reference/eks/latest/apireference/api-createaddon.md) in the _Amazon EKS API Reference_.
