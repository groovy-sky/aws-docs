...
GuardDuty console, or run the [ListDetectors](../../../../reference/guardduty/latest/apireference/api-listdetectors.md)
API.
...
supported formats, see [List formats](../../../guardduty/latest/ug/guardduty-upload-lists.md#prepare_list)
...
_Type_: Array of [TagItem](aws-properties-guardduty-trustedentityset-tagitem.md)
...
values, see [Understanding list statuses](../../../guardduty/latest/ug/guardduty-upload-lists.md#guardduty-entity-list-statuses) in the _Amazon GuardDuty User Guide_.
