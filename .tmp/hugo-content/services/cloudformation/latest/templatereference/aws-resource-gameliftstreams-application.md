...
at the end of a stream session. To retrieve stored log files, call [GetStreamSession](../../../../reference/gameliftstreams/latest/apireference/api-getstreamsession.md)
...
_Type_: [RuntimeEnvironment](aws-properties-gameliftstreams-application-runtimeenvironment.md)
...
useful for resource management, access management and cost allocation. See [Tagging AWS Resources](../../../../general/latest/gr/aws-tagging.md) in the _AWS General Reference_.
...
When you pass the logical ID of this resource to the intrinsic `Ref` function, `Ref` returns an [Amazon Resource Name (ARN)](../../../iam/latest/userguide/reference-arns.md)
...
An [Amazon Resource Name (ARN)](../../../iam/latest/userguide/reference-arns.md)
that uniquely identifies the application resource across all AWS Regions. For example:
...
Streams](../../../gameliftstreams/latest/developerguide/applications.md) in the _Amazon GameLift Streams Developer Guide_

- [CreateApplication](../../../../reference/gameliftstreams/latest/apireference/api-createapplication.md) in the
