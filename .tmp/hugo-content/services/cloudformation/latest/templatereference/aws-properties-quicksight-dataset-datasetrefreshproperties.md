...
_Type_: [RefreshFailureConfiguration](aws-properties-quicksight-dataset-refreshfailureconfiguration.md)
...
_Type_: [RefreshConfiguration](aws-properties-quicksight-dataset-refreshconfiguration.md)
