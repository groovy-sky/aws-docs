...
`TaskInstanceGroups` subproperty for the [AWS::EMR::Cluster JobFlowInstancesConfig](../userguide/aws-properties-elasticmapreduce-cluster-jobflowinstancesconfig.md) property instead. To use this
subproperty, see [AWS::EMR::Cluster](../userguide/aws-resource-elasticmapreduce-cluster.md) for examples.
...
`AutoScalingPolicy` is a subproperty of `InstanceGroupConfig`. `AutoScalingPolicy` defines how an instance group dynamically adds and terminates EC2 instances in response to the value of a CloudWatch metric. For more information, see [Using Automatic Scaling in Amazon EMR](../../../emr/latest/managementguide/emr-automatic-scaling.md) in the _Amazon EMR Management Guide_.

_Required_: No

_Type_: [AutoScalingPolicy](aws-properties-emr-instancegroupconfig-autoscalingpolicy.md)
...
_Type_: Array of [Configuration](aws-properties-emr-instancegroupconfig-configuration.md)
...
_Type_: [EbsConfiguration](aws-properties-emr-instancegroupconfig-ebsconfiguration.md)
