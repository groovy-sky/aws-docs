...
rules with AWS CloudFormation. For more information, see [Managing the Configuration Recorder](../../../config/latest/developerguide/stop-start-recorder.md).
...
[List of AWS Config\
Managed Rules](../../../config/latest/developerguide/managed-rules-by-aws-config.md). If you are adding an AWS Config managed rule, you must specify the
...
rules, see [Evaluating Resources with AWS Config Rules](../../../config/latest/developerguide/evaluate-config.md)
...
_Type_: [Compliance](aws-properties-config-configrule-compliance.md)
...
_Type_: Array of [EvaluationModeConfiguration](aws-properties-config-configrule-evaluationmodeconfiguration.md)
...
the configuration snapshot. For more information, see [ConfigSnapshotDeliveryProperties](../../../../reference/config/latest/apireference/api-configsnapshotdeliveryproperties.md).
...
To deploy with AWS CloudFormation, follow the steps in [Deploy Node.js Lambda functions with .zip file archives](../../../lambda/latest/dg/nodejs-package.md).
