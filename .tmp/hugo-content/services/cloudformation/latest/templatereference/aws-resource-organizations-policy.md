...
policies](../../../organizations/latest/userguide/orgs-manage-policies.md).
...
Before you can create a policy of a given type, you must first [enable that policy type](../../../organizations/latest/userguide/orgs-manage-policies-enable-disable.md) in your organization.
...
For more information about Organizations service quotas, see [Quotas for AWS Organizations](../../../organizations/latest/userguide/orgs-reference-limits.md) in the _AWS Organizations_
_User Guide_.
...
_Type_: Array of [Tag](aws-properties-organizations-policy-tag.md)
...
the policy to. You can get the ID by calling the [ListRoots](../../../../reference/organizations/latest/apireference/api-listroots.md), [ListOrganizationalUnitsForParent](../../../../reference/organizations/latest/apireference/api-listorganizationalunitsforparent.md), or [ListAccounts](../../../../reference/organizations/latest/apireference/api-listaccounts.md)
...
- [Managing\
AWS Organizations policies](../../../organizations/latest/userguide/orgs-manage-policies.md) in the _AWS Organizations User Guide_.

- [CreatePolicy](../../../../reference/organizations/latest/apireference/api-createpolicy.md) in the _AWS Organizations API_
_Reference Guide_.
