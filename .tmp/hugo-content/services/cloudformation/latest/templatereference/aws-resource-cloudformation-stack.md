...
- [AWS::IAM::AccessKey](aws-resource-iam-accesskey.md)

- [AWS::IAM::Group](aws-resource-iam-group.md)
...
- [AWS::IAM::User](aws-resource-iam-user.md)

- [AWS::IAM::UserToGroupAddition](aws-resource-iam-usertogroupaddition.md)
...
[AWS::Include](transform-aws-include.md) and [AWS::Serverless](transform-aws-serverless.md) transforms, which are macros hosted by CloudFormation.
...
processing on CloudFormation templates with template macros](../userguide/template-macros.md)
...
updates to stack resources](../userguide/protect-stack-resources.md) in the _CloudFormation User_
...
_Type_: Array of [Tag](aws-properties-cloudformation-stack-tag.md)
...
- For sample template snippets, see [CloudFormation template snippets](../userguide/quickref-cloudformation.md) in the
