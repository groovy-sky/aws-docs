...
_Type_: Array of [Action](aws-properties-iotanalytics-dataset-action.md)
...
_Type_: Array of [DatasetContentDeliveryRule](aws-properties-iotanalytics-dataset-datasetcontentdeliveryrule.md)
...
A list of data rules that send notifications to CloudWatch, when data arrives late. To specify `lateDataRules`, the dataset must use a [DeltaTimer](../../../../reference/iotanalytics/latest/apireference/api-deltatime.md) filter.

_Required_: No

_Type_: Array of [LateDataRule](aws-properties-iotanalytics-dataset-latedatarule.md)
...
_Type_: Array of [Tag](aws-properties-iotanalytics-dataset-tag.md)
...
_Type_: Array of [Trigger](aws-properties-iotanalytics-dataset-trigger.md)
...
see [Keeping Multiple Versions of AWS IoT Analytics datasets](../../../iotanalytics/latest/userguide/getting-started.md#aws-iot-analytics-dataset-versions) in the
...
- [CreateDataset](../../../../reference/iotanalytics/latest/apireference/api-createdataset.md) in the
