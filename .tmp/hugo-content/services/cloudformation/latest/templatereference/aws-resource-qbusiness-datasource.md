...
- [Amazon Simple Storage Service](../../../amazonq/latest/qbusiness-ug/s3-cfn.md)

- [Amazon Q\
Web Crawler](../../../amazonq/latest/qbusiness-ug/web-crawler-cfn.md)
...
1. Navigate to the [Supported\
    connectors](../../../amazonq/latest/business-use-dg/connectors-list.md) page in the Amazon Q Business User Guide, and select the
...
_Type_: [DocumentEnrichmentConfiguration](aws-properties-qbusiness-datasource-documentenrichmentconfiguration.md)
...
_Type_: [MediaExtractionConfiguration](aws-properties-qbusiness-datasource-mediaextractionconfiguration.md)
...
_Type_: Array of [Tag](aws-properties-qbusiness-datasource-tag.md)
...
Amazon VPC with Amazon Q Business connectors](../../../amazonq/latest/business-use-dg/connector-vpc.md).

_Required_: No

_Type_: [DataSourceVpcConfiguration](aws-properties-qbusiness-datasource-datasourcevpcconfiguration.md)
