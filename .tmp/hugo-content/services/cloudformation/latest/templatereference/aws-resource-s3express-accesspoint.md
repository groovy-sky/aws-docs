...
_Type_: [PublicAccessBlockConfiguration](aws-properties-s3express-accesspoint-publicaccessblockconfiguration.md)
...
_Type_: [Scope](aws-properties-s3express-accesspoint-scope.md)
...
_Type_: Array of [Tag](aws-properties-s3express-accesspoint-tag.md)
...
_Type_: [VpcConfiguration](aws-properties-s3express-accesspoint-vpcconfiguration.md)
