...
on-demand GPU computing for inference. For more information, see [Using Elastic Inference in Amazon SageMaker](../../../sagemaker/latest/dg/ei.md). For more information, see
[Using Elastic Inference in Amazon\
SageMaker](../../../sagemaker/latest/dg/ei.md).
...
SageMaker Hosting. For more information about health check, see [How Your Container Should Respond to Health Check (Ping) Requests](../../../sagemaker/latest/dg/your-algorithms-inference-code.md#your-algorithms-inference-algo-ping-requests).
...
_Type_: [ServerlessConfig](aws-properties-sagemaker-endpointconfig-serverlessconfig.md)
