...
- `Esri` – For additional information about [Esri](../../../location/previous/developerguide/esri.md)'s coverage in your region of interest, see [Esri details on street networks and traffic coverage](https://doc.arcgis.com/en/arcgis-online/reference/network-coverage.htm).
...
For additional information about [GrabMaps](../../../location/previous/developerguide/grab.md)' coverage,
see [GrabMaps\
...
Technologies](../../../location/previous/developerguide/here.md)' coverage in your region of interest, see [HERE car routing coverage](https://developer.here.com/documentation/routing-api/dev_guide/topics/coverage/car-routing.html) and [HERE truck routing coverage](https://developer.here.com/documentation/routing-api/dev_guide/topics/coverage/truck-routing.html).
...
_Type_: Array of [Tag](aws-properties-location-routecalculator-tag.md)
