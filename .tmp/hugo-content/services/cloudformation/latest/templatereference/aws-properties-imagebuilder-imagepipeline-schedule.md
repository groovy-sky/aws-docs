...
_Type_: [AutoDisablePolicy](aws-properties-imagebuilder-imagepipeline-autodisablepolicy.md)
...
version syntax, see [CreateComponent](../../../../reference/imagebuilder/latest/apireference/api-createcomponent.md)
...
cron expressions in EC2 Image Builder](../../../imagebuilder/latest/userguide/image-builder-cron.md).
...
- [Create \
an image pipeline](../../../imagebuilder/latest/userguide/managing-image-builder-cli.md#image-builder-cli-create-image-pipeline) in the _Image Builder User Guide_.
