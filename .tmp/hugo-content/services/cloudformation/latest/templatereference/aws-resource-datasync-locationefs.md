...
restricted file systems](../../../datasync/latest/userguide/create-efs-location.md#create-efs-location-iam).
...
your Amazon EFS file system's [mount targets](../../../efs/latest/ug/accessing-fs.md).
...
IAM role for file system access](../../../datasync/latest/userguide/create-efs-location.md#create-efs-location-iam-role).
...
By default, DataSync uses the root directory (or [access point](../../../efs/latest/ug/efs-access-points.md) if you provide one by using
...
_Type_: Array of [Tag](aws-properties-datasync-locationefs-tag.md)
