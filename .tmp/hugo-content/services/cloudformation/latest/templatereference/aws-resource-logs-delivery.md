...
To update an existing delivery configuration, use [UpdateDeliveryConfiguration](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-updatedeliveryconfiguration.md).
...
find the values supported for the suffix path for each log source, use the [DescribeConfigurationTemplates](../../../../reference/amazoncloudwatchlogs/latest/apireference/api-describeconfigurationtemplates.md) operation and check the
...
_Type_: Array of [Tag](aws-properties-logs-delivery-tag.md)
