...
managed key](../../../kms/latest/developerguide/create-keys.md). Enter a key ID, key ARN, alias name, or alias ARN.
...
_Type_: Array of [Tag](aws-properties-location-geofencecollection-tag.md)
