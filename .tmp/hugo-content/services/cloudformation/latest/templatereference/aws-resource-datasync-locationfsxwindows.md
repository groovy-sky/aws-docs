...
_Type_: [CmkSecretConfig](aws-properties-datasync-locationfsxwindows-cmksecretconfig.md)
...
_Type_: [CustomSecretConfig](aws-properties-datasync-locationfsxwindows-customsecretconfig.md)
...
_Type_: Array of [Tag](aws-properties-datasync-locationfsxwindows-tag.md)
...
files, folders, and metadata, see [user](../../../datasync/latest/userguide/create-fsx-location.md#FSxWuser).
