...
attribute](../userguide/aws-attribute-updatepolicy.md).
...
attribute](../userguide/aws-attribute-updatepolicy.md) to your stack to perform rolling updates (or replace the group) when a
...
attribute](../userguide/aws-attribute-creationpolicy.md) with an Auto Scaling group to prevent its status from reaching create
...
It also shows an [AWS::EC2::LaunchTemplate](../userguide/aws-resource-ec2-launchtemplate.md) resource that contains the instance configuration
information for the group, which uses the `LaunchTemplate` property to specify
the launch template. The [Ref](../userguide/intrinsic-function-reference-ref.md) intrinsic function gets the ID of the `AWS::EC2::LaunchTemplate`
resource `myLaunchTemplate`. The [GetAtt](../userguide/intrinsic-function-reference-getatt.md) function gets the latest version number (for example, `1`) of
...
information, see [AWS Systems Manager Parameter Store](../../../systems-manager/latest/userguide/systems-manager-parameter-store.md) in the _AWS Systems Manager User Guide_ and the blog post [Query for the latest Amazon Linux AMI IDs using AWS Systems Manager\
...
and custom tags. The `LaunchTemplate` property references an [AWS::EC2::LaunchTemplate](../userguide/aws-resource-ec2-launchtemplate.md) resource with the logical name
