...
_Type_: [ComputeConfig](aws-properties-dms-replicationconfig-computeconfig.md)
...
replication configuration. For example, see [Change processing tuning settings](../../../dms/latest/userguide/chap-tasks-customizingtasks-tasksettings-changeprocessingtuning.md).
...
tags](../../../dms/latest/userguide/chap-security.md#CHAP_Security.FineGrainedAccess).
...
[Specifying supplemental data for task settings](../../../dms/latest/userguide/chap-tasks-taskdata.md).
...
JSON](../../../dms/latest/userguide/chap-tasks-customizingtasks-tablemapping-selectiontransformation.md).
...
replication. For more information, see [Tagging resources in AWS Database Migration Service](../../../dms/latest/userguide/chap-tagging.md).

_Required_: No

_Type_: Array of [Tag](aws-properties-dms-replicationconfig-tag.md)
