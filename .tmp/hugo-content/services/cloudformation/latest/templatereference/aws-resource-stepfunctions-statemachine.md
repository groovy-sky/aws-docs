...
match the format of your CloudFormationtemplate file. See [Amazon States Language](../../../step-functions/latest/dg/concepts-amazon-states-language.md).
...
The Amazon States Language definition of the state machine. The state machine definition must be in JSON. See [Amazon States Language](../../../step-functions/latest/dg/concepts-amazon-states-language.md).
...
_Type_: [EncryptionConfiguration](aws-properties-stepfunctions-statemachine-encryptionconfiguration.md)
...
see [Log Levels](../../../step-functions/latest/dg/cloudwatch-log-level.md) in the AWS Step Functions User Guide.
...
Workflows](../../../step-functions/latest/dg/concepts-standard-vs-express.md) in the AWS Step Functions Developer Guide.
...
_Type_: Array of [TagsEntry](aws-properties-stepfunctions-statemachine-tagsentry.md)
