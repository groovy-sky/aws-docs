...
For more information about virtual nodes, see [Virtual nodes](../../../app-mesh/latest/userguide/virtual-nodes.md). You must be using `1.15.0` or later of the Envoy image when
setting these variables. For more information aboutApp Mesh Envoy variables, see
[Envoy\
image](../../../app-mesh/latest/userguide/envoy.md) in the AWS App Mesh User Guide.
...
_Type_: Array of [Tag](aws-properties-appmesh-virtualnode-tag.md)
...
- [Virtual Nodes](../../../app-mesh/latest/userguide/virtual-nodes.md) in the _AWS App Mesh User Guide_.

- [CreateVirtualNode](../../../../reference/app-mesh/latest/apireference/api-createvirtualnode.md) in the _AWS App Mesh API Reference_.
