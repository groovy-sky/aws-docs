...
WebSocket APIs, see [About WebSocket APIs in API Gateway](../../../apigateway/latest/developerguide/apigateway-websocket-api-overview.md) in the _API Gateway_
_Developer Guide_. For more information about HTTP APIs, see [HTTP APIs](../../../apigateway/latest/developerguide/http-api.md) in the _API Gateway Developer_
_Guide._
...
- [CreateApi](../../../apigatewayv2/latest/api-reference/apis.md#CreateApi) in the _Amazon API Gateway_
