...
template. For a complete list of Elastic Beanstalk configuration options, see [Option Values](../../../elasticbeanstalk/latest/dg/command-options.md) in the
...
The Amazon Resource Name (ARN) of the custom platform. For more information, see [Custom Platforms](../../../elasticbeanstalk/latest/dg/custom-platforms.md) in the _AWS Elastic Beanstalk Developer Guide_.
...
values. For more information, see [Supported Platforms](../../../elasticbeanstalk/latest/dg/concepts-platforms.md) in the
_AWS Elastic Beanstalk Developer Guide_.
...
Use the [`ListAvailableSolutionStacks`](../../../elasticbeanstalk/latest/api/api-listavailablesolutionstacks.md) API to obtain a list of available
solution stacks.
...
- [AWS::ElasticBeanstalk::Application](../userguide/aws-properties-beanstalk.md)
