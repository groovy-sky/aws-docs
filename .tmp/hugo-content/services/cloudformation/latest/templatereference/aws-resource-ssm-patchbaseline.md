...
For more information, see [CreatePatchBaseline](../../../../reference/systems-manager/latest/apireference/api-createpatchbaseline.md) in the _AWS Systems Manager API_
_Reference_.
...
see [Package\
name formats for approved and rejected patch lists](../../../systems-manager/latest/userguide/patch-manager-approved-rejected-package-name-formats.md) in the _AWS Systems Manager User Guide_.
...
_Type_: Array of [PatchSource](aws-properties-ssm-patchbaseline-patchsource.md)
...
_Type_: Array of [Tag](aws-properties-ssm-patchbaseline-tag.md)
...
- [CreatePatchBaseline](../../../../reference/systems-manager/latest/apireference/api-createpatchbaseline.md) in the _AWS Systems Manager_
_API Reference_.
