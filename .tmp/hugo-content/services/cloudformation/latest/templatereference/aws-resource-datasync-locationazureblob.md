...
You can make transfers with or without a [DataSync agent](../../../datasync/latest/userguide/creating-azure-blob-location.md#azure-blob-creating-agent) that connects to your
container.

Before you begin, make sure you know [how DataSync accesses Azure Blob Storage](../../../datasync/latest/userguide/creating-azure-blob-location.md#azure-blob-access) and works with [access tiers](../../../datasync/latest/userguide/creating-azure-blob-location.md#azure-blob-access-tiers) and [blob types](../../../datasync/latest/userguide/creating-azure-blob-location.md#blob-types).
...
agents for your transfer](../../../datasync/latest/userguide/multiple-agents.md).
...
applies when using the location as a transfer destination. For more information, see [Access tiers](../../../datasync/latest/userguide/creating-azure-blob-location.md#azure-blob-access-tiers).
...
_Type_: [AzureBlobSasConfiguration](aws-properties-datasync-locationazureblob-azureblobsasconfiguration.md)
...
_Type_: [CmkSecretConfig](aws-properties-datasync-locationazureblob-cmksecretconfig.md)
...
_Type_: [CustomSecretConfig](aws-properties-datasync-locationazureblob-customsecretconfig.md)
...
_Type_: Array of [Tag](aws-properties-datasync-locationazureblob-tag.md)
