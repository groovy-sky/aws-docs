...
the [CloudFormation Hooks User Guide](../../../cloudformation-cli/latest/hooks-userguide/what-is-cloudformation-hooks.md).
...
- [AWS Control Tower proactive controls as Hooks](../../../cloudformation-cli/latest/hooks-userguide/proactive-controls-hooks.md)

- [Guard Hooks](../../../cloudformation-cli/latest/hooks-userguide/guard-hooks.md)

- [Lambda Hooks](../../../cloudformation-cli/latest/hooks-userguide/lambda-hooks.md)
...
registry. For more information, see [Use third-party public extensions from the CloudFormation registry](registry-public.md).
