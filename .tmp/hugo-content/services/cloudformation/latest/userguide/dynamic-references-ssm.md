...
permission to call [GetParameters](../../../../reference/systems-manager/latest/apireference/api-getparameter.md) for the specified parameter. To learn
how to create IAM policies that provide access to specific Systems Manager parameters, see
[Restricting access to\
Systems Manager parameters using IAM policies](../../../systems-manager/latest/userguide/sysman-paramstore-access.md) in the
...
from the public parameter. For more information about public parameters, see [Discovering public parameters in Parameter Store](../../../systems-manager/latest/userguide/parameter-store-finding-public-parameters.md) in the
_AWS Systems Manager User Guide_.
