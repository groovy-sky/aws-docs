...
perform tasks during EC2 Windows instance launch](../../../ec2/latest/userguide/ec2launch-v2.md) in the _Amazon EC2 User_
_Guide_.

For information about AWS Windows AMIs, see the [AWS Windows\
AMI Reference](../../../ec2/latest/windows-ami-reference/windows-amis.md).
...
Windows instance using RDP](../../../ec2/latest/userguide/connecting-to-windows-instance.md) in the
...
- [EC2Launch directory structure](../../../ec2/latest/userguide/ec2config-service.md#UsingConfigXML_WinAMI)

- [EC2Launch v2 directory structure](../../../ec2/latest/userguide/ec2launch-v2.md#ec2launch-v2-directory)
