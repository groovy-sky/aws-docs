...
[AWS\
Secrets Manager](../../../secretsmanager/latest/userguide/intro.md) helps you to securely encrypt, store, and retrieve
credentials for your databases and other services. The [AWS\
Systems Manager Parameter Store](../../../systems-manager/latest/userguide/systems-manager-parameter-store.md) provides secure, hierarchical storage for
...
call in your account. For more information, see [Logging CloudFormation API calls with AWS CloudTrail](cfn-api-logging-cloudtrail.md).
