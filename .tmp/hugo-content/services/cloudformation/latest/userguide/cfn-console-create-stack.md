...
- [create-stack](../../../cli/latest/reference/cloudformation/create-stack.md) (AWS CLI)

- [New-CFNStack](../../../powershell/latest/reference/items/new-cfnstack.md) (AWS Tools for Windows PowerShell)
