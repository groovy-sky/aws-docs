...
Alternatively, you can use the [describe-stack-events](../../../cli/latest/reference/cloudformation/describe-stack-events.md) command while the stack is being created to view
