...
events](../../../awscloudtrail/latest/userguide/cloudtrail-events.md) and [CloudTrail record contents](../../../awscloudtrail/latest/userguide/cloudtrail-event-reference-record-contents.md).

For more information on CloudTrail event history, see [Working with CloudTrail\
Event history](../../../awscloudtrail/latest/userguide/view-cloudtrail-events.md).
