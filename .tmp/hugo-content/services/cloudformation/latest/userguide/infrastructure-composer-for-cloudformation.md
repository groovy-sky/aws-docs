...
AWS Infrastructure Composer](../../../infrastructure-composer/latest/dg/using-composer-basics.md) in the _AWS Infrastructure Composer Developer Guide_.
...
information, see the [AWS Infrastructure Composer Developer Guide](../../../infrastructure-composer/latest/dg/what-is-composer.md)
and [Infrastructure Composer](../../../toolkit-for-vscode/latest/userguide/appcomposer.md) in the _AWS Toolkit for Visual Studio Code User Guide_.
