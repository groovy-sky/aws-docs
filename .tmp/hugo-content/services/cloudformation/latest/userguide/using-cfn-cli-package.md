...
can specify local artifacts in your template and use the [package](../../../cli/latest/reference/cloudformation/package.md) command to
upload them quickly.
...
list of the supported resource properties, see the [package](../../../cli/latest/reference/cloudformation/package.md) documentation
in the [AWS CLI Command Reference](../../../cli/latest/reference/cloudformation/index.md).
...
The following [package](../../../cli/latest/reference/cloudformation/package.md) command creates and uploads a `.zip` file
...
[deploy](../../../cli/latest/reference/cloudformation/deploy.md)
command.
