...
- [Developing modules\
using the CloudFormation CLI](../../../cloudformation-cli/latest/userguide/modules.md) in the _CloudFormation Command Line_
_Interface User Guide_

- [Creating\
resource types using the CloudFormation CLI](../../../cloudformation-cli/latest/userguide/resource-types.md) in the _CloudFormation_
_Command Line Interface User Guide_

- [Developing custom Hooks using the CloudFormation CLI](../../../cloudformation-cli/latest/hooks-userguide/hooks-develop.md) in the
...
Guide](../../../cloudcontrolapi/latest/userguide/what-is-cloudcontrolapi.md). When using Cloud Control API to perform CRUDL (Create, Read, Update, Delete,
