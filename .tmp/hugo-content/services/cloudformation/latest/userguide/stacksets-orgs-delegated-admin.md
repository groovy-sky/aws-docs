...
an AWS account to join your organization](../../../organizations/latest/userguide/orgs-manage-accounts-invites.md).
...
information, see [Activate trusted access for StackSets with AWS Organizations](stacksets-orgs-activate-trusted-access.md).
