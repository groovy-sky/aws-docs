...
3](https://www.rfc-editor.org/rfc/rfc5480), which does not include `keyEncipherment` as a permitted
...
(ARN)](../../../../general/latest/gr/aws-arns-and-namespaces.md) of the certificate.
