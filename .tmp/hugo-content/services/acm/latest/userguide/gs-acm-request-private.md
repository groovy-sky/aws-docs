...
6. In the **Tags** section, you can optionally tag your
    ...
    creation, see [Tag AWS Certificate Manager resources](tags.md).
...
Use the [request-certificate](../../../cli/latest/reference/acm/request-certificate.md) command to request a private certificate in
ACM.
...
Service Linked Role with ACM](acm-slr.md).
