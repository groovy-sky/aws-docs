...
Combine ACM condition keys with AWS [global condition keys](../../../iam/latest/userguide/reference-policies-condition-keys.md) such as `aws:PrincipalArn` to further restrict actions to specific users or roles.
...
Filter requests based on ACM [key algorithm and size](acm-certificate.md#algorithms)
