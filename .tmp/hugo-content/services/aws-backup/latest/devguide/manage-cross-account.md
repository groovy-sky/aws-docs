...
[AWS Organizations](../../../organizations/latest/userguide/orgs-introduction.md) is a service that
...
single management account. [AWS Organizations quotas](../../../organizations/latest/userguide/orgs-reference-limits.md)
apply.
...
cross-account management is available, see [Feature availability by AWS Region](whatisbackup.md#features-by-region) .
...
organization](../../../organizations/latest/userguide/orgs-getting-started.md) and configure it with AWS member accounts in AWS Organizations. For
instructions, see [Tutorial: Creating\
and configuring an organization](../../../organizations/latest/userguide/orgs-tutorials-basic.md) in the _AWS Organizations User_
_Guide_.
...
For more information, see [Syntax for backup policies](../../../organizations/latest/userguide/orgs-manage-policies-backup-syntax.md#backup-policy-syntax-reference) in the _AWS Organizations User Guide_.
...
AWS Organizations](../../../organizations/latest/userguide/orgs-manage-policies.md) to create [backup\
policies](../../../organizations/latest/userguide/orgs-manage-policies-backup.md) to simplify management across your organization.

See the _AWS Organizations User Guide_ for information on how to
enable backup policies for your organization so you can:

- [Create a backup policy](../../../organizations/latest/userguide/orgs-manage-policies-backup-create.md)

- [Update a backup policy](../../../organizations/latest/userguide/orgs-manage-policies-backup-create.md#update-backup-policy-procedure); or,

- [Delete a backup policy](../../../organizations/latest/userguide/orgs-manage-policies-backup-create.md#delete-backup-policy-procedure)

- [Backup policy syntax and examples](../../../organizations/latest/userguide/orgs-manage-policies-backup-syntax.md)
...
- [Cross-account monitoring](manage-cross-account.md#enable-cross-account) allows you to monitor
...
[Create a resource-based delegation policy](../../../organizations/latest/userguide/orgs-delegate-policies.md) in the _AWS Organizations User Guide_.
...
policies](../../../organizations/latest/userguide/orgs-manage-policies-backup.md).

- **Policy syntax** – See [Backup policy\
syntax and examples](../../../organizations/latest/userguide/orgs-manage-policies-backup-syntax.md).

- **Inheritance for management policy types**
– See [Inheritance for management policy types](../../../organizations/latest/userguide/orgs-manage-policies-inheritance-mgmt.md).
