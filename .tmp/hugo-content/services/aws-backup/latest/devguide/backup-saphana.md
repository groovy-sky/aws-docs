...
For more information, see [AWS Backint](../../../sap/latest/sap-hana/aws-backint-agent-sap-hana.md).
...
Complete [these prerequisites at Amazon EC2 Systems Manager](../../../ssm-sap/latest/userguide/get-started.md).

1. [Set up required\
    permissions for Amazon EC2 instance running SAP HANA database](../../../ssm-sap/latest/userguide/get-started.md#ec2-permissions)

2. [Register\
    credentials in AWS Secrets Manager](../../../ssm-sap/latest/userguide/get-started.md#register-secrets)

3. [Install\
    AWS Backint and AWS Systems Manager for SAP Agents](../../../sap/latest/sap-hana/aws-backint-agent-installing-configuring.md)

4. [Verify SSM\
    Agent](../../../ssm-sap/latest/userguide/get-started.md#verify-ssm-agent)

5. [Verify\
    parameters](../../../ssm-sap/latest/userguide/get-started.md#verification)

6. [Register SAP HANA\
    database](../../../ssm-sap/latest/userguide/get-started.md#register-database)
...
plan](updating-a-backup-plan.md) and add SAP HANA resources to it, or you can [create a new backup\
...
You can [create a\
full on-demand backup](recov-point-create-on-demand-backup.md) that runs immediately after creation. Note that
...
points), see the [SAP HANA Restore troubleshooting](saphana-restore.md#saphanarestoretroubleshooting) section of this guide.
...
[`StartBackupJob`](api-startbackupjob.md) to backup an SAP HANA database on an EC2
instance.
...
Backint Agent](../../../sap/latest/sap-hana/aws-backint-agent-sap-hana.md) and [Amazon EC2 Systems Manager Agent](../../../systems-manager/latest/userguide/ssm-agent.md) on
