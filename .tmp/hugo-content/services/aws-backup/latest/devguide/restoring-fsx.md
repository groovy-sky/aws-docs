...
backups](../../../fsx/latest/ontapguide/using-backups.md).
...
10. If you are restoring an FSx for Windows File Server file system, provide the **Windows authentication** information used to access the file system, or
    ...
    For more information about Microsoft Active Directory, see [Working with Active Directory in Amazon FSx for Windows File Server](../../../fsx/latest/windowsguide/aws-ad-integration-fsxw.md) in
...
06. Choose a **Deployment type**. AWS Backup only supports the
    ...
    Persistent deployment type is for long-term storage. For detailed information
     ...
     Options for Amazon FSx for Lustre File Systems](../../../fsx/latest/lustreguide/using-fsx-lustre.md) in the
...
08. (Optional) For file systems using Intelligent-Tiering storage class, choose
     ...
     documentation for [managing provisioned SSD read cache](../../../fsx/latest/lustreguide/managing-ssd-read-cache.md).
...
07. (Optional) For file systems using Intelligent-Tiering storage class, choose
     the SSD read cache sizing mode and capacity. For more information, see the FSx
     documentation for [managing provisioned SSD read cache](../../../fsx/latest/openzfsguide/managing-ssd-read-cache.md).
...
[LustreReadCacheConfiguration](../../../../reference/fsx/latest/apireference/api-lustrereadcacheconfiguration.md) for more details.
...
[CreateFileSystemLustreConfiguration](../../../../reference/fsx/latest/apireference/api-createfilesystemlustreconfiguration.md) in the
...
cache for Intelligent Tiering file systems. Required when `StorageType`
is set to `INTELLIGENT_TIERING`. See
[OpenZFSReadCacheConfiguration](../../../../reference/fsx/latest/apireference/api-openzfsreadcacheconfiguration.md) for more details.

For complete details about all available parameters in
`OpenZFSConfiguration`, please see
[CreateFileSystemOpenZFSConfiguration](../../../../reference/fsx/latest/apireference/api-createfilesystemopenzfsconfiguration.md) in the
_Amazon FSx API Reference_.
