...
these expired recovery points can be restored from the Amazon EC2 console and [API](../../../../reference/awsec2/latest/apireference/operationlist-query-ec2.md) or Amazon EBS console and [API](../../../../reference/awsec2/latest/apireference/operationlist-query-ebs.md).
...
IAM identity permissions](../../../iam/latest/userguide/access-policies-manage-attach-detach.md).
