...
You can create a new encryption key by following the [Creating Keys](../../../kms/latest/developerguide/create-keys.md) procedure in the
...
backup vault. To delete your recovery points manually, see [Deleting backups](deleting-backups.md).
