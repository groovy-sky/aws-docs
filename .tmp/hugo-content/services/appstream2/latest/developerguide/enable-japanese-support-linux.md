...
3. In addition to the above commands, for Rocky Linux and Red Hat Enterprise
...
default settings, see [Tutorial: Create a Custom Linux-Based WorkSpaces Applications Image](tutorial-create-linux-image.md). In this step, we assume that you’ve
...
In the script above, the first input source (‘ibus’, ‘kkc’) is the default
    ...
    methods during streaming sessions.

2. Create the script for launching the application (Firefox) that you will add to
...
4. If you already created the optimization manifest file for the application run
...
Create the image on the image builder. For more information, see [Tutorial: Create a Custom Linux-Based WorkSpaces Applications Image](tutorial-create-linux-image.md).
...
Your Users" in [Create Your Linux-Based Images](create-linux-based-images.md).
