...
enable internet access from your VPC subnet using a [NAT gateway](../../../vpc/latest/userguide/vpc-nat-gateway.md). Or, you can
configure an internet gateway in your VPC, and attach an Elastic IP address to your
image builder. For more information, see [Networking and Access for Amazon WorkSpaces Applications](managing-network.md).
...
03. In the list, select the image builder that you want to use, and log into it as an
     Administrator.

04. Create a batch file that calls the `appref-ms` file within the user
...
05. On the image builder desktop, open Image Assistant.
...
08. After you log in as a Template User, install the application again.
