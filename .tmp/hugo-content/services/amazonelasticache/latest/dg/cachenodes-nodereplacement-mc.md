...
information, see [Modifying an ElastiCache cluster](clusters-modify.md).
...
2. Add a new node to the cluster. For instructions, see [Adding nodes to an ElastiCache cluster](clusters-addnode.md).
