...
version 5.0.6 onwards. If the parameter group is part of a [Replication across AWS Regions using global datastores](redis-global-datastore.md),
...
For more information, see [`describe-cache-parameter-groups`](../../../cli/latest/reference/elasticache/describe-cache-parameter-groups.md).
...
For more information, see [`DescribeCacheParameterGroups`](../../../../reference/amazonelasticache/latest/apireference/api-describecacheparametergroups.md).
