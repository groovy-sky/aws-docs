...
For more information, such as available parameters and permitted parameter values, see [`describe-events`](../../../cli/latest/reference/elasticache/describe-events.md).
...
For more information, such as available parameters and permitted parameter values, see [`DescribeEvents`](../../../../reference/amazonelasticache/latest/apireference/api-describeevents.md).
