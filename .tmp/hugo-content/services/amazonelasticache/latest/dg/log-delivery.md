...
You can choose to change the delivery configurations or disable log delivery at any time using the AWS console or one of the modify APIs, either [modify-cache-cluster](../../../cli/latest/reference/elasticache/modify-cache-cluster.md)
or [modify-replication-group](../../../cli/latest/reference/elasticache/modify-replication-group.md).
...
For more information, see [Overview of access management: Permissions and policies](../../../iam/latest/userguide/introduction-access-management.md).
