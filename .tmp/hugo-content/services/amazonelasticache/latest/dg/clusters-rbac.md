...
- You can't specify passwords in an access string. You set passwords with [CreateUser](../../../../reference/amazonelasticache/latest/apireference/api-createuser.md) or [ModifyUser](../../../../reference/amazonelasticache/latest/apireference/api-modifyuser.md) calls.
...
each user. ElastiCache supports the `ACL LIST` command, but does not include support for password hashes as Redis OSS does. With ElastiCache, you can use the [DescribeUsers](../../../../reference/amazonelasticache/latest/apireference/api-describeusers.md) operation to get similar information, including the
rules contained within the access string. However, [DescribeUsers](../../../../reference/amazonelasticache/latest/apireference/api-describeusers.md) doesn't retrieve a user password.
...
[describe-users](../../../cli/latest/reference/elasticache/describe-users.md) operation.
...
To see a list of user groups, you can call the [describe-user-groups](../../../cli/latest/reference/elasticache/describe-user-groups.md) operation.
...
viewing the events. For more information, see [Viewing ElastiCache events](ecevents-viewing.md).
