...
(ABAC). For more information, see [Tag your resources](using-tags.md#tag-resources) and [Control access using attribute-based access](iam-policies-for-amazon-ec2.md#control-access-with-tags).
...
launch template. For an example policy, see [Tags in a launch template](examplepolicies-ec2.md#iam-example-tags-launch-template).
