...
Amazon EC2 uses the [EC2FastLaunchServiceRolePolicy](../../../aws-managed-policy/latest/reference/ec2fastlaunchservicerolepolicy.md)
...
To view the permissions for this policy, see [EC2FastLaunchServiceRolePolicy](../../../aws-managed-policy/latest/reference/ec2fastlaunchservicerolepolicy.md) in the _AWS Managed_
_Policy Reference_.
...
this, call the [create-grant](../../../cli/latest/reference/kms/create-grant.md)
...
description of the role by using IAM. For more information, see [Editing a service-linked role](../../../iam/latest/userguide/id-roles-update-service-linked-role.md) in the
_IAM User Guide_.
...
see [Delete a service-linked role](../../../iam/latest/userguide/id-roles-manage-delete.md#id_roles_manage_delete_slr) in the _IAM User Guide_.
