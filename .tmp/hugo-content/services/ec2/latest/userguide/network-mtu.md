...
- [Set the MTU for your Amazon EC2 instances](ec2-instance-mtu.md)
...
[MTU for private virtual interfaces or transit virtual interfaces](../../../directconnect/latest/userguide/workingwithvirtualinterfaces.md#set-jumbo-frames-vif.html)
in the _Direct Connect User Guide_.

All [current generation](../instancetypes/instance-types.md#current-gen-instances)
instance types support jumbo frames.
The following [previous generation](../instancetypes/instance-types.md#previous-gen-instances)
instance types support jumbo frames:
A1, C3, I2, M3, and R3.
...
basics](../../../vpc/latest/userguide/nat-gateway-basics.md) in the _Amazon VPC User Guide_.

- For transit gateways, see [Maximum transmission unit](../../../vpc/latest/tgw/transit-gateway-quotas.md#mtu-quotas)
in the _Amazon VPC Transit Gateways User Guide_.

- For Local Zones, see [Considerations](../../../local-zones/latest/ug/how-local-zones-work.md#considerations)
in the _AWS Local Zones User Guide_.

- For AWS Wavelength, see [Maximum transmission unit](../../../wavelength/latest/developerguide/how-wavelengths-work.md#mtu) in the _AWS Wavelength User Guide_.

- For Outposts see [Service link maximum transmission unit requirements](../../../outposts/latest/userguide/region-connectivity.md#sl-max-mtu-requirements) in the _AWS Outposts User Guide_.
...
(MTU)](../../../vpc/latest/userguide/amazon-vpc-limits.md#ngw-mtus) in the _Amazon VPC User Guide_. For MTU rules over
Transit gateways, see [Maximum transmission\
unit (MTU)](../../../vpc/latest/tgw/transit-gateway-quotas.md#mtu-quotas) in the _AWS Transit Gateway User_
_Guide_.
