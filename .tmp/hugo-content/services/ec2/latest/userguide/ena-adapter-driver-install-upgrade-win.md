...
or update packages](../../../systems-manager/latest/userguide/distributor-working-with-packages-deploy.md) in the _AWS Systems Manager User Guide_.
...
6. To verify the current version that's installed, open the **Driver**
    ...
    match your target version, see [Troubleshoot the Elastic Network Adapter Windows driver](troubleshoot-ena-driver.md).
...
package. To troubleshoot this issue, see [Troubleshooting scenarios](troubleshoot-ena-driver.md#ts-ena-drv-scenarios), and expand the **Unexpected**
