...
- You can't use the [register-image](../../../cli/latest/reference/ec2/register-image.md) command or the [Register-EC2Image](../../../powershell/latest/reference/items/register-ec2image.md) cmdlet to create an AMI that
...
2. To find the volume ID of the instance, use the [describe-instances](../../../cli/latest/reference/ec2/describe-instances.md) command. You'll create a
...
3. To create a snapshot of the volume, use the [create-snapshot](../../../cli/latest/reference/ec2/create-snapshot.md) command. Use the volume ID from the
    previous step.
...
4. Wait until the state of the snapshot is `completed` before
    you go to the next step. To get the state of the snapshot, use the [describe-snapshots](../../../cli/latest/reference/ec2/describe-snapshots.md) command with
...
5. To create a new AMI, use the [register-image](../../../cli/latest/reference/ec2/register-image.md) command. Use the value of `SnapshotId`
...
6. (Optional) To verify that the newly-created AMI has the boot mode that
    you specified, use the [describe-images](../../../cli/latest/reference/ec2/describe-images.md) command.
...
2. To find the volume ID of the instance, use the [Get-EC2Instance](../../../powershell/latest/reference/items/get-ec2instance.md) cmdlet.
...
3. To create a snapshot of the volume, use the [New-EC2Snapshot](../../../powershell/latest/reference/items/new-ec2snapshot.md) cmdlet. Use the
...
4. Wait until the state of the snapshot is `completed` before you go to the
    next step. To get the state of the snapshot, use the [Get-EC2Snapshot](../../../powershell/latest/reference/items/get-ec2snapshot.md) cmdlet with the
...
5. To create a new AMI, use the [Register-EC2Image](../../../powershell/latest/reference/items/register-ec2image.md) cmdlet. Use the
...
6. (Optional) To verify that the newly-created AMI has the boot mode that
    you specified, use the [Get-EC2Image](../../../powershell/latest/reference/items/get-ec2image.md) cmdlet.
