...
Due to the [eventual consistency](../devguide/eventual-consistency.md) model followed by the Amazon EC2 API, after you create a Capacity Reservation,
...
Use the [describe-capacity-reservations](../../../cli/latest/reference/ec2/describe-capacity-reservations.md) command.
