...
You can use the [ec2-instance-connect](../../../cli/latest/reference/ec2-instance-connect/index.md) AWS CLI to connect to your instance with an SSH
...
latest version of the AWS CLI](../../../cli/latest/userguide/getting-started-install.md).
...
type to use when connecting to your instance, use the [ec2-instance-connect ssh](../../../cli/latest/reference/ec2-instance-connect/ssh.md) CLI command
...
Use the [send-ssh-public-key](../../../cli/latest/reference/ec2-instance-connect/send-ssh-public-key.md) command to push your SSH
