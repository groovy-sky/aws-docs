...
Use the following [describe-instances](../../../cli/latest/reference/ec2/describe-instances.md) command.
...
Use the [start-instances](../../../cli/latest/reference/ec2/start-instances.md)
...
Use the [Start-EC2Instance](../../../powershell/latest/reference/items/start-ec2instance.md)
cmdlet.
...
Use the [terminate-instances](../../../cli/latest/reference/ec2/terminate-instances.md) command to manually terminate your Spot Instances.
...
Use the [Remove-EC2Instance](../../../powershell/latest/reference/items/remove-ec2instance.md)
cmdlet.
