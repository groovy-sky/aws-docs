...
parameter support for Amazon Machine Image IDs](../../../systems-manager/latest/userguide/parameter-store-ec2-aliases.md) in the _AWS Systems Manager User Guide_.
...
and example IAM policies, see [Example: Use the EC2 launch instance wizard](iam-policies-ec2-console.md#ex-launch-wizard).
