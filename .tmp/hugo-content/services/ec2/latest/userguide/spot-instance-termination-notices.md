...
the [Amazon EventBridge User Guide](../../../eventbridge/latest/userguide.md). For a detailed example that walks you through how to create
...
This format differs from the [EC2 resource ARN format](../../../service-authorization/latest/reference/list-amazonec2.md#amazonec2-resources-for-iam-policies).
