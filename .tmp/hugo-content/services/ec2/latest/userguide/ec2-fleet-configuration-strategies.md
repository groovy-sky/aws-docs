...
lowest possible price.[Best practices for Amazon EC2 Spot](spot-best-practices.md)Spending limit for your fleetDo you want to limit how much you'll pay for your fleet per hour?[Set a spending limit for your EC2 Fleet or Spot Fleet](ec2-fleet-control-spending.md)Instance types and attribute-based instance type selection
