...
15. Connect to your instance and make the volume available. For more information, see
     ...
     available for use](../../../ebs/latest/userguide/ebs-using-volumes.md) in the _Amazon EBS User Guide_.
...
1. Use the [describe-snapshots](../../../cli/latest/reference/ec2/describe-snapshots.md) command with
...
3. Use the [create-volume](../../../cli/latest/reference/ec2/create-volume.md) command to create a volume
...
5. Use the [attach-volume](../../../cli/latest/reference/ec2/attach-volume.md) command to attach the volume
    to your instance.
...
8. (Optional) When you are finished with the installation media, use the [detach-volume](../../../cli/latest/reference/ec2/detach-volume.md) command to detach
    the volume from your instance. After you detach the volume, you can use the [delete-volume](../../../cli/latest/reference/ec2/delete-volume.md) command to
    delete the volume.
...
1. Use the [Get-EC2Snapshot](../../../powershell/latest/reference/items/get-ec2snapshot.md)
...
3. Use the [New-EC2Volume](../../../powershell/latest/reference/items/new-ec2volume.md)
...
5. Use the [Add-EC2Volume](../../../powershell/latest/reference/items/add-ec2volume.md)
...
8. (Optional) When you are finished with the installation media, use the [Dismount-EC2Volume](../../../powershell/latest/reference/items/dismount-ec2volume.md) cmdlet to detach
