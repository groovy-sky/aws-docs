...
- [List resources using the console](using-filtering.md#listing-resources)

- [Filter resources using the console](using-filtering.md#console-filter)

  - [Supported filters](using-filtering.md#console-filters)
- [Save filter sets using the console](using-filtering.md#saved-filter-sets-in-the-ec2-console)

  - [Key features](using-filtering.md#saved-filter-sets-key-features)

  - [Create a filter set](using-filtering.md#create-saved-filter-sets)

  - [Modify a filter set](using-filtering.md#modify-saved-filter-sets)

  - [Delete a filter set](using-filtering.md#delete-saved-filter-sets)
...
You can list your Amazon EC2 instances using [describe-instances](../../../cli/latest/reference/ec2/describe-instances.md). Without filters, the response
...
You can use the following option with [describe-snapshots](../../../cli/latest/reference/ec2/describe-snapshots.md)
...
For example, the following [describe-snapshots](../../../cli/latest/reference/ec2/describe-snapshots.md) command displays the IDs of all
...
You can list your Amazon EC2 instances using [Get-EC2Instance](../../../powershell/latest/reference/items/get-ec2instance.md). Without filters, the response
