...
Images (AMIs) with SSM Agent preinstalled](../../../systems-manager/latest/userguide/ami-preinstalled-agent.md) in the _AWS Systems Manager User Guide_.

- If you experience issues with the SSM Agent, see [Troubleshooting SSM Agent](../../../systems-manager/latest/userguide/troubleshooting-ssm-agent.md) in the _AWS Systems Manager User Guide_.
...
- [AmazonSSMManagedInstanceCore](../../../aws-managed-policy/latest/reference/amazonssmmanagedinstancecore.md) – Enables an instance to use Systems
Manager to install and configure the CloudWatch agent.

- [CloudWatchAgentServerPolicy](../../../aws-managed-policy/latest/reference/cloudwatchagentserverpolicy.md) – Enables an instance to use the CloudWatch
agent to write data to CloudWatch.

For information about how to add IAM permissions to your instance, see [Use\
instance profiles](../../../iam/latest/userguide/id-roles-use-switch-role-ec2-instance-profiles.md) in the _IAM User Guide_.
