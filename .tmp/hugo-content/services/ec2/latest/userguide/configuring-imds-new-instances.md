...
account. For information about using declarative policies, see [Declarative policies](../../../organizations/latest/userguide/orgs-manage-policies-declarative.md) in the _AWS Organizations User_
_Guide._
...
[Recommended path to requiring IMDSv2](instance-metadata-transition-to-version-2.md#recommended-path-for-requiring-imdsv2).
...
Use the [modify-instance-metadata-defaults](../../../cli/latest/reference/ec2/modify-instance-metadata-defaults.md) command and
...
Use the [get-instance-metadata-defaults](../../../cli/latest/reference/ec2/get-instance-metadata-defaults.md) command and
specify the Region.
...
Use the [modify-instance-metadata-defaults](../../../cli/latest/reference/ec2/modify-instance-metadata-defaults.md) command to
...
Use the [get-instance-metadata-defaults](../../../cli/latest/reference/ec2/get-instance-metadata-defaults.md) command.
...
Use the [Edit-EC2InstanceMetadataDefault](../../../powershell/latest/reference/items/edit-ec2instancemetadatadefault.md) cmdlet and
specify the Region in which to modify the IMDS account level
...
Use the [Get-EC2InstanceMetadataDefault](../../../powershell/latest/reference/items/get-ec2instancemetadatadefault.md) cmdlet and
specify the Region.
...
Use the [Edit-EC2InstanceMetadataDefault](../../../powershell/latest/reference/items/edit-ec2instancemetadatadefault.md) cmdlet to
modify the IMDS account level settings for all Regions.
...
Use the [Get-EC2InstanceMetadataDefault](../../../powershell/latest/reference/items/get-ec2instancemetadatadefault.md) cmdlet.
...
[Recommended path to requiring IMDSv2](instance-metadata-transition-to-version-2.md#recommended-path-for-requiring-imdsv2). If
...
[Declarative policies](../../../organizations/latest/userguide/orgs-manage-policies-declarative.md) in the _AWS Organizations User Guide_.
...
setting the hop limit to `2`. For more information, see [Instance metadata access considerations](instancedata-data-retrieval.md#imds-considerations).
...
The following [run-instances](../../../cli/latest/reference/ec2/run-instances.md) example launches a
...
The following [New-EC2Instance](../../../powershell/latest/reference/items/new-ec2instance.md) cmdlet example launches a
`c6i.large` instance with
...
see the [AWS::EC2::LaunchTemplate MetadataOptions](../../../cloudformation/latest/userguide/aws-properties-ec2-launchtemplate-metadataoptions.md) property
...
The following [register-image](../../../cli/latest/reference/ec2/register-image.md) example registers an AMI using the
...
The following [Register-EC2Image](../../../powershell/latest/reference/items/register-ec2image.md) cmdlet example registers an AMI
...
The following [modify-image-attribute](../../../cli/latest/reference/ec2/modify-image-attribute.md) example modifies an existing
...
The following [Edit-EC2ImageAttribute](../../../powershell/latest/reference/items/edit-ec2imageattribute.md) cmdlet example modifies an
...
For the example IAM policy, see [Work with instance metadata](examplepolicies-ec2.md#iam-example-instance-metadata).
...
For more information, see [Turn on access to instance metadata](configuring-imds-existing-instances.md#enable-instance-metadata-on-existing-instances).
...
The following [New-EC2Instance](../../../powershell/latest/reference/items/new-ec2instance.md) cmdlet example launches an instance
...
the [AWS::EC2::LaunchTemplate MetadataOptions](../../../cloudformation/latest/userguide/aws-properties-ec2-launchtemplate-metadataoptions.md) property in
