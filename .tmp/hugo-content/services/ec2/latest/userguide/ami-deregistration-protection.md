...
Use the [enable-image-deregistration-protection](../../../cli/latest/reference/ec2/enable-image-deregistration-protection.md) command. To enable the
...
Use the [Enable-EC2ImageDeregistrationProtection](../../../powershell/latest/reference/items/enable-ec2imagederegistrationprotection.md) cmdlet. To enable the
...
Use the [disable-image-deregistration-protection](../../../cli/latest/reference/ec2/disable-image-deregistration-protection.md) command.
...
Use the [Disable-EC2ImageDeregistrationProtection](../../../powershell/latest/reference/items/disable-ec2imagederegistrationprotection.md) cmdlet.
