...
with default credentials. For more information, see [Installing the AWS CLI](../../../cli/latest/userguide/getting-started-install.md)
...
the AWS Tools for Windows PowerShell](../../../powershell/latest/userguide/pstools-getting-started.md) in the _AWS Tools for PowerShell User Guide_.
...
12. (Optional) Depending on your use case, you might complete the
    ...
    1. To help take advantage of the four displays of up to
        ...
        protocol [Amazon DCV](../../../dcv/index.md).
...
1. To help take advantage of the four displays of up to 4K
       resolution, set up the high-performance display protocol, [Amazon DCV](../../../dcv/index.md).
