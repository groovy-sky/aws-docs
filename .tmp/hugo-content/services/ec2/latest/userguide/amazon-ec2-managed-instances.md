...
provisioned and managed by a designated service provider, such as Amazon EKS through [EKS Auto Mode](../../../eks/latest/userguide/automode.md).
...
All [Amazon EC2 purchasing options](instance-purchasing-options.md) are available for managed instances,
...
instances on your behalf. If you then decide to sign up for a [Savings Plans](../../../savingsplans/latest/userguide/what-is-savings-plans.md), the EC2 instance rate is reduced by the Savings Plans, while
...
Use the [describe-instances](../../../cli/latest/reference/ec2/describe-instances.md) command and specify the instance
ID.
