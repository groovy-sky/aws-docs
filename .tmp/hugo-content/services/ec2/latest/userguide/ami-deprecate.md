...
more information, see [Check when an Amazon EC2 AMI was last used](ami-last-launched-time.md).

- You can create Amazon Data Lifecycle Manager EBS-backed AMI policies to automate the deprecation of
EBS-backed AMIs. For more information, see [Create AMI lifecycle policies](../../../ebs/latest/userguide/ami-policy.md).
...
accounts](sharingamis-explicit.md).
...
Use the [enable-image-deprecation](../../../cli/latest/reference/ec2/enable-image-deprecation.md) command. If you specify a value for seconds,
...
Use the [Enable-EC2ImageDeprecation](../../../powershell/latest/reference/items/enable-ec2imagedeprecation.md)
...
Use the following [disable-image-deprecation](../../../cli/latest/reference/ec2/disable-image-deprecation.md) command.
...
Use the [Disable-EC2ImageDeprecation](../../../powershell/latest/reference/items/disable-ec2imagedeprecation.md)
cmdlet.
