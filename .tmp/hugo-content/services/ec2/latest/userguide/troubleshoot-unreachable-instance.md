...
Use the [get-console-output](../../../cli/latest/reference/ec2/get-console-output.md) command.
...
Use the [Get-EC2ConsoleOutput](../../../powershell/latest/reference/items/get-ec2consoleoutput.md) cmdlet.
...
Use the [get-console-screenshot](../../../cli/latest/reference/ec2/get-console-screenshot.md) command. The output is base64-encoded.
...
Use the [Get-EC2ConsoleScreenshot](../../../powershell/latest/reference/items/get-ec2consolescreenshot.md) cmdlet. The output is base64-encoded.
...
occurred for your instance, see [Verify if automatic instance recovery occurred](verify-if-automatic-recovery-occurred.md).
