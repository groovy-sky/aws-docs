...
agent, see [Reset Windows admin password for EC2 instance using EC2Launch](resettingadminpassword-ec2launch.md).

If you are using a Windows Server AMI earlier than Windows Server 2016 that does not
include the EC2Launch v2 agent, see [Reset Windows admin password for EC2 instance using EC2Config](resettingadminpassword-ec2config.md).
...
1. Open the **Disk Management** utility, and bring the drive
    ...
    available for use](../../../ebs/latest/userguide/ebs-using-volumes.md).
