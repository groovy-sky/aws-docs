...
describe a launch template version, and [delete versions](delete-launch-template.md#delete-launch-template-version) you no longer need.
...
Use the [create-launch-template-version](../../../cli/latest/reference/ec2/create-launch-template-version.md) command. You can
...
Use the [New-EC2LaunchTemplateVersion](../../../powershell/latest/reference/items/new-ec2launchtemplateversion.md) Cmdlet. You can specify a
...
Use the [modify-launch-template](../../../cli/latest/reference/ec2/modify-launch-template.md) command.
...
Use the [Edit-EC2LaunchTemplate](../../../powershell/latest/reference/items/edit-ec2launchtemplate.md) cmdlet.
...
Use the [describe-launch-template-versions](../../../cli/latest/reference/ec2/describe-launch-template-versions.md) command and
...
Use the [Get-EC2TemplateVersion](../../../powershell/latest/reference/items/get-ec2templateversion.md) Cmdlet and specify the
...
Use the [Get-EC2TemplateVersion](../../../powershell/latest/reference/items/get-ec2templateversion.md) Cmdlet and specify
