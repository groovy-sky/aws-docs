...
more information about creating alarms, see [Creating Amazon CloudWatch Alarms](../../../amazoncloudwatch/latest/monitoring/alarmthatsendsemail.md).
...
Use the following [list-metrics](../../../cli/latest/reference/cloudwatch/list-metrics.md) command:
