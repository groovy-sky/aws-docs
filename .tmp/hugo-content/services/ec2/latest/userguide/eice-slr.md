...
roles](../../../iam/latest/userguide/id-roles.md#iam-term-service-linked-role). A service-linked role is a unique type of IAM role that is linked
...
To view the permissions for the managed policy, see [Ec2InstanceConnectEndpoint](../../../aws-managed-policy/latest/reference/ec2instanceconnectendpoint.md) in the _AWS Managed Policy_
_Reference_.
...
To delete the service-linked role, see [Delete a service-linked role](../../../iam/latest/userguide/id-roles-manage-delete.md#id_roles_manage_delete-slr) in the
_IAM User Guide_.
