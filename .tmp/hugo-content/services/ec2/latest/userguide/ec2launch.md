...
[AWS Windows AMI Reference](../windows-ami-reference/windows-amis.md).
...
update the routes, see [Update metadata/KMS routes for Server 2016 and later when launching a custom AMI](ec2launch-sysprep.md#update-metadata-KMS).
