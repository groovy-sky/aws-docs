...
more information, see [Storage options for your Amazon EC2 instances](storage.md).
...
Use the [run-instances](../../../cli/latest/reference/ec2/run-instances.md) command to change the value of
...
Use the [New-EC2Instance](../../../powershell/latest/reference/items/new-ec2instance.md) cmdlet to change the value of
`DeleteOnTermination` in the block device
mapping.
