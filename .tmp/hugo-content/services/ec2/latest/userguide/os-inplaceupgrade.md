...
[Amazon EBS Elastic Volumes](../../../ebs/latest/userguide/ebs-modify-volume.md)
...
05. If you are upgrading from Windows Server 2012 or 2012 R2 to Windows Server
    ...
    3. Install the AWS Systems Manager SSM Agent. For more information, see
        [Manually install SSM Agent on Amazon EC2 for Windows Server](../../../systems-manager/latest/userguide/manually-install-ssm-agent-windows.md)
...
10. Make the new volume available for use by following the steps at [Make \
     an Amazon EBS volume available for use](../../../ebs/latest/userguide/ebs-using-volumes.md).
