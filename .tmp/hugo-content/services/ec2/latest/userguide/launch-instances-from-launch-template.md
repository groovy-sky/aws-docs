...
in the [run-instances](../../../cli/latest/reference/ec2/run-instances.md) command. The following example
...
- Use the [New-EC2Instance](../../../powershell/latest/reference/index.md) command and specify the
...
- To override a launch template parameter, specify the parameter
in the [New-EC2Instance](../../../powershell/latest/reference/index.md) command. The following example
overrides the instance type that's specified in the launch
template (if any).
...
- Use the [create-auto-scaling-group](../../../cli/latest/reference/autoscaling/create-auto-scaling-group.md) or the [update-auto-scaling-group](../../../cli/latest/reference/autoscaling/update-auto-scaling-group.md) command and specify the
...
- [Create a\
launch template for an Auto Scaling group](../../../autoscaling/ec2/userguide/create-launch-template.md)
...
(AWS CLI)](../../../autoscaling/ec2/userguide/examples-launch-templates-aws-cli.md) – Provides examples that show how to create
launch templates with various parameter combinations.

- [Create Auto Scaling groups using launch templates](../../../autoscaling/ec2/userguide/create-auto-scaling-groups-launch-template.md)

- [Update an\
Auto Scaling group](../../../autoscaling/ec2/userguide/update-auto-scaling-group.md)
...
launch template. For more information, see [Create an EC2 Fleet](create-ec2-fleet.md).

###### To create an EC2 Fleet with a launch template using the AWS CLI

- Use the [create-fleet](../../../cli/latest/reference/ec2/create-fleet.md) command. Use the
...
that are specified in the launch template. For more information, see [Create a Spot Fleet](create-spot-fleet.md).
...
6. Configure your Spot Fleet by selecting different options on this screen. For
    more information about the options, see [Create a Spot Fleet request using defined parameters](create-spot-fleet.md#create-spot-fleet-advanced).
...
- Use the [request-spot-fleet](../../../cli/latest/reference/ec2/request-spot-fleet.md) command. Use the
