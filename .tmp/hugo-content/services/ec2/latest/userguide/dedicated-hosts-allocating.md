...
Use the [allocate-hosts](../../../cli/latest/reference/ec2/allocate-hosts.md) command. The following example
...
Use the [New-EC2Host](../../../powershell/latest/reference/items/new-ec2host.md) cmdlet. The following example
allocates a Dedicated Host that supports multiple instance types from the
`m5` instance family in the `us-east-1a`
