...
Use the [run-instances](../../../cli/latest/reference/ec2/run-instances.md) command and specify the instance
...
Use the [New-EC2Instance](../../../powershell/latest/reference/items/new-ec2instance.md) cmdlet and specify the instance
affinity, tenancy, and host in the `-Placement`
parameter.
