...
06. For **Target capacity**, do the
    ...
    4. (Optional) To allow Spot Fleet to launch a replacement Spot Instance
       ...
       **before terminate**, specify the delay (in
        ...
        more information, see [Use Capacity Rebalancing in EC2 Fleet and Spot Fleet to replace at-risk Spot Instances](ec2-fleet-capacity-rebalance.md).
    ...
    5. (Optional) To control the amount you pay per hour for
       ...
       **maximum cost for Spot Instances** and then enter the
        ...
        capacity. For more information, see [Set a spending limit for your EC2 Fleet or Spot Fleet](ec2-fleet-control-spending.md).
       ...
       **that match your compute requirements**,
       ...
       3. (Optional) For **Additional instance**
          **attribute**, you can optionally specify
           ...
           values, see [get-spot-placement-scores](../../../cli/latest/reference/ec2/get-spot-placement-scores.md).
...
09. For **Allocation strategy**, choose a Spot
     ...
     meets your needs. For more information, see [Use allocation strategies to determine how EC2 Fleet or Spot Fleet fulfills Spot and On-Demand capacity](ec2-fleet-allocation-strategy.md).
...
Use the [request-spot-fleet](../../../cli/latest/reference/ec2/request-spot-fleet.md) command.
...
Use the [Request-EC2SpotFleet](../../../powershell/latest/reference/items/request-ec2spotfleet.md) cmdlet. The following example
...
configurations, see [Example CLI configurations Spot Fleet](spot-fleet-examples.md).
...
Use the [request-spot-fleet](../../../cli/latest/reference/ec2/request-spot-fleet.md) command with the
...
Use the [Request-EC2SpotFleet](../../../powershell/latest/reference/items/request-ec2spotfleet.md) cmdlet with the
