...
1. Follow the [Create a launch template using advanced settings](../../../autoscaling/ec2/userguide/advanced-settings-for-your-launch-template.md) procedure
...
**group**. For more information, see [Creating an Auto Scaling\
    Group Using a Launch Template](../../../autoscaling/ec2/userguide/create-asg-launch-template.md) in the
...
Use the [create-auto-scaling-group](../../../cli/latest/reference/autoscaling/create-auto-scaling-group.md) command and specify the
`--launch-template` parameter.

###### To add a launch template to an existing Auto Scaling group

Use the [update-auto-scaling-group](../../../cli/latest/reference/autoscaling/update-auto-scaling-group.md) command and specify the
`--launch-template` parameter.
...
Use the [New-ASAutoScalingGroup](../../../powershell/latest/reference/items/new-asautoscalinggroup.md) cmdlet and specify the
`-LaunchTemplate_LaunchTemplateId` or
`-LaunchTemplate_LaunchTemplateName` parameter.

###### To add a launch template to an existing Auto Scaling group

Use the [Update-ASAutoScalingGroup](../../../powershell/latest/reference/items/update-asautoscalinggroup.md) cmdlet and specify the
`-LaunchTemplate_LaunchTemplateId` or
`-LaunchTemplate_LaunchTemplateName` parameter.
...
which might incur an additional charge. For more information, see [Surplus credits can incur charges](burstable-performance-instances-unlimited-mode-concepts.md#unlimited-mode-surplus-credits).
...
Use the [describe-instance-credit-specifications](../../../cli/latest/reference/ec2/describe-instance-credit-specifications.md) command. If you do not
...
Use the [modify-instance-credit-specification](../../../cli/latest/reference/ec2/modify-instance-credit-specification.md) command.
...
Use the [Get-EC2CreditSpecification](../../../powershell/latest/reference/items/get-ec2creditspecification.md) cmdlet.
...
Use the [Edit-EC2InstanceCreditSpecification](../../../powershell/latest/reference/items/edit-ec2instancecreditspecification.md) cmdlet.
...
Use the [get-default-credit-specification](../../../cli/latest/reference/ec2/get-default-credit-specification.md) command.
...
Use the [modify-default-credit-specification](../../../cli/latest/reference/ec2/modify-default-credit-specification.md) command. The following
...
Use the [Get-EC2DefaultCreditSpecification](../../../powershell/latest/reference/items/get-ec2defaultcreditspecification.md) cmdlet.
...
Use the [Edit-EC2DefaultCreditSpecification](../../../powershell/latest/reference/items/edit-ec2defaultcreditspecification.md) cmdlet. The following
example sets the value to `unlimited`.
