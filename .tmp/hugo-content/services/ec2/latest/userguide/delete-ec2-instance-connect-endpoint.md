...
Use the [delete-instance-connect-endpoint](../../../cli/latest/reference/ec2/delete-instance-connect-endpoint.md) command
...
Use the [Remove-EC2InstanceConnectEndpoint](../../../cli/latest/reference/ec2/delete-instance-connect-endpoint.md) cmdlet
and specify the ID of the EC2 Instance Connect Endpoint to delete.
