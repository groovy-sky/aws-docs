...
[Service control\
policies](../../../organizations/latest/userguide/orgs-manage-policies-scps.md) in the _AWS Organizations User Guide_.
...
policies](../../../organizations/latest/userguide/orgs-manage-policies-declarative.md) in the _AWS Organizations User Guide._

###### Contents

- [Grant permission to users to manage account access](configure-access-to-serial-console.md#sc-account-access-permissions)

- [View account access status to the serial console](configure-access-to-serial-console.md#sc-view-account-access)

- [Grant account access to the serial console](configure-access-to-serial-console.md#sc-grant-account-access)

- [Deny account access to the serial console](configure-access-to-serial-console.md#sc-deny-account-access)
...
For more information, see [Creating IAM policies](../../../iam/latest/userguide/access-policies-create.md) in
...
Use the [get-serial-console-access-status](../../../cli/latest/reference/ec2/get-serial-console-access-status.md) command.
...
Use the [Get-EC2SerialConsoleAccessStatus](../../../powershell/latest/reference/items/get-ec2serialconsoleaccessstatus.md)
cmdlet.
...
Use the [enable-serial-console-access](../../../cli/latest/reference/ec2/enable-serial-console-access.md) command.
...
Use the [Enable-EC2SerialConsoleAccess](../../../powershell/latest/reference/items/enable-ec2serialconsoleaccess.md)
cmdlet.
...
Use the [disable-serial-console-access](../../../cli/latest/reference/ec2/disable-serial-console-access.md) command.
...
Use the [Disable-EC2SerialConsoleAccess](../../../powershell/latest/reference/items/disable-ec2serialconsoleaccess.md)
cmdlet.
...
[Creating IAM policies](../../../iam/latest/userguide/access-policies-create.md) in the _IAM User Guide_.
...
[Controlling\
access to AWS resources](../../../iam/latest/userguide/access-tags.md#access_tags_control-resources) in the _IAM User Guide_.
