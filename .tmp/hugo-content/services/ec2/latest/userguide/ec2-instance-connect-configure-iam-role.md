...
using resource tags as [condition keys](../../../service-authorization/latest/reference/list-amazonec2instanceconnect.md#amazonec2instanceconnect-policy-keys).

For more information, see [Actions, resources, and condition keys for Amazon EC2 Instance Connect](../../../service-authorization/latest/reference/list-amazonec2instanceconnect.md).

For information about creating IAM policies, see [Creating IAM policies](../../../iam/latest/userguide/access-policies-create.md)
...
tags to control access to your AWS resources, see [Controlling access to AWS resources](../../../iam/latest/userguide/access-tags.md#access_tags_control-resources) in the _IAM User Guide_.
