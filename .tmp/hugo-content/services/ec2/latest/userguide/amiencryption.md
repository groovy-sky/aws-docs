...
see [Understand shared AMI usage in Amazon EC2](sharing-amis.md).
...
see [Launch, List, and Terminate EC2 Instances](../../../cli/latest/userguide/cli-services-ec2-instances.md).
