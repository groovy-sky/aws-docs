...
Use the following [modify-network-interface-attribute](../../../cli/latest/reference/ec2/modify-network-interface-attribute.md)
command.
...
Use the [Edit-EC2NetworkInterfaceAttribute](../../../powershell/latest/reference/items/edit-ec2networkinterfaceattribute.md)
cmdlet.
