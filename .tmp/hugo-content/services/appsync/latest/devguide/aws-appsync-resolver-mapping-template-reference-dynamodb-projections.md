...
expressions](../../../dynamodb/latest/developerguide/expressions-projectionexpressions.md) documentation. This field is required.
...
documentation](../../../dynamodb/latest/developerguide/expressions-expressionattributenames.md).
...
You can access your GraphQL request selection set using [$context.info.selectionSetList](resolver-context-reference.md#aws-appsync-resolver-context-reference-info). This field allows you to frame your projection expression
...
[DynamoDB\
documentation](../../../../reference/amazondynamodb/latest/apireference/api-query.md#DDB-Query-request-Select).
