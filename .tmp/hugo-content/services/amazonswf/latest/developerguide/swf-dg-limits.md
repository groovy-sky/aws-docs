...
- [General Account Quotas for Amazon SWF](swf-dg-limits.md#swf-dg-limits-general)

- [Quotas on Workflow Executions](swf-dg-limits.md#swf-dg-limits-workflow-executions)

- [Quotas on Task Executions](swf-dg-limits.md#swf-dg-limits-tasks)

- [Amazon SWF throttling quotas](swf-dg-limits.md#swf-throttling-limits)

  - [Throttling quotas for all Regions](swf-dg-limits.md#throttle-limits-all-regions)

  - [Decision quotas for all Regions](swf-dg-limits.md#decision-quota-limits-all-regions)

  - [Workflow-level quotas](swf-dg-limits.md#wf-wflow-level-quotas)
- [Requesting a quota increase](swf-dg-limits.md#swf-dg-limits-how-to-increase)
...
- [CountClosedWorkflowExecutions](../../../../reference/amazonswf/latest/apireference/api-countclosedworkflowexecutions.md)

- [CountOpenWorkflowExecutions](../../../../reference/amazonswf/latest/apireference/api-countopenworkflowexecutions.md)

- [CountPendingActivityTasks](../../../../reference/amazonswf/latest/apireference/api-countpendingactivitytasks.md)

- [CountPendingDecisionTasks](../../../../reference/amazonswf/latest/apireference/api-countpendingdecisiontasks.md)
...
allows the decider to complete more quickly. If using the [Flow Framework](resources.md#aws-flow-framework-documentation), you can use
...
provides to continue executions and structure your applications using [child workflow](swf-dev-adv-child-workflows.md) executions. If you find that you
...
a timeout event to occur if a particular stage of your [activity task](swf-dev-tasks.md) execution takes too long.
...
stage of your [activity task](swf-dev-tasks.md) execution takes too long.
...
scheduling activity tasks or workflow executions, and input sent with a [workflow execution signal](swf-dev-adv-signals.md).
...
[AWS service quotas](../../../../general/latest/gr/aws-service-limits.md) in the
