...
An [encryption context](../../../kms/latest/developerguide/encrypt-context.md)
...
For more information about data protection, see [Protect your REST APIs in API Gateway](rest-api-protect.md) and the [AWS Shared Responsibility Model and GDPR](https://aws.amazon.com/blogs/security/the-aws-shared-responsibility-model-and-gdpr) blog post on the _AWS Security_
_Blog_.
