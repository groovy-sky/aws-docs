...
information, see [Monitor REST API execution with Amazon CloudWatch metrics](monitoring-cloudwatch.md).
...
**Save changes**. Alternatively, you can call the [update-stage](../../../cli/latest/reference/apigateway/update-stage.md) AWS CLI
