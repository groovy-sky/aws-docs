...
and ciphers, see [Supported security policies](apigateway-security-policies-list.md).
...
For more information, see [Monitor REST APIs in API Gateway](rest-api-monitor.md).
...
information, see
[Domain\
fronting](../../../amazoncloudfront/latest/developerguide/cnames.md#alternate-domain-names-restrictions).
