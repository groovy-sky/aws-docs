...
`$request.path.petId`.Context variable$context. `variableName` or ${context. `variableName`}The value of a [context variable](http-api-logging-variables.md).

###### Note

Only the special characters `.` and `_` are supported.

Stage variable$stageVariables. `variableName` or ${stageVariables. `variableName`}The value of a [stage variable](http-api-stages-stage-variables.md).Static value`string`A constant value.
...
The following [create-integration](../../../cli/latest/reference/apigatewayv2/create-integration.md) command
...
The following [update-integration](../../../cli/latest/reference/apigatewayv2/create-integration.md) command
