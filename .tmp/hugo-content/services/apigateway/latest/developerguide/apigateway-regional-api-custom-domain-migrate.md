...
For more information, see [Endpoint access mode](apigateway-security-policies.md#apigateway-security-policies-endpoint-access-mode).
...
08. Set up a DNS record to point the Regional custom domain name to this Regional hostname. For more information, see [configuring Route 53 to route traffic to API Gateway](../../../route53/latest/developerguide/routing-to-api-gateway.md).
...
The following [update-domain-name](../../../cli/latest/reference/apigateway/update-domain-name.md)
...
After the DNS record is set, you can remove the edge-optimized custom domain name. The following [update-domain-name](../../../cli/latest/reference/apigateway/update-domain-name.md) command removes the
...
10. Set up a DNS record to point the Regional custom domain name to this Regional hostname. For more information, see [configuring Route 53 to route traffic to API Gateway](../../../route53/latest/developerguide/routing-to-api-gateway.md).
...
08. Set up a DNS record to point the edge-optimized custom domain name to this edge-optimized hostname. For more information, see [configuring Route 53 to route traffic to API Gateway](../../../route53/latest/developerguide/routing-to-api-gateway.md).
...
of the custom domain name. The following [update-domain-name](../../../cli/latest/reference/apigateway/update-domain-name.md) command removes the Regional endpoint type:
