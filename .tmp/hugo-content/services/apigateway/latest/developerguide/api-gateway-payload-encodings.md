...
response streaming, you don't need to configure your binary media types. For more information, see [Stream the integration response for your proxy integrations in API Gateway](response-transfer-mode.md).
...
You must also configure the [binaryMediaTypes](../api/api-restapi.md#apigw-Type-RestApi-binaryMediaTypes) for your API. Your API's `binaryMediaTypes` configuration is a list of
...
media types. For more information, see [Set up a Lambda proxy integration with payload response streaming in API Gateway](response-transfer-mode-lambda.md).

## Non-proxy integrations

To handle binary payloads for non-proxy integrations, you add the media types to the
[binaryMediaTypes](../api/api-restapi.md#apigw-Type-RestApi-binaryMediaTypes) list of the `RestApi`
resource. Your API's `binaryMediaTypes` configuration is a list of content
types that your API treats as binary data. Alternatively, you can set the [contentHandling](../api/api-integration.md#contentHandling)
properties on the [Integration](../api/api-integration.md)
and the [IntegrationResponse](../api/api-integrationresponse.md) resources. The `contentHandling` value can be `CONVERT_TO_BINARY`, `CONVERT_TO_TEXT`, or
undefined.
...
- Add the desired binary media types to the `binaryMediaTypes` list on the [RestApi](../api/api-restapi.md) resource. If this
...
behaviors](integration-passthrough-behaviors.md) are enabled for the API.

- Set the `contentHandling` property of the [IntegrationResponse](../api/api-integrationresponse.md) resource. The `contentHandling`
...
type conversions. For details, see [Content type conversions in API Gateway](api-gateway-payload-encodings-workflow.md).
