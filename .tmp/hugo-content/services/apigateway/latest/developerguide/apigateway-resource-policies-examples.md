...
language, see [Access policy language overview for Amazon API Gateway](apigateway-control-access-policy-language-overview.md).
...
Version 4](../../../iam/latest/userguide/create-signed-request.md) (SigV4) or [Signature Version 4a](../../../iam/latest/userguide/reference-sigv.md#how-sigv4a-works) (SigV4a)
...
information, see [Using IPv6 addresses in IAM policies](api-ref.md#api-reference-service-endpoints-dualstack-iam).
