...
role because various entities might reference the role. However, you can edit the description of the role using IAM. For more information, see [Editing a Service-Linked Role](../../../iam/latest/userguide/using-service-linked-roles.md#edit-service-linked-role) in the
_IAM User Guide_.
...
is available. For more information, see [AWS Service Endpoints](../../../../general/latest/gr/rande.md).
...
the RSS feed on the API Gateway [Document history](history.md) page.
