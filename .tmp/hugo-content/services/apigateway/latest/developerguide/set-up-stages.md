...
07. For **Additional settings**, you modify the following settings:
    ...
    **Throttling settings**
    ...
    [Quotas for configuring and running a REST API in API Gateway](api-gateway-execution-service-limits-table.md).
...
17. To enable [AWS X-Ray](../../../xray/latest/devguide/xray-services-apigateway.md) tracing for the API stage, select **X-Ray**
