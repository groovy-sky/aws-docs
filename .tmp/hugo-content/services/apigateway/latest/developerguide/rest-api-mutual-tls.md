...
`execute-api` endpoint. To learn more, see [Disable the default endpoint for REST APIs](rest-api-disable-default-endpoint.md).
...
in API requests. You can find more information at [Custom domain name for public REST APIs in API Gateway](how-to-custom-domains.md).
...
see [Choose a security policy for your custom domain in API Gateway](apigateway-custom-domain-tls-version.md).
...
The following [create-domain-name](../../../cli/latest/reference/apigateway/create-domain-name.md) creates a
...
API operations. To learn more, see [Set up a Regional custom domain name in API Gateway](apigateway-regional-api-custom-domain-create.md).
...
The following [update-domain-name](../../../cli/latest/reference/apigateway/update-domain-name.md) disables
mutual TLS:
...
control of but you can prove ownership of the domain name, [contact Support](https://console.aws.amazon.com/support/cases) to open a
ticket.
...
If the resulting certificate is for the FQDN, [contact Support](https://console.aws.amazon.com/support/cases) to open
a ticket.
