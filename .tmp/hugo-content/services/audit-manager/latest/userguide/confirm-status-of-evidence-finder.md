...
Run the [get-settings](../../../cli/latest/reference/auditmanager/get-settings.md) command with the `--attribute`
...
Call the [GetSettings](../../../../reference/audit-manager/latest/apireference/api-getsettings.md) operation with the `attribute`
...
For more information, see [evidenceFinderEnablement](../../../../reference/audit-manager/latest/apireference/api-evidencefinderenablement.md) in the _Audit Manager API Reference_.
