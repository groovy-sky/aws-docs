...
Evidence finder uses [AWS CloudTrail Lake](../../../awscloudtrail/latest/userguide/cloudtrail-lake.md) querying and
...
[Update an event\
data store](../../../awscloudtrail/latest/userguide/query-lake-cli.md#lake-cli-update-eds.) in the _AWS CloudTrail User Guide_. You can keep
