...
remaining through the AWS Cost and Usage Report widget, AWS Management Console home, or [programmatically](../../../../reference/aws-cost-management/latest/apireference/api-operations-aws-free-tier.md) through the AWS SDK and CLI at no cost. You also
...
using the [free tier API](../../../../reference/aws-cost-management/latest/apireference/api-operations-aws-free-tier.md) or on the **Free Tier** page on the
...
costs with AWS Budgets](../../../cost-management/latest/userguide/budgets-managing-costs.md).
...
budget, see [Creating a usage budget](../../../cost-management/latest/userguide/budgets-create.md#create-usage-budget).
