...
the historical versions of the price lists by using the [service version index file](using-the-aws-price-list-bulk-api-reading-price-list-files-reading-service-version-index-file.md).
...
- [Finding service price list files](using-the-aws-price-list-bulk-api-fetching-price-list-files-manually.md#fetching-price-list-files-manually-step-4-finding-service-price-list-files)

- [Finding service price list files for Savings Plan](using-the-aws-price-list-bulk-api-fetching-price-list-files-manually.md#find-service-price-list-files-for-savings-plans)
