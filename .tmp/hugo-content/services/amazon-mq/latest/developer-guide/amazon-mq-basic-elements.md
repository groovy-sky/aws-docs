...
_broker instance type_ (for example, `mq.m5.large`). For more information, see [Broker instance types](broker-instance-types.md).
...
- [REST Operation ID:\
User](../api-reference/rest-api-user.md)

- [REST Operation ID:\
Users](../api-reference/rest-api-users.md)
