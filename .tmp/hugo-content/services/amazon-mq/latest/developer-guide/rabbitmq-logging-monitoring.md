...
[Dimension](../../../../reference/amazoncloudwatch/latest/apireference/api-dimension.md#API_Dimension_Contents) in the _Amazon CloudWatch API Reference_.
...
see [Using metric math](../../../amazoncloudwatch/latest/monitoring/using-metric-math.md).
...
see [Using service-linked roles](../../../iam/latest/userguide/using-service-linked-roles.md)
