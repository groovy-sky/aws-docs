...
_broker instance type_ (for example, `mq.m5.large`). For more information, see [What is an Amazon MQ for RabbitMQ broker?](working-with-rabbitmq.md#rabbitmq-basic-elements-broker)
...
When creating an Amazon MQ for RabbitMQ broker, follow the [broker setup best practices for RabbitMQ](best-practices-broker-setup.md)
...
[Option 1: Amazon MQ for RabbitMQ single-instance broker](rabbitmq-broker-architecture.md#rabbitmq-broker-architecture-single-instance).
...
[Option 2: Amazon MQ for RabbitMQ cluster deployment](rabbitmq-broker-architecture.md#rabbitmq-broker-architecture-cluster).
