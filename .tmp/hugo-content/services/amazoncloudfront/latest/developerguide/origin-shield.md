...
origin, and all other layers of the CloudFront cache (edge locations and [regional edge caches](howcloudfrontworks.md#CloudFrontRegionaledgecaches)) can
...
[global network of edge locations](https://aws.amazon.com/cloudfront/features), [regional edge caches](howcloudfrontworks.md#CloudFrontRegionaledgecaches) serve as a
...
Amazon CloudFront offers Origin Shield in AWS Regions where CloudFront has a [regional edge cache](howcloudfrontworks.md#CloudFrontRegionaledgecaches). When you enable
...
For more information, see [AWS::CloudFront::Distribution Origin](../../../cloudformation/latest/userguide/aws-properties-cloudfront-distribution-origin.md) in the
...
- [OriginShield](../../../../reference/cloudfront/latest/apireference/api-originshield.md) (type)

- [Origin](../../../../reference/cloudfront/latest/apireference/api-origin.md) (type)

- [DistributionConfig](../../../../reference/cloudfront/latest/apireference/api-distributionconfig.md) (type)

- [UpdateDistribution](../../../../reference/cloudfront/latest/apireference/api-updatedistribution.md)
(operation)

- [CreateDistribution](../../../../reference/cloudfront/latest/apireference/api-createdistribution.md)
(operation)
...
cache](howcloudfrontworks.md#CloudFrontRegionaledgecaches) in the same Region as Origin Shield, Origin Shield is not an
...
edge caches](howcloudfrontworks.md#CloudFrontRegionaledgecaches) feature. Each of these edge caches is built in an AWS Region
...
caches](howcloudfrontworks.md#CloudFrontRegionaledgecaches). If a request is routed from a CloudFront edge location to the regional
...
Origin Shield is compatible with [CloudFront origin groups](high-availability-origin-failover.md). Because Origin Shield is a property of the origin,
...
When you use Origin Shield with Lambda@Edge, [origin-facing triggers](lambda-cloudfront-trigger-events.md) (origin
