...
Use [AWS Elemental MediaLive](../../../medialive/latest/ug/getting-started.md) to encode live
...
[AWS Elemental MediaStore](../../../mediastore/latest/ug/getting-started.md) to serve the
...
Streaming Automated Deployment](../../../solutions/latest/live-streaming/deployment.md).
...
If you have video stored in an [AWS Elemental MediaStore](../../../mediastore/latest/ug/getting-started.md) container, you can create a CloudFront distribution to serve the
content.
...
1. Follow the procedure at [Allowing Amazon CloudFront to access your AWS Elemental MediaStore\
    container](../../../mediastore/latest/ug/cdns-allowing-cloudfront-to-access-mediastore.md), and then return to these steps to create your
    distribution.
...
options for distributions and information about setting them, see [All distribution settings reference](distribution-web-values-specify.md).
...
a channel](../../../mediapackage/latest/ug/channels-create.md) and [added endpoints](../../../mediapackage/latest/ug/channels-add-endpoint.md) for your live video using MediaPackage.
...
parameters, see [Time-shifted viewing](../../../mediapackage/latest/ug/time-shifted.md)
...
information, see [Manifest filtering](../../../mediapackage/latest/ug/manifest-filtering.md) in the _AWS Elemental MediaPackage User Guide_.
...
endpoints and the CloudFront distribution. For more information, see [Enable CDN authorization in MediaPackage](../../../mediapackage/latest/ug/cdn-auth-setup.md#cdn-aut-setup-endpoint) in the
...
process assumes that you have already [created\
a packaging group](../../../mediapackage/latest/ug/pkg-group-create.md) with a [packaging configuration](../../../mediapackage/latest/ug/pkg-cfig-create.md) and [ingested an asset](../../../mediapackage/latest/ug/asset-create.md) with MediaPackage.
...
We recommend enabling header-based MediaPackage CDN Authorization between MediaPackage
VOD content and the CloudFront distribution. For more information, see [Enable CDN authorization in MediaPackage](../../../mediapackage/latest/ug/cdn-auth-setup.md#cdn-aut-setup-endpoint) in the
_AWS Elemental MediaPackage User Guide_.
