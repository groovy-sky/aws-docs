...
- [Prerequisites](functions-tutorial-kvs.md#functions-kvs-tutorial-prerequisites)

- [Create the key value store](functions-tutorial-kvs.md#functions-kvs-tutorial-kvs-step)

- [Add key-value pairs to the key value store](functions-tutorial-kvs.md#add-key-value-pairs-to-store)

- [Associate the key value store with the function](functions-tutorial-kvs.md#functions-kvs-tutorial-functions-step)

- [Test and publish the function code](functions-tutorial-kvs.md#test-and-publish-function-code)
