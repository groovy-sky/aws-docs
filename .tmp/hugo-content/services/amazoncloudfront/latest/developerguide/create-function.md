...
- [CloudFront Functions examples for CloudFront](service-code-examples-cloudfront-functions-examples.md)
...
recommend that you [test your function](test-function.md) before you [publish it](publish-function.md). After you publish your function, the
