...
associate a CloudFront distribution with a Lambda function, CloudFront [intercepts requests and responses](../../../lambda/latest/dg/lambda-edge.md) at
...
updating functions](lambda-edge-create-function.md), [the event\
