...
- We recommend that you use the [ListDomainConflicts](../../../../reference/cloudfront/latest/apireference/api-listdomainconflicts.md) API operation, because it supports both
standard distributions and distribution tenants.

- The [ListConflictingAliases](../../../../reference/cloudfront/latest/apireference/api-listconflictingaliases.md) API operation only supports
...
For more information, see the [list-domain-conflicts](../../../cli/latest/reference/cloudfront/list-domain-conflicts.md) command in the
...
For more information, see the [list-conflicting-aliases](../../../cli/latest/reference/cloudfront/list-conflicting-aliases.md) command in
