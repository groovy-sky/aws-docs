...
To create a cache policy with the CloudFront API, use [CreateCachePolicy](../../../../reference/cloudfront/latest/apireference/api-createcachepolicy.md). For more information about the fields that
