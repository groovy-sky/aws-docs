...
12. Configure the DNS service for the alternate domain name (such as www.example.com) to
     ...
     provider. For more information, see [Add a domain to your CloudFront standard distribution](add-domain-existing-distribution.md).
    ...
    **Route 53**
    ...
    distribution by using your domain name](../../../route53/latest/developerguide/routing-to-cloudfront-distribution.md) in the
...
2. In the Route 53 console, create an alias resource record set. Follow the [Routing traffic to an Amazon CloudFront web\
    distribution by using your domain name](../../../route53/latest/developerguide/routing-to-cloudfront-distribution.md) procedure.
