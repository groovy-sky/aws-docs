...
- [How Amazon CloudFront works with IAM](security-iam-service-with-iam.md)

- [Identity-based policy examples for Amazon CloudFront](security-iam-id-based-policy-examples.md)
...
- [Troubleshoot Amazon CloudFront identity and access](security-iam-troubleshoot.md)
...
administrator if you cannot access features (see [Troubleshoot Amazon CloudFront identity and access](security-iam-troubleshoot.md))

- **Service administrator** \- determine user access and
submit permission requests (see [How Amazon CloudFront works with IAM](security-iam-service-with-iam.md))

- **IAM administrator** \- write policies to manage
access (see [Identity-based policy examples for Amazon CloudFront](security-iam-id-based-policy-examples.md))
