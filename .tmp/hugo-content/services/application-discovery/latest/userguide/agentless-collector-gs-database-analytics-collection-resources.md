...
[Using\
the AWS DMS Fleet Advisor Target Recommendations feature](../../../dms/latest/userguide/fa-recommendations.md).
...
completed the prerequisites in [Prerequisites for Agentless Collector](agentless-collector-gs-prerequisites.md).
