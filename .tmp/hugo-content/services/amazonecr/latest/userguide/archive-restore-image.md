...
console or AWS CLI. Refer to [Archiving an image](archive-image.md) for more information.
...
replication, and repository lifecycle policies. Refer to [Restoring an image](restore-image.md)
