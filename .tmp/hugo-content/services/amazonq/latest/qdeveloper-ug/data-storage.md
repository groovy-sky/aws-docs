...
how data is encrypted, see [Data encryption in Amazon Q Developer](data-encryption.md). For information about how AWS may use some questions
...
When you use Amazon Q generative SQL in Amazon Redshift, your content is stored and processed in your console Region. For more information, see [Interacting with Amazon Q generative SQL](../../../redshift/latest/mgmt/query-editor-v2-generative-ai.md) in the _Amazon Redshift Management Guide_.
...
see [Cross-region inference](cross-region-processing.md#cross-region-inference).
