...
If you see an error message that starts with, `Your account has not been
                    configured to use an Amazon Q subscription`, see [Troubleshooting Amazon Q Developer Pro subscriptions](q-admin-setup-subscribe-troubleshooting.md) for troubleshooting
tips.
