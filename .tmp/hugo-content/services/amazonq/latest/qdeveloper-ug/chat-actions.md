...
information, see [Asking Amazon Q to troubleshoot your resources](chat-actions-troubleshooting.md).
...
as the default view. For more information, see [Setting up Resource Explorer using Advanced setup](../../../resource-explorer/latest/userguide/getting-started-setting-up.md#getting-started-setting-up-advanced) in the _AWS Resource Explorer_
_User Guide_.

- The user's IAM identity must have read permissions for the default view. For
more information, see
[Granting access to Resource Explorer views for search](../../../resource-explorer/latest/userguide/configure-views-grant-access.md) in the _AWS Resource Explorer User Guide_.
