...
about creating an account, see [Create an AWS account](../../../accounts/latest/reference/manage-acct-creating.md) in the _AWS Account Management_
_Reference Guide_.
...
A **Review upgrade details for Q Developer Pro** page
    ...
    fee, see [Subscription billing](tracking-across-org-cost-usage.md). The
