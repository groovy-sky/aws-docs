...
- Make sure users are subscribed in a standalone account or, if you're using [AWS Organizations](../../../organizations/latest/userguide/orgs-introduction.md), a management account. Currently, Q Developer does not support logging
