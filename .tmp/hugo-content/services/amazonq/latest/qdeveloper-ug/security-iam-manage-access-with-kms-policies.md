...
(CMK)](../../../kms/latest/developerguide/concepts.md) when creating your key policy on a configured role in the KMS Console. When
configuring the CMK, you must provide the [IAM role ARN](../../../iam/latest/userguide/reference-identifiers.md#identifiers-arns), an identifier, used by your integration to call Amazon Q. If you already
...
encrypting or decrypting content. For more information, see [kms:ViaService](../../../kms/latest/developerguide/conditions-kms.md#conditions-kms-via-service) in the _AWS Key Management Service Developer_
_Guide_.
...
see [Encryption context](../../../kms/latest/developerguide/encrypt-context.md) in the _AWS Key Management Service Developer_
_Guide_.
