...
For more information about AWS management and member accounts, see [Managing AWS accounts in an organization with AWS Organizations](../../../organizations/latest/userguide/orgs-manage-accounts.md).

Notes about unsubscribing users:

- If you are an administrator of either a management or member account within an
organization managed by [AWS Organizations](../../../organizations/latest/userguide/orgs-introduction.md), you
