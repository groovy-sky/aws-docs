...
2024 or later). For more information refer to [How to extend the session duration for Amazon Q in the IDE](../../../singlesignon/latest/userguide/configure-user-session.md#90-day-extended-session-duration) in the
...
4. Enter the **Start URL** that your administrator got from [the Amazon Q subscription console](manage-account-details.md).

5. Choose the AWS Region in which your administrator set up your [IAM Identity Center\
    instance](../../../singlesignon/latest/userguide/identity-center-instances.md).
...
4. Provide the **Start URL** that your administrator got from [the Amazon Q subscription console](manage-account-details.md).

5. Provide the AWS Region in which your administrator set up your IAM Identity Center [instance](../../../singlesignon/latest/userguide/identity-center-instances.md).
...
8. If your administrator has configured more than one Amazon Q Developer profile, you will see
    ...
    about profiles, see [What is the Amazon Q Developer profile?](subscribe-understanding-profile.md).
...
4. The credentials profile is made up of the Profile Name, Start URL, Profile Region,
    ...
    detailed information about IAM Identity Center credentials, see [What is IAM Identity Center?](../../../singlesignon/latest/userguide/what-is.md) in the
...
8. If your administrator has configured more than one Amazon Q Developer profile, you are then
    ...
    to use. For more information about profiles, see [What is the Amazon Q Developer profile?](subscribe-understanding-profile.md).
...
For more information about authenticating in the Toolkit for Visual Studio, see [Getting Started](../../../toolkit-for-visual-studio/latest/user-guide/getting-set-up.md) in
