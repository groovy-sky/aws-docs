...
- [Trusted token issuer/App level authentication](../../../singlesignon/latest/userguide/using-apps-with-trusted-token-issuer.md#trusted-token-issuer-overview)
...
authorization](../../../singlesignon/latest/userguide/using-apps-with-trusted-token-issuer.md#trusted-token-issuer-overview)
