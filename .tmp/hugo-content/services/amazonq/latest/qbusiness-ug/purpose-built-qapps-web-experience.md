...
built-in plugins](built-in-plugin.md) and [Amazon Q Business custom\
...
. For more
information, see [Understanding and managing Verified Amazon Q Apps](verfied-apps-management.md)
