...
[Analyzing log data with CloudWatch Logs Insights](../../../amazoncloudwatch/latest/logs/analyzinglogdata.md) in
...
see [Authentication and access control for AWS KMS](../../../kms/latest/developerguide/control-access.md) in the
