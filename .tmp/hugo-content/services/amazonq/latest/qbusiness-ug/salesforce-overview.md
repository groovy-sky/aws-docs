...
**[Access Control List (ACL)](connector-concepts.md#connector-authorization) crawling**Yes. For more information, see [ACL crawling](salesforce-user-management.md). **[Identity crawling](connector-concepts.md#connector-identity-crawler)**Yes**[VPC](connector-concepts.md#connector-vpc)**Yes**Supported versions**
...
[Field mappings](salesforce-field-mappings.md).**Filters**Yes. The following filters are supported:
...
will be used.**[File types](doc-types.md)**Supports all files supported by Amazon Q.**[Crawled as a document](doc-types.md#connector-doc-crawl)**
