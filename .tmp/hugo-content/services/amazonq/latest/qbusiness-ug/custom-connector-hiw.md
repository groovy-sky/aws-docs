...
2. Call the [StartDataSourceSyncJob](../api-reference/api-startdatasourcesyncjob.md) API operation to signal
...
4. To signal the end of the sync job, use the [StopDataSourceSyncJob](../api-reference/api-stopdatasourcesyncjob.md) operation. After you call
