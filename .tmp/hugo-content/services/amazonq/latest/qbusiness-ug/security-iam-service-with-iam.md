...
To view examples of Amazon Q identity-based policies, see [Identity-based policy examples for Amazon Q Business](security-iam-id-based-policy-examples.md).
...
To see a list of Amazon Q Business actions, see [Actions Defined by Amazon Q Business](../../../iam/latest/userguide/list-your-service.md#your_service-actions-as-permissions) in the
...
`qbusiness:`. For example, to grant someone permission to list an Amazon Q application with the [`ListApplications`](../api-reference/api-listapplications.md) API operation, you include the
...
To see a list of Amazon Q Business condition keys, see [Condition Keys for Amazon Q Business](../../../iam/latest/userguide/list-your-service.md#your_service-policy-keys)
in the _Service Authorization Reference_. To learn with which actions and resources
you can use a condition key, see [Actions Defined by Amazon Q Business](../../../iam/latest/userguide/list-your-service.md#your_service-actions-as-permissions).
...
`aws:TagKeys`[ListTagsForResource](../api-reference/api-listtagsforresource.md)application, index, retriever, data source, web experience,
plugin[TagResource](../api-reference/api-tagresource.md)application, index, retriever, data source, web experience,
plugin`aws:ResourceTag`, `aws:RequestTag`,
`aws:TagKeys`[UntagResource](../api-reference/api-untagresource.md)application, index, retriever, data source, web experience,
plugin`aws:TagKeys`
