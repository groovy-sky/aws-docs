...
( [Chat](../api-reference/api-chat.md), [ChatSync](../api-reference/api-chatsync.md), and [PutFeedback](../api-reference/api-putfeedback.md)) require identity-unaware [AWS Sig V4\
credentials](../../../iam/latest/userguide/signing-elements.md) for the API call that is being made.
...
1. First, call the [AssumeRole](../../../../reference/sts/latest/apireference/api-assumerolewithwebidentity.md) API to get AWS credentials. To
...
2. Then, set the following environment variables in your command line
    environment using the credentials you received as a response from the [AssumeRole](../../../../reference/sts/latest/apireference/api-assumerole.md) API call.
