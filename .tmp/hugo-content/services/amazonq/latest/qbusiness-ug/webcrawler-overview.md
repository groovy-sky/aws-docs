...
**[Field mappings](connector-concepts.md#connector-field-mappings)**Yes. For more information, see [Field mappings](web-crawler-field-mappings.md).**Filters**Yes. The following filters are supported:
