...
(identity federation)](../../../iam/latest/userguide/id-roles-common-scenarios-federated-users.md) in the _IAM User_
_Guide_.
...
IAM policies](../../../iam/latest/userguide/access-policies-create.md) in the AWS Identity and Access Management User Guide.
...
08. On the **Add permissions** page, for
    ...
    To create a new policy, follow the instructions in [Creating IAM policies](../../../iam/latest/userguide/access-policies-create.md) in the AWS Identity and Access Management User
    Guide.
...
2. For **OIDC**, do the
      ...
      4. In **Choose method to authorize**
         ...
         **Secrets**, choose an existing IAM role to allow your Amazon Q Business web experience to access the
         ...
         instructions in [Creating IAM policies](../../../iam/latest/userguide/access-policies-create.md) in the AWS Identity and Access Management
         User Guide.
...
3. In **Web experience service access**,
      ...
      1. For **Choose a method to authorize**
         **Amazon Q Business** – A
          ...
          IAM federated application](create-application-iam-okta.md#create-iam-app-okta-prereqs).
...
to create your application and [view your web experience](customizing-web-experience-iam.md) by
