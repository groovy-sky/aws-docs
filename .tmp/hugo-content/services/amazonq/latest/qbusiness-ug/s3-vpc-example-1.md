...
[Gateway endpoints for Amazon S3](../../../vpc/latest/privatelink/vpc-endpoints-s3.md)
...
information, see [Controlling access from VPC endpoints with bucket policies](../../../s3/latest/userguide/example-bucket-policies-vpc-endpoint.md)
