...
document metadata in Amazon S3](s3-metadata.md).

###### Note

To learn how to create an Amazon S3 bucket, see [Creating a bucket](../../../s3/latest/userguide/create-bucket-overview.md) in the _Amazon Simple Storage Service User Guide_.
