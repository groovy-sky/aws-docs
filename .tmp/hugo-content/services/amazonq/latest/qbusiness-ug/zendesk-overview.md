...
**[Access Control List (ACL)](connector-concepts.md#connector-authorization) crawling**Yes. For more information, see [ACL crawling](zendesk-user-management.md). **[Identity crawling](connector-concepts.md#connector-identity-crawler)**Yes**[VPC](connector-concepts.md#connector-vpc)**Yes**Crawl features****Custom metadata**Yes**Entities**Yes. The following entities are supported:
...
[Field mappings](zendesk-field-mappings.md).**Filters**Yes. The following filters are supported:
