...
[AWS Backup\
Developer Guide](../../../aws-backup/latest/devguide/whatisbackup.md).
...
You can use IAM policies for access control. For more information, see [Using IAM with DynamoDB backup and restore](backuprestore-iam.md).
