...
steps in [Tutorial: Working with Amazon DynamoDB and Apache Hive](emrfordynamodb-tutorial.md) and you have an external table in
...
large or contain non-printable characters.

4. (Optional) You can copy the data file from HDFS to the local file
