...
For a complete list of DynamoDB and DynamoDB Streams Regions and endpoints, see [Regions and endpoints](../../../../general/latest/gr/rande.md) in the
...
information, see [Using the DynamoDB Streams Kinesis adapter to process stream records](streams-kcladapter.md).)
...
responses, see the [Amazon DynamoDB Streams API Reference](../../../../reference/amazondynamodb/latest/apireference/api-operations-amazon-dynamodb-streams.md).
