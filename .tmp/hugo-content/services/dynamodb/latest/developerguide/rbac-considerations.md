...
- Resource-based policies aren't supported for [Global table version 2017.11.29 (Legacy)](globaltables-howitworks.md) replicas.
...
- The [AWS::DynamoDB::GlobalTable](../../../cloudformation/latest/userguide/aws-resource-dynamodb-globaltable.md) resource doesn’t support creating a replica and
