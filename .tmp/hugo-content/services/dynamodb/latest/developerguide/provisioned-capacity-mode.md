...
uses a [scaling policy](../../../autoscaling/application/userguide/application-auto-scaling-target-tracking.md) in [Application Auto Scaling](../../../autoscaling/application/userguide/what-is-application-auto-scaling.md). To configure auto scaling in DynamoDB, you set the
...
see [Managing throughput capacity automatically with DynamoDB auto scaling](autoscaling.md).

If you're using DynamoDB auto scaling, the throughput settings are automatically adjusted
in response to actual workloads. You can also use the [UpdateTable](../../../../reference/amazondynamodb/latest/apireference/api-updatetable.md)
...
- [DynamoDB reserved capacity](reserved-capacity.md)
...
read consistency models, see [DynamoDB read consistency](howitworks-readconsistency.md).
...
read and write operations, see [DynamoDB read and write operations](read-write-operations.md).
...
AWS CLI, or one of the AWS SDKs. For more information, see [Managing throughput capacity automatically with DynamoDB auto scaling](autoscaling.md).
...
70%. For more information, see [Managing throughput capacity automatically with DynamoDB auto scaling](autoscaling.md).
