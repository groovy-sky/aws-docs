...
console for cost allocation tracking. For more information, see [Using DynamoDB tags to create cost allocation reports](tagging.md#CostAllocationReports).
...
01. Go to the [IAM console](https://console.aws.amazon.com/iam) with an
     Admin user.

02. Select "Policies" in the left navigation menu.

03. Select "Create policy."

04. Paste the following policy into the JSON editor.
    JSON
...
05. Complete the wizard and assign a name to the policy (for example,
     `TagKeysAndValuesReadAccess`).

06. Select "Users" in the left navigation menu.

07. From the list, select the user you normally use to access the DynamoDB
     console.

08. Select "Add permissions."

09. Select "Attach existing policies directly."
