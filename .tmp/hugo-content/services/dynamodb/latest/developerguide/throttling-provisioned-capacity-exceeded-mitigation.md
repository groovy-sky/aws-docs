...
- **For read capacity:** Increase the
[`ReadCapacityUnits`](../../../../reference/amazondynamodb/latest/apireference/api-globalsecondaryindexupdate.md) parameter for the
...
- **For write capacity:** Increase the
[`WriteCapacityUnits`](../../../../reference/amazondynamodb/latest/apireference/api-globalsecondaryindexupdate.md) parameter for the
