...
[Identity and Access Management for Amazon DynamoDB](security-iam.md).) By comparison, the DAX
...
access to the same table accessing DynamoDB directly. For more information, see [Identity and Access Management for Amazon DynamoDB](security-iam.md).
...
problem](../../../iam/latest/userguide/confused-deputy.md) in the _IAM User Guide_.
