...
allowed. For a complete list of data types, see [Data types](howitworks-namingrulesdatatypes.md#HowItWorks.DataTypes).
...
documents, and sets. For a complete list of data types, see [Data types](howitworks-namingrulesdatatypes.md#HowItWorks.DataTypes).
...
information, see [Filter expressions for scan](scan.md#Scan.FilterExpression).
