...
from the primary node to read replicas. For more information, see [DAX encryption at rest](daxencryptionatrest.md).
...
certificate. For more information, see [DAX encryption in transit](daxencryptionintransit.md).
