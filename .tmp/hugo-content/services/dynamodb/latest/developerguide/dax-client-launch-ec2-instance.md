...
**DNS** for your instance, for example:
    ...
    this public DNS name because you need it for [Step 3: Configure an Amazon EC2 instance](dax-client-configure-ec2-instance.md).

###### Note

It takes a few minutes for your Amazon EC2 instance to become available. In the
meantime, proceed to [Step 2: Create a user and policy](dax-client-create-user-policy.md) and follow the instructions
there.
