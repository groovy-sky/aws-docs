...
2. Use the [AWS Service Quotas\
    console](../../../servicequotas/latest/userguide/intro.md) to request an increase:
...
change. For details on projection types, see [Projections for Global Secondary Indexes](gsi.md#GSI.Projections).
...
For more information about implementing these strategies, see [Best Practices for Using Secondary Indexes in DynamoDB](bp-indexes.md).
