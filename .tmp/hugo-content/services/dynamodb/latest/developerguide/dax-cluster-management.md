...
accelerator](../../../../reference/amazondynamodb/latest/apireference/api-operations-amazon-dynamodb-accelerator-dax.md) in the _Amazon DynamoDB API Reference_.
...
type for your application, see [DAX cluster sizing guide](dax-sizing-guide.md).
...
see [Nodes](dax-concepts-cluster.md#DAX.concepts.nodes).

You can create a new DAX cluster using the AWS Management Console, [CloudFormation](../../../cloudformation/latest/userguide/aws-resource-dax-cluster.md), the AWS CLI, or
the [AWS SDK](../../../../reference/amazondynamodb/latest/apireference/api-operations-amazon-dynamodb-accelerator-dax.md). (For the AWS CLI, use the `--node-type` parameter to
...
Region. For more information, see [Maintenance window](dax-concepts-cluster.md#DAX.concepts.maintenance-window).
...
For more information about setting up and subscribing to an Amazon SNS topic, see [Getting started with Amazon SNS](../../../sns/latest/dg/gettingstarted.md) in the
...
groups. For more information, see [Logging DynamoDB operations by using AWS CloudTrail](logging-using-cloudtrail.md).
