...
- [How DynamoDB eliminates the need for JOIN operations](#bp-relational-modeling-joins)

- [How DynamoDB transactions eliminate overhead to the write process](#bp-relational-modeling-transactions)
...
![Example RDBMS schema.](https://docs.aws.amazon.com/images/amazondynamodb/latest/developerguide/images/RDBMS.png)
